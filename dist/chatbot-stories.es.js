...
class ql {
  ...
  createDataTableRow(e, t, a, i, n) {
    ...
    for (const l of t) {
      ...
      else if (this.shouldRenderDataTablePerson(l.key, a))
  ...
  shouldRenderDataTablePerson(e, t) {
    return this.isPersonNameColumn(e) ? !!(t.avatarUrl || t.avatar || t.avatarTone || t.source || t.personDetail || t.prospectDetail) : !1;
  }
...
function Oc(r, e, t) {
  ...
  if (a.kind === "enrichment") {
    r.push({ kind: "enrichmentPanel", config: Xc(a), at: "+=0.12" });
    return;
  }
  ...
  if (a.kind === "personalizationSwipeGame") {
    r.push({ kind: "personalizationSwipeGame", config: Zc(a), at: "+=0.06" });
    return;
  }
...
function Zt(r, e) {
  const t = Hc(r), a = r.rows.filter((o) => o.some((s) => s.trim())).map((o, s) => Yc(o, t, s)), i = r.pagination?.pageSize ?? Gc(r.pagination?.ranges) ?? Math.min(10, a.length || 10), n = r.pagination?.ranges.map((o, s) => ({
    page: s + 1,
    range: o,
  ...
  return {
    ...
    eyebrow: r.eyebrow,
    count: r.count,
    variant: t.variant ?? $c(r),
    columns: t.columns,
    rows: n[0]?.rows ?? a,
    actions: r.actions?.map(Kc),
...
function Yc(r, e, t) {
  ...
  if (e.columns.forEach((i, n) => {
    ...
    const i = ro(a[e.mutualConnectionKey] ?? ""), n = Qc(t);
...
function ro(r) {
  const [e = "", t = ""] = r.split(/\s+[—–]\s+/, 2), a = e.trim().match(/^(.+?)(?:\s*\((.+)\))?$/), i = a?.[1]?.trim() || r.trim(), n = t.trim(), o = Nc[ie(i).replace(/-/g, " ")], s = jc(a?.[2]?.trim() || "", o, n);
  return {
    name: i,
    title: s.title,
    context: n,
...
const td = [
...
}, mo = [
  {
    ...
    build: (r) => Pe(r, [
      ...
      { kind: "strategyPlans", plans: ad, at: "-=0.08" },
      Ke(Fe.right, "+=0.18")
    ])
  },
  {
  ...
  },
  {
    ...
    build: (r) => {
      ...
      return Pe(r, [
        ...
        { kind: "custom", build: () => r.chat.dataTableActionTooltip("website-visitors-sales", "email-sequence", !1), at: "<+=0.02" },
        { kind: "status", text: "building outreach sequence", at: "<" },
        { kind: "custom", build: () => r.chat.sequenceBuildThinking(od), at: "+=0.06" },
  ...
  },
  {
    ...
    build: (r) => {
      ...
      return Pe(r, [
        ...
        { kind: "dataTable", config: cd, at: "+=0.08" },
        { kind: "status", text: "Cleaning CSV", at: "<" },
        {
          kind: "thinking",
          steps: [
...
class ud {
  ...
  followPointer = () => {
    ...
    if (this.mode === "return") {
      const t = this.getReturnHomePoint(), a = hd((e - this.returnStartedAt) / ti.durationMs), i = this.getReturnWavePoint(a, t), n = this.getReturnWavePoint(Math.min(1, a + 0.035), t);
  ...
  updateFollowTarget(e) {
    ...
    if (this.lastPointer) {
      ...
      i > 1.5 && (this.trailDirection = {
        x: a.x / i,
        y: a.y / i
      }, this.velocity = wd(a, Z.maxMomentumStep));
    }
    const t = {
  ...
  updatePlayTarget(e) {
    ...
    this.target = gd(n, this.pointer, He.minPointerDistance, He.viewportInset);
  }
  resumeFollowing(e) {
  ...
  getReturnWavePoint(e, t) {
    const a = this.returnStart ?? this.getCursorViewportPoint(), i = pd(e), n = t.x - a.x, o = t.y - a.y, s = Math.hypot(n, o), l = {
      x: a.x + n * i,
      y: a.y + o * i
    };
    if (s < 1) return l;
  ...
  isCursorTooFarFromBrowser() {
    ...
    return fd(i, e) > Z.maxBrowserDistance;
  }
  getChatShell() {
    return this.chatShell?.isConnected ? this.chatShell : (this.chatShell = this.root.querySelector("[data-chat-shell]"), this.chatShell);
  }
...
class bd {
  constructor(e, t, a, i, n, o) {
    this.root = e, this.stories = t, this.resolver = a, this.cursor = i, this.chat = n, this.options = o, this.storyProgress = this.stories.map(() => 0), this.pausedCursorMimic = new ud(this.root, this.cursor, {
  ...
  updateStories(e, t = {}) {
    if (!e.length) return;
    const a = this.stories[this.activeIndex]?.id, i = this.stories, n = new Map(this.stories.map((c, d) => [c.id, this.storyProgress[d] ?? 0])), o = this.cursor.getPosition(), s = this.playing, l = yd(i, e);
...
const Ad = 3, _d = /* @__PURE__ */ new Set([
  "user",
  "assistant",
  "thinking",
  "component",
...
function vd(r) {
  ...
  const e = typeof r.schemaVersion == "number" ? r.schemaVersion : 1, t = r.stories.map((a) => Cd(a)).filter((a) => !!a);
...
function Cd(r) {
  ...
  const e = _e(r.id), t = _e(r.label), a = _e(r.summary), i = r.steps.map((n) => Td(n)).filter((n) => !!n);
...
function Td(r) {
  ...
  return !e || !t || !kd(t) ? null : {
    id: e,
    kind: t,
    text: a ?? "",
    note: i ?? "",
    thinking: vt(r.thinking) ? Ed(r.thinking, a ?? "", i ?? "") : t === "thinking" ? wo(a ?? "", i ?? "") : void 0,
    component: vt(r.component) ? Sd(r.component) : void 0
  };
}
function Ed(r, e, t) {
  const i = (Array.isArray(r.items) ? r.items : []).map((n, o) => Md(n, o)).filter((n) => !!n);
  return i.length ? {
    title: _e(r.title) ?? qe,
...
async function Pd(r, e) {
  try {
    ...
    if (!t.ok) return;
    const a = vd(await t.json());
    if (!a || a.schemaVersion !== Ad) return;
...
function Id(r, e = {}) {
  Rd(r);
  const t = e.stories?.length ? e.stories : mo, a = e.builderDraftEndpoint ?? "/api/story-draft", i = e.reducedMotion ?? window.matchMedia?.("(prefers-reduced-motion: reduce)").matches ?? !1, n = new xd(r), o = new ql(r), s = new Ql(r, n, { reducedMotion: i }), l = new bd(r, t, n, s, o, {
...
function yo(r = "[data-chatbot-stories]", e = {}) {
  return e.injectStyles !== !1 && bo(), Id(Bd(r), e);
}
const Nd = {
  init: yo,
  defaultStories: mo
