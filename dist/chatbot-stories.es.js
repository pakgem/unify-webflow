...
var me = {
...
}, ae = Array.isArray, To = /random\([^)]+\)/g, Eo = /,\s*/g, Vi = /(?:-?\.?\d|\.)+/gi, Zn = /[-+=.]*\d+[.e\-+]*\d*[e\-+]*\d*/g, bt = /[-+=.]*\d+[.e-]*\d*[a-z%]*/g, qa = /[-+=.]*\d+\.?\d*(?:e-|e\+)?\d*/gi, $n = /[+-]=-?[.\d]+/, Mo = /[^,'"\[\]\s]+/gi, Po = /^[+\-=e\s\d]*\d+[.\d]*([a-z]*|%)\s*$/i, V, Me, si, ki, fe = {}, ba = {}, er, tr = function(e) {
  ...
  var a = e._dp;
  return a && a.smoothChildTiming && e._ts && (e._start = G(a._time - (e._ts > 0 ? t / e._ts : ((e._dirty ? e.totalDuration() : e._tDur) - t) / -e._ts)), Ma(e), a._dirty || pt(a, e)), e;
}, cr = function(e, t) {
  var a;
  ...
  return t.parent && $e(t), t._start = G((He(a) ? a : a || e !== V ? ye(e, a, t) : e._time) + t._delay), t._end = G(t._start + (t.totalDuration() / Math.abs(t.timeScale()) || 0)), lr(e, t, "_first", "_last", e._sort ? "_start" : 0), di(t) || (e._recent = t), i || cr(e, t), e._ts < 0 && Pa(e, e._tTime), e;
}, dr = function(e, t) {
  ...
  return s && !i && (e._time *= o / e._dur), e._dur = o, e._tDur = n ? n < 0 ? 1e10 : G(o * (n + 1) + e._rDelay * n) : o, s > 0 && !i && Pa(e, e._tTime = e._tDur * s), e.parent && Ma(e), a || pt(e.parent, e), e;
}, ji = function(e) {
...
var re = /* @__PURE__ */ (function(r) {
  ...
  function e(a, i) {
    var n;
    return a === void 0 && (a = {}), n = r.call(this, a) || this, n.labels = {}, n.smoothChildTiming = !!a.smoothChildTiming, n.autoRemoveChildren = !!a.autoRemoveChildren, n._sort = oe(a.sortChildren), V && Pe(a.parent || V, Oe(n), i), a.reversed && n.reverse(), a.paused && n.paused(!0), a.scrollTrigger && dr(Oe(n), a.scrollTrigger), n;
  }
  var t = e.prototype;
  return t.to = function(i, n, o) {
    ...
    return n.duration = 0, n.parent = this, zt(n).repeatDelay || (n.repeat = 0), n.immediateRender = !!n.immediateRender, new j(i, n, ye(this, o), 1), this;
    ...
    if (this !== V && d > l && i >= 0 && (d = l), d !== this._tTime || o || u) {
      ...
      if (this._hasPause && !this._forcing && this._lock < 2 && (y = zo(this, G(s), G(g)), y && (d -= g - (g = y._start))), this._tTime = d, this._time = g, this._act = !!_, this._initted || (this._onUpdate = this.vars.onUpdate, this._initted = 1, this._zTime = i, s = 0), !s && d && c && !n && !x && (pe(this, "onStart"), this._tTime !== d))
        return this;
      if (g >= s && i >= 0)
        for (p = this._first; p; ) {
        ...
        for (var M = i < 0 ? i : g; p; ) {
          if (f = p._prev, (p._act || M <= p._end) && p._ts && y !== p) {
            if (p.parent !== this)
              return this.render(i, n, o);
            if (p.render(p._ts > 0 ? (M - p._start) * p._ts : (p._dirty ? p.totalDuration() : p._tDur) + (M - p._start) * p._ts, n, o || Z && Pi(p)), g !== this._time || !this._ts && !b) {
    ...
    if (o._dirty) {
      for (u = o.parent; s; )
        c = s._prev, s._dirty && s.totalDuration(), d = s._start, d > l && o._sort && s._ts && !o._lock ? (o._lock = 1, Pe(o, s, d - s._delay, 1)._lock = 0) : l = d, d < 0 && s._ts && (n -= d, (!u && !o._dp || u && u.smoothChildTiming) && (o._start += G(d / o._ts), o._time -= d, o._tTime -= d), o.shiftChildren(-d, !1, -1 / 0), l = 0), s._end > n && s._ts && (n = s._end), s = c;
...
var is = function(e, t, a, i, n, o, s) {
  ...
  var i = e.vars, n = i.ease, o = i.startAt, s = i.immediateRender, l = i.lazy, c = i.onUpdate, d = i.runBackwards, u = i.yoyoEase, g = i.keyframes, p = i.autoRevert, f = e._dur, h = e._startAt, w = e._targets, b = e.parent, y = b && b.data === "nested" ? b.vars.targets : w, _ = e._overwrite === "auto" && !Ai, A = e.timeline, x = i.easeReverse || u, T, v, C, k, M, z, F, q, D, L, P, U, $;
  if (A && (!g || !n) && (n = "none"), e._ease = gt(n, Vt.ease), e._rEase = x && (gt(x) || e._ease), e._from = !A && !!i.runBackwards, e._from && (e.ratio = 1), !A || g && !i.stagger) {
    ...
    for (e._pt = e._ptCache = 0, l = f && oe(l) || l && !f, v = 0; v < w.length; v++) {
      ...
      e._op && e._op[v] && e.kill(M, e._op[v]), _ && e._pt && (Qe = e, V.killTweensOf(M, L, e.globalTime(t)), $ = !e.parent, Qe = 0), e._pt && l && (li[F.id] = 1);
    }
...
var j = /* @__PURE__ */ (function(r) {
  ...
  function e(a, i, n, o) {
    ...
    var l = s.vars, c = l.duration, d = l.delay, u = l.immediateRender, g = l.stagger, p = l.overwrite, f = l.keyframes, h = l.defaults, w = l.scrollTrigger, b = i.parent || V, y = (ae(a) || Jn(a) ? He(a[0]) : "length" in i) ? [a] : Ae(a), _, A, x, T, v, C, k, M;
    if (s._targets = y.length ? Mi(y) : Wt("GSAP target " + a + " not found. https://gsap.com", !me.nullTargetWarn) || [], s._ptLookup = [], s._overwrite = p, f || g || na(c) || na(d)) {
      ...
      s.timeline = 0;
    return p === !0 && !Ai && (Qe = Oe(s), V.killTweensOf(y), Qe = 0), Pe(b, Oe(s), n), i.reversed && s.reverse(), i.paused && s.paused(!0), (u || !c && !f && s._start === G(b._time) && oe(u) && Oo(Oe(s)) && b.data !== "nested") && (s._tTime = -O, s.render(Math.max(0, -d) || 0)), w && dr(Oe(s), w), s;
  }
  var t = e.prototype;
...
var Zi, je, _t, Ni, ut, $i, Oi, ys = function() {
  ...
  if (i === o || !n || rn[i] || rn[o])
    return n;
  if (o !== "px" && !g && (n = r(e, t, a, "px")), b = e.getCTM && zr(e), (p || o === "%") && (Ge[t] || ~t.indexOf("adius")))
...
var Vr = {
  ...
  getSetter: function(e, t, a) {
    var i = De[t];
    return i && i.indexOf(",") < 0 && (t = i), t in Ge && t !== ce && (e._gsap.x || Fe(e, "x")) ? a && $i === a ? t === "scale" ? Ms : Es : ($i = a || {}) && (t === "scale" ? Ps : Rs) : e.style && !vi(e.style[t]) ? Cs : ~t.indexOf("-") ? Ts : qi(e, t);
  },
  core: {
    _removeProperty: et,
    _getMatrix: Fi
...
class Ul {
  ...
  observeThreadContentFit() {
    this.threadContentResizeObserver?.disconnect(), this.threadContentMutationObserver?.disconnect(), typeof ResizeObserver < "u" && (this.threadContentResizeObserver = new ResizeObserver(() => this.requestThreadContentFitUpdate()), this.threadContentResizeObserver.observe(this.chatBody), this.threadContentResizeObserver.observe(this.thread)), typeof MutationObserver < "u" && (this.threadContentMutationObserver = new MutationObserver(() => this.requestThreadContentFitUpdate()), this.threadContentMutationObserver.observe(this.thread, {
      attributes: !0,
...
function Tc(r, e, t) {
  ...
  const a = Lc(e);
  return a.length ? Re(r, [...a, Xe(ze.bottomRight, "+=0.18")]) : t.build(r);
}
function Ec(r, e) {
...
function Mc(r, e) {
  ...
  for (const n of e.steps)
    n === t || n === a || lo(i, e.id, n);
  return i.push(Xe(ze.bottomRight, "+=0.16")), Re(r, i);
}
function Pc(r, e) {
