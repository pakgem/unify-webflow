...
var he = {
  ...
  return t.parent && Xe(t), t._start = U((qe(a) ? a : a || e !== V ? _e(e, a, t) : e._time) + t._delay), t._end = U(t._start + (t.totalDuration() / Math.abs(t.timeScale()) || 0)), Nr(e, t, "_first", "_last", e._sort ? "_start" : 0), Ka(t) || (e._recent = t), i || Lr(e, t), e._ts < 0 && Sa(e, e._tTime), e;
}, qr = function(e, t) {
...
var yo = function(e, t, a, i, r, o, s) {
  ...
  var i = e.vars, r = i.ease, o = i.startAt, s = i.immediateRender, l = i.lazy, d = i.onUpdate, c = i.runBackwards, u = i.yoyoEase, p = i.keyframes, m = i.autoRevert, g = e._dur, h = e._startAt, w = e._targets, b = e.parent, y = b && b.data === "nested" ? b.vars.targets : w, _ = e._overwrite === "auto" && !pi, v = e.timeline, x = i.easeReverse || u, A, k, C, S, E, B, L, I, D, M, G, z, te;
  if (v && (!p || !r) && (r = "none"), e._ease = pt(r, jt.ease), e._rEase = x && (pt(x) || e._ease), e._from = !v && !!i.runBackwards, e._from && (e.ratio = 1), !v || p && !i.stagger) {
    ...
    for (e._pt = e._ptCache = 0, l = g && ie(l) || l && !g, k = 0; k < w.length; k++) {
      if (E = w[k], L = E._gsap || yi(w)[k]._gsap, e._ptLookup[k] = M = {}, Qa[L.id] && je.length && ma(), G = y === w ? k : y.indexOf(E), I && (D = new I()).init(E, z || A, e, G, y) !== !1 && (e._pt = S = new ne(e._pt, E, D.name, 0, 1, D.render, D, 0, D.priority), D._props.forEach(function(we) {
        M[we] = S;
      }), D.priority && (B = 1)), !I || z)
        for (C in A)
          de[C] && (D = Zr(C, A, e, G, E, y)) ? D.priority && (B = 1) : M[C] = S = xi.call(e, E, C, "get", A[C], G, y, 0, i.stringFilter);
...
var $ = /* @__PURE__ */ (function(n) {
        ...
        if (ee(g))
          ...
          for (k in x)
            for (I = x[k].sort(function(G, z) {
              ...
              }, M[k] = D.v, _.to(y, M, L), L += M.duration;
          _.duration() < d && _.to({}, {
  ...
  return t.render = function(i, r, o) {
    ...
    return this._initted || vi(this, d), c = this._ease(d / this._dur), xo(this, i, r, o, s, c, d, l) ? this.resetTo(i, r, o, s, 1) : (Sa(this, 0), this.parent || Nr(this._dp, this, "_first", "_last", this._dp._sort ? "_start" : 0), this.render(0));
  }, t.kill = function(i, r) {
...
var Do = function(e, t) {
  ...
  for (i in t)
    for (r = a.length; r--; )
      o = e._ptLookup[r][i], o && (o = o.d) && (o._pt && (o = Do(o, i)), o && o.modifier && o.modifier(t[i], e, a[r], i));
}, Da = function(e, t) {
  return {
    name: e,
    headless: 1,
...
}, Da("roundProps", ai), Da("modifiers"), Da("snap", Hr)) || wa;
...
var Vi, Ue, At, Ai, dt, Wi, Ti, Lo = function() {
...
}, Yi = "O,Moz,ms,Ms,Webkit".split(","), Dt = function(e, t, a) {
  ...
  Lo() && window.document && (Vi = window, Ue = Vi.document, At = Ue.documentElement, dt = oi("div") || {
    style: {}
  }, oi("div"), W = Dt(W), oe = W + "Origin", dt.style.cssText = "border-width:0;line-height:0;position:absolute;padding:0", un = !!Dt("perspective"), Ti = se.core.reverting, Ai = 1);
}, $i = function(e) {
  ...
  */
  ...
  if (_ && (u !== tt || c !== tt)) {
    ...
    A = parseFloat(u) * Tt, S = Math.cos(A), o = Na(y, o, k * S * -_), s = Na(y, s, -Math.sin(A) * -_), l = Na(y, l, C * S * -_ + _);
  }
...
var wn = {
    ...
    for (h in t)
      if (h !== "autoRound" && (c = t[h], !(de[h] && Zr(h, t, a, i, e, r)))) {
        if (m = typeof c, g = ba[h], m === "function" && (c = c.call(a, i, e, r), m = typeof c), m === "string" && ~c.indexOf("random(") && (c = Xt(c)), g)
          ...
          if (l && h in l ? (d = typeof l[h] == "function" ? l[h].call(a, i, e, r) : l[h], X(d) && ~d.indexOf("random(") && (d = Xt(d)), K(d + "") || d === "auto" || (d += he.units[h] || K(De(e, h)) || ""), (d + "").charAt(1) === "=" && (d = De(e, h))) : d = De(e, h), p = parseFloat(d), y = m === "string" && c.charAt(1) === "=" && c.substr(0, 2), y && (c = c.substr(2)), u = parseFloat(c), h in Ee && (h === "autoAlpha" && (p === 1 && De(e, "visibility") === "hidden" && u && (p = 0), C.push("visibility", 0, s.visibility), Ve(this, s, "visibility", p ? "inherit" : "hidden", u ? "inherit" : "hidden", !u)), h !== "scale" && h !== "transform" && (h = Ee[h], ~h.indexOf(",") && (h = h.split(",")[0]))), _ = h in Oe, _) {
  ...
  getSetter: function(e, t, a) {
    var i = Ee[t];
    return i && i.indexOf(",") < 0 && (t = i), t in Oe && t !== oe && (e._gsap.x || De(e, "x")) ? a && Wi === a ? t === "scale" ? Wo : Vo : (Wi = a || {}) && (t === "scale" ? jo : Yo) : e.style && !hi(e.style[t]) ? Go : ~t.indexOf("-") ? Uo : Si(e, t);
  },
  core: {
    _removeProperty: Je,
    _getMatrix: Pi
...
const N = "https://i.pravatar.cc/96", os = {
  "andre park": `${N}?img=52`,
  "ava garcia": `${N}?img=46`,
  ...
  createSequenceEngagement(e) {
    ...
    e.sequences.forEach((p, m) => {
      ...
      if (A?.length) {
        ...
        k.className = "wa-sequence-steps", A.forEach((I, D) => {
          const M = document.createElement("button"), G = document.createElement("span"), z = document.createElement("span"), te = document.createElement("strong"), we = this.getSequenceStepWaitDays(I, D, A.length);
          M.className = "wa-sequence-step", M.type = "button", M.tabIndex = -1, M.dataset.stepIndex = String(D), M.dataset.stepOpen = String(D === 0), M.dataset.stepSelected = String(D === 0), M.dataset.channel = this.slugChannelName(I.channel), M.dataset.stepSubject = D === 0 ? p.subject : I.label, M.dataset.stepBody = this.getSequenceStepCopy(p, I), M.dataset.stepTemplateChannel = I.channel, M.dataset.stepTemplateLabel = I.label, M.dataset.stepTemplateSubject = D === 0 ? p.subject : I.label, M.dataset.stepTemplateBody = this.getSequenceStepCopy(p, I), we && (M.dataset.waitDays = String(we), M.dataset.stepTemplateWaitDays = String(we)), M.setAttribute("aria-pressed", String(D === 0)), M.addEventListener("click", () => {
            this.selectSequenceStep(g, D);
          }), G.className = "wa-sequence-step__channel", G.textContent = I.channel, z.className = "wa-sequence-step__copy", te.textContent = I.label, z.append(te), M.append(G, z), k.append(M), we && k.append(this.createSequenceWaitRow(we, D));
...
function ra(n, e, t) {
  ...
  const s = e.x - n.x, l = e.y - n.y, d = s / i, c = l / i, u = -c, p = d, m = a() > 0.5 ? 1 : -1, g = t.curve ?? 1, w = St(i * (o === "drag" ? 0.1 : o === "click" ? 0.17 : 0.22) * g, 18, 150) * m * (0.72 + a() * 0.44), b = i / Is[r] + 0.16, y = St(b * Rs[o] * Ds, 0.3, 1.66), _ = t.overshoot === !1 || i < 120 ? 0 : typeof t.overshoot == "number" ? t.overshoot : St(i * 0.026, 4, 18), v = _ > 0 ? {
    x: e.x + d * _,
    y: e.y + c * _
  } : e, x = {
...
class qs {
  ...
  renderMimicRotation(e, t) {
    ...
    if (a * a + i * i < 4) return;
    const r = Math.atan2(i, a) * 180 / Math.PI, o = Os(r - Ns), s = this.rotationState + Bs(this.rotationState, o) * Ls;
...
class Ws {
  ...
  handleThinkingInput(e) {
    ...
    !r || !a || (r.thinking ??= Nt(r.text, r.note), ol(r.thinking, a, e.value, i), sl(r), this.selectedStepId === r.id && (this.syncPanelStepText(r.text), this.syncPanelStepNote(r.note)), this.renderExport(), this.emitChange("Thinking updated", !1));
  }
...
function fl(n) {
  ...
  return !e || !t || !di(t) ? null : {
    ...
    text: a ?? "",
    note: i ?? "",
    thinking: gt(n.thinking) ? wl(n.thinking, a ?? "", i ?? "") : t === "thinking" ? Nt(a ?? "", i ?? "") : void 0,
...
}, kl = 2.8, Sl = 42, Cl = 2, Al = 3, xa = "[data-chat-shell] [data-chat-thread]", Tl = `${xa} [data-message-role="assistant"]:not(.wa-message--component) [data-message-body]`, El = `${xa} [data-message-role="assistant"].wa-message--thinking .wa-research-step[data-step-state="current"] .wa-research-step__body, ${xa} [data-message-role="assistant"].wa-message--thinking .wa-research-step[data-step-state="complete"] .wa-research-step__label`, ci = 0.24, Sn = 0.3, Ne = {
...
function Pl(n, e, t, a, i) {
  switch (t.kind) {
    ...
    case "transitionSignupToChat":
      ...
      return;
    case "assistant":
      n.add(e.chat.assistantMessage(t.text), t.at), Nl(n, e, i, {
        kind: "assistant",
        key: t.text,
        text: t.text,
        selector: Tl,
    ...
    case "thinking": {
      ...
      t.statusBefore && n.add(e.chat.setStatus(t.statusBefore), t.at), n.add(e.chat.thinkingState(r, t.hold), t.statusBefore ? void 0 : t.at), Dl(n, e, i, t.hold, o.length, o.join("|"), a);
      return;
    }
    case "dataTable":
      bt(
...
function Dl(n, e, t, a = P.thinkingShort, i = 1, r = "thinking", o = 0) {
...
function Ul(n, e, t) {
  ...
  const a = $l(e);
  return a.length ? Te(n, [...a, We(Ne.bottomRight, "+=0.18")]) : t.build(n);
}
function Vl(n, e) {
...
function Wl(n, e) {
  ...
  for (const r of e.steps)
    r === t || r === a || An(i, e.id, r);
  return i.push(We(Ne.bottomRight, "+=0.16")), Te(n, i);
}
function jl(n, e) {
  const t = Le(e, "user"), a = Lt(e, "table"), i = Le(e, "thinking"), r = Lt(e, "sequenceEngagement"), o = a ? Ni(a.component, "website-visitors-sales") : null, s = r ? In(r.component, "visitor-outreach-sequences") : null, l = [];
  if (t && l.push({
    kind: "prompt",
    text: t.text,
    duration: Rn(t.text),
...
function Yl(n, e) {
  ...
  return Te(n, [
    ...
    ...r ? [{ kind: "dataTable", config: Ni(r.component, "cleaned-webinar-attendees"), at: "-=0.04" }] : [],
...
function Xl(n, e, t) {
  const a = t.component;
  if (a.kind === "table") {
    n.push({ kind: "dataTable", config: Ni(a, `${e}-${t.id}`), at: "-=0.04" });
    return;
  }
...
function Nd(n, e = {}) {
  Dd(n, { showBuilder: e.showBuilder !== !1 });
  const t = e.stories?.length ? e.stories : Nn, a = e.builderDraftEndpoint ?? "/api/story-draft", i = e.reducedMotion ?? window.matchMedia?.("(prefers-reduced-motion: reduce)").matches ?? !1, r = new Rd(n), o = new Fs(n, r, { reducedMotion: i }), s = new As(n, { logo: o }), l = new qs(n, r, { reducedMotion: i }), d = new Md(n, t, r, l, o, s, {
...
function On(n = "[data-chatbot-stories]", e = {}) {
  return e.injectStyles !== !1 && qn(), Nd(qd(n), e);
}
const Od = {
  init: On,
  defaultStories: Nn
