...
var we = {
...
}, ae = Array.isArray, Lo = /random\([^)]+\)/g, No = /,\s*/g, Ki = /(?:-?\.?\d|\.)+/gi, rr = /[-+=.]*\d+[.e\-+]*\d*[e\-+]*\d*/g, vt = /[-+=.]*\d+[.e-]*\d*[a-z%]*/g, za = /[-+=.]*\d+\.?\d*(?:e-|e\+)?\d*/gi, or = /[+-]=-?[.\d]+/, Oo = /[^,'"\[\]\s]+/gi, Bo = /^[+\-=e\s\d]*\d+[.\d]*([a-z]*|%)\s*$/i, G, Re, ui, Pi, be = {}, va = {}, sr, lr = function(e) {
  ...
  suppressEvents: !0
}, Di = {}, $e = [], hi = {}, dr, ue = {}, Ua = {}, Xi = 30, ba = [], Ii = "", qi = function(e) {
  var t = e[0], a, i;
  ...
  $e.length && !Z && Aa(), e.render(t, a, !!(Z && t < 0 && Li(e))), $e.length && !Z && Aa();
}, pr = function(e) {
  var t = parseFloat(e);
  ...
  var a = e._dp;
  return a && a.smoothChildTiming && e._ts && (e._start = V(a._time - (e._ts > 0 ? t / e._ts : ((e._dirty ? e.totalDuration() : e._tDur) - t) / -e._ts)), qa(e), a._dirty || mt(a, e)), e;
}, fr = function(e, t) {
  var a;
  if ((t._time || !t._dur && t._initted || t._start < e._time && (t._dur || !t.add)) && (a = Ca(e.rawTime(), t), (!t._dur || aa(0, t.totalDuration(), a) - t._tTime > B) && t.render(a, !0)), mt(e, t)._dp && e._initted && e._time >= e._dur && e._ts) {
  ...
  return t.parent && tt(t), t._start = V((He(a) ? a : a || e !== G ? ve(e, a, t) : e._time) + t._delay), t._end = V(t._start + (t.totalDuration() / Math.abs(t.timeScale()) || 0)), mr(e, t, "_first", "_last", e._sort ? "_start" : 0), gi(t) || (e._recent = t), i || fr(e, t), e._ts < 0 && La(e, e._tTime), e;
}, wr = function(e, t) {
  ...
  return s && !i && (e._time *= r / e._dur), e._dur = r, e._tDur = n ? n < 0 ? 1e10 : V(r * (n + 1) + e._rDelay * n) : r, s > 0 && !i && La(e, e._tTime = e._tDur * s), e.parent && qa(e), a || mt(e.parent, e), e;
}, $i = function(e) {
  ...
  if (n)
    return l = i[t + "Params"], c = i.callbackScope || e, a && $e.length && Aa(), s && (H = s), d = l ? n.apply(c, l) : n.call(c), H = r, d;
}, zt = function(e) {
  ...
  if (e)
    if (e = !e.name && e.default || e, Mi() || e.headless) {
      ...
      if (It(), e !== i) {
        if (ue[t])
          return;
        ye(i, ye(Sa(e, n), r)), Pt(i.prototype, Pt(n, Sa(e, r))), ue[i.prop = t] = i, e.targetTest && (ba.push(i), Di[t] = 1), t = (t === "css" ? "CSS" : t.charAt(0).toUpperCase() + t.substr(1)) + "Plugin";
      }
...
var Dr = function(e, t) {
  ...
  return e.delay = function(a) {
    ...
    if (n && n.smoothChildTiming && this._ts) {
      for (La(this, a), !n._dp || n.parent || fr(n, this); n && n.parent; )
    ...
    return this._rts = +a || 0, this._ts = this._ps || a === -B ? 0 : this._rts, this.totalTime(aa(-Math.abs(this._delay), this.totalDuration(), n), i !== !1), qa(this), Go(this);
  }, e.paused = function(a) {
  ...
  return t.to = function(i, n, r) {
    ...
    if (this !== G && d > l && i >= 0 && (d = l), d !== this._tTime || r || u) {
      ...
      if (b && !n && (this.pause(), b.render(h >= s ? 0 : -B)._zTime = h >= s ? 1 : -1, this._ts))
        return this._start = v, qa(this), this.render(i, n, r);
    ...
    return X(i) ? this.removeLabel(i) : Y(i) ? this.killTweensOf(i) : (i.parent === this && Ia(this, i), i === this._recent && (this._recent = this._last), mt(this));
    ...
    if (G._ts && (hr(G, Ca(i, G)), dr = ge.frame), ge.frame >= Xi) {
      Xi += we.autoSleep || 120;
      var n = G._first;
...
var us = function(e, t, a, i, n, r, s) {
  ...
  for (l.b = a, l.e = i, a += "", i += "", (y = ~i.indexOf("random(")) && (i = Kt(i)), r && (b = [a, i], r(b, e, t), a = b[0], i = b[1]), h = a.match(za) || []; u = za.exec(i); )
  ...
  if (v && (!h || !n) && (n = "none"), e._ease = ft(n, Yt.ease), e._rEase = _ && (ft(_) || e._ease), e._from = !v && !!i.runBackwards, e._from && (e.ratio = 1), !v || h && !i.stagger) {
    if (L = w[0] ? gt(w[0]).harness : 0, P = L && i[L.prop], T = Sa(i, Di), p && (p._zTime < 0 && p.progress(1), t < 0 && d && s && !g ? p.render(-1, !0) : p.revert(d && m ? wa : Fo), p._lazy = 0), r) {
      ...
      }, T), P && (k[L.prop] = P), tt(e._startAt = K.set(w, k)), e._startAt._dp = 0, e._startAt._sat = e, t < 0 && (Z ? e._startAt.revert(wa) : e._startAt.render(-1, !0)), e._zTime = t, !s)
        o(e._startAt, B, B);
      else if (!t)
        return;
    }
    for (e._pt = e._ptCache = 0, l = m && oe(l) || l && !m, A = 0; A < w.length; A++) {
      if (M = w[A], z = M._gsap || qi(w)[A]._gsap, e._ptLookup[A] = D = {}, hi[z.id] && $e.length && Aa(), I = b === w ? A : b.indexOf(M), L && (U = new L()).init(M, P || T, e, I, b) !== !1 && (e._pt = C = new le(e._pt, M, U.name, 0, 1, U.render, U, 0, U.priority), U._props.forEach(function(Te) {
        D[Te] = C;
      }), U.priority && (F = 1)), !L || P)
        for (k in T)
...
var K = /* @__PURE__ */ (function(o) {
  ...
  function e(a, i, n, r) {
    ...
    if (s._targets = b.length ? qi(b) : Qt("GSAP target " + a + " not found. https://gsap.com", !we.nullTargetWarn) || [], s._ptLookup = [], s._overwrite = g, m || h || ra(c) || ra(d)) {
      ...
      if (x = s.timeline = new re({
        ...
        for (v = 0; v < T; v++)
          _ = Sa(i, Lr), _.stagger = 0, F && (_.easeReverse = F), M && Pt(_, M), k = b[v], _.duration = +Wt(c, Oe(s), v, k, b), _.delay = (+Wt(d, Oe(s), v, k, b) || 0) - s._delay, !h && T === 1 && _.delay && (s._delay = d = _.delay, s._start += d, _.delay = 0), x.to(k, _, C ? C(v, k, b) : 0), x._ease = R.none;
  ...
  return t.render = function(i, n, r) {
    ...
    return this._initted || Oi(this, c), d = this._ease(c / this._dur), ps(this, i, n, r, s, d, c, l) ? this.resetTo(i, n, r, s, 1) : (La(this, 0), this.parent || mr(this._dp, this, "_first", "_last", this._dp._sort ? "_start" : 0), this.render(0));
  }, t.kill = function(i, n) {
...
we.stringFilter = Pr;
var wt = [], ya = {}, vs = [], an = 0, As = 0, Wa = function(e) {
  return (ya[e] || vs).map(function(t) {
    return t();
  });
}, yi = function() {
  var e = Date.now(), t = [];
  e - an > 2 && (Wa("matchMediaInit"), wt.forEach(function(a) {
...
}, Ya("roundProps", wi), Ya("modifiers"), Ya("snap", vr)) || ka;
...
var nn, Ke, kt, Ui, pt, rn, Hi, Ts = function() {
  ...
  var n;
  return Ui || vi(), t in qe && t !== "transform" && (t = qe[t], ~t.indexOf(",") && (t = t.split(",")[0])), Ve[t] && t !== "transform" ? (n = $t(e, i), n = t !== "transformOrigin" ? n[t] : n.svg ? n.origin : Ea(fe(e, ce)) + " " + n.zOrigin + "px") : (n = e.style[t], (!n || n === "auto" || i || ~(n + "").indexOf("calc(")) && (n = Ta[t] && Ta[t](e, t, a) || fe(e, t) || ur(e, t) || (t === "opacity" ? 1 : 0))), a && !~(n + "").trim().indexOf(" ") ? it(e, t, n, a) + a : n;
}, Vs = function(e, t, a, i) {
  if (!a || a === "none") {
  ...
  */
  ...
  if (x && (u !== st || d !== st)) {
    ...
    T = parseFloat(u) * Tt, C = Math.cos(T), r = Qa(b, r, A * C * -x), s = Qa(b, s, -Math.sin(T) * -x), l = Qa(b, l, k * C * -x + x);
  }
  ...
  init: function(e, t, a, i, n) {
    ...
    for (p in t)
      if (p !== "autoRound" && (d = t[p], !(ue[p] && Ir(p, t, a, i, e, n)))) {
        if (g = typeof d, m = Ta[p], g === "function" && (d = d.call(a, i, e, n), g = typeof d), g === "string" && ~d.indexOf("random(") && (d = Kt(d)), m)
          m(this, e, p, d, a) && (A = 1);
          ...
          if (l && p in l ? (c = typeof l[p] == "function" ? l[p].call(a, i, e, n) : l[p], X(c) && ~c.indexOf("random(") && (c = Kt(c)), te(c + "") || c === "auto" || (c += we.units[p] || te(Fe(e, p)) || ""), (c + "").charAt(1) === "=" && (c = Fe(e, p))) : c = Fe(e, p), h = parseFloat(c), b = g === "string" && d.charAt(1) === "=" && d.substr(0, 2), b && (d = d.substr(2)), u = parseFloat(d), p in qe && (p === "autoAlpha" && (h === 1 && Fe(e, "visibility") === "hidden" && u && (h = 0), k.push("visibility", 0, s.visibility), Xe(this, s, "visibility", h ? "inherit" : "hidden", u ? "inherit" : "hidden", !u)), p !== "scale" && p !== "transform" && (p = qe[p], ~p.indexOf(",") && (p = p.split(",")[0]))), x = p in Ve, x) {
            ...
            if (v || (_ = e._gsap, _.renderTransform && !t.parseTransform || $t(e, t.parseTransform), T = t.smoothOrigin !== !1 && _.smooth, v = this._pt = new le(this._pt, s, W, 0, 1, _.renderTransform, _, 0, -1), v.dep = 1), p === "scale")
              ...
              k.push(ce, 0, s[ce]), d = Gs(d), _.svg ? Ai(e, d, 0, T, 0, this) : (y = parseFloat(d.split(" ")[2]) || 0, y !== _.zOrigin && Xe(this, _, "zOrigin", _.zOrigin, y), Xe(this, s, p, Ea(c), Ea(d)));
              continue;
            } else if (p === "svgOrigin") {
              Ai(e, d, 1, T, 0, this);
              continue;
...
f.core.Tween;
const Be = "Thinking", St = "Show more", xa = "Show less";
function Wi(o, e) {
...
const Ml = [
  ...
  settleHold: S(0.24)
}, yn = "Learning your style", Il = "Voice calibrated", xn = "73 tone & tactic rules defined", Ka = [
  ...
  threadGap: 44
}, Ul = "left,right,bottom,width,height,minHeight,paddingTop,paddingRight,paddingBottom,paddingLeft,borderWidth,gap", Ja = {
  paddingTop: "",
  paddingRight: "",
  paddingBottom: "",
  paddingLeft: "",
  ...
  contentWidth: 1881,
  height: 1280
}, Wl = 96, Tn = ".wa-cursor-file, .wa-file-landing-clone, .wa-file-landing-label, .wa-csv-drop, .wa-signup-logo-transfer", En = "[data-marketing-data-sources-grid]", Mn = "[data-data-table]", Ot = "[data-table-action]", $a = "[data-table-page-button]", ei = "[data-table-page-range]", Pn = "[data-sequence-engagement]", Yl = "[data-sequence-card]", Ql = "[data-sequence-person-card]", Rn = "[data-sequence-people-rail]", j = {
  duration: S(0.12),
  incomingLag: S(0.1),
  rowStagger: S(0.03),
...
class Zl {
  ...
  normalizeThinkingItem(e, t) {
    ...
    return {
      ...
      disclosure: typeof e == "string" ? t === 0 ? St : xa : e.disclosure || (t === 0 ? St : xa)
    };
  }
...
function Ht(o) {
  return Ba(hc(o).flatMap((e) => pc(e.values)));
}
function ro(o) {
...
}, xc = 2.8, _c = 42, vc = 2, Ac = 3, Pa = "[data-chat-shell] [data-chat-thread]", Sc = `${Pa} [data-message-role="assistant"]:not(.wa-message--component) [data-message-body]`, Cc = `${Pa} [data-message-role="assistant"].wa-message--thinking .wa-research-step[data-step-state="current"] .wa-research-step__body, ${Pa} [data-message-role="assistant"].wa-message--thinking .wa-research-step[data-step-state="complete"] .wa-research-step__label`, Ra = 0.24, uo = 0.3, ze = {
...
function po(o) {
  const e = Qe(`[data-style-profile="${pe(o)}"]`), t = Da(o);
  return go([
    {
  ...
  },
  {
    ...
    build: (o) => {
      ...
      return Ie(o, [
        ...
        { kind: "sequenceEngagement", config: _a, at: "-=0.02" },
        { kind: "custom", build: () => o.timeline().to({}, { duration: E.beat + 0.24 }), at: "+=0.04" },
        {
          kind: "cursorMove",
          target: r,
...
class Nd {
  ...
  followPointer = () => {
    ...
    if (this.mode === "return") {
      const t = this.getReturnHomePoint(), a = Od((e - this.returnStartedAt) / ci.durationMs), i = this.getReturnWavePoint(a, t), n = this.getReturnWavePoint(Math.min(1, a + 0.035), t);
      if (this.target = t, this.cursor.mimicViewportPoint(i, 1, a < 1 ? n : t), a >= 1 || Ye(this.getCursorViewportPoint(), t) <= ci.arriveDistance) {
...
class Vd {
  ...
  rebuildActiveStoryTimeline(e, t, a = 0) {
    this.activeIndex = e, On(this.stories, this.activeIndex), this.activeTimeline = this.buildTimeline(this.activeIndex, t), this.activeTimeline.progress(a).pause(), this.updateStoryMeta(), this.updateProgress();
  }
  stopTimeline() {
  ...
  seekTo(e, t = 0.28) {
    ...
    const i = ma(e), n = this.activeTimeline.duration();
  ...
  setActiveTimelineProgress(e) {
    this.activeTimeline && (this.activeTimeline.progress(ma(e)).pause(), this.updateProgress());
  }
...
function Yd(o, e = {}) {
  const t = e.stories?.length ? e.stories : Eo, a = e.builderDraftEndpoint ?? "/api/story-draft", i = e.reducedMotion ?? window.matchMedia?.("(prefers-reduced-motion: reduce)").matches ?? !1, n = new Wd(o), r = new Zl(o), s = new oc(o, n, { reducedMotion: i }), l = new Vd(o, t, n, s, r, {
...
function Zd(o) {
  ...
  const e = Ce(o.id), t = Ce(o.label), a = Ce(o.summary), i = o.steps.map((n) => $d(n)).filter((n) => !!n);
...
function $d(o) {
  ...
  return !e || !t || !Xd(t) ? null : {
    ...
    text: a ?? "",
    note: i ?? "",
    thinking: Mt(o.thinking) ? eu(o.thinking, a ?? "", i ?? "") : t === "thinking" ? Po(a ?? "", i ?? "") : void 0,
...
function tu(o, e) {
  ...
  return t ? {
    ...
    disclosure: Ce(o.disclosure) ?? (e === 0 ? St : xa)
  } : null;
}
function Po(o, e = "") {
  return {
