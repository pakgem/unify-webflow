...
function jl(n, e, t) {
  ...
  if (a.kind === "enrichment") {
    n.push({ kind: "enrichmentPanel", config: ed(a), at: "+=0.12" });
    return;
  }
  ...
  if (a.kind === "styleProfile") {
    n.push({ kind: "custom", build: (i) => i.chat.outreachStyleProfile(ad(a)), at: "-=0.02" });
    return;
  }
  if (a.kind === "proximityList") {
    n.push({ kind: "custom", build: (i) => i.chat.proximityLeadList(id(a)), at: "-=0.04" });
    return;
  }
  if (a.kind === "personalizationSwipeGame") {
    n.push({ kind: "personalizationSwipeGame", config: rd(a), at: "+=0.06" });
    return;
  }
...
function Ri(n, e) {
  ...
  return {
    ...
    eyebrow: n.eyebrow,
    count: n.count,
    variant: t.variant ?? nd(n),
    columns: t.columns,
    rows: r[0]?.rows ?? a,
    actions: n.actions?.map(Zl),
    pagination: r.length > 1 ? {
      pageSize: i,
      totalRows: od(n, a.length),
      activePage: 1,
      pages: r
    } : void 0
  };
...
function Kl(n, e, t) {
  ...
  if (e.columns.forEach((i, r) => {
    ...
    const i = Ql(a[e.mutualConnectionKey] ?? ""), r = Jl(t);
...
const sd = [
  ...
  pagination: {
    ...
    pages: [
      ...
      { page: 2, range: "11-20 of 50 people", rows: xd }
    ]
  },
  actions: [
    {
...
}, Dn = [
  {
    ...
    build: (n) => Te(n, [
      ...
      { kind: "thinking", steps: sd, hold: 0.46, at: "+=0.04" },
  ...
  },
  {
    ...
    build: (n) => Te(n, [
      ...
      { kind: "marketingDataSourcesGrid", config: hd, at: "+=0.44" },
      Ve(De.bottomRight, "+=3")
    ])
  },
  {
    ...
    build: (n) => {
      ...
      return Te(n, [
        ...
        { kind: "custom", build: () => t.landAsUploadedFiles(gd), at: "<" },
        ...
        { kind: "custom", build: () => n.chat.outreachStyleProfile(fd), at: "-=0.02" },
        {
          kind: "prompt",
        ...
        { kind: "custom", build: () => n.chat.proximityLeadList(wd), at: "-=0.04" },
  ...
  },
  {
    ...
    build: (n) => {
      ...
      return Te(n, [
        ...
        { kind: "custom", build: () => n.chat.dataTableActionTooltip("website-visitors-sales", "email-sequence", !1), at: "<+=0.02" },
        { kind: "status", text: "building outreach sequence", at: "<" },
        { kind: "custom", build: () => n.chat.sequenceBuildThinking(yd), at: "+=0.06" },
        { kind: "sequenceEngagement", config: bd, at: "-=0.02" },
        { kind: "custom", build: () => n.timeline().to({}, { duration: P.beat + 0.24 }), at: "+=0.04" },
        {
          kind: "cursorMove",
          target: i,
...
class Sd {
  ...
  followPointer = () => {
    ...
    if (this.mode === "return") {
      const t = this.getReturnHomePoint(), a = Cd((e - this.returnStartedAt) / ja.durationMs), i = this.getReturnWavePoint(a, t), r = this.getReturnWavePoint(Math.min(1, a + 0.035), t);
  ...
  updatePlayTarget(e) {
    ...
    this.target = Td(r, this.pointer, Be.minPointerDistance, Be.viewportInset);
  }
  resumeFollowing(e) {
  ...
  getReturnWavePoint(e, t) {
    const a = this.returnStart ?? this.getCursorViewportPoint(), i = Ad(e), r = t.x - a.x, o = t.y - a.y, s = Math.hypot(r, o), l = {
      x: a.x + r * i,
      y: a.y + o * i
    };
    if (s < 1) return l;
...
class Id {
  constructor(e, t, a, i, r, o) {
    this.root = e, this.stories = t, this.resolver = a, this.cursor = i, this.chat = r, this.options = o, this.storyProgress = this.stories.map(() => 0), this.pausedCursorMimic = new Sd(this.root, this.cursor, {
  ...
  updateStories(e, t = {}) {
    if (!e.length) return;
    const a = this.stories[this.activeIndex]?.id, i = this.stories, r = new Map(this.stories.map((d, c) => [d.id, this.storyProgress[c] ?? 0])), o = this.cursor.getPosition(), s = this.playing, l = Rd(i, e);
...
function Ld(n, e = {}) {
  ...
  const t = e.stories?.length ? e.stories : Dn, a = e.builderDraftEndpoint ?? "/api/story-draft", i = e.reducedMotion ?? window.matchMedia?.("(prefers-reduced-motion: reduce)").matches ?? !1, r = new Nd(n), o = new As(n), s = new qs(n, r, { reducedMotion: i }), l = new Id(n, t, r, s, o, {
  ...
  return l.mount(), u?.mount(), !u && a && qd(a, d), {
    play: l.play.bind(l),
...
function On(n = "[data-chatbot-stories]", e = {}) {
  return e.injectStyles !== !1 && qn(), Ld(Od(n), e);
}
const Bd = {
  init: On,
  defaultStories: Dn
