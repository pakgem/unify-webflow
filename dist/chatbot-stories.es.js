...
var le = {
  ...
  overwrite: !1,
  delay: 0
}, Ta, X, R, pe = 1e8, I = 1 / pe, ha = Math.PI * 2, Li = ha / 4, Fi = 0, Nr = Math.sqrt, Bi = Math.cos, qi = Math.sin, J = function(e) {
...
}, Z = Array.isArray, Hi = /random\([^)]+\)/g, Gi = /,\s*/g, Ja = /(?:-?\.?\d|\.)+/gi, Dr = /[-+=.]*\d+[.e\-+]*\d*[e\-+]*\d*/g, Ke = /[-+=.]*\d+[.e-]*\d*[a-z%]*/g, ta = /[-+=.]*\d+\.?\d*(?:e-|e\+)?\d*/gi, Or = /[+-]=-?[.\d]+/, Ui = /[^,'"\[\]\s]+/gi, Yi = /^[+\-=e\s\d]*\d+[.\d]*([a-z]*|%)\s*$/i, L, fe, pa, Ma, de = {}, Yt = {}, zr, Lr = function(e) {
  return (Yt = rt(e, de)) && re;
}, Ia = function(e, t) {
  return console.warn("Invalid property", e, "set to", t, "Missing plugin? gsap.registerPlugin()");
}, St = function(e, t) {
  return !t && console.warn(e);
}, Fr = function(e, t) {
  return e && (de[e] = t) && Yt && (Yt[e] = t) || de;
}, Tt = function() {
  return 0;
}, Vi = {
  suppressEvents: !0,
  ...
  suppressEvents: !0
}, Na = {}, Me = [], ma = {}, Br, ie = {}, aa = {}, Xa = 30, Gt = [], Ra = "", Da = function(e) {
  var t = e[0], a, r;
  if (_e(t) || H(t) || (e = [e]), !(a = (t._gsap || {}).harness)) {
    for (r = Gt.length; r-- && !Gt[r].targetTest(t); )
      ;
    a = Gt[r];
  }
  for (r = e.length; r--; )
    e[r] && (e[r]._gsap || (e[r]._gsap = new oi(e[r], a))) || e.splice(r, 1);
  return e;
}, Ye = function(e) {
  return e._gsap || Da(me(e))[0]._gsap;
}, qr = function(e, t, a) {
  return (a = e[t]) && H(a) ? e[t]() : Ea(a) && e.getAttribute && e.getAttribute(t) || a;
}, ee = function(e, t) {
  ...
  for (ma = {}, Me.length = 0, a = 0; a < e; a++)
    r = t[a], r && r._lazy && (r.render(r._lazy[0], r._lazy[1], !0)._lazy = 0);
}, Oa = function(e) {
  return !!(e._initted || e._startAt || e.add);
}, Hr = function(e, t, a, r) {
  Me.length && !X && Vt(), e.render(t, a, !!(X && t < 0 && Oa(e))), Me.length && !X && Vt();
}, Gr = function(e) {
  var t = parseFloat(e);
  return (t || t === 0) && (e + "").match(Ui).length < 2 ? t : J(e) ? e.trim() : e;
}, Ur = function(e) {
  return e;
}, ce = function(e, t) {
  for (var a in t)
  ...
  var t = e.parent || L, a = e.keyframes ? Ji(Z(e.keyframes)) : ce;
  if ($(e.inherit))
    for (; t; )
  ...
  return e._startAt && (X ? e._startAt.revert(Ht) : e.vars.immediateRender && !e.vars.autoRevert || e._startAt.render(t, !0, r));
}, Zi = function o(e) {
  ...
  return e._end = z(e._start + (e._tDur / Math.abs(e._ts || e._rts || I) || 0));
}, ea = function(e, t) {
  var a = e._dp;
  return a && a.smoothChildTiming && e._ts && (e._start = z(a._time - (e._ts > 0 ? t / e._ts : ((e._dirty ? e.totalDuration() : e._tDur) - t) / -e._ts)), $t(e), a._dirty || Ve(a, e)), e;
}, Vr = function(e, t) {
  var a;
  if ((t._time || !t._dur && t._initted || t._start < e._time && (t._dur || !t.add)) && (a = Wt(e.rawTime(), t), (!t._dur || Rt(0, t.totalDuration(), a) - t._tTime > I) && t.render(a, !0)), Ve(e, t)._dp && e._initted && e._time >= e._dur && e._ts) {
  ...
  return t.parent && Ne(t), t._start = z((Ce(a) ? a : a || e !== L ? he(e, a, t) : e._time) + t._delay), t._end = z(t._start + (t.totalDuration() / Math.abs(t.timeScale()) || 0)), Yr(e, t, "_first", "_last", e._sort ? "_start" : 0), fa(t) || (e._recent = t), r || Vr(e, t), e._ts < 0 && ea(e, e._tTime), e;
}, jr = function(e, t) {
  return (de.ScrollTrigger || Ia("scrollTrigger", t)) && de.ScrollTrigger.create(t, e);
}, Wr = function(e, t, a, r, i) {
  if (La(e, t, i), !e._initted)
    return 1;
  if (!a && e._pt && !X && (e._dur && e.vars.lazy !== !1 || !e._dur && e.vars.lazy) && Br !== ne.frame)
  ...
  var i = e.ratio, n = t < 0 || !t && (!e._start && Ki(e) && !(!e._initted && fa(e)) || (e._ts < 0 || e._dp._ts < 0) && !fa(e)) ? 0 : 1, s = e._rDelay, l = 0, d, c, u;
  if (s && e._repeat && (l = Rt(0, e._tDur, t), c = it(l, s), e._yoyo && c & 1 && (n = 1 - n), c !== it(e._tTime, s) && (i = 1 - n, e.vars.repeatRefresh && e._initted && e.invalidate())), n !== i || X || r || e._zTime === I || !t && e._zTime) {
    if (!e._initted && Wr(e, t, r, a, l))
      return;
    for (u = e._zTime, e._zTime = t || (a ? I : 0), a || (a = t && !u), e.ratio = n, e._from && (n = 1 - n), e._time = 0, e._tTime = l, d = e._pt; d; )
      d.r(n, d.d), d = d._next;
    t < 0 && ga(e, t, a, !0), e._onUpdate && !a && se(e, "onUpdate"), l && e._repeat && !a && e.parent && se(e, "onRepeat"), (t >= e._tDur || t < 0) && e.ratio === n && (n && Ne(e, 1), !a && !X && (se(e, n ? "onComplete" : "onReverseComplete", !0), e._prom && e._prom()));
  ...
  var i = e._repeat, n = z(t) || 0, s = e._tTime / e._tDur;
  return s && !r && (e._time *= n / e._dur), e._dur = n, e._tDur = i ? i < 0 ? 1e10 : z(n * (i + 1) + e._rDelay * i) : n, s > 0 && !r && ea(e, e._tTime = e._tDur * s), e.parent && $t(e), a || Ve(e.parent, e), e;
}, Ka = function(e) {
  return e instanceof K ? Ve(e) : nt(e, e._dur);
}, tn = {
  _start: 0,
  endTime: Tt,
  totalDuration: Tt
}, he = function o(e, t, a) {
  var r = e.labels, i = e._recent || tn, n = e.duration() >= pe ? i.endTime(!1) : e._dur, s, l, d;
  ...
  var r = Ce(t[1]), i = (r ? 2 : 1) + (e < 2 ? 0 : 1), n = t[i], s, l;
  ...
  return new V(t[0], n, t[i + 1]);
}, Oe = function(e, t) {
  return e || e === 0 ? t(e) : t;
}, Rt = function(e, t, a) {
  return a < e ? e : a > t ? t : a;
}, Q = function(e, t) {
  return !J(e) || !(t = Yi.exec(e)) ? "" : t[1];
}, an = function(e, t, a) {
  return Oe(a, function(r) {
    return Rt(e, t, r);
  });
}, wa = [].slice, Jr = function(e, t) {
  return e && _e(e) && "length" in e && (!t && !e.length || e.length - 1 in e && _e(e[0])) && !e.nodeType && e !== fe;
}, rn = function(e, t, a) {
  return a === void 0 && (a = []), e.forEach(function(r) {
    var i;
    return J(r) && !t || Jr(r, 1) ? (i = a).push.apply(i, me(r)) : a.push(r);
  }) || a;
}, me = function(e, t, a) {
  return R && !t && R.selector ? R.selector(e) : J(e) && !a && (pa || !st()) ? wa.call((t || Ma).querySelectorAll(e), 0) : Z(e) ? rn(e, a) : Jr(e) ? wa.call(e, 0) : e ? [e] : [];
}, ba = function(e) {
  return e = me(e)[0] || St("Invalid scope") || {}, function(t) {
    var a = e.current || e.nativeElement || e;
    return me(t, a.querySelectorAll ? a : a === e ? St("Invalid scope") || Ma.createElement("div") : e);
  };
}, Xr = function(e) {
  ...
  return J(r) ? c = u = {
    ...
    var h = (g || t).length, f = n[h], _, w, x, y, b, S, A, C, k;
    if (!f) {
      ...
      for (f = n[h] = [], _ = l ? Math.min(k, h) * c - 0.5 : r % k, w = k === pe ? 0 : l ? h * u / k - 0.5 : r / k | 0, A = 0, C = pe, S = 0; S < h; S++)
        x = S % k - _, y = w - (S / k | 0), f[S] = b = d ? Math.abs(d === "y" ? y : x) : Nr(x * x + y * y), b > A && (A = b), b < C && (C = b);
      r === "random" && Xr(f), f.max = A - C, f.min = C, f.v = h = (parseFloat(t.amount) || parseFloat(t.each) * (k > h ? h - 1 : d ? d === "y" ? h / k : k : Math.max(k, h / k)) || 0) * (r === "edges" ? -1 : 1), f.b = h < 0 ? i - h : i, f.u = Q(t.amount || t.each) || 0, a = a && h < 0 ? wn(a) : a;
    }
  ...
  return function(a) {
    var r = z(Math.round(parseFloat(a) / e) * e * t);
    return (r - r % 1) / t + (Ce(a) ? 0 : Q(a));
  };
}, Zr = function(e, t) {
  var a = Z(e), r, i;
  return !a && _e(e) && (r = a = e.radius || pe, e.values ? (e = me(e.values), (i = !Ce(e[0])) && (r *= r)) : e = _a(e.increment)), Oe(t, a ? H(e) ? function(n) {
    ...
    return c = !r || d <= r ? e[c] : n, i || c === n || Ce(n) ? c : c + Q(n);
  } : _a(e));
}, Kr = function(e, t, a, r) {
  return Oe(Z(e) ? !t : a === !0 ? !!(a = 0) : !r, function() {
  ...
  var r = t - e;
  return Z(e) ? $r(e, o(0, e.length), t) : Oe(a, function(i) {
    return (r + (i - e) % r) % r + e;
  });
}, dn = function o(e, t, a) {
  var r = t - e, i = r * 2;
  return Z(e) ? $r(e, o(0, e.length - 1), t) : Oe(a, function(n) {
    return n = (i + (n - e) % i) % i || 0, e + (n > r ? i - n : n);
  });
}, Et = function(e) {
  return e.replace(Hi, function(t) {
    var a = t.indexOf("[") + 1, r = t.substring(a || 7, a ? t.indexOf("]") : t.length - 1).split(Gi);
    return Kr(a ? r : +r[0], a ? 0 : +r[1], +r[2] || 1e-5);
  });
}, ei = function(e, t, a, r, i) {
  var n = t - e, s = r - a;
  return Oe(i, function(l) {
    return a + ((l - e) / n * s || 0);
  });
}, cn = function o(e, t, a, r) {
  ...
  if (!i) {
    ...
    if (!c) {
      for (l in t)
        za.call(s, e, l, "get", t[l]);
      i = function(g) {
        return qa(g, s) || (n ? e.p : e);
      };
    }
  }
  return Oe(a, i);
  ...
  var r = e.vars, i = r[t], n = R, s = e._ctx, l, d, c;
  if (i)
    return l = r[t + "Params"], d = r.callbackScope || e, a && Me.length && Vt(), s && (R = s), c = l ? i.apply(d, l) : i.call(d), R = n, c;
}, bt = function(e) {
  return Ne(e), e.scrollTrigger && e.scrollTrigger.kill(!!X), e.progress() < 1 && se(e, "onInterrupt"), e;
}, $e, ti = [], ai = function(e) {
  if (e)
    if (e = !e.name && e.default || e, Pa() || e.headless) {
      var t = e.name, a = H(e), r = t && !a && e.init ? function() {
        this._props = [];
      } : e, i = {
        init: Tt,
        render: qa,
      ...
      if (st(), e !== r) {
        if (ie[t])
          return;
        ce(r, ce(jt(e, i), n)), rt(r.prototype, rt(i, jt(e, n))), ie[r.prop = t] = r, e.targetTest && (Gt.push(r), Na[t] = 1), t = (t === "css" ? "CSS" : t.charAt(0).toUpperCase() + t.substr(1)) + "Plugin";
      }
      Fr(t, r), e.register && e.register(re, r, te);
    } else
      ti.push(e);
}, M = 255, _t = {
  aqua: [0, M, M],
  ...
  var r = e ? Ce(e) ? [e >> 16, e >> 8 & M, e & M] : 0 : _t.black, i, n, s, l, d, c, u, p, m, g;
  if (!r) {
    if (e.substr(-1) === "," && (e = e.substr(0, e.length - 1)), _t[e])
      r = _t[e];
    else if (e.charAt(0) === "#") {
      if (e.length < 6 && (i = e.charAt(1), n = e.charAt(2), s = e.charAt(3), e = "#" + i + i + n + n + s + s + (e.length === 5 ? e.charAt(4) + e.charAt(4) : "")), e.length === 9)
        return r = parseInt(e.substr(1, 6), 16), [r >> 16, r >> 8 & M, r & M, parseInt(e.substr(7), 16) / 255];
      e = parseInt(e.substr(1), 16), r = [e >> 16, e >> 8 & M, e & M];
    } else if (e.substr(0, 3) === "hsl") {
      if (r = g = e.match(Ja), !t)
        l = +r[0] % 360 / 360, d = +r[1] / 100, c = +r[2] / 100, n = c <= 0.5 ? c * (d + 1) : c + d - c * d, i = c * 2 - n, r.length > 3 && (r[3] *= 1), r[0] = ra(l + 1 / 3, i, n), r[1] = ra(l, i, n), r[2] = ra(l - 1 / 3, i, n);
      else if (~e.indexOf("="))
        return r = e.match(Dr), a && r.length < 4 && (r[3] = 1), r;
    } else
      r = e.match(Ja) || _t.transparent;
    r = r.map(Number);
  }
  return t && !g && (i = r[0] / M, n = r[1] / M, s = r[2] / M, u = Math.max(i, n, s), p = Math.min(i, n, s), c = (u + p) / 2, u === p ? l = d = 0 : (m = u - p, d = c > 0.5 ? m / (2 - u - p) : m / (u + p), l = u === i ? (n - s) / m + (n < s ? 6 : 0) : u === n ? (s - i) / m + 2 : (i - n) / m + 4, l *= 60), r[0] = ~~(l + 0.5), r[1] = ~~(d * 100 + 0.5), r[2] = ~~(c * 100 + 0.5)), a && r.length < 4 && (r[3] = 1), r;
}, ii = function(e) {
  var t = [], a = [], r = -1;
  return e.split(Ie).forEach(function(i) {
    var n = i.match(Ke) || [];
    t.push.apply(t, n), a.push(r += n.length + 1);
  }), t.c = a, t;
}, er = function(e, t, a) {
  var r = "", i = (e + r).match(Ie), n = t ? "hsla(" : "rgba(", s = 0, l, d, c, u;
  if (!i)
    return e;
  if (i = i.map(function(p) {
    return (p = ri(p, t, 1)) && n + (t ? p[0] + "," + p[1] + "%," + p[2] + "%," + p[3] : p.join(",")) + ")";
  }), a && (c = ii(e), l = a.c, l.join(r) !== c.c.join(r)))
    for (d = e.replace(Ie, "1").split(Ke), u = d.length - 1; s < u; s++)
      r += d[s] + (~l.indexOf(s) ? i.shift() || n + "0,0,0,0)" : (c.length ? c : i.length ? i : a).shift());
  if (!d)
    for (d = e.split(Ie), u = d.length - 1; s < u; s++)
      r += d[s] + i[s];
  return r + d[u];
}, Ie = (function() {
...
})(), un = /hsl[a]?\(/, ni = function(e) {
  var t = e.join(" "), a;
  if (Ie.lastIndex = 0, Ie.test(t))
    return a = un.test(t), e[1] = er(e[1], a), e[0] = er(e[0], a, ii(e[1])), !0;
}, Pt, ne = (function() {
  var o = Date.now, e = 500, t = 33, a = o(), r = a, i = 1e3 / 240, n = i, s = [], l, d, c, u, p, m, g = function h(f) {
    var _ = o() - r, w = f === !0, x, y, b, S;
    if ((_ > e || _ < 0) && (a += _ - t), r += _, b = r - a, x = b - n, (x > 0 || w) && (S = ++u.frame, p = b - u.time * 1e3, u.time = b = b / 1e3, n += x + (x >= i ? 4 : i - x), y = 1), w || (l = d(h)), y)
  ...
  return u = {
    ...
    wake: function() {
      zr && (!pa && Pa() && (fe = pa = window, Ma = fe.document || {}, de.gsap = re, (fe.gsapVersions || (fe.gsapVersions = [])).push(re.version), Lr(Yt || fe.GreenSockGlobals || !fe.gsap && fe || {}), ti.forEach(ai)), c = typeof requestAnimationFrame < "u" && requestAnimationFrame, l && u.sleep(), d = c || function(f) {
        return setTimeout(f, n - u.time * 1e3 + 1 | 0);
      }, Pt = 1, g(2));
    },
    sleep: function() {
      (c ? cancelAnimationFrame : clearTimeout)(l), Pt = 0, d = Tt;
    },
    ...
    add: function(f, _, w) {
      var x = _ ? function(y, b, S, A) {
        f(y, b, S, A), u.remove(x);
      } : f;
      return u.remove(f), s[w ? "unshift" : "push"](x), st(), x;
    },
    remove: function(f, _) {
  ...
  return !Pt && ne.wake();
}, E = {}, hn = /^[\d.\-M][\d.\-,\s]/, pn = /["']/g, mn = function(e) {
  for (var t = {}, a = e.substr(1, e.length - 3).split(":"), r = a[0], i = 1, n = a.length, s, l, d; i < n; i++)
    l = a[i], s = i !== n - 1 ? l.lastIndexOf(",") : l.length, d = l.substr(0, s), t[r] = isNaN(d) ? d.replace(pn, "").trim() : +d, r = l.substr(s + 1).trim();
  return t;
}, gn = function(e) {
  ...
  return a && t.length > 1 && a.config ? a.config.apply(null, ~e.indexOf("{") ? [mn(t[1])] : gn(e).split(",").map(Gr)) : E._CE && hn.test(e) ? E._CE("", e) : a;
}, wn = function(e) {
  return function(t) {
    return 1 - e(1 - t);
  };
}, je = function(e, t) {
  return e && (H(e) ? e : E[e] || fn(e)) || t;
}, Je = function(e, t, a, r) {
  ...
  return ee(e, function(s) {
    E[s] = de[s] = i, E[n = s.toLowerCase()] = a;
    for (var l in i)
      E[n + (l === "easeIn" ? ".in" : l === "easeOut" ? ".out" : ".inOut")] = E[s + "." + l] = i[l];
  }), i;
}, si = function(e) {
  return function(t) {
  ...
  var r = t >= 1 ? t : 1, i = (a || (e ? 0.3 : 0.45)) / (t < 1 ? t : 1), n = i / ha * (Math.asin(1 / r) || 0), s = function(c) {
    return c === 1 ? 1 : r * Math.pow(2, -10 * c) * qi((c - n) * i) + 1;
  }, l = e === "out" ? s : e === "in" ? function(d) {
    return 1 - s(1 - d);
  } : si(s);
  return i = ha / i, l.config = function(d, c) {
    return o(e, d, c);
  }, l;
}, na = function o(e, t) {
  t === void 0 && (t = 1.70158);
...
Je("Sine", function(o) {
  return o === 1 ? 1 : -Bi(o * Li) + 1;
});
Je("Back", na("in"), na("out"), na());
E.SteppedEase = E.steps = de.SteppedEase = {
  config: function(e, t) {
    e === void 0 && (e = 1);
    var a = 1 / e, r = e + (t ? 0 : 1), i = t ? 1 : 0, n = 1 - I;
    return function(s) {
      return ((r * Rt(0, n, s) | 0) + i) * a;
    };
  }
};
Ct.ease = E["quad.out"];
ee("onComplete,onUpdate,onStart,onRepeat,onReverseComplete,onInterrupt", function(o) {
  return Ra += o + "," + o + "Params,";
});
var oi = function(e, t) {
  this.id = Fi++, e._gsap = this, this.target = e, this.harness = t, this.get = t ? t.get : qr, this.set = t ? t.getSetter : Ba;
}, Mt = /* @__PURE__ */ (function() {
  function o(t) {
    this.vars = t, this._delay = +t.delay || 0, (this._repeat = t.repeat === 1 / 0 ? -2 : t.repeat || 0) && (this._rDelay = t.repeatDelay || 0, this._yoyo = !!t.yoyo || !!t.yoyoEase), this._ts = 1, nt(this, +t.duration, 1, 1), this.data = t.data, R && (this._ctx = R, R.data.push(this)), Pt || ne.wake();
  }
  var e = o.prototype;
  return e.delay = function(a) {
    ...
    return arguments.length ? (this._dirty = 0, nt(this, this._repeat < 0 ? a : (a - this._repeat * this._rDelay) / (this._repeat + 1))) : this._tDur;
  }, e.totalTime = function(a, r) {
    if (st(), !arguments.length)
      return this._tTime;
    var i = this._dp;
    if (i && i.smoothChildTiming && this._ts) {
      for (ea(this, a), !i._dp || i.parent || Vr(i, this); i && i.parent; )
    ...
    return (this._tTime !== a || !this._dur && !r || this._initted && Math.abs(this._zTime) === I || !this._initted && this._dur && a || !a && !this._initted && (this.add || this._ptLookup)) && (this._ts || (this._pTime = a), Hr(this, a, r)), this;
  }, e.time = function(a, r) {
    return arguments.length ? this.totalTime(Math.min(this.totalDuration(), a + Za(this)) % (this._dur + this._rDelay) || (a ? this._dur : 0), r) : this._time;
    ...
    return arguments.length ? this.totalTime(this.duration() * (this._yoyo && !(this.iteration() & 1) ? 1 - a : a) + Za(this), r) : this.duration() ? Math.min(1, this._time / this._dur) : this.rawTime() > 0 ? 1 : 0;
  }, e.iteration = function(a, r) {
    var i = this.duration() + this._rDelay;
    return arguments.length ? this.totalTime(this._time + (a - 1) * i, r) : this._repeat ? it(this._tTime, i) + 1 : 1;
  }, e.timeScale = function(a, r) {
    if (!arguments.length)
      return this._rts === -I ? 0 : this._rts;
    if (this._rts === a)
      return this;
    var i = this.parent && this._ts ? Wt(this.parent._time, this) : this._tTime;
    return this._rts = +a || 0, this._ts = this._ps || a === -I ? 0 : this._rts, this.totalTime(Rt(-Math.abs(this._delay), this.totalDuration(), i), r !== !1), $t(this), Qi(this);
  }, e.paused = function(a) {
    return arguments.length ? (this._ps !== a && (this._ps = a, a ? (this._pTime = this._tTime || Math.max(-this._delay, this.rawTime()), this._ts = this._act = 0) : (st(), this._ts = this._rts, this.totalTime(this.parent && !this.parent.smoothChildTiming ? this.rawTime() : this._tTime || this._pTime, this.progress() === 1 && Math.abs(this._zTime) !== I && (this._tTime -= I)))), this) : this._ps;
  }, e.startTime = function(a) {
    if (arguments.length) {
      this._start = z(a);
      var r = this.parent || this._dp;
      return r && (r._sort || !this.parent) && we(r, this, this._start - this._delay), this;
    }
    return this._start;
    ...
    var r = this.parent || this._dp;
    return r ? a && (!this._ts || this._repeat && this._time && this.totalProgress() < 1) ? this._tTime % (this._dur + this._rDelay) : this._ts ? Wt(r.rawTime(a), this) : this._tTime : this._tTime;
  }, e.revert = function(a) {
    a === void 0 && (a = ji);
    var r = X;
    return X = a, Oa(this) && (this.timeline && this.timeline.revert(a), this.totalTime(-0.01, a.suppressEvents)), this.data !== "nested" && a.kill !== !1 && this.kill(), X = r, this;
    ...
    return arguments.length ? (this._repeat = a === 1 / 0 ? -2 : a, Ka(this)) : this._repeat === -2 ? 1 / 0 : this._repeat;
  }, e.repeatDelay = function(a) {
    if (arguments.length) {
      var r = this._time;
      return this._rDelay = a, Ka(this), r ? this.time(r) : this;
    }
    return this._rDelay;
  }, e.yoyo = function(a) {
    ...
    return this.play().totalTime(a ? -this._delay : 0, $(r)), this._dur || (this._zTime = -I), this;
  }, e.play = function(a, r) {
    ...
    return !!(!a || this._ts && this._initted && a.isActive() && (i = a.rawTime(!0)) >= r && i < this.endTime(!0) - I);
    ...
    return new Promise(function(n) {
      var s = H(a) ? a : Ur, l = function() {
        var c = r.then;
        r.then = null, i && i(), H(s) && (s = s(r)) && (s.then || s === r) && (r.then = c), n(s), r.then = c;
      };
...
var K = /* @__PURE__ */ (function(o) {
  ...
  function e(a, r) {
    var i;
    return a === void 0 && (a = {}), i = o.call(this, a) || this, i.labels = {}, i.smoothChildTiming = !!a.smoothChildTiming, i.autoRemoveChildren = !!a.autoRemoveChildren, i._sort = $(a.sortChildren), L && we(a.parent || L, ve(i), r), a.reversed && i.reverse(), a.paused && i.paused(!0), a.scrollTrigger && jr(ve(i), a.scrollTrigger), i;
  }
  var t = e.prototype;
  return t.to = function(r, i, n) {
    ...
    return i.duration = 0, i.parent = this, yt(i).repeatDelay || (i.repeat = 0), i.immediateRender = !!i.immediateRender, new V(r, i, he(this, n), 1), this;
  }, t.call = function(r, i, n) {
    return we(this, V.delayedCall(0, r, i), n);
  }, t.staggerTo = function(r, i, n, s, l, d, c) {
    return n.duration = i, n.stagger = n.stagger || s, n.onComplete = d, n.onCompleteParams = c, n.parent = this, new V(r, n, he(this, l)), this;
  }, t.staggerFrom = function(r, i, n, s, l, d, c) {
    return n.runBackwards = 1, yt(n).immediateRender = $(n.immediateRender), this.staggerTo(r, i, n, s, l, d, c);
  }, t.staggerFromTo = function(r, i, n, s, l, d, c, u) {
    return s.startAt = n, yt(s).immediateRender = $(s.immediateRender), this.staggerTo(r, i, s, l, d, c, u);
  }, t.render = function(r, i, n) {
    var s = this._time, l = this._dirty ? this.totalDuration() : this._tDur, d = this._dur, c = r <= 0 ? 0 : z(r), u = this._zTime < 0 != r < 0 && (this._initted || !d), p, m, g, h, f, _, w, x, y, b, S, A;
    if (this !== L && c > l && r >= 0 && (c = l), c !== this._tTime || n || u) {
      if (s !== this._time && d && (c += this._time - s, r += this._time - s), p = c, y = this._start, x = this._ts, _ = !x, u && (d || (s = this._zTime), (r || !i) && (this._zTime = r)), this._repeat) {
        if (S = this._yoyo, f = d + this._rDelay, this._repeat < -1 && r < 0)
          return this.totalTime(f * 100 + r, i, n);
        if (p = z(c % f), c === l ? (h = this._repeat, p = d) : (b = z(c / f), h = ~~b, h && h === b && (p = d, h--), p > d && (p = d)), b = it(this._tTime, f), !s && this._tTime && b !== h && this._tTime - b * f - this._dur <= 0 && (b = h), S && h & 1 && (p = d - p, A = 1), h !== b && !this._lock) {
          var C = S && b & 1, k = C === (S && h & 1);
          if (h < b && (C = !C), s = C ? 0 : c % d ? d : c, this._lock = 1, this.render(s || (A ? 0 : z(h * f)), i, !d)._lock = 0, this._tTime = c, !i && this.parent && se(this, "onRepeat"), this.vars.repeatRefresh && !A && (this.invalidate()._lock = 1, b = h), s && s !== this._time || _ !== !this._ts || this.vars.onRepeat && !this.parent && !this._act)
            return this;
          if (d = this._dur, l = this._tDur, k && (this._lock = 2, s = C ? d : -1e-4, this.render(s, !0), this.vars.repeatRefresh && !A && this.invalidate()), this._lock = 0, !this._ts && !_)
            return this;
        }
      }
      if (this._hasPause && !this._forcing && this._lock < 2 && (w = en(this, z(s), z(p)), w && (c -= p - (p = w._start))), this._tTime = c, this._time = p, this._act = !!x, this._initted || (this._onUpdate = this.vars.onUpdate, this._initted = 1, this._zTime = r, s = 0), !s && c && d && !i && !b && (se(this, "onStart"), this._tTime !== c))
        return this;
      if (p >= s && r >= 0)
        for (m = this._first; m; ) {
          if (g = m._next, (m._act || p >= m._start) && m._ts && w !== m) {
            ...
            if (m.render(m._ts > 0 ? (p - m._start) * m._ts : (m._dirty ? m.totalDuration() : m._tDur) + (p - m._start) * m._ts, i, n), p !== this._time || !this._ts && !_) {
              w = 0, g && (c += this._zTime = -I);
              break;
            }
          }
          m = g;
        ...
        for (var T = r < 0 ? r : p; m; ) {
          if (g = m._prev, (m._act || T <= m._end) && m._ts && w !== m) {
            if (m.parent !== this)
              return this.render(r, i, n);
            if (m.render(m._ts > 0 ? (T - m._start) * m._ts : (m._dirty ? m.totalDuration() : m._tDur) + (T - m._start) * m._ts, i, n || X && Oa(m)), p !== this._time || !this._ts && !_) {
              w = 0, g && (c += this._zTime = T ? -I : I);
              break;
            }
          }
          m = g;
      ...
      if (w && !i && (this.pause(), w.render(p >= s ? 0 : -I)._zTime = p >= s ? 1 : -1, this._ts))
        return this._start = y, $t(this), this.render(r, i, n);
      this._onUpdate && !i && se(this, "onUpdate", !0), (c === l && this._tTime >= this.totalDuration() || !c && s) && (y === this._start || Math.abs(x) !== Math.abs(this._ts)) && (this._lock || ((r || !d) && (c === l && this._ts > 0 || !c && this._ts < 0) && Ne(this, 1), !i && !(r < 0 && !s) && (c || s || !l) && (se(this, c === l && r >= 0 ? "onComplete" : "onReverseComplete", !0), this._prom && !(c < l && this.timeScale() > 0) && this._prom())));
    }
    return this;
  }, t.add = function(r, i) {
    var n = this;
    if (Ce(i) || (i = he(this, i, r)), !(r instanceof Mt)) {
      if (Z(r))
    ...
    return this !== r ? we(this, r, i) : this;
  }, t.getChildren = function(r, i, n, s) {
    r === void 0 && (r = !0), i === void 0 && (i = !0), n === void 0 && (n = !0), s === void 0 && (s = -pe);
    for (var l = [], d = this._first; d; )
      d._start >= s && (d instanceof V ? i && l.push(d) : (n && l.push(d), r && l.push.apply(l, d.getChildren(!0, i, n)))), d = d._next;
    return l;
    ...
    return J(r) ? this.removeLabel(r) : H(r) ? this.killTweensOf(r) : (r.parent === this && Kt(this, r), r === this._recent && (this._recent = this._last), Ve(this));
  }, t.totalTime = function(r, i) {
    return arguments.length ? (this._forcing = 1, !this._dp && this._ts && (this._start = z(ne.time - (this._ts > 0 ? r / this._ts : (this.totalDuration() - r) / -this._ts))), o.prototype.totalTime.call(this, r, i), this._forcing = 0, this) : this._tTime;
  }, t.addLabel = function(r, i) {
    return this.labels[r] = he(this, i), this;
  }, t.removeLabel = function(r) {
    return delete this.labels[r], this;
  }, t.addPause = function(r, i, n) {
    var s = V.delayedCall(0, i || Tt, n);
    return s.data = "isPause", this._hasPause = 1, we(this, s, he(this, r));
    ...
    for (var n = [], s = me(r), l = this._first, d = Ce(i), c; l; )
      l instanceof V ? Wi(l._targets, s) && (d ? (!Te || l._initted && l._ts) && l.globalTime(0) <= i && l.globalTime(l.totalDuration()) > i : !i || l.isActive()) && n.push(l) : (c = l.getTweensOf(s, i)).length && n.push.apply(n, c), l = l._next;
    return n;
  }, t.tweenTo = function(r, i) {
    i = i || {};
    var n = this, s = he(n, r), l = i, d = l.startAt, c = l.onStart, u = l.onStartParams, p = l.immediateRender, m, g = V.to(n, ce({
      ease: i.ease || "none",
      lazy: !1,
      immediateRender: !1,
      time: s,
      overwrite: "auto",
      duration: i.duration || Math.abs((s - (d && "time" in d ? d.time : n._time)) / n.timeScale()) || I,
      onStart: function() {
        if (n.pause(), !m) {
          var f = i.duration || Math.abs((s - (d && "time" in d ? d.time : n._time)) / n.timeScale());
          g._dur !== f && nt(g, f, 0, 1).render(g._time, !0, !0), m = 1;
        }
        c && c.apply(g, u || []);
      }
    }, i));
    ...
    return r === void 0 && (r = this._time), $a(this, he(this, r));
  }, t.previousLabel = function(r) {
    return r === void 0 && (r = this._time), $a(this, he(this, r), 1);
  }, t.currentLabel = function(r) {
    return arguments.length ? this.seek(r, !0) : this.previousLabel(this._time + I);
    ...
    if (n._dirty) {
      for (u = n.parent; s; )
        d = s._prev, s._dirty && s.totalDuration(), c = s._start, c > l && n._sort && s._ts && !n._lock ? (n._lock = 1, we(n, s, c - s._delay, 1)._lock = 0) : l = c, c < 0 && s._ts && (i -= c, (!u && !n._dp || u && u.smoothChildTiming) && (n._start += z(c / n._ts), n._time -= c, n._tTime -= c), n.shiftChildren(-c, !1, -1 / 0), l = 0), s._end > i && s._ts && (i = s._end), s = d;
      nt(n, n === L && n._time > i ? n._time : i, 1, 1), n._dirty = 0;
    }
    return n._tDur;
  }, e.updateRoot = function(r) {
    if (L._ts && (Hr(L, Wt(r, L)), Br = ne.frame), ne.frame >= Xa) {
      Xa += le.autoSleep || 120;
      var i = L._first;
...
var bn = function(e, t, a, r, i, n, s) {
  var l = new te(this._pt, e, t, 0, 1, pi, null, i), d = 0, c = 0, u, p, m, g, h, f, _, w;
  for (l.b = a, l.e = r, a += "", r += "", (_ = ~r.indexOf("random(")) && (r = Et(r)), n && (w = [a, r], n(w, e, t), a = w[0], r = w[1]), p = a.match(ta) || []; u = ta.exec(r); )
    g = u[0], h = r.substring(d, u.index), m ? m = (m + 1) % 5 : h.substr(-5) === "rgba(" && (m = 1), g !== p[c++] && (f = parseFloat(p[c - 1]) || 0, l._pt = {
      ...
      s: f,
      c: g.charAt(1) === "=" ? et(f, g) - f : parseFloat(g) - f,
      m: m && m < 4 ? Math.round : 0
    }, d = ta.lastIndex);
  return l.c = d < r.length ? r.substring(d, r.length) : "", l.fp = s, (Or.test(r) || _) && (l.e = 0), this._pt = l, l;
}, za = function(e, t, a, r, i, n, s, l, d, c) {
  H(r) && (r = r(i || 0, e, n));
  var u = e[t], p = a !== "get" ? a : H(u) ? d ? e[t.indexOf("set") || !H(e["get" + t.substr(3)]) ? t : "get" + t.substr(3)](d) : e[t]() : u, m = H(u) ? d ? An : ui : Fa, g;
  if (J(r) && (~r.indexOf("random(") && (r = Et(r)), r.charAt(1) === "=" && (g = et(p, r) + (Q(p) || 0), (g || g === 0) && (r = g))), !c || p !== r || xa)
    return !isNaN(p * r) && r !== "" ? (g = new te(this._pt, e, t, +p || 0, r - (p || 0), typeof u == "boolean" ? Cn : hi, 0, m), d && (g.fp = d), s && g.modifier(s, this, e), this._pt = g) : (!u && !(t in e) && Ia(t, r), bn.call(this, e, t, p, r, m, l || le.stringFilter, d));
}, _n = function(e, t, a, r, i) {
  if (H(e) && (e = At(e, i, t, a, r)), !_e(e) || e.style && e.nodeType || Z(e) || Rr(e))
    return J(e) ? At(e, i, t, a, r) : e;
  var n = {}, s;
  for (s in e)
    n[s] = At(e[s], i, t, a, r);
  return n;
}, li = function(e, t, a, r, i, n) {
  var s, l, d, c;
  if (ie[e] && (s = new ie[e]()).init(i, s.rawVars ? t[e] : _n(t[e], r, i, n, a), a, r, n) !== !1 && (a._pt = l = new te(a._pt, i, e, 0, 1, s.render, s, 0, s.priority), a !== $e))
    for (d = a._ptLookup[a._targets.indexOf(i)], c = s._props.length; c--; )
      d[s._props[c]] = l;
  return s;
}, Te, xa, La = function o(e, t, a) {
  var r = e.vars, i = r.ease, n = r.startAt, s = r.immediateRender, l = r.lazy, d = r.onUpdate, c = r.runBackwards, u = r.yoyoEase, p = r.keyframes, m = r.autoRevert, g = e._dur, h = e._startAt, f = e._targets, _ = e.parent, w = _ && _.data === "nested" ? _.vars.targets : f, x = e._overwrite === "auto" && !Ta, y = e.timeline, b = r.easeReverse || u, S, A, C, k, T, G, B, N, q, W, j, U, ue;
  if (y && (!p || !i) && (i = "none"), e._ease = je(i, Ct.ease), e._rEase = b && (je(b) || e._ease), e._from = !y && !!r.runBackwards, e._from && (e.ratio = 1), !y || p && !r.stagger) {
    if (N = f[0] ? Ye(f[0]).harness : 0, U = N && r[N.prop], S = jt(r, Na), h && (h._zTime < 0 && h.progress(1), t < 0 && c && s && !m ? h.render(-1, !0) : h.revert(c && g ? Ht : Vi), h._lazy = 0), n) {
      if (Ne(e._startAt = V.set(f, ce({
        data: "isStart",
        overwrite: !1,
        parent: _,
        immediateRender: !0,
        ...
        stagger: 0
      }, n))), e._startAt._dp = 0, e._startAt._sat = e, t < 0 && (X || !s && !m) && e._startAt.revert(Ht), s && g && t <= 0 && a <= 0) {
        t && (e._zTime = t);
        return;
      }
    } else if (c && g && !h) {
      ...
      }, S), U && (C[N.prop] = U), Ne(e._startAt = V.set(f, C)), e._startAt._dp = 0, e._startAt._sat = e, t < 0 && (X ? e._startAt.revert(Ht) : e._startAt.render(-1, !0)), e._zTime = t, !s)
        o(e._startAt, I, I);
      else if (!t)
        return;
    }
    for (e._pt = e._ptCache = 0, l = g && $(l) || l && !g, A = 0; A < f.length; A++) {
      if (T = f[A], B = T._gsap || Da(f)[A]._gsap, e._ptLookup[A] = W = {}, ma[B.id] && Me.length && Vt(), j = w === f ? A : w.indexOf(T), N && (q = new N()).init(T, U || S, e, j, w) !== !1 && (e._pt = k = new te(e._pt, T, q.name, 0, 1, q.render, q, 0, q.priority), q._props.forEach(function(Xe) {
        W[Xe] = k;
      }), q.priority && (G = 1)), !N || U)
        for (C in S)
          ie[C] && (q = li(C, S, e, j, T, w)) ? q.priority && (G = 1) : W[C] = k = za.call(e, T, C, "get", S[C], j, w, 0, r.stringFilter);
      e._op && e._op[A] && e.kill(T, e._op[A]), x && e._pt && (Te = e, L.killTweensOf(T, W, e.globalTime(t)), ue = !e.parent, Te = 0), e._pt && l && (ma[B.id] = 1);
    }
    G && mi(e), e._onInit && e._onInit(e);
  }
  e._onUpdate = d, e._initted = (!e._op || e._pt) && !ue, p && t <= 0 && y.render(pe, !0, !0);
}, xn = function(e, t, a, r, i, n, s, l) {
    ...
    for (d = e._ptCache[t] = [], p = e._ptLookup, m = e._targets.length; m--; ) {
      if (c = p[m][t], c && c.d && c.d._pt)
        for (c = c.d._pt; c && c.p !== t && c.fp !== t; )
          c = c._next;
      if (!c)
        return xa = 1, e.vars[t] = "+=0", La(e, s), xa = 0, l ? St(t + " not eligible for reset. Try splitting into individual properties") : 1;
      d.push(c);
    }
  for (m = d.length; m--; )
    u = d[m], c = u._pt || u, c.s = (r || r === 0) && !i ? r : c.s + (r || 0) + n * c.c, c.c = a - c.s, u.e && (u.e = Y(a) + Q(u.e)), u.b && (u.b = c.s + Q(u.b));
}, yn = function(e, t) {
  var a = e[0] ? Ye(e[0]).harness : 0, r = a && a.aliases, i, n, s, l;
  if (!r)
    return t;
  i = rt({}, t);
  for (n in r)
...
}, At = function(e, t, a, r, i) {
  return H(e) ? e.call(t, a, r, i) : J(e) && ~e.indexOf("random(") ? Et(e) : e;
}, di = Ra + "repeat,repeatDelay,yoyo,repeatRefresh,yoyoEase,easeReverse,autoRevert", ci = {};
ee(di + ",id,stagger,delay,duration,paused,scrollTrigger", function(o) {
  return ci[o] = 1;
});
var V = /* @__PURE__ */ (function(o) {
  ...
  function e(a, r, i, n) {
    var s;
    typeof r == "number" && (i.duration = r, r = i, i = null), s = o.call(this, n ? r : yt(r)) || this;
    var l = s.vars, d = l.duration, c = l.delay, u = l.immediateRender, p = l.stagger, m = l.overwrite, g = l.keyframes, h = l.defaults, f = l.scrollTrigger, _ = r.parent || L, w = (Z(a) || Rr(a) ? Ce(a[0]) : "length" in r) ? [a] : me(a), x, y, b, S, A, C, k, T;
    if (s._targets = w.length ? Da(w) : St("GSAP target " + a + " not found. https://gsap.com", !le.nullTargetWarn) || [], s._ptLookup = [], s._overwrite = m, g || p || Dt(d) || Dt(c)) {
      r = s.vars;
      var G = r.easeReverse || r.yoyoEase;
      if (x = s.timeline = new K({
        data: "nested",
        defaults: h || {},
        targets: _ && _.data === "nested" ? _.vars.targets : w
      }), x.kill(), x.parent = x._dp = ve(s), x._start = 0, p || Dt(d) || Dt(c)) {
        if (S = w.length, k = p && Qr(p), _e(p))
          for (A in p)
            ~di.indexOf(A) && (T || (T = {}), T[A] = p[A]);
        for (y = 0; y < S; y++)
          b = jt(r, ci), b.stagger = 0, G && (b.easeReverse = G), T && rt(b, T), C = w[y], b.duration = +At(d, ve(s), y, C, w), b.delay = (+At(c, ve(s), y, C, w) || 0) - s._delay, !p && S === 1 && b.delay && (s._delay = c = b.delay, s._start += c, b.delay = 0), x.to(C, b, k ? k(y, C, w) : 0), x._ease = E.none;
        x.duration() ? d = c = 0 : s.timeline = 0;
      } else if (g) {
        yt(ce(x.vars.defaults, {
          ease: "none"
        ...
        if (Z(g))
          ...
          b = {};
          for (A in g)
            A === "ease" || A === "easeEach" || vn(A, g[A], b, g.easeEach);
          for (A in b)
            for (N = b[A].sort(function(j, U) {
              return j.t - U.t;
            }), B = 0, y = 0; y < N.length; y++)
              q = N[y], W = {
                ease: q.e,
                duration: (q.t - (y ? N[y - 1].t : 0)) / 100 * d
              }, W[A] = q.v, x.to(w, W, B), B += W.duration;
          x.duration() < d && x.to({}, {
      ...
      s.timeline = 0;
    return m === !0 && !Ta && (Te = ve(s), L.killTweensOf(w), Te = 0), we(_, ve(s), i), r.reversed && s.reverse(), r.paused && s.paused(!0), (u || !d && !g && s._start === z(_._time) && $(u) && Zi(ve(s)) && _.data !== "nested") && (s._tTime = -I, s.render(Math.max(0, -c) || 0)), f && jr(ve(s), f), s;
  }
  var t = e.prototype;
  return t.render = function(r, i, n) {
    var s = this._time, l = this._tDur, d = this._dur, c = r < 0, u = r > l - I && !c ? l : r < I ? 0 : r, p, m, g, h, f, _, w, x;
    if (!d)
      $i(this, r, i, n);
      ...
      if (p = u, x = this.timeline, this._repeat) {
        ...
        if (p = z(u % h), u === l ? (g = this._repeat, p = d) : (f = z(u / h), g = ~~f, g && g === f ? (p = d, g--) : p > d && (p = d)), _ = this._yoyo && g & 1, _ && (p = d - p), f = it(this._tTime, h), p === s && !n && this._initted && g === f)
          return this._tTime = u, this;
        g !== f && this.vars.repeatRefresh && !_ && !this._lock && p !== h && this._initted && (this._lock = n = 1, this.render(z(h * g), !0).invalidate()._lock = 0);
      }
      if (!this._initted) {
        if (Wr(this, c ? r : p, n, i, u))
      ...
      if (this._from && (this.ratio = w = 1 - w), this._tTime = u, this._time = p, !this._act && this._ts && (this._act = 1, this._lazy = 0), !s && u && !i && !f && (se(this, "onStart"), this._tTime !== u))
        return this;
      for (m = this._pt; m; )
        m.r(w, m.d), m = m._next;
      x && x.render(r < 0 ? r : x._dur * x._ease(p / this._dur), i, n) || this._startAt && (this._zTime = r), this._onUpdate && !i && (c && ga(this, r, i, n), se(this, "onUpdate")), this._repeat && g !== f && this.vars.onRepeat && !i && this.parent && se(this, "onRepeat"), (u === this._tDur || !u) && this._tTime === u && (c && !this._onUpdate && ga(this, r, !0, !0), (r || !d) && (u === this._tDur && this._ts > 0 || !u && this._ts < 0) && Ne(this, 1), !i && !(c && !s) && (u || s || _) && (se(this, u === l ? "onComplete" : "onReverseComplete", !0), this._prom && !(u < l && this.timeScale() > 0) && this._prom()));
    }
    return this;
  }, t.targets = function() {
    ...
    Pt || ne.wake(), this._ts || this.play();
    var d = Math.min(this._dur, (this._dp._time - this._start) * this._ts), c;
    return this._initted || La(this, d), c = this._ease(d / this._dur), xn(this, r, i, n, s, c, d, l) ? this.resetTo(r, i, n, s, 1) : (ea(this, 0), this.parent || Yr(this._dp, this, "_first", "_last", this._dp._sort ? "_start" : 0), this.render(0));
  }, t.kill = function(r, i) {
    if (i === void 0 && (i = "all"), !r && (!i || i === "all"))
      return this._lazy = this._pt = 0, this.parent ? bt(this) : this.scrollTrigger && this.scrollTrigger.kill(!!X), this;
    if (this.timeline) {
      var n = this.timeline.totalDuration();
      return this.timeline.killTweensOf(r, i, Te && Te.vars.overwrite !== !0)._first || bt(this), this.parent && n !== this.timeline.totalDuration() && nt(this, this._dur * this.timeline._tDur / n, 0, 1), this;
    }
    var s = this._targets, l = r ? me(r) : s, d = this._ptLookup, c = this._pt, u, p, m, g, h, f, _;
    if ((!i || i === "all") && Xi(s, l))
      return i === "all" && (this._pt = 0), bt(this);
    for (u = this._op = this._op || [], i !== "all" && (J(i) && (h = {}, ee(i, function(w) {
      return h[w] = 1;
    }), i = h), i = yn(s, i)), _ = s.length; _--; )
      if (~l.indexOf(s[_])) {
        p = d[_], i === "all" ? (u[_] = i, g = p, m = {}) : (m = u[_] = u[_] || {}, g = i);
        for (h in g)
          f = p && p[h], f && ((!("kill" in f.d) || f.d.kill(h) === !0) && Kt(this, f, "_pt"), delete p[h]), m !== "all" && (m[h] = 1);
      }
...
ee("staggerTo,staggerFrom,staggerFromTo", function(o) {
  V[o] = function() {
    var e = new K(), t = wa.call(arguments, 0);
...
var Fa = function(e, t, a) {
  ...
  return H(e[t]) ? ui : Ea(e[t]) && e.setAttribute ? kn : Fa;
}, hi = function(e, t) {
  ...
  for (var t = this._pt, a, r; t; )
    r = t._next, t.p === e && !t.op || t.op === e ? Kt(this, t, "_pt") : t.dep || (a = 1), t = r;
  return !a;
}, En = function(e, t, a, r) {
  ...
  function o(t, a, r, i, n, s, l, d, c) {
    this.t = a, this.s = i, this.c = n, this.p = r, this.r = s || hi, this.d = l || this, this.set = d || Fa, this.pr = c || 0, this._next = t, t && (t._prev = this);
  }
  var e = o.prototype;
  return e.modifier = function(a, r, i) {
    this.mSet = this.mSet || this.set, this.set = En, this.m = a, this.mt = i, this.tween = r;
  }, o;
})();
ee(Ra + "parent,duration,ease,delay,overwrite,runBackwards,startAt,yoyo,immediateRender,repeat,repeatDelay,data,paused,reversed,lazy,callbackScope,stringFilter,id,yoyoEase,stagger,inherit,repeatRefresh,keyframes,autoRevert,scrollTrigger,easeReverse", function(o) {
  return Na[o] = 1;
});
de.TweenMax = de.TweenLite = V;
...
le.stringFilter = ni;
var We = [], Ut = {}, Pn = [], tr = 0, Mn = 0, sa = function(e) {
  return (Ut[e] || Pn).map(function(t) {
    return t();
  });
}, ya = function() {
  var e = Date.now(), t = [];
  e - tr > 2 && (sa("matchMediaInit"), We.forEach(function(a) {
    var r = a.queries, i = a.conditions, n, s, l, d;
    for (s in r)
      n = fe.matchMedia(r[s]).matches, n && (l = 1), n !== i[s] && (i[s] = n, d = 1);
    d && (a.revert(), l && t.push(a));
  }), sa("matchMediaRevert"), t.forEach(function(a) {
  ...
  function o(t, a) {
    this.selector = a && ba(a), this.data = [], this._r = [], this.isReverted = !1, this.id = Mn++, t && this.add(t);
  }
  var e = o.prototype;
  return e.add = function(a, r, i) {
    ...
    var n = this, s = function() {
      ...
      return d && d !== n && d.data.push(n), i && (n.selector = ba(i)), R = n, u = r.apply(n, arguments), H(u) && n._r.push(u), R = d, n.selector = c, n.isReverted = !1, u;
    };
    ...
    return this.data.forEach(function(r) {
      return r instanceof o ? a.push.apply(a, r.getTweens()) : r instanceof V && !(r.parent && r.parent.data === "nested") && a.push(r);
    }), a;
  }, e.clear = function() {
    ...
    if (a ? (function() {
      ...
      for (s.map(function(c) {
        ...
        d = i.data[l], d instanceof K ? d.data !== "nested" && (d.scrollTrigger && d.scrollTrigger.revert(), d.kill()) : !(d instanceof V) && d.revert && d.revert(a);
  ...
  return e.add = function(a, r, i) {
    ...
    var n = new gi(0, i || this.scope), s = n.conditions = {}, l, d, c;
    R && !n.selector && (n.selector = R.selector), this.contexts.push(n), r = n.add("onMatch", r), n.queries = a;
    for (d in a)
      d === "all" ? c = 1 : (l = fe.matchMedia(a[d]), l && (We.indexOf(n) < 0 && We.push(n), (s[d] = l.matches) && (c = 1), l.addListener ? l.addListener(ya) : l.addEventListener("change", ya)));
  ...
  quickSetter: function(e, t, a) {
    ...
    e = e[0] || {};
    var n = ie[t], s = Ye(e), l = s.harness && (s.harness.aliases || {})[t] || t, d = n ? function(c) {
      var u = new n();
      $e._pt = 0, u.init(e, a ? c + a : c, $e, 0, [e]), u.render(1, u), $e._pt && qa(1, $e);
    } : s.set(e, l);
  ...
  defaults: function(e) {
    return e && e.ease && (e.ease = je(e.ease, Ct.ease)), Qa(Ct, e || {});
  },
  config: function(e) {
    return Qa(le, e || {});
  },
  registerEffect: function(e) {
    ...
    (r || "").split(",").forEach(function(s) {
      return s && !ie[s] && !de[s] && St(t + " effect requires " + s + " plugin.");
    }), aa[t] = function(s, l, d) {
      return a(me(s), ce(l || {}, i), d);
    }, n && (K.prototype[t] = function(s, l, d) {
      return this.add(aa[t](s, _e(l) ? l : (d = l) && {}, this), d);
    });
  },
  ...
  parseEase: function(e, t) {
    return arguments.length ? je(e, t) : E;
  },
  getById: function(e) {
    return L.getById(e);
  },
  exportRoot: function(e, t) {
    e === void 0 && (e = {});
    var a = new K(e), r, i;
    for (a.smoothChildTiming = $(e.smoothChildTiming), L.remove(a), a._dp = 0, a._time = a._tTime = L._time, r = L._first; r; )
      i = r._next, (t || !(!r._dur && r instanceof V && r.vars.onComplete === r._targets[0])) && we(a, r, r._start - r._delay), r = i;
    return we(L, a, 0), a;
  },
  context: function(e, t) {
    return e ? new gi(e, t) : R;
  },
...
var Nn = function(e, t) {
  ...
  for (r in t)
    for (i = a.length; i--; )
      n = e._ptLookup[i][r], n && (n = n.d) && (n._pt && (n = Nn(n, r)), n && n.modifier && n.modifier(t[r], e, a[i], r));
}, oa = function(e, t) {
  return {
    name: e,
    headless: 1,
...
}, oa("roundProps", _a), oa("modifiers"), oa("snap", Zr)) || Jt;
V.version = K.version = re.version = "3.15.0";
zr = 1;
Pa() && st();
E.Power0;
E.Power1;
...
E.Expo;
E.Circ;
var ar, Ee, tt, Ha, Ue, rr, Ga, Dn = function() {
  return typeof window < "u";
}, Se = {}, He = 180 / Math.PI, at = Math.PI / 180, Qe = Math.atan2, ir = 1e8, Ua = /([A-Z])/g, On = /(left|right|width|margin|padding|x)/i, zn = /[\s,\(]\S/, be = {
  ...
  if (e in Se && i) {
    ...
    if (this.props.indexOf(F) >= 0)
      return;
    n.svg && (this.svgo = r.getAttribute("data-svg-origin"), this.props.push(ae, t, "")), e = F;
  }
  ...
  for (i = 0; i < e.length; i += 3)
    e[i + 1] ? e[i + 1] === 2 ? t[e[i]](e[i + 2]) : t[e[i]] = e[i + 2] : e[i + 2] ? a[e[i]] = e[i + 2] : a.removeProperty(e[i].substr(0, 2) === "--" ? e[i] : e[i].replace(Ua, "-$1").toLowerCase());
  if (this.tfm) {
    for (n in this.tfm)
      r[n] = this.tfm[n];
    r.svg && (r.renderTransform(), t.setAttribute("data-svg-origin", this.svgo || "")), i = Ga(), (!i || !i.isStart) && !a[F] && (bi(a), r.zOrigin && a[ae] && (a[ae] += " " + r.zOrigin + "px", r.zOrigin = 0, r.renderTransform()), r.uncache = 1);
  }
}, _i = function(e, t) {
  var a = {
    target: e,
  ...
  return r[t] || r.getPropertyValue(t.replace(Ua, "-$1").toLowerCase()) || r.getPropertyValue(t) || !a && o(e, ot(t) || t, 1) || "";
}, nr = "O,Moz,ms,Ms,Webkit".split(","), ot = function(e, t, a) {
  var r = t || Ue, i = r.style, n = 5;
  if (e in i && !a)
    return e;
  for (e = e.charAt(0).toUpperCase() + e.substr(1); n-- && !(nr[n] + e in i); )
    ;
  return n < 0 ? null : (n === 3 ? "ms" : n >= 0 ? nr[n] : "") + e;
}, ka = function() {
  Dn() && window.document && (ar = window, Ee = ar.document, tt = Ee.documentElement, Ue = Aa("div") || {
    style: {}
  }, Aa("div"), F = ot(F), ae = F + "Origin", Ue.style.cssText = "border-width:0;line-height:0;position:absolute;padding:0", xi = !!ot("perspective"), Ga = re.core.reverting, Ha = 1);
}, sr = function(e) {
  var t = e.ownerSVGElement, a = Aa("svg", t && t.getAttribute("xmlns") || "http://www.w3.org/2000/svg"), r = e.cloneNode(!0), i;
  r.style.display = "block", a.appendChild(r), tt.appendChild(a);
  try {
    i = r.getBBox();
  } catch {
  }
  return a.removeChild(r), tt.removeChild(a), i;
}, or = function(e, t) {
  for (var a = t.length; a--; )
  ...
  return t && (t.width || t.height) || a || (t = sr(e)), t && !t.width && !t.x && !t.y ? {
    x: +or(e, ["x", "cx", "x1"]) || 0,
    y: +or(e, ["y", "cy", "y1"]) || 0,
    width: 0,
    height: 0
  ...
  if (t) {
    var a = e.style, r;
    t in Se && t !== ae && (t = F), a.removeProperty ? (r = t.substr(0, 2), (r === "ms" || t.substr(0, 6) === "webkit") && (t = "-" + t), a.removeProperty(r === "--" ? t : t.replace(Ua, "-$1").toLowerCase())) : a.removeAttribute(t);
  }
}, Pe = function(e, t, a, r, i, n) {
  var s = new te(e._pt, t, a, 0, 1, n ? wi : fi);
  ...
  grid: 1,
  flex: 1
}, De = function o(e, t, a, r) {
  var i = parseFloat(a) || 0, n = (a + "").trim().substr((i + "").length) || "px", s = Ue.style, l = On.test(t), d = e.tagName.toLowerCase() === "svg", c = (d ? "client" : "offset") + (l ? "Width" : "Height"), u = 100, p = r === "px", m = r === "%", g, h, f, _;
  if (r === n || !i || lr[r] || lr[n])
    return i;
  if (n !== "px" && !p && (i = o(e, t, a, "px")), _ = e.getCTM && vi(e), (m || n === "%") && (Se[t] || ~t.indexOf("adius")))
    return g = _ ? e.getBBox()[l ? "width" : "height"] : e[c], Y(m ? i / g * u : i / 100 * g);
  if (s[l ? "width" : "height"] = u + (p ? n : r), h = r !== "rem" && ~t.indexOf("adius") || r === "em" && e.appendChild && !d ? e : e.parentNode, _ && (h = (e.ownerSVGElement || {}).parentNode), (!h || h === Ee || !h.appendChild) && (h = Ee.body), f = h._gsap, f && m && f.width && l && f.time === ne.time && !f.uncache)
    return Y(i / f.width * u);
  if (m && (t === "height" || t === "width")) {
    var w = e.style[t];
    e.style[t] = u + r, g = e[c], w ? e.style[t] = w : Re(e, t);
  } else
    (m || n === "%") && !Xn[oe(h, "display")] && (s.position = oe(e, "position")), h === e && (s.position = "static"), h.appendChild(Ue), g = Ue[c], h.removeChild(Ue), s.position = "absolute";
  return l && m && (f = Ye(h), f.time = ne.time, f.width = h[c]), Y(p ? g * i / u : g && i ? u / g * i : 0);
}, Ae = function(e, t, a, r) {
  var i;
  return Ha || ka(), t in be && t !== "transform" && (t = be[t], ~t.indexOf(",") && (t = t.split(",")[0])), Se[t] && t !== "transform" ? (i = Nt(e, r), i = t !== "transformOrigin" ? i[t] : i.svg ? i.origin : Qt(oe(e, ae)) + " " + i.zOrigin + "px") : (i = e.style[t], (!i || i === "auto" || r || ~(i + "").indexOf("calc(")) && (i = Xt[t] && Xt[t](e, t, a) || oe(e, t) || qr(e, t) || (t === "opacity" ? 1 : 0))), a && !~(i + "").trim().indexOf(" ") ? De(e, t, i, a) + a : i;
}, Qn = function(e, t, a, r) {
  if (!a || a === "none") {
    var i = ot(t, e, 1), n = i && oe(e, i, 1);
    n && n !== a ? (t = i, a = n) : t === "borderColor" && (a = oe(e, "borderTopColor"));
  }
  var s = new te(this._pt, e.style, t, 0, 1, pi), l = 0, d = 0, c, u, p, m, g, h, f, _, w, x, y, b;
  if (s.b = a, s.e = r, a += "", r += "", r.substring(0, 6) === "var(--" && (r = oe(e, r.substring(4, r.indexOf(")")))), r === "auto" && (h = e.style[t], e.style[t] = r, r = oe(e, t) || r, h ? e.style[t] = h : Re(e, t)), c = [a, r], ni(c), a = c[0], r = c[1], p = a.match(Ke) || [], b = r.match(Ke) || [], b.length) {
    for (; u = Ke.exec(r); )
      f = u[0], w = r.substring(l, u.index), g ? g = (g + 1) % 5 : (w.substr(-5) === "rgba(" || w.substr(-5) === "hsla(") && (g = 1), f !== (h = p[d++] || "") && (m = parseFloat(h) || 0, y = h.substr((m + "").length), f.charAt(1) === "=" && (f = et(m, f) + y), _ = parseFloat(f), x = f.substr((_ + "").length), l = Ke.lastIndex - x.length, x || (x = x || le.units[t] || y, l === r.length && (r += x, s.e += x)), y !== x && (m = De(e, t, h, x) || 0), s._pt = {
        _next: s._pt,
        p: w || d === 1 ? w : ",",
        //note: SVG spec allows omission of comma/space when a negative sign is wedged between two numbers, like 2.5-5.3 instead of 2.5,-5.3 but when tweening, the negative value may switch to positive, so we insert the comma just in case.
        s: m,
    ...
    s.r = t === "display" && r === "none" ? wi : fi;
  return Or.test(r) && (s.e = 0), this._pt = s, s;
}, dr = {
  top: "0%",
  bottom: "100%",
  left: "0%",
  ...
  return (a === "top" || a === "bottom" || r === "left" || r === "right") && (e = a, a = r, r = e), t[0] = dr[a] || a, t[1] = dr[r] || r, t.join(" ");
}, Kn = function(e, t) {
  if (t.tween && t.tween._time === t.tween._dur) {
    ...
    if (i === "all" || i === !0)
      ...
      for (i = i.split(","), d = i.length; --d > -1; )
        s = i[d], Se[s] && (l = 1, s = s === "transformOrigin" ? ae : F), Re(a, s);
    l && (Re(a, F), n && (n.svg && a.removeAttribute("transform"), r.scale = r.rotate = r.translate = "none", Nt(a, 1), n.uncache = 1, bi(r)));
  }
}, Xt = {
  clearProps: function(e, t, a, r, i) {
    if (i.data !== "isFromStart") {
      var n = e._pt = new te(e._pt, t, a, 0, 0, Kn);
  ...
  */
}, It = [1, 0, 0, 1, 0, 0], Ai = {}, ki = function(e) {
  return e === "matrix(1, 0, 0, 1, 0, 0)" || e === "none" || !e;
}, cr = function(e) {
  var t = oe(e, F);
  return ki(t) ? It : t.substr(7).match(Dr).map(Y);
}, Ya = function(e, t) {
  var a = e._gsap || Ye(e), r = e.style, i = cr(e), n, s, l, d;
  return a.svg && e.getAttribute("transform") ? (l = e.transform.baseVal.consolidate().matrix, i = [l.a, l.b, l.c, l.d, l.e, l.f], i.join(",") === "1,0,0,1,0,0" ? It : i) : (i === It && !e.offsetParent && e !== tt && !a.svg && (l = r.display, r.display = "block", n = e.parentNode, (!n || !e.offsetParent && !e.getBoundingClientRect().width) && (d = 1, s = e.nextElementSibling, tt.appendChild(e)), i = cr(e), l ? r.display = l : Re(e, "display"), d && (s ? n.insertBefore(e, s) : n ? n.appendChild(e) : tt.removeChild(e))), t && i.length > 6 ? [i[0], i[1], i[4], i[5], i[12], i[13]] : i);
}, Ca = function(e, t, a, r, i, n) {
  var s = e._gsap, l = i || Ya(e, !0), d = s.xOrigin || 0, c = s.yOrigin || 0, u = s.xOffset || 0, p = s.yOffset || 0, m = l[0], g = l[1], h = l[2], f = l[3], _ = l[4], w = l[5], x = t.split(" "), y = parseFloat(x[0]) || 0, b = parseFloat(x[1]) || 0, S, A, C, k;
  a ? l !== It && (A = m * f - g * h) && (C = y * (f / A) + b * (-h / A) + (h * w - f * _) / A, k = y * (-g / A) + b * (m / A) - (m * w - g * _) / A, y = C, b = k) : (S = yi(e), y = S.x + (~x[0].indexOf("%") ? y / 100 * S.width : y), b = S.y + (~(x[1] || x[0]).indexOf("%") ? b / 100 * S.height : b)), r || r !== !1 && s.smooth ? (_ = y - d, w = b - c, s.xOffset = u + (_ * m + w * h) - _, s.yOffset = p + (_ * g + w * f) - w) : s.xOffset = s.yOffset = 0, s.xOrigin = y, s.yOrigin = b, s.smooth = !!r, s.origin = t, s.originIsAbsolute = !!a, e.style[ae] = "0px 0px", n && (Pe(n, s, "xOrigin", d, y), Pe(n, s, "yOrigin", c, b), Pe(n, s, "xOffset", u, s.xOffset), Pe(n, s, "yOffset", p, s.yOffset)), e.setAttribute("data-svg-origin", y + " " + b);
}, Nt = function(e, t) {
  var a = e._gsap || new oi(e);
  if ("x" in a && !t && !a.uncache)
    return a;
  var r = e.style, i = a.scaleX < 0, n = "px", s = "deg", l = getComputedStyle(e), d = oe(e, ae) || "0", c, u, p, m, g, h, f, _, w, x, y, b, S, A, C, k, T, G, B, N, q, W, j, U, ue, Xe, lt, dt, ze, Wa, xe, Le;
  return c = u = p = h = f = _ = w = x = y = 0, m = g = 1, a.svg = !!(e.getCTM && vi(e)), l.translate && ((l.translate !== "none" || l.scale !== "none" || l.rotate !== "none") && (r[F] = (l.translate !== "none" ? "translate3d(" + (l.translate + " 0 0").split(" ").slice(0, 3).join(", ") + ") " : "") + (l.rotate !== "none" ? "rotate(" + l.rotate + ") " : "") + (l.scale !== "none" ? "scale(" + l.scale.split(" ").join(",") + ") " : "") + (l[F] !== "none" ? l[F] : "")), r.scale = r.rotate = r.translate = "none"), A = Ya(e, a.svg), a.svg && (a.uncache ? (ue = e.getBBox(), d = a.xOrigin - ue.x + "px " + (a.yOrigin - ue.y) + "px", U = "") : U = !t && e.getAttribute("data-svg-origin"), Ca(e, U || d, !!U || a.originIsAbsolute, a.smooth !== !1, A)), b = a.xOrigin || 0, S = a.yOrigin || 0, A !== It && (G = A[0], B = A[1], N = A[2], q = A[3], c = W = A[4], u = j = A[5], A.length === 6 ? (m = Math.sqrt(G * G + B * B), g = Math.sqrt(q * q + N * N), h = G || B ? Qe(B, G) * He : 0, w = N || q ? Qe(N, q) * He + h : 0, w && (g *= Math.abs(Math.cos(w * at))), a.svg && (c -= b - (b * G + S * N), u -= S - (b * B + S * q))) : (Le = A[6], Wa = A[7], lt = A[8], dt = A[9], ze = A[10], xe = A[11], c = A[12], u = A[13], p = A[14], C = Qe(Le, ze), f = C * He, C && (k = Math.cos(-C), T = Math.sin(-C), U = W * k + lt * T, ue = j * k + dt * T, Xe = Le * k + ze * T, lt = W * -T + lt * k, dt = j * -T + dt * k, ze = Le * -T + ze * k, xe = Wa * -T + xe * k, W = U, j = ue, Le = Xe), C = Qe(-N, ze), _ = C * He, C && (k = Math.cos(-C), T = Math.sin(-C), U = G * k - lt * T, ue = B * k - dt * T, Xe = N * k - ze * T, xe = q * T + xe * k, G = U, B = ue, N = Xe), C = Qe(B, G), h = C * He, C && (k = Math.cos(C), T = Math.sin(C), U = G * k + B * T, ue = W * k + j * T, B = B * k - G * T, j = j * k - W * T, G = U, W = ue), f && Math.abs(f) + Math.abs(h) > 359.9 && (f = h = 0, _ = 180 - _), m = Y(Math.sqrt(G * G + B * B + N * N)), g = Y(Math.sqrt(j * j + Le * Le)), C = Qe(W, j), w = Math.abs(C) > 2e-4 ? C * He : 0, y = xe ? 1 / (xe < 0 ? -xe : xe) : 0), a.svg && (U = e.getAttribute("transform"), a.forceCSS = e.setAttribute("transform", "") || !ki(oe(e, F)), U && e.setAttribute("transform", U))), Math.abs(w) > 90 && Math.abs(w) < 270 && (i ? (m *= -1, w += h <= 0 ? 180 : -180, h += h <= 0 ? 180 : -180) : (g *= -1, w += w <= 0 ? 180 : -180)), t = t || a.uncache, a.x = c - ((a.xPercent = c && (!t && a.xPercent || (Math.round(e.offsetWidth / 2) === Math.round(-c) ? -50 : 0))) ? e.offsetWidth * a.xPercent / 100 : 0) + n, a.y = u - ((a.yPercent = u && (!t && a.yPercent || (Math.round(e.offsetHeight / 2) === Math.round(-u) ? -50 : 0))) ? e.offsetHeight * a.yPercent / 100 : 0) + n, a.z = p + n, a.scaleX = Y(m), a.scaleY = Y(g), a.rotation = Y(h) + s, a.rotationX = Y(f) + s, a.rotationY = Y(_) + s, a.skewX = w + s, a.skewY = x + s, a.transformPerspective = y + n, (a.zOrigin = parseFloat(d.split(" ")[2]) || !t && a.zOrigin || 0) && (r[ae] = Qt(d)), a.xOffset = a.yOffset = 0, a.force3D = le.force3D, a.renderTransform = a.svg ? es : xi ? Ci : $n, a.uncache = 0, a;
}, Qt = function(e) {
  return (e = e.split(" "))[0] + " " + e[1];
}, la = function(e, t, a) {
  var r = Q(t);
  return Y(parseFloat(t) + parseFloat(De(e, "x", a + "px", r))) + r;
}, $n = function(e, t) {
  t.z = "0px", t.rotationY = t.rotationX = "0deg", t.force3D = 0, Ci(e, t);
}, Fe = "0deg", ct = "0px", Be = ") ", Ci = function(e, t) {
  var a = t || this, r = a.xPercent, i = a.yPercent, n = a.x, s = a.y, l = a.z, d = a.rotation, c = a.rotationY, u = a.rotationX, p = a.skewX, m = a.skewY, g = a.scaleX, h = a.scaleY, f = a.transformPerspective, _ = a.force3D, w = a.target, x = a.zOrigin, y = "", b = _ === "auto" && e && e !== 1 || _ === !0;
  if (x && (u !== Fe || c !== Fe)) {
    var S = parseFloat(c) * at, A = Math.sin(S), C = Math.cos(S), k;
    S = parseFloat(u) * at, k = Math.cos(S), n = la(w, n, A * k * -x), s = la(w, s, -Math.sin(S) * -x), l = la(w, l, C * k * -x + x);
  }
  f !== ct && (y += "perspective(" + f + Be), (r || i) && (y += "translate(" + r + "%, " + i + "%) "), (b || n !== ct || s !== ct || l !== ct) && (y += l !== ct || b ? "translate3d(" + n + ", " + s + ", " + l + ") " : "translate(" + n + ", " + s + Be), d !== Fe && (y += "rotate(" + d + Be), c !== Fe && (y += "rotateY(" + c + Be), u !== Fe && (y += "rotateX(" + u + Be), (p !== Fe || m !== Fe) && (y += "skew(" + p + ", " + m + Be), (g !== 1 || h !== 1) && (y += "scale(" + g + ", " + h + Be), w.style[F] = y || "translate(0, 0)";
}, es = function(e, t) {
  var a = t || this, r = a.xPercent, i = a.yPercent, n = a.x, s = a.y, l = a.rotation, d = a.skewX, c = a.skewY, u = a.scaleX, p = a.scaleY, m = a.target, g = a.xOrigin, h = a.yOrigin, f = a.xOffset, _ = a.yOffset, w = a.forceCSS, x = parseFloat(n), y = parseFloat(s), b, S, A, C, k;
  l = parseFloat(l), d = parseFloat(d), c = parseFloat(c), c && (c = parseFloat(c), d += c, l += c), l || d ? (l *= at, d *= at, b = Math.cos(l) * u, S = Math.sin(l) * u, A = Math.sin(l - d) * -p, C = Math.cos(l - d) * p, d && (c *= at, k = Math.tan(d - c), k = Math.sqrt(1 + k * k), A *= k, C *= k, c && (k = Math.tan(c), k = Math.sqrt(1 + k * k), b *= k, S *= k)), b = Y(b), S = Y(S), A = Y(A), C = Y(C)) : (b = u, C = p, S = A = 0), (x && !~(n + "").indexOf("px") || y && !~(s + "").indexOf("px")) && (x = De(m, "x", n, "px"), y = De(m, "y", s, "px")), (g || h || f || _) && (x = Y(x + g - (g * b + h * A) + f), y = Y(y + h - (g * S + h * C) + _)), (r || i) && (k = m.getBBox(), x = Y(x + r / 100 * k.width), y = Y(y + i / 100 * k.height)), k = "matrix(" + b + "," + S + "," + A + "," + C + "," + x + "," + y + ")", m.setAttribute("transform", k), w && (m.style[F] = k);
}, ts = function(e, t, a, r, i) {
  var n = 360, s = J(i), l = parseFloat(i) * (s && ~i.indexOf("rad") ? He : 1), d = l - r, c = r + d + "deg", u, p;
  return s && (u = i.split("_")[1], u === "short" && (d %= n, d !== d % (n / 2) && (d += d < 0 ? n : -n)), u === "cw" && d < 0 ? d = (d + n * ir) % n - ~~(d / n) * n : u === "ccw" && d > 0 && (d = (d - n * ir) % n - ~~(d / n) * n)), e._pt = p = new te(e._pt, t, a, r, d, Ln), p.e = c, p.u = "deg", e._props.push(a), p;
}, ur = function(e, t) {
  for (var a in t)
    e[a] = t[a];
  return e;
}, as = function(e, t, a) {
  var r = ur({}, a._gsap), i = "perspective,force3D,transformOrigin,svgOrigin", n = a.style, s, l, d, c, u, p, m, g;
  r.svg ? (d = a.getAttribute("transform"), a.setAttribute("transform", ""), n[F] = t, s = Nt(a, 1), Re(a, F), a.setAttribute("transform", d)) : (d = getComputedStyle(a)[F], n[F] = t, s = Nt(a, 1), n[F] = d);
  for (l in Se)
    d = r[l], c = s[l], d !== c && i.indexOf(l) < 0 && (m = Q(d), g = Q(c), u = m !== g ? De(a, l, d, g) : parseFloat(d), p = parseFloat(c), e._pt = new te(e._pt, s, l, u, p - u, va), e._pt.u = g || 0, e._props.push(l));
  ur(s, r);
};
ee("padding,margin,Width,Radius", function(o, e) {
  ...
  Xt[e > 1 ? "border" + o : o] = function(s, l, d, c, u) {
    var p, m;
...
var Si = {
  ...
  init: function(e, t, a, r, i) {
    var n = this._props, s = e.style, l = a.vars.startAt, d, c, u, p, m, g, h, f, _, w, x, y, b, S, A, C, k;
    Ha || ka(), this.styles = this.styles || _i(e), C = this.styles.props, this.tween = a;
    for (h in t)
      if (h !== "autoRound" && (c = t[h], !(ie[h] && li(h, t, a, r, e, i)))) {
        if (m = typeof c, g = Xt[h], m === "function" && (c = c.call(a, r, e, i), m = typeof c), m === "string" && ~c.indexOf("random(") && (c = Et(c)), g)
          g(this, e, h, c, a) && (A = 1);
        else if (h.substr(0, 2) === "--")
          d = (getComputedStyle(e).getPropertyValue(h) + "").trim(), c += "", Ie.lastIndex = 0, Ie.test(d) || (f = Q(d), _ = Q(c), _ ? f !== _ && (d = De(e, h, d, _) + _) : f && (c += f)), this.add(s, "setProperty", d, c, r, i, 0, 0, h), n.push(h), C.push(h, 0, s[h]);
        else if (m !== "undefined") {
          if (l && h in l ? (d = typeof l[h] == "function" ? l[h].call(a, r, e, i) : l[h], J(d) && ~d.indexOf("random(") && (d = Et(d)), Q(d + "") || d === "auto" || (d += le.units[h] || Q(Ae(e, h)) || ""), (d + "").charAt(1) === "=" && (d = Ae(e, h))) : d = Ae(e, h), p = parseFloat(d), w = m === "string" && c.charAt(1) === "=" && c.substr(0, 2), w && (c = c.substr(2)), u = parseFloat(c), h in be && (h === "autoAlpha" && (p === 1 && Ae(e, "visibility") === "hidden" && u && (p = 0), C.push("visibility", 0, s.visibility), Pe(this, s, "visibility", p ? "inherit" : "hidden", u ? "inherit" : "hidden", !u)), h !== "scale" && h !== "transform" && (h = be[h], ~h.indexOf(",") && (h = h.split(",")[0]))), x = h in Se, x) {
            ...
            if (y || (b = e._gsap, b.renderTransform && !t.parseTransform || Nt(e, t.parseTransform), S = t.smoothOrigin !== !1 && b.smooth, y = this._pt = new te(this._pt, s, F, 0, 1, b.renderTransform, b, 0, -1), y.dep = 1), h === "scale")
              this._pt = new te(this._pt, b, "scaleY", b.scaleY, (w ? et(b.scaleY, w + u) : u) - b.scaleY || 0, va), this._pt.u = 0, n.push("scaleY", h), h += "X";
            else if (h === "transformOrigin") {
              C.push(ae, 0, s[ae]), c = Zn(c), b.svg ? Ca(e, c, 0, S, 0, this) : (_ = parseFloat(c.split(" ")[2]) || 0, _ !== b.zOrigin && Pe(this, b, "zOrigin", b.zOrigin, _), Pe(this, s, h, Qt(d), Qt(c)));
              continue;
            } else if (h === "svgOrigin") {
              Ca(e, c, 1, S, 0, this);
              continue;
            } else if (h in Ai) {
              ts(this, b, h, p, w ? et(p, w + c) : c);
              continue;
          ...
          } else h in s || (h = ot(h) || h);
          if (x || (u || u === 0) && (p || p === 0) && !zn.test(c) && h in s)
            f = (d + "").substr((p + "").length), u || (u = 0), _ = Q(c) || (h in le.units ? le.units[h] : f), f !== _ && (p = De(e, h, d, _)), this._pt = new te(this._pt, x ? b : s, h, p, (w ? et(p, w + u) : u) - p, !x && (_ === "px" || h === "zIndex") && t.autoRound !== !1 ? qn : va), this._pt.u = _ || 0, x && k !== c ? (this._pt.b = d, this._pt.e = k, this._pt.r = Bn) : f !== _ && _ !== "%" && (this._pt.b = d, this._pt.r = Fn);
          else if (h in s)
            Qn.call(this, e, h, d, w ? w + c : c);
          else if (h in e)
            this.add(e, h, d || e[h], w ? w + c : c, r, i);
  ...
  getSetter: function(e, t, a) {
    var r = be[t];
    return r && r.indexOf(",") < 0 && (t = r), t in Se && t !== ae && (e._gsap.x || Ae(e, "x")) ? a && rr === a ? t === "scale" ? Yn : Un : (rr = a || {}) && (t === "scale" ? Vn : jn) : e.style && !Ea(e.style[t]) ? Hn : ~t.indexOf("-") ? Gn : Ba(e, t);
  },
  core: {
    _removeProperty: Re,
    _getMatrix: Ya
...
re.utils.checkPrefix = ot;
re.core.getStyleSaver = _i;
(function(o, e, t, a) {
  var r = ee(o + "," + e + "," + t, function(i) {
    Se[i] = 1;
  });
  ee(e, function(i) {
    le.units[i] = "deg", Ai[i] = 1;
...
re.registerPlugin(Si);
var v = re.registerPlugin(Si) || re;
v.core.Tween;
const rs = [
...
], is = 1.28, P = (o) => Number((o * is).toFixed(3)), ns = {
  duration: P(0.44),
  ease: "back.out(1.7)"
}, hr = {
  startOverlap: "-=0.08",
  ...
  charsPerSecond: kt.labelCharsPerSecond,
...
}, ls = 96, gr = ".wa-cursor-file, .wa-csv-drop", ge = {
  tableRow: {
...
class ds {
  constructor(e) {
    this.root = e, this.chatShell = this.required("[data-chat-shell]"), this.thread = this.required("[data-chat-thread]"), this.composer = this.required("[data-chat-input]"), this.composerText = this.required("[data-composer-text]"), this.signupScene = this.required("[data-signup-scene]"), this.signupEmail = this.required("[data-signup-email]"), this.status = this.root.querySelector("[data-chat-status]"), this.prefersReducedMotion = window.matchMedia?.("(prefers-reduced-motion: reduce)").matches ?? !1, this.root.querySelectorAll("[data-thinking], [data-research-steps], [data-result-grid]").forEach((t) => {
      t.remove();
    }), this.root.querySelectorAll(gr).forEach((t) => {
      t.remove();
    });
  }
  root;
  ...
  showComposer() {
    ...
    return e.to(this.composer, {
      ...
      this.thread,
      {
        paddingBottom: () => Math.max(mr, this.getComposerThreadInset()),
        duration: ye.showDuration,
        ease: "power3.out",
        overwrite: "auto",
  ...
  getSignupScrollOutDistance() {
    ...
    return -Math.max(ut.minScrollOut, Math.round(e * ut.scrollOutRatio));
  }
  stopScrollMotion() {
  ...
  assistantMessage(e) {
    const t = this.claimMessage("assistant", ""), a = t.querySelector("[data-message-body]"), r = v.timeline().add(this.revealMessage(t));
    return a ? r.add(
      this.streamText(a, e, {
        duration: this.getStreamDuration(e, hr),
        targetForScroll: t
      }),
      hr.startOverlap
    ) : r;
  ...
  strategyPlans(e) {
    const t = e.map((i) => this.createStrategyPlan(i)), a = document.createElement("div"), r = t.flatMap((i) => Array.from(i.querySelectorAll(".wa-strategy-plan__row")));
    return a.className = "wa-result-grid has-strategy-plans", a.dataset.strategyPlans = e.map((i) => i.id).join(" "), a.append(...t), v.set(r, { autoAlpha: 0, y: 8 }), this.revealComponentItems("strategy", a, t, ge.strategyCard).to(
      r,
      {
        autoAlpha: 1,
        y: 0,
  ...
  prepareCursorFile(e, t, a = "CSV") {
    ...
    return this.registerTransientElement(r, () => {
      ...
      startFollow: () => v.timeline().call(() => {
        i?.(), i = this.followCursorWithFile(r, t);
      }).to(r, {
        autoAlpha: 1,
        scale: 1,
        duration: P(0.24),
  ...
  revealMessageWithChildren(e, t, a, r = "-=0.22") {
    return v.timeline().add(this.revealMessage(e)).to(t, a, r);
  }
  ...
  claimMessage(e, t) {
    ...
    return this.messageIndex += 1, r.dataset.messageRole = e, r.dataset.messageId = `${e}-${a}`, this.resetMessageClasses(r), r.classList.toggle("wa-message--first-active", a === 0), r.style.display = "none", i && (delete i.dataset.streaming, i.replaceChildren(document.createTextNode(t))), this.thread.append(r), v.set(r, {
      autoAlpha: 0,
      y: 16,
      scale: 0.985,
  ...
  claimComponentMessage(e, t) {
    const a = this.messageIndex, r = this.messagePool[a] ?? this.createMessage(a), i = r.querySelector("[data-message-body]");
    return this.messageIndex += 1, r.dataset.messageRole = "assistant", r.dataset.messageId = `assistant-component-${a}`, this.resetMessageClasses(r), r.classList.toggle("wa-message--first-active", a === 0), r.classList.add("wa-message--component", `wa-message--${e}`), r.style.display = "none", i && (delete i.dataset.streaming, i.replaceChildren(t)), this.thread.append(r), v.set(r, {
      autoAlpha: 0,
      y: 16,
      scale: 0.985,
  ...
  createCsvDropArea(e = {}) {
    ...
    r.className = "wa-csv-drop__copy";
    const i = document.createElement("strong");
    i.textContent = e.title ?? "Drop CSV to clean audience data";
    const n = document.createElement("span");
    return n.textContent = e.detail ?? "Accepts webinar exports, event lists, and messy attendee spreadsheets.", r.append(i, n), t.append(a, r), t;
  }
  revealCsvDropArea(e) {
    return v.timeline().to(
      {},
  ...
  followCursorWithFile(e, t) {
    const a = e.offsetWidth || 154, r = e.offsetHeight || 42, i = v.quickSetter(e, "x", "px"), n = v.quickSetter(e, "y", "px"), s = { x: -120, y: -120 }, l = () => {
      const d = t.readPosition(), c = d.x - a * 0.5, u = d.y - r * 0.5;
      c !== s.x && (s.x = c, i(c)), u !== s.y && (s.y = u, n(u));
    };
  ...
  streamThinkingStepDetail(e) {
    ...
    return !t || !a ? v.timeline() : this.streamText(t, a, {
      duration: this.getStreamDuration(a, kt),
      targetForScroll: e.closest(".wa-message") ?? e
    });
  }
  streamText(e, t, a) {
  ...
  runThinkingSequence(e, t) {
    const a = v.timeline(), r = e.map((n, s) => this.createThinkingStep(n, s)), i = this.claimThinkingMessage(r, this.getThinkingElapsed(e.length));
    return a.call(() => {
      r.forEach((n) => {
        n.dataset.stepState = "pending";
      }), v.set(i.header, { autoAlpha: 0, y: 5 }), v.set(i.steps, { display: "grid", autoAlpha: 1, y: 0 }), v.set(r, { autoAlpha: 0, y: t.itemStartY });
      ...
      a.call(() => this.activateThinkingStep(r, s), void 0, d).to(
        ...
        "<"
      ).add(this.streamThinkingStepLabel(l), kt.startOverlap).add(this.streamThinkingStepDetail(l), "-=0.02").to({}, { duration: t.afterStepHold }).add(this.foldThinkingStep(l));
    }), a.call(() => {
      r.forEach((n) => {
  ...
  createStrategyPlan(e) {
    ...
    return r.className = "wa-strategy-plan__title", r.textContent = e.title, t.append(
      a,
      r,
  ...
  createStrategyPlanRow(e, t) {
    ...
    r.textContent = e;
    const i = document.createElement("strong");
    return i.textContent = t, a.append(r, i), a;
  }
  createDataSourcesGrid(e) {
    ...
    return r.className = "wa-data-source-grid__list", e.sources.forEach((i) => {
      ...
      n.className = "wa-data-source-card", n.dataset.dataSource = i.id;
      const s = document.createElement("span");
      ...
      c.textContent = i.detail, l.append(d, c), n.append(s, l), r.append(n);
    }), t.append(a, r), t;
  }
  ...
  highlightCardTarget(e, t) {
    const a = typeof t == "string" ? e.querySelector(t) : t ?? e.querySelector(".wa-result-row, .wa-result-action") ?? e, r = v.timeline();
    return a && r.to(a, {
  ...
  clearTransientElements() {
    ...
    this.transientCleanups = [], this.root.querySelectorAll(gr).forEach((e) => {
  ...
  requestMessageScroll(e) {
    ...
    this.scheduledScrollMessage = e, !(t - this.lastStreamScrollAt < ls) && (this.scheduledScrollFrame || (this.lastStreamScrollAt = t, this.scheduledScrollFrame = window.requestAnimationFrame(() => {
...
function Ot(o, e, t) {
  const a = Ti(t.seed), r = cs(o, e), i = t.speed ?? "normal", n = t.intent ?? "hover";
  ...
  const s = e.x - o.x, l = e.y - o.y, d = s / r, c = l / r, u = -c, p = d, m = a() > 0.5 ? 1 : -1, g = t.curve ?? 1, f = xt(r * (n === "drag" ? 0.1 : n === "click" ? 0.17 : 0.22) * g, 18, 150) * m * (0.72 + a() * 0.44), _ = r / hs[i] + 0.16, w = xt(_ * ps[n] * ms, 0.3, 1.66), x = t.overshoot === !1 || r < 120 ? 0 : typeof t.overshoot == "number" ? t.overshoot : xt(r * 0.026, 4, 18), y = x > 0 ? {
    x: e.x + d * x,
    y: e.y + c * x
  } : e, b = {
  ...
  return {
    ...
    settle: A ? {
      ...
      duration: xt(w * 0.18, 0.1, 0.24)
    } : void 0
  };
}
const wr = "button, a, [role='button'], [data-send-button], [data-result-action]", br = "[data-chat-input], [data-signup-field], input, textarea, [contenteditable='true']", da = {
  delay: 0.42,
  returnDuration: 0.18,
  segments: [
...
class ws {
  ...
  moveTo(e, t = {}) {
    const a = t.label ?? `move-${this.moveIndex}`, r = t.mode ?? "default", i = `${this.storyId}:${a}:${this.resolver.getBreakpoint()}`, n = this.resolver.resolve(e, i), s = { ...this.plannedPosition }, l = Ot(s, n, {
      seed: i,
      intent: t.intent,
      speed: t.speed,
      curve: t.curve,
    ...
    return this.moveIndex += 1, this.plannedPosition = { ...n }, d.call(() => {
      ...
      this.pathTweenFromFactory(
        () => {
          ...
          return c = Ot(this.currentPosition, u, {
            seed: i,
            intent: t.intent,
            speed: t.speed,
            curve: t.curve,
  ...
  parkForChatHistory() {
    const e = `history-park-${this.moveIndex}`, t = `${this.storyId}:${e}:${this.resolver.getBreakpoint()}`, a = { ...this.currentPosition }, r = this.resolveHistoryParkPoint(), i = Ot(a, r, {
      seed: t,
      intent: "hover",
      speed: "quick",
      overshoot: !1,
  ...
  scanAcross(e, t = {}) {
    const a = t.label ?? `scan-${this.moveIndex}`, r = v.timeline();
  ...
  pathTweenFromFactory(e, t, a = "power2.inOut") {
    ...
    return v.fromTo(
      ...
      { t: 0 },
      {
        ...
        onUpdate: () => {
          if (!i) return;
          const n = fr(i.start, i.c1, i.c2, i.end, r.t);
  ...
  createHistoryParkPlan(e) {
    this.resolver.refresh();
    const t = this.resolveHistoryParkPoint(), a = Ot(this.currentPosition, t, {
      seed: e,
      intent: "hover",
      speed: "quick",
      overshoot: !1,
  ...
  renderMimicRotation(e, t) {
    ...
    if (a * a + r * r < 4) return;
    const i = Math.atan2(r, a) * 180 / Math.PI, n = bs(i - gs), s = this.rotationState + _s(this.rotationState, n) * fs;
  ...
  getModeForElement(e) {
    return e ? e.closest(wr) ? "pointer" : e.closest(br) ? "text" : "default" : "default";
  }
  ...
  refreshModeTargetCache() {
    this.modeTargetsDirty && (this.pointerTargets = Array.from(this.root.querySelectorAll(wr)).reverse(), this.textTargets = Array.from(this.root.querySelectorAll(br)).reverse(), this.modeTargetsDirty = !1);
  }
  observeModeTargets() {
...
const Ge = {
  ...
  status: "State",
  file: "File"
}, xs = ["user", "assistant", "thinking", "component", "cursor", "file"];
class ys {
  constructor(e, t, a = {}) {
    this.root = e, this.options = a, this.stories = vs(t), this.selectedStepId = this.stories[0]?.steps[0]?.id ?? null;
  }
  root;
  options;
  refs = null;
  ...
  attachEvents() {
    ...
    e && (this.on(e.tabs, "click", (t) => {
      const a = ca(t.target, "[data-builder-story-tab]");
      a && this.selectStory(Number(a.dataset.builderStoryTab));
    }), this.on(e.addRail, "click", (t) => {
      const r = ca(t.target, "[data-builder-add]")?.dataset.builderAdd;
      !r || !vr(r) || this.addStep(r);
    }), this.on(e.copyJson, "click", () => {
      this.copyExportJson();
    }), this.on(e.thread, "click", (t) => {
      const a = ca(t.target, "[data-builder-action]");
      if (a) {
  ...
  renderAddRail() {
    ...
    const t = xs.map((a) => {
      ...
      return r.className = "wa-builder-add-button", r.type = "button", r.dataset.builderAdd = a, r.textContent = `+ ${Ge[a]}`, r;
    });
  ...
  createStepBody(e, t = !1) {
    ...
    const r = document.createElement("span");
    return r.className = "wa-builder-step__kind", r.textContent = Ge[e.kind], a.append(r, this.createInlineTextarea(e)), a;
  }
  ...
  createLabeledComponentField(e, t, a, r, i) {
    const n = document.createElement("label");
    ...
    return s.className = "wa-builder-strategy-editor__row-label", s.textContent = t, n.append(
      s,
      this.createComponentInput(e, a, r, {
        cardIndex: i,
  ...
  createDragHandle(e) {
    ...
    return t.className = "wa-builder-step__action wa-builder-step__drag", t.type = "button", t.draggable = !0, t.dataset.builderDragHandle = e, t.setAttribute("aria-label", "Drag to reorder message"), t.append(Ar("grip")), t;
  }
  createActionButton(e, t, a, r, i = !1) {
    const n = document.createElement("button");
    return n.className = "wa-builder-step__action", n.type = "button", n.dataset.builderAction = t, n.dataset.builderActionStep = e, n.disabled = i, n.setAttribute("aria-label", a), n.append(Ar(r)), n;
  }
  createField(e, t, a, r) {
  ...
  addStep(e) {
    const t = ks(e, Cs(e), ""), a = this.activeStory.steps, r = a.findIndex((n) => n.id === this.selectedStepId), i = r >= 0 ? r + 1 : a.length;
    a.splice(i, 0, t), this.selectedStepId = t.id, this.render(), this.emitChange(`Added ${Ge[e]} message`);
  }
  updateStep(e, t, a = {}) {
  ...
  handleStepAction(e) {
    ...
    i < 0 || (t === "duplicate" && (r.splice(i + 1, 0, zs(r[i])), this.selectedStepId = r[i + 1]?.id ?? a), t === "delete" && r.length > 1 && (r.splice(i, 1), this.selectedStepId = r[Math.min(i, r.length - 1)]?.id ?? null), this.render(), this.emitChange("Draft updated"));
  }
  handleDragStart(e) {
    ...
    if (Fs(t) && !t?.closest("[data-builder-drag-handle]")) {
      e.preventDefault();
      return;
    }
  ...
  handleComponentInput(e) {
    ...
    !r?.component || !a || (Ds(r.component, a, e.value, {
      rowIndex: ht(e.dataset.builderComponentRow),
      columnIndex: ht(e.dataset.builderComponentColumn),
      cardIndex: ht(e.dataset.builderComponentCard),
      fieldIndex: ht(e.dataset.builderComponentGroup),
      itemIndex: ht(e.dataset.builderComponentItem)
    }), r.text = Os(r.component), this.selectedStepId === r.id && this.syncPanelStepText(r.text), this.renderExport(), this.emitChange("Component updated", !1));
  }
  handlePanelInput(e) {
  ...
  handlePanelSelect(e) {
    e.dataset.builderPanelSelect !== "step-kind" || !this.selectedStep || !vr(e.value) || this.updateStep(this.selectedStep.id, { kind: e.value });
  }
  setStatus(e) {
    const t = this.refs;
  ...
  return ({
    ...
    "data-marketplace": [
      ...
      { kind: "thinking", text: "Searching hiring signals across data sources", note: "Companies, contacts, jobs, LinkedIn, funding, and technographics." },
      {
        ...
        component: xr("Matching new hires", [
      ...
      { kind: "thinking", text: "Checking recent funding events", note: "Keep the earlier table visible above this transformation." },
      {
        ...
        component: xr("Recently funded matches", [
          ["Jamie Chen", "Ramp", "VP of Sales"],
          ["Andre Park", "Ramp", "Head of Growth"],
          ["David Kim", "Ramp", "Head of Revenue"]
        ])
    ...
    "research-brief": [
      { kind: "user", text: "Start with these 10 best-fit buyers.", note: "" },
      {
        ...
        component: yr("10 best-fit buyers", [
      ...
      },
      {
        ...
        component: yr("50-person expanded list", [
          ["Maya Patel", "OrbitGrid", "VP Revenue", "High"],
          ["Evan Brooks", "Northstar Dev", "Head of Growth", "High"],
          ["Clara Wong", "BrightLayer", "RevOps Lead", "Med"],
          ["Sam Hollis", "Apollo", "Growth Lead", "Med"],
...
function Ds(o, e, t, a) {
  if (e === "title" && (o.title = t), o.kind === "generic" && e === "item" && a.itemIndex !== null && (o.items[a.itemIndex] = t), o.kind === "dataSources" && (e === "subtitle" && (o.subtitle = t), a.itemIndex !== null)) {
    ...
    if (!r) return;
    e === "sourceName" && (r.name = t), e === "sourceDetail" && (r.detail = t);
  }
  ...
  if (o.kind === "table" && (e === "column" && a.columnIndex !== null && (o.columns[a.columnIndex] = t), e === "cell" && a.rowIndex !== null && a.columnIndex !== null && (o.rows[a.rowIndex] ??= [], o.rows[a.rowIndex][a.columnIndex] = t)), o.kind === "strategyCards" && a.cardIndex !== null) {
    ...
    if (!r) return;
    e === "cardLabel" && (r.label = t), e === "cardTitle" && (r.title = t), e === "cardAudience" && (r.audience = t), e === "cardMotion" && (r.motion = t), e === "cardProof" && (r.proof = t);
  }
...
function zs(o) {
  return {
    ...o,
    id: Ei("step"),
    component: o.component ? Ls(o.component) : void 0
  };
}
function Ls(o) {
...
function Ar(o) {
  ...
  if (e.setAttribute("viewBox", "0 0 20 20"), e.setAttribute("aria-hidden", "true"), e.setAttribute("focusable", "false"), o === "copy" && kr(e, "M7 7.5h8v8H7z M5 13H4.5a1 1 0 0 1-1-1V4.5a1 1 0 0 1 1-1H12a1 1 0 0 1 1 1V5"), o === "x" && kr(e, "M5.5 5.5l9 9 M14.5 5.5l-9 9"), o === "grip")
    for (const t of [7, 13])
...
function ke(o, e, t = {}, a = !0) {
  return {
    desktop: { target: o, anchor: e, offset: ua(t.desktop), humanOffset: a },
    tablet: { target: o, anchor: e, offset: ua(t.tablet), humanOffset: a },
    mobile: { target: o, anchor: e, offset: ua(t.mobile), humanOffset: a }
  };
}
const Cr = {
...
}, Bs = ke("[data-signup-field]", "center", {
  desktop: -74,
  tablet: -66,
  mobile: -48
}), qs = ke("[data-send-button]", "center"), Pi = {
  desktop: {
...
}, Hs = 2.8, Gs = 42, Us = 2, Ys = 3, Zt = "[data-chat-shell] [data-chat-thread]", Vs = `${Zt} [data-message-role="assistant"]:not(.wa-message--component) [data-message-body]`, js = `${Zt} [data-message-role="assistant"].wa-message--thinking .wa-research-step[data-step-state="current"] .wa-research-step__body, ${Zt} [data-message-role="assistant"].wa-message--thinking .wa-research-step[data-step-state="complete"] .wa-research-step__label`, Sr = 0.24, Ws = 0.3, Ze = {
...
function Js(o, e, t, a, r) {
  switch (t.kind) {
    ...
    case "transitionSignupToChat":
      ...
      return;
    case "assistant":
      o.add(e.chat.assistantMessage(t.text), t.at), Qs(o, e, r, {
        kind: "assistant",
        key: t.text,
        text: t.text,
        selector: Vs,
        label: `assistant-${Sa(t.text)}`,
        stepIndex: a
      });
      return;
    case "thinking":
      t.statusBefore && o.add(e.chat.setStatus(t.statusBefore), t.at), o.add(e.chat.thinkingState(t.label, t.hold), t.statusBefore ? void 0 : t.at), Tr(o, e, r, t.hold, 1, t.label, a);
      return;
    case "research":
      t.statusBefore && o.add(e.chat.setStatus(t.statusBefore), t.at), o.add(e.chat.researchSequence(t.steps, t.hold), t.statusBefore ? void 0 : t.at), Tr(o, e, r, t.hold, t.steps.length, t.steps.join("|"), a);
      return;
    case "dataTable":
      gt(
        o,
        ...
        t.at,
        wt(`[data-data-table="${ft(t.config.id)}"]`),
        `table-${t.config.id}`
      );
      return;
    case "enrichmentPanel":
      gt(
        ...
        t.at,
        wt(`[data-enrichment-panel="${ft(t.config.id)}"]`),
    ...
    case "strategyPlans":
      gt(
        ...
        t.at,
        wt(`[data-strategy-plans~="${ft(t.plans[0]?.id ?? "strategy")}"]`),
    ...
    case "dataSourcesGrid":
      gt(
        ...
        t.at,
        wt(`[data-data-sources-grid="${ft(t.config.id)}"]`),
        `sources-${t.config.id}`
      );
      return;
    case "sequenceEngagement":
      gt(
        ...
        t.at,
        wt(`[data-sequence-engagement="${ft(t.config.id)}"]`),
...
function gt(o, e, t, a, r, i) {
  o.add(t, a), o.add(Xs(e, r, i), "+=0.06");
}
function Xs(o, e, t) {
  const a = Va(o).add(o.cursor.scanAcross(e, { label: t }));
  return ja(a);
}
function Tr(o, e, t, a = O.thinkingShort, r = 1, i = "thinking", n = 0) {
  const s = a * Math.max(1, r), l = r >= 3 && Mi(e, t, {
    kind: "thinking",
    key: i,
    text: i,
    stepIndex: n,
...
function Mi(o, e, t) {
  const a = t.text.trim(), r = t.minChars ?? Gs;
  if (a.length < r || e.textSkimCount >= Ys) return !1;
  const i = e.textCandidateCount;
  e.textCandidateCount += 1;
  const n = e.textSkimCount === 0, s = t.stepIndex - e.lastTextSkimStep >= Us, l = Ks(`${o.story.id}:${t.kind}:${i}:${t.key}`), d = i > 0 && i % 3 === 0, c = n || s && (l >= 0.58 || d);
...
const eo = [
  ...
  },
  {
    ...
    build: (o) => mt(o, [
      ...
      { kind: "enrichmentPanel", config: no, at: "+=0.12" },
      { kind: "status", text: "Contacts enriched", at: "+=0.86" },
      { kind: "dataTable", config: oo, at: "-=0.02" },
      { kind: "dataSourcesGrid", config: so, at: "+=0.44" },
      pt(Ze.bottomRight)
    ])
  },
  {
    ...
    build: (o) => {
      ...
      return mt(o, [
        ...
        { kind: "custom", build: () => o.chat.uploadedFilesMessage(lo), at: "-=0.08" },
        ...
        { kind: "custom", build: () => o.chat.outreachStyleProfile(co), at: "-=0.02" },
        {
          kind: "prompt",
        ...
        { kind: "custom", build: () => o.chat.proximityLeadList(uo), at: "-=0.04" },
        pt(Ze.bottomRight, "+=0.16")
      ]);
    }
  },
  {
    ...
    build: (o) => mt(o, [
      ...
      { kind: "dataTable", config: Ri, at: "-=0.02" },
      {
        kind: "prompt",
      ...
      { kind: "sequenceEngagement", config: po, at: "-=0.04" },
      pt(Ze.bottomRight, "+=0.14")
    ])
  },
  {
...
class go {
  ...
  setPaused(e) {
    if (this.paused !== e) {
      if (this.paused = e, this.samples = [], e) {
        this.listen();
        return;
      }
  ...
  handlePointerMove = (e) => {
    ...
    if (!this.isPointNearRoot(t)) {
      this.active && this.startSniffing(), this.samples = [];
      return;
    }
    if (this.active) {
      this.mode === "follow" && (this.updateFollowTarget(t), this.lastMoveAt = performance.now()), this.scheduleFollow();
      return;
    }
  ...
  startMimicking(e) {
    this.active || (this.active = !0, this.mode = "follow", this.homePoint = this.getCursorViewportPoint(), this.lastPointer = this.samples[this.samples.length - 2] ?? null, this.updateFollowTarget(e), this.lastMoveAt = performance.now(), this.samples = [], this.root.dataset.cursorMimicking = "true", this.options.onMimicStart?.(), this.cursor.beginMimicControl(), this.scheduleFollow());
  }
  stopMimicking() {
    this.active && (this.active = !1, this.mode = "idle", this.target = null, this.pointer = null, this.homePoint = null, this.sniffAnchor = null, this.lastPointer = null, this.velocity = { x: 0, y: 0 }, delete this.root.dataset.cursorMimicking, window.cancelAnimationFrame(this.frame), this.frame = 0, this.cursor.endMimicControl());
  }
  scheduleFollow() {
  ...
  followPointer = () => {
    ...
    if (this.mode === "sniff") {
      this.updateSniffTarget(e), this.target && this.cursor.mimicViewportPoint(this.target, Ft.smoothing, this.target), e - this.sniffStartedAt >= Ft.durationMs && this.startReturnAfterPause(), this.scheduleFollow();
      return;
    }
    if (this.mode === "return") {
      const t = this.homePoint ?? this.getCursorViewportPoint();
      if (this.target = t, this.cursor.mimicViewportPoint(t, Er.smoothing, t), Bt(this.getCursorViewportPoint(), t) <= Er.arriveDistance) {
        this.completeReturn();
        return;
      }
      this.scheduleFollow();
    ...
    if (!(this.mode !== "follow" || !this.target)) {
      ...
      if (e - this.lastMoveAt > D.idleTimeoutMs) {
        this.stopMimicking();
        return;
      }
      this.applyMomentum(e), this.cursor.mimicViewportPoint(this.target, D.smoothing, this.pointer ?? this.target), this.scheduleFollow();
    }
  };
  updateFollowTarget(e) {
    if (!this.isPointNearBrowser(e)) {
      this.startSniffing();
      return;
    }
    if (this.lastPointer) {
      ...
      r > 1.5 && (this.trailDirection = {
        x: a.x / r,
        y: a.y / r
      }, this.velocity = wo(a, D.maxMomentumStep));
    }
    const t = {
      x: e.x - this.trailDirection.x * D.trailDistance,
      y: e.y - this.trailDirection.y * D.trailDistance
    };
    Bt(e, t) < D.minPointerDistance && (t.x = e.x - this.trailDirection.x * D.minPointerDistance, t.y = e.y - this.trailDirection.y * D.minPointerDistance), this.target = t, this.pointer = e, this.lastPointer = e;
  }
  startSniffing() {
    if (!this.active || this.mode === "sniff" || this.mode === "return" || this.mode === "returnWait") return;
    const e = performance.now();
    this.mode = "sniff", this.sniffAnchor = this.getCursorViewportPoint(), this.sniffStartedAt = e, this.nextSniffAt = 0, this.sniffIndex = 0, this.pointer = null, this.velocity = { x: 0, y: 0 }, this.scheduleFollow();
  }
  updateSniffTarget(e) {
    if (this.sniffAnchor || (this.sniffAnchor = this.getCursorViewportPoint()), this.target && e < this.nextSniffAt) return;
    const t = this.sniffIndex, a = t * 1.92, r = Ft.radius * (t % 2 === 0 ? 1 : 0.58);
    this.target = {
      x: this.sniffAnchor.x + Math.cos(a) * r,
      y: this.sniffAnchor.y + Math.sin(a) * r * 0.62
    }, this.sniffIndex += 1, this.nextSniffAt = e + Ft.pointIntervalMs;
  }
  applyMomentum(e) {
    !this.target || e - this.lastMoveAt < 48 || Math.hypot(this.velocity.x, this.velocity.y) < D.minMomentum || (this.target = {
      x: this.target.x + this.velocity.x * D.momentumScale,
      y: this.target.y + this.velocity.y * D.momentumScale
    }, this.velocity = {
      x: this.velocity.x * D.momentumDecay,
      y: this.velocity.y * D.momentumDecay
    });
  }
  startReturnAfterPause() {
    this.active && (this.mode = "returnWait", this.target = null, this.pointer = null, this.lastPointer = null, this.velocity = { x: 0, y: 0 }, window.cancelAnimationFrame(this.frame), this.frame = 0, this.returnAt = performance.now() + D.returnDelayMs, this.scheduleFollow());
  }
  completeReturn() {
    this.active = !1, this.mode = "idle", this.target = null, this.pointer = null, this.homePoint = null, this.sniffAnchor = null, this.lastPointer = null, this.velocity = { x: 0, y: 0 }, delete this.root.dataset.cursorMimicking, window.cancelAnimationFrame(this.frame), this.frame = 0, this.cursor.endMimicControl();
  }
  isCursorTooFarFromBrowser() {
    ...
    return fo(r, e) > D.maxBrowserDistance;
  }
  isPointNearStoryCursor(e) {
    const t = this.root.getBoundingClientRect(), a = this.cursor.readPosition(), r = {
      x: t.left + a.x,
      y: t.top + a.y
    };
    return Bt(e, r) <= Lt.radius;
  }
  isPointNearRoot(e) {
    const t = this.root.getBoundingClientRect();
    return e.x >= t.left - D.rootMargin && e.x <= t.right + D.rootMargin && e.y >= t.top - D.rootMargin && e.y <= t.bottom + D.rootMargin;
  }
  isPointNearBrowser(e) {
    const t = this.root.querySelector("[data-chat-shell]")?.getBoundingClientRect();
    return t ? e.x >= t.left - D.browserExitMargin && e.x <= t.right + D.browserExitMargin && e.y >= t.top - D.browserExitMargin && e.y <= t.bottom + D.browserExitMargin : !0;
  }
  ...
  pruneSamples(e) {
    this.samples = this.samples.filter((t) => e - t.time <= Lt.sampleWindowMs);
  }
  hasMimicGesture() {
    return this.samples.length < 4 ? !1 : this.samples.reduce((t, a, r) => {
      const i = this.samples[r - 1];
      return i ? t + Bt(a, i) : t;
    }, 0) >= Lt.minTravel && this.countAxisReversals() >= Lt.minAxisReversals;
  }
  countAxisReversals() {
    let e = 0, t = 0, a = 0;
    for (let r = 1; r < this.samples.length; r += 1) {
      const i = this.samples[r - 1], n = this.samples[r], s = Pr(n.x - i.x), l = Pr(n.y - i.y);
      s && t && s !== t && (e += 1), l && a && l !== a && (e += 1), s && (t = s), l && (a = l);
    }
    return e;
  }
}
...
class _o {
  constructor(e, t, a, r, i, n) {
    this.root = e, this.stories = t, this.resolver = a, this.cursor = r, this.chat = i, this.options = n, this.storyProgress = this.stories.map(() => 0), this.pausedCursorMimic = new go(this.root, this.cursor, {
  ...
  seekTo(e, t = 0.28) {
    ...
    const a = xo(e), r = this.activeTimeline.duration();
...
const qt = ["mobile", "tablet", "desktop", "wide"];
class yo {
  constructor(e) {
    this.root = e;
  }
  ...
  resolve(e, t = "target") {
    ...
    if (s = {
      ...
      const l = Ti(t), d = Math.min(n.width * 0.18, 18), c = Math.min(n.height * 0.18, 14);
  ...
  pickTarget(e) {
    if (this.isBreakpointMap(e)) {
      const t = this.getBreakpoint(), a = qt.indexOf(t), r = [
        t,
        ...qt.slice(0, a).reverse(),
        ...qt.slice(a + 1)
      ];
      for (const i of r)
        if (e[i]) return e[i];
...
function Ao(o, e = {}) {
  vo(o, { showBuilder: e.showBuilder !== !1 });
  const t = e.stories?.length ? e.stories : Di, a = new yo(o), r = new ds(o), i = new ws(o, a, {
  ...
  }), s = n.destroy.bind(n), l = e.showBuilder === !1 ? null : new ys(o, t, {
...
function zi(o = "[data-chatbot-stories]", e = {}) {
  return e.injectStyles !== !1 && Co(), Ao(So(o), e);
}
const To = {
  init: zi,
  defaultStories: Di
