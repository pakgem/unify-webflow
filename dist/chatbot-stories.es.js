...
var ce = {
  ...
  overwrite: !1,
  delay: 0
}, si, $, z, be = 1e8, L = 1 / be, Wa = Math.PI * 2, Pn = Wa / 4, In = 0, gr = Math.sqrt, Nn = Math.cos, Rn = Math.sin, X = function(e) {
...
}, K = Array.isArray, Dn = /random\([^)]+\)/g, qn = /,\s*/g, Ii = /(?:-?\.?\d|\.)+/gi, wr = /[-+=.]*\d+[.e\-+]*\d*[e\-+]*\d*/g, xt = /[-+=.]*\d+[.e-]*\d*[a-z%]*/g, Aa = /[-+=.]*\d+\.?\d*(?:e-|e\+)?\d*/gi, br = /[+-]=-?[.\d]+/, Ln = /[^,'"\[\]\s]+/gi, On = /^[+\-=e\s\d]*\d+[.\d]*([a-z]*|%)\s*$/i, V, ve, Ua, ci, ue = {}, ua = {}, _r, yr = function(e) {
  return (ua = Et(e, ue)) && ne;
}, ui = function(e, t) {
  return console.warn("Invalid property", e, "set to", t, "Missing plugin? gsap.registerPlugin()");
}, jt = function(e, t) {
  return !t && console.warn(e);
}, xr = function(e, t) {
  return e && (ue[e] = t) && ua && (ua[e] = t) || ue;
}, Yt = function() {
  return 0;
}, Bn = {
  suppressEvents: !0,
  ...
  suppressEvents: !0
}, pi = {}, We = [], ja = {}, vr, oe = {}, Ca = {}, Ni = 30, da = [], hi = "", mi = function(e) {
  var t = e[0], a, i;
  ...
  return e._gsap || mi(_e(e))[0]._gsap;
}, kr = function(e, t, a) {
  return (a = e[t]) && U(a) ? e[t]() : li(a) && e.getAttribute && e.getAttribute(t) || a;
}, ae = function(e, t) {
  ...
  for (ja = {}, We.length = 0, a = 0; a < e; a++)
    i = t[a], i && i._lazy && (i.render(i._lazy[0], i._lazy[1], !0)._lazy = 0);
}, gi = function(e) {
  return !!(e._initted || e._startAt || e.add);
}, Sr = function(e, t, a, i) {
  We.length && !$ && pa(), e.render(t, a, !!($ && t < 0 && gi(e))), We.length && !$ && pa();
}, Ar = function(e) {
  var t = parseFloat(e);
  return (t || t === 0) && (e + "").match(Ln).length < 2 ? t : X(e) ? e.trim() : e;
}, Cr = function(e) {
  return e;
}, pe = function(e, t) {
  for (var a in t)
  ...
  var t = e.parent || V, a = e.keyframes ? Hn(K(e.keyframes)) : pe;
  if (te(e.inherit))
    for (; t; )
  ...
  return e._startAt && ($ ? e._startAt.revert(la) : e.vars.immediateRender && !e.vars.autoRevert || e._startAt.render(t, !0, i));
}, Wn = function n(e) {
  ...
  var a = e._dp;
  return a && a.smoothChildTiming && e._ts && (e._start = G(a._time - (e._ts > 0 ? t / e._ts : ((e._dirty ? e.totalDuration() : e._tDur) - t) / -e._ts)), xa(e), a._dirty || ct(a, e)), e;
}, Er = function(e, t) {
  var a;
  if ((t._time || !t._dur && t._initted || t._start < e._time && (t._dur || !t.add)) && (a = ma(e.rawTime(), t), (!t._dur || Zt(0, t.totalDuration(), a) - t._tTime > L) && t.render(a, !0)), ct(e, t)._dp && e._initted && e._time >= e._dur && e._ts) {
  ...
  return t.parent && Ye(t), t._start = G((Re(a) ? a : a || e !== V ? we(e, a, t) : e._time) + t._delay), t._end = G(t._start + (t.totalDuration() / Math.abs(t.timeScale()) || 0)), Tr(e, t, "_first", "_last", e._sort ? "_start" : 0), Xa(t) || (e._recent = t), i || Er(e, t), e._ts < 0 && va(e, e._tTime), e;
}, Mr = function(e, t) {
  return (ue.ScrollTrigger || ui("scrollTrigger", t)) && ue.ScrollTrigger.create(t, e);
}, Pr = function(e, t, a, i, r) {
  if (wi(e, t, r), !e._initted)
    return 1;
  if (!a && e._pt && !$ && (e._dur && e.vars.lazy !== !1 || !e._dur && e.vars.lazy) && vr !== se.frame)
  ...
  var r = e.ratio, o = t < 0 || !t && (!e._start && Un(e) && !(!e._initted && Xa(e)) || (e._ts < 0 || e._dp._ts < 0) && !Xa(e)) ? 0 : 1, s = e._rDelay, l = 0, d, c, u;
  if (s && e._repeat && (l = Zt(0, e._tDur, t), c = Mt(l, s), e._yoyo && c & 1 && (o = 1 - o), c !== Mt(e._tTime, s) && (r = 1 - o, e.vars.repeatRefresh && e._initted && e.invalidate())), o !== r || $ || i || e._zTime === L || !t && e._zTime) {
    if (!e._initted && Pr(e, t, i, a, l))
      return;
    for (u = e._zTime, e._zTime = t || (a ? L : 0), a || (a = t && !u), e.ratio = o, e._from && (o = 1 - o), e._time = 0, e._tTime = l, d = e._pt; d; )
      d.r(o, d.d), d = d._next;
    t < 0 && Ya(e, t, a, !0), e._onUpdate && !a && le(e, "onUpdate"), l && e._repeat && !a && e.parent && le(e, "onRepeat"), (t >= e._tDur || t < 0) && e.ratio === o && (o && Ye(e, 1), !a && !$ && (le(e, o ? "onComplete" : "onReverseComplete", !0), e._prom && e._prom()));
  ...
  return s && !i && (e._time *= o / e._dur), e._dur = o, e._tDur = r ? r < 0 ? 1e10 : G(o * (r + 1) + e._rDelay * r) : o, s > 0 && !i && va(e, e._tTime = e._tDur * s), e.parent && xa(e), a || ct(e.parent, e), e;
}, qi = function(e) {
  return e instanceof ee ? ct(e) : Pt(e, e._dur);
}, Xn = {
  _start: 0,
  endTime: Yt,
  totalDuration: Yt
}, we = function n(e, t, a) {
  var i = e.labels, r = e._recent || Xn, o = e.duration() >= be ? r.endTime(!1) : e._dur, s, l, d;
  ...
  var i = Re(t[1]), r = (i ? 2 : 1) + (e < 2 ? 0 : 1), o = t[r], s, l;
  ...
  return !X(e) || !(t = On.exec(e)) ? "" : t[1];
}, $n = function(e, t, a) {
  return Je(a, function(i) {
    return Zt(e, t, i);
  });
}, $a = [].slice, Ir = function(e, t) {
  return e && Ce(e) && "length" in e && (!t && !e.length || e.length - 1 in e && Ce(e[0])) && !e.nodeType && e !== ve;
}, Jn = function(e, t, a) {
  return a === void 0 && (a = []), e.forEach(function(i) {
    var r;
    return X(i) && !t || Ir(i, 1) ? (r = a).push.apply(r, _e(i)) : a.push(i);
  }) || a;
}, _e = function(e, t, a) {
  return z && !t && z.selector ? z.selector(e) : X(e) && !a && (Ua || !It()) ? $a.call((t || ci).querySelectorAll(e), 0) : K(e) ? Jn(e, a) : Ir(e) ? $a.call(e, 0) : e ? [e] : [];
}, Ja = function(e) {
  return e = _e(e)[0] || jt("Invalid scope") || {}, function(t) {
    var a = e.current || e.nativeElement || e;
    return _e(t, a.querySelectorAll ? a : a === e ? jt("Invalid scope") || ci.createElement("div") : e);
  };
}, Nr = function(e) {
  ...
  return X(i) ? c = u = {
    ...
    if (!f) {
      ...
      for (f = o[h] = [], b = l ? Math.min(S, h) * c - 0.5 : i % S, _ = S === be ? 0 : l ? h * u / S - 0.5 : i / S | 0, k = 0, A = be, C = 0; C < h; C++)
        x = C % S - b, v = _ - (C / S | 0), f[C] = y = d ? Math.abs(d === "y" ? v : x) : gr(x * x + v * v), y > k && (k = y), y < A && (A = y);
      i === "random" && Nr(f), f.max = k - A, f.min = A, f.v = h = (parseFloat(t.amount) || parseFloat(t.each) * (S > h ? h - 1 : d ? d === "y" ? h / S : S : Math.max(S, h / S)) || 0) * (i === "edges" ? -1 : 1), f.b = h < 0 ? r - h : r, f.u = Q(t.amount || t.each) || 0, a = a && h < 0 ? co(a) : a;
    }
  ...
  return function(a) {
    ...
    return (i - i % 1) / t + (Re(a) ? 0 : Q(a));
  };
}, Dr = function(e, t) {
  var a = K(e), i, r;
  return !a && Ce(e) && (i = a = e.radius || be, e.values ? (e = _e(e.values), (r = !Re(e[0])) && (i *= i)) : e = Qa(e.increment)), Je(t, a ? U(e) ? function(o) {
    ...
    return c = !i || d <= i ? e[c] : o, r || c === o || Re(o) ? c : c + Q(o);
  } : Qa(e));
}, qr = function(e, t, a, i) {
  ...
  var i = t - e;
  return K(e) ? Lr(e, n(0, e.length), t) : Je(a, function(r) {
    return (i + (r - e) % i) % i + e;
  });
}, to = function n(e, t, a) {
  var i = t - e, r = i * 2;
  return K(e) ? Lr(e, n(0, e.length - 1), t) : Je(a, function(o) {
    return o = (r + (o - e) % r) % r || 0, e + (o > i ? r - o : o);
  });
}, Xt = function(e) {
  return e.replace(Dn, function(t) {
    var a = t.indexOf("[") + 1, i = t.substring(a || 7, a ? t.indexOf("]") : t.length - 1).split(qn);
    return qr(a ? i : +i[0], a ? 0 : +i[1], +i[2] || 1e-5);
  });
  ...
  if (!r) {
    ...
    if (!c) {
      for (l in t)
        fi.call(s, e, l, "get", t[l]);
      r = function(g) {
        return yi(g, s) || (o ? e.p : e);
      };
    }
  }
  return Je(a, r);
  ...
  if (r)
    return l = i[t + "Params"], d = i.callbackScope || e, a && We.length && pa(), s && (z = s), c = l ? r.apply(d, l) : r.call(d), z = o, c;
}, zt = function(e) {
  ...
  if (e)
    if (e = !e.name && e.default || e, di() || e.headless) {
      ...
      if (It(), e !== i) {
        if (oe[t])
          return;
        pe(i, pe(ha(e, r), o)), Et(i.prototype, Et(r, ha(e, o))), oe[i.prop = t] = i, e.targetTest && (da.push(i), pi[t] = 1), t = (t === "css" ? "CSS" : t.charAt(0).toUpperCase() + t.substr(1)) + "Plugin";
      }
      xr(t, i), e.register && e.register(ne, i, ie);
    } else
      Br.push(e);
}, q = 255, Ht = {
  aqua: [0, q, q],
  ...
  var i = e ? Re(e) ? [e >> 16, e >> 8 & q, e & q] : 0 : Ht.black, r, o, s, l, d, c, u, p, m, g;
  if (!i) {
    if (e.substr(-1) === "," && (e = e.substr(0, e.length - 1)), Ht[e])
      ...
      if (i = g = e.match(Ii), !t)
        l = +i[0] % 360 / 360, d = +i[1] / 100, c = +i[2] / 100, o = c <= 0.5 ? c * (d + 1) : c + d - c * d, r = c * 2 - o, i.length > 3 && (i[3] *= 1), i[0] = Ta(l + 1 / 3, r, o), i[1] = Ta(l, r, o), i[2] = Ta(l - 1 / 3, r, o);
      else if (~e.indexOf("="))
        return i = e.match(wr), a && i.length < 4 && (i[3] = 1), i;
    } else
      i = e.match(Ii) || Ht.transparent;
    i = i.map(Number);
  }
  ...
  if (r = r.map(function(p) {
    return (p = zr(p, t, 1)) && o + (t ? p[0] + "," + p[1] + "%," + p[2] + "%," + p[3] : p.join(",")) + ")";
  }), a && (c = Hr(e), l = a.c, l.join(i) !== c.c.join(i)))
...
})(), io = /hsl[a]?\(/, Gr = function(e) {
  var t = e.join(" "), a;
  if (Ue.lastIndex = 0, Ue.test(t))
    return a = io.test(t), e[1] = Oi(e[1], a), e[0] = Oi(e[0], a, Hr(e[1])), !0;
}, $t, se = (function() {
  ...
  return u = {
    ...
    wake: function() {
      _r && (!Ua && di() && (ve = Ua = window, ci = ve.document || {}, ue.gsap = ne, (ve.gsapVersions || (ve.gsapVersions = [])).push(ne.version), yr(ua || ve.GreenSockGlobals || !ve.gsap && ve || {}), Br.forEach(Fr)), c = typeof requestAnimationFrame < "u" && requestAnimationFrame, l && u.sleep(), d = c || function(f) {
  ...
  return !$t && se.wake();
}, N = {}, ro = /^[\d.\-M][\d.\-,\s]/, no = /["']/g, oo = function(e) {
  for (var t = {}, a = e.substr(1, e.length - 3).split(":"), i = a[0], r = 1, o = a.length, s, l, d; r < o; r++)
    l = a[r], s = r !== o - 1 ? l.lastIndexOf(",") : l.length, d = l.substr(0, s), t[i] = isNaN(d) ? d.replace(no, "").trim() : +d, i = l.substr(s + 1).trim();
  return t;
}, so = function(e) {
  var t = e.indexOf("(") + 1, a = e.indexOf(")"), i = e.indexOf("(", t);
  return e.substring(t, ~i && i < a ? e.indexOf(")", a + 1) : a);
}, lo = function(e) {
  var t = (e + "").split("("), a = N[t[0]];
  return a && t.length > 1 && a.config ? a.config.apply(null, ~e.indexOf("{") ? [oo(t[1])] : so(e).split(",").map(Ar)) : N._CE && ro.test(e) ? N._CE("", e) : a;
}, co = function(e) {
  return function(t) {
    return 1 - e(1 - t);
  };
}, ut = function(e, t) {
  return e && (U(e) ? e : N[e] || lo(e)) || t;
}, gt = function(e, t, a, i) {
  ...
  return ae(e, function(s) {
    N[s] = ue[s] = r, N[o = s.toLowerCase()] = a;
    for (var l in r)
      N[o + (l === "easeIn" ? ".in" : l === "easeOut" ? ".out" : ".inOut")] = N[s + "." + l] = r[l];
  }), r;
}, Vr = function(e) {
  return function(t) {
  ...
  var i = t >= 1 ? t : 1, r = (a || (e ? 0.3 : 0.45)) / (t < 1 ? t : 1), o = r / Wa * (Math.asin(1 / i) || 0), s = function(c) {
    return c === 1 ? 1 : i * Math.pow(2, -10 * c) * Rn((c - o) * r) + 1;
  }, l = e === "out" ? s : e === "in" ? function(d) {
    return 1 - s(1 - d);
  } : Vr(s);
  return r = Wa / r, l.config = function(d, c) {
    return n(e, d, c);
  }, l;
}, Ma = function n(e, t) {
  t === void 0 && (t = 1.70158);
...
gt("Sine", function(n) {
  return n === 1 ? 1 : -Nn(n * Pn) + 1;
});
gt("Back", Ma("in"), Ma("out"), Ma());
N.SteppedEase = N.steps = ue.SteppedEase = {
  config: function(e, t) {
    e === void 0 && (e = 1);
...
ae("onComplete,onUpdate,onStart,onRepeat,onReverseComplete,onInterrupt", function(n) {
  return hi += n + "," + n + "Params,";
});
var Wr = function(e, t) {
  this.id = In++, e._gsap = this, this.target = e, this.harness = t, this.get = t ? t.get : kr, this.set = t ? t.getSetter : _i;
}, Jt = /* @__PURE__ */ (function() {
  function n(t) {
    this.vars = t, this._delay = +t.delay || 0, (this._repeat = t.repeat === 1 / 0 ? -2 : t.repeat || 0) && (this._rDelay = t.repeatDelay || 0, this._yoyo = !!t.yoyo || !!t.yoyoEase), this._ts = 1, Pt(this, +t.duration, 1, 1), this.data = t.data, z && (this._ctx = z, z.data.push(this)), $t || se.wake();
  }
  var e = n.prototype;
  return e.delay = function(a) {
    ...
    if (r && r.smoothChildTiming && this._ts) {
      for (va(this, a), !r._dp || r.parent || Er(r, this); r && r.parent; )
    ...
    return (this._tTime !== a || !this._dur && !i || this._initted && Math.abs(this._zTime) === L || !this._initted && this._dur && a || !a && !this._initted && (this.add || this._ptLookup)) && (this._ts || (this._pTime = a), Sr(this, a, i)), this;
  }, e.time = function(a, i) {
    return arguments.length ? this.totalTime(Math.min(this.totalDuration(), a + Di(this)) % (this._dur + this._rDelay) || (a ? this._dur : 0), i) : this._time;
    ...
    return arguments.length ? this.totalTime(this.duration() * (this._yoyo && !(this.iteration() & 1) ? 1 - a : a) + Di(this), i) : this.duration() ? Math.min(1, this._time / this._dur) : this.rawTime() > 0 ? 1 : 0;
    ...
    if (this._rts === a)
      return this;
    var r = this.parent && this._ts ? ma(this.parent._time, this) : this._tTime;
    return this._rts = +a || 0, this._ts = this._ps || a === -L ? 0 : this._rts, this.totalTime(Zt(-Math.abs(this._delay), this.totalDuration(), r), i !== !1), xa(this), Vn(this);
  }, e.paused = function(a) {
    ...
    a === void 0 && (a = Fn);
    var i = $;
    return $ = a, gi(this) && (this.timeline && this.timeline.revert(a), this.totalTime(-0.01, a.suppressEvents)), this.data !== "nested" && a.kill !== !1 && this.kill(), $ = i, this;
    ...
    return arguments.length ? (this._repeat = a === 1 / 0 ? -2 : a, qi(this)) : this._repeat === -2 ? 1 / 0 : this._repeat;
  }, e.repeatDelay = function(a) {
    if (arguments.length) {
      var i = this._time;
      return this._rDelay = a, qi(this), i ? this.time(i) : this;
    }
    return this._rDelay;
  }, e.yoyo = function(a) {
...
var ee = /* @__PURE__ */ (function(n) {
  ...
  function e(a, i) {
    var r;
    return a === void 0 && (a = {}), r = n.call(this, a) || this, r.labels = {}, r.smoothChildTiming = !!a.smoothChildTiming, r.autoRemoveChildren = !!a.autoRemoveChildren, r._sort = te(a.sortChildren), V && ke(a.parent || V, Me(r), i), a.reversed && r.reverse(), a.paused && r.paused(!0), a.scrollTrigger && Mr(Me(r), a.scrollTrigger), r;
  }
  var t = e.prototype;
  return t.to = function(i, r, o) {
    ...
    if (this !== V && c > l && i >= 0 && (c = l), c !== this._tTime || o || u) {
      if (s !== this._time && d && (c += this._time - s, i += this._time - s), p = c, v = this._start, x = this._ts, b = !x, u && (d || (s = this._zTime), (i || !r) && (this._zTime = i)), this._repeat) {
        ...
        if (p = G(c % f), c === l ? (h = this._repeat, p = d) : (y = G(c / f), h = ~~y, h && h === y && (p = d, h--), p > d && (p = d)), y = Mt(this._tTime, f), !s && this._tTime && y !== h && this._tTime - y * f - this._dur <= 0 && (y = h), C && h & 1 && (p = d - p, k = 1), h !== y && !this._lock) {
      ...
      if (this._hasPause && !this._forcing && this._lock < 2 && (_ = Yn(this, G(s), G(p)), _ && (c -= p - (p = _._start))), this._tTime = c, this._time = p, this._act = !!x, this._initted || (this._onUpdate = this.vars.onUpdate, this._initted = 1, this._zTime = i, s = 0), !s && c && d && !r && !y && (le(this, "onStart"), this._tTime !== c))
        return this;
      if (p >= s && i >= 0)
        for (m = this._first; m; ) {
        ...
        for (var E = i < 0 ? i : p; m; ) {
          if (g = m._prev, (m._act || E <= m._end) && m._ts && _ !== m) {
            if (m.parent !== this)
              return this.render(i, r, o);
            if (m.render(m._ts > 0 ? (E - m._start) * m._ts : (m._dirty ? m.totalDuration() : m._tDur) + (E - m._start) * m._ts, r, o || $ && gi(m)), p !== this._time || !this._ts && !b) {
      ...
      if (_ && !r && (this.pause(), _.render(p >= s ? 0 : -L)._zTime = p >= s ? 1 : -1, this._ts))
        return this._start = v, xa(this), this.render(i, r, o);
    ...
    var o = this;
    if (Re(r) || (r = we(this, r, i)), !(i instanceof Jt)) {
      if (K(i))
    ...
    return X(i) ? this.removeLabel(i) : U(i) ? this.killTweensOf(i) : (i.parent === this && ya(this, i), i === this._recent && (this._recent = this._last), ct(this));
    ...
    for (var o = [], s = _e(i), l = this._first, d = Re(r), c; l; )
      l instanceof Y ? zn(l._targets, s) && (d ? (!ze || l._initted && l._ts) && l.globalTime(0) <= r && l.globalTime(l.totalDuration()) > r : !r || l.isActive()) && o.push(l) : (c = l.getTweensOf(s, r)).length && o.push.apply(o, c), l = l._next;
    return o;
    ...
    return i === void 0 && (i = this._time), Li(this, we(this, i));
  }, t.previousLabel = function(i) {
    return i === void 0 && (i = this._time), Li(this, we(this, i), 1);
    ...
    if (V._ts && (Sr(V, ma(i, V)), vr = se.frame), se.frame >= Ni) {
      Ni += ce.autoSleep || 120;
      var r = V._first;
...
var uo = function(e, t, a, i, r, o, s) {
  var l = new ie(this._pt, e, t, 0, 1, Jr, null, r), d = 0, c = 0, u, p, m, g, h, f, b, _;
  for (l.b = a, l.e = i, a += "", i += "", (b = ~i.indexOf("random(")) && (i = Xt(i)), o && (_ = [a, i], o(_, e, t), a = _[0], i = _[1]), p = a.match(Aa) || []; u = Aa.exec(i); )
  ...
  return l.c = d < i.length ? i.substring(d, i.length) : "", l.fp = s, (br.test(i) || b) && (l.e = 0), this._pt = l, l;
}, fi = function(e, t, a, i, r, o, s, l, d, c) {
  U(i) && (i = i(r || 0, e, o));
  var u = e[t], p = a !== "get" ? a : U(u) ? d ? e[t.indexOf("set") || !U(e["get" + t.substr(3)]) ? t : "get" + t.substr(3)](d) : e[t]() : u, m = U(u) ? d ? fo : Xr : bi, g;
  if (X(i) && (~i.indexOf("random(") && (i = Xt(i)), i.charAt(1) === "=" && (g = St(p, i) + (Q(p) || 0), (g || g === 0) && (i = g))), !c || p !== i || Ka)
    return !isNaN(p * i) && i !== "" ? (g = new ie(this._pt, e, t, +p || 0, i - (p || 0), typeof u == "boolean" ? bo : $r, 0, m), d && (g.fp = d), s && g.modifier(s, this, e), this._pt = g) : (!u && !(t in e) && ui(t, i), uo.call(this, e, t, p, i, m, l || ce.stringFilter, d));
}, po = function(e, t, a, i, r) {
  if (U(e) && (e = Wt(e, r, t, a, i)), !Ce(e) || e.style && e.nodeType || K(e) || fr(e))
    return X(e) ? Wt(e, r, t, a, i) : e;
  var o = {}, s;
  for (s in e)
    o[s] = Wt(e[s], r, t, a, i);
  return o;
}, Ur = function(e, t, a, i, r, o) {
  var s, l, d, c;
  if (oe[e] && (s = new oe[e]()).init(r, s.rawVars ? t[e] : po(t[e], i, r, o, a), a, i, o) !== !1 && (a._pt = l = new ie(a._pt, r, e, 0, 1, s.render, s, 0, s.priority), a !== vt))
    for (d = a._ptLookup[a._targets.indexOf(r)], c = s._props.length; c--; )
      d[s._props[c]] = l;
  return s;
}, ze, Ka, wi = function n(e, t, a) {
  var i = e.vars, r = i.ease, o = i.startAt, s = i.immediateRender, l = i.lazy, d = i.onUpdate, c = i.runBackwards, u = i.yoyoEase, p = i.keyframes, m = i.autoRevert, g = e._dur, h = e._startAt, f = e._targets, b = e.parent, _ = b && b.data === "nested" ? b.vars.targets : f, x = e._overwrite === "auto" && !si, v = e.timeline, y = i.easeReverse || u, C, k, A, S, E, O, D, I, R, P, H, B, Z;
  if (v && (!p || !r) && (r = "none"), e._ease = ut(r, Ut.ease), e._rEase = y && (ut(y) || e._ease), e._from = !v && !!i.runBackwards, e._from && (e.ratio = 1), !v || p && !i.stagger) {
    if (I = f[0] ? dt(f[0]).harness : 0, B = I && i[I.prop], C = ha(i, pi), h && (h._zTime < 0 && h.progress(1), t < 0 && c && s && !m ? h.render(-1, !0) : h.revert(c && g ? la : Bn), h._lazy = 0), o) {
      if (Ye(e._startAt = Y.set(f, pe({
        ...
        stagger: 0
      }, o))), e._startAt._dp = 0, e._startAt._sat = e, t < 0 && ($ || !s && !m) && e._startAt.revert(la), s && g && t <= 0 && a <= 0) {
        t && (e._zTime = t);
        return;
      }
    } else if (c && g && !h) {
      ...
      }, C), B && (A[I.prop] = B), Ye(e._startAt = Y.set(f, A)), e._startAt._dp = 0, e._startAt._sat = e, t < 0 && ($ ? e._startAt.revert(la) : e._startAt.render(-1, !0)), e._zTime = t, !s)
        n(e._startAt, L, L);
      else if (!t)
        return;
    }
    for (e._pt = e._ptCache = 0, l = g && te(l) || l && !g, k = 0; k < f.length; k++) {
      if (E = f[k], D = E._gsap || mi(f)[k]._gsap, e._ptLookup[k] = P = {}, ja[D.id] && We.length && pa(), H = _ === f ? k : _.indexOf(E), I && (R = new I()).init(E, B || C, e, H, _) !== !1 && (e._pt = S = new ie(e._pt, E, R.name, 0, 1, R.render, R, 0, R.priority), R._props.forEach(function(me) {
        P[me] = S;
      }), R.priority && (O = 1)), !I || B)
        for (A in C)
          oe[A] && (R = Ur(A, C, e, H, E, _)) ? R.priority && (O = 1) : P[A] = S = fi.call(e, E, A, "get", C[A], H, _, 0, i.stringFilter);
      e._op && e._op[k] && e.kill(E, e._op[k]), x && e._pt && (ze = e, V.killTweensOf(E, P, e.globalTime(t)), Z = !e.parent, ze = 0), e._pt && l && (ja[D.id] = 1);
    }
    O && Qr(e), e._onInit && e._onInit(e);
  }
  e._onUpdate = d, e._initted = (!e._op || e._pt) && !Z, p && t <= 0 && v.render(be, !0, !0);
}, ho = function(e, t, a, i, r, o, s, l) {
    ...
    for (d = e._ptCache[t] = [], p = e._ptLookup, m = e._targets.length; m--; ) {
      if (c = p[m][t], c && c.d && c.d._pt)
        for (c = c.d._pt; c && c.p !== t && c.fp !== t; )
          c = c._next;
      if (!c)
        return Ka = 1, e.vars[t] = "+=0", wi(e, s), Ka = 0, l ? jt(t + " not eligible for reset. Try splitting into individual properties") : 1;
      d.push(c);
    }
  for (m = d.length; m--; )
...
}, jr = hi + "repeat,repeatDelay,yoyo,repeatRefresh,yoyoEase,easeReverse,autoRevert", Yr = {};
ae(jr + ",id,stagger,delay,duration,paused,scrollTrigger", function(n) {
  return Yr[n] = 1;
});
var Y = /* @__PURE__ */ (function(n) {
  ...
  function e(a, i, r, o) {
    ...
    var l = s.vars, d = l.duration, c = l.delay, u = l.immediateRender, p = l.stagger, m = l.overwrite, g = l.keyframes, h = l.defaults, f = l.scrollTrigger, b = i.parent || V, _ = (K(a) || fr(a) ? Re(a[0]) : "length" in i) ? [a] : _e(a), x, v, y, C, k, A, S, E;
    if (s._targets = _.length ? mi(_) : jt("GSAP target " + a + " not found. https://gsap.com", !ce.nullTargetWarn) || [], s._ptLookup = [], s._overwrite = m, g || p || ea(d) || ea(c)) {
      i = s.vars;
      ...
      if (x = s.timeline = new ee({
        ...
        if (C = _.length, S = p && Rr(p), Ce(p))
          for (k in p)
            ~jr.indexOf(k) && (E || (E = {}), E[k] = p[k]);
        for (v = 0; v < C; v++)
          y = ha(i, Yr), y.stagger = 0, O && (y.easeReverse = O), E && Et(y, E), A = _[v], y.duration = +Wt(d, Me(s), v, A, _), y.delay = (+Wt(c, Me(s), v, A, _) || 0) - s._delay, !p && C === 1 && y.delay && (s._delay = c = y.delay, s._start += c, y.delay = 0), x.to(A, y, S ? S(v, A, _) : 0), x._ease = N.none;
        ...
        if (K(g))
          ...
          y = {};
          for (k in g)
            k === "ease" || k === "easeEach" || go(k, g[k], y, g.easeEach);
          for (k in y)
            for (I = y[k].sort(function(H, B) {
              ...
              }, P[k] = R.v, x.to(_, P, D), D += P.duration;
          x.duration() < d && x.to({}, {
      ...
      s.timeline = 0;
    return m === !0 && !si && (ze = Me(s), V.killTweensOf(_), ze = 0), ke(b, Me(s), r), i.reversed && s.reverse(), i.paused && s.paused(!0), (u || !d && !g && s._start === G(b._time) && te(u) && Wn(Me(s)) && b.data !== "nested") && (s._tTime = -L, s.render(Math.max(0, -c) || 0)), f && Mr(Me(s), f), s;
  }
  var t = e.prototype;
  return t.render = function(i, r, o) {
    ...
    if (!d)
      ...
      if (p = u, x = this.timeline, this._repeat) {
        ...
        if (p = G(u % h), u === l ? (g = this._repeat, p = d) : (f = G(u / h), g = ~~f, g && g === f ? (p = d, g--) : p > d && (p = d)), b = this._yoyo && g & 1, b && (p = d - p), f = Mt(this._tTime, h), p === s && !o && this._initted && g === f)
      ...
      for (m = this._pt; m; )
        m.r(_, m.d), m = m._next;
      x && x.render(i < 0 ? i : x._dur * x._ease(p / this._dur), r, o) || this._startAt && (this._zTime = i), this._onUpdate && !r && (c && Ya(this, i, r, o), le(this, "onUpdate")), this._repeat && g !== f && this.vars.onRepeat && !r && this.parent && le(this, "onRepeat"), (u === this._tDur || !u) && this._tTime === u && (c && !this._onUpdate && Ya(this, i, !0, !0), (i || !d) && (u === this._tDur && this._ts > 0 || !u && this._ts < 0) && Ye(this, 1), !r && !(c && !s) && (u || s || b) && (le(this, u === l ? "onComplete" : "onReverseComplete", !0), this._prom && !(u < l && this.timeScale() > 0) && this._prom()));
    }
    return this;
  }, t.targets = function() {
    ...
    return this._initted || wi(this, d), c = this._ease(d / this._dur), ho(this, i, r, o, s, c, d, l) ? this.resetTo(i, r, o, s, 1) : (va(this, 0), this.parent || Tr(this._dp, this, "_first", "_last", this._dp._sort ? "_start" : 0), this.render(0));
  }, t.kill = function(i, r) {
    ...
    if (this.timeline) {
      ...
      return this.timeline.killTweensOf(i, r, ze && ze.vars.overwrite !== !0)._first || zt(this), this.parent && o !== this.timeline.totalDuration() && Pt(this, this._dur * this.timeline._tDur / o, 0, 1), this;
    }
    ...
    for (u = this._op = this._op || [], r !== "all" && (X(r) && (h = {}, ae(r, function(_) {
      ...
      if (~l.indexOf(s[b])) {
        ...
        for (h in g)
          f = p && p[h], f && ((!("kill" in f.d) || f.d.kill(h) === !0) && ya(this, f, "_pt"), delete p[h]), m !== "all" && (m[h] = 1);
      }
...
ae("staggerTo,staggerFrom,staggerFromTo", function(n) {
  Y[n] = function() {
    var e = new ee(), t = $a.call(arguments, 0);
...
var bi = function(e, t, a) {
  ...
  return U(e[t]) ? Xr : li(e[t]) && e.setAttribute ? wo : bi;
}, $r = function(e, t) {
  ...
  function n(t, a, i, r, o, s, l, d, c) {
    this.t = a, this.s = r, this.c = o, this.p = i, this.r = s || $r, this.d = l || this, this.set = d || bi, this.pr = c || 0, this._next = t, t && (t._prev = this);
  }
  var e = n.prototype;
  return e.modifier = function(a, i, r) {
    this.mSet = this.mSet || this.set, this.set = xo, this.m = a, this.mt = r, this.tween = i;
  }, n;
})();
ae(hi + "parent,duration,ease,delay,overwrite,runBackwards,startAt,yoyo,immediateRender,repeat,repeatDelay,data,paused,reversed,lazy,callbackScope,stringFilter,id,yoyoEase,stagger,inherit,repeatRefresh,keyframes,autoRevert,scrollTrigger,easeReverse", function(n) {
  return pi[n] = 1;
});
...
ce.stringFilter = Gr;
var pt = [], ca = {}, vo = [], Bi = 0, ko = 0, Pa = function(e) {
  return (ca[e] || vo).map(function(t) {
    return t();
  });
}, Za = function() {
  var e = Date.now(), t = [];
  e - Bi > 2 && (Pa("matchMediaInit"), pt.forEach(function(a) {
    var i = a.queries, r = a.conditions, o, s, l, d;
    for (s in i)
      o = ve.matchMedia(i[s]).matches, o && (l = 1), o !== r[s] && (r[s] = o, d = 1);
    d && (a.revert(), l && t.push(a));
  }), Pa("matchMediaRevert"), t.forEach(function(a) {
  ...
  function n(t, a) {
    this.selector = a && Ja(a), this.data = [], this._r = [], this.isReverted = !1, this.id = ko++, t && this.add(t);
  }
  var e = n.prototype;
  return e.add = function(a, i, r) {
    ...
    var o = this, s = function() {
      ...
      return d && d !== o && d.data.push(o), r && (o.selector = Ja(r)), z = o, u = i.apply(o, arguments), U(u) && o._r.push(u), z = d, o.selector = c, o.isReverted = !1, u;
    };
  ...
  return e.add = function(a, i, r) {
    ...
    var o = new Kr(0, r || this.scope), s = o.conditions = {}, l, d, c;
    z && !o.selector && (o.selector = z.selector), this.contexts.push(o), i = o.add("onMatch", i), o.queries = a;
    for (d in a)
      d === "all" ? c = 1 : (l = ve.matchMedia(a[d]), l && (pt.indexOf(o) < 0 && pt.push(o), (s[d] = l.matches) && (c = 1), l.addListener ? l.addListener(Za) : l.addEventListener("change", Za)));
  ...
  quickSetter: function(e, t, a) {
    ...
    var o = oe[t], s = dt(e), l = s.harness && (s.harness.aliases || {})[t] || t, d = o ? function(c) {
      var u = new o();
      vt._pt = 0, u.init(e, a ? c + a : c, vt, 0, [e]), u.render(1, u), vt._pt && yi(1, vt);
    } : s.set(e, l);
  ...
  defaults: function(e) {
    return e && e.ease && (e.ease = ut(e.ease, Ut.ease)), Ri(Ut, e || {});
  },
  config: function(e) {
    return Ri(ce, e || {});
  },
  registerEffect: function(e) {
    ...
    (i || "").split(",").forEach(function(s) {
      ...
      return this.add(Ca[t](s, Ce(l) ? l : (d = l) && {}, this), d);
    });
  },
  ...
  parseEase: function(e, t) {
    return arguments.length ? ut(e, t) : N;
  },
  getById: function(e) {
    return V.getById(e);
  },
...
var Ao = function(e, t) {
  ...
  for (i in t)
    for (r = a.length; r--; )
      o = e._ptLookup[r][i], o && (o = o.d) && (o._pt && (o = Ao(o, i)), o && o.modifier && o.modifier(t[i], e, a[r], i));
}, Ia = function(e, t) {
  return {
    name: e,
    headless: 1,
...
}, Ia("roundProps", Qa), Ia("modifiers"), Ia("snap", Dr)) || ga;
...
N.Expo;
N.Circ;
var Fi, He, At, xi, lt, zi, vi, To = function() {
  return typeof window < "u";
}, De = {}, ot = 180 / Math.PI, Ct = Math.PI / 180, ft = Math.atan2, Hi = 1e8, ki = /([A-Z])/g, Eo = /(left|right|width|margin|padding|x)/i, Mo = /[\s,\(]\S/, Ae = {
  ...
  for (r = 0; r < e.length; r += 3)
    e[r + 1] ? e[r + 1] === 2 ? t[e[r]](e[r + 2]) : t[e[r]] = e[r + 2] : e[r + 2] ? a[e[r]] = e[r + 2] : a.removeProperty(e[r].substr(0, 2) === "--" ? e[r] : e[r].replace(ki, "-$1").toLowerCase());
  if (this.tfm) {
    for (o in this.tfm)
      i[o] = this.tfm[o];
    i.svg && (i.renderTransform(), t.setAttribute("data-svg-origin", this.svgo || "")), r = vi(), (!r || !r.isStart) && !a[W] && (tn(a), i.zOrigin && a[re] && (a[re] += " " + i.zOrigin + "px", i.zOrigin = 0, i.renderTransform()), i.uncache = 1);
  }
}, an = function(e, t) {
  var a = {
    target: e,
  ...
  return i[t] || i.getPropertyValue(t.replace(ki, "-$1").toLowerCase()) || i.getPropertyValue(t) || !a && n(e, Nt(t) || t, 1) || "";
}, Gi = "O,Moz,ms,Ms,Webkit".split(","), Nt = function(e, t, a) {
  var i = t || lt, r = i.style, o = 5;
  if (e in r && !a)
    return e;
  for (e = e.charAt(0).toUpperCase() + e.substr(1); o-- && !(Gi[o] + e in r); )
    ;
  return o < 0 ? null : (o === 3 ? "ms" : o >= 0 ? Gi[o] : "") + e;
}, ai = function() {
  To() && window.document && (Fi = window, He = Fi.document, At = He.documentElement, lt = ti("div") || {
    style: {}
  }, ti("div"), W = Nt(W), re = W + "Origin", lt.style.cssText = "border-width:0;line-height:0;position:absolute;padding:0", rn = !!Nt("perspective"), vi = ne.core.reverting, xi = 1);
}, Vi = function(e) {
  var t = e.ownerSVGElement, a = ti("svg", t && t.getAttribute("xmlns") || "http://www.w3.org/2000/svg"), i = e.cloneNode(!0), r;
  ...
  return t && (t.width || t.height) || a || (t = Vi(e)), t && !t.width && !t.x && !t.y ? {
    x: +Wi(e, ["x", "cx", "x1"]) || 0,
    y: +Wi(e, ["y", "cy", "y1"]) || 0,
    width: 0,
    height: 0
  ...
  if (t) {
    var a = e.style, i;
    t in De && t !== re && (t = W), a.removeProperty ? (i = t.substr(0, 2), (i === "ms" || t.substr(0, 6) === "webkit") && (t = "-" + t), a.removeProperty(i === "--" ? t : t.replace(ki, "-$1").toLowerCase())) : a.removeAttribute(t);
  }
}, Ge = function(e, t, a, i, r, o) {
  var s = new ie(e._pt, t, a, 0, 1, o ? en : Zr);
  ...
  var r = parseFloat(a) || 0, o = (a + "").trim().substr((r + "").length) || "px", s = lt.style, l = Eo.test(t), d = e.tagName.toLowerCase() === "svg", c = (d ? "client" : "offset") + (l ? "Width" : "Height"), u = 100, p = i === "px", m = i === "%", g, h, f, b;
  if (i === o || !r || Ui[i] || Ui[o])
    return r;
  if (o !== "px" && !p && (r = n(e, t, a, "px")), b = e.getCTM && on(e), (m || o === "%") && (De[t] || ~t.indexOf("adius")))
  ...
  if (m && (t === "height" || t === "width")) {
    var _ = e.style[t];
    e.style[t] = u + i, g = e[c], _ ? e.style[t] = _ : Xe(e, t);
  } else
    (m || o === "%") && !Go[de(h, "display")] && (s.position = de(e, "position")), h === e && (s.position = "static"), h.appendChild(lt), g = lt[c], h.removeChild(lt), s.position = "absolute";
  return l && m && (f = dt(h), f.time = se.time, f.width = h[c]), j(p ? g * r / u : g && r ? u / g * r : 0);
}, Pe = function(e, t, a, i) {
  var r;
  return xi || ai(), t in Ae && t !== "transform" && (t = Ae[t], ~t.indexOf(",") && (t = t.split(",")[0])), De[t] && t !== "transform" ? (r = Kt(e, i), r = t !== "transformOrigin" ? r[t] : r.svg ? r.origin : wa(de(e, re)) + " " + r.zOrigin + "px") : (r = e.style[t], (!r || r === "auto" || i || ~(r + "").indexOf("calc(")) && (r = fa[t] && fa[t](e, t, a) || de(e, t) || kr(e, t) || (t === "opacity" ? 1 : 0))), a && !~(r + "").trim().indexOf(" ") ? $e(e, t, r, a) + a : r;
}, Vo = function(e, t, a, i) {
  if (!a || a === "none") {
    var r = Nt(t, e, 1), o = r && de(e, r, 1);
    o && o !== a ? (t = r, a = o) : t === "borderColor" && (a = de(e, "borderTopColor"));
  }
  var s = new ie(this._pt, e.style, t, 0, 1, Jr), l = 0, d = 0, c, u, p, m, g, h, f, b, _, x, v, y;
  if (s.b = a, s.e = i, a += "", i += "", i.substring(0, 6) === "var(--" && (i = de(e, i.substring(4, i.indexOf(")")))), i === "auto" && (h = e.style[t], e.style[t] = i, i = de(e, t) || i, h ? e.style[t] = h : Xe(e, t)), c = [a, i], Gr(c), a = c[0], i = c[1], p = a.match(xt) || [], y = i.match(xt) || [], y.length) {
    for (; u = xt.exec(i); )
      f = u[0], _ = i.substring(l, u.index), g ? g = (g + 1) % 5 : (_.substr(-5) === "rgba(" || _.substr(-5) === "hsla(") && (g = 1), f !== (h = p[d++] || "") && (m = parseFloat(h) || 0, v = h.substr((m + "").length), f.charAt(1) === "=" && (f = St(m, f) + v), b = parseFloat(f), x = f.substr((b + "").length), l = xt.lastIndex - x.length, x || (x = x || ce.units[t] || v, l === i.length && (i += x, s.e += x)), v !== x && (m = $e(e, t, h, x) || 0), s._pt = {
        _next: s._pt,
        p: _ || d === 1 ? _ : ",",
        //note: SVG spec allows omission of comma/space when a negative sign is wedged between two numbers, like 2.5-5.3 instead of 2.5,-5.3 but when tweening, the negative value may switch to positive, so we insert the comma just in case.
        s: m,
    ...
    s.r = t === "display" && i === "none" ? en : Zr;
  return br.test(i) && (s.e = 0), this._pt = s, s;
}, ji = {
  top: "0%",
  bottom: "100%",
  left: "0%",
  ...
  if (t.tween && t.tween._time === t.tween._dur) {
    ...
    l && (Xe(a, W), o && (o.svg && a.removeAttribute("transform"), i.scale = i.rotate = i.translate = "none", Kt(a, 1), o.uncache = 1, tn(i)));
  }
}, fa = {
  clearProps: function(e, t, a, i, r) {
    if (r.data !== "isFromStart") {
      var o = e._pt = new ie(e._pt, t, a, 0, 0, Uo);
  ...
  */
}, Qt = [1, 0, 0, 1, 0, 0], sn = {}, ln = function(e) {
  return e === "matrix(1, 0, 0, 1, 0, 0)" || e === "none" || !e;
}, Yi = function(e) {
  var t = de(e, W);
  return ln(t) ? Qt : t.substr(7).match(wr).map(j);
}, Si = function(e, t) {
  var a = e._gsap || dt(e), i = e.style, r = Yi(e), o, s, l, d;
  return a.svg && e.getAttribute("transform") ? (l = e.transform.baseVal.consolidate().matrix, r = [l.a, l.b, l.c, l.d, l.e, l.f], r.join(",") === "1,0,0,1,0,0" ? Qt : r) : (r === Qt && !e.offsetParent && e !== At && !a.svg && (l = i.display, i.display = "block", o = e.parentNode, (!o || !e.offsetParent && !e.getBoundingClientRect().width) && (d = 1, s = e.nextElementSibling, At.appendChild(e)), r = Yi(e), l ? i.display = l : Xe(e, "display"), d && (s ? o.insertBefore(e, s) : o ? o.appendChild(e) : At.removeChild(e))), t && r.length > 6 ? [r[0], r[1], r[4], r[5], r[12], r[13]] : r);
}, ii = function(e, t, a, i, r, o) {
  var s = e._gsap, l = r || Si(e, !0), d = s.xOrigin || 0, c = s.yOrigin || 0, u = s.xOffset || 0, p = s.yOffset || 0, m = l[0], g = l[1], h = l[2], f = l[3], b = l[4], _ = l[5], x = t.split(" "), v = parseFloat(x[0]) || 0, y = parseFloat(x[1]) || 0, C, k, A, S;
  a ? l !== Qt && (k = m * f - g * h) && (A = v * (f / k) + y * (-h / k) + (h * _ - f * b) / k, S = v * (-g / k) + y * (m / k) - (m * _ - g * b) / k, v = A, y = S) : (C = nn(e), v = C.x + (~x[0].indexOf("%") ? v / 100 * C.width : v), y = C.y + (~(x[1] || x[0]).indexOf("%") ? y / 100 * C.height : y)), i || i !== !1 && s.smooth ? (b = v - d, _ = y - c, s.xOffset = u + (b * m + _ * h) - b, s.yOffset = p + (b * g + _ * f) - _) : s.xOffset = s.yOffset = 0, s.xOrigin = v, s.yOrigin = y, s.smooth = !!i, s.origin = t, s.originIsAbsolute = !!a, e.style[re] = "0px 0px", o && (Ge(o, s, "xOrigin", d, v), Ge(o, s, "yOrigin", c, y), Ge(o, s, "xOffset", u, s.xOffset), Ge(o, s, "yOffset", p, s.yOffset)), e.setAttribute("data-svg-origin", v + " " + y);
}, Kt = function(e, t) {
  var a = e._gsap || new Wr(e);
  if ("x" in a && !t && !a.uncache)
    return a;
  var i = e.style, r = a.scaleX < 0, o = "px", s = "deg", l = getComputedStyle(e), d = de(e, re) || "0", c, u, p, m, g, h, f, b, _, x, v, y, C, k, A, S, E, O, D, I, R, P, H, B, Z, me, Lt, Ot, Qe, Pi, Te, Ke;
  return c = u = p = h = f = b = _ = x = v = 0, m = g = 1, a.svg = !!(e.getCTM && on(e)), l.translate && ((l.translate !== "none" || l.scale !== "none" || l.rotate !== "none") && (i[W] = (l.translate !== "none" ? "translate3d(" + (l.translate + " 0 0").split(" ").slice(0, 3).join(", ") + ") " : "") + (l.rotate !== "none" ? "rotate(" + l.rotate + ") " : "") + (l.scale !== "none" ? "scale(" + l.scale.split(" ").join(",") + ") " : "") + (l[W] !== "none" ? l[W] : "")), i.scale = i.rotate = i.translate = "none"), k = Si(e, a.svg), a.svg && (a.uncache ? (Z = e.getBBox(), d = a.xOrigin - Z.x + "px " + (a.yOrigin - Z.y) + "px", B = "") : B = !t && e.getAttribute("data-svg-origin"), ii(e, B || d, !!B || a.originIsAbsolute, a.smooth !== !1, k)), y = a.xOrigin || 0, C = a.yOrigin || 0, k !== Qt && (O = k[0], D = k[1], I = k[2], R = k[3], c = P = k[4], u = H = k[5], k.length === 6 ? (m = Math.sqrt(O * O + D * D), g = Math.sqrt(R * R + I * I), h = O || D ? ft(D, O) * ot : 0, _ = I || R ? ft(I, R) * ot + h : 0, _ && (g *= Math.abs(Math.cos(_ * Ct))), a.svg && (c -= y - (y * O + C * I), u -= C - (y * D + C * R))) : (Ke = k[6], Pi = k[7], Lt = k[8], Ot = k[9], Qe = k[10], Te = k[11], c = k[12], u = k[13], p = k[14], A = ft(Ke, Qe), f = A * ot, A && (S = Math.cos(-A), E = Math.sin(-A), B = P * S + Lt * E, Z = H * S + Ot * E, me = Ke * S + Qe * E, Lt = P * -E + Lt * S, Ot = H * -E + Ot * S, Qe = Ke * -E + Qe * S, Te = Pi * -E + Te * S, P = B, H = Z, Ke = me), A = ft(-I, Qe), b = A * ot, A && (S = Math.cos(-A), E = Math.sin(-A), B = O * S - Lt * E, Z = D * S - Ot * E, me = I * S - Qe * E, Te = R * E + Te * S, O = B, D = Z, I = me), A = ft(D, O), h = A * ot, A && (S = Math.cos(A), E = Math.sin(A), B = O * S + D * E, Z = P * S + H * E, D = D * S - O * E, H = H * S - P * E, O = B, P = Z), f && Math.abs(f) + Math.abs(h) > 359.9 && (f = h = 0, b = 180 - b), m = j(Math.sqrt(O * O + D * D + I * I)), g = j(Math.sqrt(H * H + Ke * Ke)), A = ft(P, H), _ = Math.abs(A) > 2e-4 ? A * ot : 0, v = Te ? 1 / (Te < 0 ? -Te : Te) : 0), a.svg && (B = e.getAttribute("transform"), a.forceCSS = e.setAttribute("transform", "") || !ln(de(e, W)), B && e.setAttribute("transform", B))), Math.abs(_) > 90 && Math.abs(_) < 270 && (r ? (m *= -1, _ += h <= 0 ? 180 : -180, h += h <= 0 ? 180 : -180) : (g *= -1, _ += _ <= 0 ? 180 : -180)), t = t || a.uncache, a.x = c - ((a.xPercent = c && (!t && a.xPercent || (Math.round(e.offsetWidth / 2) === Math.round(-c) ? -50 : 0))) ? e.offsetWidth * a.xPercent / 100 : 0) + o, a.y = u - ((a.yPercent = u && (!t && a.yPercent || (Math.round(e.offsetHeight / 2) === Math.round(-u) ? -50 : 0))) ? e.offsetHeight * a.yPercent / 100 : 0) + o, a.z = p + o, a.scaleX = j(m), a.scaleY = j(g), a.rotation = j(h) + s, a.rotationX = j(f) + s, a.rotationY = j(b) + s, a.skewX = _ + s, a.skewY = x + s, a.transformPerspective = v + o, (a.zOrigin = parseFloat(d.split(" ")[2]) || !t && a.zOrigin || 0) && (i[re] = wa(d)), a.xOffset = a.yOffset = 0, a.force3D = ce.force3D, a.renderTransform = a.svg ? Yo : rn ? dn : jo, a.uncache = 0, a;
}, wa = function(e) {
...
}, Ze = "0deg", Bt = "0px", et = ") ", dn = function(e, t) {
  ...
  f !== Bt && (v += "perspective(" + f + et), (i || r) && (v += "translate(" + i + "%, " + r + "%) "), (y || o !== Bt || s !== Bt || l !== Bt) && (v += l !== Bt || y ? "translate3d(" + o + ", " + s + ", " + l + ") " : "translate(" + o + ", " + s + et), d !== Ze && (v += "rotate(" + d + et), c !== Ze && (v += "rotateY(" + c + et), u !== Ze && (v += "rotateX(" + u + et), (p !== Ze || m !== Ze) && (v += "skew(" + p + ", " + m + et), (g !== 1 || h !== 1) && (v += "scale(" + g + ", " + h + et), _.style[W] = v || "translate(0, 0)";
}, Yo = function(e, t) {
  ...
  l = parseFloat(l), d = parseFloat(d), c = parseFloat(c), c && (c = parseFloat(c), d += c, l += c), l || d ? (l *= Ct, d *= Ct, y = Math.cos(l) * u, C = Math.sin(l) * u, k = Math.sin(l - d) * -p, A = Math.cos(l - d) * p, d && (c *= Ct, S = Math.tan(d - c), S = Math.sqrt(1 + S * S), k *= S, A *= S, c && (S = Math.tan(c), S = Math.sqrt(1 + S * S), y *= S, C *= S)), y = j(y), C = j(C), k = j(k), A = j(A)) : (y = u, A = p, C = k = 0), (x && !~(o + "").indexOf("px") || v && !~(s + "").indexOf("px")) && (x = $e(m, "x", o, "px"), v = $e(m, "y", s, "px")), (g || h || f || b) && (x = j(x + g - (g * y + h * k) + f), v = j(v + h - (g * C + h * A) + b)), (i || r) && (S = m.getBBox(), x = j(x + i / 100 * S.width), v = j(v + r / 100 * S.height)), S = "matrix(" + y + "," + C + "," + k + "," + A + "," + x + "," + v + ")", m.setAttribute("transform", S), _ && (m.style[W] = S);
}, Xo = function(e, t, a, i, r) {
  var o = 360, s = X(r), l = parseFloat(r) * (s && ~r.indexOf("rad") ? ot : 1), d = l - i, c = i + d + "deg", u, p;
  return s && (u = r.split("_")[1], u === "short" && (d %= o, d !== d % (o / 2) && (d += d < 0 ? o : -o)), u === "cw" && d < 0 ? d = (d + o * Hi) % o - ~~(d / o) * o : u === "ccw" && d > 0 && (d = (d - o * Hi) % o - ~~(d / o) * o)), e._pt = p = new ie(e._pt, t, a, i, d, Po), p.e = c, p.u = "deg", e._props.push(a), p;
}, Xi = function(e, t) {
  for (var a in t)
    e[a] = t[a];
  return e;
}, $o = function(e, t, a) {
  var i = Xi({}, a._gsap), r = "perspective,force3D,transformOrigin,svgOrigin", o = a.style, s, l, d, c, u, p, m, g;
  ...
  for (l in De)
    d = i[l], c = s[l], d !== c && r.indexOf(l) < 0 && (m = Q(d), g = Q(c), u = m !== g ? $e(a, l, d, g) : parseFloat(d), p = parseFloat(c), e._pt = new ie(e._pt, s, l, u, p - u, ei), e._pt.u = g || 0, e._props.push(l));
  Xi(s, i);
};
ae("padding,margin,Width,Radius", function(n, e) {
  ...
  fa[e > 1 ? "border" + n : n] = function(s, l, d, c, u) {
    var p, m;
...
var cn = {
  ...
  init: function(e, t, a, i, r) {
    ...
    xi || ai(), this.styles = this.styles || an(e), A = this.styles.props, this.tween = a;
    for (h in t)
      if (h !== "autoRound" && (c = t[h], !(oe[h] && Ur(h, t, a, i, e, r)))) {
        if (m = typeof c, g = fa[h], m === "function" && (c = c.call(a, i, e, r), m = typeof c), m === "string" && ~c.indexOf("random(") && (c = Xt(c)), g)
          g(this, e, h, c, a) && (k = 1);
          ...
          if (l && h in l ? (d = typeof l[h] == "function" ? l[h].call(a, i, e, r) : l[h], X(d) && ~d.indexOf("random(") && (d = Xt(d)), Q(d + "") || d === "auto" || (d += ce.units[h] || Q(Pe(e, h)) || ""), (d + "").charAt(1) === "=" && (d = Pe(e, h))) : d = Pe(e, h), p = parseFloat(d), _ = m === "string" && c.charAt(1) === "=" && c.substr(0, 2), _ && (c = c.substr(2)), u = parseFloat(c), h in Ae && (h === "autoAlpha" && (p === 1 && Pe(e, "visibility") === "hidden" && u && (p = 0), A.push("visibility", 0, s.visibility), Ge(this, s, "visibility", p ? "inherit" : "hidden", u ? "inherit" : "hidden", !u)), h !== "scale" && h !== "transform" && (h = Ae[h], ~h.indexOf(",") && (h = h.split(",")[0]))), x = h in De, x) {
            ...
            if (v || (y = e._gsap, y.renderTransform && !t.parseTransform || Kt(e, t.parseTransform), C = t.smoothOrigin !== !1 && y.smooth, v = this._pt = new ie(this._pt, s, W, 0, 1, y.renderTransform, y, 0, -1), v.dep = 1), h === "scale")
              this._pt = new ie(this._pt, y, "scaleY", y.scaleY, (_ ? St(y.scaleY, _ + u) : u) - y.scaleY || 0, ei), this._pt.u = 0, o.push("scaleY", h), h += "X";
            else if (h === "transformOrigin") {
              A.push(re, 0, s[re]), c = Wo(c), y.svg ? ii(e, c, 0, C, 0, this) : (b = parseFloat(c.split(" ")[2]) || 0, b !== y.zOrigin && Ge(this, y, "zOrigin", y.zOrigin, b), Ge(this, s, h, wa(d), wa(c)));
              continue;
            } else if (h === "svgOrigin") {
              ii(e, c, 1, C, 0, this);
              continue;
            } else if (h in sn) {
              Xo(this, y, h, p, _ ? St(p, _ + c) : c);
              continue;
            } else if (h === "smoothOrigin") {
              Ge(this, y, "smooth", y.smooth, c);
              continue;
            } else if (h === "force3D") {
              y[h] = c;
              continue;
          ...
          if (x || (u || u === 0) && (p || p === 0) && !Mo.test(c) && h in s)
            f = (d + "").substr((p + "").length), u || (u = 0), b = Q(c) || (h in ce.units ? ce.units[h] : f), f !== b && (p = $e(e, h, d, b)), this._pt = new ie(this._pt, x ? y : s, h, p, (_ ? St(p, _ + u) : u) - p, !x && (b === "px" || h === "zIndex") && t.autoRound !== !1 ? Ro : ei), this._pt.u = b || 0, x && S !== c ? (this._pt.b = d, this._pt.e = S, this._pt.r = No) : f !== b && b !== "%" && (this._pt.b = d, this._pt.r = Io);
          else if (h in s)
            Vo.call(this, e, h, d, _ ? _ + c : c);
          else if (h in e)
  ...
  getSetter: function(e, t, a) {
    var i = Ae[t];
    return i && i.indexOf(",") < 0 && (t = i), t in De && t !== re && (e._gsap.x || Pe(e, "x")) ? a && zi === a ? t === "scale" ? Oo : Lo : (zi = a || {}) && (t === "scale" ? Bo : Fo) : e.style && !li(e.style[t]) ? Do : ~t.indexOf("-") ? qo : _i(e, t);
  },
  core: {
    _removeProperty: Xe,
    _getMatrix: Si
...
ne.utils.checkPrefix = Nt;
ne.core.getStyleSaver = an;
(function(n, e, t, a) {
  var i = ae(n + "," + e + "," + t, function(r) {
    De[r] = 1;
  });
  ae(e, function(r) {
    ce.units[r] = "deg", sn[r] = 1;
...
ne.registerPlugin(cn);
var w = ne.registerPlugin(cn) || ne;
w.core.Tween;
...
const Ko = [
...
], Zo = 1.28, T = (n) => Number((n * Zo).toFixed(3)), es = [2, 3, 2], qe = {
  ...
  0,
  4
], as = /* @__PURE__ */ new Set([5, 8, 10, 16]), is = [
  ...
  threadGap: 44
}, ss = "left,right,bottom,width,height,minHeight,paddingTop,paddingRight,paddingBottom,paddingLeft,borderWidth,gap", Ra = {
  paddingTop: "",
  paddingRight: "",
  paddingBottom: "",
  paddingLeft: "",
  ...
  contentWidth: 1881,
  height: 1280
}, ds = 96, Ki = ".wa-cursor-file, .wa-file-landing-clone, .wa-csv-drop, .wa-loading-logo-shadow", cs = "[data-marketing-data-sources-grid]", qa = {
  offscreenMargin: 96,
...
class us {
  constructor(e, t = {}) {
    this.root = e, this.options = t, this.chatShell = this.required("[data-chat-shell]"), this.chatBody = this.required(".wa-chat-shell__body"), this.thread = this.required("[data-chat-thread]"), this.composer = this.required("[data-chat-input]"), this.composerText = this.required("[data-composer-text]"), this.composerContents = Array.from(this.composer.children).filter(
      ...
      a.remove();
    }), this.root.querySelectorAll(Ki).forEach((a) => {
      a.remove();
  ...
  showComposer() {
    ...
    return e.set(this.composer, {
      ...
      paddingBottom: () => Math.max(Qi, this.getComposerThreadInsetForFrame(t))
    ...
    return w.timeline().set(this.composer, {
      ...
      onComplete: () => {
        w.set(this.composerContents, { visibility: "hidden" }), w.set(this.composer, {
          visibility: "hidden"
        }), w.set(this.thread, { paddingBottom: Qi }), this.pinThreadToBottom();
      }
    }, 0);
  }
  clearComposer() {
  ...
  measureComposerFullFrame() {
    w.set(this.composer, { clearProps: ss });
  ...
  assistantMessage(e) {
    ...
    return a ? i.add(
      this.streamText(a, e, {
        duration: this.getStreamDuration(e, $i),
        targetForScroll: t
      }),
      $i.startOverlap
    ) : i;
  ...
  resetMessageClasses(e) {
    e.classList.remove(...Ko), e.classList.remove("wa-message--first-active");
  }
  createCsvDropArea(e = {}) {
  ...
  getCursorFileEntryOffset(e, t) {
    const a = e.offsetWidth || 154, i = t.readPosition(), r = this.root.getBoundingClientRect().width || window.innerWidth, o = i.x + a * 0.5, s = r + qa.offscreenMargin;
    return {
      x: Math.max(0, s - o),
      y: 0
    };
  ...
  streamThinkingStepLabel(e) {
    return this.streamThinkingChild(e, ".wa-research-step__label", ns);
  }
  ...
  addThinkingElapsedTimer(e, t, a) {
    Qo(e, t, a, { reducedMotion: this.prefersReducedMotion });
  }
  ...
  setMarketingDataGridScale(e) {
    const t = this.chatBody.getBoundingClientRect(), a = getComputedStyle(this.chatBody), i = Number.parseFloat(a.paddingLeft) || 0, r = Number.parseFloat(a.paddingRight) || i, o = Math.max(0, t.width - i - r) / Da.contentWidth, s = Math.max(0, t.height) / Da.height, l = Math.min(o || 1, s || 1), d = l > 0 ? i / l : 0, c = l > 0 ? r / l : d, u = Da.contentWidth + d + c;
  ...
  createMailboxThumbprintGroup(e, t = !1) {
    ...
    return a.classList.add(e), is.forEach((i, r) => {
  ...
  createSequenceEngagement(e) {
    ...
    e.sequences.forEach((p, m) => {
      ...
      if (C?.length) {
        ...
        k.className = "wa-sequence-steps", C.forEach((I, R) => {
          const P = document.createElement("button"), H = document.createElement("span"), B = document.createElement("span"), Z = document.createElement("strong"), me = this.getSequenceStepWaitDays(I, R, C.length);
          P.className = "wa-sequence-step", P.type = "button", P.tabIndex = -1, P.dataset.stepIndex = String(R), P.dataset.stepOpen = String(R === 0), P.dataset.stepSelected = String(R === 0), P.dataset.channel = this.slugChannelName(I.channel), P.dataset.stepSubject = R === 0 ? p.subject : I.label, P.dataset.stepBody = this.getSequenceStepCopy(p, I), P.dataset.stepTemplateChannel = I.channel, P.dataset.stepTemplateLabel = I.label, P.dataset.stepTemplateSubject = R === 0 ? p.subject : I.label, P.dataset.stepTemplateBody = this.getSequenceStepCopy(p, I), me && (P.dataset.waitDays = String(me), P.dataset.stepTemplateWaitDays = String(me)), P.setAttribute("aria-pressed", String(R === 0)), P.addEventListener("click", () => {
            this.selectSequenceStep(g, R);
          }), H.className = "wa-sequence-step__channel", H.textContent = I.channel, B.className = "wa-sequence-step__copy", Z.textContent = I.label, B.append(Z), P.append(H, B), k.append(P), me && k.append(this.createSequenceWaitRow(me, R));
  ...
  getSequenceStepWaitDays(e, t, a) {
    return t >= a - 1 ? null : e.waitDays ?? es[t] ?? 1;
  }
...
`);
  ...
  clearTransientElements() {
    ...
    this.transientCleanups = [], this.root.querySelectorAll(Ki).forEach((e) => {
      w.killTweensOf(e), e.remove();
    });
  }
...
function hs(n, e) {
  const t = ts[n] ?? 0, a = 24 + n * 11 % 8, i = Math.min(100, t + a), r = ps((e - t) / (i - t));
  if (r <= 0) return 0;
  const o = as.has(n) ? 20 : 12;
...
function ia(n, e, t) {
  const a = Ai(t.seed), i = ms(n, e), r = t.speed ?? "normal", o = t.intent ?? "hover";
  ...
  const s = e.x - n.x, l = e.y - n.y, d = s / i, c = l / i, u = -c, p = d, m = a() > 0.5 ? 1 : -1, g = t.curve ?? 1, f = kt(i * (o === "drag" ? 0.1 : o === "click" ? 0.17 : 0.22) * g, 18, 150) * m * (0.72 + a() * 0.44), b = i / fs[r] + 0.16, _ = kt(b * ws[o] * bs, 0.3, 1.66), x = t.overshoot === !1 || i < 120 ? 0 : typeof t.overshoot == "number" ? t.overshoot : kt(i * 0.026, 4, 18), v = x > 0 ? {
    x: e.x + d * x,
    y: e.y + c * x
  } : e, y = {
...
const La = "button, a, [role='button'], [data-send-button], [data-result-action]", Oa = "[data-chat-input][data-visible='true'], [data-signup-field], input, textarea, [contenteditable='true']", Ba = {
  delay: 0.42,
  returnDuration: 0.18,
  segments: [
...
class xs {
  ...
  pathTweenFromFactory(e, t, a = "power2.inOut") {
    ...
    return w.fromTo(
      ...
      { t: 0 },
      {
        ...
        onUpdate: () => {
          if (!r) return;
          const o = er(r.start, r.c1, r.c2, r.end, i.t);
  ...
  renderMimicRotation(e, t) {
    ...
    if (a * a + i * i < 4) return;
    const r = Math.atan2(i, a) * 180 / Math.PI, o = vs(r - _s), s = this.rotationState + ks(this.rotationState, o) * ys;
  ...
  getModeForElement(e) {
    return e ? e.closest(La) ? "pointer" : e.closest(Oa) ? "text" : "default" : "default";
  }
  getModeForLocalPoint(e, t) {
    return this.refreshModeTargetCache(), this.findLocalHit(this.pointerTargets, e, t, La) ? "pointer" : this.findLocalHit(this.textTargets, e, t, Oa) ? "text" : "default";
  }
  ...
  refreshModeTargetCache() {
    this.modeTargetsDirty && (this.pointerTargets = Array.from(this.root.querySelectorAll(La)).reverse(), this.textTargets = Array.from(this.root.querySelectorAll(Oa)).reverse(), this.modeTargetsDirty = !1);
  }
  observeModeTargets() {
...
class As {
  ...
  createShadow(e) {
    ...
    t.dataset.loadingLogoShadow = "", t.dataset.logoMode = this.mode, this.root.append(t), w.set(t, {
      x: e.x,
      y: e.y,
      autoAlpha: Fa.startOpacity,
      scale: 1
    }), w.to(t, {
      autoAlpha: 0,
      scale: Fa.endScale,
      duration: this.options.reducedMotion ? at.reducedDuration : Fa.duration,
      ease: "power2.out",
      onComplete: () => t.remove()
    });
  }
  createElement(e) {
    ...
    const a = document.createElement("span");
    return a.className = `${e}__body`, a.append(Cs()), t.append(a), e === "wa-loading-logo" && (t.dataset.loadingLogo = "", this.root.append(t)), t;
  }
}
function Cs() {
...
const st = {
  ...
  status: "State",
  file: "File"
}, Ts = ["user", "assistant", "thinking", "component", "cursor", "file"], Es = "/api/story-draft", Ms = 800, _t = 3;
class Ps {
  constructor(e, t, a = {}) {
    this.root = e, this.sourceStories = t, this.options = a, this.stories = rr(t), this.selectedStepId = this.stories[0]?.steps[0]?.id ?? null, this.draftEndpoint = a.draftEndpoint ?? Es, this.draftAutoSave = a.draftAutoSave ?? !0;
  }
  root;
  sourceStories;
  options;
  ...
  createComponentBody(e) {
    if (e.component ??= qs(e.text), e.component.kind === "table") return this.createTableComponentBody(e, e.component);
  ...
  createDragHandle(e) {
    ...
    return t.className = "wa-builder-step__action wa-builder-step__drag", t.type = "button", t.draggable = !0, t.dataset.builderDragHandle = e, t.setAttribute("aria-label", "Drag to reorder message"), t.append(or("grip")), t;
  }
  createActionButton(e, t, a, i, r = !1) {
    const o = document.createElement("button");
    return o.className = "wa-builder-step__action", o.type = "button", o.dataset.builderAction = t, o.dataset.builderActionStep = e, o.disabled = r, o.setAttribute("aria-label", a), o.append(or(i)), o;
  }
  createField(e, t, a, i) {
  ...
  addStep(e) {
    const t = Ns(e, Ds(e), ""), a = this.activeStory.steps, i = a.findIndex((o) => o.id === this.selectedStepId), r = i >= 0 ? i + 1 : a.length;
  ...
  updateStep(e, t, a = {}) {
    ...
    i && (Object.assign(i, t), i.kind === "thinking" && Ys(i, t), this.renderExport(), this.emitChange("Draft updated", !1), a.renderThread !== !1 && (this.renderThread(), this.renderPanel()));
  }
  handleStepAction(e) {
    const t = e.dataset.builderAction, a = e.dataset.builderActionStep;
    if (!t || !a) return;
    const i = this.activeStory.steps, r = i.findIndex((o) => o.id === a);
    r < 0 || (t === "duplicate" && (i.splice(r + 1, 0, Qs(i[r])), this.selectedStepId = i[r + 1]?.id ?? a), t === "delete" && i.length > 1 && (i.splice(r, 1), this.selectedStepId = i[Math.min(r, i.length - 1)]?.id ?? null), this.render(), this.emitChange("Draft updated"));
  }
  handleDragStart(e) {
    ...
    if (rl(t) && !t?.closest("[data-builder-drag-handle]")) {
      e.preventDefault();
      return;
    }
  ...
  handleThinkingInput(e) {
    ...
    !r || !a || (r.thinking ??= Rt(r.text, r.note), Us(r.thinking, a, e.value, i), js(r), this.selectedStepId === r.id && (this.syncPanelStepText(r.text), this.syncPanelStepNote(r.note)), this.renderExport(), this.emitChange("Thinking updated", !1));
  }
  handleComponentInput(e) {
    ...
    !i?.component || !a || ($s(i.component, a, e.value, {
    ...
    }), i.text = Js(i.component), this.selectedStepId === i.id && this.syncPanelStepText(i.text), this.renderExport(), this.emitChange("Component updated", !1));
  }
  handlePanelInput(e) {
  ...
  handlePanelSelect(e) {
    e.dataset.builderPanelSelect !== "step-kind" || !this.selectedStep || !ri(e.value) || this.updateStep(this.selectedStep.id, { kind: e.value });
  }
  setStatus(e) {
    const t = this.refs;
  ...
  syncThreadThinking(e) {
    ...
    !t || !e.thinking || t.thread.querySelectorAll(
      ...
      const i = a.dataset.builderThinkingField, r = rt(a.dataset.builderThinkingItem), o = Xs(e.thinking, i, r);
  ...
  async loadRemoteDraft() {
    if (this.draftEndpoint) {
      ...
      try {
        ...
        const t = await e.json(), a = hn(t), i = a?.stories;
        if (!a || !i?.length)
          throw new Error("draft payload did not include stories");
        this.stories = a.schemaVersion === _t ? i : rr(this.sourceStories), this.activeStoryIndex = Math.min(this.activeStoryIndex, Math.max(0, this.stories.length - 1)), this.selectedStepId = this.activeStory.steps[0]?.id ?? null, this.render(), this.setStatus(a.schemaVersion === _t ? "draft loaded" : "draft upgraded"), this.options.onStoriesChange?.(this.stories, { source: "load" }), a.schemaVersion !== _t && this.queueRemoteSave();
      } catch {
  ...
  return ({
    ...
    "data-marketplace": [
      ...
      it(["Searching hiring signals, headcount, and company data"]),
      {
        ...
        component: nr("New hires at dev-tool companies", [
      ...
      it(["Checking rounds announced since February 2026"]),
      {
        ...
        component: nr("Raised in the past three months", [
          ["Jamie Chen", "Ramp", "VP of Sales"],
          ["Andre Park", "Ramp", "Head of Growth"],
          ["David Kim", "Ramp", "Head of Revenue"],
          ["Patrick Bateman", "Stripe", "COO"]
    ...
    "research-brief": [
      { kind: "user", text: "Show me 50 sales leaders that have recently visited my website.", note: "" },
      {
        ...
        component: Ls("Recent website visitors", [
...
function Qs(n) {
  return {
    ...n,
    id: mn("step"),
    component: n.component ? Ks(n.component) : void 0
  };
}
function Ks(n) {
...
function hn(n) {
  ...
  const e = typeof n.schemaVersion == "number" ? n.schemaVersion : 1, t = n.stories.map((a) => el(a)).filter((a) => !!a);
...
function el(n) {
  ...
  const e = ye(n.id), t = ye(n.label), a = ye(n.summary), i = n.steps.map((r) => tl(r)).filter((r) => !!r);
...
function tl(n) {
  ...
  return !e || !t || !ri(t) ? null : {
    id: e,
    kind: t,
    text: a ?? "",
    note: i ?? "",
    thinking: mt(n.thinking) ? al(n.thinking, a ?? "", i ?? "") : t === "thinking" ? Rt(a ?? "", i ?? "") : void 0,
    component: mt(n.component) ? JSON.parse(JSON.stringify(n.component)) : void 0
  };
}
function al(n, e, t) {
  const i = (Array.isArray(n.items) ? n.items : []).map((r, o) => il(r, o)).filter((r) => !!r);
  return i.length ? {
    title: ye(n.title) ?? Fe,
    elapsed: ye(n.elapsed) ?? ka(i.length),
    items: i
  } : Rt(e, t);
}
function il(n, e) {
  ...
  return t ? {
    ...
    disclosure: ye(n.disclosure) ?? (e === 0 ? je : ht)
  } : null;
}
function mt(n) {
...
function or(n) {
  ...
  if (e.setAttribute("viewBox", "0 0 20 20"), e.setAttribute("aria-hidden", "true"), e.setAttribute("focusable", "false"), n === "copy" && sr(e, "M7 7.5h8v8H7z M5 13H4.5a1 1 0 0 1-1-1V4.5a1 1 0 0 1 1-1H12a1 1 0 0 1 1 1V5"), n === "x" && sr(e, "M5.5 5.5l9 9 M14.5 5.5l-9 9"), n === "grip")
    for (const t of [7, 13])
...
function F(n, e, t = {}, a = !0) {
  return {
    desktop: { target: n, anchor: e, offset: Ha(t.desktop), humanOffset: a },
    tablet: { target: n, anchor: e, offset: Ha(t.tablet), humanOffset: a },
    mobile: { target: n, anchor: e, offset: Ha(t.mobile), humanOffset: a }
  };
}
const ba = {
...
}, gn = F("[data-signup-field]", "center", {
  desktop: -74,
  tablet: -66,
  mobile: -48
}), sl = F("[data-send-button]", "center"), Ci = {
  desktop: {
...
}, ll = 2.8, dl = 42, cl = 2, ul = 3, _a = "[data-chat-shell] [data-chat-thread]", pl = `${_a} [data-message-role="assistant"]:not(.wa-message--component) [data-message-body]`, hl = `${_a} [data-message-role="assistant"].wa-message--thinking .wa-research-step[data-step-state="current"] .wa-research-step__body, ${_a} [data-message-role="assistant"].wa-message--thinking .wa-research-step[data-step-state="complete"] .wa-research-step__label`, ni = 0.24, fn = 0.3, Ie = {
  ...
  switch (t.kind) {
    ...
    case "assistant":
      n.add(e.chat.assistantMessage(t.text), t.at), _l(n, e, i, {
        ...
        text: t.text,
        selector: pl,
        label: `assistant-${oi(t.text)}`,
        stepIndex: a
      });
      return;
    case "thinking": {
      const r = gl(t), o = r.items.map((s) => s.label);
    ...
    case "dataTable":
      wt(
        ...
        t.at,
        yt(`[data-data-table="${Be(t.config.id)}"]`),
        `table-${t.config.id}`
      );
      return;
    case "enrichmentPanel":
      wt(
        ...
        t.at,
        yt(`[data-enrichment-panel="${Be(t.config.id)}"]`),
    ...
    case "strategyPlans":
      wt(
        ...
        t.at,
        yt(`[data-strategy-plans~="${Be(t.plans[0]?.id ?? "strategy")}"]`),
    ...
    case "dataSourcesGrid":
      wt(
        ...
        t.at,
        yt(`[data-data-sources-grid="${Be(t.config.id)}"]`),
        `sources-${t.config.id}`
      );
      return;
    ...
    case "sequenceEngagement":
      wt(
        ...
        t.at,
        yt(`[data-sequence-engagement="${Be(t.config.id)}"]`),
...
function gl(n) {
  return "thinking" in n && n.thinking ? n.thinking : Array.isArray(n.steps) ? { items: n.steps.map(lr) } : { items: [lr(n.label ?? "")] };
}
function lr(n) {
  return typeof n == "string" ? { label: n } : n;
}
function wt(n, e, t, a, i, r) {
  n.add(t, a), n.add(wl(e, i, r), "+=0.06");
}
function fl(n, e, t, a) {
  const i = yt(
...
function wl(n, e, t) {
  const a = Ti(n).add(n.cursor.scanAcross(e, { label: t }));
  return Ei(a);
}
function bl(n, e, t, a = M.thinkingShort, i = 1, r = "thinking", o = 0) {
  const s = a * Math.max(1, i), l = i >= 3 && wn(e, t, {
    kind: "thinking",
    key: r,
    text: r,
    stepIndex: o,
  ...
  l && n.add(
    e.cursor.scanAcross(hl, {
      label: `thinking-skim-${oi(r)}`,
      match: "last",
      duration: 0.72
    }),
    "<+=0.58"
...
function wn(n, e, t) {
  ...
  if (a.length < i || e.textSkimCount >= ul) return !1;
  const r = e.textCandidateCount;
  e.textCandidateCount += 1;
  const o = e.textSkimCount === 0, s = t.stepIndex - e.lastTextSkimStep >= cl, l = xl(`${n.story.id}:${t.kind}:${r}:${t.key}`), d = r > 0 && r % 3 === 0, c = o || s && (l >= 0.58 || d);
...
function vl(n, e) {
  ...
  return e.statusBefore && t.add(n.chat.setStatus(e.statusBefore)), t.add(n.chat.showComposer(), e.statusBefore ? "-=0.02" : void 0), e.fromEntry || t.add(
    ...
    "-=0.12"
  ), e.statusAfter && t.add(n.chat.setStatus(e.statusAfter), "<"), Ei(t);
}
function Ti(n) {
  const e = n.timeline();
  return e.pause(0), e;
...
function Al(n, e) {
  return n === "hit-ground-running" ? gn : n === "data-marketplace" ? ba.dataMarketplace : n === "research-brief" ? ba.researchBrief : e.entry;
}
function Cl(n, e) {
  return n === "hit-ground-running" ? fn : n === "data-marketplace" || n === "research-brief" ? ni : e.entryLeadTime;
}
function Tl(n, e, t) {
  if (e.id === "hit-ground-running") return El(n, e);
  if (e.id === "crm-update") return Ml(n, e);
  if (e.id === "research-brief") return Pl(n, e);
  if (e.id === "csv-import-cleanup") return Il(n, e);
  const a = Nl(e);
...
function Ml(n, e) {
  ...
  if (t && vn(i, xn(t.component)), a) {
    const r = yn(a.component), o = n.chat.prepareCsvDropArea({
...
function Pl(n, e) {
  const t = Ne(e, "user"), a = Dt(e, "table"), i = Ne(e, "thinking"), r = Dt(e, "sequenceEngagement"), o = a ? Mi(a.component, "website-visitors-sales") : null, s = r ? kn(r.component, "visitor-outreach-sequences") : null, l = [];
  if (t && l.push({
    kind: "prompt",
    text: t.text,
    duration: Sn(t.text),
  ...
  if (i && l.push(Sa(i, { hold: M.thinkingMedium, at: "+=0.06" })), s) {
    const d = F(
...
function Nl(n) {
  ...
  for (const a of n.steps)
    t += a.kind === "user" ? 1 : 0, bn(e, n.id, a, t === 1);
  return e;
}
function bn(n, e, t, a = !1) {
  ...
  if (t.kind === "thinking") {
    n.push(Sa(t, { hold: M.thinkingMedium }));
    return;
  }
  ...
  t.kind !== "component" || !t.component || Rl(n, e, t);
}
function Rl(n, e, t) {
  const a = t.component;
  if (a.kind === "table") {
  ...
  if (a.kind === "enrichment") {
    n.push({ kind: "enrichmentPanel", config: Ol(a), at: "+=0.12" });
    return;
  }
  ...
  if (a.kind === "uploadedFiles") {
    n.push({ kind: "custom", build: (i) => i.chat.uploadedFilesMessage(yn(a)), at: "-=0.04" });
    return;
  }
  ...
  if (a.kind === "personalizationSwipeGame") {
    n.push({ kind: "personalizationSwipeGame", config: Hl(a), at: "+=0.06" });
    return;
  }
  if (a.kind === "sequenceEngagement") {
    n.push({ kind: "sequenceEngagement", config: kn(a, `${e}-${t.id}`), at: "-=0.02" });
    return;
  }
...
function Sa(n, e = {}) {
  return {
    kind: "thinking",
    thinking: Dl(n.thinking, n.text, n.note),
    hold: e.hold,
    at: e.at
  };
}
...
function Mi(n, e) {
  ...
  return {
    ...
    columns: t,
    rows: r[0]?.rows ?? a,
    actions: n.actions?.map(Ll),
    pagination: r.length > 1 ? {
      pageSize: i,
      totalRows: Vl(n, a.length),
      activePage: 1,
      pages: r
    } : void 0
  };
...
const Wl = [
  ...
  pagination: {
    ...
    activePage: 1,
    pages: [
      { page: 1, range: "1-10 of 50 people", rows: dr },
  ...
  },
  {
    ...
    build: (n) => Se(n, [
      ...
      { kind: "dataTable", config: Yl, at: "-=0.04" },
      {
        kind: "prompt",
      ...
      { kind: "enrichmentPanel", config: $l, at: "+=0.12" },
      { kind: "status", text: "Contacts enriched", at: "+=0.86" },
      { kind: "dataTable", config: Ql, at: "-=0.02" },
      { kind: "marketingDataSourcesGrid", config: Jl, at: "+=0.44" },
      Ve(Ie.bottomRight, "+=3")
    ])
  },
  {
    ...
    build: (n) => {
      ...
      return Se(n, [
        ...
        { kind: "custom", build: () => t.landAsUploadedFiles(Kl), at: "<" },
        ...
        { kind: "custom", build: () => n.chat.outreachStyleProfile(Zl), at: "-=0.02" },
        {
          kind: "prompt",
        ...
        { kind: "custom", build: () => n.chat.proximityLeadList(ed), at: "-=0.04" },
  ...
  },
  {
    ...
    build: (n) => {
      ...
      return Se(n, [
        ...
        { kind: "dataTable", config: nd, at: "-=0.02" },
        {
          kind: "cursorMove",
          target: e,
          options: { mode: "pointer", intent: "click", speed: "normal", label: "open-visitor-page-2" },
        ...
        { kind: "custom", build: () => n.chat.dataTableActionTooltip("website-visitors-sales", "email-sequence", !1), at: "<+=0.02" },
        { kind: "status", text: "building outreach sequence", at: "<" },
        { kind: "custom", build: () => n.chat.sequenceBuildThinking(ad), at: "+=0.06" },
        { kind: "sequenceEngagement", config: td, at: "-=0.02" },
        { kind: "custom", build: () => n.timeline().to({}, { duration: M.beat + 0.24 }), at: "+=0.04" },
        {
          kind: "cursorMove",
          target: i,
...
class sd {
  ...
  followPointer = () => {
    ...
    if (this.mode === "return") {
      const t = this.getReturnHomePoint(), a = ld((e - this.returnStartedAt) / Ga.durationMs), i = this.getReturnWavePoint(a, t), r = this.getReturnWavePoint(Math.min(1, a + 0.035), t);
      if (this.target = t, this.cursor.mimicViewportPoint(i, 1, a < 1 ? r : t), a >= 1 || Oe(this.getCursorViewportPoint(), t) <= Ga.arriveDistance) {
  ...
  updateFollowTarget(e) {
    ...
    if (this.lastPointer) {
      ...
      i > 1.5 && (this.trailDirection = {
        x: a.x / i,
        y: a.y / i
      }, this.velocity = hd(a, J.maxMomentumStep));
    }
    const t = {
  ...
  updatePlayTarget(e) {
    ...
    this.target = cd(r, this.pointer, Le.minPointerDistance, Le.viewportInset);
  }
  resumeFollowing(e) {
  ...
  getReturnWavePoint(e, t) {
    const a = this.returnStart ?? this.getCursorViewportPoint(), i = dd(e), r = t.x - a.x, o = t.y - a.y, s = Math.hypot(r, o), l = {
      x: a.x + r * i,
      y: a.y + o * i
    };
    if (s < 1) return l;
    const d = Math.sin(Math.PI * e), c = Math.sin(Math.PI * 2 * e) * d * Ga.amplitude * this.returnWaveDirection;
    return {
      x: l.x - o / s * c,
      y: l.y + r / s * c
    };
...
function ur(n, e) {
  return {
    x: cr(n.x, e, window.innerWidth - e),
    y: cr(n.y, e, window.innerHeight - e)
  };
}
function cd(n, e, t, a) {
  const i = ur(ud(n, e, t), a);
...
class gd {
  constructor(e, t, a, i, r, o, s) {
    this.root = e, this.stories = t, this.resolver = a, this.cursor = i, this.logo = r, this.chat = o, this.options = s, this.storyProgress = this.stories.map(() => 0), this.pausedCursorMimic = new sd(this.root, this.cursor, {
  ...
  seekTo(e, t = 0.28) {
    ...
    const a = fd(e), i = this.activeTimeline.duration();
  ...
  createStoryTab(e, t) {
    ...
    const o = document.createElement("span");
    o.className = "wa-story-tab__body";
    const s = document.createElement("span");
    if (s.className = "wa-story-tab__title", s.textContent = e.navLabel ?? e.label, o.append(s), e.navDescription) {
      const l = document.createElement("span");
      l.className = "wa-story-tab__description", l.textContent = e.navDescription, o.append(l);
    }
...
class bd {
  ...
  resolve(e, t = "target") {
    ...
    if (s = {
      ...
      const l = Ai(t), d = Math.min(o.width * 0.18, 18), c = Math.min(o.height * 0.18, 14);
...
function yd(n, e = {}) {
  ...
  const t = e.stories?.length ? e.stories : Cn, a = e.builderDraftEndpoint ?? "/api/story-draft", i = e.reducedMotion ?? window.matchMedia?.("(prefers-reduced-motion: reduce)").matches ?? !1, r = new bd(n), o = new As(n, r, { reducedMotion: i }), s = new us(n, { logo: o }), l = new xs(n, r, { reducedMotion: i }), d = new gd(n, t, r, l, o, s, {
    ...
    d.updateStories(kl(m, t), {
      restartActive: g.source === "load"
    });
  }, u = d.destroy.bind(d), p = e.showBuilder === !1 ? null : new Ps(n, t, {
...
function Mn(n = "[data-chatbot-stories]", e = {}) {
  return e.injectStyles !== !1 && En(), yd(vd(n), e);
}
const kd = {
  init: Mn,
  defaultStories: Cn
...
if (typeof window < "u") {
  ...
  const n = () => {
    document.querySelector("[data-chatbot-stories][data-auto-init]") && En(), document.querySelectorAll("[data-chatbot-stories][data-auto-init]").forEach((e) => {
