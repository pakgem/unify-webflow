...
function Na() {
  ...
  t.classList.add("wa-cursor-svg__tail-shape"), t.setAttribute("d", "M9.7 20.8L14.8 20.8L18.3 34.3L14.2 35.8Z");
  const a = document.createElementNS(et, "path");
  a.classList.add("wa-cursor-svg__tail-outline"), a.setAttribute("d", "M9.7 20.8L14.2 35.8L18.3 34.3L14.8 20.8"), e.append(t, a);
  ...
  return r.classList.add("wa-cursor-svg__body-outline"), r.setAttribute("d", "M22.9 21.1L2.4 1.7L2.4 30.4L10.9 21.1"), o.append(e, i, r), o;
}
function Ti(o, e, t) {
  return {
    x: o.x + (e.x - o.x) * t,
