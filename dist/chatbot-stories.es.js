...
function Rc(r, e, t) {
  ...
  if (a.kind === "table") {
    const i = Zt(a, `${e}-${t.id}`);
    Oc(e, t, i) && (i.scrollAlign = "equal-inset"), r.push({ kind: "dataTable", config: i, at: "-=0.04" });
    return;
  }
  ...
  if (a.kind === "enrichment") {
    r.push({ kind: "enrichmentPanel", config: Yc(a), at: "+=0.12" });
    return;
  }
  ...
  if (a.kind === "personalizationSwipeGame") {
    r.push({ kind: "personalizationSwipeGame", config: jc(a), at: "+=0.06" });
    return;
  }
...
function Zt(r, e) {
  const t = Bc(r, e), a = r.rows.filter((o) => o.some((s) => s.trim())).map((o, s) => Uc(o, t, s)), i = r.pagination?.pageSize ?? Nc(r.pagination?.ranges) ?? Math.min(10, a.length || 10), n = r.pagination?.ranges.map((o, s) => ({
    page: s + 1,
    range: o,
  ...
  return {
    ...
    eyebrow: r.eyebrow,
    count: r.count,
    variant: t.variant ?? Kc(r),
    columns: t.columns,
    rows: n[0]?.rows ?? a,
    actions: r.actions?.map(Wc),
    pagination: n.length > 1 ? {
      pageSize: i,
      totalRows: Xc(r, a.length),
      activePage: 1,
      pages: n
    } : void 0
  };
...
function Uc(r, e, t) {
  ...
  if (e.columns.forEach((i, n) => {
    ...
    const i = Vc(a[e.mutualConnectionKey] ?? ""), n = Gc(t);
...
function Vc(r) {
  const [e = "", t = ""] = r.split(/\s+[—–]\s+/, 2), a = e.trim().match(/^(.+?)(?:\s*\((.+)\))?$/), i = a?.[1]?.trim() || r.trim(), n = t.trim(), o = Dc[te(i).replace(/-/g, " ")], s = Hc(a?.[2]?.trim() || "", o, n);
  return {
    name: i,
    title: s.title,
    context: n,
  ...
  },
  {
    ...
    build: (r) => {
      ...
      return Pe(r, [
        ...
        { kind: "custom", build: () => r.chat.dataTableActionTooltip("website-visitors-sales", "email-sequence", !1), at: "<+=0.02" },
        { kind: "status", text: "building outreach sequence", at: "<" },
        { kind: "custom", build: () => r.chat.sequenceBuildThinking(ad), at: "+=0.06" },
  ...
  },
  {
    ...
    build: (r) => {
      ...
      return Pe(r, [
        ...
        { kind: "dataTable", config: rd, at: "+=0.08" },
        { kind: "status", text: "Cleaning CSV", at: "<" },
        {
          kind: "thinking",
          steps: [
...
class sd {
  ...
  followPointer = () => {
    ...
    if (this.mode === "return") {
      const t = this.getReturnHomePoint(), a = ld((e - this.returnStartedAt) / ti.durationMs), i = this.getReturnWavePoint(a, t), n = this.getReturnWavePoint(Math.min(1, a + 0.035), t);
  ...
  updatePlayTarget(e) {
    ...
    this.target = dd(n, this.pointer, He.minPointerDistance, He.viewportInset);
  }
  resumeFollowing(e) {
  ...
  getReturnWavePoint(e, t) {
    const a = this.returnStart ?? this.getCursorViewportPoint(), i = cd(e), n = t.x - a.x, o = t.y - a.y, s = Math.hypot(n, o), l = {
      x: a.x + n * i,
      y: a.y + o * i
    };
    if (s < 1) return l;
  ...
  isCursorTooFarFromBrowser() {
    ...
    return hd(i, e) > Z.maxBrowserDistance;
  }
  getChatShell() {
    return this.chatShell?.isConnected ? this.chatShell : (this.chatShell = this.root.querySelector("[data-chat-shell]"), this.chatShell);
  }
...
class gd {
  constructor(e, t, a, i, n, o) {
    this.root = e, this.stories = t, this.resolver = a, this.cursor = i, this.chat = n, this.options = o, this.storyProgress = this.stories.map(() => 0), this.pausedCursorMimic = new sd(this.root, this.cursor, {
  ...
  updateStories(e, t = {}) {
    if (!e.length) return;
    const a = this.stories[this.activeIndex]?.id, i = this.stories, n = new Map(this.stories.map((c, d) => [c.id, this.storyProgress[d] ?? 0])), o = this.cursor.getPosition(), s = this.playing, l = md(i, e);
...
const wd = 3, bd = /* @__PURE__ */ new Set([
  "user",
  "assistant",
  "thinking",
  "component",
...
function yd(r) {
  ...
  const e = typeof r.schemaVersion == "number" ? r.schemaVersion : 1, t = r.stories.map((a) => Ad(a)).filter((a) => !!a);
...
function Ad(r) {
  ...
  const e = Ae(r.id), t = Ae(r.label), a = Ae(r.summary), i = r.steps.map((n) => vd(n)).filter((n) => !!n);
...
function vd(r) {
  ...
  return !e || !t || !xd(t) ? null : {
    ...
    text: a ?? "",
    note: i ?? "",
    thinking: vt(r.thinking) ? kd(r.thinking, a ?? "", i ?? "") : t === "thinking" ? go(a ?? "", i ?? "") : void 0,
    component: vt(r.component) ? _d(r.component) : void 0
  };
}
function kd(r, e, t) {
  const i = (Array.isArray(r.items) ? r.items : []).map((n, o) => Sd(n, o)).filter((n) => !!n);
  return i.length ? {
    title: Ae(r.title) ?? qe,
...
async function Cd(r, e) {
  try {
    ...
    if (!t.ok) return;
    const a = yd(await t.json());
    if (!a || a.schemaVersion !== wd) return;
...
function Ed(r, e = {}) {
  Td(r);
  const t = e.stories?.length ? e.stories : ho, a = e.builderDraftEndpoint ?? "/api/story-draft", i = e.reducedMotion ?? window.matchMedia?.("(prefers-reduced-motion: reduce)").matches ?? !1, n = new fd(r), o = new Nl(r), s = new Hl(r, n, { reducedMotion: i }), l = new gd(r, t, n, s, o, {
...
function fo(r = "[data-chatbot-stories]", e = {}) {
  return e.injectStyles !== !1 && mo(), Ed(Id(r), e);
}
const Dd = {
  init: fo,
  defaultStories: ho
