...
var ge = {
  ...
  overwrite: !1,
  delay: 0
}, bi, J, G, xe = 1e8, q = 1 / xe, ai = Math.PI * 2, Ao = ai / 4, _o = 0, Qn = Math.sqrt, vo = Math.cos, ko = Math.sin, K = function(e) {
...
}, te = Array.isArray, So = /random\([^)]+\)/g, Co = /,\s*/g, Ui = /(?:-?\.?\d|\.)+/gi, Kn = /[-+=.]*\d+[.e\-+]*\d*[e\-+]*\d*/g, wt = /[-+=.]*\d+[.e-]*\d*[a-z%]*/g, Ra = /[-+=.]*\d+\.?\d*(?:e-|e\+)?\d*/gi, Xn = /[+-]=-?[.\d]+/, To = /[^,'"\[\]\s]+/gi, Eo = /^[+\-=e\s\d]*\d+[.\d]*([a-z]*|%)\s*$/i, H, Ee, ii, Ai, me = {}, ma = {}, Jn, Zn = function(e) {
  ...
  suppressEvents: !0
}, vi = {}, Xe = [], ni = {}, er, de = {}, Ia = {}, Gi = 30, ha = [], ki = "", Si = function(e) {
  var t = e[0], a, i;
  ...
  return e._gsap || Si(Ae(e))[0]._gsap;
}, tr = function(e, t, a) {
  ...
  return (me.ScrollTrigger || _i("scrollTrigger", t)) && me.ScrollTrigger.create(t, e);
  ...
  return a === void 0 && (a = []), e.forEach(function(i) {
    var n;
    return K(i) && !t || cr(i, 1) ? (n = a).push.apply(n, Ae(i)) : a.push(i);
  }) || a;
}, Ae = function(e, t, a) {
  return G && !t && G.selector ? G.selector(e) : K(e) && !a && (ii || !Tt()) ? si.call((t || Ai).querySelectorAll(e), 0) : te(e) ? Uo(e, a) : cr(e) ? si.call(e, 0) : e ? [e] : [];
}, li = function(e) {
  return e = Ae(e)[0] || Ht("Invalid scope") || {}, function(t) {
    var a = e.current || e.nativeElement || e;
    return Ae(t, a.querySelectorAll ? a : a === e ? Ht("Invalid scope") || Ai.createElement("div") : e);
  };
}, dr = function(e) {
  ...
  return K(i) ? d = u = {
    ...
    var h = (f || t).length, w = o[h], b, y, A, _, x, T, v, C, S;
    if (!w) {
      ...
      for (w = o[h] = [], b = l ? Math.min(S, h) * d - 0.5 : i % S, y = S === xe ? 0 : l ? h * u / S - 0.5 : i / S | 0, v = 0, C = xe, T = 0; T < h; T++)
        A = T % S - b, _ = y - (T / S | 0), w[T] = x = c ? Math.abs(c === "y" ? _ : A) : Qn(A * A + _ * _), x > v && (v = x), x < C && (C = x);
      i === "random" && dr(w), w.max = v - C, w.min = C, w.v = h = (parseFloat(t.amount) || parseFloat(t.each) * (S > h ? h - 1 : c ? c === "y" ? h / S : S : Math.max(S, h / S)) || 0) * (i === "edges" ? -1 : 1), w.b = h < 0 ? n - h : n, w.u = ee(t.amount || t.each) || 0, a = a && h < 0 ? es(a) : a;
    }
  ...
  var a = te(e), i, n;
  return !a && Ie(e) && (i = a = e.radius || xe, e.values ? (e = Ae(e.values), (n = !Ge(e[0])) && (i *= i)) : e = ci(e.increment)), tt(t, a ? Y(e) ? function(o) {
...
})(), jo = /hsl[a]?\(/, xr = function(e) {
  var t = e.join(" "), a;
  if (Je.lastIndex = 0, Je.test(t))
    return a = jo.test(t), e[1] = Qi(e[1], a), e[0] = Qi(e[0], a, yr(e[1])), !0;
}, Qt, ue = (function() {
  var r = Date.now, e = 500, t = 33, a = r(), i = a, n = 1e3 / 240, o = n, s = [], l, c, d, u, g, p, f = function h(w) {
    var b = r() - i, y = w === !0, A, _, x, T;
    if ((b > e || b < 0) && (a += b - t), i += b, x = i - a, A = x - o, (A > 0 || y) && (T = ++u.frame, g = x - u.time * 1e3, u.time = x = x / 1e3, o += A + (A >= n ? 4 : n - A), _ = 1), y || (l = c(h)), _)
  ...
  return u = {
    ...
    wake: function() {
      Jn && (!ii && xi() && (Ee = ii = window, Ai = Ee.document || {}, me.gsap = ce, (Ee.gsapVersions || (Ee.gsapVersions = [])).push(ce.version), Zn(ma || Ee.GreenSockGlobals || !Ee.gsap && Ee || {}), fr.forEach(wr)), d = typeof requestAnimationFrame < "u" && requestAnimationFrame, l && u.sleep(), c = d || function(w) {
    ...
    add: function(w, b, y) {
      var A = b ? function(_, x, T, v) {
        w(_, x, T, v), u.remove(A);
      } : w;
      return u.remove(w), s[y ? "unshift" : "push"](A), Tt(), A;
    },
    remove: function(w, b) {
  ...
  return a && t.length > 1 && a.config ? a.config.apply(null, ~e.indexOf("{") ? [Jo(t[1])] : Zo(e).split(",").map(ir)) : R._CE && Ko.test(e) ? R._CE("", e) : a;
}, es = function(e) {
  return function(t) {
    return 1 - e(1 - t);
  };
...
var _r = function(e, t) {
  this.id = _o++, e._gsap = this, this.target = e, this.harness = t, this.get = t ? t.get : tr, this.set = t ? t.getSetter : Pi;
...
var ne = /* @__PURE__ */ (function(r) {
  ...
  function e(a, i) {
    var n;
    return a === void 0 && (a = {}), n = r.call(this, a) || this, n.labels = {}, n.smoothChildTiming = !!a.smoothChildTiming, n.autoRemoveChildren = !!a.autoRemoveChildren, n._sort = re(a.sortChildren), H && Me(a.parent || H, Be(n), i), a.reversed && n.reverse(), a.paused && n.paused(!0), a.scrollTrigger && sr(Be(n), a.scrollTrigger), n;
  }
  var t = e.prototype;
  return t.to = function(i, n, o) {
    ...
    var s = this._time, l = this._dirty ? this.totalDuration() : this._tDur, c = this._dur, d = i <= 0 ? 0 : V(i), u = this._zTime < 0 != i < 0 && (this._initted || !c), g, p, f, h, w, b, y, A, _, x, T, v;
    if (this !== H && d > l && i >= 0 && (d = l), d !== this._tTime || o || u) {
      if (s !== this._time && c && (d += this._time - s, i += this._time - s), g = d, _ = this._start, A = this._ts, b = !A, u && (c || (s = this._zTime), (i || !n) && (this._zTime = i)), this._repeat) {
      ...
      if (this._hasPause && !this._forcing && this._lock < 2 && (y = qo(this, V(s), V(g)), y && (d -= g - (g = y._start))), this._tTime = d, this._time = g, this._act = !!A, this._initted || (this._onUpdate = this.vars.onUpdate, this._initted = 1, this._zTime = i, s = 0), !s && d && c && !n && !x && (he(this, "onStart"), this._tTime !== d))
        return this;
      if (g >= s && i >= 0)
        for (p = this._first; p; ) {
      ...
      if (y && !n && (this.pause(), y.render(g >= s ? 0 : -q)._zTime = g >= s ? 1 : -1, this._ts))
        return this._start = _, Ca(this), this.render(i, n, o);
      this._onUpdate && !n && he(this, "onUpdate", !0), (d === l && this._tTime >= this.totalDuration() || !d && s) && (_ === this._start || Math.abs(A) !== Math.abs(this._ts)) && (this._lock || ((i || !c) && (d === l && this._ts > 0 || !d && this._ts < 0) && Ze(this, 1), !n && !(i < 0 && !s) && (d || s || !l) && (he(this, d === l && i >= 0 ? "onComplete" : "onReverseComplete", !0), this._prom && !(d < l && this.timeScale() > 0) && this._prom())));
    }
    return this;
  }, t.add = function(i, n) {
    var o = this;
    ...
    for (var o = [], s = Ae(i), l = this._first, c = Ge(n), d; l; )
...
var ts = function(e, t, a, i, n, o, s) {
  ...
  Y(i) && (i = i(n || 0, e, o));
  var u = e[t], g = a !== "get" ? a : Y(u) ? c ? e[t.indexOf("set") || !Y(e["get" + t.substr(3)]) ? t : "get" + t.substr(3)](c) : e[t]() : u, p = Y(u) ? c ? os : Cr : Mi, f;
  if (K(i) && (~i.indexOf("random(") && (i = Yt(i)), i.charAt(1) === "=" && (f = yt(g, i) + (ee(g) || 0), (f || f === 0) && (i = f))), !d || g !== i || di)
    return !isNaN(g * i) && i !== "" ? (f = new se(this._pt, e, t, +g || 0, i - (g || 0), typeof u == "boolean" ? ls : Tr, 0, p), c && (f.fp = c), s && f.modifier(s, this, e), this._pt = f) : (!u && !(t in e) && _i(t, i), ts.call(this, e, t, g, i, p, l || ge.stringFilter, c));
}, as = function(e, t, a, i, n) {
  if (Y(e) && (e = Ut(e, n, t, a, i)), !Ie(e) || e.style && e.nodeType || te(e) || jn(e))
  ...
  var i = e.vars, n = i.ease, o = i.startAt, s = i.immediateRender, l = i.lazy, c = i.onUpdate, d = i.runBackwards, u = i.yoyoEase, g = i.keyframes, p = i.autoRevert, f = e._dur, h = e._startAt, w = e._targets, b = e.parent, y = b && b.data === "nested" ? b.vars.targets : w, A = e._overwrite === "auto" && !bi, _ = e.timeline, x = i.easeReverse || u, T, v, C, S, M, z, O, D, I, N, P, U, Z;
  if (_ && (!g || !n) && (n = "none"), e._ease = pt(n, Vt.ease), e._rEase = x && (pt(x) || e._ease), e._from = !_ && !!i.runBackwards, e._from && (e.ratio = 1), !_ || g && !i.stagger) {
    if (D = w[0] ? ut(w[0]).harness : 0, U = D && i[D.prop], T = wa(i, vi), h && (h._zTime < 0 && h.progress(1), t < 0 && d && s && !p ? h.render(-1, !0) : h.revert(d && f ? ua : Mo), h._lazy = 0), o) {
    ...
    for (e._pt = e._ptCache = 0, l = f && re(l) || l && !f, v = 0; v < w.length; v++) {
      if (M = w[v], O = M._gsap || Si(w)[v]._gsap, e._ptLookup[v] = N = {}, ni[O.id] && Xe.length && fa(), P = y === w ? v : y.indexOf(M), D && (I = new D()).init(M, U || T, e, P, y) !== !1 && (e._pt = S = new se(e._pt, M, I.name, 0, 1, I.render, I, 0, I.priority), I._props.forEach(function(De) {
        N[De] = S;
      }), I.priority && (z = 1)), !D || U)
        for (C in T)
          de[C] && (I = vr(C, T, e, P, M, y)) ? I.priority && (z = 1) : N[C] = S = Ti.call(e, M, C, "get", T[C], P, y, 0, i.stringFilter);
      e._op && e._op[v] && e.kill(M, e._op[v]), A && e._pt && (Ye = e, H.killTweensOf(M, N, e.globalTime(t)), Z = !e.parent, Ye = 0), e._pt && l && (ni[O.id] = 1);
    }
    z && Mr(e), e._onInit && e._onInit(e);
  }
  e._onUpdate = c, e._initted = (!e._op || e._pt) && !Z, g && t <= 0 && _.render(xe, !0, !0);
...
}, kr = ki + "repeat,repeatDelay,yoyo,repeatRefresh,yoyoEase,easeReverse,autoRevert", Sr = {};
...
var j = /* @__PURE__ */ (function(r) {
  ...
  function e(a, i, n, o) {
    ...
    var l = s.vars, c = l.duration, d = l.delay, u = l.immediateRender, g = l.stagger, p = l.overwrite, f = l.keyframes, h = l.defaults, w = l.scrollTrigger, b = i.parent || H, y = (te(a) || jn(a) ? Ge(a[0]) : "length" in i) ? [a] : Ae(a), A, _, x, T, v, C, S, M;
    if (s._targets = y.length ? Si(y) : Ht("GSAP target " + a + " not found. https://gsap.com", !ge.nullTargetWarn) || [], s._ptLookup = [], s._overwrite = p, f || g || ia(c) || ia(d)) {
      ...
      if (A = s.timeline = new ne({
        data: "nested",
        defaults: h || {},
        targets: b && b.data === "nested" ? b.vars.targets : y
      }), A.kill(), A.parent = A._dp = Be(s), A._start = 0, g || ia(c) || ia(d)) {
        if (T = y.length, S = g && ur(g), Ie(g))
          for (v in g)
            ~kr.indexOf(v) && (M || (M = {}), M[v] = g[v]);
        for (_ = 0; _ < T; _++)
          x = wa(i, Sr), x.stagger = 0, z && (x.easeReverse = z), M && kt(x, M), C = y[_], x.duration = +Ut(c, Be(s), _, C, y), x.delay = (+Ut(d, Be(s), _, C, y) || 0) - s._delay, !g && T === 1 && x.delay && (s._delay = d = x.delay, s._start += d, x.delay = 0), A.to(C, x, S ? S(_, C, y) : 0), A._ease = R.none;
        A.duration() ? c = d = 0 : s.timeline = 0;
      } else if (f) {
        Ft(fe(A.vars.defaults, {
          ease: "none"
        })), A._ease = pt(f.ease || i.ease || "none");
        var O = 0, D, I, N;
        if (te(f))
          ...
          for (v in x)
            for (D = x[v].sort(function(P, U) {
              return P.t - U.t;
            }), O = 0, _ = 0; _ < D.length; _++)
              I = D[_], N = {
                ease: I.e,
                duration: (I.t - (_ ? D[_ - 1].t : 0)) / 100 * c
              }, N[v] = I.v, A.to(y, N, O), O += N.duration;
          A.duration() < c && A.to({}, {
            duration: c - A.duration()
          });
        }
      }
      c || s.duration(c = A.duration());
    } else
      s.timeline = 0;
    return p === !0 && !bi && (Ye = Be(s), H.killTweensOf(y), Ye = 0), Me(b, Be(s), n), i.reversed && s.reverse(), i.paused && s.paused(!0), (u || !c && !f && s._start === V(b._time) && re(u) && No(Be(s)) && b.data !== "nested") && (s._tTime = -q, s.render(Math.max(0, -d) || 0)), w && sr(Be(s), w), s;
  }
  var t = e.prototype;
  return t.render = function(i, n, o) {
    var s = this._time, l = this._tDur, c = this._dur, d = i < 0, u = i > l - q && !d ? l : i < q ? 0 : i, g, p, f, h, w, b, y, A;
    if (!c)
      Bo(this, i, n, o);
    else if (u !== this._tTime || !i || o || !this._initted && this._tTime || this._startAt && this._zTime < 0 !== d || this._lazy) {
      if (g = u, A = this.timeline, this._repeat) {
      ...
      if (this._rEase) {
        ...
        if (_ !== this._inv) {
          var x = _ ? s : c - s;
          this._inv = _, this._from && (this.ratio = 1 - this.ratio), this._invRatio = this.ratio, this._invTime = s, this._invRecip = x ? (_ ? -1 : 1) / x : 0, this._invScale = _ ? -this.ratio : 1 - this.ratio, this._invEase = _ ? this._rEase : this._ease;
        }
    ...
    return this._initted || Ei(this, c), d = this._ease(c / this._dur), is(this, i, n, o, s, d, c, l) ? this.resetTo(i, n, o, s, 1) : (Ta(this, 0), this.parent || rr(this._dp, this, "_first", "_last", this._dp._sort ? "_start" : 0), this.render(0));
  }, t.kill = function(i, n) {
    if (n === void 0 && (n = "all"), !i && (!n || n === "all"))
      return this._lazy = this._pt = 0, this.parent ? Nt(this) : this.scrollTrigger && this.scrollTrigger.kill(!!J), this;
    if (this.timeline) {
...
var Mi = function(e, t, a) {
  ...
  return Y(e[t]) ? Cr : yi(e[t]) && e.setAttribute ? ss : Mi;
}, Tr = function(e, t) {
  ...
  function r(t, a, i, n, o, s, l, c, d) {
    this.t = a, this.s = n, this.c = o, this.p = i, this.r = s || Tr, this.d = l || this, this.set = c || Mi, this.pr = d || 0, this._next = t, t && (t._prev = this);
  }
  var e = r.prototype;
...
ge.stringFilter = xr;
var gt = [], pa = {}, hs = [], ji = 0, ps = 0, Oa = function(e) {
  return (pa[e] || hs).map(function(t) {
    return t();
  });
}, ui = function() {
  var e = Date.now(), t = [];
  e - ji > 2 && (Oa("matchMediaInit"), gt.forEach(function(a) {
...
R.Expo;
R.Circ;
var Ki, Qe, xt, Ii, dt, Xi, Di, ws = function() {
  return typeof window < "u";
}, Ve = {}, lt = 180 / Math.PI, At = Math.PI / 180, ft = Math.atan2, Ji = 1e8, Li = /([A-Z])/g, bs = /(left|right|width|margin|padding|x)/i, ys = /[\s,\(]\S/, Re = {
  ...
  if (this.tfm) {
    for (o in this.tfm)
      i[o] = this.tfm[o];
    i.svg && (i.renderTransform(), t.setAttribute("data-svg-origin", this.svgo || "")), n = Di(), (!n || !n.isStart) && !a[W] && (Dr(a), i.zOrigin && a[le] && (a[le] += " " + i.zOrigin + "px", i.zOrigin = 0, i.renderTransform()), i.uncache = 1);
  }
}, Lr = function(e, t) {
  var a = {
    target: e,
  ...
  ws() && window.document && (Ki = window, Qe = Ki.document, xt = Qe.documentElement, dt = pi("div") || {
    style: {}
  }, pi("div"), W = Et(W), le = W + "Origin", dt.style.cssText = "border-width:0;line-height:0;position:absolute;padding:0", Nr = !!Et("perspective"), Di = ce.core.reverting, Ii = 1);
}, $i = function(e) {
  ...
  if (p && (t === "height" || t === "width")) {
    ...
    (p || o === "%") && !Is[pe(h, "display")] && (s.position = pe(e, "position")), h === e && (s.position = "static"), h.appendChild(dt), f = dt[d], h.removeChild(dt), s.position = "absolute";
  return l && p && (w = ut(h), w.time = ue.time, w.width = h[d]), Q(g ? f * n / u : f && n ? u / f * n : 0);
}, Fe = function(e, t, a, i) {
  var n;
  return Ii || gi(), t in Re && t !== "transform" && (t = Re[t], ~t.indexOf(",") && (t = t.split(",")[0])), Ve[t] && t !== "transform" ? (n = Xt(e, i), n = t !== "transformOrigin" ? n[t] : n.svg ? n.origin : Aa(pe(e, le)) + " " + n.zOrigin + "px") : (n = e.style[t], (!n || n === "auto" || i || ~(n + "").indexOf("calc(")) && (n = xa[t] && xa[t](e, t, a) || pe(e, t) || tr(e, t) || (t === "opacity" ? 1 : 0))), a && !~(n + "").trim().indexOf(" ") ? et(e, t, n, a) + a : n;
}, Ds = function(e, t, a, i) {
  if (!a || a === "none") {
    var n = Et(t, e, 1), o = n && pe(e, n, 1);
    o && o !== a ? (t = n, a = o) : t === "borderColor" && (a = pe(e, "borderTopColor"));
  }
  var s = new se(this._pt, e.style, t, 0, 1, Er), l = 0, c = 0, d, u, g, p, f, h, w, b, y, A, _, x;
  if (s.b = a, s.e = i, a += "", i += "", i.substring(0, 6) === "var(--" && (i = pe(e, i.substring(4, i.indexOf(")")))), i === "auto" && (h = e.style[t], e.style[t] = i, i = pe(e, t) || i, h ? e.style[t] = h : $e(e, t)), d = [a, i], xr(d), a = d[0], i = d[1], g = a.match(wt) || [], x = i.match(wt) || [], x.length) {
    for (; u = wt.exec(i); )
      w = u[0], y = i.substring(l, u.index), f ? f = (f + 1) % 5 : (y.substr(-5) === "rgba(" || y.substr(-5) === "hsla(") && (f = 1), w !== (h = g[c++] || "") && (p = parseFloat(h) || 0, _ = h.substr((p + "").length), w.charAt(1) === "=" && (w = yt(p, w) + _), b = parseFloat(w), A = w.substr((b + "").length), l = wt.lastIndex - A.length, A || (A = A || ge.units[t] || _, l === i.length && (i += A, s.e += A)), _ !== A && (p = et(e, t, h, A) || 0), s._pt = {
        _next: s._pt,
        p: y || c === 1 ? y : ",",
        //note: SVG spec allows omission of comma/space when a negative sign is wedged between two numbers, like 2.5-5.3 instead of 2.5,-5.3 but when tweening, the negative value may switch to positive, so we insert the comma just in case.
        s: p,
  ...
  clearProps: function(e, t, a, i, n) {
    if (n.data !== "isFromStart") {
      var o = e._pt = new se(e._pt, t, a, 0, 0, Ns);
  ...
  */
}, Kt = [1, 0, 0, 1, 0, 0], qr = {}, Fr = function(e) {
  return e === "matrix(1, 0, 0, 1, 0, 0)" || e === "none" || !e;
}, nn = function(e) {
  var t = pe(e, W);
  return Fr(t) ? Kt : t.substr(7).match(Kn).map(Q);
}, Ni = function(e, t) {
  ...
  var s = e._gsap, l = n || Ni(e, !0), c = s.xOrigin || 0, d = s.yOrigin || 0, u = s.xOffset || 0, g = s.yOffset || 0, p = l[0], f = l[1], h = l[2], w = l[3], b = l[4], y = l[5], A = t.split(" "), _ = parseFloat(A[0]) || 0, x = parseFloat(A[1]) || 0, T, v, C, S;
  a ? l !== Kt && (v = p * w - f * h) && (C = _ * (w / v) + x * (-h / v) + (h * y - w * b) / v, S = _ * (-f / v) + x * (p / v) - (p * y - f * b) / v, _ = C, x = S) : (T = Or(e), _ = T.x + (~A[0].indexOf("%") ? _ / 100 * T.width : _), x = T.y + (~(A[1] || A[0]).indexOf("%") ? x / 100 * T.height : x)), i || i !== !1 && s.smooth ? (b = _ - c, y = x - d, s.xOffset = u + (b * p + y * h) - b, s.yOffset = g + (b * f + y * w) - y) : s.xOffset = s.yOffset = 0, s.xOrigin = _, s.yOrigin = x, s.smooth = !!i, s.origin = t, s.originIsAbsolute = !!a, e.style[le] = "0px 0px", o && (je(o, s, "xOrigin", c, _), je(o, s, "yOrigin", d, x), je(o, s, "xOffset", u, s.xOffset), je(o, s, "yOffset", g, s.yOffset)), e.setAttribute("data-svg-origin", _ + " " + x);
}, Xt = function(e, t) {
  var a = e._gsap || new _r(e);
  if ("x" in a && !t && !a.uncache)
    return a;
  var i = e.style, n = a.scaleX < 0, o = "px", s = "deg", l = getComputedStyle(e), c = pe(e, le) || "0", d, u, g, p, f, h, w, b, y, A, _, x, T, v, C, S, M, z, O, D, I, N, P, U, Z, De, ve, Mt, at, zi, Le, it;
  return d = u = g = h = w = b = y = A = _ = 0, p = f = 1, a.svg = !!(e.getCTM && Br(e)), l.translate && ((l.translate !== "none" || l.scale !== "none" || l.rotate !== "none") && (i[W] = (l.translate !== "none" ? "translate3d(" + (l.translate + " 0 0").split(" ").slice(0, 3).join(", ") + ") " : "") + (l.rotate !== "none" ? "rotate(" + l.rotate + ") " : "") + (l.scale !== "none" ? "scale(" + l.scale.split(" ").join(",") + ") " : "") + (l[W] !== "none" ? l[W] : "")), i.scale = i.rotate = i.translate = "none"), v = Ni(e, a.svg), a.svg && (a.uncache ? (Z = e.getBBox(), c = a.xOrigin - Z.x + "px " + (a.yOrigin - Z.y) + "px", U = "") : U = !t && e.getAttribute("data-svg-origin"), mi(e, U || c, !!U || a.originIsAbsolute, a.smooth !== !1, v)), x = a.xOrigin || 0, T = a.yOrigin || 0, v !== Kt && (z = v[0], O = v[1], D = v[2], I = v[3], d = N = v[4], u = P = v[5], v.length === 6 ? (p = Math.sqrt(z * z + O * O), f = Math.sqrt(I * I + D * D), h = z || O ? ft(O, z) * lt : 0, y = D || I ? ft(D, I) * lt + h : 0, y && (f *= Math.abs(Math.cos(y * At))), a.svg && (d -= x - (x * z + T * D), u -= T - (x * O + T * I))) : (it = v[6], zi = v[7], ve = v[8], Mt = v[9], at = v[10], Le = v[11], d = v[12], u = v[13], g = v[14], C = ft(it, at), w = C * lt, C && (S = Math.cos(-C), M = Math.sin(-C), U = N * S + ve * M, Z = P * S + Mt * M, De = it * S + at * M, ve = N * -M + ve * S, Mt = P * -M + Mt * S, at = it * -M + at * S, Le = zi * -M + Le * S, N = U, P = Z, it = De), C = ft(-D, at), b = C * lt, C && (S = Math.cos(-C), M = Math.sin(-C), U = z * S - ve * M, Z = O * S - Mt * M, De = D * S - at * M, Le = I * M + Le * S, z = U, O = Z, D = De), C = ft(O, z), h = C * lt, C && (S = Math.cos(C), M = Math.sin(C), U = z * S + O * M, Z = N * S + P * M, O = O * S - z * M, P = P * S - N * M, z = U, N = Z), w && Math.abs(w) + Math.abs(h) > 359.9 && (w = h = 0, b = 180 - b), p = Q(Math.sqrt(z * z + O * O + D * D)), f = Q(Math.sqrt(P * P + it * it)), C = ft(N, P), y = Math.abs(C) > 2e-4 ? C * lt : 0, _ = Le ? 1 / (Le < 0 ? -Le : Le) : 0), a.svg && (U = e.getAttribute("transform"), a.forceCSS = e.setAttribute("transform", "") || !Fr(pe(e, W)), U && e.setAttribute("transform", U))), Math.abs(y) > 90 && Math.abs(y) < 270 && (n ? (p *= -1, y += h <= 0 ? 180 : -180, h += h <= 0 ? 180 : -180) : (f *= -1, y += y <= 0 ? 180 : -180)), t = t || a.uncache, a.x = d - ((a.xPercent = d && (!t && a.xPercent || (Math.round(e.offsetWidth / 2) === Math.round(-d) ? -50 : 0))) ? e.offsetWidth * a.xPercent / 100 : 0) + o, a.y = u - ((a.yPercent = u && (!t && a.yPercent || (Math.round(e.offsetHeight / 2) === Math.round(-u) ? -50 : 0))) ? e.offsetHeight * a.yPercent / 100 : 0) + o, a.z = g + o, a.scaleX = Q(p), a.scaleY = Q(f), a.rotation = Q(h) + s, a.rotationX = Q(w) + s, a.rotationY = Q(b) + s, a.skewX = y + s, a.skewY = A + s, a.transformPerspective = _ + o, (a.zOrigin = parseFloat(c.split(" ")[2]) || !t && a.zOrigin || 0) && (i[le] = Aa(c)), a.xOffset = a.yOffset = 0, a.force3D = ge.force3D, a.renderTransform = a.svg ? Bs : Nr ? zr : Os, a.uncache = 0, a;
}, Aa = function(e) {
  ...
  var a = t || this, i = a.xPercent, n = a.yPercent, o = a.x, s = a.y, l = a.z, c = a.rotation, d = a.rotationY, u = a.rotationX, g = a.skewX, p = a.skewY, f = a.scaleX, h = a.scaleY, w = a.transformPerspective, b = a.force3D, y = a.target, A = a.zOrigin, _ = "", x = b === "auto" && e && e !== 1 || b === !0;
  if (A && (u !== nt || d !== nt)) {
    var T = parseFloat(d) * At, v = Math.sin(T), C = Math.cos(T), S;
    T = parseFloat(u) * At, S = Math.cos(T), o = qa(y, o, v * S * -A), s = qa(y, s, -Math.sin(T) * -A), l = qa(y, l, C * S * -A + A);
  }
  w !== Pt && (_ += "perspective(" + w + rt), (i || n) && (_ += "translate(" + i + "%, " + n + "%) "), (x || o !== Pt || s !== Pt || l !== Pt) && (_ += l !== Pt || x ? "translate3d(" + o + ", " + s + ", " + l + ") " : "translate(" + o + ", " + s + rt), c !== nt && (_ += "rotate(" + c + rt), d !== nt && (_ += "rotateY(" + d + rt), u !== nt && (_ += "rotateX(" + u + rt), (g !== nt || p !== nt) && (_ += "skew(" + g + ", " + p + rt), (f !== 1 || h !== 1) && (_ += "scale(" + f + ", " + h + rt), y.style[W] = _ || "translate(0, 0)";
}, Bs = function(e, t) {
  var a = t || this, i = a.xPercent, n = a.yPercent, o = a.x, s = a.y, l = a.rotation, c = a.skewX, d = a.skewY, u = a.scaleX, g = a.scaleY, p = a.target, f = a.xOrigin, h = a.yOrigin, w = a.xOffset, b = a.yOffset, y = a.forceCSS, A = parseFloat(o), _ = parseFloat(s), x, T, v, C, S;
  l = parseFloat(l), c = parseFloat(c), d = parseFloat(d), d && (d = parseFloat(d), c += d, l += d), l || c ? (l *= At, c *= At, x = Math.cos(l) * u, T = Math.sin(l) * u, v = Math.sin(l - c) * -g, C = Math.cos(l - c) * g, c && (d *= At, S = Math.tan(c - d), S = Math.sqrt(1 + S * S), v *= S, C *= S, d && (S = Math.tan(d), S = Math.sqrt(1 + S * S), x *= S, T *= S)), x = Q(x), T = Q(T), v = Q(v), C = Q(C)) : (x = u, C = g, T = v = 0), (A && !~(o + "").indexOf("px") || _ && !~(s + "").indexOf("px")) && (A = et(p, "x", o, "px"), _ = et(p, "y", s, "px")), (f || h || w || b) && (A = Q(A + f - (f * x + h * v) + w), _ = Q(_ + h - (f * T + h * C) + b)), (i || n) && (S = p.getBBox(), A = Q(A + i / 100 * S.width), _ = Q(_ + n / 100 * S.height)), S = "matrix(" + x + "," + T + "," + v + "," + C + "," + A + "," + _ + ")", p.setAttribute("transform", S), y && (p.style[W] = S);
}, qs = function(e, t, a, i, n) {
  var o = 360, s = K(n), l = parseFloat(n) * (s && ~n.indexOf("rad") ? lt : 1), c = l - i, d = i + c + "deg", u, g;
  return s && (u = n.split("_")[1], u === "short" && (c %= o, c !== c % (o / 2) && (c += c < 0 ? o : -o)), u === "cw" && c < 0 ? c = (c + o * Ji) % o - ~~(c / o) * o : u === "ccw" && c > 0 && (c = (c - o * Ji) % o - ~~(c / o) * o)), e._pt = g = new se(e._pt, t, a, i, c, xs), g.e = d, g.u = "deg", e._props.push(a), g;
}, rn = function(e, t) {
  for (var a in t)
    e[a] = t[a];
  return e;
...
var Ur = {
  ...
  init: function(e, t, a, i, n) {
    var o = this._props, s = e.style, l = a.vars.startAt, c, d, u, g, p, f, h, w, b, y, A, _, x, T, v, C, S;
    Ii || gi(), this.styles = this.styles || Lr(e), C = this.styles.props, this.tween = a;
    for (h in t)
      if (h !== "autoRound" && (d = t[h], !(de[h] && vr(h, t, a, i, e, n)))) {
        if (p = typeof d, f = xa[h], p === "function" && (d = d.call(a, i, e, n), p = typeof d), p === "string" && ~d.indexOf("random(") && (d = Yt(d)), f)
          ...
          if (l && h in l ? (c = typeof l[h] == "function" ? l[h].call(a, i, e, n) : l[h], K(c) && ~c.indexOf("random(") && (c = Yt(c)), ee(c + "") || c === "auto" || (c += ge.units[h] || ee(Fe(e, h)) || ""), (c + "").charAt(1) === "=" && (c = Fe(e, h))) : c = Fe(e, h), g = parseFloat(c), y = p === "string" && d.charAt(1) === "=" && d.substr(0, 2), y && (d = d.substr(2)), u = parseFloat(d), h in Re && (h === "autoAlpha" && (g === 1 && Fe(e, "visibility") === "hidden" && u && (g = 0), C.push("visibility", 0, s.visibility), je(this, s, "visibility", g ? "inherit" : "hidden", u ? "inherit" : "hidden", !u)), h !== "scale" && h !== "transform" && (h = Re[h], ~h.indexOf(",") && (h = h.split(",")[0]))), A = h in Ve, A) {
            ...
            if (_ || (x = e._gsap, x.renderTransform && !t.parseTransform || Xt(e, t.parseTransform), T = t.smoothOrigin !== !1 && x.smooth, _ = this._pt = new se(this._pt, s, W, 0, 1, x.renderTransform, x, 0, -1), _.dep = 1), h === "scale")
              this._pt = new se(this._pt, x, "scaleY", x.scaleY, (y ? yt(x.scaleY, y + u) : u) - x.scaleY || 0, hi), this._pt.u = 0, o.push("scaleY", h), h += "X";
            else if (h === "transformOrigin") {
              C.push(le, 0, s[le]), d = Ls(d), x.svg ? mi(e, d, 0, T, 0, this) : (b = parseFloat(d.split(" ")[2]) || 0, b !== x.zOrigin && je(this, x, "zOrigin", x.zOrigin, b), je(this, s, h, Aa(c), Aa(d)));
              continue;
            } else if (h === "svgOrigin") {
              mi(e, d, 1, T, 0, this);
              continue;
          ...
          if (A || (u || u === 0) && (g || g === 0) && !ys.test(d) && h in s)
            w = (c + "").substr((g + "").length), u || (u = 0), b = ee(d) || (h in ge.units ? ge.units[h] : w), w !== b && (g = et(e, h, c, b)), this._pt = new se(this._pt, A ? x : s, h, g, (y ? yt(g, y + u) : u) - g, !A && (b === "px" || h === "zIndex") && t.autoRound !== !1 ? vs : hi), this._pt.u = b || 0, A && S !== d ? (this._pt.b = c, this._pt.e = S, this._pt.r = _s) : w !== b && b !== "%" && (this._pt.b = c, this._pt.r = As);
          else if (h in s)
            Ds.call(this, e, h, c, y ? y + d : d);
          else if (h in e)
          ...
          A || (h in s ? C.push(h, 0, s[h]) : typeof e[h] == "function" ? C.push(h, 2, e[h]()) : C.push(h, 1, c || e[h])), o.push(h);
        }
      }
    v && Mr(this);
  },
  ...
  getSetter: function(e, t, a) {
    var i = Re[t];
    return i && i.indexOf(",") < 0 && (t = i), t in Ve && t !== le && (e._gsap.x || Fe(e, "x")) ? a && Xi === a ? t === "scale" ? Ts : Cs : (Xi = a || {}) && (t === "scale" ? Es : Ms) : e.style && !yi(e.style[t]) ? ks : ~t.indexOf("-") ? Ss : Pi(e, t);
  },
  core: {
    _removeProperty: $e,
    _getMatrix: Ni
...
const yl = [
...
], xl = 1.28, k = (r) => Number((r * xl).toFixed(3)), Al = [2, 3, 2], ae = {
  ...
  settleHold: k(0.24)
}, un = "Learning your style", _l = "Voice calibrated", hn = "73 tone & tactic rules defined", za = [
  ...
  charsPerSecond: _t.labelCharsPerSecond,
  minDuration: _t.minDuration,
  maxDuration: _t.maxDuration
}, Ml = {
  charsPerSecond: 62,
  minDuration: 0.18,
  maxDuration: 0.42
  ...
  contentWidth: 1881,
  height: 1280
}, Dl = 96, bn = ".wa-cursor-file, .wa-file-landing-clone, .wa-file-landing-label, .wa-csv-drop, .wa-signup-logo-transfer", yn = "[data-marketing-data-sources-grid]", xn = "[data-data-table]", It = "[data-table-action]", An = "[data-table-page-button]", Ll = "[data-table-page-range]", Nl = "https://cdn.jsdelivr.net/npm/simple-icons@latest/icons", Ol = "https://www.google.com/s2/favicons", Bl = {
  adyen: "adyen",
  airtable: "airtable",
  brex: "brex",
  "dbt labs": "dbt",
...
class Fl {
  ...
  dataTablePage(e, t, a = {}) {
    ...
    return i.to(n, {
      ...
      ease: "power1.out",
      onStart: () => {
        l.table = this.findDataTable(e), s && this.expectedDataTablePages.set(e, t), l.currentRows = l.table ? this.getVisibleDataTableRows(l.table) : [], l.targetRows = l.table ? this.queryElements(l.table, `.wa-data-table__row[data-page="${t}"]`) : [], l.buttons = l.table ? this.queryElements(l.table, An) : [], l.targetButton = l.buttons.find((c) => Number(c.dataset.tablePageButton) === t), l.range = l.table?.querySelector(Ll) ?? null, l.canSwitch = !!(l.table && l.targetRows.length && l.table.dataset.activePage !== String(t)), l.canSwitch && m.set(l.currentRows, { autoAlpha: 1, y: 0 });
      },
      onUpdate: () => {
  ...
  strategyPlans(e) {
    ...
    const d = this.claimComponentMessage("strategy", a), u = m.timeline().add(this.revealMessage(d, n, fn)).addLabel(s, Rl).call(() => this.setMotionHints(c), void 0, s).to(t, { ...o.to }, s);
  ...
  streamThinkingStepDetail(e) {
    return this.streamThinkingChild(e, ".wa-research-step__detail", _t);
  }
  ...
  addThinkingStepReveal(e, t, a = {}) {
    return e.to(
      ...
      a.position ?? "<"
    ).add(this.streamThinkingStepLabel(t), _t.startOverlap).add(this.streamThinkingStepDetail(t), "-=0.02");
  }
  ...
  addThinkingStepStreams(e, t) {
    t.forEach((a, i) => {
      e.add(this.streamThinkingStepLabel(a), i === 0 ? _t.startOverlap : "<");
    }), t.forEach((a, i) => {
  ...
  createDataTable(e) {
    ...
    l.className = "wa-data-table__grid";
    const c = e.renderPeople !== !1;
    l.append(this.createDataTableRow("header", e.columns, {}, e.id, void 0, c));
    for (const d of a)
      for (const u of d.rows) {
        const g = this.createDataTableRow(u.id, e.columns, u.values, e.id, d.page, c);
        d.page !== i && (g.style.display = "none", m.set(g, { autoAlpha: 0, y: 6 })), l.append(g);
      }
    return t.append(n, l), (e.actions?.length || e.pagination) && t.append(this.createDataTableFooter(e, a, i)), t;
  }
  createDataTableRow(e, t, a, i, n, o = !0) {
    const s = document.createElement("div");
    s.className = "wa-data-table__row", s.dataset.tableRow = e;
    const l = e === "header";
    l && (s.dataset.header = "true"), !l && a.source && (s.dataset.source = a.source), !l && n !== void 0 && (s.dataset.page = String(n));
    for (const c of t) {
      const d = document.createElement(l ? "strong" : "span");
      if (d.className = "wa-data-table__cell", d.dataset.columnKey = c.key, l)
        d.textContent = c.label;
      else if (o && this.shouldRenderDataTablePerson(c.key))
        d.append(this.createDataTablePerson(a, a[c.key] ?? ""));
      else if (c.key === "mutualConnection")
        d.append(this.createDataTablePerson(a, a[c.key] ?? "", {
        ...
        const u = a[c.key] ?? "", g = document.createElement("span");
        g.className = "wa-data-table__cell-text", g.textContent = u || "-", d.append(g), u || (d.dataset.empty = "true");
      }
      s.append(d);
    }
    return l && s.append(this.createDataTableAddButton(i)), s;
  }
  ...
  shouldRenderDataTablePerson(e) {
    return this.isPersonNameColumn(e);
  }
  ...
  getCompanyLogoUrl(e, t) {
    ...
    if (o) return `${Nl}/${encodeURIComponent(o)}.svg`;
  ...
  createSequenceEngagement(e) {
    ...
    if (s) {
      ...
      p.className = "wa-sequence-people-wrap", f.className = "wa-sequence-people", f.dataset.sequencePeopleRail = e.id, f.setAttribute("aria-label", "Sequence people"), p.append(f), e.sequences.forEach((h, w) => {
        const b = document.createElement("button"), y = document.createElement("span"), A = document.createElement("span"), _ = document.createElement("span"), x = document.createElement("strong"), T = document.createElement("span");
        ...
        }), y.className = "wa-sequence-person-card__avatar-wrap", A.className = "wa-sequence-person-card__avatar", A.dataset.avatarTone = String(w % 9 + 1), this.setProfileAvatar(A, h.name, h.avatarUrl), y.append(A);
        const v = this.createSequenceCompanyBadge(h.company);
        v && y.append(v), _.className = "wa-sequence-person-card__copy", x.textContent = h.name, T.textContent = [h.title, h.company].filter(Boolean).join(", "), _.append(x, T), b.append(y, _), f.append(b);
      }), l = p;
    }
    e.sequences.forEach((p, f) => {
      ...
      const A = document.createElement("span");
      A.textContent = [p.title, p.company].filter(Boolean).join(", "), b.append(y, A);
      const _ = document.createElement("span");
      _.className = "wa-sequence-card__label", _.textContent = p.signal ?? "Personalized", w.append(b, _);
      ...
      const v = p.steps;
      if (v?.length) {
        const C = document.createElement("div"), S = v[0], M = document.createElement("div"), z = document.createElement("span"), O = document.createElement("strong"), D = document.createElement("p");
        C.className = "wa-sequence-steps", v.forEach((I, N) => {
          const P = document.createElement("button"), U = document.createElement("span"), Z = document.createElement("span"), De = document.createElement("strong"), ve = this.getSequenceStepWaitDays(I, N, v.length);
          ...
          }), U.className = "wa-sequence-step__channel", U.textContent = this.formatSequenceChannelLabel(I.channel), Z.className = "wa-sequence-step__copy", De.textContent = I.label, Z.append(De), P.append(U, Z), C.append(P), ve && C.append(this.createSequenceWaitRow(ve, N));
        }), M.className = "wa-sequence-copy-panel", M.dataset.sequenceCopyPanel = "", z.className = "wa-sequence-copy-panel__meta", z.dataset.sequenceCopyMeta = "", z.textContent = S ? `${S.channel} 1` : "Email", O.className = "wa-sequence-copy-panel__subject", O.dataset.sequenceCopySubject = "", O.textContent = p.subject, D.className = "wa-sequence-copy-panel__body", D.dataset.sequenceCopyBody = "", D.textContent = S ? this.getSequenceStepCopy(p, S) : p.personalization, M.append(z, O, D), h.append(C, M);
      } else
        h.append(w, x, T);
      o.append(h);
    });
...
`);
  ...
  requestMessageScroll(e) {
    ...
    this.scheduledScrollMessage = e, !(t - this.lastStreamScrollAt < Dl) && (this.scheduledScrollFrame || (this.lastStreamScrollAt = t, this.scheduledScrollFrame = window.requestAnimationFrame(() => {
...
function zl(r, e) {
  const t = kl[r] ?? 0, a = 24 + r * 11 % 8, i = Math.min(100, t + a), n = Yr((e - t) / (i - t));
  if (n <= 0) return 0;
...
function ra(r, e, t) {
  const a = Qr(t.seed), i = Ul(r, e), n = t.speed ?? "normal", o = t.intent ?? "hover";
  ...
  const s = e.x - r.x, l = e.y - r.y, c = s / i, d = l / i, u = -d, g = c, p = a() > 0.5 ? 1 : -1, f = t.curve ?? 1, w = Bt(i * (o === "drag" ? 0.1 : o === "click" ? 0.17 : 0.22) * f, 18, 150) * p * (0.72 + a() * 0.44), b = i / Vl[n] + 0.16, y = Bt(
    ...
    0.3,
    1.98
  ), A = t.overshoot === !1 || i < 120 ? 0 : typeof t.overshoot == "number" ? t.overshoot : Bt(i * 0.026, 4, 18), _ = A > 0 ? {
    x: e.x + c * A,
    y: e.y + d * A
  } : e, x = {
  ...
  return {
    ...
    settle: v ? {
      start: _,
      c1: {
        x: _.x - c * A * 0.45 + u * w * 0.04,
        y: _.y - d * A * 0.45 + g * w * 0.04
      },
      c2: {
        x: e.x + c * A * 0.16,
        y: e.y + d * A * 0.16
...
const _a = {
  ...
  tablet: -66,
  mobile: -48
}), Zr = F("[data-signup-submit]", "center"), ac = F("[data-send-button]", "center"), Bi = {
  desktop: {
...
}, ic = 2.8, nc = 42, rc = 2, oc = 3, va = "[data-chat-shell] [data-chat-thread]", sc = `${va} [data-message-role="assistant"]:not(.wa-message--component) [data-message-body]`, lc = `${va} [data-message-role="assistant"].wa-message--thinking .wa-research-step[data-step-state="current"] .wa-research-step__body, ${va} [data-message-role="assistant"].wa-message--thinking .wa-research-step[data-step-state="complete"] .wa-research-step__label`, wi = 0.24, $r = 0.3, ze = {
...
function _c(r) {
  ...
  for (const t of r.steps) {
    ...
    const a = t.component;
    a.kind === "table" && qt(Zt(a, `${r.id}-${t.id}`)).forEach((i) => e.add(i)), a.kind === "dataSources" && jr(lo(a)).forEach((i) => e.add(i)), a.kind === "proximityList" && Kr(po(a)).forEach((i) => e.add(i)), a.kind === "sequenceEngagement" && Xr(Fi(a, `${r.id}-${t.id}`)).forEach((i) => e.add(i));
  }
  return [...e];
}
function vc(r, e) {
  return r === "hit-ground-running" ? Jr : r === "data-marketplace" ? _a.dataMarketplace : r === "research-brief" ? _a.researchBrief : e.entry;
}
function kc(r, e) {
...
function Ec(r, e) {
  const t = Ue(e, "user"), a = $t(e, "table"), i = Ue(e, "thinking"), n = $t(e, "sequenceEngagement"), o = a ? Zt(a.component, "website-visitors-sales") : null, s = n ? Fi(n.component, "visitor-outreach-sequences") : null, l = [];
...
function Mc(r, e) {
  ...
  ), o = a ? e.steps.indexOf(a) : -1, s = n.find((f) => o >= 0 && e.steps.indexOf(f) < o), l = [...n].reverse().find((f) => f !== s), c = t?.text || "may_webinar_attendees.csv", d = Pc(t, s?.component ?? l?.component), u = r.chat.prepareCsvDropArea(), g = r.chat.prepareCursorFile(c, r.cursor), p = F("[data-chat-shell]", "center", {
    desktop: { x: 0, y: 82 },
    tablet: { x: 0, y: 72 },
    mobile: { x: 0, y: 64 }
  });
  return Pe(r, [
    ...
    ...l ? [{ kind: "dataTable", config: Fc(Zt(l.component, "cleaned-webinar-attendees")), at: "-=0.04" }] : [],
...
function Oc(r, e, t) {
  ...
  if (a.kind === "table") {
    const i = Zt(a, `${e}-${t.id}`);
    e === "data-marketplace" && zc(i), Wc(e, t, i) && (i.scrollAlign = "equal-inset"), r.push({ kind: "dataTable", config: i, at: "-=0.04" });
    return;
  }
...
function Yc(r, e) {
  const t = r.columns, a = t.findIndex((d) => d.trim().toLowerCase() === "name"), i = a >= 0 ? t.findIndex((d, u) => u > a && /^role\b/i.test(d.trim())) : -1, n = a >= 0 && i >= 0, o = qi(e) ? t.findIndex((d) => d.trim().toLowerCase() === "title") : -1, s = n ? i : o >= 0 ? o : void 0, l = t.map((d, u) => u).filter((d) => d !== i && d !== o), c = l.map((d) => {
    const u = t[d] || `Column ${d + 1}`;
    return n && d === a ? {
      key: "name",
      label: "Prospect",
      width: "minmax(220px,0.95fr)"
    } : n && /^via\s+connector\b/i.test(u.trim()) ? {
      key: "mutualConnection",
      label: "Best connection",
      width: "minmax(0,1.3fr)"
    } : {
      key: jc(e, u) ?? ie(u || `column-${d + 1}`),
      label: u,
      width: Kc(e, u) ?? Qc(u, n)
    };
  });
...
function jc(r, e) {
  const t = e.trim().toLowerCase();
  if (qi(r) && t === "full name") return "fullName";
}
function Kc(r, e) {
  const t = e.trim().toLowerCase();
  if (r === "raw-webinar-attendees") {
    if (t === "name") return "110px";
    if (t === "email") return "250px";
    if (t === "company") return "minmax(120px,1fr)";
  }
  if (qi(r)) {
    if (t === "full name") return "245px";
    if (t === "work email") return "215px";
    if (t === "company") return "minmax(110px,1fr)";
  }
}
function Xc(r) {
  return r !== "raw-webinar-attendees";
}
function qi(r) {
...
const od = [
  ...
  },
  {
    ...
    build: (r) => Pe(r, [
      ...
      { kind: "marketingDataSourcesGrid", config: Nn, at: "+=1.44" },
      Ke(ze.bottomRight, "+=3")
    ])
  },
  {
    ...
    build: (r) => {
      ...
      return Pe(r, [
        ...
        { kind: "custom", build: () => r.chat.proximityLeadList(Fn), at: "-=0.04" },
...
function Rd(r) {
  ...
  const e = _e(r.id), t = _e(r.label), a = _e(r.summary), i = r.steps.map((n) => Id(n)).filter((n) => !!n);
...
function Id(r) {
  if (!vt(r)) return null;
  const e = _e(r.id), t = _e(r.kind), a = _e(r.text), i = _e(r.note);
  return !e || !t || !Md(t) ? null : {
    id: e,
    kind: t,
    text: a ?? "",
    note: i ?? "",
    thinking: vt(r.thinking) ? Dd(r.thinking, a ?? "", i ?? "") : t === "thinking" ? bo(a ?? "", i ?? "") : void 0,
...
function Dd(r, e, t) {
  ...
  return i.length ? {
    title: _e(r.title) ?? qe,
    elapsed: _e(r.elapsed) ?? Ea(i.length),
    items: i
  } : bo(e, t);
}
function Ld(r, e) {
  ...
  return t ? {
    label: t,
    detail: _e(r.detail) ?? Oi(t, e),
    disclosure: _e(r.disclosure) ?? (e === 0 ? Gt : ga)
  } : null;
}
function bo(r, e = "") {
  return {
...
function Bd(r, e = {}) {
  Od(r);
  const t = e.stories?.length ? e.stories : fo, a = e.builderDraftEndpoint ?? "/api/story-draft", i = e.reducedMotion ?? window.matchMedia?.("(prefers-reduced-motion: reduce)").matches ?? !1, n = new Sd(r), o = new Fl(r), s = new jl(r, n, { reducedMotion: i }), l = new vd(r, t, n, s, o, {
