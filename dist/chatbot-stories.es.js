...
var fe = {
  ...
  overwrite: !1,
  delay: 0
}, vi, $, H, ve = 1e8, B = 1 / ve, oi = Math.PI * 2, Ao = oi / 4, So = 0, Xn = Math.sqrt, Co = Math.cos, ko = Math.sin, J = function(e) {
...
}, ae = Array.isArray, To = /random\([^)]+\)/g, Eo = /,\s*/g, Gi = /(?:-?\.?\d|\.)+/gi, Zn = /[-+=.]*\d+[.e\-+]*\d*[e\-+]*\d*/g, yt = /[-+=.]*\d+[.e-]*\d*[a-z%]*/g, qa = /[-+=.]*\d+\.?\d*(?:e-|e\+)?\d*/gi, $n = /[+-]=-?[.\d]+/, Mo = /[^,'"\[\]\s]+/gi, Po = /^[+\-=e\s\d]*\d+[.\d]*([a-z]*|%)\s*$/i, G, Pe, si, Ci, we = {}, ba = {}, er, tr = function(e) {
  return (ba = kt(e, we)) && de;
}, ki = function(e, t) {
  return console.warn("Invalid property", e, "set to", t, "Missing plugin? gsap.registerPlugin()");
}, Wt = function(e, t) {
  return !t && console.warn(e);
}, ar = function(e, t) {
  return e && (we[e] = t) && ba && (ba[e] = t) || we;
}, Yt = function() {
  return 0;
}, Ro = {
  suppressEvents: !0,
  ...
  suppressEvents: !0
}, Ti = {}, $e = [], li = {}, ir, he = {}, La = {}, Wi = 30, ga = [], Ei = "", Mi = function(e) {
  var t = e[0], a, i;
  if (qe(t) || Q(t) || (e = [e]), !(a = (t._gsap || {}).harness)) {
  ...
  return (a = e[t]) && Q(a) ? e[t]() : Ai(a) && e.getAttribute && e.getAttribute(t) || a;
}, se = function(e, t) {
  ...
  for (li = {}, $e.length = 0, a = 0; a < e; a++)
    i = t[a], i && i._lazy && (i.render(i._lazy[0], i._lazy[1], !0)._lazy = 0);
}, Pi = function(e) {
  return !!(e._initted || e._startAt || e.add);
}, rr = function(e, t, a, i) {
  $e.length && !$ && ya(), e.render(t, a, !!($ && t < 0 && Pi(e))), $e.length && !$ && ya();
}, or = function(e) {
  var t = parseFloat(e);
  return (t || t === 0) && (e + "").match(Mo).length < 2 ? t : J(e) ? e.trim() : e;
}, sr = function(e) {
  return e;
}, be = function(e, t) {
  for (var a in t)
  ...
  for (var a in t)
    a !== "__proto__" && a !== "constructor" && a !== "prototype" && (e[a] = qe(t[a]) ? o(e[a] || (e[a] = {}), t[a]) : t[a]);
  return e;
}, xa = function(e, t) {
  var a = {}, i;
  for (i in e)
  ...
  var t = e.parent || G, a = e.keyframes ? qo(ae(e.keyframes)) : be;
  if (oe(e.inherit))
    for (; t; )
  ...
  return e._startAt && ($ ? e._startAt.revert(pa) : e.vars.immediateRender && !e.vars.autoRevert || e._startAt.render(t, !0, i));
}, Oo = function o(e) {
  ...
  var a;
  if ((t._time || !t._dur && t._initted || t._start < e._time && (t._dur || !t.add)) && (a = _a(e.rawTime(), t), (!t._dur || ta(0, t.totalDuration(), a) - t._tTime > B) && t.render(a, !0)), gt(e, t)._dp && e._initted && e._time >= e._dur && e._ts) {
  ...
  return t.parent && tt(t), t._start = V((Ve(a) ? a : a || e !== G ? xe(e, a, t) : e._time) + t._delay), t._end = V(t._start + (t.totalDuration() / Math.abs(t.timeScale()) || 0)), lr(e, t, "_first", "_last", e._sort ? "_start" : 0), di(t) || (e._recent = t), i || cr(e, t), e._ts < 0 && Pa(e, e._tTime), e;
}, dr = function(e, t) {
  return (we.ScrollTrigger || ki("scrollTrigger", t)) && we.ScrollTrigger.create(t, e);
}, ur = function(e, t, a, i, n) {
  if (Di(e, t, n), !e._initted)
    return 1;
  if (!a && e._pt && !$ && (e._dur && e.vars.lazy !== !1 || !e._dur && e.vars.lazy) && ir !== pe.frame)
  ...
  if (s && e._repeat && (l = ta(0, e._tDur, t), d = Tt(l, s), e._yoyo && d & 1 && (r = 1 - r), d !== Tt(e._tTime, s) && (n = 1 - r, e.vars.repeatRefresh && e._initted && e.invalidate())), r !== n || $ || i || e._zTime === B || !t && e._zTime) {
    if (!e._initted && ur(e, t, i, a, l))
      return;
    for (u = e._zTime, e._zTime = t || (a ? B : 0), a || (a = t && !u), e.ratio = r, e._from && (r = 1 - r), e._time = 0, e._tTime = l, c = e._pt; c; )
      c.r(r, c.d), c = c._next;
    t < 0 && ci(e, t, a, !0), e._onUpdate && !a && ge(e, "onUpdate"), l && e._repeat && !a && e.parent && ge(e, "onRepeat"), (t >= e._tDur || t < 0) && e.ratio === r && (r && tt(e, 1), !a && !$ && (ge(e, r ? "onComplete" : "onReverseComplete", !0), e._prom && e._prom()));
  ...
  return s && !i && (e._time *= r / e._dur), e._dur = r, e._tDur = n ? n < 0 ? 1e10 : V(r * (n + 1) + e._rDelay * n) : r, s > 0 && !i && Pa(e, e._tTime = e._tDur * s), e.parent && Ma(e), a || gt(e.parent, e), e;
}, ji = function(e) {
  ...
  var i = e.labels, n = e._recent || Uo, r = e.duration() >= ve ? n.endTime(!1) : e._dur, s, l, c;
  ...
  return new X(t[0], r, t[n + 1]);
}, nt = function(e, t) {
  return e || e === 0 ? t(e) : t;
}, ta = function(e, t, a) {
  return a < e ? e : a > t ? t : a;
}, te = function(e, t) {
  return !J(e) || !(t = Po.exec(e)) ? "" : t[1];
}, Ho = function(e, t, a) {
  ...
  return a === void 0 && (a = []), e.forEach(function(i) {
    var n;
    return J(i) && !t || hr(i, 1) ? (n = a).push.apply(n, Ae(i)) : a.push(i);
  }) || a;
}, Ae = function(e, t, a) {
  return H && !t && H.selector ? H.selector(e) : J(e) && !a && (si || !Mt()) ? ui.call((t || Ci).querySelectorAll(e), 0) : ae(e) ? Vo(e, a) : hr(e) ? ui.call(e, 0) : e ? [e] : [];
}, hi = function(e) {
  return e = Ae(e)[0] || Wt("Invalid scope") || {}, function(t) {
    var a = e.current || e.nativeElement || e;
    return Ae(t, a.querySelectorAll ? a : a === e ? Wt("Invalid scope") || Ci.createElement("div") : e);
  };
}, pr = function(e) {
  ...
  var t = qe(e) ? e : {
    each: e
  }, a = mt(t.ease), i = t.from || 0, n = parseFloat(t.base) || 0, r = {}, s = i > 0 && i < 1, l = isNaN(i) || s, c = t.axis, d = i, u = i;
  return J(i) ? d = u = {
    center: 0.5,
    edges: 0.5,
    end: 1
  }[i] || 0 : !s && l && (d = i[0], u = i[1]), function(p, g, f) {
    var h = (f || t).length, w = r[h], b, y, x, v, _, T, A, k, C;
    if (!w) {
      if (C = t.grid === "auto" ? 0 : (t.grid || [1, ve])[1], !C) {
        for (A = -ve; A < (A = f[C++].getBoundingClientRect().left) && C < h; )
          ;
        C < h && C--;
      }
      for (w = r[h] = [], b = l ? Math.min(C, h) * d - 0.5 : i % C, y = C === ve ? 0 : l ? h * u / C - 0.5 : i / C | 0, A = 0, k = ve, T = 0; T < h; T++)
        x = T % C - b, v = y - (T / C | 0), w[T] = _ = c ? Math.abs(c === "y" ? v : x) : Xn(x * x + v * v), _ > A && (A = _), _ < k && (k = _);
    ...
    return h = (w[p] - w.min) / w.max || 0, V(w.b + (a ? a(h) : h) * w.v) + w.u;
  };
}, pi = function(e) {
  ...
  var a = ae(e), i, n;
  return !a && qe(e) && (i = a = e.radius || ve, e.values ? (e = Ae(e.values), (n = !Ve(e[0])) && (i *= i)) : e = pi(e.increment)), nt(t, a ? Q(e) ? function(r) {
    return n = e(r), Math.abs(n - r) <= i ? n : r;
  } : function(r) {
    for (var s = parseFloat(n ? r.x : r), l = parseFloat(n ? r.y : 0), c = ve, d = 0, u = e.length, p, g; u--; )
      n ? (p = e[u].x - s, g = e[u].y - l, p = p * p + g * g) : p = Math.abs(e[u] - s), p < c && (c = p, d = u);
  ...
  var i = t - e;
  return ae(e) ? wr(e, o(0, e.length), t) : nt(a, function(n) {
    return (i + (n - e) % i) % i + e;
  });
}, jo = function o(e, t, a) {
  var i = t - e, n = i * 2;
  return ae(e) ? wr(e, o(0, e.length - 1), t) : nt(a, function(r) {
  ...
  if (!n) {
    ...
    if (a === !0 && (i = 1) && (a = null), r)
      ...
      for (d = [], u = e.length, p = u - 2, c = 1; c < u; c++)
        d.push(o(e[c - 1], e[c]));
      u--, n = function(f) {
        f *= u;
        var h = Math.min(p, ~~f);
  ...
  if (n)
    return l = i[t + "Params"], c = i.callbackScope || e, a && $e.length && ya(), s && (H = s), d = l ? n.apply(c, l) : n.call(c), H = r, d;
}, Nt = function(e) {
  return tt(e), e.scrollTrigger && e.scrollTrigger.kill(!!$), e.progress() < 1 && ge(e, "onInterrupt"), e;
}, xt, yr = [], xr = function(e) {
  if (e)
    if (e = !e.name && e.default || e, Si() || e.headless) {
      ...
      if (Mt(), e !== i) {
        if (he[t])
          return;
        be(i, be(xa(e, n), r)), kt(i.prototype, kt(n, xa(e, r))), he[i.prop = t] = i, e.targetTest && (ga.push(i), Ti[t] = 1), t = (t === "css" ? "CSS" : t.charAt(0).toUpperCase() + t.substr(1)) + "Plugin";
      }
  ...
  var i = e ? Ve(e) ? [e >> 16, e >> 8 & O, e & O] : 0 : Ot.black, n, r, s, l, c, d, u, p, g, f;
  if (!i) {
  ...
  return t && !f && (n = i[0] / O, r = i[1] / O, s = i[2] / O, u = Math.max(n, r, s), p = Math.min(n, r, s), d = (u + p) / 2, u === p ? l = c = 0 : (g = u - p, c = d > 0.5 ? g / (2 - u - p) : g / (u + p), l = u === n ? (r - s) / g + (r < s ? 6 : 0) : u === r ? (s - n) / g + 2 : (n - r) / g + 4, l *= 60), i[0] = ~~(l + 0.5), i[1] = ~~(c * 100 + 0.5), i[2] = ~~(d * 100 + 0.5)), a && i.length < 4 && (i[3] = 1), i;
}, vr = function(e) {
  var t = [], a = [], i = -1;
  ...
  if (n = n.map(function(p) {
    return (p = _r(p, t, 1)) && r + (t ? p[0] + "," + p[1] + "%," + p[2] + "%," + p[3] : p.join(",")) + ")";
  }), a && (d = vr(e), l = a.c, l.join(i) !== d.c.join(i)))
    for (c = e.replace(et, "1").split(yt), u = c.length - 1; s < u; s++)
  ...
  var o = Date.now, e = 500, t = 33, a = o(), i = a, n = 1e3 / 240, r = n, s = [], l, c, d, u, p, g, f = function h(w) {
    var b = o() - i, y = w === !0, x, v, _, T;
    if ((b > e || b < 0) && (a += b - t), i += b, _ = i - a, x = _ - r, (x > 0 || y) && (T = ++u.frame, p = _ - u.time * 1e3, u.time = _ = _ / 1e3, r += x + (x >= n ? 4 : n - x), v = 1), y || (l = c(h)), v)
  ...
  return u = {
    ...
    wake: function() {
      er && (!si && Si() && (Pe = si = window, Ci = Pe.document || {}, we.gsap = de, (Pe.gsapVersions || (Pe.gsapVersions = [])).push(de.version), tr(ba || Pe.GreenSockGlobals || !Pe.gsap && Pe || {}), yr.forEach(xr)), d = typeof requestAnimationFrame < "u" && requestAnimationFrame, l && u.sleep(), c = d || function(w) {
    ...
    add: function(w, b, y) {
      var x = b ? function(v, _, T, A) {
        w(v, _, T, A), u.remove(x);
      } : w;
      return u.remove(w), s[y ? "unshift" : "push"](x), Mt(), x;
    },
    remove: function(w, b) {
      ~(b = s.indexOf(w)) && s.splice(b, 1) && g >= b && g--;
    },
    _listeners: s
  }, u;
})(), Mt = function() {
  return !jt && pe.wake();
}, P = {}, Jo = /^[\d.\-M][\d.\-,\s]/, Zo = /["']/g, $o = function(e) {
  ...
  return a && t.length > 1 && a.config ? a.config.apply(null, ~e.indexOf("{") ? [$o(t[1])] : es(e).split(",").map(or)) : P._CE && Jo.test(e) ? P._CE("", e) : a;
}, as = function(e) {
  return function(t) {
    return 1 - e(1 - t);
  };
}, mt = function(e, t) {
  return e && (Q(e) ? e : P[e] || ts(e)) || t;
}, wt = function(e, t, a, i) {
  ...
  return se(e, function(s) {
    P[s] = we[s] = n, P[r = s.toLowerCase()] = a;
    for (var l in n)
      P[r + (l === "easeIn" ? ".in" : l === "easeOut" ? ".out" : ".inOut")] = P[s + "." + l] = n[l];
  }), n;
}, Sr = function(e) {
  return function(t) {
...
P.SteppedEase = P.steps = we.SteppedEase = {
  config: function(e, t) {
    e === void 0 && (e = 1);
...
var Cr = function(e, t) {
  ...
  function o(t) {
    this.vars = t, this._delay = +t.delay || 0, (this._repeat = t.repeat === 1 / 0 ? -2 : t.repeat || 0) && (this._rDelay = t.repeatDelay || 0, this._yoyo = !!t.yoyo || !!t.yoyoEase), this._ts = 1, Et(this, +t.duration, 1, 1), this.data = t.data, H && (this._ctx = H, H.data.push(this)), jt || pe.wake();
  }
  var e = o.prototype;
  return e.delay = function(a) {
    ...
    return (this._tTime !== a || !this._dur && !i || this._initted && Math.abs(this._zTime) === B || !this._initted && this._dur && a || !a && !this._initted && (this.add || this._ptLookup)) && (this._ts || (this._pTime = a), rr(this, a, i)), this;
  }, e.time = function(a, i) {
    ...
    return this._rts = +a || 0, this._ts = this._ps || a === -B ? 0 : this._rts, this.totalTime(ta(-Math.abs(this._delay), this.totalDuration(), n), i !== !1), Ma(this), No(this);
  }, e.paused = function(a) {
    return arguments.length ? (this._ps !== a && (this._ps = a, a ? (this._pTime = this._tTime || Math.max(-this._delay, this.rawTime()), this._ts = this._act = 0) : (Mt(), this._ts = this._rts, this.totalTime(this.parent && !this.parent.smoothChildTiming ? this.rawTime() : this._tTime || this._pTime, this.progress() === 1 && Math.abs(this._zTime) !== B && (this._tTime -= B)))), this) : this._ps;
    ...
    a === void 0 && (a = Do);
    var i = $;
    return $ = a, Pi(this) && (this.timeline && this.timeline.revert(a), this.totalTime(-0.01, a.suppressEvents)), this.data !== "nested" && a.kill !== !1 && this.kill(), $ = i, this;
    ...
    return this.totalTime(xe(this, a), oe(i));
    ...
    return new Promise(function(r) {
      var s = Q(a) ? a : sr, l = function() {
        var d = i.then;
        i.then = null, n && n(), Q(s) && (s = s(i)) && (s.then || s === i) && (i.then = d), r(s), i.then = d;
      };
...
var re = /* @__PURE__ */ (function(o) {
  ...
  function e(a, i) {
    var n;
    return a === void 0 && (a = {}), n = o.call(this, a) || this, n.labels = {}, n.smoothChildTiming = !!a.smoothChildTiming, n.autoRemoveChildren = !!a.autoRemoveChildren, n._sort = oe(a.sortChildren), G && Re(a.parent || G, Be(n), i), a.reversed && n.reverse(), a.paused && n.paused(!0), a.scrollTrigger && dr(Be(n), a.scrollTrigger), n;
  }
  var t = e.prototype;
  return t.to = function(i, n, r) {
    ...
    return n.duration = 0, n.parent = this, zt(n).repeatDelay || (n.repeat = 0), n.immediateRender = !!n.immediateRender, new X(i, n, xe(this, r), 1), this;
  }, t.call = function(i, n, r) {
    return Re(this, X.delayedCall(0, i, n), r);
  }, t.staggerTo = function(i, n, r, s, l, c, d) {
    return r.duration = n, r.stagger = r.stagger || s, r.onComplete = c, r.onCompleteParams = d, r.parent = this, new X(i, r, xe(this, l)), this;
    ...
    var s = this._time, l = this._dirty ? this.totalDuration() : this._tDur, c = this._dur, d = i <= 0 ? 0 : V(i), u = this._zTime < 0 != i < 0 && (this._initted || !c), p, g, f, h, w, b, y, x, v, _, T, A;
    if (this !== G && d > l && i >= 0 && (d = l), d !== this._tTime || r || u) {
      if (s !== this._time && c && (d += this._time - s, i += this._time - s), p = d, v = this._start, x = this._ts, b = !x, u && (c || (s = this._zTime), (i || !n) && (this._zTime = i)), this._repeat) {
        if (T = this._yoyo, w = c + this._rDelay, this._repeat < -1 && i < 0)
          return this.totalTime(w * 100 + i, n, r);
        if (p = V(d % w), d === l ? (h = this._repeat, p = c) : (_ = V(d / w), h = ~~_, h && h === _ && (p = c, h--), p > c && (p = c)), _ = Tt(this._tTime, w), !s && this._tTime && _ !== h && this._tTime - _ * w - this._dur <= 0 && (_ = h), T && h & 1 && (p = c - p, A = 1), h !== _ && !this._lock) {
          var k = T && _ & 1, C = k === (T && h & 1);
          if (h < _ && (k = !k), s = k ? 0 : d % c ? c : d, this._lock = 1, this.render(s || (A ? 0 : V(h * w)), n, !c)._lock = 0, this._tTime = d, !n && this.parent && ge(this, "onRepeat"), this.vars.repeatRefresh && !A && (this.invalidate()._lock = 1, _ = h), s && s !== this._time || b !== !this._ts || this.vars.onRepeat && !this.parent && !this._act)
            return this;
      ...
      if (this._hasPause && !this._forcing && this._lock < 2 && (y = zo(this, V(s), V(p)), y && (d -= p - (p = y._start))), this._tTime = d, this._time = p, this._act = !!x, this._initted || (this._onUpdate = this.vars.onUpdate, this._initted = 1, this._zTime = i, s = 0), !s && d && c && !n && !_ && (ge(this, "onStart"), this._tTime !== d))
        return this;
      if (p >= s && i >= 0)
        for (g = this._first; g; ) {
          if (f = g._next, (g._act || p >= g._start) && g._ts && y !== g) {
            if (g.parent !== this)
              return this.render(i, n, r);
            if (g.render(g._ts > 0 ? (p - g._start) * g._ts : (g._dirty ? g.totalDuration() : g._tDur) + (p - g._start) * g._ts, n, r), p !== this._time || !this._ts && !b) {
              y = 0, f && (d += this._zTime = -B);
              break;
            }
          }
          g = f;
        ...
        g = this._last;
        for (var M = i < 0 ? i : p; g; ) {
          if (f = g._prev, (g._act || M <= g._end) && g._ts && y !== g) {
            if (g.parent !== this)
              return this.render(i, n, r);
            if (g.render(g._ts > 0 ? (M - g._start) * g._ts : (g._dirty ? g.totalDuration() : g._tDur) + (M - g._start) * g._ts, n, r || $ && Pi(g)), p !== this._time || !this._ts && !b) {
              y = 0, f && (d += this._zTime = M ? -B : B);
              break;
            }
          }
          g = f;
      ...
      this._onUpdate && !n && ge(this, "onUpdate", !0), (d === l && this._tTime >= this.totalDuration() || !d && s) && (v === this._start || Math.abs(x) !== Math.abs(this._ts)) && (this._lock || ((i || !c) && (d === l && this._ts > 0 || !d && this._ts < 0) && tt(this, 1), !n && !(i < 0 && !s) && (d || s || !l) && (ge(this, d === l && i >= 0 ? "onComplete" : "onReverseComplete", !0), this._prom && !(d < l && this.timeScale() > 0) && this._prom())));
    }
    return this;
  }, t.add = function(i, n) {
    var r = this;
    if (Ve(n) || (n = xe(this, n, i)), !(i instanceof Kt)) {
      if (ae(i))
    ...
    for (var l = [], c = this._first; c; )
      c._start >= s && (c instanceof X ? n && l.push(c) : (r && l.push(c), i && l.push.apply(l, c.getChildren(!0, n, r)))), c = c._next;
    return l;
    ...
    return J(i) ? this.removeLabel(i) : Q(i) ? this.killTweensOf(i) : (i.parent === this && Ea(this, i), i === this._recent && (this._recent = this._last), gt(this));
  }, t.totalTime = function(i, n) {
    return arguments.length ? (this._forcing = 1, !this._dp && this._ts && (this._start = V(pe.time - (this._ts > 0 ? i / this._ts : (this.totalDuration() - i) / -this._ts))), o.prototype.totalTime.call(this, i, n), this._forcing = 0, this) : this._tTime;
  }, t.addLabel = function(i, n) {
    return this.labels[i] = xe(this, n), this;
  }, t.removeLabel = function(i) {
    return delete this.labels[i], this;
  }, t.addPause = function(i, n, r) {
    var s = X.delayedCall(0, n || Yt, r);
    return s.data = "isPause", this._hasPause = 1, Re(this, s, xe(this, i));
    ...
    for (var r = [], s = Ae(i), l = this._first, c = Ve(n), d; l; )
      l instanceof X ? Io(l._targets, s) && (c ? (!Ke || l._initted && l._ts) && l.globalTime(0) <= n && l.globalTime(l.totalDuration()) > n : !n || l.isActive()) && r.push(l) : (d = l.getTweensOf(s, n)).length && r.push.apply(r, d), l = l._next;
    return r;
  }, t.tweenTo = function(i, n) {
    n = n || {};
    var r = this, s = xe(r, i), l = n, c = l.startAt, d = l.onStart, u = l.onStartParams, p = l.immediateRender, g, f = X.to(r, be({
      ease: n.ease || "none",
      lazy: !1,
      immediateRender: !1,
      time: s,
      ...
      onStart: function() {
        if (r.pause(), !g) {
          ...
          f._dur !== w && Et(f, w, 0, 1).render(f._time, !0, !0), g = 1;
        }
        d && d.apply(f, u || []);
      }
    }, n));
    ...
    return i === void 0 && (i = this._time), Ki(this, xe(this, i));
  }, t.previousLabel = function(i) {
    return i === void 0 && (i = this._time), Ki(this, xe(this, i), 1);
    ...
    if (r._dirty) {
      for (u = r.parent; s; )
        c = s._prev, s._dirty && s.totalDuration(), d = s._start, d > l && r._sort && s._ts && !r._lock ? (r._lock = 1, Re(r, s, d - s._delay, 1)._lock = 0) : l = d, d < 0 && s._ts && (n -= d, (!u && !r._dp || u && u.smoothChildTiming) && (r._start += V(d / r._ts), r._time -= d, r._tTime -= d), r.shiftChildren(-d, !1, -1 / 0), l = 0), s._end > n && s._ts && (n = s._end), s = c;
      Et(r, r === G && r._time > n ? r._time : n, 1, 1), r._dirty = 0;
    }
    return r._tDur;
  }, e.updateRoot = function(i) {
    if (G._ts && (rr(G, _a(i, G)), ir = pe.frame), pe.frame >= Wi) {
      Wi += fe.autoSleep || 120;
      var n = G._first;
      if ((!n || !n._ts) && fe.autoSleep && pe._listeners.length < 2) {
        for (; n && !n._ts; )
          n = n._next;
        n || pe.sleep();
      }
...
var is = function(e, t, a, i, n, r, s) {
  var l = new le(this._pt, e, t, 0, 1, Rr, null, n), c = 0, d = 0, u, p, g, f, h, w, b, y;
  for (l.b = a, l.e = i, a += "", i += "", (b = ~i.indexOf("random(")) && (i = Qt(i)), r && (y = [a, i], r(y, e, t), a = y[0], i = y[1]), p = a.match(qa) || []; u = qa.exec(i); )
    f = u[0], h = i.substring(c, u.index), g ? g = (g + 1) % 5 : h.substr(-5) === "rgba(" && (g = 1), f !== p[d++] && (w = parseFloat(p[d - 1]) || 0, l._pt = {
      _next: l._pt,
      p: h || d === 1 ? h : ",",
      //note: SVG spec allows omission of comma/space when a negative sign is wedged between two numbers, like 2.5-5.3 instead of 2.5,-5.3 but when tweening, the negative value may switch to positive, so we insert the comma just in case.
      s: w,
      c: f.charAt(1) === "=" ? _t(w, f) - w : parseFloat(f) - w,
  ...
  Q(i) && (i = i(n || 0, e, r));
  var u = e[t], p = a !== "get" ? a : Q(u) ? c ? e[t.indexOf("set") || !Q(e["get" + t.substr(3)]) ? t : "get" + t.substr(3)](c) : e[t]() : u, g = Q(u) ? c ? ls : Mr : Ii, f;
  if (J(i) && (~i.indexOf("random(") && (i = Qt(i)), i.charAt(1) === "=" && (f = _t(p, i) + (te(p) || 0), (f || f === 0) && (i = f))), !d || p !== i || gi)
    return !isNaN(p * i) && i !== "" ? (f = new le(this._pt, e, t, +p || 0, i - (p || 0), typeof u == "boolean" ? ds : Pr, 0, g), c && (f.fp = c), s && f.modifier(s, this, e), this._pt = f) : (!u && !(t in e) && ki(t, i), is.call(this, e, t, p, i, g, l || fe.stringFilter, c));
}, ns = function(e, t, a, i, n) {
  if (Q(e) && (e = Ht(e, n, t, a, i)), !qe(e) || e.style && e.nodeType || ae(e) || Jn(e))
    return J(e) ? Ht(e, n, t, a, i) : e;
  var r = {}, s;
  for (s in e)
    r[s] = Ht(e[s], n, t, a, i);
  return r;
  ...
  var s, l, c, d;
  if (he[e] && (s = new he[e]()).init(n, s.rawVars ? t[e] : ns(t[e], i, n, r, a), a, i, r) !== !1 && (a._pt = l = new le(a._pt, n, e, 0, 1, s.render, s, 0, s.priority), a !== xt))
    for (c = a._ptLookup[a._targets.indexOf(n)], d = s._props.length; d--; )
      c[s._props[d]] = l;
  return s;
}, Ke, gi, Di = function o(e, t, a) {
  var i = e.vars, n = i.ease, r = i.startAt, s = i.immediateRender, l = i.lazy, c = i.onUpdate, d = i.runBackwards, u = i.yoyoEase, p = i.keyframes, g = i.autoRevert, f = e._dur, h = e._startAt, w = e._targets, b = e.parent, y = b && b.data === "nested" ? b.vars.targets : w, x = e._overwrite === "auto" && !vi, v = e.timeline, _ = i.easeReverse || u, T, A, k, C, M, U, N, L, z, Y, D, I, R;
  if (v && (!p || !n) && (n = "none"), e._ease = mt(n, Gt.ease), e._rEase = _ && (mt(_) || e._ease), e._from = !v && !!i.runBackwards, e._from && (e.ratio = 1), !v || p && !i.stagger) {
    if (L = w[0] ? pt(w[0]).harness : 0, I = L && i[L.prop], T = xa(i, Ti), h && (h._zTime < 0 && h.progress(1), t < 0 && d && s && !g ? h.render(-1, !0) : h.revert(d && f ? pa : Ro), h._lazy = 0), r) {
      if (tt(e._startAt = X.set(w, be({
        data: "isStart",
        overwrite: !1,
        parent: b,
        immediateRender: !0,
        ...
        stagger: 0
      }, r))), e._startAt._dp = 0, e._startAt._sat = e, t < 0 && ($ || !s && !g) && e._startAt.revert(pa), s && f && t <= 0 && a <= 0) {
        t && (e._zTime = t);
        return;
      }
    } else if (d && f && !h) {
      ...
      }, T), I && (k[L.prop] = I), tt(e._startAt = X.set(w, k)), e._startAt._dp = 0, e._startAt._sat = e, t < 0 && ($ ? e._startAt.revert(pa) : e._startAt.render(-1, !0)), e._zTime = t, !s)
        o(e._startAt, B, B);
      else if (!t)
        return;
    }
    for (e._pt = e._ptCache = 0, l = f && oe(l) || l && !f, A = 0; A < w.length; A++) {
      if (M = w[A], N = M._gsap || Mi(w)[A]._gsap, e._ptLookup[A] = Y = {}, li[N.id] && $e.length && ya(), D = y === w ? A : y.indexOf(M), L && (z = new L()).init(M, I || T, e, D, y) !== !1 && (e._pt = C = new le(e._pt, M, z.name, 0, 1, z.render, z, 0, z.priority), z._props.forEach(function(Ce) {
        Y[Ce] = C;
      }), z.priority && (U = 1)), !L || I)
        for (k in T)
          he[k] && (z = kr(k, T, e, D, M, y)) ? z.priority && (U = 1) : Y[k] = C = Ri.call(e, M, k, "get", T[k], D, y, 0, i.stringFilter);
      e._op && e._op[A] && e.kill(M, e._op[A]), x && e._pt && (Ke = e, G.killTweensOf(M, Y, e.globalTime(t)), R = !e.parent, Ke = 0), e._pt && l && (li[N.id] = 1);
    }
    U && Dr(e), e._onInit && e._onInit(e);
  }
  e._onUpdate = c, e._initted = (!e._op || e._pt) && !R, p && t <= 0 && v.render(ve, !0, !0);
}, rs = function(e, t, a, i, n, r, s, l) {
  var c = (e._pt && e._ptCache || (e._ptCache = {}))[t], d, u, p, g;
  if (!c)
    for (c = e._ptCache[t] = [], p = e._ptLookup, g = e._targets.length; g--; ) {
      if (d = p[g][t], d && d.d && d.d._pt)
  ...
  for (g = c.length; g--; )
    u = c[g], d = u._pt || u, d.s = (i || i === 0) && !n ? i : d.s + (i || 0) + r * d.c, d.c = a - d.s, u.e && (u.e = j(a) + te(u.e)), u.b && (u.b = d.s + te(u.b));
}, os = function(e, t) {
  var a = e[0] ? pt(e[0]).harness : 0, i = a && a.aliases, n, r, s, l;
  if (!i)
    return t;
  n = kt({}, t);
  for (r in i)
  ...
  return Q(e) ? e.call(t, a, i, n) : J(e) && ~e.indexOf("random(") ? Qt(e) : e;
...
var X = /* @__PURE__ */ (function(o) {
  ...
  function e(a, i, n, r) {
    ...
    var l = s.vars, c = l.duration, d = l.delay, u = l.immediateRender, p = l.stagger, g = l.overwrite, f = l.keyframes, h = l.defaults, w = l.scrollTrigger, b = i.parent || G, y = (ae(a) || Jn(a) ? Ve(a[0]) : "length" in i) ? [a] : Ae(a), x, v, _, T, A, k, C, M;
    if (s._targets = y.length ? Mi(y) : Wt("GSAP target " + a + " not found. https://gsap.com", !fe.nullTargetWarn) || [], s._ptLookup = [], s._overwrite = g, f || p || na(c) || na(d)) {
      i = s.vars;
      ...
      }), x.kill(), x.parent = x._dp = Be(s), x._start = 0, p || na(c) || na(d)) {
        if (T = y.length, C = p && gr(p), qe(p))
          for (A in p)
            ~Tr.indexOf(A) && (M || (M = {}), M[A] = p[A]);
        for (v = 0; v < T; v++)
          _ = xa(i, Er), _.stagger = 0, U && (_.easeReverse = U), M && kt(_, M), k = y[v], _.duration = +Ht(c, Be(s), v, k, y), _.delay = (+Ht(d, Be(s), v, k, y) || 0) - s._delay, !p && T === 1 && _.delay && (s._delay = d = _.delay, s._start += d, _.delay = 0), x.to(k, _, C ? C(v, k, y) : 0), x._ease = P.none;
        x.duration() ? c = d = 0 : s.timeline = 0;
      } else if (f) {
        zt(be(x.vars.defaults, {
          ease: "none"
        })), x._ease = mt(f.ease || i.ease || "none");
        var N = 0, L, z, Y;
        if (ae(f))
          ...
          _ = {};
          for (A in f)
            A === "ease" || A === "easeEach" || ss(A, f[A], _, f.easeEach);
          for (A in _)
            for (L = _[A].sort(function(D, I) {
              return D.t - I.t;
            }), N = 0, v = 0; v < L.length; v++)
              z = L[v], Y = {
                ease: z.e,
                duration: (z.t - (v ? L[v - 1].t : 0)) / 100 * c
              }, Y[A] = z.v, x.to(y, Y, N), N += Y.duration;
          x.duration() < c && x.to({}, {
      ...
      s.timeline = 0;
    return g === !0 && !vi && (Ke = Be(s), G.killTweensOf(y), Ke = 0), Re(b, Be(s), n), i.reversed && s.reverse(), i.paused && s.paused(!0), (u || !c && !f && s._start === V(b._time) && oe(u) && Oo(Be(s)) && b.data !== "nested") && (s._tTime = -B, s.render(Math.max(0, -d) || 0)), w && dr(Be(s), w), s;
  }
  var t = e.prototype;
  return t.render = function(i, n, r) {
    var s = this._time, l = this._tDur, c = this._dur, d = i < 0, u = i > l - B && !d ? l : i < B ? 0 : i, p, g, f, h, w, b, y, x;
    if (!c)
      Fo(this, i, n, r);
      ...
      if (p = u, x = this.timeline, this._repeat) {
        ...
        if (p = V(u % h), u === l ? (f = this._repeat, p = c) : (w = V(u / h), f = ~~w, f && f === w ? (p = c, f--) : p > c && (p = c)), b = this._yoyo && f & 1, b && (p = c - p), w = Tt(this._tTime, h), p === s && !r && this._initted && f === w)
          return this._tTime = u, this;
        f !== w && this.vars.repeatRefresh && !b && !this._lock && p !== h && this._initted && (this._lock = r = 1, this.render(V(h * f), !0).invalidate()._lock = 0);
      }
      if (!this._initted) {
        if (ur(this, d ? i : p, r, n, u))
      ...
      if (this._rEase) {
        ...
        this.ratio = y = this._ease(p / c);
      if (this._from && (this.ratio = y = 1 - y), this._tTime = u, this._time = p, !this._act && this._ts && (this._act = 1, this._lazy = 0), !s && u && !n && !w && (ge(this, "onStart"), this._tTime !== u))
        return this;
      for (g = this._pt; g; )
        g.r(y, g.d), g = g._next;
      x && x.render(i < 0 ? i : x._dur * x._ease(p / this._dur), n, r) || this._startAt && (this._zTime = i), this._onUpdate && !n && (d && ci(this, i, n, r), ge(this, "onUpdate")), this._repeat && f !== w && this.vars.onRepeat && !n && this.parent && ge(this, "onRepeat"), (u === this._tDur || !u) && this._tTime === u && (d && !this._onUpdate && ci(this, i, !0, !0), (i || !c) && (u === this._tDur && this._ts > 0 || !u && this._ts < 0) && tt(this, 1), !n && !(d && !s) && (u || s || b) && (ge(this, u === l ? "onComplete" : "onReverseComplete", !0), this._prom && !(u < l && this.timeScale() > 0) && this._prom()));
    }
    return this;
  }, t.targets = function() {
    ...
    if (n === void 0 && (n = "all"), !i && (!n || n === "all"))
      return this._lazy = this._pt = 0, this.parent ? Nt(this) : this.scrollTrigger && this.scrollTrigger.kill(!!$), this;
    if (this.timeline) {
      var r = this.timeline.totalDuration();
      return this.timeline.killTweensOf(i, n, Ke && Ke.vars.overwrite !== !0)._first || Nt(this), this.parent && r !== this.timeline.totalDuration() && Et(this, this._dur * this.timeline._tDur / r, 0, 1), this;
    }
    var s = this._targets, l = i ? Ae(i) : s, c = this._ptLookup, d = this._pt, u, p, g, f, h, w, b;
    if ((!n || n === "all") && Lo(s, l))
      return n === "all" && (this._pt = 0), Nt(this);
    for (u = this._op = this._op || [], n !== "all" && (J(n) && (h = {}, se(n, function(y) {
      return h[y] = 1;
    }), n = h), n = os(s, n)), b = s.length; b--; )
      if (~l.indexOf(s[b])) {
        p = c[b], n === "all" ? (u[b] = n, f = p, g = {}) : (g = u[b] = u[b] || {}, f = n);
        for (h in f)
          w = p && p[h], w && ((!("kill" in w.d) || w.d.kill(h) === !0) && Ea(this, w, "_pt"), delete p[h]), g !== "all" && (g[h] = 1);
      }
...
var Ii = function(e, t, a) {
  ...
  return Q(e[t]) ? Mr : Ai(e[t]) && e.setAttribute ? cs : Ii;
}, Pr = function(e, t) {
...
we.TweenMax = we.TweenLite = X;
we.TimelineLite = we.TimelineMax = re;
G = new re({
  sortChildren: !1,
  defaults: Gt,
...
var ft = [], ma = {}, gs = [], Ji = 0, ms = 0, Fa = function(e) {
  ...
  e - Ji > 2 && (Fa("matchMediaInit"), ft.forEach(function(a) {
    ...
    for (s in i)
      r = Pe.matchMedia(i[s]).matches, r && (l = 1), r !== n[s] && (n[s] = r, c = 1);
  ...
  return e.add = function(a, i, n) {
    ...
    var r = this, s = function() {
      ...
      return c && c !== r && c.data.push(r), n && (r.selector = hi(n)), H = r, u = i.apply(r, arguments), Q(u) && r._r.push(u), H = c, r.selector = d, r.isReverted = !1, u;
    };
    return r.last = s, a === Q ? s(r, function(l) {
      return r.add(null, l);
    }) : a ? r[a] = s : s;
  }, e.ignore = function(a) {
    var i = H;
    ...
    return this.data.forEach(function(i) {
      return i instanceof o ? a.push.apply(a, i.getTweens()) : i instanceof X && !(i.parent && i.parent.data === "nested") && a.push(i);
    }), a;
  }, e.clear = function() {
    ...
    if (a ? (function() {
      ...
      for (s.map(function(d) {
        ...
        c = n.data[l], c instanceof re ? c.data !== "nested" && (c.scrollTrigger && c.scrollTrigger.revert(), c.kill()) : !(c instanceof X) && c.revert && c.revert(a);
  ...
  return e.add = function(a, i, n) {
    ...
    for (c in a)
      c === "all" ? d = 1 : (l = Pe.matchMedia(a[c]), l && (ft.indexOf(r) < 0 && ft.push(r), (s[c] = l.matches) && (d = 1), l.addListener ? l.addListener(mi) : l.addEventListener("change", mi)));
  ...
  quickSetter: function(e, t, a) {
    ...
    e = e[0] || {};
    var r = he[t], s = pt(e), l = s.harness && (s.harness.aliases || {})[t] || t, c = r ? function(d) {
      var u = new r();
  ...
  quickTo: function(e, t, a) {
    var i, n = de.to(e, be((i = {}, i[t] = "+=0.1", i.paused = !0, i.stagger = 0, i), a || {})), r = function(l, c, d) {
  ...
  registerEffect: function(e) {
    ...
    (i || "").split(",").forEach(function(s) {
      return s && !he[s] && !we[s] && Wt(t + " effect requires " + s + " plugin.");
    }), La[t] = function(s, l, c) {
      return a(Ae(s), be(l || {}, n), c);
  ...
  parseEase: function(e, t) {
    return arguments.length ? mt(e, t) : P;
  },
  getById: function(e) {
    return G.getById(e);
  },
  exportRoot: function(e, t) {
    ...
    for (a.smoothChildTiming = oe(e.smoothChildTiming), G.remove(a), a._dp = 0, a._time = a._tTime = G._time, i = G._first; i; )
      n = i._next, (t || !(!i._dur && i instanceof X && i.vars.onComplete === i._targets[0])) && Re(a, i, i._start - i._delay), i = n;
    return Re(G, a, 0), a;
  },
...
X.version = re.version = de.version = "3.15.0";
er = 1;
Si() && Mt();
P.Power0;
P.Power1;
...
P.Expo;
P.Circ;
var Zi, Xe, vt, Ni, ht, $i, Oi, ys = function() {
  return typeof window < "u";
}, Ge = {}, dt = 180 / Math.PI, At = Math.PI / 180, bt = Math.atan2, en = 1e8, Bi = /([A-Z])/g, xs = /(left|right|width|margin|padding|x)/i, _s = /[\s,\(]\S/, Ie = {
  ...
  return i[t] || i.getPropertyValue(t.replace(Bi, "-$1").toLowerCase()) || i.getPropertyValue(t) || !a && o(e, Pt(t) || t, 1) || "";
}, tn = "O,Moz,ms,Ms,Webkit".split(","), Pt = function(e, t, a) {
  var i = t || ht, n = i.style, r = 5;
  if (e in n && !a)
    return e;
  ...
  ys() && window.document && (Zi = window, Xe = Zi.document, vt = Xe.documentElement, ht = wi("div") || {
    style: {}
  ...
  if (t) {
    var a = e.style, i;
    t in Ge && t !== ce && (t = W), a.removeProperty ? (i = t.substr(0, 2), (i === "ms" || t.substr(0, 6) === "webkit") && (t = "-" + t), a.removeProperty(i === "--" ? t : t.replace(Bi, "-$1").toLowerCase())) : a.removeAttribute(t);
  }
  ...
  var n = parseFloat(a) || 0, r = (a + "").trim().substr((n + "").length) || "px", s = ht.style, l = xs.test(t), c = e.tagName.toLowerCase() === "svg", d = (c ? "client" : "offset") + (l ? "Width" : "Height"), u = 100, p = i === "px", g = i === "%", f, h, w, b;
  if (i === r || !n || rn[i] || rn[r])
    return n;
  if (r !== "px" && !p && (n = o(e, t, a, "px")), b = e.getCTM && zr(e), (g || r === "%") && (Ge[t] || ~t.indexOf("adius")))
    return f = b ? e.getBBox()[l ? "width" : "height"] : e[d], j(g ? n / f * u : n / 100 * f);
  if (s[l ? "width" : "height"] = u + (p ? r : i), h = i !== "rem" && ~t.indexOf("adius") || i === "em" && e.appendChild && !c ? e : e.parentNode, b && (h = (e.ownerSVGElement || {}).parentNode), (!h || h === Xe || !h.appendChild) && (h = Xe.body), w = h._gsap, w && g && w.width && l && w.time === pe.time && !w.uncache)
    return j(n / w.width * u);
  if (g && (t === "height" || t === "width")) {
    var y = e.style[t];
    e.style[t] = u + i, f = e[d], y ? e.style[t] = y : at(e, t);
  } else
    (g || r === "%") && !qs[me(h, "display")] && (s.position = me(e, "position")), h === e && (s.position = "static"), h.appendChild(ht), f = ht[d], h.removeChild(ht), s.position = "absolute";
  return l && g && (w = pt(h), w.time = pe.time, w.width = h[d]), j(p ? f * n / u : f && n ? u / f * n : 0);
}, ze = function(e, t, a, i) {
  var n;
  return Ni || bi(), t in Ie && t !== "transform" && (t = Ie[t], ~t.indexOf(",") && (t = t.split(",")[0])), Ge[t] && t !== "transform" ? (n = Jt(e, i), n = t !== "transformOrigin" ? n[t] : n.svg ? n.origin : Sa(me(e, ce)) + " " + n.zOrigin + "px") : (n = e.style[t], (!n || n === "auto" || i || ~(n + "").indexOf("calc(")) && (n = Aa[t] && Aa[t](e, t, a) || me(e, t) || nr(e, t) || (t === "opacity" ? 1 : 0))), a && !~(n + "").trim().indexOf(" ") ? it(e, t, n, a) + a : n;
}, Ls = function(e, t, a, i) {
  if (!a || a === "none") {
    var n = Pt(t, e, 1), r = n && me(e, n, 1);
    r && r !== a ? (t = n, a = r) : t === "borderColor" && (a = me(e, "borderTopColor"));
  }
  var s = new le(this._pt, e.style, t, 0, 1, Rr), l = 0, c = 0, d, u, p, g, f, h, w, b, y, x, v, _;
  if (s.b = a, s.e = i, a += "", i += "", i.substring(0, 6) === "var(--" && (i = me(e, i.substring(4, i.indexOf(")")))), i === "auto" && (h = e.style[t], e.style[t] = i, i = me(e, t) || i, h ? e.style[t] = h : at(e, t)), d = [a, i], Ar(d), a = d[0], i = d[1], p = a.match(yt) || [], _ = i.match(yt) || [], _.length) {
    for (; u = yt.exec(i); )
      w = u[0], y = i.substring(l, u.index), f ? f = (f + 1) % 5 : (y.substr(-5) === "rgba(" || y.substr(-5) === "hsla(") && (f = 1), w !== (h = p[c++] || "") && (g = parseFloat(h) || 0, v = h.substr((g + "").length), w.charAt(1) === "=" && (w = _t(g, w) + v), b = parseFloat(w), x = w.substr((b + "").length), l = yt.lastIndex - x.length, x || (x = x || fe.units[t] || v, l === i.length && (i += x, s.e += x)), v !== x && (g = it(e, t, h, x) || 0), s._pt = {
        _next: s._pt,
        p: y || c === 1 ? y : ",",
        //note: SVG spec allows omission of comma/space when a negative sign is wedged between two numbers, like 2.5-5.3 instead of 2.5,-5.3 but when tweening, the negative value may switch to positive, so we insert the comma just in case.
        s: g,
  ...
  if (t.tween && t.tween._time === t.tween._dur) {
    ...
    l && (at(a, W), r && (r.svg && a.removeAttribute("transform"), i.scale = i.rotate = i.translate = "none", Jt(a, 1), r.uncache = 1, Nr(i)));
  }
}, Aa = {
  ...
  */
  ...
  var t = me(e, W);
  return Hr(t) ? Xt : t.substr(7).match(Zn).map(j);
}, Fi = function(e, t) {
  var a = e._gsap || pt(e), i = e.style, n = sn(e), r, s, l, c;
  return a.svg && e.getAttribute("transform") ? (l = e.transform.baseVal.consolidate().matrix, n = [l.a, l.b, l.c, l.d, l.e, l.f], n.join(",") === "1,0,0,1,0,0" ? Xt : n) : (n === Xt && !e.offsetParent && e !== vt && !a.svg && (l = i.display, i.display = "block", r = e.parentNode, (!r || !e.offsetParent && !e.getBoundingClientRect().width) && (c = 1, s = e.nextElementSibling, vt.appendChild(e)), n = sn(e), l ? i.display = l : at(e, "display"), c && (s ? r.insertBefore(e, s) : r ? r.appendChild(e) : vt.removeChild(e))), t && n.length > 6 ? [n[0], n[1], n[4], n[5], n[12], n[13]] : n);
}, yi = function(e, t, a, i, n, r) {
  var s = e._gsap, l = n || Fi(e, !0), c = s.xOrigin || 0, d = s.yOrigin || 0, u = s.xOffset || 0, p = s.yOffset || 0, g = l[0], f = l[1], h = l[2], w = l[3], b = l[4], y = l[5], x = t.split(" "), v = parseFloat(x[0]) || 0, _ = parseFloat(x[1]) || 0, T, A, k, C;
  a ? l !== Xt && (A = g * w - f * h) && (k = v * (w / A) + _ * (-h / A) + (h * y - w * b) / A, C = v * (-f / A) + _ * (g / A) - (g * y - f * b) / A, v = k, _ = C) : (T = Fr(e), v = T.x + (~x[0].indexOf("%") ? v / 100 * T.width : v), _ = T.y + (~(x[1] || x[0]).indexOf("%") ? _ / 100 * T.height : _)), i || i !== !1 && s.smooth ? (b = v - c, y = _ - d, s.xOffset = u + (b * g + y * h) - b, s.yOffset = p + (b * f + y * w) - y) : s.xOffset = s.yOffset = 0, s.xOrigin = v, s.yOrigin = _, s.smooth = !!i, s.origin = t, s.originIsAbsolute = !!a, e.style[ce] = "0px 0px", r && (Je(r, s, "xOrigin", c, v), Je(r, s, "yOrigin", d, _), Je(r, s, "xOffset", u, s.xOffset), Je(r, s, "yOffset", p, s.yOffset)), e.setAttribute("data-svg-origin", v + " " + _);
}, Jt = function(e, t) {
  var a = e._gsap || new Cr(e);
  if ("x" in a && !t && !a.uncache)
    return a;
  var i = e.style, n = a.scaleX < 0, r = "px", s = "deg", l = getComputedStyle(e), c = me(e, ce) || "0", d, u, p, g, f, h, w, b, y, x, v, _, T, A, k, C, M, U, N, L, z, Y, D, I, R, Ce, Le, We, ue, Vi, Ne, rt;
  return d = u = p = h = w = b = y = x = v = 0, g = f = 1, a.svg = !!(e.getCTM && zr(e)), l.translate && ((l.translate !== "none" || l.scale !== "none" || l.rotate !== "none") && (i[W] = (l.translate !== "none" ? "translate3d(" + (l.translate + " 0 0").split(" ").slice(0, 3).join(", ") + ") " : "") + (l.rotate !== "none" ? "rotate(" + l.rotate + ") " : "") + (l.scale !== "none" ? "scale(" + l.scale.split(" ").join(",") + ") " : "") + (l[W] !== "none" ? l[W] : "")), i.scale = i.rotate = i.translate = "none"), A = Fi(e, a.svg), a.svg && (a.uncache ? (R = e.getBBox(), c = a.xOrigin - R.x + "px " + (a.yOrigin - R.y) + "px", I = "") : I = !t && e.getAttribute("data-svg-origin"), yi(e, I || c, !!I || a.originIsAbsolute, a.smooth !== !1, A)), _ = a.xOrigin || 0, T = a.yOrigin || 0, A !== Xt && (U = A[0], N = A[1], L = A[2], z = A[3], d = Y = A[4], u = D = A[5], A.length === 6 ? (g = Math.sqrt(U * U + N * N), f = Math.sqrt(z * z + L * L), h = U || N ? bt(N, U) * dt : 0, y = L || z ? bt(L, z) * dt + h : 0, y && (f *= Math.abs(Math.cos(y * At))), a.svg && (d -= _ - (_ * U + T * L), u -= T - (_ * N + T * z))) : (rt = A[6], Vi = A[7], Le = A[8], We = A[9], ue = A[10], Ne = A[11], d = A[12], u = A[13], p = A[14], k = bt(rt, ue), w = k * dt, k && (C = Math.cos(-k), M = Math.sin(-k), I = Y * C + Le * M, R = D * C + We * M, Ce = rt * C + ue * M, Le = Y * -M + Le * C, We = D * -M + We * C, ue = rt * -M + ue * C, Ne = Vi * -M + Ne * C, Y = I, D = R, rt = Ce), k = bt(-L, ue), b = k * dt, k && (C = Math.cos(-k), M = Math.sin(-k), I = U * C - Le * M, R = N * C - We * M, Ce = L * C - ue * M, Ne = z * M + Ne * C, U = I, N = R, L = Ce), k = bt(N, U), h = k * dt, k && (C = Math.cos(k), M = Math.sin(k), I = U * C + N * M, R = Y * C + D * M, N = N * C - U * M, D = D * C - Y * M, U = I, Y = R), w && Math.abs(w) + Math.abs(h) > 359.9 && (w = h = 0, b = 180 - b), g = j(Math.sqrt(U * U + N * N + L * L)), f = j(Math.sqrt(D * D + rt * rt)), k = bt(Y, D), y = Math.abs(k) > 2e-4 ? k * dt : 0, v = Ne ? 1 / (Ne < 0 ? -Ne : Ne) : 0), a.svg && (I = e.getAttribute("transform"), a.forceCSS = e.setAttribute("transform", "") || !Hr(me(e, W)), I && e.setAttribute("transform", I))), Math.abs(y) > 90 && Math.abs(y) < 270 && (n ? (g *= -1, y += h <= 0 ? 180 : -180, h += h <= 0 ? 180 : -180) : (f *= -1, y += y <= 0 ? 180 : -180)), t = t || a.uncache, a.x = d - ((a.xPercent = d && (!t && a.xPercent || (Math.round(e.offsetWidth / 2) === Math.round(-d) ? -50 : 0))) ? e.offsetWidth * a.xPercent / 100 : 0) + r, a.y = u - ((a.yPercent = u && (!t && a.yPercent || (Math.round(e.offsetHeight / 2) === Math.round(-u) ? -50 : 0))) ? e.offsetHeight * a.yPercent / 100 : 0) + r, a.z = p + r, a.scaleX = j(g), a.scaleY = j(f), a.rotation = j(h) + s, a.rotationX = j(w) + s, a.rotationY = j(b) + s, a.skewX = y + s, a.skewY = x + s, a.transformPerspective = v + r, (a.zOrigin = parseFloat(c.split(" ")[2]) || !t && a.zOrigin || 0) && (i[ce] = Sa(c)), a.xOffset = a.yOffset = 0, a.force3D = fe.force3D, a.renderTransform = a.svg ? Fs : Br ? Vr : Bs, a.uncache = 0, a;
}, Sa = function(e) {
  return (e = e.split(" "))[0] + " " + e[1];
}, Ua = function(e, t, a) {
  var i = te(t);
  return j(parseFloat(t) + parseFloat(it(e, "x", a + "px", i))) + i;
}, Bs = function(e, t) {
  t.z = "0px", t.rotationY = t.rotationX = "0deg", t.force3D = 0, Vr(e, t);
}, ot = "0deg", Rt = "0px", st = ") ", Vr = function(e, t) {
  var a = t || this, i = a.xPercent, n = a.yPercent, r = a.x, s = a.y, l = a.z, c = a.rotation, d = a.rotationY, u = a.rotationX, p = a.skewX, g = a.skewY, f = a.scaleX, h = a.scaleY, w = a.transformPerspective, b = a.force3D, y = a.target, x = a.zOrigin, v = "", _ = b === "auto" && e && e !== 1 || b === !0;
  if (x && (u !== ot || d !== ot)) {
    var T = parseFloat(d) * At, A = Math.sin(T), k = Math.cos(T), C;
    T = parseFloat(u) * At, C = Math.cos(T), r = Ua(y, r, A * C * -x), s = Ua(y, s, -Math.sin(T) * -x), l = Ua(y, l, k * C * -x + x);
  }
  w !== Rt && (v += "perspective(" + w + st), (i || n) && (v += "translate(" + i + "%, " + n + "%) "), (_ || r !== Rt || s !== Rt || l !== Rt) && (v += l !== Rt || _ ? "translate3d(" + r + ", " + s + ", " + l + ") " : "translate(" + r + ", " + s + st), c !== ot && (v += "rotate(" + c + st), d !== ot && (v += "rotateY(" + d + st), u !== ot && (v += "rotateX(" + u + st), (p !== ot || g !== ot) && (v += "skew(" + p + ", " + g + st), (f !== 1 || h !== 1) && (v += "scale(" + f + ", " + h + st), y.style[W] = v || "translate(0, 0)";
}, Fs = function(e, t) {
  var a = t || this, i = a.xPercent, n = a.yPercent, r = a.x, s = a.y, l = a.rotation, c = a.skewX, d = a.skewY, u = a.scaleX, p = a.scaleY, g = a.target, f = a.xOrigin, h = a.yOrigin, w = a.xOffset, b = a.yOffset, y = a.forceCSS, x = parseFloat(r), v = parseFloat(s), _, T, A, k, C;
  l = parseFloat(l), c = parseFloat(c), d = parseFloat(d), d && (d = parseFloat(d), c += d, l += d), l || c ? (l *= At, c *= At, _ = Math.cos(l) * u, T = Math.sin(l) * u, A = Math.sin(l - c) * -p, k = Math.cos(l - c) * p, c && (d *= At, C = Math.tan(c - d), C = Math.sqrt(1 + C * C), A *= C, k *= C, d && (C = Math.tan(d), C = Math.sqrt(1 + C * C), _ *= C, T *= C)), _ = j(_), T = j(T), A = j(A), k = j(k)) : (_ = u, k = p, T = A = 0), (x && !~(r + "").indexOf("px") || v && !~(s + "").indexOf("px")) && (x = it(g, "x", r, "px"), v = it(g, "y", s, "px")), (f || h || w || b) && (x = j(x + f - (f * _ + h * A) + w), v = j(v + h - (f * T + h * k) + b)), (i || n) && (C = g.getBBox(), x = j(x + i / 100 * C.width), v = j(v + n / 100 * C.height)), C = "matrix(" + _ + "," + T + "," + A + "," + k + "," + x + "," + v + ")", g.setAttribute("transform", C), y && (g.style[W] = C);
}, zs = function(e, t, a, i, n) {
  var r = 360, s = J(n), l = parseFloat(n) * (s && ~n.indexOf("rad") ? dt : 1), c = l - i, d = i + c + "deg", u, p;
  return s && (u = n.split("_")[1], u === "short" && (c %= r, c !== c % (r / 2) && (c += c < 0 ? r : -r)), u === "cw" && c < 0 ? c = (c + r * en) % r - ~~(c / r) * r : u === "ccw" && c > 0 && (c = (c - r * en) % r - ~~(c / r) * r)), e._pt = p = new le(e._pt, t, a, i, c, vs), p.e = d, p.u = "deg", e._props.push(a), p;
}, ln = function(e, t) {
  for (var a in t)
    e[a] = t[a];
  return e;
}, Us = function(e, t, a) {
  var i = ln({}, a._gsap), n = "perspective,force3D,transformOrigin,svgOrigin", r = a.style, s, l, c, d, u, p, g, f;
  i.svg ? (c = a.getAttribute("transform"), a.setAttribute("transform", ""), r[W] = t, s = Jt(a, 1), at(a, W), a.setAttribute("transform", c)) : (c = getComputedStyle(a)[W], r[W] = t, s = Jt(a, 1), r[W] = c);
  for (l in Ge)
    c = i[l], d = s[l], c !== d && n.indexOf(l) < 0 && (g = te(c), f = te(d), u = g !== f ? it(a, l, c, f) : parseFloat(c), p = parseFloat(d), e._pt = new le(e._pt, s, l, u, p - u, fi), e._pt.u = f || 0, e._props.push(l));
  ln(s, i);
};
se("padding,margin,Width,Radius", function(o, e) {
  ...
  Aa[e > 1 ? "border" + o : o] = function(s, l, c, d, u) {
    ...
    if (arguments.length < 4)
      return p = r.map(function(f) {
        return ze(s, f, c);
      }), g = p.join(" "), g.split(p[0]).length === 5 ? p[0] : g;
    p = (d + "").split(" "), g = {}, r.forEach(function(f, h) {
      return g[f] = p[h] = p[h] || p[(h - 1) / 2 | 0];
    }), s.init(l, g, u);
  };
});
var Gr = {
  ...
  init: function(e, t, a, i, n) {
    var r = this._props, s = e.style, l = a.vars.startAt, c, d, u, p, g, f, h, w, b, y, x, v, _, T, A, k, C;
    Ni || bi(), this.styles = this.styles || Or(e), k = this.styles.props, this.tween = a;
    for (h in t)
      if (h !== "autoRound" && (d = t[h], !(he[h] && kr(h, t, a, i, e, n)))) {
        if (g = typeof d, f = Aa[h], g === "function" && (d = d.call(a, i, e, n), g = typeof d), g === "string" && ~d.indexOf("random(") && (d = Qt(d)), f)
          f(this, e, h, d, a) && (A = 1);
        else if (h.substr(0, 2) === "--")
          c = (getComputedStyle(e).getPropertyValue(h) + "").trim(), d += "", et.lastIndex = 0, et.test(c) || (w = te(c), b = te(d), b ? w !== b && (c = it(e, h, c, b) + b) : w && (d += w)), this.add(s, "setProperty", c, d, i, n, 0, 0, h), r.push(h), k.push(h, 0, s[h]);
        else if (g !== "undefined") {
          if (l && h in l ? (c = typeof l[h] == "function" ? l[h].call(a, i, e, n) : l[h], J(c) && ~c.indexOf("random(") && (c = Qt(c)), te(c + "") || c === "auto" || (c += fe.units[h] || te(ze(e, h)) || ""), (c + "").charAt(1) === "=" && (c = ze(e, h))) : c = ze(e, h), p = parseFloat(c), y = g === "string" && d.charAt(1) === "=" && d.substr(0, 2), y && (d = d.substr(2)), u = parseFloat(d), h in Ie && (h === "autoAlpha" && (p === 1 && ze(e, "visibility") === "hidden" && u && (p = 0), k.push("visibility", 0, s.visibility), Je(this, s, "visibility", p ? "inherit" : "hidden", u ? "inherit" : "hidden", !u)), h !== "scale" && h !== "transform" && (h = Ie[h], ~h.indexOf(",") && (h = h.split(",")[0]))), x = h in Ge, x) {
            if (this.styles.save(h), C = d, g === "string" && d.substring(0, 6) === "var(--") {
              if (d = me(e, d.substring(4, d.indexOf(")"))), d.substring(0, 5) === "calc(") {
                var M = e.style.perspective;
                e.style.perspective = d, d = me(e, "perspective"), M ? e.style.perspective = M : at(e, "perspective");
              }
              u = parseFloat(d);
            }
            if (v || (_ = e._gsap, _.renderTransform && !t.parseTransform || Jt(e, t.parseTransform), T = t.smoothOrigin !== !1 && _.smooth, v = this._pt = new le(this._pt, s, W, 0, 1, _.renderTransform, _, 0, -1), v.dep = 1), h === "scale")
              this._pt = new le(this._pt, _, "scaleY", _.scaleY, (y ? _t(_.scaleY, y + u) : u) - _.scaleY || 0, fi), this._pt.u = 0, r.push("scaleY", h), h += "X";
            else if (h === "transformOrigin") {
              k.push(ce, 0, s[ce]), d = Ns(d), _.svg ? yi(e, d, 0, T, 0, this) : (b = parseFloat(d.split(" ")[2]) || 0, b !== _.zOrigin && Je(this, _, "zOrigin", _.zOrigin, b), Je(this, s, h, Sa(c), Sa(d)));
              continue;
            } else if (h === "svgOrigin") {
              yi(e, d, 1, T, 0, this);
              continue;
            } else if (h in Ur) {
              zs(this, _, h, p, y ? _t(p, y + d) : d);
              continue;
          ...
          } else h in s || (h = Pt(h) || h);
          if (x || (u || u === 0) && (p || p === 0) && !_s.test(d) && h in s)
            w = (c + "").substr((p + "").length), u || (u = 0), b = te(d) || (h in fe.units ? fe.units[h] : w), w !== b && (p = it(e, h, c, b)), this._pt = new le(this._pt, x ? _ : s, h, p, (y ? _t(p, y + u) : u) - p, !x && (b === "px" || h === "zIndex") && t.autoRound !== !1 ? Cs : fi), this._pt.u = b || 0, x && C !== d ? (this._pt.b = c, this._pt.e = C, this._pt.r = Ss) : w !== b && b !== "%" && (this._pt.b = c, this._pt.r = As);
          else if (h in s)
          ...
          x || (h in s ? k.push(h, 0, s[h]) : typeof e[h] == "function" ? k.push(h, 2, e[h]()) : k.push(h, 1, c || e[h])), r.push(h);
        }
      }
    A && Dr(this);
  },
  ...
  getSetter: function(e, t, a) {
    var i = Ie[t];
    return i && i.indexOf(",") < 0 && (t = i), t in Ge && t !== ce && (e._gsap.x || ze(e, "x")) ? a && $i === a ? t === "scale" ? Ms : Es : ($i = a || {}) && (t === "scale" ? Ps : Rs) : e.style && !Ai(e.style[t]) ? ks : ~t.indexOf("-") ? Ts : qi(e, t);
  },
  core: {
    _removeProperty: at,
    _getMatrix: Fi
...
(function(o, e, t, a) {
  ...
  se(e, function(n) {
    fe.units[n] = "deg", Ur[n] = 1;
  }), Ie[i[13]] = o + "," + e, se(a, function(n) {
    var r = n.split(":");
    Ie[r[1]] = i[r[0]];
  });
...
m.core.Tween;
const Fe = "Thinking", Vt = "Show more", fa = "Show less";
function zi(o, e) {
...
class Ul {
  ...
  showComposer() {
    ...
    return e.set(this.composer, {
      ...
      ease: ye.contentEase,
      overwrite: "auto"
    }, ye.contentShowDelay).call(() => this.pinThreadToBottom()), e;
  }
  hideComposer() {
    ...
    return m.timeline().set(this.composer, {
      ...
      opacity: 0,
      duration: ye.contentHideDuration,
      ease: "power2.out",
      overwrite: "auto"
    }, 0).to(this.composer, {
      left: t.left,
  ...
  getComposerThreadInsetForFrame(e) {
    ...
    return Math.ceil(i + ye.threadGap);
  }
  ...
  getComposerCompactFrame(e) {
    const t = Math.min(ye.compactWidth, e.width), a = Math.min(ye.compactHeight, e.height);
    return {
  ...
  getComposerCollapsedFrame(e) {
    const t = ye.collapsedWidth, a = ye.collapsedHeight;
    return {
      left: e.left + (e.width - t) / 2,
      bottom: e.bottom + (e.height - a) / 2,
      width: t,
  ...
  scrollToLive(e = Z.followDuration) {
  ...
  scrollToLiveTimeline(e = Z.followDuration) {
  ...
  scrollDataTableFooterIntoView(e, t = Z.revealDuration, a = {}) {
  ...
  scrollChatElementIntoView(e, t = {}) {
    return this.scrollChatTarget(() => {
      ...
      align: t.align ?? "top",
      duration: t.duration ?? Z.revealDuration,
      offset: t.offset,
      fallback: "current"
    });
  }
  ...
  enrichmentPanel(e) {
    ...
    return m.set(r, { autoAlpha: 0, y: 3, scale: 0.98 }), m.set(n, { scale: 1 }), s.call(() => this.setLocalLogoMode(l, "thinking"), void 0, 0), s.add(this.animateEnrichmentWaterfall(i), `+=${Ee.rowStartHold}`), s.call(() => this.setLocalLogoMode(l, "done")), s;
  }
  strategyPlans(e) {
    const t = e.map((p) => this.createStrategyPlan(p)), a = document.createElement("div"), i = t.flatMap((p) => this.queryElements(p, ".wa-strategy-plan__bullets li")), n = this.getLastMessageBody(), r = Me.strategyCard, s = "strategyCardsIn", l = r.to.stagger, c = [...t, ...i];
    a.className = "wa-result-grid has-strategy-plans", a.dataset.strategyPlans = e.map((p) => p.id).join(" "), a.append(...t), t.length && m.set(t, { ...r.from }), m.set(i, { ..._n.from });
    ...
    return t.forEach((p, g) => {
      const f = this.queryElements(p, ".wa-strategy-plan__bullets li");
      f.length && u.to(f, { ..._n.to }, `${s}+=${g * l}`);
    }), u.call(() => this.clearMotionHints(c)).call(
      () => this.animateMessageScrollIntoView(d, Z.followDuration, n, xn),
      void 0,
      "+=0.02"
    );
  }
  ...
  swipePersonalizationCard(e, t, a) {
    ...
    ), n = i?.querySelector(`[data-swipe-card="${this.escapeSelectorValue(t)}"]`), r = this.getSwipeCards(i), s = n ? r.indexOf(n) : -1, l = r[s + 1], c = a === "use" ? 1 : -1, d = i?.querySelector(`[data-swipe-action="${a}"]`), u = i?.querySelector("[data-swipe-complete]"), p = i?.querySelector(".wa-swipe-game__actions"), g = m.timeline();
    ...
    return this.addThinkingStepReveal(d, t, { position: "<" }), d.to({}, { duration: Wa.templateHold }).add(this.foldThinkingStep(t)).call(() => {
      ...
      onUpdate: () => {
        ...
        l.forEach(({ label: g, bar: f }) => {
          g && (g.textContent = `${u}/${e.total}`), f && m.set(f, { scaleX: p });
        }), this.requestMessageScroll(r.message);
      }
    }, "+=0.14").to({}, { duration: Wa.finalHold }), a.forEach((u, p) => {
      d.add(this.foldThinkingStep(u), p === 0 ? void 0 : "<");
  ...
  createFileLandingClones(e, t) {
    ...
    return t.map((n, r) => {
      const l = a[Math.min(r, a.length - 1)].getBoundingClientRect(), c = n.getBoundingClientRect(), d = this.getElementLocalRect(l, i), u = this.getElementLocalRect(c, i), p = n.cloneNode(!0), g = this.getCursorFileCardRotation(r, a.length), f = window.getComputedStyle(n), h = d.left + (l.width - c.width) * 0.5, w = d.top + (l.height - c.height) * 0.5;
      return p.classList.add("wa-file-landing-clone"), p.dataset.fileLandingClone = "", i.append(p), m.set(p, {
        position: "absolute",
        zIndex: 21,
        top: 0,
        left: 0,
        ...
        endHeight: c.height,
        startRotation: g,
        setX: m.quickSetter(p, "x", "px"),
        setY: m.quickSetter(p, "y", "px"),
        setRotation: m.quickSetter(p, "rotation", "deg")
      };
    });
  }
  ...
  getFileLandingCloneBounds(e, t) {
    const a = e.map((g) => t === "start" ? g.startX : g.endX), i = e.map((g) => t === "start" ? g.startY : g.endY), n = e.map((g) => t === "start" ? g.startWidth : g.endWidth), r = e.map((g) => t === "start" ? g.startHeight : g.endHeight), s = e.map((g, f) => a[f] + n[f]), l = e.map((g, f) => i[f] + r[f]), c = Math.min(...a), d = Math.min(...i), u = Math.max(...s), p = Math.max(...l);
    return {
      left: c,
      top: d,
      width: u - c,
  ...
  revealPreparedItems(e, t, a, i = null, n = 0) {
    ...
    return r.call(
      () => this.animateMessageScrollIntoView(e, Z.followDuration, i, n),
      void 0,
      Z.componentFollowDelay
    ), r.call(
      () => this.animateMessageScrollIntoView(e, Z.followDuration, i, n),
      void 0,
      "+=0.02"
  ...
  revealMessage(e, t = null, a = 0) {
    let i = 0;
    const n = e.classList.contains("wa-message--component") ? Z.componentRevealDelay : 0.04;
    return m.timeline().call(() => {
  ...
  followCursorWithFile(e, t, a) {
    const i = e.offsetWidth || 154, n = e.offsetHeight || 42, r = m.quickSetter(e, "x", "px"), s = m.quickSetter(e, "y", "px"), l = { x: -120, y: -120 }, c = () => {
      const d = t.readPosition(), u = d.x - i * 0.5 + a.x, p = d.y - n * 0.5 + a.y;
      t.isPayloadDragging() && t.el.dataset.cursorMode !== "drag" && t.setMode("drag"), u !== l.x && (l.x = u, r(u)), p !== l.y && (l.y = p, s(p));
    };
  ...
  streamText(e, t, a) {
    ...
    return m.timeline().call(() => {
      ...
      e.textContent = t, delete e.dataset.streaming, this.cancelScheduledScroll(), this.animateMessageScrollIntoView(a.targetForScroll, Z.followDuration * 0.7);
    });
  }
  foldThinkingStep(e) {
  ...
  claimCard(e) {
    ...
    return this.cardIndex += 1, a.dataset.resultCard = e.id, a.style.display = "none", i && (i.textContent = e.kicker ?? "Result"), n && (n.textContent = e.title), r && (r.textContent = e.body ?? ""), s?.replaceChildren(
      ...(e.rows ?? []).map((c, d) => {
        ...
        return g.textContent = c.value, u.append(p, g), u;
      })
    ), l?.replaceChildren(
      ...(e.actions ?? []).map((c) => {
  ...
  createWaterfallRow(e, t, a) {
    ...
    return s.className = "wa-waterfall-row__chips", a.forEach((l, c) => {
      ...
      if (d.className = "wa-waterfall-service-step", d.append(u), c < a.length - 1) {
        const p = document.createElement("span");
        p.className = "wa-waterfall-arrow", p.setAttribute("aria-hidden", "true"), p.append(this.createTablerIcon("arrow-right", 16)), d.append(p);
      }
      s.append(d);
    }), i.append(n, r, s), i;
  }
  ...
  animateEnrichmentWaterfall(e) {
    ...
    return e.forEach((a, i) => {
      const n = this.queryElements(a, ".wa-waterfall-chip"), r = this.queryElements(a, ".wa-waterfall-service-step"), s = this.getAttemptedWaterfallChips(n), l = this.getWaterfallFinalState(a), c = m.timeline(), d = Ee.rowOffsets[i % Ee.rowOffsets.length] ?? 0, u = Ee.serviceLoadDuration + (i % 2 === 0 ? Ee.serviceLoadVariance : -Ee.serviceLoadVariance);
      c.call(() => this.setWaterfallState(a, "loading")).to(r, {
        ...
        const g = this.getWaterfallFinalState(p);
        c.call(() => this.setWaterfallState(p, "loading")).to(p, {
          scale: 1.025,
          duration: Ee.serviceSettleDuration,
          ease: "power2.out"
        }, "<").to({}, { duration: u }).call(() => this.setWaterfallState(p, g)).to(p, {
          scale: 1,
          duration: Ee.serviceSettleDuration,
  ...
  createMailboxConnection(e) {
    ...
    const p = document.createElement("span");
    p.dataset.mailboxLearningTitleText = "", p.textContent = e.learningTitle ?? gn;
    const g = document.createElement("span");
    g.className = "wa-mailbox-learning__ready-chevron", g.dataset.mailboxLearningReadyChevron = "", g.setAttribute("aria-hidden", "true"), u.append(p, g);
  ...
  createPersonalizationSwipeGame(e) {
    ...
    p.className = "wa-swipe-game__complete", p.dataset.swipeComplete = "", p.textContent = e.completeLabel ?? `${e.signals.length} choices captured`, d.append(p), m.set(p, { autoAlpha: 0, y: 12, scale: 0.96 });
  ...
  createSequenceEngagement(e) {
    ...
    const i = document.createElement("span");
    i.className = "wa-sequence-engagement__count", i.dataset.sequenceCount = "", i.textContent = e.sequences.some((h) => h.steps?.length) ? this.getSequenceCountLabel(a, e.peopleCount) : e.peopleCount;
    ...
    const s = e.sequences.some((h) => h.steps?.length);
    let l = null;
    if (s) {
      const h = document.createElement("div"), w = document.createElement("div");
      h.className = "wa-sequence-people-wrap", w.className = "wa-sequence-people", w.dataset.sequencePeopleRail = e.id, w.setAttribute("aria-label", "Sequence people"), h.append(w), e.sequences.forEach((b, y) => {
        const x = document.createElement("button"), v = document.createElement("span"), _ = document.createElement("span"), T = document.createElement("span"), A = document.createElement("strong"), k = document.createElement("span");
        x.className = "wa-sequence-person-card", x.type = "button", x.tabIndex = -1, x.dataset.sequencePersonCard = `${e.id}:${y}`, x.dataset.sequencePersonIndex = String(y), x.dataset.active = String(y === a), x.setAttribute("aria-pressed", String(y === a)), x.setAttribute("aria-label", `Preview sequence for ${b.name}`), x.addEventListener("click", () => this.playSequencePersonInteraction(e.id, y)), v.className = "wa-sequence-person-card__avatar-wrap", _.className = "wa-sequence-person-card__avatar", _.dataset.avatarTone = String(y % 9 + 1), this.setProfileAvatar(_, b.name, b.avatarUrl), v.append(_);
        const C = this.createSequenceCompanyBadge(b.company);
        C && v.append(C), T.className = "wa-sequence-person-card__copy", A.textContent = b.name, k.textContent = [b.title, b.company].filter(Boolean).join(", "), T.append(A, k), x.append(v, T), w.append(x);
      }), l = h;
    }
    e.sequences.forEach((h, w) => {
      const b = document.createElement("article");
      b.className = "wa-sequence-card", b.dataset.sequenceCard = `${e.id}:${w}`, b.dataset.sequenceIndex = String(w), b.dataset.active = String(w === a), b.dataset.sequenceName = h.name, b.dataset.sequenceMeta = [h.title, h.company].filter(Boolean).join(", "), b.dataset.sequenceAvatarUrl = h.avatarUrl ?? "", b.dataset.sequenceTemplateName = h.name, b.dataset.sequenceTemplateMeta = [h.title, h.company].filter(Boolean).join(", "), b.dataset.sequenceTemplateAvatarUrl = h.avatarUrl ?? "", b.dataset.sequenceEmail = this.getSequenceRecipientEmail(h), b.dataset.sequenceTemplateEmail = this.getSequenceRecipientEmail(h), b.dataset.sequencePhone = this.getSequenceRecipientPhone(h), b.dataset.sequenceTemplatePhone = this.getSequenceRecipientPhone(h), w !== a && (b.style.display = "none", m.set(b, { autoAlpha: 0, y: 8 }));
      const y = document.createElement("div");
      y.className = "wa-sequence-card__top";
      const x = document.createElement("span");
      x.className = "wa-sequence-card__identity";
      const v = document.createElement("strong");
      v.textContent = h.name;
      const _ = document.createElement("span");
      _.textContent = [h.title, h.company].filter(Boolean).join(", "), x.append(v, _);
      const T = document.createElement("span");
      T.className = "wa-sequence-card__label", T.textContent = h.signal ?? "Personalized", y.append(x, T);
      const A = document.createElement("p");
      A.className = "wa-sequence-card__subject", A.textContent = h.subject;
      const k = document.createElement("p");
      k.className = "wa-sequence-card__personalization", k.textContent = h.personalization;
      const C = h.steps;
      if (C?.length) {
        const M = document.createElement("div"), U = this.getInitialSequenceStepIndex(e, C.length), N = document.createElement("div"), L = document.createElement("span"), z = document.createElement("strong"), Y = document.createElement("div");
        M.className = "wa-sequence-steps", C.forEach((D, I) => {
          const R = document.createElement("button"), Ce = document.createElement("span"), Le = document.createElement("span"), We = document.createElement("strong"), ue = this.getSequenceStepWaitDays(D, I, C.length);
          R.className = "wa-sequence-step", R.type = "button", R.tabIndex = -1, R.dataset.stepIndex = String(I), R.dataset.stepOpen = String(I === U), R.dataset.stepSelected = String(I === U), R.dataset.channel = this.slugChannelName(D.channel), R.dataset.stepSubject = I === 0 ? h.subject : D.label, R.dataset.stepBody = this.getSequenceStepCopy(h, D), R.dataset.stepTemplateChannel = D.channel, R.dataset.stepTemplateLabel = D.label, R.dataset.stepTemplateSubject = I === 0 ? h.subject : D.label, R.dataset.stepTemplateBody = this.getSequenceStepCopy(h, D), ue && (R.dataset.waitDays = String(ue), R.dataset.stepTemplateWaitDays = String(ue)), R.setAttribute("aria-pressed", String(I === 0)), R.addEventListener("click", () => {
            this.selectSequenceStep(b, I, { cancelPersonTransition: !0 });
          }), Ce.className = "wa-sequence-step__channel", Ce.append(
            this.createSequenceChannelIcon(D.channel),
            document.createTextNode(this.formatSequenceChannelLabel(D.channel))
          ), Le.className = "wa-sequence-step__copy", We.textContent = this.formatSequenceStepTitle(D.label), Le.append(We), R.append(Ce, Le), M.append(R), ue && M.append(this.createSequenceWaitRow(ue, I));
        }), N.className = "wa-sequence-copy-panel", N.dataset.sequenceCopyPanel = "", L.className = "wa-sequence-copy-panel__meta", L.dataset.sequenceCopyMeta = "", z.className = "wa-sequence-copy-panel__subject", z.dataset.sequenceCopySubject = "", Y.className = "wa-sequence-copy-panel__body", Y.dataset.sequenceCopyBody = "", N.append(L, z, Y), b.append(M, N), this.selectSequenceStep(b, U);
      } else
        b.append(y, A, k);
      r.append(b);
    });
    const c = document.createElement("div");
    c.className = "wa-engage-channels", e.channels.forEach((h) => {
      const w = document.createElement("button");
      w.className = "wa-engage-channel", w.type = "button", w.tabIndex = -1;
      const b = document.createElement("span");
      b.className = "wa-engage-channel__copy";
      const y = document.createElement("strong");
      y.textContent = h.label;
      const x = document.createElement("span");
      if (x.textContent = h.detail, b.append(y, x), w.append(b), h.badge) {
        const v = document.createElement("span");
        v.className = "wa-engage-channel__badge", v.textContent = h.badge, w.dataset.badge = h.badge.toLowerCase(), w.append(v);
      }
      c.append(w);
    });
    const d = document.createElement("div"), u = document.createElement("button"), p = document.createElement("span"), g = document.createElement("button"), f = document.createElement("span");
    return d.className = "wa-sequence-actions", u.className = "wa-sequence-action wa-sequence-action--draft", u.type = "button", u.tabIndex = -1, u.dataset.sequenceSaveDraft = e.id, u.setAttribute("aria-label", "Save as draft"), p.className = "wa-sequence-kickoff__label", p.textContent = "Save as draft", u.append(p), g.className = "wa-sequence-kickoff", g.type = "button", g.tabIndex = -1, g.dataset.sequenceKickoff = e.id, g.setAttribute("aria-label", `Enroll ${e.peopleCount}`), f.className = "wa-sequence-kickoff__label", f.textContent = `Enroll ${e.peopleCount}`, g.append(f), g.addEventListener("click", () => {
      this.sequenceKickoff(e.id).play();
    }), d.append(u, g), s ? (t.append(...this.compactElements(n, l, r, d)), this.observeInitialSequenceRailCenter(t)) : t.append(n, r, c), t;
  }
  ...
  prepareSequencePersonContentSwap(e, t, a, i) {
    ...
    return e.dataset.sequenceContentSwapActive = "true", e.style.minWidth = `${n.width}px`, e.style.minHeight = `${this.formatSequenceSwapSize(n.height)}px`, e.replaceChildren(r, s), this.setDataTablePageCellSwapState([r], 1, 0), this.setDataTablePageCellSwapState([s], 0, K.incomingY), {
      target: e,
      currentClone: r,
      incomingClone: s,
      finalHtml: a,
  ...
  measureSequenceContentSwapBox(e, t, a) {
    const i = e.getBoundingClientRect(), n = this.isSequenceCopyPanelShellRow(e), r = n ? [i.height] : [i.height, e.offsetHeight, e.scrollHeight], s = e.parentElement, l = n ? 0 : Math.ceil(Math.max(Math.abs(K.incomingY), Math.abs(K.outgoingY))) + 2;
    if (!s || i.width <= 0)
      return {
        width: i.width,
        height: Math.max(...r) + l
  ...
  applySequenceTemplateToDisplayCard(e, t, a, i) {
    ...
    t.dataset.sequenceName = a.dataset.sequenceTemplateName ?? a.dataset.sequenceName ?? "", t.dataset.sequenceMeta = a.dataset.sequenceTemplateMeta ?? a.dataset.sequenceMeta ?? "", t.dataset.sequenceAvatarUrl = a.dataset.sequenceTemplateAvatarUrl ?? a.dataset.sequenceAvatarUrl ?? "", t.dataset.sequenceEmail = a.dataset.sequenceTemplateEmail ?? a.dataset.sequenceEmail ?? "", t.dataset.sequencePhone = a.dataset.sequenceTemplatePhone ?? a.dataset.sequencePhone ?? "", r.forEach((c, d) => {
      const u = l[d], p = c.querySelector(".wa-sequence-step__channel"), g = c.querySelector(".wa-sequence-step__copy strong");
      if (!u) return;
      if (c.dataset.channel = u.dataset.channel ?? "", c.dataset.stepSubject = u.dataset.stepTemplateSubject ?? u.dataset.stepSubject ?? "", c.dataset.stepBody = u.dataset.stepTemplateBody ?? u.dataset.stepBody ?? "", c.dataset.waitDays = u.dataset.stepTemplateWaitDays ?? u.dataset.waitDays ?? "", p) {
        const b = u.dataset.stepTemplateChannel ?? p.textContent ?? "";
        p.replaceChildren(
...
`);
  ...
  animateMessageScrollIntoView(e, t = Z.followDuration, a = null, i = 0) {
...
function sa(o, e, t) {
  ...
  const s = e.x - o.x, l = e.y - o.y, c = s / i, d = l / i, u = -d, p = c, g = a() > 0.5 ? 1 : -1, f = t.curve ?? 1, w = Bt(i * (r === "drag" ? 0.1 : r === "click" ? 0.17 : 0.22) * f, 18, 150) * g * (0.72 + a() * 0.44), b = i / Wl[n] + 0.16, y = Bt(
    ...
    y: o.y + l * (0.25 + a() * 0.08) + p * w
  }, T = {
    x: o.x + s * (0.68 + a() * 0.12) - u * w * 0.42,
    y: o.y + l * (0.68 + a() * 0.12) - p * w * 0.42
  }, A = t.settle !== !1 && x > 0;
  return {
    start: o,
    c1: _,
...
class Xl {
    ...
    return this.moveIndex += 1, this.plannedPosition = { ...r }, d.call(() => {
      ...
      this.pathTweenFromFactory(
        () => {
          ...
          const p = this.resolver.resolve(e, n);
          return u = sa(this.currentPosition, p, {
            seed: n,
            intent: t.intent,
            speed: t.speed,
            curve: t.curve,
  ...
  resolveScanPoint(e, t, a, i = "first") {
    ...
    this.resolver.refresh();
    const r = this.seededScanRandom(t), s = this.root.getBoundingClientRect(), l = n.getBoundingClientRect(), c = this.getChatShellRect(), d = c ? Math.max(l.left, c.left + 18) : l.left, u = c ? Math.min(l.right, c.right - 18) : l.right, p = c ? Math.max(l.top, c.top + 58) : l.top, g = c ? Math.min(l.bottom, c.bottom - 34) : l.bottom, f = Math.max(1, u - d), h = Math.max(1, g - p), w = a === "start" ? 0.16 + r() * 0.08 : 0.76 + r() * 0.12, b = 0.34 + r() * 0.32;
    return {
      x: d - s.left + f * w,
      y: p - s.top + h * b
    };
...
}, eo = F("[data-signup-field]", "center", {
  desktop: -74,
  tablet: -66,
  mobile: -48
}), to = F("[data-signup-submit]", "center"), nc = F("[data-send-button]", "center"), Ui = {
  desktop: {
...
}, rc = 2.8, oc = 42, sc = 2, lc = 3, ka = "[data-chat-shell] [data-chat-thread]", cc = `${ka} [data-message-role="assistant"]:not(.wa-message--component) [data-message-body]`, dc = `${ka} [data-message-role="assistant"].wa-message--thinking .wa-research-step[data-step-state="current"] .wa-research-step__body, ${ka} [data-message-role="assistant"].wa-message--thinking .wa-research-step[data-step-state="complete"] .wa-research-step__label`, xi = 0.24, ao = 0.3, Ue = {
...
function io(o) {
  ...
  return [
    ...
    ...ro([
      {
        selector: `[data-mailbox-connection="${_e(o.id)}"]`,
...
function no(o) {
  const e = ut(`[data-style-profile="${_e(o)}"]`), t = Ta(o);
  return ro([
    {
  ...
  switch (t.kind) {
    ...
    case "dataTable":
      Lt(
        ...
        t.at,
        ut(`[data-data-table="${_e(t.config.id)}"]`),
        `table-${t.config.id}`
      );
      return;
    case "enrichmentPanel":
      Lt(
        ...
        t.at,
        ut(`[data-enrichment-panel="${_e(t.config.id)}"]`),
        `enrichment-${t.config.id}`
      );
      return;
    case "strategyPlans":
      {
        const n = ut(`[data-strategy-plans~="${_e(t.plans[0]?.id ?? "strategy")}"]`);
    ...
    case "dataSourcesGrid":
      Lt(
        ...
        t.at,
        ut(`[data-data-sources-grid="${_e(t.config.id)}"]`),
        `sources-${t.config.id}`
      );
      return;
    case "marketingDataSourcesGrid":
      Lt(
        ...
        t.at,
        `[data-marketing-data-sources-grid="${_e(t.config.id)}"]`,
    ...
    case "sequenceEngagement":
      Lt(
        ...
        t.at,
        ut(`[data-sequence-engagement="${_e(t.config.id)}"]`),
...
function pc(o, e, t, a) {
  const i = ut(
    `[data-personalization-swipe-game="${_e(t.id)}"]`
  );
  o.add(e.chat.personalizationSwipeGame(t), a), t.signals.forEach((n, r) => {
    const s = `${i} [data-swipe-card="${_e(n.id)}"]`, l = n.decision === "use" ? 1 : -1, c = n.decision === "use" ? "right" : "left", d = F(s, c, {
...
function mc(o, e, t) {
  ...
  return t.forEach((i, n) => {
    const r = `${e} [data-strategy-plan="${_e(i.id)}"]`;
    a.add(
...
function Ec(o, e) {
  const t = He(e, "status"), a = He(e, "user"), i = He(e, "thinking"), n = He(e, "assistant"), r = ea(e, "strategyCards");
  return De(o, [
...
function Mc(o, e) {
  ...
  if (t && fo(i, mo(t.component)), a) {
    ...
    }), s = n.length > 1 ? `${n.length} context files` : n[0]?.name ?? a.text, l = o.chat.prepareCursorFile(s, o.cursor, n[0]?.type ?? "DOC", n), c = F("[data-chat-shell]", "center", {
      desktop: { x: 0, y: 74 },
      tablet: { x: 0, y: 64 },
      mobile: { x: 0, y: 56 }
    });
...
function Pc(o, e) {
  const t = He(e, "user"), a = ea(e, "table"), i = He(e, "thinking"), n = ea(e, "sequenceEngagement"), r = a ? $t(a.component, "website-visitors-sales") : null, s = n ? Hi(n.component, "visitor-outreach-sequences") : null, l = [];
...
function Rc(o, e) {
  ...
  ), r = a ? e.steps.indexOf(a) : -1, s = n.find((f) => r >= 0 && e.steps.indexOf(f) < r), l = [...n].reverse().find((f) => f !== s), c = t?.text || "may_webinar_attendees.csv", d = Dc(t, s?.component ?? l?.component), u = o.chat.prepareCsvDropArea(), p = o.chat.prepareCursorFile(c, o.cursor), g = F("[data-chat-shell]", "center", {
    desktop: { x: 0, y: 82 },
    tablet: { x: 0, y: 72 },
    mobile: { x: 0, y: 64 }
  });
  return De(o, [
    ...
    { kind: "custom", build: () => p.startFollow(), at: `+=${E.fileGrab}` },
    ...
    { kind: "custom", build: () => p.landAsUploadedFile(c, d), at: "<" },
...
function jc(o, e) {
  const t = o.columns, a = t.findIndex((d) => d.trim().toLowerCase() === "name"), i = a >= 0 ? t.findIndex((d, u) => u > a && /^role\b/i.test(d.trim())) : -1, n = a >= 0 && i >= 0, r = co(e) ? t.findIndex((d) => d.trim().toLowerCase() === "title") : -1, s = n ? i : r >= 0 ? r : void 0, l = t.map((d, u) => u).filter((d) => d !== i && d !== r), c = l.map((d) => {
    ...
    const p = Xc(e, u), g = p.key ?? ne(u || `column-${d + 1}`);
    return {
      key: g,
      label: u,
      width: p.width ?? Kc(u, n),
      cellType: p.cellType ?? Jc(e, u, g),
      person: p.person
    };
  });
  return {
...
const pd = {
  ...
  },
  {
    ...
    entryLeadTime: 0.18,
    build: (o) => {
      const e = o.chat.prepareCsvDropArea(), t = o.chat.prepareCursorFile("may_webinar_attendees.csv", o.cursor), a = F("[data-chat-shell]", "center", {
        desktop: { x: 0, y: 82 },
        tablet: { x: 0, y: 72 },
        mobile: { x: 0, y: 64 }
      });
...
class bd {
  ...
  followPointer = () => {
    ...
    if (this.mode === "return") {
      ...
      if (this.target = t, this.cursor.mimicViewportPoint(i, 1, a < 1 ? n : t), a >= 1 || je(this.getCursorViewportPoint(), t) <= ri.arriveDistance) {
  ...
  updatePlayTarget(e) {
    ...
    this.target = _d(n, this.pointer, Ye.minPointerDistance, Ye.viewportInset);
  }
  resumeFollowing(e) {
  ...
  isDismissShakeWindow(e) {
    ...
    return i >= ct.minDurationMs && n >= ct.minTravel && r <= ct.maxNetDistance && n / i >= ct.minAverageSpeed && s >= ct.minTravelToNetRatio && this.countAxisReversals(e) >= ct.minAxisReversals;
  }
...
class Cd {
  ...
  getMarkerProgress(e, t, a = null) {
    if (a?.marker === e && a.trackLength > 0) {
      ...
      return ua((r - a.trackStart) / a.trackLength);
    }
...
function Pd(o) {
  if (!Ct(o) || !Array.isArray(o.stories)) return null;
...
function Id(o) {
  if (!Ct(o) || !Array.isArray(o.steps)) return null;
  const e = Se(o.id), t = Se(o.label), a = Se(o.summary), i = o.steps.map((n) => qd(n)).filter((n) => !!n);
...
function qd(o) {
  ...
  return !e || !t || !Rd(t) ? null : {
    ...
    text: a ?? "",
    note: i ?? "",
    thinking: Ct(o.thinking) ? Ld(o.thinking, a ?? "", i ?? "") : t === "thinking" ? vo(a ?? "", i ?? "") : void 0,
    component: Ct(o.component) ? Dd(o.component) : void 0
  };
}
function Ld(o, e, t) {
  ...
  return i.length ? {
    title: Se(o.title) ?? Fe,
    elapsed: Se(o.elapsed) ?? Ra(i.length),
    items: i
  } : vo(e, t);
}
function Nd(o, e) {
  ...
  return t ? {
    label: t,
    detail: Se(o.detail) ?? zi(t, e),
    disclosure: Se(o.disclosure) ?? (e === 0 ? Vt : fa)
  } : null;
}
function vo(o, e = "") {
  return {
...
function Hd(o, {
  ...
  function r(l = t, c = {}) {
    ...
    if (u) return u;
    c.injectStyles !== !1 && a?.();
    const p = o(d, c), g = p.destroy.bind(p);
    let f = !1;
    const h = {
      ...p,
      destroy: () => {
