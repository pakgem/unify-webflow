...
var we = {
...
}, ae = Array.isArray, Lo = /random\([^)]+\)/g, No = /,\s*/g, Ki = /(?:-?\.?\d|\.)+/gi, rr = /[-+=.]*\d+[.e\-+]*\d*[e\-+]*\d*/g, vt = /[-+=.]*\d+[.e-]*\d*[a-z%]*/g, Fa = /[-+=.]*\d+\.?\d*(?:e-|e\+)?\d*/gi, or = /[+-]=-?[.\d]+/, Oo = /[^,'"\[\]\s]+/gi, Bo = /^[+\-=e\s\d]*\d+[.\d]*([a-z]*|%)\s*$/i, G, Re, ui, Pi, be = {}, _a = {}, sr, lr = function(e) {
  return (_a = Pt(e, be)) && de;
}, Ri = function(e, t) {
  ...
  $e.length && !Z && va(), e.render(t, a, !!(Z && t < 0 && Li(e))), $e.length && !Z && va();
}, pr = function(e) {
  var t = parseFloat(e);
  ...
  return t.parent && tt(t), t._start = V((He(a) ? a : a || e !== G ? ve(e, a, t) : e._time) + t._delay), t._end = V(t._start + (t.totalDuration() / Math.abs(t.timeScale()) || 0)), mr(e, t, "_first", "_last", e._sort ? "_start" : 0), gi(t) || (e._recent = t), i || fr(e, t), e._ts < 0 && qa(e, e._tTime), e;
}, wr = function(e, t) {
  ...
  return X(i) ? d = u = {
    ...
    var p = (m || t).length, w = r[p], y, b, x, v, _, T, A, k, C;
    if (!w) {
      ...
      for (w = r[p] = [], y = l ? Math.min(C, p) * d - 0.5 : i % C, b = C === Ae ? 0 : l ? p * u / C - 0.5 : i / C | 0, A = 0, k = Ae, T = 0; T < p; T++)
        x = T % C - y, v = b - (T / C | 0), w[T] = _ = c ? Math.abs(c === "y" ? v : x) : ir(x * x + v * v), _ > A && (A = _), _ < k && (k = _);
  ...
  if (n)
    return l = i[t + "Params"], c = i.callbackScope || e, a && $e.length && va(), s && (H = s), d = l ? n.apply(c, l) : n.call(c), H = r, d;
}, zt = function(e) {
  ...
  if (n = n.map(function(h) {
    ...
    for (c = e.replace(et, "1").split(vt), u = c.length - 1; s < u; s++)
  ...
  return u = {
    ...
    wake: function() {
      sr && (!ui && Mi() && (Re = ui = window, Pi = Re.document || {}, be.gsap = de, (Re.gsapVersions || (Re.gsapVersions = [])).push(de.version), lr(_a || Re.GreenSockGlobals || !Re.gsap && Re || {}), kr.forEach(Tr)), d = typeof requestAnimationFrame < "u" && requestAnimationFrame, l && u.sleep(), c = d || function(w) {
...
var re = /* @__PURE__ */ (function(o) {
  ...
  return t.to = function(i, n, r) {
    ...
    return n.duration = 0, n.parent = this, Vt(n).repeatDelay || (n.repeat = 0), n.immediateRender = !!n.immediateRender, new K(i, n, ve(this, r), 1), this;
    ...
    if (this !== G && d > l && i >= 0 && (d = l), d !== this._tTime || r || u) {
      if (s !== this._time && c && (d += this._time - s, i += this._time - s), h = d, v = this._start, x = this._ts, y = !x, u && (c || (s = this._zTime), (i || !n) && (this._zTime = i)), this._repeat) {
        ...
        if (h = V(d % w), d === l ? (p = this._repeat, h = c) : (_ = V(d / w), p = ~~_, p && p === _ && (h = c, p--), h > c && (h = c)), _ = Rt(this._tTime, w), !s && this._tTime && _ !== p && this._tTime - _ * w - this._dur <= 0 && (_ = p), T && p & 1 && (h = c - h, A = 1), p !== _ && !this._lock) {
          var k = T && _ & 1, C = k === (T && p & 1);
          if (p < _ && (k = !k), s = k ? 0 : d % c ? c : d, this._lock = 1, this.render(s || (A ? 0 : V(p * w)), n, !c)._lock = 0, this._tTime = d, !n && this.parent && me(this, "onRepeat"), this.vars.repeatRefresh && !A && (this.invalidate()._lock = 1, _ = p), s && s !== this._time || y !== !this._ts || this.vars.onRepeat && !this.parent && !this._act)
            return this;
      ...
      if (this._hasPause && !this._forcing && this._lock < 2 && (b = jo(this, V(s), V(h)), b && (d -= h - (h = b._start))), this._tTime = d, this._time = h, this._act = !!x, this._initted || (this._onUpdate = this.vars.onUpdate, this._initted = 1, this._zTime = i, s = 0), !s && d && c && !n && !_ && (me(this, "onStart"), this._tTime !== d))
        return this;
      if (h >= s && i >= 0)
        for (g = this._first; g; ) {
      ...
      if (b && !n && (this.pause(), b.render(h >= s ? 0 : -B)._zTime = h >= s ? 1 : -1, this._ts))
        return this._start = v, Ia(this), this.render(i, n, r);
      this._onUpdate && !n && me(this, "onUpdate", !0), (d === l && this._tTime >= this.totalDuration() || !d && s) && (v === this._start || Math.abs(x) !== Math.abs(this._ts)) && (this._lock || ((i || !c) && (d === l && this._ts > 0 || !d && this._ts < 0) && tt(this, 1), !n && !(i < 0 && !s) && (d || s || !l) && (me(this, d === l && i >= 0 ? "onComplete" : "onReverseComplete", !0), this._prom && !(d < l && this.timeScale() > 0) && this._prom())));
    }
    return this;
  }, t.add = function(i, n) {
    var r = this;
    if (He(n) || (n = ve(this, n, i)), !(i instanceof Jt)) {
      if (ae(i))
    ...
    return s.data = "isPause", this._hasPause = 1, De(this, s, ve(this, i));
...
var us = function(e, t, a, i, n, r, s) {
  ...
  var i = e.vars, n = i.ease, r = i.startAt, s = i.immediateRender, l = i.lazy, c = i.onUpdate, d = i.runBackwards, u = i.yoyoEase, h = i.keyframes, g = i.autoRevert, m = e._dur, p = e._startAt, w = e._targets, y = e.parent, b = y && y.data === "nested" ? y.vars.targets : w, x = e._overwrite === "auto" && !Ti, v = e.timeline, _ = i.easeReverse || u, T, A, k, C, M, F, z, L, U, D, I, P, $;
  if (v && (!h || !n) && (n = "none"), e._ease = ft(n, Yt.ease), e._rEase = _ && (ft(_) || e._ease), e._from = !v && !!i.runBackwards, e._from && (e.ratio = 1), !v || h && !i.stagger) {
    ...
    for (e._pt = e._ptCache = 0, l = m && oe(l) || l && !m, A = 0; A < w.length; A++) {
      if (M = w[A], z = M._gsap || qi(w)[A]._gsap, e._ptLookup[A] = D = {}, hi[z.id] && $e.length && va(), I = b === w ? A : b.indexOf(M), L && (U = new L()).init(M, P || T, e, I, b) !== !1 && (e._pt = C = new le(e._pt, M, U.name, 0, 1, U.render, U, 0, U.priority), U._props.forEach(function(Te) {
        D[Te] = C;
      }), U.priority && (F = 1)), !L || P)
        for (k in T)
...
var K = /* @__PURE__ */ (function(o) {
  ...
  function e(a, i, n, r) {
    ...
    var l = s.vars, c = l.duration, d = l.delay, u = l.immediateRender, h = l.stagger, g = l.overwrite, m = l.keyframes, p = l.defaults, w = l.scrollTrigger, y = i.parent || G, b = (ae(a) || nr(a) ? He(a[0]) : "length" in i) ? [a] : Se(a), x, v, _, T, A, k, C, M;
    if (s._targets = b.length ? qi(b) : Qt("GSAP target " + a + " not found. https://gsap.com", !we.nullTargetWarn) || [], s._ptLookup = [], s._overwrite = g, m || h || ra(c) || ra(d)) {
      ...
      if (x = s.timeline = new re({
        ...
        for (v = 0; v < T; v++)
          _ = Aa(i, Lr), _.stagger = 0, F && (_.easeReverse = F), M && Pt(_, M), k = b[v], _.duration = +Wt(c, Oe(s), v, k, b), _.delay = (+Wt(d, Oe(s), v, k, b) || 0) - s._delay, !h && T === 1 && _.delay && (s._delay = d = _.delay, s._start += d, _.delay = 0), x.to(k, _, C ? C(v, k, b) : 0), x._ease = R.none;
        ...
        if (ae(m))
          ...
          _ = {};
          for (A in m)
            A === "ease" || A === "easeEach" || ms(A, m[A], _, m.easeEach);
          for (A in _)
...
we.stringFilter = Pr;
var wt = [], ba = {}, vs = [], an = 0, As = 0, Ga = function(e) {
...
}, Wa("roundProps", wi), Wa("modifiers"), Wa("snap", vr)) || Ca;
...
var nn, Ke, kt, Ui, pt, rn, Hi, Ts = function() {
  ...
  Ts() && window.document && (nn = window, Ke = nn.document, kt = Ke.documentElement, pt = _i("div") || {
    style: {}
  }, _i("div"), W = qt(W), ce = W + "Origin", pt.style.cssText = "border-width:0;line-height:0;position:absolute;padding:0", Wr = !!qt("perspective"), Hi = de.core.reverting, Ui = 1);
}, ln = function(e) {
  ...
  var n;
  return Ui || vi(), t in qe && t !== "transform" && (t = qe[t], ~t.indexOf(",") && (t = t.split(",")[0])), Ve[t] && t !== "transform" ? (n = $t(e, i), n = t !== "transformOrigin" ? n[t] : n.svg ? n.origin : Ta(fe(e, ce)) + " " + n.zOrigin + "px") : (n = e.style[t], (!n || n === "auto" || i || ~(n + "").indexOf("calc(")) && (n = ka[t] && ka[t](e, t, a) || fe(e, t) || ur(e, t) || (t === "opacity" ? 1 : 0))), a && !~(n + "").trim().indexOf(" ") ? it(e, t, n, a) + a : n;
}, Vs = function(e, t, a, i) {
  if (!a || a === "none") {
    var n = qt(t, e, 1), r = n && fe(e, n, 1);
    r && r !== a ? (t = n, a = r) : t === "borderColor" && (a = fe(e, "borderTopColor"));
  }
  var s = new le(this._pt, e.style, t, 0, 1, Br), l = 0, c = 0, d, u, h, g, m, p, w, y, b, x, v, _;
  if (s.b = a, s.e = i, a += "", i += "", i.substring(0, 6) === "var(--" && (i = fe(e, i.substring(4, i.indexOf(")")))), i === "auto" && (p = e.style[t], e.style[t] = i, i = fe(e, t) || i, p ? e.style[t] = p : at(e, t)), d = [a, i], Pr(d), a = d[0], i = d[1], h = a.match(vt) || [], _ = i.match(vt) || [], _.length) {
    for (; u = vt.exec(i); )
      w = u[0], b = i.substring(l, u.index), m ? m = (m + 1) % 5 : (b.substr(-5) === "rgba(" || b.substr(-5) === "hsla(") && (m = 1), w !== (p = h[c++] || "") && (g = parseFloat(p) || 0, v = p.substr((g + "").length), w.charAt(1) === "=" && (w = Ct(g, w) + v), y = parseFloat(w), x = w.substr((y + "").length), l = vt.lastIndex - x.length, x || (x = x || we.units[t] || v, l === i.length && (i += x, s.e += x)), v !== x && (g = it(e, t, p, x) || 0), s._pt = {
        _next: s._pt,
        p: b || c === 1 ? b : ",",
        //note: SVG spec allows omission of comma/space when a negative sign is wedged between two numbers, like 2.5-5.3 instead of 2.5,-5.3 but when tweening, the negative value may switch to positive, so we insert the comma just in case.
        s: g,
  ...
  */
  ...
  w !== Lt && (v += "perspective(" + w + lt), (i || n) && (v += "translate(" + i + "%, " + n + "%) "), (_ || r !== Lt || s !== Lt || l !== Lt) && (v += l !== Lt || _ ? "translate3d(" + r + ", " + s + ", " + l + ") " : "translate(" + r + ", " + s + lt), c !== st && (v += "rotate(" + c + lt), d !== st && (v += "rotateY(" + d + lt), u !== st && (v += "rotateX(" + u + lt), (h !== st || g !== st) && (v += "skew(" + h + ", " + g + lt), (m !== 1 || p !== 1) && (v += "scale(" + m + ", " + p + lt), b.style[W] = v || "translate(0, 0)";
}, Qs = function(e, t) {
  var a = t || this, i = a.xPercent, n = a.yPercent, r = a.x, s = a.y, l = a.rotation, c = a.skewX, d = a.skewY, u = a.scaleX, h = a.scaleY, g = a.target, m = a.xOrigin, p = a.yOrigin, w = a.xOffset, y = a.yOffset, b = a.forceCSS, x = parseFloat(r), v = parseFloat(s), _, T, A, k, C;
  l = parseFloat(l), c = parseFloat(c), d = parseFloat(d), d && (d = parseFloat(d), c += d, l += d), l || c ? (l *= Tt, c *= Tt, _ = Math.cos(l) * u, T = Math.sin(l) * u, A = Math.sin(l - c) * -h, k = Math.cos(l - c) * h, c && (d *= Tt, C = Math.tan(c - d), C = Math.sqrt(1 + C * C), A *= C, k *= C, d && (C = Math.tan(d), C = Math.sqrt(1 + C * C), _ *= C, T *= C)), _ = Q(_), T = Q(T), A = Q(A), k = Q(k)) : (_ = u, k = h, T = A = 0), (x && !~(r + "").indexOf("px") || v && !~(s + "").indexOf("px")) && (x = it(g, "x", r, "px"), v = it(g, "y", s, "px")), (m || p || w || y) && (x = Q(x + m - (m * _ + p * A) + w), v = Q(v + p - (m * T + p * k) + y)), (i || n) && (C = g.getBBox(), x = Q(x + i / 100 * C.width), v = Q(v + n / 100 * C.height)), C = "matrix(" + _ + "," + T + "," + A + "," + k + "," + x + "," + v + ")", g.setAttribute("transform", C), b && (g.style[W] = C);
...
var Jr = {
  ...
  init: function(e, t, a, i, n) {
    var r = this._props, s = e.style, l = a.vars.startAt, c, d, u, h, g, m, p, w, y, b, x, v, _, T, A, k, C;
    Ui || vi(), this.styles = this.styles || Gr(e), k = this.styles.props, this.tween = a;
    for (p in t)
        ...
        if (g = typeof d, m = ka[p], g === "function" && (d = d.call(a, i, e, n), g = typeof d), g === "string" && ~d.indexOf("random(") && (d = Kt(d)), m)
          ...
          if (l && p in l ? (c = typeof l[p] == "function" ? l[p].call(a, i, e, n) : l[p], X(c) && ~c.indexOf("random(") && (c = Kt(c)), te(c + "") || c === "auto" || (c += we.units[p] || te(Fe(e, p)) || ""), (c + "").charAt(1) === "=" && (c = Fe(e, p))) : c = Fe(e, p), h = parseFloat(c), b = g === "string" && d.charAt(1) === "=" && d.substr(0, 2), b && (d = d.substr(2)), u = parseFloat(d), p in qe && (p === "autoAlpha" && (h === 1 && Fe(e, "visibility") === "hidden" && u && (h = 0), k.push("visibility", 0, s.visibility), Xe(this, s, "visibility", h ? "inherit" : "hidden", u ? "inherit" : "hidden", !u)), p !== "scale" && p !== "transform" && (p = qe[p], ~p.indexOf(",") && (p = p.split(",")[0]))), x = p in Ve, x) {
            ...
            if (v || (_ = e._gsap, _.renderTransform && !t.parseTransform || $t(e, t.parseTransform), T = t.smoothOrigin !== !1 && _.smooth, v = this._pt = new le(this._pt, s, W, 0, 1, _.renderTransform, _, 0, -1), v.dep = 1), p === "scale")
              ...
              k.push(ce, 0, s[ce]), d = Gs(d), _.svg ? Ai(e, d, 0, T, 0, this) : (y = parseFloat(d.split(" ")[2]) || 0, y !== _.zOrigin && Xe(this, _, "zOrigin", _.zOrigin, y), Xe(this, s, p, Ta(c), Ta(d)));
              continue;
            } else if (p === "svgOrigin") {
              Ai(e, d, 1, T, 0, this);
              continue;
            } else if (p in jr) {
              js(this, _, p, h, b ? Ct(h, b + d) : d);
              continue;
          ...
          if (x || (u || u === 0) && (h || h === 0) && !Ms.test(d) && p in s)
            w = (c + "").substr((h + "").length), u || (u = 0), y = te(d) || (p in we.units ? we.units[p] : w), w !== y && (h = it(e, p, c, y)), this._pt = new le(this._pt, x ? _ : s, p, h, (b ? Ct(h, b + u) : u) - h, !x && (y === "px" || p === "zIndex") && t.autoRound !== !1 ? Is : xi), this._pt.u = y || 0, x && C !== d ? (this._pt.b = c, this._pt.e = C, this._pt.r = Ds) : w !== y && y !== "%" && (this._pt.b = c, this._pt.r = Rs);
          else if (p in s)
  ...
  createSequenceEngagement(e) {
    ...
    if (r) {
      ...
      m.className = "wa-sequence-people-wrap", p.className = "wa-sequence-people", p.dataset.sequencePeopleRail = e.id, p.setAttribute("aria-label", "Sequence people"), m.append(p), e.sequences.forEach((w, y) => {
        ...
        k && x.append(k), _.className = "wa-sequence-person-card__copy", T.textContent = w.name, A.textContent = [w.title, w.company].filter(Boolean).join(", "), _.append(T, A), b.append(x, _), p.append(b);
      }), s = m;
    }
...
function ca(o, e, t) {
  ...
  const s = e.x - o.x, l = e.y - o.y, c = s / i, d = l / i, u = -d, h = c, g = a() > 0.5 ? 1 : -1, m = t.curve ?? 1, w = Je(i * (r === "drag" ? 0.1 : r === "click" ? 0.17 : 0.22), 18, 150) * m * g * (0.72 + a() * 0.44), y = i / ac[n] + 0.16, b = Je(
    ...
    0.3,
    1.98
  ), x = t.overshoot === !1 || i < 120 ? 0 : typeof t.overshoot == "number" ? t.overshoot : Je(i * 0.026, 4, 18), v = x > 0 ? {
    x: e.x + c * x,
    y: e.y + d * x
  } : e, _ = {
...
}, _c = 2.8, vc = 42, Ac = 2, Sc = 3, Ma = "[data-chat-shell] [data-chat-thread]", Cc = `${Ma} [data-message-role="assistant"]:not(.wa-message--component) [data-message-body]`, kc = `${Ma} [data-message-role="assistant"].wa-message--thinking .wa-research-step[data-step-state="current"] .wa-research-step__body, ${Ma} [data-message-role="assistant"].wa-message--thinking .wa-research-step[data-step-state="complete"] .wa-research-step__label`, Pa = 0.24, uo = 0.3, ze = {
