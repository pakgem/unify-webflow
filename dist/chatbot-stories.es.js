...
var ge = {
  ...
  overwrite: !1,
  delay: 0
}, bi, X, G, xe = 1e8, q = 1 / xe, ai = Math.PI * 2, fo = ai / 4, wo = 0, Vn = Math.sqrt, bo = Math.cos, yo = Math.sin, K = function(e) {
  ...
  return Y(e) || K(e);
}, Hn = typeof ArrayBuffer == "function" && ArrayBuffer.isView || function() {
}, ee = Array.isArray, xo = /random\([^)]+\)/g, _o = /,\s*/g, zi = /(?:-?\.?\d|\.)+/gi, Wn = /[-+=.]*\d+[.e\-+]*\d*[e\-+]*\d*/g, wt = /[-+=.]*\d+[.e-]*\d*[a-z%]*/g, Ra = /[-+=.]*\d+\.?\d*(?:e-|e\+)?\d*/gi, Yn = /[+-]=-?[.\d]+/, Ao = /[^,'"\[\]\s]+/gi, vo = /^[+\-=e\s\d]*\d+[.\d]*([a-z]*|%)\s*$/i, H, Ee, ii, _i, me = {}, pa = {}, Qn, jn = function(e) {
  ...
  suppressEvents: !0
}, vi = {}, Xe = [], ni = {}, Xn, de = {}, Ia = {}, Ui = 30, da = [], ki = "", Si = function(e) {
  var t = e[0], a, i;
  ...
  for (i = e.length; i--; )
    e[i] && (e[i]._gsap || (e[i]._gsap = new br(e[i], a))) || e.splice(i, 1);
  return e;
}, ut = function(e) {
  ...
  var t = parseFloat(e);
  return (t || t === 0) && (e + "").match(Ao).length < 2 ? t : K(e) ? e.trim() : e;
}, er = function(e) {
  return e;
}, fe = function(e, t) {
  for (var a in t)
  ...
  var t = e.parent || H, a = e.keyframes ? To(ee(e.keyframes)) : fe;
  if (re(e.inherit))
    for (; t; )
  ...
  return t.parent && Ze(t), t._start = V((Ge(a) ? a : a || e !== H ? be(e, a, t) : e._time) + t._delay), t._end = V(t._start + (t.totalDuration() / Math.abs(t.timeScale()) || 0)), tr(e, t, "_first", "_last", e._sort ? "_start" : 0), oi(t) || (e._recent = t), i || ar(e, t), e._ts < 0 && Sa(e, e._tTime), e;
}, ir = function(e, t) {
  return (me.ScrollTrigger || Ai("scrollTrigger", t)) && me.ScrollTrigger.create(t, e);
}, nr = function(e, t, a, i, n) {
  if (Ei(e, t, n), !e._initted)
    return 1;
  if (!a && e._pt && !X && (e._dur && e.vars.lazy !== !1 || !e._dur && e.vars.lazy) && Xn !== ue.frame)
  ...
  var n = e.ratio, o = t < 0 || !t && (!e._start && Ro(e) && !(!e._initted && oi(e)) || (e._ts < 0 || e._dp._ts < 0) && !oi(e)) ? 0 : 1, s = e._rDelay, l = 0, c, d, u;
  ...
  var i = e.labels, n = e._recent || Lo, o = e.duration() >= xe ? n.endTime(!1) : e._dur, s, l, c;
  ...
  return !K(e) || !(t = vo.exec(e)) ? "" : t[1];
}, No = function(e, t, a) {
  return tt(a, function(i) {
    return ea(e, t, i);
  });
}, si = [].slice, rr = function(e, t) {
  return e && Ie(e) && "length" in e && (!t && !e.length || e.length - 1 in e && Ie(e[0])) && !e.nodeType && e !== Ee;
}, Oo = function(e, t, a) {
  return a === void 0 && (a = []), e.forEach(function(i) {
    var n;
    return K(i) && !t || rr(i, 1) ? (n = a).push.apply(n, _e(i)) : a.push(i);
  }) || a;
}, _e = function(e, t, a) {
  return G && !t && G.selector ? G.selector(e) : K(e) && !a && (ii || !Tt()) ? si.call((t || _i).querySelectorAll(e), 0) : ee(e) ? Oo(e, a) : rr(e) ? si.call(e, 0) : e ? [e] : [];
}, li = function(e) {
  ...
  return K(i) ? d = u = {
    ...
    if (!w) {
      ...
      for (w = o[h] = [], b = l ? Math.min(S, h) * d - 0.5 : i % S, y = S === xe ? 0 : l ? h * u / S - 0.5 : i / S | 0, v = 0, C = xe, T = 0; T < h; T++)
        _ = T % S - b, A = y - (T / S | 0), w[T] = x = c ? Math.abs(c === "y" ? A : _) : Vn(_ * _ + A * A), x > v && (v = x), x < C && (C = x);
      i === "random" && or(w), w.max = v - C, w.min = C, w.v = h = (parseFloat(t.amount) || parseFloat(t.each) * (S > h ? h - 1 : c ? c === "y" ? h / S : S : Math.max(S, h / S)) || 0) * (i === "edges" ? -1 : 1), w.b = h < 0 ? n - h : n, w.u = $(t.amount || t.each) || 0, a = a && h < 0 ? Ko(a) : a;
    }
  ...
  var i = t - e;
  return ee(e) ? dr(e, r(0, e.length), t) : tt(a, function(n) {
    return (i + (n - e) % i) % i + e;
  });
}, Uo = function r(e, t, a) {
  var i = t - e, n = i * 2;
  return ee(e) ? dr(e, r(0, e.length - 1), t) : tt(a, function(o) {
    return o = (n + (o - e) % n) % n || 0, e + (o > i ? n - o : o);
  });
}, Yt = function(e) {
  return e.replace(xo, function(t) {
    var a = t.indexOf("[") + 1, i = t.substring(a || 7, a ? t.indexOf("]") : t.length - 1).split(_o);
    return cr(a ? i : +i[0], a ? 0 : +i[1], +i[2] || 1e-5);
  });
  ...
  if (e)
    if (e = !e.name && e.default || e, xi() || e.headless) {
      ...
      Kn(t, i), e.register && e.register(ce, i, se);
    } else
      hr.push(e);
}, B = 255, Ot = {
  aqua: [0, B, B],
  ...
  if (!i) {
    if (e.substr(-1) === "," && (e = e.substr(0, e.length - 1)), Ot[e])
      ...
      if (i = f = e.match(zi), !t)
        ...
        return i = e.match(Wn), a && i.length < 4 && (i[3] = 1), i;
    } else
  ...
  if (n = n.map(function(g) {
    return (g = gr(g, t, 1)) && o + (t ? g[0] + "," + g[1] + "%," + g[2] + "%," + g[3] : g.join(",")) + ")";
...
})(), Vo = /hsl[a]?\(/, fr = function(e) {
  var t = e.join(" "), a;
  if (Je.lastIndex = 0, Je.test(t))
    return a = Vo.test(t), e[1] = Yi(e[1], a), e[0] = Yi(e[0], a, mr(e[1])), !0;
}, Qt, ue = (function() {
  ...
  return u = {
    ...
    wake: function() {
      Qn && (!ii && xi() && (Ee = ii = window, _i = Ee.document || {}, me.gsap = ce, (Ee.gsapVersions || (Ee.gsapVersions = [])).push(ce.version), jn(pa || Ee.GreenSockGlobals || !Ee.gsap && Ee || {}), hr.forEach(pr)), d = typeof requestAnimationFrame < "u" && requestAnimationFrame, l && u.sleep(), c = d || function(w) {
  ...
  return !Qt && ue.wake();
}, R = {}, Ho = /^[\d.\-M][\d.\-,\s]/, Wo = /["']/g, Yo = function(e) {
  for (var t = {}, a = e.substr(1, e.length - 3).split(":"), i = a[0], n = 1, o = a.length, s, l, c; n < o; n++)
    l = a[n], s = n !== o - 1 ? l.lastIndexOf(",") : l.length, c = l.substr(0, s), t[i] = isNaN(c) ? c.replace(Wo, "").trim() : +c, i = l.substr(s + 1).trim();
  return t;
}, Qo = function(e) {
  ...
  return a && t.length > 1 && a.config ? a.config.apply(null, ~e.indexOf("{") ? [Yo(t[1])] : Qo(e).split(",").map($n)) : R._CE && Ho.test(e) ? R._CE("", e) : a;
}, Ko = function(e) {
  return function(t) {
    return 1 - e(1 - t);
  };
}, pt = function(e, t) {
  return e && (Y(e) ? e : R[e] || jo(e)) || t;
}, mt = function(e, t, a, i) {
  ...
  var i = t >= 1 ? t : 1, n = (a || (e ? 0.3 : 0.45)) / (t < 1 ? t : 1), o = n / ai * (Math.asin(1 / i) || 0), s = function(d) {
    return d === 1 ? 1 : i * Math.pow(2, -10 * d) * yo((d - o) * n) + 1;
...
var br = function(e, t) {
  this.id = wo++, e._gsap = this, this.target = e, this.harness = t, this.get = t ? t.get : Jn, this.set = t ? t.getSetter : Pi;
  ...
  return e.delay = function(a) {
    ...
    if (n && n.smoothChildTiming && this._ts) {
      for (Sa(this, a), !n._dp || n.parent || ar(n, this); n && n.parent; )
    ...
    return (this._tTime !== a || !this._dur && !i || this._initted && Math.abs(this._zTime) === q || !this._initted && this._dur && a || !a && !this._initted && (this.add || this._ptLookup)) && (this._ts || (this._pTime = a), Zn(this, a, i)), this;
  }, e.time = function(a, i) {
    ...
    return this._rts = +a || 0, this._ts = this._ps || a === -q ? 0 : this._rts, this.totalTime(ea(-Math.abs(this._delay), this.totalDuration(), n), i !== !1), ka(this), Mo(this);
  }, e.paused = function(a) {
...
var ne = /* @__PURE__ */ (function(r) {
  ...
  function e(a, i) {
    var n;
    return a === void 0 && (a = {}), n = r.call(this, a) || this, n.labels = {}, n.smoothChildTiming = !!a.smoothChildTiming, n.autoRemoveChildren = !!a.autoRemoveChildren, n._sort = re(a.sortChildren), H && Me(a.parent || H, Be(n), i), a.reversed && n.reverse(), a.paused && n.paused(!0), a.scrollTrigger && ir(Be(n), a.scrollTrigger), n;
  }
  var t = e.prototype;
  return t.to = function(i, n, o) {
    ...
    if (this !== H && d > l && i >= 0 && (d = l), d !== this._tTime || o || u) {
      ...
      if (this._hasPause && !this._forcing && this._lock < 2 && (y = Do(this, V(s), V(g)), y && (d -= g - (g = y._start))), this._tTime = d, this._time = g, this._act = !!_, this._initted || (this._onUpdate = this.vars.onUpdate, this._initted = 1, this._zTime = i, s = 0), !s && d && c && !n && !x && (he(this, "onStart"), this._tTime !== d))
        return this;
      if (g >= s && i >= 0)
        for (p = this._first; p; ) {
    ...
    for (var o = [], s = _e(i), l = this._first, c = Ge(n), d; l; )
      l instanceof j ? Co(l._targets, s) && (c ? (!Ye || l._initted && l._ts) && l.globalTime(0) <= n && l.globalTime(l.totalDuration()) > n : !n || l.isActive()) && o.push(l) : (d = l.getTweensOf(s, n)).length && o.push.apply(o, d), l = l._next;
    return o;
    ...
    if (H._ts && (Zn(H, fa(i, H)), Xn = ue.frame), ue.frame >= Ui) {
      Ui += ge.autoSleep || 120;
      var n = H._first;
...
var Xo = function(e, t, a, i, n, o, s) {
  var l = new se(this._pt, e, t, 0, 1, kr, null, n), c = 0, d = 0, u, g, p, f, h, w, b, y;
  ...
  return l.c = c < i.length ? i.substring(c, i.length) : "", l.fp = s, (Yn.test(i) || b) && (l.e = 0), this._pt = l, l;
}, Ti = function(e, t, a, i, n, o, s, l, c, d) {
  Y(i) && (i = i(n || 0, e, o));
  var u = e[t], g = a !== "get" ? a : Y(u) ? c ? e[t.indexOf("set") || !Y(e["get" + t.substr(3)]) ? t : "get" + t.substr(3)](c) : e[t]() : u, p = Y(u) ? c ? ts : Ar : Mi, f;
  if (K(i) && (~i.indexOf("random(") && (i = Yt(i)), i.charAt(1) === "=" && (f = yt(g, i) + ($(g) || 0), (f || f === 0) && (i = f))), !d || g !== i || di)
    return !isNaN(g * i) && i !== "" ? (f = new se(this._pt, e, t, +g || 0, i - (g || 0), typeof u == "boolean" ? is : vr, 0, p), c && (f.fp = c), s && f.modifier(s, this, e), this._pt = f) : (!u && !(t in e) && Ai(t, i), Xo.call(this, e, t, g, i, p, l || ge.stringFilter, c));
}, Jo = function(e, t, a, i, n) {
  if (Y(e) && (e = Ut(e, n, t, a, i)), !Ie(e) || e.style && e.nodeType || ee(e) || Hn(e))
    return K(e) ? Ut(e, n, t, a, i) : e;
  var o = {}, s;
  for (s in e)
    o[s] = Ut(e[s], n, t, a, i);
  return o;
}, yr = function(e, t, a, i, n, o) {
  var s, l, c, d;
  if (de[e] && (s = new de[e]()).init(n, s.rawVars ? t[e] : Jo(t[e], i, n, o, a), a, i, o) !== !1 && (a._pt = l = new se(a._pt, n, e, 0, 1, s.render, s, 0, s.priority), a !== bt))
  ...
  if (A && (!g || !n) && (n = "none"), e._ease = pt(n, Vt.ease), e._rEase = x && (pt(x) || e._ease), e._from = !A && !!i.runBackwards, e._from && (e.ratio = 1), !A || g && !i.stagger) {
    if (D = w[0] ? ut(w[0]).harness : 0, U = D && i[D.prop], T = ma(i, vi), h && (h._zTime < 0 && h.progress(1), t < 0 && d && s && !p ? h.render(-1, !0) : h.revert(d && f ? ca : ko), h._lazy = 0), o) {
...
}, xr = ki + "repeat,repeatDelay,yoyo,repeatRefresh,yoyoEase,easeReverse,autoRevert", _r = {};
oe(xr + ",id,stagger,delay,duration,paused,scrollTrigger", function(r) {
  return _r[r] = 1;
});
var j = /* @__PURE__ */ (function(r) {
  ...
  function e(a, i, n, o) {
    ...
    var l = s.vars, c = l.duration, d = l.delay, u = l.immediateRender, g = l.stagger, p = l.overwrite, f = l.keyframes, h = l.defaults, w = l.scrollTrigger, b = i.parent || H, y = (ee(a) || Hn(a) ? Ge(a[0]) : "length" in i) ? [a] : _e(a), _, A, x, T, v, C, S, E;
    if (s._targets = y.length ? Si(y) : Ht("GSAP target " + a + " not found. https://gsap.com", !ge.nullTargetWarn) || [], s._ptLookup = [], s._overwrite = p, f || g || ta(c) || ta(d)) {
      ...
      if (_ = s.timeline = new ne({
        ...
        if (T = y.length, S = g && sr(g), Ie(g))
          for (v in g)
            ~xr.indexOf(v) && (E || (E = {}), E[v] = g[v]);
        for (A = 0; A < T; A++)
          x = ma(i, _r), x.stagger = 0, z && (x.easeReverse = z), E && kt(x, E), C = y[A], x.duration = +Ut(c, Be(s), A, C, y), x.delay = (+Ut(d, Be(s), A, C, y) || 0) - s._delay, !g && T === 1 && x.delay && (s._delay = d = x.delay, s._start += d, x.delay = 0), _.to(C, x, S ? S(A, C, y) : 0), _._ease = R.none;
        ...
        if (ee(f))
          ...
          x = {};
          for (v in f)
            v === "ease" || v === "easeEach" || es(v, f[v], x, f.easeEach);
          for (v in x)
      ...
      s.timeline = 0;
    return p === !0 && !bi && (Ye = Be(s), H.killTweensOf(y), Ye = 0), Me(b, Be(s), n), i.reversed && s.reverse(), i.paused && s.paused(!0), (u || !c && !f && s._start === V(b._time) && re(u) && Po(Be(s)) && b.data !== "nested") && (s._tTime = -q, s.render(Math.max(0, -d) || 0)), w && ir(Be(s), w), s;
  }
  var t = e.prototype;
  return t.render = function(i, n, o) {
    ...
    return this._initted || Ei(this, c), d = this._ease(c / this._dur), Zo(this, i, n, o, s, d, c, l) ? this.resetTo(i, n, o, s, 1) : (Sa(this, 0), this.parent || tr(this._dp, this, "_first", "_last", this._dp._sort ? "_start" : 0), this.render(0));
  }, t.kill = function(i, n) {
...
var Mi = function(e, t, a) {
  ...
  return Y(e[t]) ? Ar : yi(e[t]) && e.setAttribute ? as : Mi;
}, vr = function(e, t) {
  ...
  function r(t, a, i, n, o, s, l, c, d) {
    this.t = a, this.s = n, this.c = o, this.p = i, this.r = s || vr, this.d = l || this, this.set = c || Mi, this.pr = d || 0, this._next = t, t && (t._prev = this);
  }
  var e = r.prototype;
  return e.modifier = function(a, i, n) {
    this.mSet = this.mSet || this.set, this.set = os, this.m = a, this.mt = n, this.tween = i;
  }, r;
})();
...
ge.stringFilter = fr;
var gt = [], ua = {}, ss = [], Qi = 0, ls = 0, Oa = function(e) {
  return (ua[e] || ss).map(function(t) {
    return t();
  });
}, ui = function() {
  var e = Date.now(), t = [];
  ...
  function r(t, a) {
    this.selector = a && li(a), this.data = [], this._r = [], this.isReverted = !1, this.id = ls++, t && this.add(t);
  }
  var e = r.prototype;
  ...
  return e.add = function(a, i, n) {
    ...
    var o = new Cr(0, n || this.scope), s = o.conditions = {}, l, c, d;
...
var ds = function(e, t) {
  ...
  for (i in t)
    for (n = a.length; n--; )
      o = e._ptLookup[n][i], o && (o = o.d) && (o._pt && (o = ds(o, i)), o && o.modifier && o.modifier(t[i], e, a[n], i));
}, Ba = function(e, t) {
  return {
    name: e,
    headless: 1,
...
}, Ba("roundProps", ci), Ba("modifiers"), Ba("snap", lr)) || wa;
...
R.Expo;
R.Circ;
var ji, Qe, xt, Ii, dt, Ki, Di, hs = function() {
  return typeof window < "u";
}, Ve = {}, lt = 180 / Math.PI, _t = Math.PI / 180, ft = Math.atan2, Xi = 1e8, Li = /([A-Z])/g, ps = /(left|right|width|margin|padding|x)/i, gs = /[\s,\(]\S/, Re = {
  ...
  if (this.tfm) {
    for (o in this.tfm)
      i[o] = this.tfm[o];
    i.svg && (i.renderTransform(), t.setAttribute("data-svg-origin", this.svgo || "")), n = Di(), (!n || !n.isStart) && !a[W] && (Mr(a), i.zOrigin && a[le] && (a[le] += " " + i.zOrigin + "px", i.zOrigin = 0, i.renderTransform()), i.uncache = 1);
  }
}, Pr = function(e, t) {
  var a = {
    target: e,
  ...
  hs() && window.document && (ji = window, Qe = ji.document, xt = Qe.documentElement, dt = pi("div") || {
    style: {}
  }, pi("div"), W = Et(W), le = W + "Origin", dt.style.cssText = "border-width:0;line-height:0;position:absolute;padding:0", Rr = !!Et("perspective"), Di = ce.core.reverting, Ii = 1);
}, Zi = function(e) {
  ...
  var s = new se(e._pt, t, a, 0, 1, o ? Er : Tr);
  ...
  var n = parseFloat(a) || 0, o = (a + "").trim().substr((n + "").length) || "px", s = dt.style, l = ps.test(t), c = e.tagName.toLowerCase() === "svg", d = (c ? "client" : "offset") + (l ? "Width" : "Height"), u = 100, g = i === "px", p = i === "%", f, h, w, b;
  if (i === o || !n || en[i] || en[o])
    return n;
  if (o !== "px" && !g && (n = r(e, t, a, "px")), b = e.getCTM && Dr(e), (p || o === "%") && (Ve[t] || ~t.indexOf("adius")))
  ...
  if (p && (t === "height" || t === "width")) {
    ...
    (p || o === "%") && !Ts[pe(h, "display")] && (s.position = pe(e, "position")), h === e && (s.position = "static"), h.appendChild(dt), f = dt[d], h.removeChild(dt), s.position = "absolute";
  return l && p && (w = ut(h), w.time = ue.time, w.width = h[d]), Q(g ? f * n / u : f && n ? u / f * n : 0);
}, Fe = function(e, t, a, i) {
  var n;
  return Ii || gi(), t in Re && t !== "transform" && (t = Re[t], ~t.indexOf(",") && (t = t.split(",")[0])), Ve[t] && t !== "transform" ? (n = Xt(e, i), n = t !== "transformOrigin" ? n[t] : n.svg ? n.origin : ya(pe(e, le)) + " " + n.zOrigin + "px") : (n = e.style[t], (!n || n === "auto" || i || ~(n + "").indexOf("calc(")) && (n = ba[t] && ba[t](e, t, a) || pe(e, t) || Jn(e, t) || (t === "opacity" ? 1 : 0))), a && !~(n + "").trim().indexOf(" ") ? et(e, t, n, a) + a : n;
}, Es = function(e, t, a, i) {
  if (!a || a === "none") {
    var n = Et(t, e, 1), o = n && pe(e, n, 1);
    o && o !== a ? (t = n, a = o) : t === "borderColor" && (a = pe(e, "borderTopColor"));
  }
  var s = new se(this._pt, e.style, t, 0, 1, kr), l = 0, c = 0, d, u, g, p, f, h, w, b, y, _, A, x;
  if (s.b = a, s.e = i, a += "", i += "", i.substring(0, 6) === "var(--" && (i = pe(e, i.substring(4, i.indexOf(")")))), i === "auto" && (h = e.style[t], e.style[t] = i, i = pe(e, t) || i, h ? e.style[t] = h : $e(e, t)), d = [a, i], fr(d), a = d[0], i = d[1], g = a.match(wt) || [], x = i.match(wt) || [], x.length) {
    for (; u = wt.exec(i); )
    ...
    s.r = t === "display" && i === "none" ? Er : Tr;
  return Yn.test(i) && (s.e = 0), this._pt = s, s;
}, tn = {
  top: "0%",
  bottom: "100%",
  left: "0%",
  ...
  if (t.tween && t.tween._time === t.tween._dur) {
    ...
    l && ($e(a, W), o && (o.svg && a.removeAttribute("transform"), i.scale = i.rotate = i.translate = "none", Xt(a, 1), o.uncache = 1, Mr(i)));
  }
}, ba = {
  clearProps: function(e, t, a, i, n) {
    if (n.data !== "isFromStart") {
      var o = e._pt = new se(e._pt, t, a, 0, 0, Ps);
  ...
  */
}, Kt = [1, 0, 0, 1, 0, 0], Lr = {}, Nr = function(e) {
  return e === "matrix(1, 0, 0, 1, 0, 0)" || e === "none" || !e;
}, an = function(e) {
  var t = pe(e, W);
  return Nr(t) ? Kt : t.substr(7).match(Wn).map(Q);
}, Ni = function(e, t) {
  ...
  a ? l !== Kt && (v = p * w - f * h) && (C = A * (w / v) + x * (-h / v) + (h * y - w * b) / v, S = A * (-f / v) + x * (p / v) - (p * y - f * b) / v, A = C, x = S) : (T = Ir(e), A = T.x + (~_[0].indexOf("%") ? A / 100 * T.width : A), x = T.y + (~(_[1] || _[0]).indexOf("%") ? x / 100 * T.height : x)), i || i !== !1 && s.smooth ? (b = A - c, y = x - d, s.xOffset = u + (b * p + y * h) - b, s.yOffset = g + (b * f + y * w) - y) : s.xOffset = s.yOffset = 0, s.xOrigin = A, s.yOrigin = x, s.smooth = !!i, s.origin = t, s.originIsAbsolute = !!a, e.style[le] = "0px 0px", o && (je(o, s, "xOrigin", c, A), je(o, s, "yOrigin", d, x), je(o, s, "xOffset", u, s.xOffset), je(o, s, "yOffset", g, s.yOffset)), e.setAttribute("data-svg-origin", A + " " + x);
}, Xt = function(e, t) {
  var a = e._gsap || new br(e);
...
}, nt = "0deg", Pt = "0px", rt = ") ", Or = function(e, t) {
  ...
  return s && (u = n.split("_")[1], u === "short" && (c %= o, c !== c % (o / 2) && (c += c < 0 ? o : -o)), u === "cw" && c < 0 ? c = (c + o * Xi) % o - ~~(c / o) * o : u === "ccw" && c > 0 && (c = (c - o * Xi) % o - ~~(c / o) * o)), e._pt = g = new se(e._pt, t, a, i, c, ms), g.e = d, g.u = "deg", e._props.push(a), g;
}, nn = function(e, t) {
  for (var a in t)
    e[a] = t[a];
  return e;
...
var Br = {
  ...
  init: function(e, t, a, i, n) {
    ...
    Ii || gi(), this.styles = this.styles || Pr(e), C = this.styles.props, this.tween = a;
    for (h in t)
      if (h !== "autoRound" && (d = t[h], !(de[h] && yr(h, t, a, i, e, n)))) {
        if (p = typeof d, f = ba[h], p === "function" && (d = d.call(a, i, e, n), p = typeof d), p === "string" && ~d.indexOf("random(") && (d = Yt(d)), f)
          ...
          if (l && h in l ? (c = typeof l[h] == "function" ? l[h].call(a, i, e, n) : l[h], K(c) && ~c.indexOf("random(") && (c = Yt(c)), $(c + "") || c === "auto" || (c += ge.units[h] || $(Fe(e, h)) || ""), (c + "").charAt(1) === "=" && (c = Fe(e, h))) : c = Fe(e, h), g = parseFloat(c), y = p === "string" && d.charAt(1) === "=" && d.substr(0, 2), y && (d = d.substr(2)), u = parseFloat(d), h in Re && (h === "autoAlpha" && (g === 1 && Fe(e, "visibility") === "hidden" && u && (g = 0), C.push("visibility", 0, s.visibility), je(this, s, "visibility", g ? "inherit" : "hidden", u ? "inherit" : "hidden", !u)), h !== "scale" && h !== "transform" && (h = Re[h], ~h.indexOf(",") && (h = h.split(",")[0]))), _ = h in Ve, _) {
            ...
            if (A || (x = e._gsap, x.renderTransform && !t.parseTransform || Xt(e, t.parseTransform), T = t.smoothOrigin !== !1 && x.smooth, A = this._pt = new se(this._pt, s, W, 0, 1, x.renderTransform, x, 0, -1), A.dep = 1), h === "scale")
              ...
              C.push(le, 0, s[le]), d = Ms(d), x.svg ? mi(e, d, 0, T, 0, this) : (b = parseFloat(d.split(" ")[2]) || 0, b !== x.zOrigin && je(this, x, "zOrigin", x.zOrigin, b), je(this, s, h, ya(c), ya(d)));
              continue;
            } else if (h === "svgOrigin") {
              mi(e, d, 1, T, 0, this);
              continue;
            } else if (h in Lr) {
              Ds(this, x, h, g, y ? yt(g, y + d) : d);
              continue;
          ...
          if (_ || (u || u === 0) && (g || g === 0) && !gs.test(d) && h in s)
            w = (c + "").substr((g + "").length), u || (u = 0), b = $(d) || (h in ge.units ? ge.units[h] : w), w !== b && (g = et(e, h, c, b)), this._pt = new se(this._pt, _ ? x : s, h, g, (y ? yt(g, y + u) : u) - g, !_ && (b === "px" || h === "zIndex") && t.autoRound !== !1 ? bs : hi), this._pt.u = b || 0, _ && S !== d ? (this._pt.b = c, this._pt.e = S, this._pt.r = ws) : w !== b && b !== "%" && (this._pt.b = c, this._pt.r = fs);
          else if (h in s)
            Es.call(this, e, h, c, y ? y + d : d);
          else if (h in e)
  ...
  getSetter: function(e, t, a) {
    var i = Re[t];
    return i && i.indexOf(",") < 0 && (t = i), t in Ve && t !== le && (e._gsap.x || Fe(e, "x")) ? a && Ki === a ? t === "scale" ? As : _s : (Ki = a || {}) && (t === "scale" ? vs : ks) : e.style && !yi(e.style[t]) ? ys : ~t.indexOf("-") ? xs : Pi(e, t);
  },
  core: {
    _removeProperty: $e,
    _getMatrix: Ni
...
ce.core.getStyleSaver = Pr;
(function(r, e, t, a) {
  var i = oe(r + "," + e + "," + t, function(n) {
    Ve[n] = 1;
  });
  oe(e, function(n) {
    ge.units[n] = "deg", Lr[n] = 1;
...
ce.registerPlugin(Br);
var m = ce.registerPlugin(Br) || ce;
m.core.Tween;
...
function ul(r) {
  const e = qr(r).replace(/[^a-z0-9]+/g, "-").replace(/^-|-$/g, "");
  return e ? `${L}?u=${encodeURIComponent(e)}` : "";
}
function Ta(r, e) {
  const t = qr(r), a = e?.trim() || void 0;
  return dl[t] ?? a ?? ul(r);
}
const Fr = `
...
const hl = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="52 42 88 66">
<path fill="#4285f4" d="M58 108h14V74L52 59v43c0 3.32 2.69 6 6 6"/>
<path fill="#34a853" d="M120 108h14c3.32 0 6-2.69 6-6V59l-20 15"/>
<path fill="#fbbc04" d="M120 48v26l20-15v-8c0-7.42-8.47-11.65-14.4-7.2"/>
<path fill="#ea4335" d="M72 74V48l24 18 24-18v26L96 92"/>
<path fill="#c5221f" d="M52 51v8l20 15V48l-5.6-4.2c-5.94-4.45-14.4-.22-14.4 7.2"/>
</svg>`, pl = `<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" viewBox="60 90.4 570.02 539.67">
<defs>
...
const gl = [
...
], ml = 1.28, k = (r) => Number((r * ml).toFixed(3)), fl = [2, 3, 2], te = {
  ...
  settleHold: k(0.24)
}, dn = "Learning your style", wl = "Voice calibrated", un = "73 tone & tactic rules defined", za = [
  ...
  0,
  4
], xl = /* @__PURE__ */ new Set([5, 8, 10, 16]), _l = [
  ...
  threadGap: 44
}, Sl = "left,right,bottom,width,height,minHeight,paddingTop,paddingRight,paddingBottom,paddingLeft,borderWidth,gap", Va = {
  paddingTop: "",
  paddingRight: "",
  paddingBottom: "",
  paddingLeft: "",
  ...
  contentWidth: 1881,
  height: 1280
}, El = 96, wn = ".wa-cursor-file, .wa-file-landing-clone, .wa-file-landing-label, .wa-csv-drop, .wa-signup-logo-transfer", bn = "[data-marketing-data-sources-grid]", yn = "[data-data-table]", It = "[data-table-action]", xn = "[data-table-page-button]", Ml = "[data-table-page-range]", Pl = "https://cdn.jsdelivr.net/npm/simple-icons@latest/icons", Rl = "https://www.google.com/s2/favicons", Il = {
  adyen: "adyen",
  airtable: "airtable",
  brex: "brex",
  "dbt labs": "dbt",
...
class Ll {
  ...
  measureComposerFullFrame() {
    m.set(this.composer, { clearProps: Sl });
  ...
  scrollToLive(e = ae.followDuration) {
  ...
  scrollDataTableToFooter(e, t = ae.revealDuration) {
  ...
  scrollChatElementIntoView(e, t = {}) {
    return this.scrollChatTarget(() => {
      ...
      align: t.align ?? "top",
      duration: t.duration ?? ae.revealDuration,
      offset: t.offset,
      fallback: "current"
    });
  }
  ...
  strategyPlans(e) {
    ...
    const d = this.claimComponentMessage("strategy", a), u = m.timeline().add(this.revealMessage(d, n, mn)).addLabel(s, Cl).call(() => this.setMotionHints(c), void 0, s).to(t, { ...o.to }, s);
    return t.forEach((g, p) => {
      ...
      () => this.animateMessageScrollIntoView(d, ae.followDuration, n, mn),
      void 0,
      "+=0.02"
    );
  }
  ...
  connectMailbox(e) {
    ...
    return p.call(() => {
      ...
      i.dataset.mailboxLearningState = "ready", l.textContent = wl, d.textContent = i.dataset.mailboxLearningReadyDetail ?? un;
    }).fromTo(
      l,
      { autoAlpha: 0, y: 4 },
      {
  ...
  revealPreparedItems(e, t, a, i = null, n = 0) {
    ...
    return o.call(
      () => this.animateMessageScrollIntoView(e, ae.followDuration, i, n),
      void 0,
      ae.componentFollowDelay
    ), o.call(
      () => this.animateMessageScrollIntoView(e, ae.followDuration, i, n),
      void 0,
      "+=0.02"
  ...
  revealMessage(e, t = null, a = 0) {
    let i = 0;
    const n = e.classList.contains("wa-message--component") ? ae.componentRevealDelay : 0.04;
    return m.timeline().call(() => {
  ...
  resetMessageClasses(e) {
    e.classList.remove(...gl), e.classList.remove("wa-message--first-active");
  }
  createCsvDropArea(e = {}) {
  ...
  streamThinkingHeader(e) {
    return this.streamThinkingChild(e, ".wa-thinking__title", kl);
  }
  streamThinkingStepLabel(e) {
    return this.streamThinkingChild(e, ".wa-research-step__label", vl);
  }
  ...
  streamText(e, t, a) {
    ...
    return m.timeline().call(() => {
      ...
      e.textContent = t, delete e.dataset.streaming, this.cancelScheduledScroll(), this.animateMessageScrollIntoView(a.targetForScroll, ae.followDuration * 0.7);
    });
  }
  foldThinkingStep(e) {
  ...
  renderSignupLogoTransfer(e, t) {
    if (!e) return;
    const a = e.target.getBoundingClientRect(), i = this.getElementLocalRect(a, this.chatBody), n = Gr(t);
  ...
  addThinkingElapsedTimer(e, t, a) {
    Os(e, t, a, { reducedMotion: this.prefersReducedMotion });
  }
  ...
  getCompanyLogoUrl(e, t) {
    ...
    if (o) return `${Pl}/${encodeURIComponent(o)}.svg`;
    const s = t.companyDomain || this.getCompanyLogoDomain(e) || this.getEmailDomainFromValues(t);
    return s ? `${Rl}?domain=${encodeURIComponent(s)}&sz=64` : "";
  }
  getCompanyLogoIconSlug(e) {
    return e ? Il[this.getCompanyKey(e)] ?? "" : "";
  }
  ...
  createMarketingDataSourcesGrid(e) {
    ...
    return t.classList.add("wa-data-source-grid--marketing"), t.dataset.marketingDataSourcesGrid = e.id, a.className = "wa-data-source-grid__scale", i.className = "wa-data-source-grid__groups", Tl.forEach((s) => {
      const l = document.createElement("div");
  ...
  createMailboxProviderIcon(e) {
    ...
    return t.className = "wa-mailbox-connection__provider-icon", t.src = bl[e], t.alt = "", t.decoding = "async", t.loading = "eager", t.setAttribute("aria-hidden", "true"), t;
  }
  ...
  createMailboxThumbprintGroup(e, t = !1) {
    ...
    return a.classList.add(e), _l.forEach((i, n) => {
      const o = document.createElementNS("http://www.w3.org/2000/svg", "path");
  ...
  getSequenceStepWaitDays(e, t, a) {
    return t >= a - 1 ? null : e.waitDays ?? fl[t] ?? 1;
  }
...
`);
  ...
  animateMessageScrollIntoView(e, t = ae.followDuration, a = null, i = 0) {
  ...
  requestMessageScroll(e) {
    ...
    this.scheduledScrollMessage = e, !(t - this.lastStreamScrollAt < El) && (this.scheduledScrollFrame || (this.lastStreamScrollAt = t, this.scheduledScrollFrame = window.requestAnimationFrame(() => {
...
function Nl(r, e) {
  const t = yl[r] ?? 0, a = 24 + r * 11 % 8, i = Math.min(100, t + a), n = Gr((e - t) / (i - t));
  if (n <= 0) return 0;
  const o = xl.has(r) ? 20 : 12;
...
function ia(r, e, t) {
  const a = Vr(t.seed), i = Ol(r, e), n = t.speed ?? "normal", o = t.intent ?? "hover";
  ...
  const s = e.x - r.x, l = e.y - r.y, c = s / i, d = l / i, u = -d, g = c, p = a() > 0.5 ? 1 : -1, f = t.curve ?? 1, w = Bt(i * (o === "drag" ? 0.1 : o === "click" ? 0.17 : 0.22) * f, 18, 150) * p * (0.72 + a() * 0.44), b = i / ql[n] + 0.16, y = Bt(b * Fl[o] * zl, 0.3, 1.66), _ = t.overshoot === !1 || i < 120 ? 0 : typeof t.overshoot == "number" ? t.overshoot : Bt(i * 0.026, 4, 18), A = _ > 0 ? {
    x: e.x + c * _,
    y: e.y + d * _
  } : e, x = {
...
class Vl {
  ...
  renderMimicRotation(e, t) {
    ...
    if (a * a + i * i < 4) return;
    const n = Math.atan2(i, a) * 180 / Math.PI, o = Hl(n - Ul), s = this.rotationState + Wl(this.rotationState, o) * Gl;
...
function Tn(r) {
  if (r?.assetUrls?.length)
    for (const e of r.assetUrls) Ql(e);
}
function qt(r) {
  const e = /* @__PURE__ */ new Set(), t = (a) => Yl(e, a.values);
...
}, Qr = F("[data-signup-field]", "center", {
  desktop: -74,
  tablet: -66,
  mobile: -48
}), jr = F("[data-signup-submit]", "center"), Xl = F("[data-send-button]", "center"), Bi = {
  desktop: {
...
}, Jl = 2.8, Zl = 42, $l = 2, ec = 3, _a = "[data-chat-shell] [data-chat-thread]", tc = `${_a} [data-message-role="assistant"]:not(.wa-message--component) [data-message-body]`, ac = `${_a} [data-message-role="assistant"].wa-message--thinking .wa-research-step[data-step-state="current"] .wa-research-step__body, ${_a} [data-message-role="assistant"].wa-message--thinking .wa-research-step[data-step-state="complete"] .wa-research-step__label`, wi = 0.24, Kr = 0.3, ze = {
...
function ic(r, e, t, a, i) {
  switch (t.kind) {
    ...
    case "transitionSignupToChat":
      ...
      return;
    case "assistant":
      r.add(e.chat.assistantMessage(t.text), t.at), cc(r, e, i, {
        kind: "assistant",
        key: t.text,
        text: t.text,
        selector: tc,
      ...
      return;
    case "thinking": {
      const n = nc(t), o = n.items.map((s) => s.label);
      t.statusBefore && r.add(e.chat.setStatus(t.statusBefore), t.at), r.add(e.chat.thinkingState(n, t.hold), t.statusBefore ? void 0 : t.at), lc(r, e, i, t.hold, o.length, o.join("|"), a);
      return;
    }
    case "dataTable":
      Lt(
    ...
    case "strategyPlans":
      {
        ...
        r.add(e.chat.strategyPlans(t.plans), t.at), r.add(sc(e, n, t.plans), "+=0.06");
      }
      return;
...
function lc(r, e, t, a = M.thinkingShort, i = 1, n = "thinking", o = 0) {
  const s = a * Math.max(1, i), l = i >= 3 && eo(e, t, {
    kind: "thinking",
    key: n,
    text: n,
    stepIndex: o,
...
function eo(r, e, t) {
  const a = t.text.trim(), i = t.minChars ?? Zl;
  if (a.length < i || e.textSkimCount >= ec) return !1;
  const n = e.textCandidateCount;
  e.textCandidateCount += 1;
  const o = e.textSkimCount === 0, s = t.stepIndex - e.lastTextSkimStep >= $l, l = uc(`${r.story.id}:${t.kind}:${n}:${t.key}`), c = n > 0 && n % 3 === 0, d = o || s && (l >= 0.58 || c);
...
function fc(r) {
  ...
  for (const t of r.steps) {
    ...
    const a = t.component;
    a.kind === "table" && qt(Zt(a, `${r.id}-${t.id}`)).forEach((i) => e.add(i)), a.kind === "dataSources" && Hr(io(a)).forEach((i) => e.add(i)), a.kind === "proximityList" && Wr(so(a)).forEach((i) => e.add(i)), a.kind === "sequenceEngagement" && Yr(qi(a, `${r.id}-${t.id}`)).forEach((i) => e.add(i));
  }
  return [...e];
}
function wc(r, e) {
  return r === "hit-ground-running" ? Qr : r === "data-marketplace" ? xa.dataMarketplace : r === "research-brief" ? xa.researchBrief : e.entry;
}
function bc(r, e) {
  return r === "hit-ground-running" ? Kr : r === "data-marketplace" || r === "research-brief" ? wi : e.entryLeadTime;
}
function yc(r, e, t) {
  if (e.id === "hit-ground-running") return xc(r, e);
  if (e.id === "crm-update") return _c(r, e);
  if (e.id === "research-brief") return Ac(r, e);
  if (e.id === "csv-import-cleanup") return vc(r, e);
  const a = Tc(e);
...
function xc(r, e) {
  ...
  return Pe(r, [
    ...
    ...o ? [{ kind: "strategyPlans", plans: ao(o.component), at: "-=0.08" }] : [],
    Ke(ze.right, "+=0.18")
  ]);
}
function _c(r, e) {
  const t = $t(e, "mailboxConnection"), a = $t(e, "uploadedFiles"), i = [];
  if (t && oo(i, ro(t.component)), a) {
    const n = no(a.component), o = r.chat.prepareCsvDropArea({
...
function Ac(r, e) {
  ...
  if (o && (o.scrollAlign = "equal-inset"), t && l.push({
    ...
    $r("website-visitors-sales", M.beat + 0.18, "+=0.08")
...
function vc(r, e) {
  ...
  ), o = a ? e.steps.indexOf(a) : -1, s = n.find((f) => o >= 0 && e.steps.indexOf(f) < o), l = [...n].reverse().find((f) => f !== s), c = t?.text || "may_webinar_attendees.csv", d = kc(t, s?.component ?? l?.component), u = r.chat.prepareCsvDropArea(), g = r.chat.prepareCursorFile(c, r.cursor), p = F("[data-chat-shell]", "center", {
    desktop: { x: 0, y: 82 },
    tablet: { x: 0, y: 72 },
    mobile: { x: 0, y: 64 }
  });
  return Pe(r, [
    ...
    ...l ? [{ kind: "dataTable", config: Ic(Zt(l.component, "cleaned-webinar-attendees")), at: "-=0.04" }] : [],
...
function Tc(r) {
  const e = [], t = r.id === "data-marketplace" ? Ec(r.steps) : r.steps;
  let a = 0;
  for (const i of t)
    a += i.kind === "user" ? 1 : 0, to(e, r.id, i, a === 1);
  return e;
}
function Ec(r) {
  const e = [];
...
function to(r, e, t, a = !1) {
  ...
  t.kind !== "component" || !t.component || Pc(r, e, t);
}
function Pc(r, e, t) {
  const a = t.component;
  if (a.kind === "table") {
    const i = Zt(a, `${e}-${t.id}`);
    Lc(e, t, i) && (i.scrollAlign = "equal-inset"), r.push({ kind: "dataTable", config: i, at: "-=0.04" });
    return;
  }
  if (a.kind === "strategyCards") {
    r.push({ kind: "strategyPlans", plans: ao(a), at: "-=0.04" });
    return;
  }
  if (a.kind === "enrichment") {
    r.push({ kind: "enrichmentPanel", config: Vc(a), at: "+=0.12" });
    return;
  }
  ...
  if (a.kind === "uploadedFiles") {
    r.push({ kind: "custom", build: (i) => i.chat.uploadedFilesMessage(no(a)), at: "-=0.04" });
    return;
  }
  ...
  if (a.kind === "styleProfile") {
    ...
    r.push({
      ...
      at: "-=0.02"
    }), e === "crm-update" && r.push(...Jr(i.id));
    return;
  }
  if (a.kind === "proximityList") {
    r.push({ kind: "custom", build: (i) => i.chat.proximityLeadList(so(a)), at: "-=0.04" });
    return;
  }
  if (a.kind === "personalizationSwipeGame") {
    r.push({ kind: "personalizationSwipeGame", config: Wc(a), at: "+=0.06" });
    return;
  }
...
function Pa(r, e = {}) {
  return {
    kind: "thinking",
    thinking: Rc(r.thinking, r.text, r.note),
    hold: e.hold,
    at: e.at
  };
}
...
function Zt(r, e) {
  const t = Nc(r, e), a = r.rows.filter((o) => o.some((s) => s.trim())).map((o, s) => Fc(o, t, s)), i = r.pagination?.pageSize ?? Dc(r.pagination?.ranges) ?? Math.min(10, a.length || 10), n = r.pagination?.ranges.map((o, s) => ({
    page: s + 1,
    range: o,
  ...
  return {
    ...
    eyebrow: r.eyebrow,
    count: r.count,
    variant: t.variant ?? Yc(r),
    columns: t.columns,
    rows: n[0]?.rows ?? a,
    actions: r.actions?.map(Gc),
    pagination: n.length > 1 ? {
      pageSize: i,
      totalRows: Qc(r, a.length),
      activePage: 1,
      pages: n
    } : void 0
  };
...
function Fc(r, e, t) {
  ...
  if (e.columns.forEach((i, n) => {
    ...
    const i = Uc(a[e.mutualConnectionKey] ?? ""), n = zc(t);
...
const jc = [
  ...
  pagination: {
    ...
    activePage: 1,
    pages: [
      { page: 1, range: "1-10 of 50 people", rows: On },
      { page: 2, range: "11-20 of 50 people", rows: td }
    ]
  },
  actions: [
    {
...
}, uo = [
  {
    ...
    build: (r) => Pe(r, [
      ...
      { kind: "strategyPlans", plans: Kc, at: "-=0.08" },
      Ke(ze.right, "+=0.18")
    ])
  },
  {
    ...
    build: (r) => Pe(r, [
      ...
      { kind: "dataTable", config: Mn, at: "-=0.04" },
      {
        kind: "prompt",
      ...
      { kind: "enrichmentPanel", config: Jc, at: "+=0.12" },
      { kind: "status", text: "Contacts enriched", at: "+=0.86" },
      { kind: "dataTable", config: In, at: "-=0.02" },
      { kind: "marketingDataSourcesGrid", config: Rn, at: "+=1.44" },
      Ke(ze.bottomRight, "+=3")
    ])
  },
  {
    ...
    build: (r) => {
      ...
      }), t = r.chat.prepareCursorFile("4 context files", r.cursor, "DOC", Dn), a = {
        desktop: { target: "[data-chat-shell]", anchor: "right", outside: "right", offset: { x: 420, y: -74 }, humanOffset: !1 },
        tablet: { target: "[data-chat-shell]", anchor: "right", outside: "right", offset: { x: 360, y: -58 }, humanOffset: !1 },
        mobile: { target: "[data-chat-shell]", anchor: "right", outside: "right", offset: { x: 280, y: -42 }, humanOffset: !1 }
      ...
      return Pe(r, [
        ...
        { kind: "custom", build: () => t.landAsUploadedFiles(Dn), at: "<" },
        ...
        {
          kind: "custom",
          build: () => r.chat.outreachStyleProfile(Ln, { scrollAlign: "equal-inset" }),
          at: "-=0.02"
        },
        ...Jr(Ln.id),
        {
        ...
        { kind: "custom", build: () => r.chat.proximityLeadList(Nn), at: "-=0.04" },
  ...
  },
  {
    ...
    build: (r) => {
      ...
      return Pe(r, [
        ...
        { kind: "dataTable", config: Bn, at: "-=0.02" },
        $r("website-visitors-sales", M.beat + 0.18, "+=0.08"),
        {
          kind: "cursorMove",
          target: e,
        ...
        { kind: "custom", build: () => r.chat.dataTableActionTooltip("website-visitors-sales", "email-sequence", !1), at: "<+=0.02" },
        { kind: "status", text: "building outreach sequence", at: "<" },
        { kind: "custom", build: () => r.chat.sequenceBuildThinking($c), at: "+=0.06" },
  ...
  },
  {
    ...
    build: (r) => {
      ...
      return Pe(r, [
        ...
        { kind: "dataTable", config: ad, at: "+=0.08" },
        { kind: "status", text: "Cleaning CSV", at: "<" },
        {
          kind: "thinking",
          steps: [
        ...
        { kind: "dataTable", config: id, at: "-=0.04" },
        Ke(ze.bottomRight, "+=0.18")
      ]);
    }
  }
...
class nd {
  ...
  followPointer = () => {
    ...
    if (this.mode === "return") {
      const t = this.getReturnHomePoint(), a = rd((e - this.returnStartedAt) / ti.durationMs), i = this.getReturnWavePoint(a, t), n = this.getReturnWavePoint(Math.min(1, a + 0.035), t);
  ...
  updateFollowTarget(e) {
    ...
    if (this.lastPointer) {
      ...
      i > 1.5 && (this.trailDirection = {
        x: a.x / i,
        y: a.y / i
      }, this.velocity = dd(a, Z.maxMomentumStep));
    }
    const t = {
  ...
  updatePlayTarget(e) {
    ...
    this.target = sd(n, this.pointer, He.minPointerDistance, He.viewportInset);
  }
  resumeFollowing(e) {
  ...
  getReturnWavePoint(e, t) {
    const a = this.returnStart ?? this.getCursorViewportPoint(), i = od(e), n = t.x - a.x, o = t.y - a.y, s = Math.hypot(n, o), l = {
      x: a.x + n * i,
      y: a.y + o * i
    };
    if (s < 1) return l;
  ...
  isCursorTooFarFromBrowser() {
    ...
    return cd(i, e) > Z.maxBrowserDistance;
  }
  getChatShell() {
    return this.chatShell?.isConnected ? this.chatShell : (this.chatShell = this.root.querySelector("[data-chat-shell]"), this.chatShell);
  }
  ...
  countAxisReversals(e) {
    ...
    for (let n = 1; n < e.length; n += 1) {
      const o = e[n - 1], s = e[n], l = zn(s.x - o.x), c = zn(s.y - o.y);
...
function Fn(r, e) {
  return {
    x: qn(r.x, e, window.innerWidth - e),
    y: qn(r.y, e, window.innerHeight - e)
  };
}
function sd(r, e, t, a) {
  const i = Fn(ld(r, e, t), a);
...
class ud {
  constructor(e, t, a, i, n, o) {
    this.root = e, this.stories = t, this.resolver = a, this.cursor = i, this.chat = n, this.options = o, this.storyProgress = this.stories.map(() => 0), this.pausedCursorMimic = new nd(this.root, this.cursor, {
  ...
  updateStories(e, t = {}) {
    if (!e.length) return;
    const a = this.stories[this.activeIndex]?.id, i = this.stories, n = new Map(this.stories.map((c, d) => [c.id, this.storyProgress[d] ?? 0])), o = this.cursor.getPosition(), s = this.playing, l = hd(i, e);
  ...
  attachChatHistoryScroll() {
    ...
    const a = (i) => {
      ...
      if (Math.abs(n) < Un.minPixelDelta) return;
      const o = this.getThreadMaxScroll(t);
      if (o <= 0 || !(n < 0 || this.historyPaused)) return;
      const l = ho(t.scrollTop + n, 0, o);
      if (!(Math.abs(l - t.scrollTop) >= 0.5)) return;
      const d = Math.max(0, n - (o - t.scrollTop));
      i.preventDefault(), this.pauseForChatHistory(), t.scrollTop = l, d >= Un.minPixelDelta && window.scrollBy({ top: d, left: 0, behavior: "auto" });
    };
...
class pd {
  ...
  resolve(e, t = "target") {
    ...
    if (s = {
      ...
      const l = Vr(t), c = Math.min(o.width * 0.18, 18), d = Math.min(o.height * 0.18, 14);
...
const gd = 3, md = /* @__PURE__ */ new Set([
  "user",
  "assistant",
  "thinking",
  "component",
...
function fd(r) {
  ...
  const e = typeof r.schemaVersion == "number" ? r.schemaVersion : 1, t = r.stories.map((a) => yd(a)).filter((a) => !!a);
...
function yd(r) {
  ...
  const e = Ae(r.id), t = Ae(r.label), a = Ae(r.summary), i = r.steps.map((n) => xd(n)).filter((n) => !!n);
...
function xd(r) {
  ...
  return !e || !t || !wd(t) ? null : {
    id: e,
    kind: t,
    text: a ?? "",
    note: i ?? "",
    thinking: vt(r.thinking) ? _d(r.thinking, a ?? "", i ?? "") : t === "thinking" ? po(a ?? "", i ?? "") : void 0,
    component: vt(r.component) ? bd(r.component) : void 0
  };
}
function _d(r, e, t) {
  const i = (Array.isArray(r.items) ? r.items : []).map((n, o) => Ad(n, o)).filter((n) => !!n);
  return i.length ? {
    title: Ae(r.title) ?? qe,
...
async function vd(r, e) {
  try {
    ...
    if (!t.ok) return;
    const a = fd(await t.json());
    if (!a || a.schemaVersion !== gd) return;
          ...
          <div class="wa-chat-shell" data-chat-shell>
            ...
            <div class="wa-chat-shell__body">
              <div class="wa-signup-scene" data-signup-scene>
                <span class="wa-signup-scene__logo" data-signup-logo-target aria-hidden="true">${Fr}</span>
...
function Sd(r, e = {}) {
  kd(r);
  const t = e.stories?.length ? e.stories : uo, a = e.builderDraftEndpoint ?? "/api/story-draft", i = e.reducedMotion ?? window.matchMedia?.("(prefers-reduced-motion: reduce)").matches ?? !1, n = new pd(r), o = new Ll(r), s = new Vl(r, n, { reducedMotion: i }), l = new ud(r, t, n, s, o, {
    ...
    l.updateStories(gc(d, t), {
      restartActive: u.source === "load"
    });
  };
  return l.mount(), a && vd(a, c), {
    play: l.play.bind(l),
...
function mo(r = "[data-chatbot-stories]", e = {}) {
  return e.injectStyles !== !1 && go(), Sd(Md(r), e);
}
const Pd = {
  init: mo,
  defaultStories: uo
...
if (typeof window < "u") {
  window.ChatbotStories = Pd;
  const r = () => {
    document.querySelector("[data-chatbot-stories][data-auto-init]") && go(), document.querySelectorAll("[data-chatbot-stories][data-auto-init]").forEach((e) => {
      e.dataset.chatbotStoriesMounted || (e.dataset.chatbotStoriesMounted = "true", mo(e));
    });
  };
  document.readyState === "loading" ? document.addEventListener("DOMContentLoaded", r, { once: !0 }) : r();
}
export {
  uo as defaultStories,
  mo as init
};
