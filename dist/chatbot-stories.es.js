...
var ge = {
  ...
  overwrite: !1,
  delay: 0
}, bi, X, G, xe = 1e8, q = 1 / xe, ai = Math.PI * 2, wo = ai / 4, bo = 0, Hn = Math.sqrt, yo = Math.cos, xo = Math.sin, K = function(e) {
...
}, ee = Array.isArray, _o = /random\([^)]+\)/g, Ao = /,\s*/g, zi = /(?:-?\.?\d|\.)+/gi, Yn = /[-+=.]*\d+[.e\-+]*\d*[e\-+]*\d*/g, wt = /[-+=.]*\d+[.e-]*\d*[a-z%]*/g, Ra = /[-+=.]*\d+\.?\d*(?:e-|e\+)?\d*/gi, Qn = /[+-]=-?[.\d]+/, vo = /[^,'"\[\]\s]+/gi, ko = /^[+\-=e\s\d]*\d+[.\d]*([a-z]*|%)\s*$/i, H, Ee, ii, _i, me = {}, pa = {}, jn, Kn = function(e) {
  return (pa = kt(e, me)) && ce;
}, Ai = function(e, t) {
  return console.warn("Invalid property", e, "set to", t, "Missing plugin? gsap.registerPlugin()");
}, Ht = function(e, t) {
  return !t && console.warn(e);
}, Xn = function(e, t) {
  return e && (me[e] = t) && pa && (pa[e] = t) || me;
}, Wt = function() {
  return 0;
}, So = {
  suppressEvents: !0,
  ...
  suppressEvents: !0
}, vi = {}, Xe = [], ni = {}, Jn, de = {}, Ia = {}, Ui = 30, da = [], ki = "", Si = function(e) {
  var t = e[0], a, i;
  ...
  return e._gsap || Si(_e(e))[0]._gsap;
}, Zn = function(e, t, a) {
  return (a = e[t]) && Y(a) ? e[t]() : yi(a) && e.getAttribute && e.getAttribute(t) || a;
}, oe = function(e, t) {
  ...
  for (ni = {}, Xe.length = 0, a = 0; a < e; a++)
    i = t[a], i && i._lazy && (i.render(i._lazy[0], i._lazy[1], !0)._lazy = 0);
}, Ci = function(e) {
  return !!(e._initted || e._startAt || e.add);
}, $n = function(e, t, a, i) {
  Xe.length && !X && ga(), e.render(t, a, !!(X && t < 0 && Ci(e))), Xe.length && !X && ga();
}, er = function(e) {
  var t = parseFloat(e);
  return (t || t === 0) && (e + "").match(vo).length < 2 ? t : K(e) ? e.trim() : e;
}, tr = function(e) {
  return e;
}, fe = function(e, t) {
  for (var a in t)
  ...
  var t = e.parent || H, a = e.keyframes ? Eo(ee(e.keyframes)) : fe;
  if (re(e.inherit))
    for (; t; )
  ...
  return e._startAt && (X ? e._startAt.revert(ca) : e.vars.immediateRender && !e.vars.autoRevert || e._startAt.render(t, !0, i));
}, Ro = function r(e) {
  ...
  return e._end = V(e._start + (e._tDur / Math.abs(e._ts || e._rts || q) || 0));
}, Sa = function(e, t) {
  var a = e._dp;
  return a && a.smoothChildTiming && e._ts && (e._start = V(a._time - (e._ts > 0 ? t / e._ts : ((e._dirty ? e.totalDuration() : e._tDur) - t) / -e._ts)), ka(e), a._dirty || ht(a, e)), e;
}, ir = function(e, t) {
  var a;
  if ((t._time || !t._dur && t._initted || t._start < e._time && (t._dur || !t.add)) && (a = fa(e.rawTime(), t), (!t._dur || ea(0, t.totalDuration(), a) - t._tTime > q) && t.render(a, !0)), ht(e, t)._dp && e._initted && e._time >= e._dur && e._ts) {
  ...
  return t.parent && Ze(t), t._start = V((Ge(a) ? a : a || e !== H ? be(e, a, t) : e._time) + t._delay), t._end = V(t._start + (t.totalDuration() / Math.abs(t.timeScale()) || 0)), ar(e, t, "_first", "_last", e._sort ? "_start" : 0), oi(t) || (e._recent = t), i || ir(e, t), e._ts < 0 && Sa(e, e._tTime), e;
}, nr = function(e, t) {
  return (me.ScrollTrigger || Ai("scrollTrigger", t)) && me.ScrollTrigger.create(t, e);
}, rr = function(e, t, a, i, n) {
  if (Ei(e, t, n), !e._initted)
    return 1;
  if (!a && e._pt && !X && (e._dur && e.vars.lazy !== !1 || !e._dur && e.vars.lazy) && Jn !== ue.frame)
  ...
  var n = e.ratio, o = t < 0 || !t && (!e._start && Io(e) && !(!e._initted && oi(e)) || (e._ts < 0 || e._dp._ts < 0) && !oi(e)) ? 0 : 1, s = e._rDelay, l = 0, c, d, u;
  if (s && e._repeat && (l = ea(0, e._tDur, t), d = St(l, s), e._yoyo && d & 1 && (o = 1 - o), d !== St(e._tTime, s) && (n = 1 - o, e.vars.repeatRefresh && e._initted && e.invalidate())), o !== n || X || i || e._zTime === q || !t && e._zTime) {
    if (!e._initted && rr(e, t, i, a, l))
      return;
    for (u = e._zTime, e._zTime = t || (a ? q : 0), a || (a = t && !u), e.ratio = o, e._from && (o = 1 - o), e._time = 0, e._tTime = l, c = e._pt; c; )
      c.r(o, c.d), c = c._next;
    t < 0 && ri(e, t, a, !0), e._onUpdate && !a && he(e, "onUpdate"), l && e._repeat && !a && e.parent && he(e, "onRepeat"), (t >= e._tDur || t < 0) && e.ratio === o && (o && Ze(e, 1), !a && !X && (he(e, o ? "onComplete" : "onReverseComplete", !0), e._prom && e._prom()));
  ...
  return s && !i && (e._time *= o / e._dur), e._dur = o, e._tDur = n ? n < 0 ? 1e10 : V(o * (n + 1) + e._rDelay * n) : o, s > 0 && !i && Sa(e, e._tTime = e._tDur * s), e.parent && ka(e), a || ht(e.parent, e), e;
}, Hi = function(e) {
  return e instanceof ne ? ht(e) : Ct(e, e._dur);
}, No = {
  _start: 0,
  endTime: Wt,
  totalDuration: Wt
}, be = function r(e, t, a) {
  var i = e.labels, n = e._recent || No, o = e.duration() >= xe ? n.endTime(!1) : e._dur, s, l, c;
  return K(t) && (isNaN(t) || t in i) ? (l = t.charAt(0), c = t.substr(-1) === "%", s = t.indexOf("="), l === "<" || l === ">" ? (s >= 0 && (t = t.replace(/=/, "")), (l === "<" ? n._start : n.endTime(n._repeat >= 0)) + (parseFloat(t.substr(1)) || 0) * (c ? (s < 0 ? n : a).totalDuration() / 100 : 1)) : s < 0 ? (t in i || (i[t] = o), i[t]) : (l = parseFloat(t.charAt(s - 1) + t.substr(s + 1)), c && a && (l = l / 100 * (ee(a) ? a[0] : a).totalDuration()), s > 1 ? r(e, t.substr(0, s - 1), a) + l : o + l)) : t == null ? o : +t;
}, zt = function(e, t, a) {
  ...
  return !K(e) || !(t = ko.exec(e)) ? "" : t[1];
}, Oo = function(e, t, a) {
  return tt(a, function(i) {
    return ea(e, t, i);
  });
}, si = [].slice, or = function(e, t) {
  return e && Ie(e) && "length" in e && (!t && !e.length || e.length - 1 in e && Ie(e[0])) && !e.nodeType && e !== Ee;
}, Bo = function(e, t, a) {
  return a === void 0 && (a = []), e.forEach(function(i) {
    var n;
    return K(i) && !t || or(i, 1) ? (n = a).push.apply(n, _e(i)) : a.push(i);
  }) || a;
}, _e = function(e, t, a) {
  return G && !t && G.selector ? G.selector(e) : K(e) && !a && (ii || !Tt()) ? si.call((t || _i).querySelectorAll(e), 0) : ee(e) ? Bo(e, a) : or(e) ? si.call(e, 0) : e ? [e] : [];
}, li = function(e) {
  return e = _e(e)[0] || Ht("Invalid scope") || {}, function(t) {
    var a = e.current || e.nativeElement || e;
    return _e(t, a.querySelectorAll ? a : a === e ? Ht("Invalid scope") || _i.createElement("div") : e);
  };
}, sr = function(e) {
  ...
  var t = Ie(e) ? e : {
    each: e
  }, a = pt(t.ease), i = t.from || 0, n = parseFloat(t.base) || 0, o = {}, s = i > 0 && i < 1, l = isNaN(i) || s, c = t.axis, d = i, u = i;
  return K(i) ? d = u = {
    center: 0.5,
    edges: 0.5,
    end: 1
  }[i] || 0 : !s && l && (d = i[0], u = i[1]), function(g, p, f) {
    var h = (f || t).length, w = o[h], b, y, _, A, x, T, v, C, S;
    if (!w) {
      if (S = t.grid === "auto" ? 0 : (t.grid || [1, xe])[1], !S) {
        for (v = -xe; v < (v = f[S++].getBoundingClientRect().left) && S < h; )
          ;
        S < h && S--;
      }
      for (w = o[h] = [], b = l ? Math.min(S, h) * d - 0.5 : i % S, y = S === xe ? 0 : l ? h * u / S - 0.5 : i / S | 0, v = 0, C = xe, T = 0; T < h; T++)
        _ = T % S - b, A = y - (T / S | 0), w[T] = x = c ? Math.abs(c === "y" ? A : _) : Hn(_ * _ + A * A), x > v && (v = x), x < C && (C = x);
      i === "random" && sr(w), w.max = v - C, w.min = C, w.v = h = (parseFloat(t.amount) || parseFloat(t.each) * (S > h ? h - 1 : c ? c === "y" ? h / S : S : Math.max(S, h / S)) || 0) * (i === "edges" ? -1 : 1), w.b = h < 0 ? n - h : n, w.u = $(t.amount || t.each) || 0, a = a && h < 0 ? Xo(a) : a;
    }
  ...
  return function(a) {
    ...
    return (i - i % 1) / t + (Ge(a) ? 0 : $(a));
  };
}, cr = function(e, t) {
  var a = ee(e), i, n;
  return !a && Ie(e) && (i = a = e.radius || xe, e.values ? (e = _e(e.values), (n = !Ge(e[0])) && (i *= i)) : e = ci(e.increment)), tt(t, a ? Y(e) ? function(o) {
    return n = e(o), Math.abs(n - o) <= i ? n : o;
  } : function(o) {
    for (var s = parseFloat(n ? o.x : o), l = parseFloat(n ? o.y : 0), c = xe, d = 0, u = e.length, g, p; u--; )
      n ? (g = e[u].x - s, p = e[u].y - l, g = g * g + p * p) : g = Math.abs(e[u] - s), g < c && (c = g, d = u);
    return d = !i || c <= i ? e[d] : o, n || d === o || Ge(o) ? d : d + $(o);
  } : ci(e));
}, dr = function(e, t, a, i) {
  return tt(ee(e) ? !t : a === !0 ? !!(a = 0) : !i, function() {
  ...
  var i = t - e;
  return ee(e) ? ur(e, r(0, e.length), t) : tt(a, function(n) {
    return (i + (n - e) % i) % i + e;
  });
}, Go = function r(e, t, a) {
  var i = t - e, n = i * 2;
  return ee(e) ? ur(e, r(0, e.length - 1), t) : tt(a, function(o) {
    return o = (n + (o - e) % n) % n || 0, e + (o > i ? n - o : o);
  });
}, Yt = function(e) {
  return e.replace(_o, function(t) {
    var a = t.indexOf("[") + 1, i = t.substring(a || 7, a ? t.indexOf("]") : t.length - 1).split(Ao);
    return dr(a ? i : +i[0], a ? 0 : +i[1], +i[2] || 1e-5);
  });
  ...
  if (!n) {
    ...
    if (!d) {
      ...
      n = function(f) {
        return Ri(f, s) || (o ? e.p : e);
      };
    }
  }
  return tt(a, n);
}, Wi = function(e, t, a) {
  var i = e.labels, n = xe, o, s, l;
  for (o in i)
    s = i[o] - t, s < 0 == !!a && s && n > (s = Math.abs(s)) && (l = o, n = s);
  return l;
}, he = function(e, t, a) {
  var i = e.vars, n = i[t], o = G, s = e._ctx, l, c, d;
  if (n)
    return l = i[t + "Params"], c = i.callbackScope || e, a && Xe.length && ga(), s && (G = s), d = l ? n.apply(c, l) : n.call(c), G = o, d;
}, Nt = function(e) {
  return Ze(e), e.scrollTrigger && e.scrollTrigger.kill(!!X), e.progress() < 1 && he(e, "onInterrupt"), e;
}, bt, pr = [], gr = function(e) {
  if (e)
    if (e = !e.name && e.default || e, xi() || e.headless) {
      ...
      if (Tt(), e !== i) {
        if (de[t])
          return;
        fe(i, fe(ma(e, n), o)), kt(i.prototype, kt(n, ma(e, o))), de[i.prop = t] = i, e.targetTest && (da.push(i), vi[t] = 1), t = (t === "css" ? "CSS" : t.charAt(0).toUpperCase() + t.substr(1)) + "Plugin";
      }
      Xn(t, i), e.register && e.register(ce, i, se);
    } else
      pr.push(e);
}, B = 255, Ot = {
  aqua: [0, B, B],
  ...
  var i = e ? Ge(e) ? [e >> 16, e >> 8 & B, e & B] : 0 : Ot.black, n, o, s, l, c, d, u, g, p, f;
  if (!i) {
    if (e.substr(-1) === "," && (e = e.substr(0, e.length - 1)), Ot[e])
      ...
      if (i = f = e.match(zi), !t)
        ...
        return i = e.match(Yn), a && i.length < 4 && (i[3] = 1), i;
    } else
  ...
  var t = [], a = [], i = -1;
  return e.split(Je).forEach(function(n) {
    var o = n.match(wt) || [];
    t.push.apply(t, o), a.push(i += o.length + 1);
  }), t.c = a, t;
}, Yi = function(e, t, a) {
  var i = "", n = (e + i).match(Je), o = t ? "hsla(" : "rgba(", s = 0, l, c, d, u;
  if (!n)
    return e;
  if (n = n.map(function(g) {
    return (g = mr(g, t, 1)) && o + (t ? g[0] + "," + g[1] + "%," + g[2] + "%," + g[3] : g.join(",")) + ")";
  }), a && (d = fr(e), l = a.c, l.join(i) !== d.c.join(i)))
    for (c = e.replace(Je, "1").split(wt), u = c.length - 1; s < u; s++)
      i += c[s] + (~l.indexOf(s) ? n.shift() || o + "0,0,0,0)" : (d.length ? d : n.length ? n : a).shift());
  if (!c)
    for (c = e.split(Je), u = c.length - 1; s < u; s++)
      i += c[s] + n[s];
  return i + c[u];
}, Je = (function() {
...
})(), Ho = /hsl[a]?\(/, wr = function(e) {
  var t = e.join(" "), a;
  if (Je.lastIndex = 0, Je.test(t))
    return a = Ho.test(t), e[1] = Yi(e[1], a), e[0] = Yi(e[0], a, fr(e[1])), !0;
}, Qt, ue = (function() {
  var r = Date.now, e = 500, t = 33, a = r(), i = a, n = 1e3 / 240, o = n, s = [], l, c, d, u, g, p, f = function h(w) {
    var b = r() - i, y = w === !0, _, A, x, T;
    if ((b > e || b < 0) && (a += b - t), i += b, x = i - a, _ = x - o, (_ > 0 || y) && (T = ++u.frame, g = x - u.time * 1e3, u.time = x = x / 1e3, o += _ + (_ >= n ? 4 : n - _), A = 1), y || (l = c(h)), A)
  ...
  return u = {
    ...
    wake: function() {
      jn && (!ii && xi() && (Ee = ii = window, _i = Ee.document || {}, me.gsap = ce, (Ee.gsapVersions || (Ee.gsapVersions = [])).push(ce.version), Kn(pa || Ee.GreenSockGlobals || !Ee.gsap && Ee || {}), pr.forEach(gr)), d = typeof requestAnimationFrame < "u" && requestAnimationFrame, l && u.sleep(), c = d || function(w) {
        return setTimeout(w, o - u.time * 1e3 + 1 | 0);
      }, Qt = 1, f(2));
    },
    sleep: function() {
      (d ? cancelAnimationFrame : clearTimeout)(l), Qt = 0, c = Wt;
    },
    ...
    add: function(w, b, y) {
      ...
      return u.remove(w), s[y ? "unshift" : "push"](_), Tt(), _;
    },
    remove: function(w, b) {
  ...
  return !Qt && ue.wake();
}, R = {}, Wo = /^[\d.\-M][\d.\-,\s]/, Yo = /["']/g, Qo = function(e) {
  for (var t = {}, a = e.substr(1, e.length - 3).split(":"), i = a[0], n = 1, o = a.length, s, l, c; n < o; n++)
    l = a[n], s = n !== o - 1 ? l.lastIndexOf(",") : l.length, c = l.substr(0, s), t[i] = isNaN(c) ? c.replace(Yo, "").trim() : +c, i = l.substr(s + 1).trim();
  return t;
}, jo = function(e) {
  ...
  return a && t.length > 1 && a.config ? a.config.apply(null, ~e.indexOf("{") ? [Qo(t[1])] : jo(e).split(",").map(er)) : R._CE && Wo.test(e) ? R._CE("", e) : a;
}, Xo = function(e) {
  return function(t) {
    return 1 - e(1 - t);
  };
}, pt = function(e, t) {
  return e && (Y(e) ? e : R[e] || Ko(e)) || t;
}, mt = function(e, t, a, i) {
  ...
  var i = t >= 1 ? t : 1, n = (a || (e ? 0.3 : 0.45)) / (t < 1 ? t : 1), o = n / ai * (Math.asin(1 / i) || 0), s = function(d) {
    return d === 1 ? 1 : i * Math.pow(2, -10 * d) * xo((d - o) * n) + 1;
  }, l = e === "out" ? s : e === "in" ? function(c) {
    return 1 - s(1 - c);
  } : br(s);
  return n = ai / n, l.config = function(c, d) {
    return r(e, c, d);
  }, l;
}, Na = function r(e, t) {
  t === void 0 && (t = 1.70158);
...
var yr = function(e, t) {
  this.id = bo++, e._gsap = this, this.target = e, this.harness = t, this.get = t ? t.get : Zn, this.set = t ? t.getSetter : Pi;
}, jt = /* @__PURE__ */ (function() {
  function r(t) {
    this.vars = t, this._delay = +t.delay || 0, (this._repeat = t.repeat === 1 / 0 ? -2 : t.repeat || 0) && (this._rDelay = t.repeatDelay || 0, this._yoyo = !!t.yoyo || !!t.yoyoEase), this._ts = 1, Ct(this, +t.duration, 1, 1), this.data = t.data, G && (this._ctx = G, G.data.push(this)), Qt || ue.wake();
  }
  var e = r.prototype;
  return e.delay = function(a) {
    ...
    if (n && n.smoothChildTiming && this._ts) {
      for (Sa(this, a), !n._dp || n.parent || ir(n, this); n && n.parent; )
    ...
    return (this._tTime !== a || !this._dur && !i || this._initted && Math.abs(this._zTime) === q || !this._initted && this._dur && a || !a && !this._initted && (this.add || this._ptLookup)) && (this._ts || (this._pTime = a), $n(this, a, i)), this;
  }, e.time = function(a, i) {
    return arguments.length ? this.totalTime(Math.min(this.totalDuration(), a + Vi(this)) % (this._dur + this._rDelay) || (a ? this._dur : 0), i) : this._time;
    ...
    return arguments.length ? this.totalTime(this.duration() * (this._yoyo && !(this.iteration() & 1) ? 1 - a : a) + Vi(this), i) : this.duration() ? Math.min(1, this._time / this._dur) : this.rawTime() > 0 ? 1 : 0;
    ...
    return this._rts = +a || 0, this._ts = this._ps || a === -q ? 0 : this._rts, this.totalTime(ea(-Math.abs(this._delay), this.totalDuration(), n), i !== !1), ka(this), Po(this);
  }, e.paused = function(a) {
    return arguments.length ? (this._ps !== a && (this._ps = a, a ? (this._pTime = this._tTime || Math.max(-this._delay, this.rawTime()), this._ts = this._act = 0) : (Tt(), this._ts = this._rts, this.totalTime(this.parent && !this.parent.smoothChildTiming ? this.rawTime() : this._tTime || this._pTime, this.progress() === 1 && Math.abs(this._zTime) !== q && (this._tTime -= q)))), this) : this._ps;
    ...
    a === void 0 && (a = Co);
    var i = X;
    return X = a, Ci(this) && (this.timeline && this.timeline.revert(a), this.totalTime(-0.01, a.suppressEvents)), this.data !== "nested" && a.kill !== !1 && this.kill(), X = i, this;
    ...
    return this.play().totalTime(a ? -this._delay : 0, re(i)), this._dur || (this._zTime = -q), this;
  }, e.play = function(a, i) {
    ...
    return !!(!a || this._ts && this._initted && a.isActive() && (n = a.rawTime(!0)) >= i && n < this.endTime(!0) - q);
...
var ne = /* @__PURE__ */ (function(r) {
  ...
  function e(a, i) {
    var n;
    return a === void 0 && (a = {}), n = r.call(this, a) || this, n.labels = {}, n.smoothChildTiming = !!a.smoothChildTiming, n.autoRemoveChildren = !!a.autoRemoveChildren, n._sort = re(a.sortChildren), H && Me(a.parent || H, Be(n), i), a.reversed && n.reverse(), a.paused && n.paused(!0), a.scrollTrigger && nr(Be(n), a.scrollTrigger), n;
  }
  var t = e.prototype;
  return t.to = function(i, n, o) {
    ...
    return n.duration = 0, n.parent = this, Ft(n).repeatDelay || (n.repeat = 0), n.immediateRender = !!n.immediateRender, new j(i, n, be(this, o), 1), this;
  }, t.call = function(i, n, o) {
    return Me(this, j.delayedCall(0, i, n), o);
  }, t.staggerTo = function(i, n, o, s, l, c, d) {
    return o.duration = n, o.stagger = o.stagger || s, o.onComplete = c, o.onCompleteParams = d, o.parent = this, new j(i, o, be(this, l)), this;
  }, t.staggerFrom = function(i, n, o, s, l, c, d) {
    return o.runBackwards = 1, Ft(o).immediateRender = re(o.immediateRender), this.staggerTo(i, n, o, s, l, c, d);
  }, t.staggerFromTo = function(i, n, o, s, l, c, d, u) {
    return s.startAt = o, Ft(s).immediateRender = re(s.immediateRender), this.staggerTo(i, n, s, l, c, d, u);
    ...
    if (this !== H && d > l && i >= 0 && (d = l), d !== this._tTime || o || u) {
      if (s !== this._time && c && (d += this._time - s, i += this._time - s), g = d, A = this._start, _ = this._ts, b = !_, u && (c || (s = this._zTime), (i || !n) && (this._zTime = i)), this._repeat) {
        ...
        if (g = V(d % w), d === l ? (h = this._repeat, g = c) : (x = V(d / w), h = ~~x, h && h === x && (g = c, h--), g > c && (g = c)), x = St(this._tTime, w), !s && this._tTime && x !== h && this._tTime - x * w - this._dur <= 0 && (x = h), T && h & 1 && (g = c - g, v = 1), h !== x && !this._lock) {
          var C = T && x & 1, S = C === (T && h & 1);
          if (h < x && (C = !C), s = C ? 0 : d % c ? c : d, this._lock = 1, this.render(s || (v ? 0 : V(h * w)), n, !c)._lock = 0, this._tTime = d, !n && this.parent && he(this, "onRepeat"), this.vars.repeatRefresh && !v && (this.invalidate()._lock = 1, x = h), s && s !== this._time || b !== !this._ts || this.vars.onRepeat && !this.parent && !this._act)
            return this;
          if (c = this._dur, l = this._tDur, S && (this._lock = 2, s = C ? c : -1e-4, this.render(s, !0), this.vars.repeatRefresh && !v && this.invalidate()), this._lock = 0, !this._ts && !b)
            return this;
        }
      }
      if (this._hasPause && !this._forcing && this._lock < 2 && (y = Lo(this, V(s), V(g)), y && (d -= g - (g = y._start))), this._tTime = d, this._time = g, this._act = !!_, this._initted || (this._onUpdate = this.vars.onUpdate, this._initted = 1, this._zTime = i, s = 0), !s && d && c && !n && !x && (he(this, "onStart"), this._tTime !== d))
        return this;
      if (g >= s && i >= 0)
        for (p = this._first; p; ) {
      ...
      if (y && !n && (this.pause(), y.render(g >= s ? 0 : -q)._zTime = g >= s ? 1 : -1, this._ts))
        return this._start = A, ka(this), this.render(i, n, o);
      this._onUpdate && !n && he(this, "onUpdate", !0), (d === l && this._tTime >= this.totalDuration() || !d && s) && (A === this._start || Math.abs(_) !== Math.abs(this._ts)) && (this._lock || ((i || !c) && (d === l && this._ts > 0 || !d && this._ts < 0) && Ze(this, 1), !n && !(i < 0 && !s) && (d || s || !l) && (he(this, d === l && i >= 0 ? "onComplete" : "onReverseComplete", !0), this._prom && !(d < l && this.timeScale() > 0) && this._prom())));
    }
    return this;
  }, t.add = function(i, n) {
    var o = this;
    if (Ge(n) || (n = be(this, n, i)), !(i instanceof jt)) {
      if (ee(i))
    ...
    i === void 0 && (i = !0), n === void 0 && (n = !0), o === void 0 && (o = !0), s === void 0 && (s = -xe);
    for (var l = [], c = this._first; c; )
      c._start >= s && (c instanceof j ? n && l.push(c) : (o && l.push(c), i && l.push.apply(l, c.getChildren(!0, n, o)))), c = c._next;
    return l;
    ...
    return K(i) ? this.removeLabel(i) : Y(i) ? this.killTweensOf(i) : (i.parent === this && va(this, i), i === this._recent && (this._recent = this._last), ht(this));
  }, t.totalTime = function(i, n) {
    return arguments.length ? (this._forcing = 1, !this._dp && this._ts && (this._start = V(ue.time - (this._ts > 0 ? i / this._ts : (this.totalDuration() - i) / -this._ts))), r.prototype.totalTime.call(this, i, n), this._forcing = 0, this) : this._tTime;
  }, t.addLabel = function(i, n) {
    return this.labels[i] = be(this, n), this;
  }, t.removeLabel = function(i) {
    return delete this.labels[i], this;
  }, t.addPause = function(i, n, o) {
    var s = j.delayedCall(0, n || Wt, o);
    ...
    for (var o = [], s = _e(i), l = this._first, c = Ge(n), d; l; )
      l instanceof j ? To(l._targets, s) && (c ? (!Ye || l._initted && l._ts) && l.globalTime(0) <= n && l.globalTime(l.totalDuration()) > n : !n || l.isActive()) && o.push(l) : (d = l.getTweensOf(s, n)).length && o.push.apply(o, d), l = l._next;
    return o;
  }, t.tweenTo = function(i, n) {
    n = n || {};
    var o = this, s = be(o, i), l = n, c = l.startAt, d = l.onStart, u = l.onStartParams, g = l.immediateRender, p, f = j.to(o, fe({
      ease: n.ease || "none",
      lazy: !1,
      immediateRender: !1,
      time: s,
      overwrite: "auto",
      duration: n.duration || Math.abs((s - (c && "time" in c ? c.time : o._time)) / o.timeScale()) || q,
      onStart: function() {
        if (o.pause(), !p) {
    ...
    return this._dp && (this._time = this._tTime = this._pTime = 0), i && (this.labels = {}), ht(this);
  }, t.totalDuration = function(i) {
    var n = 0, o = this, s = o._last, l = xe, c, d, u;
    if (arguments.length)
      return o.timeScale((o._repeat < 0 ? o.duration() : o.totalDuration()) / (o.reversed() ? -i : i));
    if (o._dirty) {
      for (u = o.parent; s; )
        c = s._prev, s._dirty && s.totalDuration(), d = s._start, d > l && o._sort && s._ts && !o._lock ? (o._lock = 1, Me(o, s, d - s._delay, 1)._lock = 0) : l = d, d < 0 && s._ts && (n -= d, (!u && !o._dp || u && u.smoothChildTiming) && (o._start += V(d / o._ts), o._time -= d, o._tTime -= d), o.shiftChildren(-d, !1, -1 / 0), l = 0), s._end > n && s._ts && (n = s._end), s = c;
      Ct(o, o === H && o._time > n ? o._time : n, 1, 1), o._dirty = 0;
    }
    return o._tDur;
  }, e.updateRoot = function(i) {
    if (H._ts && ($n(H, fa(i, H)), Jn = ue.frame), ue.frame >= Ui) {
      Ui += ge.autoSleep || 120;
      var n = H._first;
      if ((!n || !n._ts) && ge.autoSleep && ue._listeners.length < 2) {
        for (; n && !n._ts; )
          n = n._next;
        n || ue.sleep();
      }
...
var Jo = function(e, t, a, i, n, o, s) {
  var l = new se(this._pt, e, t, 0, 1, Sr, null, n), c = 0, d = 0, u, g, p, f, h, w, b, y;
  for (l.b = a, l.e = i, a += "", i += "", (b = ~i.indexOf("random(")) && (i = Yt(i)), o && (y = [a, i], o(y, e, t), a = y[0], i = y[1]), g = a.match(Ra) || []; u = Ra.exec(i); )
  ...
  return l.c = c < i.length ? i.substring(c, i.length) : "", l.fp = s, (Qn.test(i) || b) && (l.e = 0), this._pt = l, l;
}, Ti = function(e, t, a, i, n, o, s, l, c, d) {
  Y(i) && (i = i(n || 0, e, o));
  var u = e[t], g = a !== "get" ? a : Y(u) ? c ? e[t.indexOf("set") || !Y(e["get" + t.substr(3)]) ? t : "get" + t.substr(3)](c) : e[t]() : u, p = Y(u) ? c ? as : vr : Mi, f;
  if (K(i) && (~i.indexOf("random(") && (i = Yt(i)), i.charAt(1) === "=" && (f = yt(g, i) + ($(g) || 0), (f || f === 0) && (i = f))), !d || g !== i || di)
    return !isNaN(g * i) && i !== "" ? (f = new se(this._pt, e, t, +g || 0, i - (g || 0), typeof u == "boolean" ? ns : kr, 0, p), c && (f.fp = c), s && f.modifier(s, this, e), this._pt = f) : (!u && !(t in e) && Ai(t, i), Jo.call(this, e, t, g, i, p, l || ge.stringFilter, c));
}, Zo = function(e, t, a, i, n) {
  if (Y(e) && (e = Ut(e, n, t, a, i)), !Ie(e) || e.style && e.nodeType || ee(e) || Wn(e))
    return K(e) ? Ut(e, n, t, a, i) : e;
  var o = {}, s;
  for (s in e)
    o[s] = Ut(e[s], n, t, a, i);
  return o;
}, xr = function(e, t, a, i, n, o) {
  var s, l, c, d;
  if (de[e] && (s = new de[e]()).init(n, s.rawVars ? t[e] : Zo(t[e], i, n, o, a), a, i, o) !== !1 && (a._pt = l = new se(a._pt, n, e, 0, 1, s.render, s, 0, s.priority), a !== bt))
    for (c = a._ptLookup[a._targets.indexOf(n)], d = s._props.length; d--; )
      c[s._props[d]] = l;
  return s;
}, Ye, di, Ei = function r(e, t, a) {
  var i = e.vars, n = i.ease, o = i.startAt, s = i.immediateRender, l = i.lazy, c = i.onUpdate, d = i.runBackwards, u = i.yoyoEase, g = i.keyframes, p = i.autoRevert, f = e._dur, h = e._startAt, w = e._targets, b = e.parent, y = b && b.data === "nested" ? b.vars.targets : w, _ = e._overwrite === "auto" && !bi, A = e.timeline, x = i.easeReverse || u, T, v, C, S, E, z, O, D, I, N, P, U, J;
  if (A && (!g || !n) && (n = "none"), e._ease = pt(n, Vt.ease), e._rEase = x && (pt(x) || e._ease), e._from = !A && !!i.runBackwards, e._from && (e.ratio = 1), !A || g && !i.stagger) {
    if (D = w[0] ? ut(w[0]).harness : 0, U = D && i[D.prop], T = ma(i, vi), h && (h._zTime < 0 && h.progress(1), t < 0 && d && s && !p ? h.render(-1, !0) : h.revert(d && f ? ca : So), h._lazy = 0), o) {
      if (Ze(e._startAt = j.set(w, fe({
        ...
        stagger: 0
      }, o))), e._startAt._dp = 0, e._startAt._sat = e, t < 0 && (X || !s && !p) && e._startAt.revert(ca), s && f && t <= 0 && a <= 0) {
        t && (e._zTime = t);
        return;
      }
    } else if (d && f && !h) {
      ...
      }, T), U && (C[D.prop] = U), Ze(e._startAt = j.set(w, C)), e._startAt._dp = 0, e._startAt._sat = e, t < 0 && (X ? e._startAt.revert(ca) : e._startAt.render(-1, !0)), e._zTime = t, !s)
        r(e._startAt, q, q);
      else if (!t)
        return;
    }
    for (e._pt = e._ptCache = 0, l = f && re(l) || l && !f, v = 0; v < w.length; v++) {
      if (E = w[v], O = E._gsap || Si(w)[v]._gsap, e._ptLookup[v] = N = {}, ni[O.id] && Xe.length && ga(), P = y === w ? v : y.indexOf(E), D && (I = new D()).init(E, U || T, e, P, y) !== !1 && (e._pt = S = new se(e._pt, E, I.name, 0, 1, I.render, I, 0, I.priority), I._props.forEach(function(De) {
        N[De] = S;
      }), I.priority && (z = 1)), !D || U)
        for (C in T)
          de[C] && (I = xr(C, T, e, P, E, y)) ? I.priority && (z = 1) : N[C] = S = Ti.call(e, E, C, "get", T[C], P, y, 0, i.stringFilter);
      e._op && e._op[v] && e.kill(E, e._op[v]), _ && e._pt && (Ye = e, H.killTweensOf(E, N, e.globalTime(t)), J = !e.parent, Ye = 0), e._pt && l && (ni[O.id] = 1);
    }
    z && Cr(e), e._onInit && e._onInit(e);
  }
  e._onUpdate = c, e._initted = (!e._op || e._pt) && !J, g && t <= 0 && A.render(xe, !0, !0);
}, $o = function(e, t, a, i, n, o, s, l) {
    ...
    for (c = e._ptCache[t] = [], g = e._ptLookup, p = e._targets.length; p--; ) {
      if (d = g[p][t], d && d.d && d.d._pt)
        for (d = d.d._pt; d && d.p !== t && d.fp !== t; )
          d = d._next;
      if (!d)
        return di = 1, e.vars[t] = "+=0", Ei(e, s), di = 0, l ? Ht(t + " not eligible for reset. Try splitting into individual properties") : 1;
      c.push(d);
    }
  for (p = c.length; p--; )
    u = c[p], d = u._pt || u, d.s = (i || i === 0) && !n ? i : d.s + (i || 0) + o * d.c, d.c = a - d.s, u.e && (u.e = Q(a) + $(u.e)), u.b && (u.b = d.s + $(u.b));
}, es = function(e, t) {
...
}, Ut = function(e, t, a, i, n) {
  return Y(e) ? e.call(t, a, i, n) : K(e) && ~e.indexOf("random(") ? Yt(e) : e;
}, _r = ki + "repeat,repeatDelay,yoyo,repeatRefresh,yoyoEase,easeReverse,autoRevert", Ar = {};
oe(_r + ",id,stagger,delay,duration,paused,scrollTrigger", function(r) {
  return Ar[r] = 1;
});
var j = /* @__PURE__ */ (function(r) {
  ...
  function e(a, i, n, o) {
    var s;
    typeof i == "number" && (n.duration = i, i = n, n = null), s = r.call(this, o ? i : Ft(i)) || this;
    var l = s.vars, c = l.duration, d = l.delay, u = l.immediateRender, g = l.stagger, p = l.overwrite, f = l.keyframes, h = l.defaults, w = l.scrollTrigger, b = i.parent || H, y = (ee(a) || Wn(a) ? Ge(a[0]) : "length" in i) ? [a] : _e(a), _, A, x, T, v, C, S, E;
    if (s._targets = y.length ? Si(y) : Ht("GSAP target " + a + " not found. https://gsap.com", !ge.nullTargetWarn) || [], s._ptLookup = [], s._overwrite = p, f || g || ta(c) || ta(d)) {
      ...
      if (_ = s.timeline = new ne({
        data: "nested",
        defaults: h || {},
        targets: b && b.data === "nested" ? b.vars.targets : y
      }), _.kill(), _.parent = _._dp = Be(s), _._start = 0, g || ta(c) || ta(d)) {
        if (T = y.length, S = g && lr(g), Ie(g))
          for (v in g)
            ~_r.indexOf(v) && (E || (E = {}), E[v] = g[v]);
        for (A = 0; A < T; A++)
          x = ma(i, Ar), x.stagger = 0, z && (x.easeReverse = z), E && kt(x, E), C = y[A], x.duration = +Ut(c, Be(s), A, C, y), x.delay = (+Ut(d, Be(s), A, C, y) || 0) - s._delay, !g && T === 1 && x.delay && (s._delay = d = x.delay, s._start += d, x.delay = 0), _.to(C, x, S ? S(A, C, y) : 0), _._ease = R.none;
        _.duration() ? c = d = 0 : s.timeline = 0;
      } else if (f) {
        Ft(fe(_.vars.defaults, {
          ease: "none"
        })), _._ease = pt(f.ease || i.ease || "none");
        var O = 0, D, I, N;
        if (ee(f))
          ...
          x = {};
          for (v in f)
            v === "ease" || v === "easeEach" || ts(v, f[v], x, f.easeEach);
          for (v in x)
            for (D = x[v].sort(function(P, U) {
              return P.t - U.t;
            }), O = 0, A = 0; A < D.length; A++)
              I = D[A], N = {
                ease: I.e,
                duration: (I.t - (A ? D[A - 1].t : 0)) / 100 * c
              }, N[v] = I.v, _.to(y, N, O), O += N.duration;
          _.duration() < c && _.to({}, {
      ...
      s.timeline = 0;
    return p === !0 && !bi && (Ye = Be(s), H.killTweensOf(y), Ye = 0), Me(b, Be(s), n), i.reversed && s.reverse(), i.paused && s.paused(!0), (u || !c && !f && s._start === V(b._time) && re(u) && Ro(Be(s)) && b.data !== "nested") && (s._tTime = -q, s.render(Math.max(0, -d) || 0)), w && nr(Be(s), w), s;
  }
  var t = e.prototype;
  return t.render = function(i, n, o) {
    var s = this._time, l = this._tDur, c = this._dur, d = i < 0, u = i > l - q && !d ? l : i < q ? 0 : i, g, p, f, h, w, b, y, _;
    if (!c)
      Do(this, i, n, o);
      ...
      if (g = u, _ = this.timeline, this._repeat) {
        ...
        if (g = V(u % h), u === l ? (f = this._repeat, g = c) : (w = V(u / h), f = ~~w, f && f === w ? (g = c, f--) : g > c && (g = c)), b = this._yoyo && f & 1, b && (g = c - g), w = St(this._tTime, h), g === s && !o && this._initted && f === w)
          return this._tTime = u, this;
        f !== w && this.vars.repeatRefresh && !b && !this._lock && g !== h && this._initted && (this._lock = o = 1, this.render(V(h * f), !0).invalidate()._lock = 0);
      }
      if (!this._initted) {
        if (rr(this, d ? i : g, o, n, u))
      ...
      if (this._from && (this.ratio = y = 1 - y), this._tTime = u, this._time = g, !this._act && this._ts && (this._act = 1, this._lazy = 0), !s && u && !n && !w && (he(this, "onStart"), this._tTime !== u))
        return this;
      for (p = this._pt; p; )
        p.r(y, p.d), p = p._next;
      _ && _.render(i < 0 ? i : _._dur * _._ease(g / this._dur), n, o) || this._startAt && (this._zTime = i), this._onUpdate && !n && (d && ri(this, i, n, o), he(this, "onUpdate")), this._repeat && f !== w && this.vars.onRepeat && !n && this.parent && he(this, "onRepeat"), (u === this._tDur || !u) && this._tTime === u && (d && !this._onUpdate && ri(this, i, !0, !0), (i || !c) && (u === this._tDur && this._ts > 0 || !u && this._ts < 0) && Ze(this, 1), !n && !(d && !s) && (u || s || b) && (he(this, u === l ? "onComplete" : "onReverseComplete", !0), this._prom && !(u < l && this.timeScale() > 0) && this._prom()));
    }
    return this;
  }, t.targets = function() {
    ...
    Qt || ue.wake(), this._ts || this.play();
    var c = Math.min(this._dur, (this._dp._time - this._start) * this._ts), d;
    return this._initted || Ei(this, c), d = this._ease(c / this._dur), $o(this, i, n, o, s, d, c, l) ? this.resetTo(i, n, o, s, 1) : (Sa(this, 0), this.parent || ar(this._dp, this, "_first", "_last", this._dp._sort ? "_start" : 0), this.render(0));
  }, t.kill = function(i, n) {
    if (n === void 0 && (n = "all"), !i && (!n || n === "all"))
      return this._lazy = this._pt = 0, this.parent ? Nt(this) : this.scrollTrigger && this.scrollTrigger.kill(!!X), this;
    if (this.timeline) {
      var o = this.timeline.totalDuration();
      return this.timeline.killTweensOf(i, n, Ye && Ye.vars.overwrite !== !0)._first || Nt(this), this.parent && o !== this.timeline.totalDuration() && Ct(this, this._dur * this.timeline._tDur / o, 0, 1), this;
    }
    var s = this._targets, l = i ? _e(i) : s, c = this._ptLookup, d = this._pt, u, g, p, f, h, w, b;
    if ((!n || n === "all") && Mo(s, l))
      return n === "all" && (this._pt = 0), Nt(this);
    for (u = this._op = this._op || [], n !== "all" && (K(n) && (h = {}, oe(n, function(y) {
      return h[y] = 1;
    }), n = h), n = es(s, n)), b = s.length; b--; )
      if (~l.indexOf(s[b])) {
        g = c[b], n === "all" ? (u[b] = n, f = g, p = {}) : (p = u[b] = u[b] || {}, f = n);
        for (h in f)
          w = g && g[h], w && ((!("kill" in w.d) || w.d.kill(h) === !0) && va(this, w, "_pt"), delete g[h]), p !== "all" && (p[h] = 1);
      }
...
oe("staggerTo,staggerFrom,staggerFromTo", function(r) {
  j[r] = function() {
    var e = new ne(), t = si.call(arguments, 0);
...
var Mi = function(e, t, a) {
  ...
  return Y(e[t]) ? vr : yi(e[t]) && e.setAttribute ? is : Mi;
}, kr = function(e, t) {
  ...
  function r(t, a, i, n, o, s, l, c, d) {
    this.t = a, this.s = n, this.c = o, this.p = i, this.r = s || kr, this.d = l || this, this.set = c || Mi, this.pr = d || 0, this._next = t, t && (t._prev = this);
  }
  var e = r.prototype;
  return e.modifier = function(a, i, n) {
    this.mSet = this.mSet || this.set, this.set = ss, this.m = a, this.mt = n, this.tween = i;
  }, r;
})();
...
me.TweenMax = me.TweenLite = j;
me.TimelineLite = me.TimelineMax = ne;
H = new ne({
  sortChildren: !1,
  defaults: Vt,
...
ge.stringFilter = wr;
var gt = [], ua = {}, ls = [], Qi = 0, cs = 0, Oa = function(e) {
  return (ua[e] || ls).map(function(t) {
    return t();
  });
}, ui = function() {
  var e = Date.now(), t = [];
  e - Qi > 2 && (Oa("matchMediaInit"), gt.forEach(function(a) {
    var i = a.queries, n = a.conditions, o, s, l, c;
    for (s in i)
      o = Ee.matchMedia(i[s]).matches, o && (l = 1), o !== n[s] && (n[s] = o, c = 1);
  ...
  function r(t, a) {
    this.selector = a && li(a), this.data = [], this._r = [], this.isReverted = !1, this.id = cs++, t && this.add(t);
  }
  var e = r.prototype;
  return e.add = function(a, i, n) {
    Y(a) && (n = i, i = a, a = Y);
    var o = this, s = function() {
      var c = G, d = o.selector, u;
      return c && c !== o && c.data.push(o), n && (o.selector = li(n)), G = o, u = i.apply(o, arguments), Y(u) && o._r.push(u), G = c, o.selector = d, o.isReverted = !1, u;
    };
    ...
    if (a ? (function() {
      ...
      for (s.map(function(d) {
        ...
        c = n.data[l], c instanceof ne ? c.data !== "nested" && (c.scrollTrigger && c.scrollTrigger.revert(), c.kill()) : !(c instanceof j) && c.revert && c.revert(a);
      ...
      for (var o = gt.length; o--; )
        gt[o].id === this.id && gt.splice(o, 1);
  }, e.revert = function(a) {
    this.kill(a || {});
  }, r;
})(), ds = /* @__PURE__ */ (function() {
  function r(t) {
    this.contexts = [], this.scope = t, G && G.data.push(this);
  }
  var e = r.prototype;
  return e.add = function(a, i, n) {
    Ie(a) || (a = {
    ...
    var o = new Tr(0, n || this.scope), s = o.conditions = {}, l, c, d;
    G && !o.selector && (o.selector = G.selector), this.contexts.push(o), i = o.add("onMatch", i), o.queries = a;
    for (c in a)
      c === "all" ? d = 1 : (l = Ee.matchMedia(a[c]), l && (gt.indexOf(o) < 0 && gt.push(o), (s[c] = l.matches) && (d = 1), l.addListener ? l.addListener(ui) : l.addEventListener("change", ui)));
  ...
  quickSetter: function(e, t, a) {
    ...
    e = e[0] || {};
    var o = de[t], s = ut(e), l = s.harness && (s.harness.aliases || {})[t] || t, c = o ? function(d) {
      var u = new o();
      bt._pt = 0, u.init(e, a ? d + a : d, bt, 0, [e]), u.render(1, u), bt._pt && Ri(1, bt);
    } : s.set(e, l);
  ...
  defaults: function(e) {
    return e && e.ease && (e.ease = pt(e.ease, Vt.ease)), Gi(Vt, e || {});
  },
  config: function(e) {
    return Gi(ge, e || {});
  },
  registerEffect: function(e) {
    ...
    (i || "").split(",").forEach(function(s) {
      return s && !de[s] && !me[s] && Ht(t + " effect requires " + s + " plugin.");
    }), Ia[t] = function(s, l, c) {
  ...
  exportRoot: function(e, t) {
    e === void 0 && (e = {});
    var a = new ne(e), i, n;
    for (a.smoothChildTiming = re(e.smoothChildTiming), H.remove(a), a._dp = 0, a._time = a._tTime = H._time, i = H._first; i; )
      n = i._next, (t || !(!i._dur && i instanceof j && i.vars.onComplete === i._targets[0])) && Me(a, i, i._start - i._delay), i = n;
    return Me(H, a, 0), a;
  },
  context: function(e, t) {
    return e ? new Tr(e, t) : G;
  },
...
var us = function(e, t) {
  ...
  for (i in t)
    for (n = a.length; n--; )
      o = e._ptLookup[n][i], o && (o = o.d) && (o._pt && (o = us(o, i)), o && o.modifier && o.modifier(t[i], e, a[n], i));
}, Ba = function(e, t) {
  return {
    name: e,
    headless: 1,
...
}, Ba("roundProps", ci), Ba("modifiers"), Ba("snap", cr)) || wa;
j.version = ne.version = ce.version = "3.15.0";
jn = 1;
xi() && Tt();
R.Power0;
R.Power1;
...
R.Expo;
R.Circ;
var ji, Qe, xt, Ii, dt, Ki, Di, ps = function() {
  return typeof window < "u";
}, Ve = {}, lt = 180 / Math.PI, _t = Math.PI / 180, ft = Math.atan2, Xi = 1e8, Li = /([A-Z])/g, gs = /(left|right|width|margin|padding|x)/i, ms = /[\s,\(]\S/, Re = {
  ...
  if (e in Ve && n) {
    ...
    if (this.props.indexOf(W) >= 0)
      return;
    o.svg && (this.svgo = i.getAttribute("data-svg-origin"), this.props.push(le, t, "")), e = W;
  }
  ...
  if (this.tfm) {
    for (o in this.tfm)
      i[o] = this.tfm[o];
    i.svg && (i.renderTransform(), t.setAttribute("data-svg-origin", this.svgo || "")), n = Di(), (!n || !n.isStart) && !a[W] && (Pr(a), i.zOrigin && a[le] && (a[le] += " " + i.zOrigin + "px", i.zOrigin = 0, i.renderTransform()), i.uncache = 1);
  }
}, Rr = function(e, t) {
  var a = {
    target: e,
  ...
  var a = Qe.createElementNS ? Qe.createElementNS((t || "http://www.w3.org/1999/xhtml").replace(/^https/, "http"), e) : Qe.createElement(e);
  return a && a.style ? a : Qe.createElement(e);
}, pe = function r(e, t, a) {
  var i = getComputedStyle(e);
  return i[t] || i.getPropertyValue(t.replace(Li, "-$1").toLowerCase()) || i.getPropertyValue(t) || !a && r(e, Et(t) || t, 1) || "";
}, Ji = "O,Moz,ms,Ms,Webkit".split(","), Et = function(e, t, a) {
  var i = t || dt, n = i.style, o = 5;
  if (e in n && !a)
    return e;
  for (e = e.charAt(0).toUpperCase() + e.substr(1); o-- && !(Ji[o] + e in n); )
    ;
  return o < 0 ? null : (o === 3 ? "ms" : o >= 0 ? Ji[o] : "") + e;
}, gi = function() {
  ps() && window.document && (ji = window, Qe = ji.document, xt = Qe.documentElement, dt = pi("div") || {
    style: {}
  }, pi("div"), W = Et(W), le = W + "Origin", dt.style.cssText = "border-width:0;line-height:0;position:absolute;padding:0", Ir = !!Et("perspective"), Di = ce.core.reverting, Ii = 1);
}, Zi = function(e) {
  var t = e.ownerSVGElement, a = pi("svg", t && t.getAttribute("xmlns") || "http://www.w3.org/2000/svg"), i = e.cloneNode(!0), n;
  i.style.display = "block", a.appendChild(i), xt.appendChild(a);
  try {
    n = i.getBBox();
  } catch {
  }
  return a.removeChild(i), xt.removeChild(a), n;
}, $i = function(e, t) {
  for (var a = t.length; a--; )
  ...
  if (t) {
    var a = e.style, i;
    t in Ve && t !== le && (t = W), a.removeProperty ? (i = t.substr(0, 2), (i === "ms" || t.substr(0, 6) === "webkit") && (t = "-" + t), a.removeProperty(i === "--" ? t : t.replace(Li, "-$1").toLowerCase())) : a.removeAttribute(t);
  }
}, je = function(e, t, a, i, n, o) {
  var s = new se(e._pt, t, a, 0, 1, o ? Mr : Er);
  ...
  grid: 1,
  flex: 1
}, et = function r(e, t, a, i) {
  var n = parseFloat(a) || 0, o = (a + "").trim().substr((n + "").length) || "px", s = dt.style, l = gs.test(t), c = e.tagName.toLowerCase() === "svg", d = (c ? "client" : "offset") + (l ? "Width" : "Height"), u = 100, g = i === "px", p = i === "%", f, h, w, b;
  if (i === o || !n || en[i] || en[o])
    return n;
  if (o !== "px" && !g && (n = r(e, t, a, "px")), b = e.getCTM && Lr(e), (p || o === "%") && (Ve[t] || ~t.indexOf("adius")))
    return f = b ? e.getBBox()[l ? "width" : "height"] : e[d], Q(p ? n / f * u : n / 100 * f);
  if (s[l ? "width" : "height"] = u + (g ? o : i), h = i !== "rem" && ~t.indexOf("adius") || i === "em" && e.appendChild && !c ? e : e.parentNode, b && (h = (e.ownerSVGElement || {}).parentNode), (!h || h === Qe || !h.appendChild) && (h = Qe.body), w = h._gsap, w && p && w.width && l && w.time === ue.time && !w.uncache)
    return Q(n / w.width * u);
  if (p && (t === "height" || t === "width")) {
    var y = e.style[t];
    e.style[t] = u + i, f = e[d], y ? e.style[t] = y : $e(e, t);
  } else
    (p || o === "%") && !Es[pe(h, "display")] && (s.position = pe(e, "position")), h === e && (s.position = "static"), h.appendChild(dt), f = dt[d], h.removeChild(dt), s.position = "absolute";
  return l && p && (w = ut(h), w.time = ue.time, w.width = h[d]), Q(g ? f * n / u : f && n ? u / f * n : 0);
}, Fe = function(e, t, a, i) {
  var n;
  return Ii || gi(), t in Re && t !== "transform" && (t = Re[t], ~t.indexOf(",") && (t = t.split(",")[0])), Ve[t] && t !== "transform" ? (n = Xt(e, i), n = t !== "transformOrigin" ? n[t] : n.svg ? n.origin : ya(pe(e, le)) + " " + n.zOrigin + "px") : (n = e.style[t], (!n || n === "auto" || i || ~(n + "").indexOf("calc(")) && (n = ba[t] && ba[t](e, t, a) || pe(e, t) || Zn(e, t) || (t === "opacity" ? 1 : 0))), a && !~(n + "").trim().indexOf(" ") ? et(e, t, n, a) + a : n;
}, Ms = function(e, t, a, i) {
  if (!a || a === "none") {
    var n = Et(t, e, 1), o = n && pe(e, n, 1);
    o && o !== a ? (t = n, a = o) : t === "borderColor" && (a = pe(e, "borderTopColor"));
  }
  var s = new se(this._pt, e.style, t, 0, 1, Sr), l = 0, c = 0, d, u, g, p, f, h, w, b, y, _, A, x;
  if (s.b = a, s.e = i, a += "", i += "", i.substring(0, 6) === "var(--" && (i = pe(e, i.substring(4, i.indexOf(")")))), i === "auto" && (h = e.style[t], e.style[t] = i, i = pe(e, t) || i, h ? e.style[t] = h : $e(e, t)), d = [a, i], wr(d), a = d[0], i = d[1], g = a.match(wt) || [], x = i.match(wt) || [], x.length) {
    for (; u = wt.exec(i); )
      w = u[0], y = i.substring(l, u.index), f ? f = (f + 1) % 5 : (y.substr(-5) === "rgba(" || y.substr(-5) === "hsla(") && (f = 1), w !== (h = g[c++] || "") && (p = parseFloat(h) || 0, A = h.substr((p + "").length), w.charAt(1) === "=" && (w = yt(p, w) + A), b = parseFloat(w), _ = w.substr((b + "").length), l = wt.lastIndex - _.length, _ || (_ = _ || ge.units[t] || A, l === i.length && (i += _, s.e += _)), A !== _ && (p = et(e, t, h, _) || 0), s._pt = {
        _next: s._pt,
        p: y || c === 1 ? y : ",",
        //note: SVG spec allows omission of comma/space when a negative sign is wedged between two numbers, like 2.5-5.3 instead of 2.5,-5.3 but when tweening, the negative value may switch to positive, so we insert the comma just in case.
        s: p,
    ...
    s.r = t === "display" && i === "none" ? Mr : Er;
  return Qn.test(i) && (s.e = 0), this._pt = s, s;
}, tn = {
  top: "0%",
  bottom: "100%",
  left: "0%",
  ...
  if (t.tween && t.tween._time === t.tween._dur) {
    ...
    if (n === "all" || n === !0)
      ...
      for (n = n.split(","), c = n.length; --c > -1; )
        s = n[c], Ve[s] && (l = 1, s = s === "transformOrigin" ? le : W), $e(a, s);
    l && ($e(a, W), o && (o.svg && a.removeAttribute("transform"), i.scale = i.rotate = i.translate = "none", Xt(a, 1), o.uncache = 1, Pr(i)));
  }
}, ba = {
  clearProps: function(e, t, a, i, n) {
    if (n.data !== "isFromStart") {
      var o = e._pt = new se(e._pt, t, a, 0, 0, Rs);
  ...
  */
}, Kt = [1, 0, 0, 1, 0, 0], Nr = {}, Or = function(e) {
  return e === "matrix(1, 0, 0, 1, 0, 0)" || e === "none" || !e;
}, an = function(e) {
  var t = pe(e, W);
  return Or(t) ? Kt : t.substr(7).match(Yn).map(Q);
}, Ni = function(e, t) {
  var a = e._gsap || ut(e), i = e.style, n = an(e), o, s, l, c;
  return a.svg && e.getAttribute("transform") ? (l = e.transform.baseVal.consolidate().matrix, n = [l.a, l.b, l.c, l.d, l.e, l.f], n.join(",") === "1,0,0,1,0,0" ? Kt : n) : (n === Kt && !e.offsetParent && e !== xt && !a.svg && (l = i.display, i.display = "block", o = e.parentNode, (!o || !e.offsetParent && !e.getBoundingClientRect().width) && (c = 1, s = e.nextElementSibling, xt.appendChild(e)), n = an(e), l ? i.display = l : $e(e, "display"), c && (s ? o.insertBefore(e, s) : o ? o.appendChild(e) : xt.removeChild(e))), t && n.length > 6 ? [n[0], n[1], n[4], n[5], n[12], n[13]] : n);
}, mi = function(e, t, a, i, n, o) {
  var s = e._gsap, l = n || Ni(e, !0), c = s.xOrigin || 0, d = s.yOrigin || 0, u = s.xOffset || 0, g = s.yOffset || 0, p = l[0], f = l[1], h = l[2], w = l[3], b = l[4], y = l[5], _ = t.split(" "), A = parseFloat(_[0]) || 0, x = parseFloat(_[1]) || 0, T, v, C, S;
  a ? l !== Kt && (v = p * w - f * h) && (C = A * (w / v) + x * (-h / v) + (h * y - w * b) / v, S = A * (-f / v) + x * (p / v) - (p * y - f * b) / v, A = C, x = S) : (T = Dr(e), A = T.x + (~_[0].indexOf("%") ? A / 100 * T.width : A), x = T.y + (~(_[1] || _[0]).indexOf("%") ? x / 100 * T.height : x)), i || i !== !1 && s.smooth ? (b = A - c, y = x - d, s.xOffset = u + (b * p + y * h) - b, s.yOffset = g + (b * f + y * w) - y) : s.xOffset = s.yOffset = 0, s.xOrigin = A, s.yOrigin = x, s.smooth = !!i, s.origin = t, s.originIsAbsolute = !!a, e.style[le] = "0px 0px", o && (je(o, s, "xOrigin", c, A), je(o, s, "yOrigin", d, x), je(o, s, "xOffset", u, s.xOffset), je(o, s, "yOffset", g, s.yOffset)), e.setAttribute("data-svg-origin", A + " " + x);
}, Xt = function(e, t) {
  var a = e._gsap || new yr(e);
  if ("x" in a && !t && !a.uncache)
    return a;
  var i = e.style, n = a.scaleX < 0, o = "px", s = "deg", l = getComputedStyle(e), c = pe(e, le) || "0", d, u, g, p, f, h, w, b, y, _, A, x, T, v, C, S, E, z, O, D, I, N, P, U, J, De, ve, Mt, at, Fi, Le, it;
  return d = u = g = h = w = b = y = _ = A = 0, p = f = 1, a.svg = !!(e.getCTM && Lr(e)), l.translate && ((l.translate !== "none" || l.scale !== "none" || l.rotate !== "none") && (i[W] = (l.translate !== "none" ? "translate3d(" + (l.translate + " 0 0").split(" ").slice(0, 3).join(", ") + ") " : "") + (l.rotate !== "none" ? "rotate(" + l.rotate + ") " : "") + (l.scale !== "none" ? "scale(" + l.scale.split(" ").join(",") + ") " : "") + (l[W] !== "none" ? l[W] : "")), i.scale = i.rotate = i.translate = "none"), v = Ni(e, a.svg), a.svg && (a.uncache ? (J = e.getBBox(), c = a.xOrigin - J.x + "px " + (a.yOrigin - J.y) + "px", U = "") : U = !t && e.getAttribute("data-svg-origin"), mi(e, U || c, !!U || a.originIsAbsolute, a.smooth !== !1, v)), x = a.xOrigin || 0, T = a.yOrigin || 0, v !== Kt && (z = v[0], O = v[1], D = v[2], I = v[3], d = N = v[4], u = P = v[5], v.length === 6 ? (p = Math.sqrt(z * z + O * O), f = Math.sqrt(I * I + D * D), h = z || O ? ft(O, z) * lt : 0, y = D || I ? ft(D, I) * lt + h : 0, y && (f *= Math.abs(Math.cos(y * _t))), a.svg && (d -= x - (x * z + T * D), u -= T - (x * O + T * I))) : (it = v[6], Fi = v[7], ve = v[8], Mt = v[9], at = v[10], Le = v[11], d = v[12], u = v[13], g = v[14], C = ft(it, at), w = C * lt, C && (S = Math.cos(-C), E = Math.sin(-C), U = N * S + ve * E, J = P * S + Mt * E, De = it * S + at * E, ve = N * -E + ve * S, Mt = P * -E + Mt * S, at = it * -E + at * S, Le = Fi * -E + Le * S, N = U, P = J, it = De), C = ft(-D, at), b = C * lt, C && (S = Math.cos(-C), E = Math.sin(-C), U = z * S - ve * E, J = O * S - Mt * E, De = D * S - at * E, Le = I * E + Le * S, z = U, O = J, D = De), C = ft(O, z), h = C * lt, C && (S = Math.cos(C), E = Math.sin(C), U = z * S + O * E, J = N * S + P * E, O = O * S - z * E, P = P * S - N * E, z = U, N = J), w && Math.abs(w) + Math.abs(h) > 359.9 && (w = h = 0, b = 180 - b), p = Q(Math.sqrt(z * z + O * O + D * D)), f = Q(Math.sqrt(P * P + it * it)), C = ft(N, P), y = Math.abs(C) > 2e-4 ? C * lt : 0, A = Le ? 1 / (Le < 0 ? -Le : Le) : 0), a.svg && (U = e.getAttribute("transform"), a.forceCSS = e.setAttribute("transform", "") || !Or(pe(e, W)), U && e.setAttribute("transform", U))), Math.abs(y) > 90 && Math.abs(y) < 270 && (n ? (p *= -1, y += h <= 0 ? 180 : -180, h += h <= 0 ? 180 : -180) : (f *= -1, y += y <= 0 ? 180 : -180)), t = t || a.uncache, a.x = d - ((a.xPercent = d && (!t && a.xPercent || (Math.round(e.offsetWidth / 2) === Math.round(-d) ? -50 : 0))) ? e.offsetWidth * a.xPercent / 100 : 0) + o, a.y = u - ((a.yPercent = u && (!t && a.yPercent || (Math.round(e.offsetHeight / 2) === Math.round(-u) ? -50 : 0))) ? e.offsetHeight * a.yPercent / 100 : 0) + o, a.z = g + o, a.scaleX = Q(p), a.scaleY = Q(f), a.rotation = Q(h) + s, a.rotationX = Q(w) + s, a.rotationY = Q(b) + s, a.skewX = y + s, a.skewY = _ + s, a.transformPerspective = A + o, (a.zOrigin = parseFloat(c.split(" ")[2]) || !t && a.zOrigin || 0) && (i[le] = ya(c)), a.xOffset = a.yOffset = 0, a.force3D = ge.force3D, a.renderTransform = a.svg ? Ds : Ir ? Br : Is, a.uncache = 0, a;
}, ya = function(e) {
  return (e = e.split(" "))[0] + " " + e[1];
}, qa = function(e, t, a) {
  var i = $(t);
  return Q(parseFloat(t) + parseFloat(et(e, "x", a + "px", i))) + i;
}, Is = function(e, t) {
  t.z = "0px", t.rotationY = t.rotationX = "0deg", t.force3D = 0, Br(e, t);
}, nt = "0deg", Pt = "0px", rt = ") ", Br = function(e, t) {
  var a = t || this, i = a.xPercent, n = a.yPercent, o = a.x, s = a.y, l = a.z, c = a.rotation, d = a.rotationY, u = a.rotationX, g = a.skewX, p = a.skewY, f = a.scaleX, h = a.scaleY, w = a.transformPerspective, b = a.force3D, y = a.target, _ = a.zOrigin, A = "", x = b === "auto" && e && e !== 1 || b === !0;
  if (_ && (u !== nt || d !== nt)) {
    var T = parseFloat(d) * _t, v = Math.sin(T), C = Math.cos(T), S;
    T = parseFloat(u) * _t, S = Math.cos(T), o = qa(y, o, v * S * -_), s = qa(y, s, -Math.sin(T) * -_), l = qa(y, l, C * S * -_ + _);
  }
  w !== Pt && (A += "perspective(" + w + rt), (i || n) && (A += "translate(" + i + "%, " + n + "%) "), (x || o !== Pt || s !== Pt || l !== Pt) && (A += l !== Pt || x ? "translate3d(" + o + ", " + s + ", " + l + ") " : "translate(" + o + ", " + s + rt), c !== nt && (A += "rotate(" + c + rt), d !== nt && (A += "rotateY(" + d + rt), u !== nt && (A += "rotateX(" + u + rt), (g !== nt || p !== nt) && (A += "skew(" + g + ", " + p + rt), (f !== 1 || h !== 1) && (A += "scale(" + f + ", " + h + rt), y.style[W] = A || "translate(0, 0)";
}, Ds = function(e, t) {
  var a = t || this, i = a.xPercent, n = a.yPercent, o = a.x, s = a.y, l = a.rotation, c = a.skewX, d = a.skewY, u = a.scaleX, g = a.scaleY, p = a.target, f = a.xOrigin, h = a.yOrigin, w = a.xOffset, b = a.yOffset, y = a.forceCSS, _ = parseFloat(o), A = parseFloat(s), x, T, v, C, S;
  l = parseFloat(l), c = parseFloat(c), d = parseFloat(d), d && (d = parseFloat(d), c += d, l += d), l || c ? (l *= _t, c *= _t, x = Math.cos(l) * u, T = Math.sin(l) * u, v = Math.sin(l - c) * -g, C = Math.cos(l - c) * g, c && (d *= _t, S = Math.tan(c - d), S = Math.sqrt(1 + S * S), v *= S, C *= S, d && (S = Math.tan(d), S = Math.sqrt(1 + S * S), x *= S, T *= S)), x = Q(x), T = Q(T), v = Q(v), C = Q(C)) : (x = u, C = g, T = v = 0), (_ && !~(o + "").indexOf("px") || A && !~(s + "").indexOf("px")) && (_ = et(p, "x", o, "px"), A = et(p, "y", s, "px")), (f || h || w || b) && (_ = Q(_ + f - (f * x + h * v) + w), A = Q(A + h - (f * T + h * C) + b)), (i || n) && (S = p.getBBox(), _ = Q(_ + i / 100 * S.width), A = Q(A + n / 100 * S.height)), S = "matrix(" + x + "," + T + "," + v + "," + C + "," + _ + "," + A + ")", p.setAttribute("transform", S), y && (p.style[W] = S);
}, Ls = function(e, t, a, i, n) {
  var o = 360, s = K(n), l = parseFloat(n) * (s && ~n.indexOf("rad") ? lt : 1), c = l - i, d = i + c + "deg", u, g;
  return s && (u = n.split("_")[1], u === "short" && (c %= o, c !== c % (o / 2) && (c += c < 0 ? o : -o)), u === "cw" && c < 0 ? c = (c + o * Xi) % o - ~~(c / o) * o : u === "ccw" && c > 0 && (c = (c - o * Xi) % o - ~~(c / o) * o)), e._pt = g = new se(e._pt, t, a, i, c, fs), g.e = d, g.u = "deg", e._props.push(a), g;
}, nn = function(e, t) {
  for (var a in t)
    e[a] = t[a];
  return e;
}, Ns = function(e, t, a) {
  var i = nn({}, a._gsap), n = "perspective,force3D,transformOrigin,svgOrigin", o = a.style, s, l, c, d, u, g, p, f;
  i.svg ? (c = a.getAttribute("transform"), a.setAttribute("transform", ""), o[W] = t, s = Xt(a, 1), $e(a, W), a.setAttribute("transform", c)) : (c = getComputedStyle(a)[W], o[W] = t, s = Xt(a, 1), o[W] = c);
  for (l in Ve)
    c = i[l], d = s[l], c !== d && n.indexOf(l) < 0 && (p = $(c), f = $(d), u = p !== f ? et(a, l, c, f) : parseFloat(c), g = parseFloat(d), e._pt = new se(e._pt, s, l, u, g - u, hi), e._pt.u = f || 0, e._props.push(l));
  nn(s, i);
};
...
var qr = {
  ...
  init: function(e, t, a, i, n) {
    var o = this._props, s = e.style, l = a.vars.startAt, c, d, u, g, p, f, h, w, b, y, _, A, x, T, v, C, S;
    Ii || gi(), this.styles = this.styles || Rr(e), C = this.styles.props, this.tween = a;
    for (h in t)
      if (h !== "autoRound" && (d = t[h], !(de[h] && xr(h, t, a, i, e, n)))) {
        if (p = typeof d, f = ba[h], p === "function" && (d = d.call(a, i, e, n), p = typeof d), p === "string" && ~d.indexOf("random(") && (d = Yt(d)), f)
          f(this, e, h, d, a) && (v = 1);
        else if (h.substr(0, 2) === "--")
          c = (getComputedStyle(e).getPropertyValue(h) + "").trim(), d += "", Je.lastIndex = 0, Je.test(c) || (w = $(c), b = $(d), b ? w !== b && (c = et(e, h, c, b) + b) : w && (d += w)), this.add(s, "setProperty", c, d, i, n, 0, 0, h), o.push(h), C.push(h, 0, s[h]);
        else if (p !== "undefined") {
          if (l && h in l ? (c = typeof l[h] == "function" ? l[h].call(a, i, e, n) : l[h], K(c) && ~c.indexOf("random(") && (c = Yt(c)), $(c + "") || c === "auto" || (c += ge.units[h] || $(Fe(e, h)) || ""), (c + "").charAt(1) === "=" && (c = Fe(e, h))) : c = Fe(e, h), g = parseFloat(c), y = p === "string" && d.charAt(1) === "=" && d.substr(0, 2), y && (d = d.substr(2)), u = parseFloat(d), h in Re && (h === "autoAlpha" && (g === 1 && Fe(e, "visibility") === "hidden" && u && (g = 0), C.push("visibility", 0, s.visibility), je(this, s, "visibility", g ? "inherit" : "hidden", u ? "inherit" : "hidden", !u)), h !== "scale" && h !== "transform" && (h = Re[h], ~h.indexOf(",") && (h = h.split(",")[0]))), _ = h in Ve, _) {
            ...
            if (A || (x = e._gsap, x.renderTransform && !t.parseTransform || Xt(e, t.parseTransform), T = t.smoothOrigin !== !1 && x.smooth, A = this._pt = new se(this._pt, s, W, 0, 1, x.renderTransform, x, 0, -1), A.dep = 1), h === "scale")
              this._pt = new se(this._pt, x, "scaleY", x.scaleY, (y ? yt(x.scaleY, y + u) : u) - x.scaleY || 0, hi), this._pt.u = 0, o.push("scaleY", h), h += "X";
            else if (h === "transformOrigin") {
              C.push(le, 0, s[le]), d = Ps(d), x.svg ? mi(e, d, 0, T, 0, this) : (b = parseFloat(d.split(" ")[2]) || 0, b !== x.zOrigin && je(this, x, "zOrigin", x.zOrigin, b), je(this, s, h, ya(c), ya(d)));
              continue;
            } else if (h === "svgOrigin") {
              mi(e, d, 1, T, 0, this);
              continue;
            } else if (h in Nr) {
              Ls(this, x, h, g, y ? yt(g, y + d) : d);
              continue;
            } else if (h === "smoothOrigin") {
              je(this, x, "smooth", x.smooth, d);
              continue;
            } else if (h === "force3D") {
              x[h] = d;
              continue;
          ...
          if (_ || (u || u === 0) && (g || g === 0) && !ms.test(d) && h in s)
            w = (c + "").substr((g + "").length), u || (u = 0), b = $(d) || (h in ge.units ? ge.units[h] : w), w !== b && (g = et(e, h, c, b)), this._pt = new se(this._pt, _ ? x : s, h, g, (y ? yt(g, y + u) : u) - g, !_ && (b === "px" || h === "zIndex") && t.autoRound !== !1 ? ys : hi), this._pt.u = b || 0, _ && S !== d ? (this._pt.b = c, this._pt.e = S, this._pt.r = bs) : w !== b && b !== "%" && (this._pt.b = c, this._pt.r = ws);
          else if (h in s)
            Ms.call(this, e, h, c, y ? y + d : d);
          else if (h in e)
          ...
          _ || (h in s ? C.push(h, 0, s[h]) : typeof e[h] == "function" ? C.push(h, 2, e[h]()) : C.push(h, 1, c || e[h])), o.push(h);
        }
      }
    v && Cr(this);
  },
  ...
  getSetter: function(e, t, a) {
    var i = Re[t];
    return i && i.indexOf(",") < 0 && (t = i), t in Ve && t !== le && (e._gsap.x || Fe(e, "x")) ? a && Ki === a ? t === "scale" ? vs : As : (Ki = a || {}) && (t === "scale" ? ks : Ss) : e.style && !yi(e.style[t]) ? xs : ~t.indexOf("-") ? _s : Pi(e, t);
  },
  core: {
    _removeProperty: $e,
    _getMatrix: Ni
...
ce.core.getStyleSaver = Rr;
(function(r, e, t, a) {
  var i = oe(r + "," + e + "," + t, function(n) {
    Ve[n] = 1;
  });
  oe(e, function(n) {
    ge.units[n] = "deg", Nr[n] = 1;
...
ce.registerPlugin(qr);
var m = ce.registerPlugin(qr) || ce;
m.core.Tween;
const qe = "Thinking", Gt = "Show more", ha = "Show less";
function Oi(r, e) {
...
const qs = "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABAAAAAQCAYAAAAf8/9hAAAAeUlEQVQ4jd3TsRFAYAyG4Td+1rGFRm8CnbOO0gL0GgOomcEWjmg07jj86aRN8tyXIsJYKN9rAXoceeCxDBABKavUvsBRmhgBInk1NhYNkF21rAkImcpLGXQmroZnQLfmptcCj4D5hB8A4vkLpwSLEZDeBjjNgc43yQ5kyxoFPrhHWwAAAABJRU5ErkJggg==", Fs = "data:image/png;base64,", Fa = "data:image/png;base64,", zs = "data:image/png;base64,", rn = "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABAAAAAQCAIAAACQkWg2AAAAFklEQVR4nGNQOhpHEmIY1TCqYfhqAACML0UQHuDXpwAAAABJRU5ErkJggg==", Us = "data:image/png;base64,", Gs = "data:image/png;base64,", on = "data:image/png;base64,", Vs = "data:image/png;base64,", Hs = "data:image/png;base64,", Ws = "data:image/png;base64,", Ys = "data:image/png;base64,", Qs = "data:image/png;base64,", js = "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABAAAAAQCAIAAACQkWg2AAAAFklEQVR4nGPojvlGEmIY1TCqYfhqAAAq1t0QMabSpAAAAABJRU5ErkJggg==", Ks = "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABAAAAAQCAIAAACQkWg2AAAAFklEQVR4nGOwbvpGEmIY1TCqYfhqAACHB7MQtEO1oAAAAABJRU5ErkJggg==", Xs = "data:image/png;base64,", Js = "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABAAAAAQCAIAAACQkWg2AAAAFklEQVR4nGP4Oo+bJMQwqmFUw/DVAAACRZ4QdD+g5wAAAABJRU5ErkJggg==", Zs = "data:image/png;base64,", $s = "data:image/png;base64,", el = "data:image/png;base64,", tl = "data:image/png;base64,", al = "data:image/png;base64,", il = "data:image/png;base64,", nl = "data:image/png;base64,", sn = "data:image/png;base64,", rl = "data:image/png;base64,", ol = "data:image/png;base64,", ln = "data:image/png;base64,", sl = "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABAAAAAQCAMAAAAoLQ9TAAAAKlBMVEUAAAD///8nJye3t7cyMjKHh4f8/Pz39/ecnJwaGhoSEhI5OTnW1tbT09NHEhmuAAAAOklEQVQYlWNgoB5gZUUTYGNH5XMwMnIg8zkZgYALSYAZJMCM4HMzggE3XIAHIsALF2BhAgMWSt0OAwBMcQCayCv/8QAAAABJRU5ErkJggg==", ll = "data:image/png;base64,", cl = "data:image/png;base64,", dl = {
  adyen: qs,
  airtable: Fs,
  apollo: Fa,
  "apollo io": Fa,
...
function hl(r) {
  const e = Fr(r).replace(/[^a-z0-9]+/g, "-").replace(/^-|-$/g, "");
  return e ? `${L}?u=${encodeURIComponent(e)}` : "";
}
function Ta(r, e) {
  const t = Fr(r), a = e?.trim() || void 0;
  return ul[t] ?? a ?? hl(r);
}
const zr = `
...
const pl = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="52 42 88 66">
<path fill="#4285f4" d="M58 108h14V74L52 59v43c0 3.32 2.69 6 6 6"/>
<path fill="#34a853" d="M120 108h14c3.32 0 6-2.69 6-6V59l-20 15"/>
<path fill="#fbbc04" d="M120 48v26l20-15v-8c0-7.42-8.47-11.65-14.4-7.2"/>
<path fill="#ea4335" d="M72 74V48l24 18 24-18v26L96 92"/>
<path fill="#c5221f" d="M52 51v8l20 15V48l-5.6-4.2c-5.94-4.45-14.4-.22-14.4 7.2"/>
</svg>`, gl = `<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" viewBox="60 90.4 570.02 539.67">
<defs>
...
const ml = [
...
], fl = 1.28, k = (r) => Number((r * fl).toFixed(3)), wl = [2, 3, 2], ae = {
  pressDuration: k(0.09),
  releaseDuration: k(0.2),
  loadingHoldDuration: k(0.78),
  successHoldDuration: k(0.12),
  learningRevealDuration: k(0.34),
  detailSwapDuration: 0.16,
  readyPopUpDuration: 0.12,
  readyPopSettleDuration: 0.22,
  settleHold: k(0.24)
}, dn = "Learning your style", bl = "Voice calibrated", un = "73 tone & tactic rules defined", za = [
  ...
  0,
  4
], _l = /* @__PURE__ */ new Set([5, 8, 10, 16]), Al = [
  ...
  templateHold: k(0.54),
  progressDuration: k(3.9),
  finalHold: k(0.34)
}, Ne = {
  exitDuration: k(0.07),
  enterDuration: k(0.17),
  railCenterDuration: k(0.26),
  exitY: -2,
  enterY: 4,
  stagger: 6e-3,
  exitEase: "power2.in",
  ...
  showDuration: k(0.42),
  hideDuration: k(0.32),
  contentShowDelay: k(0.1),
  contentHideDuration: k(0.1),
  showEase: "expo.out",
  hideEase: "power3.in",
  contentEase: "power2.out",
  threadGap: 44
}, Cl = "left,right,bottom,width,height,minHeight,paddingTop,paddingRight,paddingBottom,paddingLeft,borderWidth,gap", Va = {
  paddingTop: "",
  paddingRight: "",
  paddingBottom: "",
  paddingLeft: "",
  ...
  contentWidth: 1881,
  height: 1280
}, Ml = 96, wn = ".wa-cursor-file, .wa-file-landing-clone, .wa-file-landing-label, .wa-csv-drop, .wa-signup-logo-transfer", bn = "[data-marketing-data-sources-grid]", yn = "[data-data-table]", It = "[data-table-action]", xn = "[data-table-page-button]", Pl = "[data-table-page-range]", Rl = "https://cdn.jsdelivr.net/npm/simple-icons@latest/icons", Il = "https://www.google.com/s2/favicons", Dl = {
  adyen: "adyen",
  airtable: "airtable",
  brex: "brex",
  "dbt labs": "dbt",
  ...
  rowStartHold: k(0.36),
  serviceRevealDuration: k(0.32),
  serviceLoadDuration: k(1.36),
  serviceLoadVariance: k(0.28),
  serviceSettleDuration: k(0.28),
  rowCompleteHold: k(0.32),
  rowOffsets: [0, k(0.16), k(0.28)]
}, Te = {
  tableRow: {
...
class Nl {
  ...
  handleDataTableControlClick = (e) => {
    ...
    if (!t) return;
    const i = t.closest(yn)?.dataset.dataTable, n = Number(t.dataset.tablePageButton);
  ...
  animateStorySwitchExit() {
    ...
    const a = this.getThreadBottomScrollTarget(), i = Math.min(a, this.thread.scrollTop + ot.scrollDistance);
    return m.killTweensOf(e), i > this.thread.scrollTop + 0.5 && t.to(
      this.thread,
      {
        scrollTop: i,
        duration: ot.scrollDuration,
        ease: "power2.inOut",
        overwrite: "auto"
      },
      0
  ...
  showComposer() {
    ...
    return e.set(this.composer, {
      ...
      paddingBottom: () => Math.max(gn, this.getComposerThreadInsetForFrame(t))
    ...
    return m.timeline().set(this.composer, {
      ...
      onComplete: () => {
        m.set(this.composerContents, { visibility: "hidden" }), m.set(this.composer, {
          visibility: "hidden"
        }), m.set(this.thread, { paddingBottom: gn }), this.pinThreadToBottom();
      }
    }, 0);
  }
  clearComposer() {
  ...
  measureComposerFullFrame() {
    m.set(this.composer, { clearProps: Cl });
  ...
  scrollToLive(e = ie.followDuration) {
  ...
  dataTable(e) {
    const t = this.isCsvDataTable(e) ? this.createCsvDataTable(e) : this.createDataTable(e), a = e.scrollAnchor === "previous-message" ? this.getLastMessageBody() : null;
    return this.revealComponentItems("table", t, ".wa-data-table__row", Te.tableRow, a);
  }
  scrollDataTableToFooter(e, t = ie.revealDuration) {
    return this.scrollChatTarget(() => this.findDataTable(e), {
      align: "bottom",
      duration: t,
      fallback: "bottom"
    });
  ...
  scrollChatElementIntoView(e, t = {}) {
    return this.scrollChatTarget(() => {
      ...
      align: t.align ?? "top",
      duration: t.duration ?? ie.revealDuration,
      offset: t.offset,
      fallback: "current"
    });
  }
  scrollChatTarget(e, t) {
    ...
    return a.call(() => {
      const n = e();
      this.stopScrollMotion(), i = n ? this.getElementScrollTarget(n, t) : this.getMissingScrollTarget(t.fallback ?? "current");
    }), a.to(this.thread, {
      scrollTop: () => i,
      duration: t.duration,
      ease: ie.revealEase,
  ...
  dataTablePage(e, t, a = {}) {
    ...
    return i.to(n, {
      ...
      ease: "power1.out",
      onStart: () => {
        l.table = this.findDataTable(e), s && this.expectedDataTablePages.set(e, t), l.currentRows = l.table ? this.getVisibleDataTableRows(l.table) : [], l.targetRows = l.table ? this.queryElements(l.table, `.wa-data-table__row[data-page="${t}"]`) : [], l.buttons = l.table ? this.queryElements(l.table, xn) : [], l.targetButton = l.buttons.find((c) => Number(c.dataset.tablePageButton) === t), l.range = l.table?.querySelector(Pl) ?? null, l.canSwitch = !!(l.table && l.targetRows.length && l.table.dataset.activePage !== String(t)), l.canSwitch && m.set(l.currentRows, { autoAlpha: 1, y: 0 });
      },
      onUpdate: () => {
  ...
  enrichmentPanel(e) {
    const t = this.createEnrichmentPanel(e), a = this.claimComponentMessage("enrichment", t), i = this.queryElements(t, ".wa-waterfall-row"), n = this.queryElements(t, ".wa-waterfall-chip"), o = this.queryElements(t, ".wa-waterfall-service-step"), s = this.revealPreparedItems(a, i, Te.waterfallRow), l = t.querySelector(".wa-thinking__glyph");
    return m.set(o, { autoAlpha: 0, y: 3, scale: 0.98 }), m.set(n, { scale: 1 }), s.call(() => this.setLocalLogoMode(l, "thinking"), void 0, 0), s.add(this.animateEnrichmentWaterfall(i), `+=${Ce.rowStartHold}`), s.call(() => this.setLocalLogoMode(l, "done")), s;
  }
  strategyPlans(e) {
    const t = e.map((g) => this.createStrategyPlan(g)), a = document.createElement("div"), i = t.flatMap((g) => this.queryElements(g, ".wa-strategy-plan__bullets li")), n = this.getLastMessageBody(), o = Te.strategyCard, s = "strategyCardsIn", l = o.to.stagger, c = [...t, ...i];
    a.className = "wa-result-grid has-strategy-plans", a.dataset.strategyPlans = e.map((g) => g.id).join(" "), a.append(...t), t.length && m.set(t, { ...o.from }), m.set(i, { ...fn.from });
    const d = this.claimComponentMessage("strategy", a), u = m.timeline().add(this.revealMessage(d, n, mn)).addLabel(s, Tl).call(() => this.setMotionHints(c), void 0, s).to(t, { ...o.to }, s);
    return t.forEach((g, p) => {
      const f = this.queryElements(g, ".wa-strategy-plan__bullets li");
      f.length && u.to(f, { ...fn.to }, `${s}+=${p * l}`);
    }), u.call(() => this.clearMotionHints(c)).call(
      () => this.animateMessageScrollIntoView(d, ie.followDuration, n, mn),
      void 0,
      "+=0.02"
    );
  }
  ...
  dataSourcesGrid(e) {
    ...
    return this.revealComponentItems("sources", t, ".wa-data-source-card", Te.smallCard);
  }
  ...
  proximityLeadList(e) {
    ...
    return this.revealComponentItems("table", t, ".wa-data-table__row", Te.tableRow);
  }
  mailboxConnection(e) {
  ...
  connectMailbox(e) {
    ...
    return p.call(() => {
      ...
      i.dataset.mailboxLearningState = "ready", l.textContent = bl, d.textContent = i.dataset.mailboxLearningReadyDetail ?? un;
    }).fromTo(
      l,
      { autoAlpha: 0, y: 4 },
      {
  ...
  sequenceBuildThinking(e) {
    ...
    return this.addThinkingStepReveal(d, t, { position: "<" }), d.to({}, { duration: Ga.templateHold }).add(this.foldThinkingStep(t)).call(() => {
      a.forEach((u) => {
    ...
    }, "+=0.14").to({}, { duration: Ga.finalHold }), a.forEach((u, g) => {
  ...
  sequencePerson(e, t) {
    const a = this.findSequenceEngagement(e), i = m.timeline({ defaults: { overwrite: "auto" } });
    if (!a) return i;
    ...
    this.setSequencePersonRailState(a, t, !0);
    const c = this.getSequenceTransitionTargets(o);
    return m.killTweensOf(c), i.to(c, {
      autoAlpha: 0,
      y: Ne.exitY,
      duration: Ne.exitDuration,
      ease: Ne.exitEase,
      stagger: Ne.stagger,
      force3D: !0
    }).call(() => {
      this.applySequenceTemplateToDisplayCard(a, o, s, t), m.set(c, {
        autoAlpha: 0,
        y: Ne.enterY,
        force3D: !0
      });
  ...
  uploadedFilesMessage(e) {
    ...
    return this.revealUserComponentItems("file", t, ".wa-uploaded-file", {
      ...Te.compactRow,
      from: { ...Te.compactRow.from, scale: 0.99 },
      to: { ...Te.compactRow.to, scale: 1 },
      position: "-=0.24"
    });
  }
  ...
  createFileLandingClones(e, t) {
    ...
    return t.map((n, o) => {
      const l = a[Math.min(o, a.length - 1)].getBoundingClientRect(), c = n.getBoundingClientRect(), d = this.getElementLocalRect(l, i), u = this.getElementLocalRect(c, i), g = n.cloneNode(!0), p = this.getCursorFileCardRotation(o, a.length), f = window.getComputedStyle(n), h = d.left + (l.width - c.width) * 0.5, w = d.top + (l.height - c.height) * 0.5;
  ...
  renderFileLandingLabel(e, t) {
    if (!e) return;
    const a = fi(t / 0.16), i = fi((1 - t) / 0.16);
  ...
  getFileLandingShadow(e) {
    const t = 1 - e;
    return `0 ${this.interpolate(Se.shadowY, 0, e).toFixed(2)}px ${this.interpolate(
      Se.shadowBlur,
      0,
      e
    ).toFixed(2)}px rgba(23, 23, 20, ${(Se.shadowAlpha * t).toFixed(3)})`;
  }
  ...
  revealPreparedItems(e, t, a, i = null, n = 0) {
    ...
    return o.call(
      () => this.animateMessageScrollIntoView(e, ie.followDuration, i, n),
      void 0,
      ie.componentFollowDelay
    ), o.call(
      () => this.animateMessageScrollIntoView(e, ie.followDuration, i, n),
      void 0,
      "+=0.02"
  ...
  revealMessage(e, t = null, a = 0) {
    let i = 0;
    const n = e.classList.contains("wa-message--component") ? ie.componentRevealDelay : 0.04;
    return m.timeline().call(() => {
  ...
  followCursorWithFile(e, t, a) {
    const i = e.offsetWidth || 154, n = e.offsetHeight || 42, o = m.quickSetter(e, "x", "px"), s = m.quickSetter(e, "y", "px"), l = { x: -120, y: -120 }, c = () => {
      ...
      t.isPayloadDragging() && t.el.dataset.cursorMode !== "drag" && t.setMode("drag"), u !== l.x && (l.x = u, o(u)), g !== l.y && (l.y = g, s(g));
    };
    return c(), m.ticker.add(c), () => m.ticker.remove(c);
  }
  getCursorFileEntryOffset(e, t) {
    const a = e.offsetWidth || 154, i = t.readPosition(), n = this.root.getBoundingClientRect(), o = window.innerWidth - n.left, s = i.x - a * 0.5, l = o + Ya.offscreenMargin;
    return {
      x: Math.max(0, l - s),
      y: 0
    };
  ...
  streamThinkingHeader(e) {
    return this.streamThinkingChild(e, ".wa-thinking__title", Sl);
  }
  streamThinkingStepLabel(e) {
    return this.streamThinkingChild(e, ".wa-research-step__label", kl);
  }
  ...
  streamText(e, t, a) {
    ...
    return m.timeline().call(() => {
      ...
      e.textContent = t, delete e.dataset.streaming, this.cancelScheduledScroll(), this.animateMessageScrollIntoView(a.targetForScroll, ie.followDuration * 0.7);
    });
  }
  foldThinkingStep(e) {
  ...
  revealThinkingHeaderFromSignupLogo(e, t) {
    ...
    }).add(this.streamThinkingHeader(e.header), k(Math.min(t, 0.16))).to(i, {
      value: 1,
  ...
  renderSignupLogoTransfer(e, t) {
    if (!e) return;
    const a = e.target.getBoundingClientRect(), i = this.getElementLocalRect(a, this.chatBody), n = Vr(t);
  ...
  addThinkingElapsedTimer(e, t, a) {
    Bs(e, t, a, { reducedMotion: this.prefersReducedMotion });
  }
  createThinkingLogo(e = "wa-thinking__glyph") {
    const t = document.createElement("span");
    return t.className = e, t.dataset.logoMode = "thinking", t.setAttribute("aria-hidden", "true"), t.append(cn("wa-thinking__logo-mark")), t;
  }
  ...
  normalizeThinkingItem(e, t) {
    ...
    return {
      ...
      disclosure: typeof e == "string" ? t === 0 ? Gt : ha : e.disclosure || (t === 0 ? Gt : ha)
    };
  }
  ...
  createCsvDataTable(e) {
    const t = document.createElement("article"), a = this.getDataTablePages(e), i = e.pagination?.activePage ?? a[0]?.page ?? 1;
    t.className = "wa-csv-table", t.dataset.dataTable = e.id, t.dataset.tableVariant = "csv", t.dataset.columnCount = String(e.columns.length), t.dataset.activePage = String(i), this.expectedDataTablePages.set(e.id, i), t.style.setProperty(
      "--wa-csv-table-columns",
      e.columns.map((o) => this.getCsvTableColumnWidth(o)).join(" ")
    );
    const n = document.createElement("div");
    n.className = "wa-csv-table__grid", n.append(this.createCsvDataTableRow("header", e.columns, {}, e.id));
    for (const o of a)
      for (const s of o.rows) {
        const l = this.createCsvDataTableRow(s.id, e.columns, s.values, e.id, o.page);
        o.page !== i && (l.style.display = "none", m.set(l, { autoAlpha: 0, y: 6 })), n.append(l);
      }
    return t.append(n), e.pagination && t.append(this.createDataTableFooter(e, a, i)), t;
  }
  createCsvDataTableRow(e, t, a, i, n) {
    const o = document.createElement("div"), s = e === "header";
    o.className = "wa-csv-table__row wa-data-table__row", o.dataset.tableRow = e, s && (o.dataset.header = "true"), !s && n !== void 0 && (o.dataset.page = String(n));
    for (const l of t) {
      const c = document.createElement(s ? "strong" : "span");
      c.className = "wa-csv-table__cell", c.dataset.columnKey = l.key;
      const d = document.createElement("span");
      d.className = "wa-csv-table__text", d.textContent = s ? l.label : a[l.key] || "-", c.append(d), !s && !a[l.key] && (c.dataset.empty = "true"), o.append(c);
    }
    if (s) {
      const l = document.createElement("button");
      l.className = "wa-data-table__add wa-csv-table__add", l.type = "button", l.tabIndex = -1, l.setAttribute("aria-label", `Add row to ${i}`), l.append(this.createDataTableAddIcon()), o.append(l);
    }
    return o;
  }
  getCsvTableColumnWidth(e) {
    const t = e.key.toLowerCase(), a = e.label.toLowerCase(), i = `${t} ${a}`;
    return i.includes("email") ? "minmax(250px, 1.35fr)" : i.includes("company") ? "minmax(140px, 0.85fr)" : i.includes("title") ? "minmax(160px, 1fr)" : "minmax(150px, 1fr)";
  }
  isCsvDataTable(e) {
    return e.variant === "csv" || e.id === "raw-webinar-attendees" || e.id === "clean-webinar-attendees" || e.id === "cleaned-webinar-attendees";
  }
  createDataTableRow(e, t, a, i, n) {
    ...
    for (const l of t) {
      ...
      else if (this.isPersonNameColumn(l.key))
  ...
  isPersonNameColumn(e) {
    return e === "name" || e === "contact" || e === "fullName";
  }
  ...
  findDataTablePageButton(e) {
    return e instanceof Element ? e.closest(xn) : null;
  }
  findDataTable(e) {
  ...
  appendWaterfallServiceIcon(e, t) {
    if (t === "on-prem") {
      e.append(cn("wa-waterfall-chip__mark"));
      return;
    }
  ...
  animateEnrichmentWaterfall(e) {
    ...
    return e.forEach((a, i) => {
      const n = this.queryElements(a, ".wa-waterfall-chip"), o = this.queryElements(a, ".wa-waterfall-service-step"), s = this.getAttemptedWaterfallChips(n), l = this.getWaterfallFinalState(a), c = m.timeline(), d = Ce.rowOffsets[i % Ce.rowOffsets.length] ?? 0, u = Ce.serviceLoadDuration + (i % 2 === 0 ? Ce.serviceLoadVariance : -Ce.serviceLoadVariance);
      c.call(() => this.setWaterfallState(a, "loading")).to(o, {
        autoAlpha: 1,
        y: 0,
        scale: 1,
        duration: Ce.serviceRevealDuration,
        ease: "power2.out",
        stagger: 0.035
      }, "<"), s.forEach((g) => {
        ...
        c.call(() => this.setWaterfallState(g, "loading")).to(g, {
          scale: 1.025,
          duration: Ce.serviceSettleDuration,
          ease: "power2.out"
      ...
      }), c.call(() => this.setWaterfallState(a, l)).to({}, { duration: Ce.rowCompleteHold }), t.add(c, d);
    }), t;
  }
  ...
  createMarketingDataSourcesGrid(e) {
    ...
    return t.classList.add("wa-data-source-grid--marketing"), t.dataset.marketingDataSourcesGrid = e.id, a.className = "wa-data-source-grid__scale", i.className = "wa-data-source-grid__groups", El.forEach((s) => {
      const l = document.createElement("div");
  ...
  createMailboxConnection(e) {
    ...
    const s = this.createMailboxProviderButton({
      id: e.id,
      icon: "gmail",
      label: Qa("gmail", e.ctaLabel),
      loadingLabel: ja(e.loadingLabel, "Connecting"),
      connectedLabel: Qa("gmail", e.status, "connected"),
      isPrimary: !0
    }), l = this.createMailboxProviderButton({
      icon: "outlook",
      label: Qa("outlook", e.secondaryCtaLabel)
    });
    o.append(s, l), a.append(i, o);
    const c = document.createElement("div");
    c.className = "wa-mailbox-learning", c.dataset.mailboxLearning = "", c.dataset.mailboxLearningReadyDetail = e.learningReadyDetail ?? un;
    ...
    const g = document.createElement("span");
    g.dataset.mailboxLearningTitleText = "", g.textContent = e.learningTitle ?? dn;
  ...
  createMailboxProviderIcon(e) {
    ...
    return t.className = "wa-mailbox-connection__provider-icon", t.src = yl[e], t.alt = "", t.decoding = "async", t.loading = "eager", t.setAttribute("aria-hidden", "true"), t;
  }
  ...
  createMailboxThumbprintGroup(e, t = !1) {
    ...
    return a.classList.add(e), Al.forEach((i, n) => {
      const o = document.createElementNS("http://www.w3.org/2000/svg", "path");
  ...
  createSequenceEngagement(e) {
    const t = document.createElement("section"), a = Ur(e);
    ...
    if (s) {
      ...
      p.className = "wa-sequence-people-wrap", f.className = "wa-sequence-people", f.dataset.sequencePeopleRail = e.id, f.setAttribute("aria-label", "Sequence people"), p.append(f), e.sequences.forEach((h, w) => {
        ...
        }), y.className = "wa-sequence-person-card__avatar-wrap", _.className = "wa-sequence-person-card__avatar", _.dataset.avatarTone = String(w % 9 + 1), this.setProfileAvatar(_, h.name, h.avatarUrl), y.append(_);
    ...
    e.sequences.forEach((p, f) => {
      ...
      const v = p.steps;
      if (v?.length) {
        const C = document.createElement("div"), S = v[0], E = document.createElement("div"), z = document.createElement("span"), O = document.createElement("strong"), D = document.createElement("p");
        C.className = "wa-sequence-steps", v.forEach((I, N) => {
          const P = document.createElement("button"), U = document.createElement("span"), J = document.createElement("span"), De = document.createElement("strong"), ve = this.getSequenceStepWaitDays(I, N, v.length);
          ...
          }), U.className = "wa-sequence-step__channel", U.textContent = this.formatSequenceChannelLabel(I.channel), J.className = "wa-sequence-step__copy", De.textContent = I.label, J.append(De), P.append(U, J), C.append(P), ve && C.append(this.createSequenceWaitRow(ve, N));
        }), E.className = "wa-sequence-copy-panel", E.dataset.sequenceCopyPanel = "", z.className = "wa-sequence-copy-panel__meta", z.dataset.sequenceCopyMeta = "", z.textContent = S ? `${S.channel} 1` : "Email", O.className = "wa-sequence-copy-panel__subject", O.dataset.sequenceCopySubject = "", O.textContent = p.subject, D.className = "wa-sequence-copy-panel__body", D.dataset.sequenceCopyBody = "", D.textContent = S ? this.getSequenceStepCopy(p, S) : p.personalization, E.append(z, O, D), h.append(C, E);
      } else
        h.append(w, x, T);
      o.append(h);
    });
  ...
  getSequenceStepWaitDays(e, t, a) {
    return t >= a - 1 ? null : e.waitDays ?? wl[t] ?? 1;
  }
  ...
  setSequencePersonRailState(e, t, a = !1) {
    ...
    e.dataset.activeSequenceIndex = String(t), i.forEach((o) => {
      const s = Number(o.dataset.sequencePersonIndex) === t;
      o.dataset.active = String(s), o.setAttribute("aria-pressed", String(s));
  ...
  centerSequencePersonCard(e, t) {
    ...
    m.to(a, {
      scrollLeft: n,
      duration: Ne.railCenterDuration,
      ease: "power2.out",
      overwrite: "auto"
    });
  }
...
`);
  ...
  getStorySwitchExitTargets() {
    return this.compactElements(
      ...
      ...this.queryElements(this.chatBody, bn).filter(
  ...
  getElementBottomScrollTarget(e, t = 0) {
    return Math.max(
      0,
      this.getElementOffsetTopWithinThread(e) + e.offsetHeight + this.getThreadBottomPadding() - this.thread.clientHeight + t
    );
  }
  pinThreadToBottom() {
    this.thread.scrollTop = this.getThreadBottomScrollTarget();
  }
  animateMessageScrollIntoView(e, t = ie.followDuration, a = null, i = 0) {
  ...
  requestMessageScroll(e) {
    ...
    this.scheduledScrollMessage = e, !(t - this.lastStreamScrollAt < Ml) && (this.scheduledScrollFrame || (this.lastStreamScrollAt = t, this.scheduledScrollFrame = window.requestAnimationFrame(() => {
...
function Ol(r, e) {
  const t = xl[r] ?? 0, a = 24 + r * 11 % 8, i = Math.min(100, t + a), n = Vr((e - t) / (i - t));
  if (n <= 0) return 0;
  const o = _l.has(r) ? 20 : 12;
...
function ia(r, e, t) {
  const a = Hr(t.seed), i = Bl(r, e), n = t.speed ?? "normal", o = t.intent ?? "hover";
  ...
  const s = e.x - r.x, l = e.y - r.y, c = s / i, d = l / i, u = -d, g = c, p = a() > 0.5 ? 1 : -1, f = t.curve ?? 1, w = Bt(i * (o === "drag" ? 0.1 : o === "click" ? 0.17 : 0.22) * f, 18, 150) * p * (0.72 + a() * 0.44), b = i / Fl[n] + 0.16, y = Bt(b * zl[o] * Ul, 0.3, 1.66), _ = t.overshoot === !1 || i < 120 ? 0 : typeof t.overshoot == "number" ? t.overshoot : Bt(i * 0.026, 4, 18), A = _ > 0 ? {
    x: e.x + c * _,
    y: e.y + d * _
  } : e, x = {
...
const Ka = [
  ...
  "[data-strategy-plan]",
  ".wa-sequence-step"
].join(", "), Xa = "[data-chat-input][data-visible='true'], [data-signup-field], input, textarea, [contenteditable='true']", Ja = {
  delay: 0.42,
  returnDuration: 0.18,
  segments: [
...
class Hl {
  ...
  pathTweenFromFactory(e, t, a = "power2.inOut") {
    ...
    return m.fromTo(
      ...
      { t: 0 },
      {
        ...
        onUpdate: () => {
          if (!n) return;
          const o = An(n.start, n.c1, n.c2, n.end, i.t);
  ...
  renderMimicRotation(e, t) {
    ...
    if (a * a + i * i < 4) return;
    const n = Math.atan2(i, a) * 180 / Math.PI, o = Wl(n - Gl), s = this.rotationState + Yl(this.rotationState, o) * Vl;
  ...
  getModeForElement(e) {
    return e ? e.closest(Ka) ? "pointer" : e.closest(Xa) ? "text" : "default" : "default";
  }
  getModeForLocalPoint(e, t) {
    return this.refreshModeTargetCache(), this.findLocalHit(this.pointerTargets, e, t, Ka) ? "pointer" : this.findLocalHit(this.textTargets, e, t, Xa) ? "text" : "default";
  }
  ...
  refreshModeTargetCache() {
    this.modeTargetsDirty && (this.pointerTargets = Array.from(this.root.querySelectorAll(Ka)).reverse(), this.textTargets = Array.from(this.root.querySelectorAll(Xa)).reverse(), this.modeTargetsDirty = !1);
  }
  observeModeTargets() {
  ...
  createElement() {
    ...
    const a = document.createElement("div");
    return a.className = "wa-cursor__glyph", a.append(vn()), t.append(a), e.append(t), this.root.append(e), e;
  }
  ensureFloatLayer() {
    const e = this.el.querySelector("[data-cursor-float]");
    if (e) return e;
    const t = this.el.querySelector(".wa-cursor__glyph") ?? document.createElement("div");
    t.classList.contains("wa-cursor__glyph") || (t.className = "wa-cursor__glyph"), t.querySelector(".wa-cursor__mimic-head") || t.append(vn());
    const a = document.createElement("div");
...
function Cn(r, e) {
  r.length && (Tn(r[e]), Tn(r[(e + 1) % r.length]));
}
function Tn(r) {
  if (r?.assetUrls?.length)
    for (const e of r.assetUrls) jl(e);
}
function qt(r) {
  const e = /* @__PURE__ */ new Set(), t = (a) => Ql(e, a.values);
  return r.rows.forEach(t), r.pagination?.pages.forEach((a) => a.rows.forEach(t)), [...e];
}
function Wr(r) {
  return r.sources.map((e) => e.logoSrc).filter(Jt);
}
function Yr(r) {
  return r.leads.map((e) => Ta(e.name, e.avatarUrl)).filter(Jt);
}
function Qr(r) {
  return r.sequences.map((e) => Ta(e.name, e.avatarUrl)).filter(Jt);
}
function Ql(r, e) {
...
}, jr = F("[data-signup-field]", "center", {
  desktop: -74,
  tablet: -66,
  mobile: -48
}), Kr = F("[data-signup-submit]", "center"), Jl = F("[data-send-button]", "center"), Bi = {
  desktop: {
...
}, Zl = 2.8, $l = 42, ec = 2, tc = 3, _a = "[data-chat-shell] [data-chat-thread]", ac = `${_a} [data-message-role="assistant"]:not(.wa-message--component) [data-message-body]`, ic = `${_a} [data-message-role="assistant"].wa-message--thinking .wa-research-step[data-step-state="current"] .wa-research-step__body, ${_a} [data-message-role="assistant"].wa-message--thinking .wa-research-step[data-step-state="complete"] .wa-research-step__label`, wi = 0.24, Xr = 0.3, ze = {
...
function Jr(r) {
  ...
  return [
    ...
    ...$r([
      {
        selector: `[data-mailbox-connection="${ye(r.id)}"]`,
...
function Zr(r) {
  const e = ct(`[data-style-profile="${ye(r)}"]`), t = Aa(r);
  return $r([
    {
...
function nc(r, e, t, a, i) {
  switch (t.kind) {
    ...
    case "transitionSignupToChat":
      ...
      return;
    case "assistant":
      r.add(e.chat.assistantMessage(t.text), t.at), dc(r, e, i, {
        kind: "assistant",
        key: t.text,
        text: t.text,
        selector: ac,
        label: `assistant-${Aa(t.text)}`,
        stepIndex: a
      });
      return;
    case "thinking": {
      const n = rc(t), o = n.items.map((s) => s.label);
      t.statusBefore && r.add(e.chat.setStatus(t.statusBefore), t.at), r.add(e.chat.thinkingState(n, t.hold), t.statusBefore ? void 0 : t.at), cc(r, e, i, t.hold, o.length, o.join("|"), a);
      return;
    }
    case "dataTable":
      Lt(
        ...
        t.at,
        ct(`[data-data-table="${ye(t.config.id)}"]`),
        `table-${t.config.id}`
      );
      return;
    case "enrichmentPanel":
      Lt(
        ...
        t.at,
        ct(`[data-enrichment-panel="${ye(t.config.id)}"]`),
        `enrichment-${t.config.id}`
      );
      return;
    case "strategyPlans":
      {
        const n = ct(`[data-strategy-plans~="${ye(t.plans[0]?.id ?? "strategy")}"]`);
        r.add(e.chat.strategyPlans(t.plans), t.at), r.add(lc(e, n, t.plans), "+=0.06");
      }
      return;
    case "dataSourcesGrid":
      Lt(
        ...
        t.at,
        ct(`[data-data-sources-grid="${ye(t.config.id)}"]`),
        `sources-${t.config.id}`
      );
      return;
    case "marketingDataSourcesGrid":
      Lt(
        ...
        t.at,
        `[data-marketing-data-sources-grid="${ye(t.config.id)}"]`,
        `marketing-sources-${t.config.id}`
      );
      return;
    case "personalizationSwipeGame":
      oc(r, e, t.config, t.at);
      return;
    case "sequenceEngagement":
      Lt(
        ...
        t.at,
        ct(`[data-sequence-engagement="${ye(t.config.id)}"]`),
...
function rc(r) {
  return "thinking" in r && r.thinking ? r.thinking : Array.isArray(r.steps) ? { items: r.steps.map(En) } : { items: [En(r.label ?? "")] };
}
function En(r) {
  return typeof r == "string" ? { label: r } : r;
}
function Lt(r, e, t, a, i, n) {
  r.add(t, a), r.add(sc(e, i, n), "+=0.06");
}
function oc(r, e, t, a) {
  const i = ct(
    `[data-personalization-swipe-game="${ye(t.id)}"]`
  );
  r.add(e.chat.personalizationSwipeGame(t), a), t.signals.forEach((n, o) => {
    const s = `${i} [data-swipe-card="${ye(n.id)}"]`, l = n.decision === "use" ? 1 : -1, c = n.decision === "use" ? "right" : "left", d = F(s, c, {
...
function lc(r, e, t) {
  ...
  return t.forEach((i, n) => {
    const o = `${e} [data-strategy-plan="${ye(i.id)}"]`;
    a.add(
...
function cc(r, e, t, a = M.thinkingShort, i = 1, n = "thinking", o = 0) {
  const s = a * Math.max(1, i), l = i >= 3 && to(e, t, {
    kind: "thinking",
    key: n,
    text: n,
    stepIndex: o,
  ...
  l && r.add(
    e.cursor.scanAcross(ic, {
      label: `thinking-skim-${Aa(n)}`,
      match: "last",
      duration: 0.72
    }),
    "<+=0.58"
...
function to(r, e, t) {
  const a = t.text.trim(), i = t.minChars ?? $l;
  if (a.length < i || e.textSkimCount >= tc) return !1;
  const n = e.textCandidateCount;
  e.textCandidateCount += 1;
  const o = e.textSkimCount === 0, s = t.stepIndex - e.lastTextSkimStep >= ec, l = hc(`${r.story.id}:${t.kind}:${n}:${t.key}`), c = n > 0 && n % 3 === 0, d = o || s && (l >= 0.58 || c);
...
function wc(r) {
  ...
  for (const t of r.steps) {
    ...
    const a = t.component;
    a.kind === "table" && qt(Zt(a, `${r.id}-${t.id}`)).forEach((i) => e.add(i)), a.kind === "dataSources" && Wr(no(a)).forEach((i) => e.add(i)), a.kind === "proximityList" && Yr(lo(a)).forEach((i) => e.add(i)), a.kind === "sequenceEngagement" && Qr(qi(a, `${r.id}-${t.id}`)).forEach((i) => e.add(i));
  }
  return [...e];
}
function bc(r, e) {
  return r === "hit-ground-running" ? jr : r === "data-marketplace" ? xa.dataMarketplace : r === "research-brief" ? xa.researchBrief : e.entry;
}
function yc(r, e) {
  return r === "hit-ground-running" ? Xr : r === "data-marketplace" || r === "research-brief" ? wi : e.entryLeadTime;
}
function xc(r, e, t) {
  if (e.id === "hit-ground-running") return _c(r, e);
  if (e.id === "crm-update") return Ac(r, e);
  if (e.id === "research-brief") return vc(r, e);
  if (e.id === "csv-import-cleanup") return kc(r, e);
  const a = Ec(e);
  return a.length ? Pe(r, [...a, Ke(ze.bottomRight, "+=0.18")]) : t.build(r);
}
function _c(r, e) {
  const t = Ue(e, "status"), a = Ue(e, "user"), i = Ue(e, "thinking"), n = Ue(e, "assistant"), o = $t(e, "strategyCards");
  return Pe(r, [
    ...
    ...o ? [{ kind: "strategyPlans", plans: io(o.component), at: "-=0.08" }] : [],
    Ke(ze.right, "+=0.18")
  ]);
}
function Ac(r, e) {
  const t = $t(e, "mailboxConnection"), a = $t(e, "uploadedFiles"), i = [];
  if (t && so(i, oo(t.component)), a) {
    const n = ro(a.component), o = r.chat.prepareCsvDropArea({
      title: a.component.title,
      detail: n.map((d) => d.name).join(", ")
    }), s = n.length > 1 ? `${n.length} context files` : n[0]?.name ?? a.text, l = r.chat.prepareCursorFile(s, r.cursor, n[0]?.type ?? "DOC", n), c = F("[data-chat-shell]", "center", {
      desktop: { x: 0, y: 74 },
      tablet: { x: 0, y: 64 },
      mobile: { x: 0, y: 56 }
    });
  ...
  for (const n of e.steps)
    n === t || n === a || ao(i, e.id, n);
  return i.push(Ke(ze.bottomRight, "+=0.16")), Pe(r, i);
}
function vc(r, e) {
  const t = Ue(e, "user"), a = $t(e, "table"), i = Ue(e, "thinking"), n = $t(e, "sequenceEngagement"), o = a ? Zt(a.component, "website-visitors-sales") : null, s = n ? qi(n.component, "visitor-outreach-sequences") : null, l = [];
  if (o && (o.scrollAlign = "equal-inset"), t && l.push({
    ...
    eo("website-visitors-sales", M.beat + 0.18, "+=0.08")
...
function kc(r, e) {
  ...
  ), o = a ? e.steps.indexOf(a) : -1, s = n.find((f) => o >= 0 && e.steps.indexOf(f) < o), l = [...n].reverse().find((f) => f !== s), c = t?.text || "may_webinar_attendees.csv", d = Sc(t, s?.component ?? l?.component), u = r.chat.prepareCsvDropArea(), g = r.chat.prepareCursorFile(c, r.cursor), p = F("[data-chat-shell]", "center", {
    desktop: { x: 0, y: 82 },
    tablet: { x: 0, y: 72 },
    mobile: { x: 0, y: 64 }
  });
  return Pe(r, [
    ...
    ...l ? [{ kind: "dataTable", config: Lc(Zt(l.component, "cleaned-webinar-attendees")), at: "-=0.04" }] : [],
    Ke(ze.bottomRight, "+=0.18")
  ]);
}
function Sc(r, e) {
  const t = Cc(e);
...
function Ec(r) {
  const e = [], t = r.id === "data-marketplace" ? Mc(r.steps) : r.steps;
  let a = 0;
  for (const i of t)
    a += i.kind === "user" ? 1 : 0, ao(e, r.id, i, a === 1);
  return e;
}
function Mc(r) {
  const e = [];
...
function ao(r, e, t, a = !1) {
  ...
  t.kind !== "component" || !t.component || Rc(r, e, t);
}
function Rc(r, e, t) {
  const a = t.component;
  if (a.kind === "table") {
    const i = Zt(a, `${e}-${t.id}`);
    Bc(e, t, i) && (i.scrollAlign = "equal-inset"), r.push({ kind: "dataTable", config: i, at: "-=0.04" });
    return;
  }
  if (a.kind === "strategyCards") {
    r.push({ kind: "strategyPlans", plans: io(a), at: "-=0.04" });
    return;
  }
  if (a.kind === "enrichment") {
    r.push({ kind: "enrichmentPanel", config: Qc(a), at: "+=0.12" });
    return;
  }
  ...
  if (a.kind === "uploadedFiles") {
    r.push({ kind: "custom", build: (i) => i.chat.uploadedFilesMessage(ro(a)), at: "-=0.04" });
    return;
  }
  ...
  if (a.kind === "styleProfile") {
    ...
    r.push({
      ...
      at: "-=0.02"
    }), e === "crm-update" && r.push(...Zr(i.id));
    return;
  }
  if (a.kind === "proximityList") {
    r.push({ kind: "custom", build: (i) => i.chat.proximityLeadList(lo(a)), at: "-=0.04" });
    return;
  }
  if (a.kind === "personalizationSwipeGame") {
    r.push({ kind: "personalizationSwipeGame", config: Kc(a), at: "+=0.06" });
    return;
  }
...
function Pa(r, e = {}) {
  return {
    kind: "thinking",
    thinking: Ic(r.thinking, r.text, r.note),
    hold: e.hold,
    at: e.at
  };
}
...
function Zt(r, e) {
  const t = qc(r, e), a = r.rows.filter((o) => o.some((s) => s.trim())).map((o, s) => Gc(o, t, s)), i = r.pagination?.pageSize ?? Oc(r.pagination?.ranges) ?? Math.min(10, a.length || 10), n = r.pagination?.ranges.map((o, s) => ({
    page: s + 1,
    range: o,
    rows: a.slice(s * i, (s + 1) * i)
  })).filter((o) => o.rows.length) ?? [];
  return {
    id: e === "website-visitors-sales" ? e : te(r.title || e),
    title: r.title,
    eyebrow: r.eyebrow,
    count: r.count,
    variant: Nc(e) ? "csv" : t.variant ?? Xc(r),
    columns: t.columns,
    rows: n[0]?.rows ?? a,
    actions: r.actions?.map(Yc),
    pagination: n.length > 1 ? {
      pageSize: i,
      totalRows: Jc(r, a.length),
      activePage: 1,
      pages: n
    } : void 0
  };
...
function Nc(r) {
  return r === "raw-webinar-attendees" || r === "clean-webinar-attendees" || r === "cleaned-webinar-attendees";
}
function Oc(r) {
...
function Gc(r, e, t) {
  ...
  if (e.columns.forEach((i, n) => {
    ...
    const i = Hc(a[e.mutualConnectionKey] ?? ""), n = Vc(t);
...
function Hc(r) {
  const [e = "", t = ""] = r.split(/\s+[—–]\s+/, 2), a = e.trim().match(/^(.+?)(?:\s*\((.+)\))?$/), i = a?.[1]?.trim() || r.trim(), n = t.trim(), o = Dc[te(i).replace(/-/g, " ")], s = Wc(a?.[2]?.trim() || "", o, n);
  return {
    name: i,
    title: s.title,
    context: n,
...
function Wc(r, e, t) {
  const a = Mn(t);
  return e && (!r || /\bUnify\b/i.test(r)) ? e : r && a && /\bUnify\b/i.test(r) ? {
...
function io(r) {
  return r.cards.map((e, t) => ({
    id: te(e.label || e.title || `strategy-${t + 1}`),
    label: e.label,
    title: e.title,
    summary: e.summary,
...
function no(r) {
  return {
    id: te(r.title || "data-sources"),
    title: r.title,
    subtitle: r.subtitle,
    sources: r.sources.map((e, t) => ({
      id: te(e.name || `source-${t + 1}`),
      category: e.category,
      name: e.name,
      detail: e.detail,
      logoSrc: e.logoSrc
...
function oo(r) {
  return {
    id: te(r.title || "mailbox-connection"),
    title: r.title,
    subtitle: r.subtitle,
    provider: r.provider,
    account: r.account,
...
function Kc(r) {
  return {
    id: te(r.title || "personalization-swipe"),
    title: r.title,
    subtitle: r.subtitle,
    prompt: r.prompt,
...
const Zc = [
  ...
  pagination: {
    ...
    activePage: 1,
    pages: [
      { page: 1, range: "1-10 of 50 people", rows: Bn },
      { page: 2, range: "11-20 of 50 people", rows: rd }
    ]
  },
  actions: [
    {
  ...
  },
  {
    ...
    build: (r) => Pe(r, [
      ...
      { kind: "dataTable", config: Pn, at: "-=0.04" },
      {
        kind: "prompt",
      ...
      { kind: "dataTable", config: Rn, at: "-=0.04" },
      {
        kind: "prompt",
      ...
      { kind: "dataTable", config: Dn, at: "-=0.02" },
      { kind: "marketingDataSourcesGrid", config: In, at: "+=1.44" },
      Ke(ze.bottomRight, "+=3")
    ])
  },
  {
    ...
    build: (r) => {
      ...
      }), t = r.chat.prepareCursorFile("4 context files", r.cursor, "DOC", Ln), a = {
        desktop: { target: "[data-chat-shell]", anchor: "right", outside: "right", offset: { x: 420, y: -74 }, humanOffset: !1 },
        tablet: { target: "[data-chat-shell]", anchor: "right", outside: "right", offset: { x: 360, y: -58 }, humanOffset: !1 },
        mobile: { target: "[data-chat-shell]", anchor: "right", outside: "right", offset: { x: 280, y: -42 }, humanOffset: !1 }
      ...
      return Pe(r, [
        ...
        { kind: "custom", build: () => t.landAsUploadedFiles(Ln), at: "<" },
        ...
        {
          kind: "custom",
          build: () => r.chat.outreachStyleProfile(Nn, { scrollAlign: "equal-inset" }),
          at: "-=0.02"
        },
        ...Zr(Nn.id),
        {
        ...
        { kind: "custom", build: () => r.chat.proximityLeadList(On), at: "-=0.04" },
        Ke(ze.bottomRight, "+=0.16")
      ]);
    }
  },
  {
    ...
    build: (r) => {
      ...
      return Pe(r, [
        ...
        { kind: "custom", build: () => r.chat.dataTableActionTooltip("website-visitors-sales", "email-sequence", !1), at: "<+=0.02" },
        { kind: "status", text: "building outreach sequence", at: "<" },
        { kind: "custom", build: () => r.chat.sequenceBuildThinking(id), at: "+=0.06" },
  ...
  },
  {
    ...
    entryLeadTime: 0.18,
    build: (r) => {
      const e = r.chat.prepareCsvDropArea(), t = r.chat.prepareCursorFile("may_webinar_attendees.csv", r.cursor), a = F("[data-chat-shell]", "center", {
        desktop: { x: 0, y: 82 },
        tablet: { x: 0, y: 72 },
        mobile: { x: 0, y: 64 }
      });
      return Pe(r, [
        ...
        { kind: "dataTable", config: od, at: "+=0.08" },
        { kind: "status", text: "Cleaning CSV", at: "<" },
        {
          kind: "thinking",
          steps: [
...
class ld {
  ...
  followPointer = () => {
    ...
    if (this.mode === "return") {
      const t = this.getReturnHomePoint(), a = cd((e - this.returnStartedAt) / ti.durationMs), i = this.getReturnWavePoint(a, t), n = this.getReturnWavePoint(Math.min(1, a + 0.035), t);
      if (this.target = t, this.cursor.mimicViewportPoint(i, 1, a < 1 ? n : t), a >= 1 || We(this.getCursorViewportPoint(), t) <= ti.arriveDistance) {
  ...
  updateFollowTarget(e) {
    ...
    if (this.lastPointer) {
      ...
      i > 1.5 && (this.trailDirection = {
        x: a.x / i,
        y: a.y / i
      }, this.velocity = gd(a, Z.maxMomentumStep));
    }
    const t = {
      x: e.x - this.trailDirection.x * Z.trailDistance,
      y: e.y - this.trailDirection.y * Z.trailDistance
    };
    We(e, t) < Z.minPointerDistance && (t.x = e.x - this.trailDirection.x * Z.minPointerDistance, t.y = e.y - this.trailDirection.y * Z.minPointerDistance), this.target = t, this.pointer = e, this.lastPointer = e;
  }
  startPlayfulIdle(e) {
  ...
  updatePlayTarget(e) {
    ...
    this.target = ud(n, this.pointer, He.minPointerDistance, He.viewportInset);
  }
  resumeFollowing(e) {
  ...
  getReturnWavePoint(e, t) {
    const a = this.returnStart ?? this.getCursorViewportPoint(), i = dd(e), n = t.x - a.x, o = t.y - a.y, s = Math.hypot(n, o), l = {
      x: a.x + n * i,
      y: a.y + o * i
    };
    if (s < 1) return l;
    const c = Math.sin(Math.PI * e), d = Math.sin(Math.PI * 2 * e) * c * ti.amplitude * this.returnWaveDirection;
    return {
      x: l.x - o / s * d,
      y: l.y + n / s * d
    };
  ...
  isCursorTooFarFromBrowser() {
    ...
    return pd(i, e) > Z.maxBrowserDistance;
  }
  getChatShell() {
    return this.chatShell?.isConnected ? this.chatShell : (this.chatShell = this.root.querySelector("[data-chat-shell]"), this.chatShell);
  }
  ...
  countAxisReversals(e) {
    ...
    for (let n = 1; n < e.length; n += 1) {
      const o = e[n - 1], s = e[n], l = Un(s.x - o.x), c = Un(s.y - o.y);
...
function zn(r, e) {
  return {
    x: Fn(r.x, e, window.innerWidth - e),
    y: Fn(r.y, e, window.innerHeight - e)
  };
}
function ud(r, e, t, a) {
  const i = zn(hd(r, e, t), a);
...
class md {
  constructor(e, t, a, i, n, o) {
    this.root = e, this.stories = t, this.resolver = a, this.cursor = i, this.chat = n, this.options = o, this.storyProgress = this.stories.map(() => 0), this.pausedCursorMimic = new ld(this.root, this.cursor, {
  ...
  updateStories(e, t = {}) {
    if (!e.length) return;
    const a = this.stories[this.activeIndex]?.id, i = this.stories, n = new Map(this.stories.map((c, d) => [c.id, this.storyProgress[d] ?? 0])), o = this.cursor.getPosition(), s = this.playing, l = fd(i, e);
    ...
    this.updateStoryMeta(), this.updateAllTabProgress(), Cn(this.stories, this.activeIndex);
  }
  goTo(e, t = {}) {
  ...
  rebuildActiveStoryTimeline(e, t, a = 0) {
    this.activeIndex = e, Cn(this.stories, this.activeIndex), this.activeTimeline = this.buildTimeline(this.activeIndex, t), this.activeTimeline.progress(a).pause(), this.updateStoryMeta(), this.updateProgress();
  }
  stopTimeline() {
  ...
  attachChatHistoryScroll() {
    ...
    const a = (i) => {
      ...
      if (Math.abs(n) < Gn.minPixelDelta) return;
      ...
      i.preventDefault(), this.pauseForChatHistory(), t.scrollTop = l, d >= Gn.minPixelDelta && window.scrollBy({ top: d, left: 0, behavior: "auto" });
    };
...
class wd {
  ...
  resolve(e, t = "target") {
    ...
    if (s = {
      ...
      const l = Hr(t), c = Math.min(o.width * 0.18, 18), d = Math.min(o.height * 0.18, 14);
...
const bd = 3, yd = /* @__PURE__ */ new Set([
  "user",
  "assistant",
  "thinking",
  "component",
...
function xd(r) {
  ...
  const e = typeof r.schemaVersion == "number" ? r.schemaVersion : 1, t = r.stories.map((a) => vd(a)).filter((a) => !!a);
...
function vd(r) {
  ...
  const e = Ae(r.id), t = Ae(r.label), a = Ae(r.summary), i = r.steps.map((n) => kd(n)).filter((n) => !!n);
...
function kd(r) {
  ...
  return !e || !t || !_d(t) ? null : {
    id: e,
    kind: t,
    text: a ?? "",
    note: i ?? "",
    thinking: vt(r.thinking) ? Sd(r.thinking, a ?? "", i ?? "") : t === "thinking" ? go(a ?? "", i ?? "") : void 0,
    component: vt(r.component) ? Ad(r.component) : void 0
  };
}
function Sd(r, e, t) {
  const i = (Array.isArray(r.items) ? r.items : []).map((n, o) => Cd(n, o)).filter((n) => !!n);
  return i.length ? {
    title: Ae(r.title) ?? qe,
    elapsed: Ae(r.elapsed) ?? Ca(i.length),
    items: i
  } : go(e, t);
}
function Cd(r, e) {
  ...
  return t ? {
    label: t,
    detail: Ae(r.detail) ?? Oi(t, e),
    disclosure: Ae(r.disclosure) ?? (e === 0 ? Gt : ha)
  } : null;
}
function go(r, e = "") {
  return {
...
async function Td(r, e) {
  try {
    ...
    if (!a || a.schemaVersion !== bd) return;
...
function Md(r, e = {}) {
  Ed(r);
  const t = e.stories?.length ? e.stories : ho, a = e.builderDraftEndpoint ?? "/api/story-draft", i = e.reducedMotion ?? window.matchMedia?.("(prefers-reduced-motion: reduce)").matches ?? !1, n = new wd(r), o = new Nl(r), s = new Hl(r, n, { reducedMotion: i }), l = new md(r, t, n, s, o, {
    ...
    l.updateStories(mc(d, t), {
      restartActive: u.source === "load"
    });
  };
  return l.mount(), a && Td(a, c), {
    play: l.play.bind(l),
...
function fo(r = "[data-chatbot-stories]", e = {}) {
  return e.injectStyles !== !1 && mo(), Md(Dd(r), e);
}
const Ld = {
  init: fo,
  defaultStories: ho
...
if (typeof window < "u") {
  window.ChatbotStories = Ld;
  const r = () => {
    document.querySelector("[data-chatbot-stories][data-auto-init]") && mo(), document.querySelectorAll("[data-chatbot-stories][data-auto-init]").forEach((e) => {
      e.dataset.chatbotStoriesMounted || (e.dataset.chatbotStoriesMounted = "true", fo(e));
    });
  };
  document.readyState === "loading" ? document.addEventListener("DOMContentLoaded", r, { once: !0 }) : r();
}
export {
  ho as defaultStories,
  fo as init
};
