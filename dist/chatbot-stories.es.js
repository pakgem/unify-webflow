...
class As {
  ...
  createThinkingStep(e, t) {
    ...
    d.className = "wa-research-step__disclosure", d.textContent = e.disclosure;
    const c = document.createElement("span");
    return c.className = "wa-research-step__chevron", c.setAttribute("aria-hidden", "true"), o.append(s, c), r.append(o, l, d), a.append(i, r), a;
  }
