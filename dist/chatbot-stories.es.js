...
var he = {
  ...
  var a = Z(e), i, r;
  return !a && Me(e) && (i = a = e.radius || _e, e.values ? (e = xe(e.values), (r = !Oe(e[0])) && (i *= i)) : e = ai(e.increment)), Ze(t, a ? j(e) ? function(o) {
...
var Zr = function(e, t) {
  this.id = jn++, e._gsap = this, this.target = e, this.harness = t, this.get = t ? t.get : Rr, this.set = t ? t.getSetter : Si;
...
var Ao = function(e, t, a, i, r, o, s) {
  ...
  if (X(i) && (~i.indexOf("random(") && (i = Jt(i)), i.charAt(1) === "=" && (g = St(p, i) + (Q(p) || 0), (g || g === 0) && (i = g))), !c || p !== i || ii)
    return !isNaN(p * i) && i !== "" ? (g = new ne(this._pt, e, t, +p || 0, i - (p || 0), typeof u == "boolean" ? Do : nn, 0, m), d && (g.fp = d), s && g.modifier(s, this, e), this._pt = g) : (!u && !(t in e) && fi(t, i), Ao.call(this, e, t, p, i, m, l || he.stringFilter, d));
  ...
  var i = e.vars, r = i.ease, o = i.startAt, s = i.immediateRender, l = i.lazy, d = i.onUpdate, c = i.runBackwards, u = i.yoyoEase, p = i.keyframes, m = i.autoRevert, g = e._dur, h = e._startAt, f = e._targets, b = e.parent, _ = b && b.data === "nested" ? b.vars.targets : f, y = e._overwrite === "auto" && !pi, v = e.timeline, x = i.easeReverse || u, T, k, C, S, E, B, L, I, D, M, G, z, ee;
  if (v && (!p || !r) && (r = "none"), e._ease = pt(r, Yt.ease), e._rEase = x && (pt(x) || e._ease), e._from = !v && !!i.runBackwards, e._from && (e.ratio = 1), !v || p && !i.stagger) {
    ...
    for (e._pt = e._ptCache = 0, l = g && ie(l) || l && !g, k = 0; k < f.length; k++) {
      if (E = f[k], L = E._gsap || yi(f)[k]._gsap, e._ptLookup[k] = M = {}, Ka[L.id] && Ye.length && ga(), G = _ === f ? k : _.indexOf(E), I && (D = new I()).init(E, z || T, e, G, _) !== !1 && (e._pt = S = new ne(e._pt, E, D.name, 0, 1, D.render, D, 0, D.priority), D._props.forEach(function(fe) {
        M[fe] = S;
      }), D.priority && (B = 1)), !I || z)
        for (C in T)
          de[C] && (D = en(C, T, e, G, E, _)) ? D.priority && (B = 1) : M[C] = S = xi.call(e, E, C, "get", T[C], G, _, 0, i.stringFilter);
      e._op && e._op[k] && e.kill(E, e._op[k]), y && e._pt && (Ue = e, V.killTweensOf(E, M, e.globalTime(t)), ee = !e.parent, Ue = 0), e._pt && l && (Ka[L.id] = 1);
    }
...
var $ = /* @__PURE__ */ (function(n) {
  ...
  function e(a, i, r, o) {
    ...
    if (s._targets = _.length ? yi(_) : $t("GSAP target " + a + " not found. https://gsap.com", !he.nullTargetWarn) || [], s._ptLookup = [], s._overwrite = m, g || p || ia(d) || ia(c)) {
      ...
      if (y = s.timeline = new ae({
        ...
        for (v = 0; v < T; v++)
          x = fa(i, an), x.stagger = 0, B && (x.easeReverse = B), E && Et(x, E), C = _[v], x.duration = +jt(d, De(s), v, C, _), x.delay = (+jt(c, De(s), v, C, _) || 0) - s._delay, !p && T === 1 && x.delay && (s._delay = c = x.delay, s._start += c, x.delay = 0), y.to(C, x, S ? S(v, C, _) : 0), y._ease = R.none;
      ...
      s.timeline = 0;
    return m === !0 && !pi && (Ue = De(s), V.killTweensOf(_), Ue = 0), Te(b, De(s), r), i.reversed && s.reverse(), i.paused && s.paused(!0), (u || !d && !g && s._start === U(b._time) && ie(u) && no(De(s)) && b.data !== "nested") && (s._tTime = -O, s.render(Math.max(0, -c) || 0)), f && Br(De(s), f), s;
  }
  var t = e.prototype;
  return t.render = function(i, r, o) {
    ...
    if (this.timeline) {
      ...
      return this.timeline.killTweensOf(i, r, Ue && Ue.vars.overwrite !== !0)._first || Ht(this), this.parent && o !== this.timeline.totalDuration() && Mt(this, this._dur * this.timeline._tDur / o, 0, 1), this;
    }
...
var ki = function(e, t, a) {
  ...
  return j(e[t]) ? rn : hi(e[t]) && e.setAttribute ? Ro : ki;
}, nn = function(e, t) {
...
he.stringFilter = Kr;
var ht = [], ha = {}, Oo = [], Gi = 0, Bo = 0, Ra = function(e) {
...
}, Da("roundProps", ai), Da("modifiers"), Da("snap", Ur)) || ba;
...
var Ui, Ve, Ct, Ai, dt, Vi, Ti, Go = function() {
  ...
  return i[t] || i.getPropertyValue(t.replace(Ei, "-$1").toLowerCase()) || i.getPropertyValue(t) || !a && n(e, Rt(t) || t, 1) || "";
}, ji = "O,Moz,ms,Ms,Webkit".split(","), Rt = function(e, t, a) {
  ...
  Go() && window.document && (Ui = window, Ve = Ui.document, Ct = Ve.documentElement, dt = oi("div") || {
    style: {}
  }, oi("div"), W = Rt(W), oe = W + "Origin", dt.style.cssText = "border-width:0;line-height:0;position:absolute;padding:0", hn = !!Rt("perspective"), Ti = se.core.reverting, Ai = 1);
}, Yi = function(e) {
  ...
  var r;
  return Ai || si(), t in Pe && t !== "transform" && (t = Pe[t], ~t.indexOf(",") && (t = t.split(",")[0])), Be[t] && t !== "transform" ? (r = ea(e, i), r = t !== "transformOrigin" ? r[t] : r.svg ? r.origin : _a(pe(e, oe)) + " " + r.zOrigin + "px") : (r = e.style[t], (!r || r === "auto" || i || ~(r + "").indexOf("calc(")) && (r = ya[t] && ya[t](e, t, a) || pe(e, t) || Rr(e, t) || (t === "opacity" ? 1 : 0))), a && !~(r + "").trim().indexOf(" ") ? Qe(e, t, r, a) + a : r;
}, rs = function(e, t, a, i) {
  if (!a || a === "none") {
...
<path style=" stroke:none;fill-rule:nonzero;fill:rgb(100%,100%,100%);fill-opacity:1;" d="M 179.332031 535.847656 C 159.5625 535.847656 143.332031 529.472656 130.640625 516.71875 C 117.953125 503.964844 111.605469 487.320312 111.605469 466.789062 C 111.605469 445.105469 118.046875 427.570312 130.929688 414.179688 C 143.8125 400.785156 160.679688 394.089844 181.53125 394.089844 C 201.234375 394.089844 217.273438 400.5 229.644531 413.316406 C 242.082031 426.136719 248.296875 443.035156 248.296875 464.015625 C 248.296875 485.566406 241.855469 502.945312 228.976562 516.144531 C 216.15625 529.28125 199.609375 535.847656 179.332031 535.847656 Z M 179.902344 508.78125 C 190.679688 508.78125 199.355469 504.984375 205.921875 497.398438 C 212.492188 489.808594 215.773438 479.253906 215.773438 465.734375 C 215.773438 451.640625 212.585938 440.675781 206.210938 432.832031 C 199.832031 424.988281 191.320312 421.066406 180.671875 421.066406 C 169.699219 421.066406 160.867188 425.113281 154.171875 433.214844 C 147.476562 441.246094 144.128906 451.898438 144.128906 465.160156 C 144.128906 478.617188 147.476562 489.265625 154.171875 497.109375 C 160.867188 504.890625 169.445312 508.78125 179.902344 508.78125 Z M 179.902344 508.78125 "/>
  ...
  contentWidth: 1881,
  height: 1280
}, Rs = 96, rr = ".wa-cursor-file, .wa-file-landing-clone, .wa-csv-drop", Ds = "[data-marketing-data-sources-grid]", nr = "[data-data-table]", Ft = "[data-table-action]", or = "[data-table-page-button]", Ns = "[data-table-page-range]", Fa = {
  offscreenMargin: 96,
...
class Ks {
  ...
  handleThinkingInput(e) {
    ...
    !r || !a || (r.thinking ??= Dt(r.text, r.note), pl(r.thinking, a, e.value, i), hl(r), this.selectedStepId === r.id && (this.syncPanelStepText(r.text), this.syncPanelStepNote(r.note)), this.renderExport(), this.emitChange("Thinking updated", !1));
  }
...
function vl(n) {
  ...
  return !e || !t || !di(t) ? null : {
    ...
    text: a ?? "",
    note: i ?? "",
    thinking: gt(n.thinking) ? kl(n.thinking, a ?? "", i ?? "") : t === "thinking" ? Dt(a ?? "", i ?? "") : void 0,
...
const xa = {
  ...
  tablet: -66,
  mobile: -48
}), El = F("[data-send-button]", "center"), Mi = {
  desktop: {
...
}, Pl = 2.8, Ml = 42, Il = 2, Rl = 3, va = "[data-chat-shell] [data-chat-thread]", Dl = `${va} [data-message-role="assistant"]:not(.wa-message--component) [data-message-body]`, Nl = `${va} [data-message-role="assistant"].wa-message--thinking .wa-research-step[data-step-state="current"] .wa-research-step__body, ${va} [data-message-role="assistant"].wa-message--thinking .wa-research-step[data-step-state="complete"] .wa-research-step__label`, ci = 0.24, In = 0.3, Le = {
...
function Bl(n, e, t) {
  ...
  return t.startsWith("strategy-") && a.add(n.chat.strategyPlanHoverSequence(e), "<+=0.06"), Ri(a);
}
function zl(n, e, t, a = P.thinkingShort, i = 1, r = "thinking", o = 0) {
...
function Ql(n, e) {
  const t = qe(e, "user"), a = Nt(e, "table"), i = qe(e, "thinking"), r = Nt(e, "sequenceEngagement"), o = a ? Di(a.component, "website-visitors-sales") : null, s = r ? Bn(r.component, "visitor-outreach-sequences") : null, l = [];
  if (t && l.push({
    kind: "prompt",
    text: t.text,
    duration: zn(t.text),
...
function Di(n, e) {
  const t = dd(n.columns), a = n.rows.filter((o) => o.some((s) => s.trim())).map((o, s) => ud(o, t, s)), i = Math.min(10, a.length || 10), r = n.pagination?.ranges.map((o, s) => ({
    page: s + 1,
    range: o,
  ...
  },
  {
    ...
    build: (n) => {
      ...
      return Ee(n, [
        ...
        { kind: "sequenceEngagement", config: Rd, at: "-=0.02" },
        { kind: "custom", build: () => n.timeline().to({}, { duration: P.beat + 0.24 }), at: "+=0.04" },
        {
          kind: "cursorMove",
          target: i,
