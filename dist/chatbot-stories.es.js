...
var le = {
  ...
  overwrite: !1,
  delay: 0
}, Da, X, D, me = 1e8, I = 1 / me, ba = Math.PI * 2, Yr = ba / 4, Vr = 0, qi = Math.sqrt, Wr = Math.cos, jr = Math.sin, j = function(e) {
...
}, Z = Array.isArray, Xr = /random\([^)]+\)/g, Jr = /,\s*/g, ai = /(?:-?\.?\d|\.)+/gi, Gi = /[-+=.]*\d+[.e\-+]*\d*[e\-+]*\d*/g, st = /[-+=.]*\d+[.e-]*\d*[a-z%]*/g, sa = /[-+=.]*\d+\.?\d*(?:e-|e\+)?\d*/gi, Ui = /[+-]=-?[.\d]+/, Qr = /[^,'"\[\]\s]+/gi, Zr = /^[+\-=e\s\d]*\d+[.\d]*([a-z]*|%)\s*$/i, z, _e, _a, La, de = {}, Jt = {}, Yi, Vi = function(e) {
  ...
  suppressEvents: !0
}, Ba = {}, Re = [], ya = {}, ji, re = {}, oa = {}, ii = 30, jt = [], qa = "", Ha = function(e) {
  var t = e[0], a, i;
  ...
  Re.length && !X && Qt(), e.render(t, a, !!(X && t < 0 && Ga(e))), Re.length && !X && Qt();
}, Qi = function(e) {
  var t = parseFloat(e);
  return (t || t === 0) && (e + "").match(Qr).length < 2 ? t : j(e) ? e.trim() : e;
}, Zi = function(e) {
  return e;
}, ce = function(e, t) {
  for (var a in t)
  ...
  var t = e.parent || z, a = e.keyframes ? tn(Z(e.keyframes)) : ce;
  if ($(e.inherit))
    for (; t; )
  ...
  return e._startAt && (X ? e._startAt.revert(Wt) : e.vars.immediateRender && !e.vars.autoRevert || e._startAt.render(t, !0, i));
}, nn = function o(e) {
  ...
  var a = e._dp;
  return a && a.smoothChildTiming && e._ts && (e._start = O(a._time - (e._ts > 0 ? t / e._ts : ((e._dirty ? e.totalDuration() : e._tDur) - t) / -e._ts)), ra(e), a._dirty || Xe(a, e)), e;
}, $i = function(e, t) {
  var a;
  if ((t._time || !t._dur && t._initted || t._start < e._time && (t._dur || !t.add)) && (a = Kt(e.rawTime(), t), (!t._dur || Bt(0, t.totalDuration(), a) - t._tTime > I) && t.render(a, !0)), Xe(e, t)._dp && e._initted && e._time >= e._dur && e._ts) {
  ...
  return t.parent && Oe(t), t._start = O((Te(a) ? a : a || e !== z ? pe(e, a, t) : e._time) + t._delay), t._end = O(t._start + (t.totalDuration() / Math.abs(t.timeScale()) || 0)), Ki(e, t, "_first", "_last", e._sort ? "_start" : 0), va(t) || (e._recent = t), i || $i(e, t), e._ts < 0 && na(e, e._tTime), e;
}, er = function(e, t) {
  return (de.ScrollTrigger || Fa("scrollTrigger", t)) && de.ScrollTrigger.create(t, e);
}, tr = function(e, t, a, i, r) {
  if (Ya(e, t, r), !e._initted)
    return 1;
  if (!a && e._pt && !X && (e._dur && e.vars.lazy !== !1 || !e._dur && e.vars.lazy) && ji !== ne.frame)
  ...
  var r = e.ratio, n = t < 0 || !t && (!e._start && sn(e) && !(!e._initted && va(e)) || (e._ts < 0 || e._dp._ts < 0) && !va(e)) ? 0 : 1, s = e._rDelay, l = 0, d, c, u;
  ...
  return s && !i && (e._time *= n / e._dur), e._dur = n, e._tDur = r ? r < 0 ? 1e10 : O(n * (r + 1) + e._rDelay * r) : n, s > 0 && !i && na(e, e._tTime = e._tDur * s), e.parent && ra(e), a || Xe(e.parent, e), e;
}, si = function(e) {
  ...
  var i = e.labels, r = e._recent || dn, n = e.duration() >= me ? r.endTime(!1) : e._dur, s, l, d;
  ...
  return !j(e) || !(t = Zr.exec(e)) ? "" : t[1];
}, cn = function(e, t, a) {
  return Fe(a, function(i) {
    return Bt(e, t, i);
  });
}, Aa = [].slice, ar = function(e, t) {
  return e && ve(e) && "length" in e && (!t && !e.length || e.length - 1 in e && ve(e[0])) && !e.nodeType && e !== _e;
}, un = function(e, t, a) {
  return a === void 0 && (a = []), e.forEach(function(i) {
    var r;
    return j(i) && !t || ar(i, 1) ? (r = a).push.apply(r, ge(i)) : a.push(i);
  }) || a;
}, ge = function(e, t, a) {
  return D && !t && D.selector ? D.selector(e) : j(e) && !a && (_a || !mt()) ? Aa.call((t || La).querySelectorAll(e), 0) : Z(e) ? un(e, a) : ar(e) ? Aa.call(e, 0) : e ? [e] : [];
}, Ca = function(e) {
  ...
  return j(i) ? c = u = {
    ...
    if (!f) {
      ...
      for (f = n[h] = [], b = l ? Math.min(C, h) * c - 0.5 : i % C, _ = C === me ? 0 : l ? h * u / C - 0.5 : i / C | 0, A = 0, S = me, k = 0; k < h; k++)
        x = k % C - b, v = _ - (k / C | 0), f[k] = y = d ? Math.abs(d === "y" ? v : x) : qi(x * x + v * v), y > A && (A = y), y < S && (S = y);
      i === "random" && ir(f), f.max = A - S, f.min = S, f.v = h = (parseFloat(t.amount) || parseFloat(t.each) * (C > h ? h - 1 : d ? d === "y" ? h / C : C : Math.max(C, h / C)) || 0) * (i === "edges" ? -1 : 1), f.b = h < 0 ? r - h : r, f.u = Q(t.amount || t.each) || 0, a = a && h < 0 ? Cn(a) : a;
    }
  ...
  var i = t - e;
  return Z(e) ? or(e, o(0, e.length), t) : Fe(a, function(r) {
    return (i + (r - e) % i) % i + e;
  });
}, fn = function o(e, t, a) {
  var i = t - e, r = i * 2;
  return Z(e) ? or(e, o(0, e.length - 1), t) : Fe(a, function(n) {
  ...
  if (e)
    if (e = !e.name && e.default || e, za() || e.headless) {
      ...
      Wi(t, i), e.register && e.register(ie, i, te);
    } else
      dr.push(e);
}, M = 255, St = {
  aqua: [0, M, M],
  ...
  if (!i) {
    if (e.substr(-1) === "," && (e = e.substr(0, e.length - 1)), St[e])
      ...
      if (i = g = e.match(ai), !t)
        ...
        return i = e.match(Gi), a && i.length < 4 && (i[3] = 1), i;
    } else
...
})(), bn = /hsl[a]?\(/, pr = function(e) {
  var t = e.join(" "), a;
  if (De.lastIndex = 0, De.test(t))
    return a = bn.test(t), e[1] = li(e[1], a), e[0] = li(e[0], a, hr(e[1])), !0;
}, Ot, ne = (function() {
  ...
  return u = {
    ...
    wake: function() {
      Yi && (!_a && za() && (_e = _a = window, La = _e.document || {}, de.gsap = ie, (_e.gsapVersions || (_e.gsapVersions = [])).push(ie.version), Vi(Jt || _e.GreenSockGlobals || !_e.gsap && _e || {}), dr.forEach(cr)), c = typeof requestAnimationFrame < "u" && requestAnimationFrame, l && u.sleep(), d = c || function(f) {
  ...
  return !Ot && ne.wake();
}, P = {}, _n = /^[\d.\-M][\d.\-,\s]/, yn = /["']/g, xn = function(e) {
  for (var t = {}, a = e.substr(1, e.length - 3).split(":"), i = a[0], r = 1, n = a.length, s, l, d; r < n; r++)
    l = a[r], s = r !== n - 1 ? l.lastIndexOf(",") : l.length, d = l.substr(0, s), t[i] = isNaN(d) ? d.replace(yn, "").trim() : +d, i = l.substr(s + 1).trim();
  return t;
}, vn = function(e) {
  ...
  return a && t.length > 1 && a.config ? a.config.apply(null, ~e.indexOf("{") ? [xn(t[1])] : vn(e).split(",").map(Qi)) : P._CE && _n.test(e) ? P._CE("", e) : a;
}, Cn = function(e) {
  return function(t) {
    return 1 - e(1 - t);
  };
}, Je = function(e, t) {
  return e && (q(e) ? e : P[e] || An(e)) || t;
}, Ze = function(e, t, a, i) {
  ...
  var i = t >= 1 ? t : 1, r = (a || (e ? 0.3 : 0.45)) / (t < 1 ? t : 1), n = r / ba * (Math.asin(1 / i) || 0), s = function(c) {
    return c === 1 ? 1 : i * Math.pow(2, -10 * c) * jr((c - n) * r) + 1;
...
Ze("Sine", function(o) {
  return o === 1 ? 1 : -Wr(o * Yr) + 1;
});
Ze("Back", ca("in"), ca("out"), ca());
...
var gr = function(e, t) {
  this.id = Vr++, e._gsap = this, this.target = e, this.harness = t, this.get = t ? t.get : Xi, this.set = t ? t.getSetter : Wa;
  ...
  return e.delay = function(a) {
    ...
    return this._rts = +a || 0, this._ts = this._ps || a === -I ? 0 : this._rts, this.totalTime(Bt(-Math.abs(this._delay), this.totalDuration(), r), i !== !1), ra(this), rn(this);
  }, e.paused = function(a) {
...
var K = /* @__PURE__ */ (function(o) {
  ...
  function e(a, i) {
    var r;
    return a === void 0 && (a = {}), r = o.call(this, a) || this, r.labels = {}, r.smoothChildTiming = !!a.smoothChildTiming, r.autoRemoveChildren = !!a.autoRemoveChildren, r._sort = $(a.sortChildren), z && ye(a.parent || z, Se(r), i), a.reversed && r.reverse(), a.paused && r.paused(!0), a.scrollTrigger && er(Se(r), a.scrollTrigger), r;
  }
  var t = e.prototype;
  return t.to = function(i, r, n) {
    ...
    if (this !== z && c > l && i >= 0 && (c = l), c !== this._tTime || n || u) {
      ...
      if (this._hasPause && !this._forcing && this._lock < 2 && (_ = ln(this, O(s), O(p)), _ && (c -= p - (p = _._start))), this._tTime = c, this._time = p, this._act = !!x, this._initted || (this._onUpdate = this.vars.onUpdate, this._initted = 1, this._zTime = i, s = 0), !s && c && d && !r && !y && (se(this, "onStart"), this._tTime !== c))
        return this;
      if (p >= s && i >= 0)
        for (m = this._first; m; ) {
    ...
    return j(i) ? this.removeLabel(i) : q(i) ? this.killTweensOf(i) : (i.parent === this && ia(this, i), i === this._recent && (this._recent = this._last), Xe(this));
    ...
    for (var n = [], s = ge(i), l = this._first, d = Te(r), c; l; )
      l instanceof Y ? en(l._targets, s) && (d ? (!Me || l._initted && l._ts) && l.globalTime(0) <= r && l.globalTime(l.totalDuration()) > r : !r || l.isActive()) && n.push(l) : (c = l.getTweensOf(s, r)).length && n.push.apply(n, c), l = l._next;
    return n;
    ...
    if (z._ts && (Ji(z, Kt(i, z)), ji = ne.frame), ne.frame >= ii) {
      ii += le.autoSleep || 120;
      var r = z._first;
...
var Sn = function(e, t, a, i, r, n, s) {
  var l = new te(this._pt, e, t, 0, 1, xr, null, r), d = 0, c = 0, u, p, m, g, h, f, b, _;
  ...
  q(i) && (i = i(r || 0, e, n));
  var u = e[t], p = a !== "get" ? a : q(u) ? d ? e[t.indexOf("set") || !q(e["get" + t.substr(3)]) ? t : "get" + t.substr(3)](d) : e[t]() : u, m = q(u) ? d ? Mn : _r : Va, g;
  if (j(i) && (~i.indexOf("random(") && (i = Dt(i)), i.charAt(1) === "=" && (g = lt(p, i) + (Q(p) || 0), (g || g === 0) && (i = g))), !c || p !== i || ka)
    return !isNaN(p * i) && i !== "" ? (g = new te(this._pt, e, t, +p || 0, i - (p || 0), typeof u == "boolean" ? Nn : yr, 0, m), d && (g.fp = d), s && g.modifier(s, this, e), this._pt = g) : (!u && !(t in e) && Fa(t, i), Sn.call(this, e, t, p, i, m, l || le.stringFilter, d));
}, kn = function(e, t, a, i, r) {
  if (q(e) && (e = Pt(e, r, t, a, i)), !ve(e) || e.style && e.nodeType || Z(e) || Hi(e))
  ...
  var s, l, d, c;
  if (re[e] && (s = new re[e]()).init(r, s.rawVars ? t[e] : kn(t[e], i, r, n, a), a, i, n) !== !1 && (a._pt = l = new te(a._pt, r, e, 0, 1, s.render, s, 0, s.priority), a !== ot))
    for (d = a._ptLookup[a._targets.indexOf(r)], c = s._props.length; c--; )
      d[s._props[c]] = l;
  return s;
}, Me, ka, Ya = function o(e, t, a) {
  var i = e.vars, r = i.ease, n = i.startAt, s = i.immediateRender, l = i.lazy, d = i.onUpdate, c = i.runBackwards, u = i.yoyoEase, p = i.keyframes, m = i.autoRevert, g = e._dur, h = e._startAt, f = e._targets, b = e.parent, _ = b && b.data === "nested" ? b.vars.targets : f, x = e._overwrite === "auto" && !Da, v = e.timeline, y = i.easeReverse || u, k, A, S, C, E, H, F, N, B, W, V, G, ue;
  if (v && (!p || !r) && (r = "none"), e._ease = Je(r, It.ease), e._rEase = y && (Je(y) || e._ease), e._from = !v && !!i.runBackwards, e._from && (e.ratio = 1), !v || p && !i.stagger) {
    if (N = f[0] ? je(f[0]).harness : 0, G = N && i[N.prop], k = Zt(i, Ba), h && (h._zTime < 0 && h.progress(1), t < 0 && c && s && !m ? h.render(-1, !0) : h.revert(c && g ? Wt : Kr), h._lazy = 0), n) {
      if (Oe(e._startAt = Y.set(f, ce({
        ...
        stagger: 0
      }, n))), e._startAt._dp = 0, e._startAt._sat = e, t < 0 && (X || !s && !m) && e._startAt.revert(Wt), s && g && t <= 0 && a <= 0) {
        t && (e._zTime = t);
        return;
      }
    } else if (c && g && !h) {
      ...
      }, k), G && (S[N.prop] = G), Oe(e._startAt = Y.set(f, S)), e._startAt._dp = 0, e._startAt._sat = e, t < 0 && (X ? e._startAt.revert(Wt) : e._startAt.render(-1, !0)), e._zTime = t, !s)
        o(e._startAt, I, I);
      else if (!t)
        return;
    }
    for (e._pt = e._ptCache = 0, l = g && $(l) || l && !g, A = 0; A < f.length; A++) {
      if (E = f[A], F = E._gsap || Ha(f)[A]._gsap, e._ptLookup[A] = W = {}, ya[F.id] && Re.length && Qt(), V = _ === f ? A : _.indexOf(E), N && (B = new N()).init(E, G || k, e, V, _) !== !1 && (e._pt = C = new te(e._pt, E, B.name, 0, 1, B.render, B, 0, B.priority), B._props.forEach(function(Ke) {
        W[Ke] = C;
      }), B.priority && (H = 1)), !N || G)
        for (S in k)
          re[S] && (B = fr(S, k, e, V, E, _)) ? B.priority && (H = 1) : W[S] = C = Ua.call(e, E, S, "get", k[S], V, _, 0, i.stringFilter);
      e._op && e._op[A] && e.kill(E, e._op[A]), x && e._pt && (Me = e, z.killTweensOf(E, W, e.globalTime(t)), ue = !e.parent, Me = 0), e._pt && l && (ya[F.id] = 1);
    }
    H && vr(e), e._onInit && e._onInit(e);
  }
  e._onUpdate = d, e._initted = (!e._op || e._pt) && !ue, p && t <= 0 && v.render(me, !0, !0);
}, Tn = function(e, t, a, i, r, n, s, l) {
...
}, wr = qa + "repeat,repeatDelay,yoyo,repeatRefresh,yoyoEase,easeReverse,autoRevert", br = {};
ee(wr + ",id,stagger,delay,duration,paused,scrollTrigger", function(o) {
  return br[o] = 1;
});
var Y = /* @__PURE__ */ (function(o) {
  ...
  function e(a, i, r, n) {
    ...
    var l = s.vars, d = l.duration, c = l.delay, u = l.immediateRender, p = l.stagger, m = l.overwrite, g = l.keyframes, h = l.defaults, f = l.scrollTrigger, b = i.parent || z, _ = (Z(a) || Hi(a) ? Te(a[0]) : "length" in i) ? [a] : ge(a), x, v, y, k, A, S, C, E;
    if (s._targets = _.length ? Ha(_) : Nt("GSAP target " + a + " not found. https://gsap.com", !le.nullTargetWarn) || [], s._ptLookup = [], s._overwrite = m, g || p || qt(d) || qt(c)) {
      ...
      if (x = s.timeline = new K({
        ...
        if (k = _.length, C = p && rr(p), ve(p))
          for (A in p)
            ~wr.indexOf(A) && (E || (E = {}), E[A] = p[A]);
        for (v = 0; v < k; v++)
          y = Zt(i, br), y.stagger = 0, H && (y.easeReverse = H), E && ut(y, E), S = _[v], y.duration = +Pt(d, Se(s), v, S, _), y.delay = (+Pt(c, Se(s), v, S, _) || 0) - s._delay, !p && k === 1 && y.delay && (s._delay = c = y.delay, s._start += c, y.delay = 0), x.to(S, y, C ? C(v, S, _) : 0), x._ease = P.none;
        ...
        if (Z(g))
          ...
          y = {};
          for (A in g)
            A === "ease" || A === "easeEach" || Pn(A, g[A], y, g.easeEach);
          for (A in y)
      ...
      s.timeline = 0;
    return m === !0 && !Da && (Me = Se(s), z.killTweensOf(_), Me = 0), ye(b, Se(s), r), i.reversed && s.reverse(), i.paused && s.paused(!0), (u || !d && !g && s._start === O(b._time) && $(u) && nn(Se(s)) && b.data !== "nested") && (s._tTime = -I, s.render(Math.max(0, -c) || 0)), f && er(Se(s), f), s;
  }
  var t = e.prototype;
  return t.render = function(i, r, n) {
    ...
    return this._initted || Ya(this, d), c = this._ease(d / this._dur), Tn(this, i, r, n, s, c, d, l) ? this.resetTo(i, r, n, s, 1) : (na(this, 0), this.parent || Ki(this._dp, this, "_first", "_last", this._dp._sort ? "_start" : 0), this.render(0));
  }, t.kill = function(i, r) {
...
var Va = function(e, t, a) {
  ...
  return q(e[t]) ? _r : Oa(e[t]) && e.setAttribute ? In : Va;
}, yr = function(e, t) {
  ...
  function o(t, a, i, r, n, s, l, d, c) {
    this.t = a, this.s = r, this.c = n, this.p = i, this.r = s || yr, this.d = l || this, this.set = d || Va, this.pr = c || 0, this._next = t, t && (t._prev = this);
  }
  var e = o.prototype;
  return e.modifier = function(a, i, r) {
    this.mSet = this.mSet || this.set, this.set = On, this.m = a, this.mt = r, this.tween = i;
  }, o;
})();
...
le.stringFilter = pr;
var Qe = [], Xt = {}, zn = [], di = 0, Ln = 0, ua = function(e) {
  return (Xt[e] || zn).map(function(t) {
    return t();
  });
}, Ta = function() {
  var e = Date.now(), t = [];
  e - di > 2 && (ua("matchMediaInit"), Qe.forEach(function(a) {
  ...
  function o(t, a) {
    this.selector = a && Ca(a), this.data = [], this._r = [], this.isReverted = !1, this.id = Ln++, t && this.add(t);
  }
  var e = o.prototype;
  ...
  return e.add = function(a, i, r) {
    ...
    var n = new Ar(0, r || this.scope), s = n.conditions = {}, l, d, c;
    D && !n.selector && (n.selector = D.selector), this.contexts.push(n), i = n.add("onMatch", i), n.queries = a;
    for (d in a)
      d === "all" ? c = 1 : (l = _e.matchMedia(a[d]), l && (Qe.indexOf(n) < 0 && Qe.push(n), (s[d] = l.matches) && (c = 1), l.addListener ? l.addListener(Ta) : l.addEventListener("change", Ta)));
  ...
  defaults: function(e) {
    return e && e.ease && (e.ease = Je(e.ease, It.ease)), ri(It, e || {});
  },
  config: function(e) {
    return ri(le, e || {});
  },
...
var Bn = function(e, t) {
  ...
  for (i in t)
    for (r = a.length; r--; )
      n = e._ptLookup[r][i], n && (n = n.d) && (n._pt && (n = Bn(n, i)), n && n.modifier && n.modifier(t[i], e, a[r], i));
}, ha = function(e, t) {
  return {
    name: e,
    headless: 1,
...
}, ha("roundProps", Sa), ha("modifiers"), ha("snap", nr)) || $t;
...
P.Expo;
P.Circ;
var ci, Ie, dt, Xa, We, ui, Ja, Hn = function() {
  return typeof window < "u";
}, Ee = {}, Ye = 180 / Math.PI, ct = Math.PI / 180, $e = Math.atan2, hi = 1e8, Qa = /([A-Z])/g, Gn = /(left|right|width|margin|padding|x)/i, Un = /[\s,\(]\S/, xe = {
...
}, L = "transform", ae = L + "Origin", es = function o(e, t) {
  ...
  if (this.tfm) {
    for (n in this.tfm)
      i[n] = this.tfm[n];
    i.svg && (i.renderTransform(), t.setAttribute("data-svg-origin", this.svgo || "")), r = Ja(), (!r || !r.isStart) && !a[L] && (kr(a), i.zOrigin && a[ae] && (a[ae] += " " + i.zOrigin + "px", i.zOrigin = 0, i.renderTransform()), i.uncache = 1);
  }
}, Tr = function(e, t) {
  var a = {
    target: e,
  ...
  Hn() && window.document && (ci = window, Ie = ci.document, dt = Ie.documentElement, We = Pa("div") || {
    style: {}
  }, Pa("div"), L = gt(L), ae = L + "Origin", We.style.cssText = "border-width:0;line-height:0;position:absolute;padding:0", Er = !!gt("perspective"), Ja = ie.core.reverting, Xa = 1);
}, mi = function(e) {
  ...
  var s = new te(e._pt, t, a, 0, 1, n ? Sr : Cr);
  ...
  var r = parseFloat(a) || 0, n = (a + "").trim().substr((r + "").length) || "px", s = We.style, l = Gn.test(t), d = e.tagName.toLowerCase() === "svg", c = (d ? "client" : "offset") + (l ? "Width" : "Height"), u = 100, p = i === "px", m = i === "%", g, h, f, b;
  if (i === n || !r || fi[i] || fi[n])
    return r;
  if (n !== "px" && !p && (r = o(e, t, a, "px")), b = e.getCTM && Mr(e), (m || n === "%") && (Ee[t] || ~t.indexOf("adius")))
  ...
  if (m && (t === "height" || t === "width")) {
    ...
    (m || n === "%") && !as[oe(h, "display")] && (s.position = oe(e, "position")), h === e && (s.position = "static"), h.appendChild(We), g = We[c], h.removeChild(We), s.position = "absolute";
  return l && m && (f = je(h), f.time = ne.time, f.width = h[c]), U(p ? g * r / u : g && r ? u / g * r : 0);
}, ke = function(e, t, a, i) {
  var r;
  return Xa || Ma(), t in xe && t !== "transform" && (t = xe[t], ~t.indexOf(",") && (t = t.split(",")[0])), Ee[t] && t !== "transform" ? (r = Ft(e, i), r = t !== "transformOrigin" ? r[t] : r.svg ? r.origin : ta(oe(e, ae)) + " " + r.zOrigin + "px") : (r = e.style[t], (!r || r === "auto" || i || ~(r + "").indexOf("calc(")) && (r = ea[t] && ea[t](e, t, a) || oe(e, t) || Xi(e, t) || (t === "opacity" ? 1 : 0))), a && !~(r + "").trim().indexOf(" ") ? Le(e, t, r, a) + a : r;
}, is = function(e, t, a, i) {
  if (!a || a === "none") {
    var r = gt(t, e, 1), n = r && oe(e, r, 1);
    n && n !== a ? (t = r, a = n) : t === "borderColor" && (a = oe(e, "borderTopColor"));
  }
  var s = new te(this._pt, e.style, t, 0, 1, xr), l = 0, d = 0, c, u, p, m, g, h, f, b, _, x, v, y;
  if (s.b = a, s.e = i, a += "", i += "", i.substring(0, 6) === "var(--" && (i = oe(e, i.substring(4, i.indexOf(")")))), i === "auto" && (h = e.style[t], e.style[t] = i, i = oe(e, t) || i, h ? e.style[t] = h : ze(e, t)), c = [a, i], pr(c), a = c[0], i = c[1], p = a.match(st) || [], y = i.match(st) || [], y.length) {
    for (; u = st.exec(i); )
  ...
  if (t.tween && t.tween._time === t.tween._dur) {
    ...
    l && (ze(a, L), n && (n.svg && a.removeAttribute("transform"), i.scale = i.rotate = i.translate = "none", Ft(a, 1), n.uncache = 1, kr(i)));
  }
}, ea = {
  clearProps: function(e, t, a, i, r) {
    if (r.data !== "isFromStart") {
      var n = e._pt = new te(e._pt, t, a, 0, 0, ns);
  ...
  */
}, Lt = [1, 0, 0, 1, 0, 0], Ir = {}, Nr = function(e) {
  return e === "matrix(1, 0, 0, 1, 0, 0)" || e === "none" || !e;
}, bi = function(e) {
  var t = oe(e, L);
  return Nr(t) ? Lt : t.substr(7).match(Gi).map(U);
}, Za = function(e, t) {
  ...
  a ? l !== Lt && (A = m * f - g * h) && (S = v * (f / A) + y * (-h / A) + (h * _ - f * b) / A, C = v * (-g / A) + y * (m / A) - (m * _ - g * b) / A, v = S, y = C) : (k = Pr(e), v = k.x + (~x[0].indexOf("%") ? v / 100 * k.width : v), y = k.y + (~(x[1] || x[0]).indexOf("%") ? y / 100 * k.height : y)), i || i !== !1 && s.smooth ? (b = v - d, _ = y - c, s.xOffset = u + (b * m + _ * h) - b, s.yOffset = p + (b * g + _ * f) - _) : s.xOffset = s.yOffset = 0, s.xOrigin = v, s.yOrigin = y, s.smooth = !!i, s.origin = t, s.originIsAbsolute = !!a, e.style[ae] = "0px 0px", n && (Ne(n, s, "xOrigin", d, v), Ne(n, s, "yOrigin", c, y), Ne(n, s, "xOffset", u, s.xOffset), Ne(n, s, "yOffset", p, s.yOffset)), e.setAttribute("data-svg-origin", v + " " + y);
}, Ft = function(e, t) {
  var a = e._gsap || new gr(e);
  if ("x" in a && !t && !a.uncache)
    return a;
  var i = e.style, r = a.scaleX < 0, n = "px", s = "deg", l = getComputedStyle(e), d = oe(e, ae) || "0", c, u, p, m, g, h, f, b, _, x, v, y, k, A, S, C, E, H, F, N, B, W, V, G, ue, Ke, ft, wt, Be, ti, Ae, qe;
  return c = u = p = h = f = b = _ = x = v = 0, m = g = 1, a.svg = !!(e.getCTM && Mr(e)), l.translate && ((l.translate !== "none" || l.scale !== "none" || l.rotate !== "none") && (i[L] = (l.translate !== "none" ? "translate3d(" + (l.translate + " 0 0").split(" ").slice(0, 3).join(", ") + ") " : "") + (l.rotate !== "none" ? "rotate(" + l.rotate + ") " : "") + (l.scale !== "none" ? "scale(" + l.scale.split(" ").join(",") + ") " : "") + (l[L] !== "none" ? l[L] : "")), i.scale = i.rotate = i.translate = "none"), A = Za(e, a.svg), a.svg && (a.uncache ? (ue = e.getBBox(), d = a.xOrigin - ue.x + "px " + (a.yOrigin - ue.y) + "px", G = "") : G = !t && e.getAttribute("data-svg-origin"), Ia(e, G || d, !!G || a.originIsAbsolute, a.smooth !== !1, A)), y = a.xOrigin || 0, k = a.yOrigin || 0, A !== Lt && (H = A[0], F = A[1], N = A[2], B = A[3], c = W = A[4], u = V = A[5], A.length === 6 ? (m = Math.sqrt(H * H + F * F), g = Math.sqrt(B * B + N * N), h = H || F ? $e(F, H) * Ye : 0, _ = N || B ? $e(N, B) * Ye + h : 0, _ && (g *= Math.abs(Math.cos(_ * ct))), a.svg && (c -= y - (y * H + k * N), u -= k - (y * F + k * B))) : (qe = A[6], ti = A[7], ft = A[8], wt = A[9], Be = A[10], Ae = A[11], c = A[12], u = A[13], p = A[14], S = $e(qe, Be), f = S * Ye, S && (C = Math.cos(-S), E = Math.sin(-S), G = W * C + ft * E, ue = V * C + wt * E, Ke = qe * C + Be * E, ft = W * -E + ft * C, wt = V * -E + wt * C, Be = qe * -E + Be * C, Ae = ti * -E + Ae * C, W = G, V = ue, qe = Ke), S = $e(-N, Be), b = S * Ye, S && (C = Math.cos(-S), E = Math.sin(-S), G = H * C - ft * E, ue = F * C - wt * E, Ke = N * C - Be * E, Ae = B * E + Ae * C, H = G, F = ue, N = Ke), S = $e(F, H), h = S * Ye, S && (C = Math.cos(S), E = Math.sin(S), G = H * C + F * E, ue = W * C + V * E, F = F * C - H * E, V = V * C - W * E, H = G, W = ue), f && Math.abs(f) + Math.abs(h) > 359.9 && (f = h = 0, b = 180 - b), m = U(Math.sqrt(H * H + F * F + N * N)), g = U(Math.sqrt(V * V + qe * qe)), S = $e(W, V), _ = Math.abs(S) > 2e-4 ? S * Ye : 0, v = Ae ? 1 / (Ae < 0 ? -Ae : Ae) : 0), a.svg && (G = e.getAttribute("transform"), a.forceCSS = e.setAttribute("transform", "") || !Nr(oe(e, L)), G && e.setAttribute("transform", G))), Math.abs(_) > 90 && Math.abs(_) < 270 && (r ? (m *= -1, _ += h <= 0 ? 180 : -180, h += h <= 0 ? 180 : -180) : (g *= -1, _ += _ <= 0 ? 180 : -180)), t = t || a.uncache, a.x = c - ((a.xPercent = c && (!t && a.xPercent || (Math.round(e.offsetWidth / 2) === Math.round(-c) ? -50 : 0))) ? e.offsetWidth * a.xPercent / 100 : 0) + n, a.y = u - ((a.yPercent = u && (!t && a.yPercent || (Math.round(e.offsetHeight / 2) === Math.round(-u) ? -50 : 0))) ? e.offsetHeight * a.yPercent / 100 : 0) + n, a.z = p + n, a.scaleX = U(m), a.scaleY = U(g), a.rotation = U(h) + s, a.rotationX = U(f) + s, a.rotationY = U(b) + s, a.skewX = _ + s, a.skewY = x + s, a.transformPerspective = v + n, (a.zOrigin = parseFloat(d.split(" ")[2]) || !t && a.zOrigin || 0) && (i[ae] = ta(d)), a.xOffset = a.yOffset = 0, a.force3D = le.force3D, a.renderTransform = a.svg ? os : Er ? Rr : ss, a.uncache = 0, a;
}, ta = function(e) {
...
}, He = "0deg", bt = "0px", Ge = ") ", Rr = function(e, t) {
  ...
  f !== bt && (v += "perspective(" + f + Ge), (i || r) && (v += "translate(" + i + "%, " + r + "%) "), (y || n !== bt || s !== bt || l !== bt) && (v += l !== bt || y ? "translate3d(" + n + ", " + s + ", " + l + ") " : "translate(" + n + ", " + s + Ge), d !== He && (v += "rotate(" + d + Ge), c !== He && (v += "rotateY(" + c + Ge), u !== He && (v += "rotateX(" + u + Ge), (p !== He || m !== He) && (v += "skew(" + p + ", " + m + Ge), (g !== 1 || h !== 1) && (v += "scale(" + g + ", " + h + Ge), _.style[L] = v || "translate(0, 0)";
}, os = function(e, t) {
  ...
  return s && (u = r.split("_")[1], u === "short" && (d %= n, d !== d % (n / 2) && (d += d < 0 ? n : -n)), u === "cw" && d < 0 ? d = (d + n * hi) % n - ~~(d / n) * n : u === "ccw" && d > 0 && (d = (d - n * hi) % n - ~~(d / n) * n)), e._pt = p = new te(e._pt, t, a, i, d, Yn), p.e = c, p.u = "deg", e._props.push(a), p;
}, _i = function(e, t) {
  for (var a in t)
    e[a] = t[a];
  return e;
...
var Dr = {
  ...
  init: function(e, t, a, i, r) {
    ...
    Xa || Ma(), this.styles = this.styles || Tr(e), S = this.styles.props, this.tween = a;
    for (h in t)
      if (h !== "autoRound" && (c = t[h], !(re[h] && fr(h, t, a, i, e, r)))) {
        if (m = typeof c, g = ea[h], m === "function" && (c = c.call(a, i, e, r), m = typeof c), m === "string" && ~c.indexOf("random(") && (c = Dt(c)), g)
          ...
          if (l && h in l ? (d = typeof l[h] == "function" ? l[h].call(a, i, e, r) : l[h], j(d) && ~d.indexOf("random(") && (d = Dt(d)), Q(d + "") || d === "auto" || (d += le.units[h] || Q(ke(e, h)) || ""), (d + "").charAt(1) === "=" && (d = ke(e, h))) : d = ke(e, h), p = parseFloat(d), _ = m === "string" && c.charAt(1) === "=" && c.substr(0, 2), _ && (c = c.substr(2)), u = parseFloat(c), h in xe && (h === "autoAlpha" && (p === 1 && ke(e, "visibility") === "hidden" && u && (p = 0), S.push("visibility", 0, s.visibility), Ne(this, s, "visibility", p ? "inherit" : "hidden", u ? "inherit" : "hidden", !u)), h !== "scale" && h !== "transform" && (h = xe[h], ~h.indexOf(",") && (h = h.split(",")[0]))), x = h in Ee, x) {
            ...
            if (v || (y = e._gsap, y.renderTransform && !t.parseTransform || Ft(e, t.parseTransform), k = t.smoothOrigin !== !1 && y.smooth, v = this._pt = new te(this._pt, s, L, 0, 1, y.renderTransform, y, 0, -1), v.dep = 1), h === "scale")
              ...
              S.push(ae, 0, s[ae]), c = rs(c), y.svg ? Ia(e, c, 0, k, 0, this) : (b = parseFloat(c.split(" ")[2]) || 0, b !== y.zOrigin && Ne(this, y, "zOrigin", y.zOrigin, b), Ne(this, s, h, ta(d), ta(c)));
              continue;
            } else if (h === "svgOrigin") {
              Ia(e, c, 1, k, 0, this);
              continue;
            } else if (h in Ir) {
              ls(this, y, h, p, _ ? lt(p, _ + c) : c);
              continue;
          ...
          if (x || (u || u === 0) && (p || p === 0) && !Un.test(c) && h in s)
            f = (d + "").substr((p + "").length), u || (u = 0), b = Q(c) || (h in le.units ? le.units[h] : f), f !== b && (p = Le(e, h, d, b)), this._pt = new te(this._pt, x ? y : s, h, p, (_ ? lt(p, _ + u) : u) - p, !x && (b === "px" || h === "zIndex") && t.autoRound !== !1 ? jn : Ea), this._pt.u = b || 0, x && C !== c ? (this._pt.b = d, this._pt.e = C, this._pt.r = Wn) : f !== b && b !== "%" && (this._pt.b = d, this._pt.r = Vn);
          else if (h in s)
            is.call(this, e, h, d, _ ? _ + c : c);
          else if (h in e)
  ...
  getSetter: function(e, t, a) {
    var i = xe[t];
    return i && i.indexOf(",") < 0 && (t = i), t in Ee && t !== ae && (e._gsap.x || ke(e, "x")) ? a && ui === a ? t === "scale" ? Zn : Qn : (ui = a || {}) && (t === "scale" ? Kn : $n) : e.style && !Oa(e.style[t]) ? Xn : ~t.indexOf("-") ? Jn : Wa(e, t);
  },
  core: {
    _removeProperty: ze,
    _getMatrix: Za
...
ie.core.getStyleSaver = Tr;
(function(o, e, t, a) {
  var i = ee(o + "," + e + "," + t, function(r) {
    Ee[r] = 1;
  });
  ee(e, function(r) {
    le.units[r] = "deg", Ir[r] = 1;
...
ie.registerPlugin(Dr);
var w = ie.registerPlugin(Dr) || ie;
w.core.Tween;
const cs = [
...
], us = 1.28, T = (o) => Number((o * us).toFixed(3)), hs = {
  duration: T(0.44),
  ease: "back.out(1.7)"
}, yi = {
  startOverlap: "-=0.08",
  ...
  revealEase: "power3.inOut",
  cardDuration: T(0.28)
}, gs = 96, Ai = ".wa-cursor-file, .wa-file-landing-clone, .wa-csv-drop", fs = "[data-marketing-data-sources-grid]", ma = {
  offscreenMargin: 96,
...
class ws {
  ...
  renderFileLandingClones(e, t) {
    ...
    for (const i of e) {
      const r = i.target.getBoundingClientRect(), n = r.left - a.left, s = r.top - a.top, l = bs(
...
function Ht(o, e, t) {
  const a = Or(t.seed), i = _s(o, e), r = t.speed ?? "normal", n = t.intent ?? "hover";
  ...
  const s = e.x - o.x, l = e.y - o.y, d = s / i, c = l / i, u = -c, p = d, m = a() > 0.5 ? 1 : -1, g = t.curve ?? 1, f = kt(i * (n === "drag" ? 0.1 : n === "click" ? 0.17 : 0.22) * g, 18, 150) * m * (0.72 + a() * 0.44), b = i / xs[r] + 0.16, _ = kt(b * vs[n] * As, 0.3, 1.66), x = t.overshoot === !1 || i < 120 ? 0 : typeof t.overshoot == "number" ? t.overshoot : kt(i * 0.026, 4, 18), v = x > 0 ? {
    x: e.x + d * x,
    y: e.y + c * x
  } : e, y = {
...
const Si = "button, a, [role='button'], [data-send-button], [data-result-action]", ki = "[data-chat-input], [data-signup-field], input, textarea, [contenteditable='true']", ga = {
  ...
  minTopInset: 74,
  maxTopInset: 190
}, et = "http://www.w3.org/2000/svg", Cs = -135, Ss = 0.34;
class ks {
  constructor(e, t, a = {}) {
  ...
  renderMimicRotation(e, t) {
    ...
    if (a * a + i * i < 4) return;
    const r = Math.atan2(i, a) * 180 / Math.PI, n = Ts(r - Cs), s = this.rotationState + Es(this.rotationState, n) * Ss;
...
function Na() {
  ...
  const e = document.createElementNS(et, "g");
  e.classList.add("wa-cursor-svg__tail");
  const t = document.createElementNS(et, "path");
  t.classList.add("wa-cursor-svg__tail-shape"), t.setAttribute("d", "M8.7 20.5L14.4 20.5L18.2 34.6L13.5 36.2Z");
  const a = document.createElementNS(et, "path");
  a.classList.add("wa-cursor-svg__tail-outline"), a.setAttribute("d", "M8.7 20.5L13.5 36.2L18.2 34.6L14.4 20.5"), e.append(t, a);
...
class Ms {
  ...
  createComponentBody(e) {
    if (e.component ??= Os(e.text), e.component.kind === "table") return this.createTableComponentBody(e, e.component);
  ...
  addStep(e) {
    const t = Rs(e, Ds(e), ""), a = this.activeStory.steps, i = a.findIndex((n) => n.id === this.selectedStepId), r = i >= 0 ? i + 1 : a.length;
  ...
  handleComponentInput(e) {
    ...
    !i?.component || !a || (Ys(i.component, a, e.value, {
  ...
  return ({
    ...
    "research-brief": [
      { kind: "user", text: "Start with these 10 best-fit buyers.", note: "" },
      {
        ...
        component: Pi("10 best-fit buyers", [
      ...
      },
      {
        ...
        component: Pi("50-person expanded list", [
          ["Maya Patel", "OrbitGrid", "VP Revenue", "High"],
          ["Evan Brooks", "Northstar Dev", "Head of Growth", "High"],
          ["Clara Wong", "BrightLayer", "RevOps Lead", "Med"],
          ["Sam Hollis", "Apollo", "Growth Lead", "Med"],
...
function Ws(o) {
  return {
    ...o,
    id: zr("step"),
    component: o.component ? js(o.component) : void 0
  };
}
function js(o) {
...
function Ii(o) {
  ...
  if (e.setAttribute("viewBox", "0 0 20 20"), e.setAttribute("aria-hidden", "true"), e.setAttribute("focusable", "false"), o === "copy" && Ni(e, "M7 7.5h8v8H7z M5 13H4.5a1 1 0 0 1-1-1V4.5a1 1 0 0 1 1-1H12a1 1 0 0 1 1 1V5"), o === "x" && Ni(e, "M5.5 5.5l9 9 M14.5 5.5l-9 9"), o === "grip")
    for (const t of [7, 13])
...
const Ri = {
  ...
  tablet: -66,
  mobile: -48
}), Qs = be("[data-send-button]", "center"), Ka = {
  desktop: {
...
}, Zs = 2.8, Ks = 42, $s = 2, eo = 3, aa = "[data-chat-shell] [data-chat-thread]", to = `${aa} [data-message-role="assistant"]:not(.wa-message--component) [data-message-body]`, ao = `${aa} [data-message-role="assistant"].wa-message--thinking .wa-research-step[data-step-state="current"] .wa-research-step__body, ${aa} [data-message-role="assistant"].wa-message--thinking .wa-research-step[data-step-state="complete"] .wa-research-step__label`, Di = 0.24, io = 0.3, rt = {
...
function ro(o, e, t, a, i) {
  switch (t.kind) {
    ...
    case "transitionSignupToChat":
      ...
      return;
    case "assistant":
      o.add(e.chat.assistantMessage(t.text), t.at), oo(o, e, i, {
        kind: "assistant",
        key: t.text,
        text: t.text,
        selector: to,
      ...
      return;
    case "thinking":
      t.statusBefore && o.add(e.chat.setStatus(t.statusBefore), t.at), o.add(e.chat.thinkingState(t.label, t.hold), t.statusBefore ? void 0 : t.at), Oi(o, e, i, t.hold, 1, t.label, a);
      return;
    case "research":
      t.statusBefore && o.add(e.chat.setStatus(t.statusBefore), t.at), o.add(e.chat.researchSequence(t.steps, t.hold), t.statusBefore ? void 0 : t.at), Oi(o, e, i, t.hold, t.steps.length, t.steps.join("|"), a);
      return;
    case "dataTable":
      tt(
        o,
...
function Oi(o, e, t, a = R.thinkingShort, i = 1, r = "thinking", n = 0) {
  const s = a * Math.max(1, i), l = i >= 3 && Lr(e, t, {
    kind: "thinking",
    key: r,
    text: r,
    stepIndex: n,
...
function Lr(o, e, t) {
  ...
  const n = e.textSkimCount === 0, s = t.stepIndex - e.lastTextSkimStep >= $s, l = co(`${o.story.id}:${t.kind}:${r}:${t.key}`), d = r > 0 && r % 3 === 0, c = n || s && (l >= 0.58 || d);
...
const ho = [
  ...
  },
  {
    ...
    build: (o) => {
      ...
      return vt(o, [
        ...
        { kind: "custom", build: () => o.chat.outreachStyleProfile(xo), at: "-=0.02" },
        {
          kind: "assistant",
        ...
        { kind: "custom", build: () => o.chat.proximityLeadList(Ao), at: "-=0.04" },
  ...
  },
  {
    ...
    build: (o) => vt(o, [
      ...
      { kind: "dataTable", config: qr, at: "-=0.02" },
      {
        kind: "prompt",
      ...
      { kind: "sequenceEngagement", config: So, at: "-=0.04" },
  ...
  },
  {
    ...
    build: (o) => {
      ...
      return vt(o, [
        ...
        { kind: "dataTable", config: ko, at: "-=0.04" },
...
class Eo {
  ...
  followPointer = () => {
    ...
    if (this.mode === "return") {
      ...
      if (this.target = t, this.cursor.mimicViewportPoint(t, zi.smoothing, t), it(this.getCursorViewportPoint(), t) <= zi.arriveDistance) {
        this.completeReturn();
        return;
      }
      this.scheduleFollow();
  ...
  updateFollowTarget(e) {
    ...
    if (this.lastPointer) {
      ...
      i > 1.5 && (this.trailDirection = {
        x: a.x / i,
        y: a.y / i
      }, this.velocity = Mo(a, J.maxMomentumStep));
    }
    const t = {
  ...
  isCursorTooFarFromBrowser() {
    ...
    return Po(i, e) > J.maxBrowserDistance;
  }
  ...
  countAxisReversals(e) {
    ...
    for (let r = 1; r < e.length; r += 1) {
      const n = e[r - 1], s = e[r], l = Li(s.x - n.x), d = Li(s.y - n.y);
...
class No {
  ...
  seekTo(e, t = 0.28) {
    ...
    const a = Ro(e), i = this.activeTimeline.duration();
...
class Do {
  ...
  resolve(e, t = "target") {
    ...
    if (s = {
      ...
      const l = Or(t), d = Math.min(n.width * 0.18, 18), c = Math.min(n.height * 0.18, 14);
...
function zo(o, e = {}) {
  Oo(o, { showBuilder: e.showBuilder !== !1 });
  const t = e.stories?.length ? e.stories : Hr, a = new Do(o), i = new ws(o), r = new ks(o, a, {
  ...
  }), s = n.destroy.bind(n), l = e.showBuilder === !1 ? null : new Ms(o, t, {
...
function Ur(o = "[data-chatbot-stories]", e = {}) {
  return e.injectStyles !== !1 && Fo(), zo(Bo(o), e);
}
const qo = {
  init: Ur,
  defaultStories: Hr
