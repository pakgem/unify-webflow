      ...
      try {
        ...
        if (e.status === 404) {
          ...
          if (zt(i) && i.error === "not_found") {
            this.setStatus("seeding database draft"), this.loadingRemoteDraft = !1, this.queueRemoteSave();
            return;
          }
...
}, ro = Q("[data-signup-field]", "center", {
  desktop: -74,
  tablet: -66,
  mobile: -48
}), no = Q("[data-send-button]", "center"), ai = {
  desktop: {
...
}, so = 2.8, oo = 42, lo = 2, co = 3, aa = "[data-chat-shell] [data-chat-thread]", uo = `${aa} [data-message-role="assistant"]:not(.wa-message--component) [data-message-body]`, po = `${aa} [data-message-role="assistant"].wa-message--thinking .wa-research-step[data-step-state="current"] .wa-research-step__body, ${aa} [data-message-role="assistant"].wa-message--thinking .wa-research-step[data-step-state="complete"] .wa-research-step__label`, qi = 0.24, ho = 0.3, kt = {
...
function mo(o, e, t, a, i) {
  switch (t.kind) {
    ...
    case "transitionSignupToChat":
      ...
      return;
    case "assistant":
      o.add(e.chat.assistantMessage(t.text), t.at), _o(o, e, i, {
        kind: "assistant",
        key: t.text,
        text: t.text,
        selector: uo,
    ...
    case "thinking": {
      const r = go(t);
      t.statusBefore && o.add(e.chat.setStatus(t.statusBefore), t.at), o.add(e.chat.thinkingState(r, t.hold), t.statusBefore ? void 0 : t.at), bo(o, e, i, t.hold, r.length, r.join("|"), a);
      return;
    }
    case "dataTable":
      it(
...
function bo(o, e, t, a = B.thinkingShort, i = 1, r = "thinking", n = 0) {
...
function zr(o, e, t) {
  ...
  if (a.length < i || e.textSkimCount >= co) return !1;
  const r = e.textCandidateCount;
  e.textCandidateCount += 1;
  const n = e.textSkimCount === 0, s = t.stepIndex - e.lastTextSkimStep >= lo, l = xo(`${o.story.id}:${t.kind}:${r}:${t.key}`), d = r > 0 && r % 3 === 0, c = n || s && (l >= 0.58 || d);
...
const So = [
  ...
  pagination: {
    ...
    pages: [
      ...
      { page: 2, range: "11-20 of 50 people", rows: Bo }
    ]
  },
  actions: [
    {
...
}, Lr = [
  {
    ...
    build: (o) => xt(o, [
      ...
      { kind: "thinking", steps: So, hold: 0.46, at: "+=0.04" },
  ...
  },
  {
    ...
    build: (o) => xt(o, [
      ...
      { kind: "enrichmentPanel", config: Eo, at: "+=0.12" },
      { kind: "status", text: "Contacts enriched", at: "+=0.86" },
      { kind: "dataTable", config: Io, at: "-=0.02" },
      { kind: "marketingDataSourcesGrid", config: Po, at: "+=0.44" },
      Wt(kt.bottomRight, "+=3")
    ])
  },
  {
    ...
    build: (o) => {
      ...
      return xt(o, [
        ...
        { kind: "custom", build: () => o.chat.outreachStyleProfile(Ro), at: "-=0.02" },
        {
          kind: "assistant",
        ...
        { kind: "custom", build: () => o.chat.proximityLeadList(No), at: "-=0.04" },
  ...
  },
  {
    ...
    build: (o) => {
      ...
      return xt(o, [
        ...
        { kind: "custom", build: () => o.chat.sequenceBuildThinking(Oo), at: "+=0.06" },
        { kind: "sequenceEngagement", config: qo, at: "-=0.02" },
...
class Ho {
  ...
  followPointer = () => {
    ...
    if (this.mode === "return") {
      const t = this.getReturnHomePoint(), a = Wo((e - this.returnStartedAt) / xa.durationMs), i = this.getReturnWavePoint(a, t), r = this.getReturnWavePoint(Math.min(1, a + 0.035), t);
  ...
  getReturnWavePoint(e, t) {
    const a = this.returnStart ?? this.getCursorViewportPoint(), i = Uo(e), r = t.x - a.x, n = t.y - a.y, s = Math.hypot(r, n), l = {
      x: a.x + r * i,
      y: a.y + n * i
    };
    if (s < 1) return l;
  ...
  isCursorTooFarFromBrowser() {
    ...
    return Go(i, e) > J.maxBrowserDistance;
  }
...
class Yo {
  constructor(e, t, a, i, r, n) {
    this.root = e, this.stories = t, this.resolver = a, this.cursor = i, this.chat = r, this.options = n, this.storyProgress = this.stories.map(() => 0), this.pausedCursorMimic = new Ho(this.root, this.cursor, {
  ...
  seekTo(e, t = 0.28) {
    ...
    const a = Xo(e), i = this.activeTimeline.duration();
  ...
  attachChatHistoryScroll() {
    ...
    const a = (i) => {
      ...
      if (Math.abs(r) < jo.minPixelDelta) return;
...
function Zo(o, e = {}) {
  Qo(o, { showBuilder: e.showBuilder !== !1 });
  const t = e.stories?.length ? e.stories : Lr, a = new Jo(o), i = new _s(o), r = new Es(o, a, {
...
function Hr(o = "[data-chatbot-stories]", e = {}) {
  return e.injectStyles !== !1 && $o(), Zo(el(o), e);
}
const tl = {
  init: Hr,
  defaultStories: Lr
