...
var le = {
  ...
  overwrite: !1,
  delay: 0
}, Pa, J, R, pe = 1e8, M = 1 / pe, ma = Math.PI * 2, Bi = ma / 4, qi = 0, Dr = Math.sqrt, Hi = Math.cos, Gi = Math.sin, j = function(e) {
...
}, Z = Array.isArray, Ui = /random\([^)]+\)/g, Yi = /,\s*/g, Qa = /(?:-?\.?\d|\.)+/gi, zr = /[-+=.]*\d+[.e\-+]*\d*[e\-+]*\d*/g, et = /[-+=.]*\d+[.e-]*\d*[a-z%]*/g, aa = /[-+=.]*\d+\.?\d*(?:e-|e\+)?\d*/gi, Lr = /[+-]=-?[.\d]+/, Vi = /[^,'"\[\]\s]+/gi, Wi = /^[+\-=e\s\d]*\d+[.\d]*([a-z]*|%)\s*$/i, z, fe, ga, Na, de = {}, Vt = {}, Fr, Br = function(e) {
  ...
  return t.parent && Ne(t), t._start = O((Ce(a) ? a : a || e !== z ? he(e, a, t) : e._time) + t._delay), t._end = O(t._start + (t.totalDuration() / Math.abs(t.timeScale()) || 0)), Wr(e, t, "_first", "_last", e._sort ? "_start" : 0), ba(t) || (e._recent = t), r || jr(e, t), e._ts < 0 && ta(e, e._tTime), e;
}, Jr = function(e, t) {
  return (de.ScrollTrigger || Ra("scrollTrigger", t)) && de.ScrollTrigger.create(t, e);
  ...
  if (s && e._repeat && (l = Ot(0, e._tDur, t), c = st(l, s), e._yoyo && c & 1 && (n = 1 - n), c !== st(e._tTime, s) && (i = 1 - n, e.vars.repeatRefresh && e._initted && e.invalidate())), n !== i || J || r || e._zTime === M || !t && e._zTime) {
    ...
    for (u = e._zTime, e._zTime = t || (a ? M : 0), a || (a = t && !u), e.ratio = n, e._from && (n = 1 - n), e._time = 0, e._tTime = l, d = e._pt; d; )
      d.r(n, d.d), d = d._next;
    t < 0 && wa(e, t, a, !0), e._onUpdate && !a && se(e, "onUpdate"), l && e._repeat && !a && e.parent && se(e, "onRepeat"), (t >= e._tDur || t < 0) && e.ratio === n && (n && Ne(e, 1), !a && !J && (se(e, n ? "onComplete" : "onReverseComplete", !0), e._prom && e._prom()));
  ...
  return R && !t && R.selector ? R.selector(e) : j(e) && !a && (ga || !lt()) ? _a.call((t || Na).querySelectorAll(e), 0) : Z(e) ? sn(e, a) : Qr(e) ? _a.call(e, 0) : e ? [e] : [];
}, xa = function(e) {
  return e = me(e)[0] || Et("Invalid scope") || {}, function(t) {
    var a = e.current || e.nativeElement || e;
    return me(t, a.querySelectorAll ? a : a === e ? Et("Invalid scope") || Na.createElement("div") : e);
  };
}, Zr = function(e) {
  ...
  if (i)
    return l = r[t + "Params"], d = r.callbackScope || e, a && Ie.length && Wt(), s && (R = s), c = l ? i.apply(d, l) : i.call(d), R = n, c;
}, xt = function(e) {
  ...
  return u = {
    ...
    wake: function() {
      Fr && (!ga && Ma() && (fe = ga = window, Na = fe.document || {}, de.gsap = re, (fe.gsapVersions || (fe.gsapVersions = [])).push(re.version), Br(Vt || fe.GreenSockGlobals || !fe.gsap && fe || {}), ri.forEach(ii)), c = typeof requestAnimationFrame < "u" && requestAnimationFrame, l && u.sleep(), d = c || function(f) {
...
var K = /* @__PURE__ */ (function(o) {
  ...
  return t.to = function(r, i, n) {
    ...
    var n = this;
    if (Ce(i) || (i = he(this, i, r)), !(r instanceof Nt)) {
      if (Z(r))
...
var xn = function(e, t, a, r, i, n, s) {
  ...
  if (j(r) && (~r.indexOf("random(") && (r = It(r)), r.charAt(1) === "=" && (g = at(p, r) + (Q(p) || 0), (g || g === 0) && (r = g))), !c || p !== r || va)
    return !isNaN(p * r) && r !== "" ? (g = new te(this._pt, e, t, +p || 0, r - (p || 0), typeof u == "boolean" ? Tn : mi, 0, m), d && (g.fp = d), s && g.modifier(s, this, e), this._pt = g) : (!u && !(t in e) && Ra(t, r), xn.call(this, e, t, p, r, m, l || le.stringFilter, d));
  ...
  var r = e.vars, i = r.ease, n = r.startAt, s = r.immediateRender, l = r.lazy, d = r.onUpdate, c = r.runBackwards, u = r.yoyoEase, p = r.keyframes, m = r.autoRevert, g = e._dur, h = e._startAt, f = e._targets, _ = e.parent, w = _ && _.data === "nested" ? _.vars.targets : f, x = e._overwrite === "auto" && !Pa, v = e.timeline, b = r.easeReverse || u, S, A, C, k, T, H, F, N, B, W, V, G, ue;
  if (v && (!p || !i) && (i = "none"), e._ease = We(i, Tt.ease), e._rEase = b && (We(b) || e._ease), e._from = !v && !!r.runBackwards, e._from && (e.ratio = 1), !v || p && !r.stagger) {
    if (N = f[0] ? Ye(f[0]).harness : 0, G = N && r[N.prop], S = jt(r, Da), h && (h._zTime < 0 && h.progress(1), t < 0 && c && s && !m ? h.render(-1, !0) : h.revert(c && g ? Gt : ji), h._lazy = 0), n) {
      ...
      }, S), G && (C[N.prop] = G), Ne(e._startAt = Y.set(f, C)), e._startAt._dp = 0, e._startAt._sat = e, t < 0 && (J ? e._startAt.revert(Gt) : e._startAt.render(-1, !0)), e._zTime = t, !s)
        o(e._startAt, M, M);
      else if (!t)
        return;
    }
    for (e._pt = e._ptCache = 0, l = g && $(l) || l && !g, A = 0; A < f.length; A++) {
      if (T = f[A], F = T._gsap || za(f)[A]._gsap, e._ptLookup[A] = W = {}, fa[F.id] && Ie.length && Wt(), V = w === f ? A : w.indexOf(T), N && (B = new N()).init(T, G || S, e, V, w) !== !1 && (e._pt = k = new te(e._pt, T, B.name, 0, 1, B.render, B, 0, B.priority), B._props.forEach(function(Xe) {
        W[Xe] = k;
      }), B.priority && (H = 1)), !N || G)
        for (C in S)
...
var Y = /* @__PURE__ */ (function(o) {
  ...
  return t.render = function(r, i, n) {
    ...
    if (!d)
      ...
      for (m = this._pt; m; )
        m.r(w, m.d), m = m._next;
      x && x.render(r < 0 ? r : x._dur * x._ease(p / this._dur), i, n) || this._startAt && (this._zTime = r), this._onUpdate && !i && (c && wa(this, r, i, n), se(this, "onUpdate")), this._repeat && g !== f && this.vars.onRepeat && !i && this.parent && se(this, "onRepeat"), (u === this._tDur || !u) && this._tTime === u && (c && !this._onUpdate && wa(this, r, !0, !0), (r || !d) && (u === this._tDur && this._ts > 0 || !u && this._ts < 0) && Ne(this, 1), !i && !(c && !s) && (u || s || _) && (se(this, u === l ? "onComplete" : "onReverseComplete", !0), this._prom && !(u < l && this.timeScale() > 0) && this._prom()));
    }
    return this;
  }, t.targets = function() {
...
le.stringFilter = oi;
var je = [], Yt = {}, Mn = [], rr = 0, Nn = 0, oa = function(e) {
  ...
  function o(t, a) {
    this.selector = a && xa(a), this.data = [], this._r = [], this.isReverted = !1, this.id = Nn++, t && this.add(t);
  }
  var e = o.prototype;
...
var ir, Ee, rt, Ua, Ue, nr, Ya, zn = function() {
  ...
  if (s.b = a, s.e = r, a += "", r += "", r.substring(0, 6) === "var(--" && (r = oe(e, r.substring(4, r.indexOf(")")))), r === "auto" && (h = e.style[t], e.style[t] = r, r = oe(e, t) || r, h ? e.style[t] = h : Re(e, t)), c = [a, r], oi(c), a = c[0], r = c[1], p = a.match(et) || [], b = r.match(et) || [], b.length) {
    for (; u = et.exec(r); )
  ...
  if (t.tween && t.tween._time === t.tween._dur) {
    ...
    l && (Re(a, L), n && (n.svg && a.removeAttribute("transform"), r.scale = r.rotate = r.translate = "none", Dt(a, 1), n.uncache = 1, xi(r)));
  }
}, Qt = {
  ...
  */
}, Rt = [1, 0, 0, 1, 0, 0], Ci = {}, Si = function(e) {
  return e === "matrix(1, 0, 0, 1, 0, 0)" || e === "none" || !e;
}, hr = function(e) {
  var t = oe(e, L);
  return Si(t) ? Rt : t.substr(7).match(zr).map(U);
}, Wa = function(e, t) {
  var a = e._gsap || Ye(e), r = e.style, i = hr(e), n, s, l, d;
  return a.svg && e.getAttribute("transform") ? (l = e.transform.baseVal.consolidate().matrix, i = [l.a, l.b, l.c, l.d, l.e, l.f], i.join(",") === "1,0,0,1,0,0" ? Rt : i) : (i === Rt && !e.offsetParent && e !== rt && !a.svg && (l = r.display, r.display = "block", n = e.parentNode, (!n || !e.offsetParent && !e.getBoundingClientRect().width) && (d = 1, s = e.nextElementSibling, rt.appendChild(e)), i = hr(e), l ? r.display = l : Re(e, "display"), d && (s ? n.insertBefore(e, s) : n ? n.appendChild(e) : rt.removeChild(e))), t && i.length > 6 ? [i[0], i[1], i[4], i[5], i[12], i[13]] : i);
  ...
  r.svg ? (d = a.getAttribute("transform"), a.setAttribute("transform", ""), n[L] = t, s = Dt(a, 1), Re(a, L), a.setAttribute("transform", d)) : (d = getComputedStyle(a)[L], n[L] = t, s = Dt(a, 1), n[L] = d);
  for (l in Se)
  ...
  revealCsvDropArea(e) {
    return y.timeline().to(
      {},
      {
        duration: 1e-3,
        onStart: () => {
          e.dataset.dropComplete !== "true" && (e.dataset.dropState = "idle", e.isConnected || this.chatShell.append(e), y.set(e, {
            autoAlpha: 1,
  ...
  completeCsvDropArea(e) {
    return y.timeline().to(
      {},
      {
        duration: 1e-3,
        onStart: () => {
          e.dataset.dropState = "complete", e.dataset.dropComplete = "true", y.killTweensOf(e), y.set(e, { autoAlpha: 0 }), e.remove();
        }
      }
    );
  }
...
function Pr(o, e, t, a = D.thinkingShort, r = 1, i = "thinking", n = 0) {
  const s = a * Math.max(1, r), l = r >= 3 && Ni(e, t, {
    kind: "thinking",
    key: i,
    text: i,
    stepIndex: n,
...
function To() {
  ...
  o.id = Nr, o.textContent = So, document.head.append(o);
}
function Eo(o) {
