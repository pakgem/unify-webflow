...
var we = {
...
}, ae = Array.isArray, qo = /random\([^)]+\)/g, Lo = /,\s*/g, Ki = /(?:-?\.?\d|\.)+/gi, nr = /[-+=.]*\d+[.e\-+]*\d*[e\-+]*\d*/g, At = /[-+=.]*\d+[.e-]*\d*[a-z%]*/g, Fa = /[-+=.]*\d+\.?\d*(?:e-|e\+)?\d*/gi, rr = /[+-]=-?[.\d]+/, No = /[^,'"\[\]\s]+/gi, Oo = /^[+\-=e\s\d]*\d+[.\d]*([a-z]*|%)\s*$/i, V, Re, ui, Pi, be = {}, _a = {}, or, sr = function(e) {
  return (_a = Rt(e, be)) && de;
}, Ri = function(e, t) {
  return console.warn("Invalid property", e, "set to", t, "Missing plugin? gsap.registerPlugin()");
}, Qt = function(e, t) {
  return !t && console.warn(e);
}, lr = function(e, t) {
  return e && (be[e] = t) && _a && (_a[e] = t) || be;
}, jt = function() {
  return 0;
}, Bo = {
  suppressEvents: !0,
  ...
  et.length && !Z && va(), e.render(t, a, !!(Z && t < 0 && Li(e))), et.length && !Z && va();
}, hr = function(e) {
  var t = parseFloat(e);
  ...
  return t.parent && at(t), t._start = G((Ge(a) ? a : a || e !== V ? ve(e, a, t) : e._time) + t._delay), t._end = G(t._start + (t.totalDuration() / Math.abs(t.timeScale()) || 0)), gr(e, t, "_first", "_last", e._sort ? "_start" : 0), gi(t) || (e._recent = t), i || mr(e, t), e._ts < 0 && qa(e, e._tTime), e;
}, fr = function(e, t) {
  ...
  return X(i) ? d = u = {
    ...
    var p = (m || t).length, w = r[p], y, b, x, v, _, T, A, C, k;
    if (!w) {
      ...
      for (w = r[p] = [], y = l ? Math.min(k, p) * d - 0.5 : i % k, b = k === Ae ? 0 : l ? p * u / k - 0.5 : i / k | 0, A = 0, C = Ae, T = 0; T < p; T++)
        x = T % k - y, v = b - (T / k | 0), w[T] = _ = c ? Math.abs(c === "y" ? v : x) : ar(x * x + v * v), _ > A && (A = _), _ < C && (C = _);
  ...
  if (n)
    return l = i[t + "Params"], c = i.callbackScope || e, a && et.length && va(), s && (H = s), d = l ? n.apply(c, l) : n.call(c), H = r, d;
}, zt = function(e) {
  ...
  var o = Date.now, e = 500, t = 33, a = o(), i = a, n = 1e3 / 240, r = n, s = [], l, c, d, u, h, g, m = function p(w) {
    var y = o() - i, b = w === !0, x, v, _, T;
    if ((y > e || y < 0) && (a += y - t), i += y, _ = i - a, x = _ - r, (x > 0 || b) && (T = ++u.frame, h = _ - u.time * 1e3, u.time = _ = _ / 1e3, r += x + (x >= n ? 4 : n - x), v = 1), b || (l = c(p)), v)
  ...
  return u = {
    ...
    wake: function() {
      or && (!ui && Mi() && (Re = ui = window, Pi = Re.document || {}, be.gsap = de, (Re.gsapVersions || (Re.gsapVersions = [])).push(de.version), sr(_a || Re.GreenSockGlobals || !Re.gsap && Re || {}), kr.forEach(Cr)), d = typeof requestAnimationFrame < "u" && requestAnimationFrame, l && u.sleep(), c = d || function(w) {
...
var Rr = function(e, t) {
  ...
  return e.delay = function(a) {
    ...
    return this.totalTime(ve(this, a), oe(i));
...
var re = /* @__PURE__ */ (function(o) {
  ...
  return t.to = function(i, n, r) {
    ...
    return n.duration = 0, n.parent = this, Gt(n).repeatDelay || (n.repeat = 0), n.immediateRender = !!n.immediateRender, new K(i, n, ve(this, r), 1), this;
  }, t.call = function(i, n, r) {
    return Ie(this, K.delayedCall(0, i, n), r);
  }, t.staggerTo = function(i, n, r, s, l, c, d) {
    return r.duration = n, r.stagger = r.stagger || s, r.onComplete = c, r.onCompleteParams = d, r.parent = this, new K(i, r, ve(this, l)), this;
    ...
    var s = this._time, l = this._dirty ? this.totalDuration() : this._tDur, c = this._dur, d = i <= 0 ? 0 : G(i), u = this._zTime < 0 != i < 0 && (this._initted || !c), h, g, m, p, w, y, b, x, v, _, T, A;
    if (this !== V && d > l && i >= 0 && (d = l), d !== this._tTime || r || u) {
      if (s !== this._time && c && (d += this._time - s, i += this._time - s), h = d, v = this._start, x = this._ts, y = !x, u && (c || (s = this._zTime), (i || !n) && (this._zTime = i)), this._repeat) {
        ...
        if (h = G(d % w), d === l ? (p = this._repeat, h = c) : (_ = G(d / w), p = ~~_, p && p === _ && (h = c, p--), h > c && (h = c)), _ = It(this._tTime, w), !s && this._tTime && _ !== p && this._tTime - _ * w - this._dur <= 0 && (_ = p), T && p & 1 && (h = c - h, A = 1), p !== _ && !this._lock) {
          var C = T && _ & 1, k = C === (T && p & 1);
          if (p < _ && (C = !C), s = C ? 0 : d % c ? c : d, this._lock = 1, this.render(s || (A ? 0 : G(p * w)), n, !c)._lock = 0, this._tTime = d, !n && this.parent && me(this, "onRepeat"), this.vars.repeatRefresh && !A && (this.invalidate()._lock = 1, _ = p), s && s !== this._time || y !== !this._ts || this.vars.onRepeat && !this.parent && !this._act)
            return this;
      ...
      if (this._hasPause && !this._forcing && this._lock < 2 && (b = Qo(this, G(s), G(h)), b && (d -= h - (h = b._start))), this._tTime = d, this._time = h, this._act = !!x, this._initted || (this._onUpdate = this.vars.onUpdate, this._initted = 1, this._zTime = i, s = 0), !s && d && c && !n && !_ && (me(this, "onStart"), this._tTime !== d))
        return this;
      if (h >= s && i >= 0)
        for (g = this._first; g; ) {
      ...
      if (b && !n && (this.pause(), b.render(h >= s ? 0 : -B)._zTime = h >= s ? 1 : -1, this._ts))
        return this._start = v, Da(this), this.render(i, n, r);
      this._onUpdate && !n && me(this, "onUpdate", !0), (d === l && this._tTime >= this.totalDuration() || !d && s) && (v === this._start || Math.abs(x) !== Math.abs(this._ts)) && (this._lock || ((i || !c) && (d === l && this._ts > 0 || !d && this._ts < 0) && at(this, 1), !n && !(i < 0 && !s) && (d || s || !l) && (me(this, d === l && i >= 0 ? "onComplete" : "onReverseComplete", !0), this._prom && !(d < l && this.timeScale() > 0) && this._prom())));
    }
    return this;
  }, t.add = function(i, n) {
    var r = this;
    if (Ge(n) || (n = ve(this, n, i)), !(i instanceof Jt)) {
      if (ae(i))
    ...
    return s.data = "isPause", this._hasPause = 1, Ie(this, s, ve(this, i));
    ...
    n = n || {};
    var r = this, s = ve(r, i), l = n, c = l.startAt, d = l.onStart, u = l.onStartParams, h = l.immediateRender, g, m = K.to(r, ye({
      ease: n.ease || "none",
      lazy: !1,
      immediateRender: !1,
      time: s,
    ...
    return i === void 0 && (i = this._time), en(this, ve(this, i));
  }, t.previousLabel = function(i) {
    return i === void 0 && (i = this._time), en(this, ve(this, i), 1);
...
var ds = function(e, t, a, i, n, r, s) {
  ...
  var i = e.vars, n = i.ease, r = i.startAt, s = i.immediateRender, l = i.lazy, c = i.onUpdate, d = i.runBackwards, u = i.yoyoEase, h = i.keyframes, g = i.autoRevert, m = e._dur, p = e._startAt, w = e._targets, y = e.parent, b = y && y.data === "nested" ? y.vars.targets : w, x = e._overwrite === "auto" && !Ti, v = e.timeline, _ = i.easeReverse || u, T, A, C, k, M, F, z, L, U, I, D, P, $;
  if (v && (!h || !n) && (n = "none"), e._ease = wt(n, Yt.ease), e._rEase = _ && (wt(_) || e._ease), e._from = !v && !!i.runBackwards, e._from && (e.ratio = 1), !v || h && !i.stagger) {
    ...
    for (e._pt = e._ptCache = 0, l = m && oe(l) || l && !m, A = 0; A < w.length; A++) {
      if (M = w[A], z = M._gsap || qi(w)[A]._gsap, e._ptLookup[A] = I = {}, hi[z.id] && et.length && va(), D = b === w ? A : b.indexOf(M), L && (U = new L()).init(M, P || T, e, D, b) !== !1 && (e._pt = k = new le(e._pt, M, U.name, 0, 1, U.render, U, 0, U.priority), U._props.forEach(function(Te) {
        I[Te] = k;
      }), U.priority && (F = 1)), !L || P)
        for (C in T)
  ...
  e._onUpdate = c, e._initted = (!e._op || e._pt) && !$, h && t <= 0 && v.render(Ae, !0, !0);
...
var K = /* @__PURE__ */ (function(o) {
  ...
  function e(a, i, n, r) {
    ...
    var l = s.vars, c = l.duration, d = l.delay, u = l.immediateRender, h = l.stagger, g = l.overwrite, m = l.keyframes, p = l.defaults, w = l.scrollTrigger, y = i.parent || V, b = (ae(a) || ir(a) ? Ge(a[0]) : "length" in i) ? [a] : Se(a), x, v, _, T, A, C, k, M;
    if (s._targets = b.length ? qi(b) : Qt("GSAP target " + a + " not found. https://gsap.com", !we.nullTargetWarn) || [], s._ptLookup = [], s._overwrite = g, m || h || ra(c) || ra(d)) {
      ...
      if (x = s.timeline = new re({
        ...
        for (v = 0; v < T; v++)
          _ = Aa(i, qr), _.stagger = 0, F && (_.easeReverse = F), M && Rt(_, M), C = b[v], _.duration = +Wt(c, Be(s), v, C, b), _.delay = (+Wt(d, Be(s), v, C, b) || 0) - s._delay, !h && T === 1 && _.delay && (s._delay = d = _.delay, s._start += d, _.delay = 0), x.to(C, _, k ? k(v, C, b) : 0), x._ease = R.none;
        ...
        if (ae(m))
          ...
          _ = {};
          for (A in m)
            A === "ease" || A === "easeEach" || gs(A, m[A], _, m.easeEach);
          for (A in _)
            for (L = _[A].sort(function(D, P) {
              return D.t - P.t;
...
we.stringFilter = Mr;
var bt = [], ba = {}, _s = [], an = 0, vs = 0, Va = function(e) {
  return (ba[e] || _s).map(function(t) {
    return t();
  });
}, yi = function() {
  var e = Date.now(), t = [];
  ...
  function o(t, a) {
    this.selector = a && fi(a), this.data = [], this._r = [], this.isReverted = !1, this.id = vs++, t && this.add(t);
  }
  var e = o.prototype;
...
}, Wa("roundProps", wi), Wa("modifiers"), Wa("snap", _r)) || ka;
...
var nn, Xe, Tt, Ui, gt, rn, Hi, Cs = function() {
  ...
  Cs() && window.document && (nn = window, Xe = nn.document, Tt = Xe.documentElement, gt = _i("div") || {
    style: {}
  }, _i("div"), W = Lt(W), ce = W + "Origin", gt.style.cssText = "border-width:0;line-height:0;position:absolute;padding:0", Vr = !!Lt("perspective"), Hi = de.core.reverting, Ui = 1);
}, ln = function(e) {
  ...
  var n;
  return Ui || vi(), t in qe && t !== "transform" && (t = qe[t], ~t.indexOf(",") && (t = t.split(",")[0])), Ve[t] && t !== "transform" ? (n = $t(e, i), n = t !== "transformOrigin" ? n[t] : n.svg ? n.origin : Ta(fe(e, ce)) + " " + n.zOrigin + "px") : (n = e.style[t], (!n || n === "auto" || i || ~(n + "").indexOf("calc(")) && (n = Ca[t] && Ca[t](e, t, a) || fe(e, t) || dr(e, t) || (t === "opacity" ? 1 : 0))), a && !~(n + "").trim().indexOf(" ") ? nt(e, t, n, a) + a : n;
}, Hs = function(e, t, a, i) {
  if (!a || a === "none") {
    var n = Lt(t, e, 1), r = n && fe(e, n, 1);
    r && r !== a ? (t = n, a = r) : t === "borderColor" && (a = fe(e, "borderTopColor"));
  }
  var s = new le(this._pt, e.style, t, 0, 1, Or), l = 0, c = 0, d, u, h, g, m, p, w, y, b, x, v, _;
  if (s.b = a, s.e = i, a += "", i += "", i.substring(0, 6) === "var(--" && (i = fe(e, i.substring(4, i.indexOf(")")))), i === "auto" && (p = e.style[t], e.style[t] = i, i = fe(e, t) || i, p ? e.style[t] = p : it(e, t)), d = [a, i], Mr(d), a = d[0], i = d[1], h = a.match(At) || [], _ = i.match(At) || [], _.length) {
    for (; u = At.exec(i); )
      w = u[0], b = i.substring(l, u.index), m ? m = (m + 1) % 5 : (b.substr(-5) === "rgba(" || b.substr(-5) === "hsla(") && (m = 1), w !== (p = h[c++] || "") && (g = parseFloat(p) || 0, v = p.substr((g + "").length), w.charAt(1) === "=" && (w = Ct(g, w) + v), y = parseFloat(w), x = w.substr((y + "").length), l = At.lastIndex - x.length, x || (x = x || we.units[t] || v, l === i.length && (i += x, s.e += x)), v !== x && (g = nt(e, t, p, x) || 0), s._pt = {
        _next: s._pt,
        p: b || c === 1 ? b : ",",
        //note: SVG spec allows omission of comma/space when a negative sign is wedged between two numbers, like 2.5-5.3 instead of 2.5,-5.3 but when tweening, the negative value may switch to positive, so we insert the comma just in case.
        s: g,
  ...
  */
  ...
  var s = e._gsap, l = n || Vi(e, !0), c = s.xOrigin || 0, d = s.yOrigin || 0, u = s.xOffset || 0, h = s.yOffset || 0, g = l[0], m = l[1], p = l[2], w = l[3], y = l[4], b = l[5], x = t.split(" "), v = parseFloat(x[0]) || 0, _ = parseFloat(x[1]) || 0, T, A, C, k;
  a ? l !== Zt && (A = g * w - m * p) && (C = v * (w / A) + _ * (-p / A) + (p * b - w * y) / A, k = v * (-m / A) + _ * (g / A) - (g * b - m * y) / A, v = C, _ = k) : (T = Wr(e), v = T.x + (~x[0].indexOf("%") ? v / 100 * T.width : v), _ = T.y + (~(x[1] || x[0]).indexOf("%") ? _ / 100 * T.height : _)), i || i !== !1 && s.smooth ? (y = v - c, b = _ - d, s.xOffset = u + (y * g + b * p) - y, s.yOffset = h + (y * m + b * w) - b) : s.xOffset = s.yOffset = 0, s.xOrigin = v, s.yOrigin = _, s.smooth = !!i, s.origin = t, s.originIsAbsolute = !!a, e.style[ce] = "0px 0px", r && (Je(r, s, "xOrigin", c, v), Je(r, s, "yOrigin", d, _), Je(r, s, "xOffset", u, s.xOffset), Je(r, s, "yOffset", h, s.yOffset)), e.setAttribute("data-svg-origin", v + " " + _);
}, $t = function(e, t) {
  var a = e._gsap || new Rr(e);
  if ("x" in a && !t && !a.uncache)
    return a;
  var i = e.style, n = a.scaleX < 0, r = "px", s = "deg", l = getComputedStyle(e), c = fe(e, ce) || "0", d, u, h, g, m, p, w, y, b, x, v, _, T, A, C, k, M, F, z, L, U, I, D, P, $, Te, We, Ce, ot, ji, Ne, st;
  return d = u = h = p = w = y = b = x = v = 0, g = m = 1, a.svg = !!(e.getCTM && Yr(e)), l.translate && ((l.translate !== "none" || l.scale !== "none" || l.rotate !== "none") && (i[W] = (l.translate !== "none" ? "translate3d(" + (l.translate + " 0 0").split(" ").slice(0, 3).join(", ") + ") " : "") + (l.rotate !== "none" ? "rotate(" + l.rotate + ") " : "") + (l.scale !== "none" ? "scale(" + l.scale.split(" ").join(",") + ") " : "") + (l[W] !== "none" ? l[W] : "")), i.scale = i.rotate = i.translate = "none"), A = Vi(e, a.svg), a.svg && (a.uncache ? ($ = e.getBBox(), c = a.xOrigin - $.x + "px " + (a.yOrigin - $.y) + "px", P = "") : P = !t && e.getAttribute("data-svg-origin"), Ai(e, P || c, !!P || a.originIsAbsolute, a.smooth !== !1, A)), _ = a.xOrigin || 0, T = a.yOrigin || 0, A !== Zt && (F = A[0], z = A[1], L = A[2], U = A[3], d = I = A[4], u = D = A[5], A.length === 6 ? (g = Math.sqrt(F * F + z * z), m = Math.sqrt(U * U + L * L), p = F || z ? xt(z, F) * pt : 0, b = L || U ? xt(L, U) * pt + p : 0, b && (m *= Math.abs(Math.cos(b * Et))), a.svg && (d -= _ - (_ * F + T * L), u -= T - (_ * z + T * U))) : (st = A[6], ji = A[7], We = A[8], Ce = A[9], ot = A[10], Ne = A[11], d = A[12], u = A[13], h = A[14], C = xt(st, ot), w = C * pt, C && (k = Math.cos(-C), M = Math.sin(-C), P = I * k + We * M, $ = D * k + Ce * M, Te = st * k + ot * M, We = I * -M + We * k, Ce = D * -M + Ce * k, ot = st * -M + ot * k, Ne = ji * -M + Ne * k, I = P, D = $, st = Te), C = xt(-L, ot), y = C * pt, C && (k = Math.cos(-C), M = Math.sin(-C), P = F * k - We * M, $ = z * k - Ce * M, Te = L * k - ot * M, Ne = U * M + Ne * k, F = P, z = $, L = Te), C = xt(z, F), p = C * pt, C && (k = Math.cos(C), M = Math.sin(C), P = F * k + z * M, $ = I * k + D * M, z = z * k - F * M, D = D * k - I * M, F = P, I = $), w && Math.abs(w) + Math.abs(p) > 359.9 && (w = p = 0, y = 180 - y), g = Q(Math.sqrt(F * F + z * z + L * L)), m = Q(Math.sqrt(D * D + st * st)), C = xt(I, D), b = Math.abs(C) > 2e-4 ? C * pt : 0, v = Ne ? 1 / (Ne < 0 ? -Ne : Ne) : 0), a.svg && (P = e.getAttribute("transform"), a.forceCSS = e.setAttribute("transform", "") || !jr(fe(e, W)), P && e.setAttribute("transform", P))), Math.abs(b) > 90 && Math.abs(b) < 270 && (n ? (g *= -1, b += p <= 0 ? 180 : -180, p += p <= 0 ? 180 : -180) : (m *= -1, b += b <= 0 ? 180 : -180)), t = t || a.uncache, a.x = d - ((a.xPercent = d && (!t && a.xPercent || (Math.round(e.offsetWidth / 2) === Math.round(-d) ? -50 : 0))) ? e.offsetWidth * a.xPercent / 100 : 0) + r, a.y = u - ((a.yPercent = u && (!t && a.yPercent || (Math.round(e.offsetHeight / 2) === Math.round(-u) ? -50 : 0))) ? e.offsetHeight * a.yPercent / 100 : 0) + r, a.z = h + r, a.scaleX = Q(g), a.scaleY = Q(m), a.rotation = Q(p) + s, a.rotationX = Q(w) + s, a.rotationY = Q(y) + s, a.skewX = b + s, a.skewY = x + s, a.transformPerspective = v + r, (a.zOrigin = parseFloat(c.split(" ")[2]) || !t && a.zOrigin || 0) && (i[ce] = Ta(c)), a.xOffset = a.yOffset = 0, a.force3D = we.force3D, a.renderTransform = a.svg ? Ys : Vr ? Kr : Ws, a.uncache = 0, a;
}, Ta = function(e) {
  ...
  var a = t || this, i = a.xPercent, n = a.yPercent, r = a.x, s = a.y, l = a.z, c = a.rotation, d = a.rotationY, u = a.rotationX, h = a.skewX, g = a.skewY, m = a.scaleX, p = a.scaleY, w = a.transformPerspective, y = a.force3D, b = a.target, x = a.zOrigin, v = "", _ = y === "auto" && e && e !== 1 || y === !0;
  if (x && (u !== lt || d !== lt)) {
  ...
  w !== Nt && (v += "perspective(" + w + ct), (i || n) && (v += "translate(" + i + "%, " + n + "%) "), (_ || r !== Nt || s !== Nt || l !== Nt) && (v += l !== Nt || _ ? "translate3d(" + r + ", " + s + ", " + l + ") " : "translate(" + r + ", " + s + ct), c !== lt && (v += "rotate(" + c + ct), d !== lt && (v += "rotateY(" + d + ct), u !== lt && (v += "rotateX(" + u + ct), (h !== lt || g !== lt) && (v += "skew(" + h + ", " + g + ct), (m !== 1 || p !== 1) && (v += "scale(" + m + ", " + p + ct), b.style[W] = v || "translate(0, 0)";
}, Ys = function(e, t) {
  var a = t || this, i = a.xPercent, n = a.yPercent, r = a.x, s = a.y, l = a.rotation, c = a.skewX, d = a.skewY, u = a.scaleX, h = a.scaleY, g = a.target, m = a.xOrigin, p = a.yOrigin, w = a.xOffset, y = a.yOffset, b = a.forceCSS, x = parseFloat(r), v = parseFloat(s), _, T, A, C, k;
  l = parseFloat(l), c = parseFloat(c), d = parseFloat(d), d && (d = parseFloat(d), c += d, l += d), l || c ? (l *= Et, c *= Et, _ = Math.cos(l) * u, T = Math.sin(l) * u, A = Math.sin(l - c) * -h, C = Math.cos(l - c) * h, c && (d *= Et, k = Math.tan(c - d), k = Math.sqrt(1 + k * k), A *= k, C *= k, d && (k = Math.tan(d), k = Math.sqrt(1 + k * k), _ *= k, T *= k)), _ = Q(_), T = Q(T), A = Q(A), C = Q(C)) : (_ = u, C = h, T = A = 0), (x && !~(r + "").indexOf("px") || v && !~(s + "").indexOf("px")) && (x = nt(g, "x", r, "px"), v = nt(g, "y", s, "px")), (m || p || w || y) && (x = Q(x + m - (m * _ + p * A) + w), v = Q(v + p - (m * T + p * C) + y)), (i || n) && (k = g.getBBox(), x = Q(x + i / 100 * k.width), v = Q(v + n / 100 * k.height)), k = "matrix(" + _ + "," + T + "," + A + "," + C + "," + x + "," + v + ")", g.setAttribute("transform", k), b && (g.style[W] = k);
...
var Xr = {
  ...
  init: function(e, t, a, i, n) {
    var r = this._props, s = e.style, l = a.vars.startAt, c, d, u, h, g, m, p, w, y, b, x, v, _, T, A, C, k;
    Ui || vi(), this.styles = this.styles || Gr(e), C = this.styles.props, this.tween = a;
    for (p in t)
      if (p !== "autoRound" && (d = t[p], !(ue[p] && Ir(p, t, a, i, e, n)))) {
        if (g = typeof d, m = Ca[p], g === "function" && (d = d.call(a, i, e, n), g = typeof d), g === "string" && ~d.indexOf("random(") && (d = Kt(d)), m)
          ...
          if (l && p in l ? (c = typeof l[p] == "function" ? l[p].call(a, i, e, n) : l[p], X(c) && ~c.indexOf("random(") && (c = Kt(c)), te(c + "") || c === "auto" || (c += we.units[p] || te(ze(e, p)) || ""), (c + "").charAt(1) === "=" && (c = ze(e, p))) : c = ze(e, p), h = parseFloat(c), b = g === "string" && d.charAt(1) === "=" && d.substr(0, 2), b && (d = d.substr(2)), u = parseFloat(d), p in qe && (p === "autoAlpha" && (h === 1 && ze(e, "visibility") === "hidden" && u && (h = 0), C.push("visibility", 0, s.visibility), Je(this, s, "visibility", h ? "inherit" : "hidden", u ? "inherit" : "hidden", !u)), p !== "scale" && p !== "transform" && (p = qe[p], ~p.indexOf(",") && (p = p.split(",")[0]))), x = p in Ve, x) {
            ...
            if (v || (_ = e._gsap, _.renderTransform && !t.parseTransform || $t(e, t.parseTransform), T = t.smoothOrigin !== !1 && _.smooth, v = this._pt = new le(this._pt, s, W, 0, 1, _.renderTransform, _, 0, -1), v.dep = 1), p === "scale")
              this._pt = new le(this._pt, _, "scaleY", _.scaleY, (b ? Ct(_.scaleY, b + u) : u) - _.scaleY || 0, xi), this._pt.u = 0, r.push("scaleY", p), p += "X";
            else if (p === "transformOrigin") {
              C.push(ce, 0, s[ce]), d = Gs(d), _.svg ? Ai(e, d, 0, T, 0, this) : (y = parseFloat(d.split(" ")[2]) || 0, y !== _.zOrigin && Je(this, _, "zOrigin", _.zOrigin, y), Je(this, s, p, Ta(c), Ta(d)));
              continue;
            } else if (p === "svgOrigin") {
              Ai(e, d, 1, T, 0, this);
              continue;
            } else if (p in Qr) {
              Qs(this, _, p, h, b ? Ct(h, b + d) : d);
              continue;
            } else if (p === "smoothOrigin") {
              Je(this, _, "smooth", _.smooth, d);
              continue;
            } else if (p === "force3D") {
              _[p] = d;
              continue;
          ...
          if (x || (u || u === 0) && (h || h === 0) && !Es.test(d) && p in s)
            w = (c + "").substr((h + "").length), u || (u = 0), y = te(d) || (p in we.units ? we.units[p] : w), w !== y && (h = nt(e, p, c, y)), this._pt = new le(this._pt, x ? _ : s, p, h, (b ? Ct(h, b + u) : u) - h, !x && (y === "px" || p === "zIndex") && t.autoRound !== !1 ? Is : xi), this._pt.u = y || 0, x && k !== d ? (this._pt.b = c, this._pt.e = k, this._pt.r = Rs) : w !== y && y !== "%" && (this._pt.b = c, this._pt.r = Ps);
          else if (p in s)
...
class $l {
  ...
  showComposer() {
    ...
    return e.set(this.composer, {
      ...
      ease: _e.contentEase,
      overwrite: "auto"
    }, _e.contentShowDelay).call(() => this.pinThreadToBottom()), e;
  }
  hideComposer() {
    ...
    return f.timeline().set(this.composer, {
      ...
      opacity: 0,
      duration: _e.contentHideDuration,
      ease: "power2.out",
      overwrite: "auto"
    }, 0).to(this.composer, {
      left: t.left,
  ...
  getComposerThreadInsetForFrame(e) {
    ...
    return Math.ceil(i + _e.threadGap);
  }
  ...
  getComposerCompactFrame(e) {
    const t = Math.min(_e.compactWidth, e.width), a = Math.min(_e.compactHeight, e.height);
    return {
  ...
  getComposerCollapsedFrame(e) {
    const t = _e.collapsedWidth, a = _e.collapsedHeight;
    return {
      left: e.left + (e.width - t) / 2,
      bottom: e.bottom + (e.height - a) / 2,
      width: t,
  ...
  assistantMessage(e) {
    ...
    return a ? i.add(
      this.streamText(a, e, {
        duration: this.getStreamDuration(e, _n),
        targetForScroll: t
      }),
      _n.startOverlap
    ) : i;
  ...
  setDataTablePageCellSwapState(e, t, a) {
    const i = t > 1e-3, n = vt(t).toFixed(3), r = Math.abs(a) < 0.01 ? "0" : a.toFixed(2);
    e.forEach((s) => {
...
function ca(o, e, t) {
  ...
  const s = e.x - o.x, l = e.y - o.y, c = s / i, d = l / i, u = -d, h = c, g = a() > 0.5 ? 1 : -1, m = t.curve ?? 1, w = Ze(i * (r === "drag" ? 0.1 : r === "click" ? 0.17 : 0.22), 18, 150) * m * g * (0.72 + a() * 0.44), y = i / ac[n] + 0.16, b = Ze(
    ...
    0.3,
    1.98
  ), x = t.overshoot === !1 || i < 120 ? 0 : typeof t.overshoot == "number" ? t.overshoot : Ze(i * 0.026, 4, 18), v = x > 0 ? {
    x: e.x + c * x,
    y: e.y + d * x
  } : e, _ = {
...
}, _c = 2.8, vc = 42, Ac = 2, Sc = 3, Ma = "[data-chat-shell] [data-chat-thread]", kc = `${Ma} [data-message-role="assistant"]:not(.wa-message--component) [data-message-body]`, Cc = `${Ma} [data-message-role="assistant"].wa-message--thinking .wa-research-step[data-step-state="current"] .wa-research-step__body, ${Ma} [data-message-role="assistant"].wa-message--thinking .wa-research-step[data-step-state="complete"] .wa-research-step__label`, Pa = 0.24, co = 0.3, Ue = {
...
function Qc(o, e) {
  ...
  if (t && Ao(i, vo(t.component)), a) {
    const n = _o(a.component), r = o.chat.prepareCsvDropArea({
...
function ad(o, e, t) {
  ...
  if (a.kind === "uploadedFiles") {
    o.push({ kind: "custom", build: (i) => i.chat.uploadedFilesMessage(_o(a)), at: "-=0.04" });
    return;
  }
