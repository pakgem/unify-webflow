...
var le = {
  ...
  return t.parent && Oe(t), t._start = O((Te(a) ? a : a || e !== z ? pe(e, a, t) : e._time) + t._delay), t._end = O(t._start + (t.totalDuration() / Math.abs(t.timeScale()) || 0)), tr(e, t, "_first", "_last", e._sort ? "_start" : 0), va(t) || (e._recent = t), i || ar(e, t), e._ts < 0 && na(e, e._tTime), e;
}, ir = function(e, t) {
...
var En = function(e, t, a, i, r, n, s) {
  ...
  if (v && (!p || !r) && (r = "none"), e._ease = Qe(r, It.ease), e._rEase = y && (Qe(y) || e._ease), e._from = !v && !!i.runBackwards, e._from && (e.ratio = 1), !v || p && !i.stagger) {
    ...
    for (e._pt = e._ptCache = 0, l = g && $(l) || l && !g, A = 0; A < f.length; A++) {
      ...
      e._op && e._op[A] && e.kill(E, e._op[A]), x && e._pt && (Me = e, z.killTweensOf(E, V, e.globalTime(t)), ue = !e.parent, Me = 0), e._pt && l && (ya[F.id] = 1);
    }
...
var Y = /* @__PURE__ */ (function(o) {
  ...
  function e(a, i, r, n) {
    ...
    if (s._targets = _.length ? Ga(_) : Nt("GSAP target " + a + " not found. https://gsap.com", !le.nullTargetWarn) || [], s._ptLookup = [], s._overwrite = m, g || p || qt(d) || qt(c)) {
      ...
      s.timeline = 0;
    return m === !0 && !Da && (Me = Se(s), z.killTweensOf(_), Me = 0), ye(b, Se(s), r), i.reversed && s.reverse(), i.paused && s.paused(!0), (u || !d && !g && s._start === O(b._time) && $(u) && ln(Se(s)) && b.data !== "nested") && (s._tTime = -I, s.render(Math.max(0, -c) || 0)), f && ir(Se(s), f), s;
  }
  var t = e.prototype;
...
var ci, Ie, dt, Xa, je, ui, Ja, Yn = function() {
  ...
  var r;
  return Xa || Ma(), t in xe && t !== "transform" && (t = xe[t], ~t.indexOf(",") && (t = t.split(",")[0])), Ee[t] && t !== "transform" ? (r = Ft(e, i), r = t !== "transformOrigin" ? r[t] : r.svg ? r.origin : ta(oe(e, ae)) + " " + r.zOrigin + "px") : (r = e.style[t], (!r || r === "auto" || i || ~(r + "").indexOf("calc(")) && (r = ea[t] && ea[t](e, t, a) || oe(e, t) || Zi(e, t) || (t === "opacity" ? 1 : 0))), a && !~(r + "").trim().indexOf(" ") ? Le(e, t, r, a) + a : r;
}, ss = function(e, t, a, i) {
  if (!a || a === "none") {
  ...
  if (s.b = a, s.e = i, a += "", i += "", i.substring(0, 6) === "var(--" && (i = oe(e, i.substring(4, i.indexOf(")")))), i === "auto" && (h = e.style[t], e.style[t] = i, i = oe(e, t) || i, h ? e.style[t] = h : ze(e, t)), c = [a, i], fr(c), a = c[0], i = c[1], p = a.match(st) || [], y = i.match(st) || [], y.length) {
    for (; u = st.exec(i); )
      f = u[0], _ = i.substring(l, u.index), g ? g = (g + 1) % 5 : (_.substr(-5) === "rgba(" || _.substr(-5) === "hsla(") && (g = 1), f !== (h = p[d++] || "") && (m = parseFloat(h) || 0, v = h.substr((m + "").length), f.charAt(1) === "=" && (f = lt(m, f) + v), b = parseFloat(f), x = f.substr((b + "").length), l = st.lastIndex - x.length, x || (x = x || le.units[t] || v, l === i.length && (i += x, s.e += x)), v !== x && (m = Le(e, t, h, x) || 0), s._pt = {
        _next: s._pt,
        p: _ || d === 1 ? _ : ",",
        //note: SVG spec allows omission of comma/space when a negative sign is wedged between two numbers, like 2.5-5.3 instead of 2.5,-5.3 but when tweening, the negative value may switch to positive, so we insert the comma just in case.
        s: m,
  ...
  if (t.tween && t.tween._time === t.tween._dur) {
    ...
    l && (ze(a, L), n && (n.svg && a.removeAttribute("transform"), i.scale = i.rotate = i.translate = "none", Ft(a, 1), n.uncache = 1, Pr(i)));
  }
}, ea = {
  ...
  */
...
}, Ge = "0deg", bt = "0px", He = ") ", zr = function(e, t) {
  ...
  f !== bt && (v += "perspective(" + f + He), (i || r) && (v += "translate(" + i + "%, " + r + "%) "), (y || n !== bt || s !== bt || l !== bt) && (v += l !== bt || y ? "translate3d(" + n + ", " + s + ", " + l + ") " : "translate(" + n + ", " + s + He), d !== Ge && (v += "rotate(" + d + He), c !== Ge && (v += "rotateY(" + c + He), u !== Ge && (v += "rotateX(" + u + He), (p !== Ge || m !== Ge) && (v += "skew(" + p + ", " + m + He), (g !== 1 || h !== 1) && (v += "scale(" + g + ", " + h + He), _.style[L] = v || "translate(0, 0)";
}, cs = function(e, t) {
  ...
  l = parseFloat(l), d = parseFloat(d), c = parseFloat(c), c && (c = parseFloat(c), d += c, l += c), l || d ? (l *= ct, d *= ct, y = Math.cos(l) * u, k = Math.sin(l) * u, A = Math.sin(l - d) * -p, S = Math.cos(l - d) * p, d && (c *= ct, C = Math.tan(d - c), C = Math.sqrt(1 + C * C), A *= C, S *= C, c && (C = Math.tan(c), C = Math.sqrt(1 + C * C), y *= C, k *= C)), y = U(y), k = U(k), A = U(A), S = U(S)) : (y = u, S = p, k = A = 0), (x && !~(n + "").indexOf("px") || v && !~(s + "").indexOf("px")) && (x = Le(m, "x", n, "px"), v = Le(m, "y", s, "px")), (g || h || f || b) && (x = U(x + g - (g * y + h * A) + f), v = U(v + h - (g * k + h * S) + b)), (i || r) && (C = m.getBBox(), x = U(x + i / 100 * C.width), v = U(v + r / 100 * C.height)), C = "matrix(" + y + "," + k + "," + A + "," + S + "," + x + "," + v + ")", m.setAttribute("transform", C), _ && (m.style[L] = C);
  ...
  i.svg ? (d = a.getAttribute("transform"), a.setAttribute("transform", ""), n[L] = t, s = Ft(a, 1), ze(a, L), a.setAttribute("transform", d)) : (d = getComputedStyle(a)[L], n[L] = t, s = Ft(a, 1), n[L] = d);
  for (l in Ee)
    d = i[l], c = s[l], d !== c && r.indexOf(l) < 0 && (m = Q(d), g = Q(c), u = m !== g ? Le(a, l, d, g) : parseFloat(d), p = parseFloat(c), e._pt = new te(e._pt, s, l, u, p - u, Ea), e._pt.u = g || 0, e._props.push(l));
  _i(s, i);
};
    ...
    for (h in t)
      if (h !== "autoRound" && (c = t[h], !(re[h] && _r(h, t, a, i, e, r)))) {
        if (m = typeof c, g = ea[h], m === "function" && (c = c.call(a, i, e, r), m = typeof c), m === "string" && ~c.indexOf("random(") && (c = Dt(c)), g)
          ...
          d = (getComputedStyle(e).getPropertyValue(h) + "").trim(), c += "", De.lastIndex = 0, De.test(d) || (f = Q(d), b = Q(c), b ? f !== b && (d = Le(e, h, d, b) + b) : f && (c += f)), this.add(s, "setProperty", d, c, i, r, 0, 0, h), n.push(h), S.push(h, 0, s[h]);
        else if (m !== "undefined") {
          ...
          if (x || (u || u === 0) && (p || p === 0) && !Vn.test(c) && h in s)
            f = (d + "").substr((p + "").length), u || (u = 0), b = Q(c) || (h in le.units ? le.units[h] : f), f !== b && (p = Le(e, h, d, b)), this._pt = new te(this._pt, x ? y : s, h, p, (_ ? lt(p, _ + u) : u) - p, !x && (b === "px" || h === "zIndex") && t.autoRound !== !1 ? Qn : Ea), this._pt.u = b || 0, x && C !== c ? (this._pt.b = d, this._pt.e = C, this._pt.r = Jn) : f !== b && b !== "%" && (this._pt.b = d, this._pt.r = Xn);
          else if (h in s)
