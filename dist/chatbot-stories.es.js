...
var ge = {
  ...
  overwrite: !1,
  delay: 0
}, bi, X, G, xe = 1e8, q = 1 / xe, ai = Math.PI * 2, Ao = ai / 4, _o = 0, Qn = Math.sqrt, vo = Math.cos, ko = Math.sin, K = function(e) {
...
}, ee = Array.isArray, So = /random\([^)]+\)/g, Co = /,\s*/g, Ui = /(?:-?\.?\d|\.)+/gi, Kn = /[-+=.]*\d+[.e\-+]*\d*[e\-+]*\d*/g, wt = /[-+=.]*\d+[.e-]*\d*[a-z%]*/g, Ra = /[-+=.]*\d+\.?\d*(?:e-|e\+)?\d*/gi, Xn = /[+-]=-?[.\d]+/, To = /[^,'"\[\]\s]+/gi, Eo = /^[+\-=e\s\d]*\d+[.\d]*([a-z]*|%)\s*$/i, H, Ee, ii, Ai, me = {}, pa = {}, Jn, Zn = function(e) {
  ...
  suppressEvents: !0
}, vi = {}, Xe = [], ni = {}, er, de = {}, Ia = {}, Gi = 30, da = [], ki = "", Si = function(e) {
  var t = e[0], a, i;
  ...
  var t = e.parent || H, a = e.keyframes ? Io(ee(e.keyframes)) : fe;
  if (re(e.inherit))
    for (; t; )
  ...
  return t.parent && Ze(t), t._start = V((Ge(a) ? a : a || e !== H ? be(e, a, t) : e._time) + t._delay), t._end = V(t._start + (t.totalDuration() / Math.abs(t.timeScale()) || 0)), rr(e, t, "_first", "_last", e._sort ? "_start" : 0), oi(t) || (e._recent = t), i || or(e, t), e._ts < 0 && Sa(e, e._tTime), e;
}, sr = function(e, t) {
  return (me.ScrollTrigger || _i("scrollTrigger", t)) && me.ScrollTrigger.create(t, e);
}, lr = function(e, t, a, i, n) {
  if (Ei(e, t, n), !e._initted)
    return 1;
  if (!a && e._pt && !X && (e._dur && e.vars.lazy !== !1 || !e._dur && e.vars.lazy) && er !== ue.frame)
  ...
  return G && !t && G.selector ? G.selector(e) : K(e) && !a && (ii || !Tt()) ? si.call((t || Ai).querySelectorAll(e), 0) : ee(e) ? Uo(e, a) : cr(e) ? si.call(e, 0) : e ? [e] : [];
}, li = function(e) {
  ...
  return K(i) ? d = u = {
    ...
    if (!w) {
      ...
      i === "random" && dr(w), w.max = v - C, w.min = C, w.v = h = (parseFloat(t.amount) || parseFloat(t.each) * (S > h ? h - 1 : c ? c === "y" ? h / S : S : Math.max(S, h / S)) || 0) * (i === "edges" ? -1 : 1), w.b = h < 0 ? n - h : n, w.u = $(t.amount || t.each) || 0, a = a && h < 0 ? es(a) : a;
    }
  ...
  var i = t - e;
  return ee(e) ? gr(e, r(0, e.length), t) : tt(a, function(n) {
    return (i + (n - e) % i) % i + e;
  });
}, Yo = function r(e, t, a) {
  var i = t - e, n = i * 2;
  return ee(e) ? gr(e, r(0, e.length - 1), t) : tt(a, function(o) {
  ...
  return u = {
    ...
    wake: function() {
      Jn && (!ii && xi() && (Ee = ii = window, Ai = Ee.document || {}, me.gsap = ce, (Ee.gsapVersions || (Ee.gsapVersions = [])).push(ce.version), Zn(pa || Ee.GreenSockGlobals || !Ee.gsap && Ee || {}), fr.forEach(wr)), d = typeof requestAnimationFrame < "u" && requestAnimationFrame, l && u.sleep(), c = d || function(w) {
...
var _r = function(e, t) {
  ...
  return e.delay = function(a) {
    ...
    if (n && n.smoothChildTiming && this._ts) {
      for (Sa(this, a), !n._dp || n.parent || or(n, this); n && n.parent; )
    ...
    return this._rts = +a || 0, this._ts = this._ps || a === -q ? 0 : this._rts, this.totalTime(ea(-Math.abs(this._delay), this.totalDuration(), n), i !== !1), ka(this), Lo(this);
  }, e.paused = function(a) {
...
var ne = /* @__PURE__ */ (function(r) {
  ...
  return t.to = function(i, n, o) {
    ...
    if (H._ts && (ar(H, fa(i, H)), er = ue.frame), ue.frame >= Gi) {
      Gi += ge.autoSleep || 120;
      var n = H._first;
...
var ts = function(e, t, a, i, n, o, s) {
  ...
  if (Y(e) && (e = Ut(e, n, t, a, i)), !Ie(e) || e.style && e.nodeType || ee(e) || jn(e))
  ...
  var i = e.vars, n = i.ease, o = i.startAt, s = i.immediateRender, l = i.lazy, c = i.onUpdate, d = i.runBackwards, u = i.yoyoEase, g = i.keyframes, p = i.autoRevert, f = e._dur, h = e._startAt, w = e._targets, b = e.parent, y = b && b.data === "nested" ? b.vars.targets : w, A = e._overwrite === "auto" && !bi, _ = e.timeline, x = i.easeReverse || u, T, v, C, S, M, z, O, D, I, N, P, U, J;
  if (_ && (!g || !n) && (n = "none"), e._ease = pt(n, Vt.ease), e._rEase = x && (pt(x) || e._ease), e._from = !_ && !!i.runBackwards, e._from && (e.ratio = 1), !_ || g && !i.stagger) {
    ...
    for (e._pt = e._ptCache = 0, l = f && re(l) || l && !f, v = 0; v < w.length; v++) {
      if (M = w[v], O = M._gsap || Si(w)[v]._gsap, e._ptLookup[v] = N = {}, ni[O.id] && Xe.length && ga(), P = y === w ? v : y.indexOf(M), D && (I = new D()).init(M, U || T, e, P, y) !== !1 && (e._pt = S = new se(e._pt, M, I.name, 0, 1, I.render, I, 0, I.priority), I._props.forEach(function(De) {
        N[De] = S;
      }), I.priority && (z = 1)), !D || U)
        for (C in T)
          de[C] && (I = vr(C, T, e, P, M, y)) ? I.priority && (z = 1) : N[C] = S = Ti.call(e, M, C, "get", T[C], P, y, 0, i.stringFilter);
      e._op && e._op[v] && e.kill(M, e._op[v]), A && e._pt && (Ye = e, H.killTweensOf(M, N, e.globalTime(t)), J = !e.parent, Ye = 0), e._pt && l && (ni[O.id] = 1);
    }
...
var j = /* @__PURE__ */ (function(r) {
  ...
  function e(a, i, n, o) {
    ...
    if (s._targets = y.length ? Si(y) : Ht("GSAP target " + a + " not found. https://gsap.com", !ge.nullTargetWarn) || [], s._ptLookup = [], s._overwrite = p, f || g || ta(c) || ta(d)) {
      ...
      if (A = s.timeline = new ne({
        ...
        for (_ = 0; _ < T; _++)
          x = ma(i, Sr), x.stagger = 0, z && (x.easeReverse = z), M && kt(x, M), C = y[_], x.duration = +Ut(c, Be(s), _, C, y), x.delay = (+Ut(d, Be(s), _, C, y) || 0) - s._delay, !g && T === 1 && x.delay && (s._delay = d = x.delay, s._start += d, x.delay = 0), A.to(C, x, S ? S(_, C, y) : 0), A._ease = R.none;
  ...
  return t.render = function(i, n, o) {
    ...
    return this._initted || Ei(this, c), d = this._ease(c / this._dur), is(this, i, n, o, s, d, c, l) ? this.resetTo(i, n, o, s, 1) : (Sa(this, 0), this.parent || rr(this._dp, this, "_first", "_last", this._dp._sort ? "_start" : 0), this.render(0));
  }, t.kill = function(i, n) {
...
ge.stringFilter = xr;
var gt = [], ua = {}, hs = [], ji = 0, ps = 0, Oa = function(e) {
  return (ua[e] || hs).map(function(t) {
    return t();
  });
}, ui = function() {
  var e = Date.now(), t = [];
...
}, Ba("roundProps", ci), Ba("modifiers"), Ba("snap", hr)) || wa;
...
var Ki, Qe, xt, Ii, dt, Xi, Di, ws = function() {
  ...
  var n;
  return Ii || gi(), t in Re && t !== "transform" && (t = Re[t], ~t.indexOf(",") && (t = t.split(",")[0])), Ve[t] && t !== "transform" ? (n = Xt(e, i), n = t !== "transformOrigin" ? n[t] : n.svg ? n.origin : ya(pe(e, le)) + " " + n.zOrigin + "px") : (n = e.style[t], (!n || n === "auto" || i || ~(n + "").indexOf("calc(")) && (n = ba[t] && ba[t](e, t, a) || pe(e, t) || tr(e, t) || (t === "opacity" ? 1 : 0))), a && !~(n + "").trim().indexOf(" ") ? et(e, t, n, a) + a : n;
}, Ds = function(e, t, a, i) {
  if (!a || a === "none") {
        ...
        if (p = typeof d, f = ba[h], p === "function" && (d = d.call(a, i, e, n), p = typeof d), p === "string" && ~d.indexOf("random(") && (d = Yt(d)), f)
          ...
          if (l && h in l ? (c = typeof l[h] == "function" ? l[h].call(a, i, e, n) : l[h], K(c) && ~c.indexOf("random(") && (c = Yt(c)), $(c + "") || c === "auto" || (c += ge.units[h] || $(Fe(e, h)) || ""), (c + "").charAt(1) === "=" && (c = Fe(e, h))) : c = Fe(e, h), g = parseFloat(c), y = p === "string" && d.charAt(1) === "=" && d.substr(0, 2), y && (d = d.substr(2)), u = parseFloat(d), h in Re && (h === "autoAlpha" && (g === 1 && Fe(e, "visibility") === "hidden" && u && (g = 0), C.push("visibility", 0, s.visibility), je(this, s, "visibility", g ? "inherit" : "hidden", u ? "inherit" : "hidden", !u)), h !== "scale" && h !== "transform" && (h = Re[h], ~h.indexOf(",") && (h = h.split(",")[0]))), A = h in Ve, A) {
            ...
            if (_ || (x = e._gsap, x.renderTransform && !t.parseTransform || Xt(e, t.parseTransform), T = t.smoothOrigin !== !1 && x.smooth, _ = this._pt = new se(this._pt, s, W, 0, 1, x.renderTransform, x, 0, -1), _.dep = 1), h === "scale")
              ...
              C.push(le, 0, s[le]), d = Ls(d), x.svg ? mi(e, d, 0, T, 0, this) : (b = parseFloat(d.split(" ")[2]) || 0, b !== x.zOrigin && je(this, x, "zOrigin", x.zOrigin, b), je(this, s, h, ya(c), ya(d)));
              continue;
            } else if (h === "svgOrigin") {
              mi(e, d, 1, T, 0, this);
              continue;
          ...
          if (A || (u || u === 0) && (g || g === 0) && !ys.test(d) && h in s)
            w = (c + "").substr((g + "").length), u || (u = 0), b = $(d) || (h in ge.units ? ge.units[h] : w), w !== b && (g = et(e, h, c, b)), this._pt = new se(this._pt, A ? x : s, h, g, (y ? yt(g, y + u) : u) - g, !A && (b === "px" || h === "zIndex") && t.autoRound !== !1 ? vs : hi), this._pt.u = b || 0, A && S !== d ? (this._pt.b = c, this._pt.e = S, this._pt.r = _s) : w !== b && b !== "%" && (this._pt.b = c, this._pt.r = As);
          else if (h in s)
...
], xl = 1.28, k = (r) => Number((r * xl).toFixed(3)), Al = [2, 3, 2], te = {
...
class Fl {
  ...
  strategyPlans(e) {
    ...
    return t.forEach((g, p) => {
      ...
      () => this.animateMessageScrollIntoView(d, ae.followDuration, n, fn),
      void 0,
      "+=0.02"
    );
  }
...
function ia(r, e, t) {
  ...
  const s = e.x - r.x, l = e.y - r.y, c = s / i, d = l / i, u = -d, g = c, p = a() > 0.5 ? 1 : -1, f = t.curve ?? 1, w = Bt(i * (o === "drag" ? 0.1 : o === "click" ? 0.17 : 0.22) * f, 18, 150) * p * (0.72 + a() * 0.44), b = i / Vl[n] + 0.16, y = Bt(b * Hl[o] * Wl, 0.3, 1.66), A = t.overshoot === !1 || i < 120 ? 0 : typeof t.overshoot == "number" ? t.overshoot : Bt(i * 0.026, 4, 18), _ = A > 0 ? {
    x: e.x + c * A,
    y: e.y + d * A
  } : e, x = {
...
}, ic = 2.8, nc = 42, rc = 2, oc = 3, Aa = "[data-chat-shell] [data-chat-thread]", sc = `${Aa} [data-message-role="assistant"]:not(.wa-message--component) [data-message-body]`, lc = `${Aa} [data-message-role="assistant"].wa-message--thinking .wa-research-step[data-step-state="current"] .wa-research-step__body, ${Aa} [data-message-role="assistant"].wa-message--thinking .wa-research-step[data-step-state="complete"] .wa-research-step__label`, wi = 0.24, $r = 0.3, ze = {
...
class fd {
  ...
  updateFollowTarget(e) {
    ...
    if (this.lastPointer) {
      ...
      i > 1.5 && (this.trailDirection = {
        x: a.x / i,
        y: a.y / i
      }, this.velocity = _d(a, Z.maxMomentumStep));
    }
    const t = {
  ...
  isCursorTooFarFromBrowser() {
    ...
    return Ad(i, e) > Z.maxBrowserDistance;
  }
  getChatShell() {
    return this.chatShell?.isConnected ? this.chatShell : (this.chatShell = this.root.querySelector("[data-chat-shell]"), this.chatShell);
  }
