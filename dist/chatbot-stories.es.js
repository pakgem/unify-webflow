...
var le = {
  ...
  var a;
  if ((t._time || !t._dur && t._initted || t._start < e._time && (t._dur || !t.add)) && (a = Qt(e.rawTime(), t), (!t._dur || Bt(0, t.totalDuration(), a) - t._tTime > M) && t.render(a, !0)), Xe(e, t)._dp && e._initted && e._time >= e._dur && e._ts) {
...
var An = function(e, t, a, i, r, n, s) {
  ...
  if (v && (!p || !r) && (r = "none"), e._ease = Je(r, Pt.ease), e._rEase = y && (Je(y) || e._ease), e._from = !v && !!i.runBackwards, e._from && (e.ratio = 1), !v || p && !i.stagger) {
    if (R = f[0] ? je(f[0]).harness : 0, G = R && i[R.prop], k = Jt(i, Ba), h && (h._zTime < 0 && h.progress(1), t < 0 && c && s && !m ? h.render(-1, !0) : h.revert(c && g ? Yt : Qr), h._lazy = 0), n) {
    ...
    for (e._pt = e._ptCache = 0, l = g && $(l) || l && !g, A = 0; A < f.length; A++) {
      if (E = f[A], L = E._gsap || Fa(f)[A]._gsap, e._ptLookup[A] = V = {}, _a[L.id] && Ne.length && Xt(), W = _ === f ? A : _.indexOf(E), R && (F = new R()).init(E, G || k, e, W, _) !== !1 && (e._pt = S = new te(e._pt, E, F.name, 0, 1, F.render, F, 0, F.priority), F._props.forEach(function(Ze) {
        V[Ze] = S;
      }), F.priority && (H = 1)), !R || G)
        for (C in k)
...
le.stringFilter = ur;
var Qe = [], Vt = {}, Dn = [], oi = 0, On = 0, da = function(e) {
...
P.Expo;
P.Circ;
var li, Me, lt, Va, Ve, di, ja, Fn = function() {
  return typeof window < "u";
  ...
  Fn() && window.document && (li = window, Me = li.document, lt = Me.documentElement, Ve = Ea("div") || {
    style: {}
  }, Ea("div"), B = mt(B), ae = B + "Origin", Ve.style.cssText = "border-width:0;line-height:0;position:absolute;padding:0", kr = !!mt("perspective"), ja = ie.core.reverting, Va = 1);
}, hi = function(e) {
  ...
  var r = parseFloat(a) || 0, n = (a + "").trim().substr((r + "").length) || "px", s = Ve.style, l = qn.test(t), d = e.tagName.toLowerCase() === "svg", c = (d ? "client" : "offset") + (l ? "Width" : "Height"), u = 100, p = i === "px", m = i === "%", g, h, f, b;
  if (i === n || !r || mi[i] || mi[n])
    return r;
  ...
  if (m && (t === "height" || t === "width")) {
    ...
    (m || n === "%") && !es[oe(h, "display")] && (s.position = oe(e, "position")), h === e && (s.position = "static"), h.appendChild(Ve), g = Ve[c], h.removeChild(Ve), s.position = "absolute";
  ...
  */
  ...
  if ("x" in a && !t && !a.uncache)
    return a;
  var i = e.style, r = a.scaleX < 0, n = "px", s = "deg", l = getComputedStyle(e), d = oe(e, ae) || "0", c, u, p, m, g, h, f, b, _, x, v, y, k, A, C, S, E, H, L, R, F, V, W, G, ue, Ze, gt, ft, Fe, $a, Ae, qe;
  return c = u = p = h = f = b = _ = x = v = 0, m = g = 1, a.svg = !!(e.getCTM && Er(e)), l.translate && ((l.translate !== "none" || l.scale !== "none" || l.rotate !== "none") && (i[B] = (l.translate !== "none" ? "translate3d(" + (l.translate + " 0 0").split(" ").slice(0, 3).join(", ") + ") " : "") + (l.rotate !== "none" ? "rotate(" + l.rotate + ") " : "") + (l.scale !== "none" ? "scale(" + l.scale.split(" ").join(",") + ") " : "") + (l[B] !== "none" ? l[B] : "")), i.scale = i.rotate = i.translate = "none"), A = Ja(e, a.svg), a.svg && (a.uncache ? (ue = e.getBBox(), d = a.xOrigin - ue.x + "px " + (a.yOrigin - ue.y) + "px", G = "") : G = !t && e.getAttribute("data-svg-origin"), Ia(e, G || d, !!G || a.originIsAbsolute, a.smooth !== !1, A)), y = a.xOrigin || 0, k = a.yOrigin || 0, A !== Ot && (H = A[0], L = A[1], R = A[2], F = A[3], c = V = A[4], u = W = A[5], A.length === 6 ? (m = Math.sqrt(H * H + L * L), g = Math.sqrt(F * F + R * R), h = H || L ? $e(L, H) * Ye : 0, _ = R || F ? $e(R, F) * Ye + h : 0, _ && (g *= Math.abs(Math.cos(_ * dt))), a.svg && (c -= y - (y * H + k * R), u -= k - (y * L + k * F))) : (qe = A[6], $a = A[7], gt = A[8], ft = A[9], Fe = A[10], Ae = A[11], c = A[12], u = A[13], p = A[14], C = $e(qe, Fe), f = C * Ye, C && (S = Math.cos(-C), E = Math.sin(-C), G = V * S + gt * E, ue = W * S + ft * E, Ze = qe * S + Fe * E, gt = V * -E + gt * S, ft = W * -E + ft * S, Fe = qe * -E + Fe * S, Ae = $a * -E + Ae * S, V = G, W = ue, qe = Ze), C = $e(-R, Fe), b = C * Ye, C && (S = Math.cos(-C), E = Math.sin(-C), G = H * S - gt * E, ue = L * S - ft * E, Ze = R * S - Fe * E, Ae = F * E + Ae * S, H = G, L = ue, R = Ze), C = $e(L, H), h = C * Ye, C && (S = Math.cos(C), E = Math.sin(C), G = H * S + L * E, ue = V * S + W * E, L = L * S - H * E, W = W * S - V * E, H = G, V = ue), f && Math.abs(f) + Math.abs(h) > 359.9 && (f = h = 0, b = 180 - b), m = U(Math.sqrt(H * H + L * L + R * R)), g = U(Math.sqrt(W * W + qe * qe)), C = $e(V, W), _ = Math.abs(C) > 2e-4 ? C * Ye : 0, v = Ae ? 1 / (Ae < 0 ? -Ae : Ae) : 0), a.svg && (G = e.getAttribute("transform"), a.forceCSS = e.setAttribute("transform", "") || !Ir(oe(e, B)), G && e.setAttribute("transform", G))), Math.abs(_) > 90 && Math.abs(_) < 270 && (r ? (m *= -1, _ += h <= 0 ? 180 : -180, h += h <= 0 ? 180 : -180) : (g *= -1, _ += _ <= 0 ? 180 : -180)), t = t || a.uncache, a.x = c - ((a.xPercent = c && (!t && a.xPercent || (Math.round(e.offsetWidth / 2) === Math.round(-c) ? -50 : 0))) ? e.offsetWidth * a.xPercent / 100 : 0) + n, a.y = u - ((a.yPercent = u && (!t && a.yPercent || (Math.round(e.offsetHeight / 2) === Math.round(-u) ? -50 : 0))) ? e.offsetHeight * a.yPercent / 100 : 0) + n, a.z = p + n, a.scaleX = U(m), a.scaleY = U(g), a.rotation = U(h) + s, a.rotationX = U(f) + s, a.rotationY = U(b) + s, a.skewX = _ + s, a.skewY = x + s, a.transformPerspective = v + n, (a.zOrigin = parseFloat(d.split(" ")[2]) || !t && a.zOrigin || 0) && (i[ae] = $t(d)), a.xOffset = a.yOffset = 0, a.force3D = le.force3D, a.renderTransform = a.svg ? ns : kr ? Mr : rs, a.uncache = 0, a;
}, $t = function(e) {
...
class Es {
  ...
  renderAddRail() {
    ...
    const t = Ts.map((a) => {
      ...
      return i.className = "wa-builder-add-button", i.type = "button", i.dataset.builderAdd = a, i.textContent = `+ ${We[a]}`, i;
    });
  ...
  renderPanel() {
    ...
    if (r.className = "wa-builder-panel__divider", i.append(r), a) {
      ...
      for (const d of Object.keys(We)) {
        const c = document.createElement("option");
        c.value = d, c.textContent = We[d], c.selected = a.kind === d, l.append(c);
      }
  ...
  createStepBody(e, t = !1) {
    ...
    const i = document.createElement("span");
    return i.className = "wa-builder-step__kind", i.textContent = We[e.kind], a.append(i, this.createInlineTextarea(e)), a;
  }
  ...
  createInlineTextarea(e) {
    ...
    return t.className = "wa-builder-step__textarea", t.dataset.builderStepField = e.id, t.value = e.text, t.rows = 1, t.spellcheck = !0, t.setAttribute("aria-label", `${We[e.kind]} message text`), t;
  }
  ...
  addStep(e) {
    ...
    a.splice(r, 0, t), this.selectedStepId = t.id, this.render(), this.emitChange(`Added ${We[e]} message`);
  }
  updateStep(e, t, a = {}) {
