...
var he = {
  ...
  return X(i) ? c = u = {
    ...
    if (!f) {
      ...
      for (f = o[h] = [], b = l ? Math.min(S, h) * c - 0.5 : i % S, y = S === xe ? 0 : l ? h * u / S - 0.5 : i / S | 0, k = 0, C = xe, A = 0; A < h; A++)
        _ = A % S - b, v = y - (A / S | 0), f[A] = x = d ? Math.abs(d === "y" ? v : _) : vr(_ * _ + v * v), x > k && (k = x), x < C && (C = x);
      i === "random" && zr(f), f.max = k - C, f.min = C, f.v = h = (parseFloat(t.amount) || parseFloat(t.each) * (S > h ? h - 1 : d ? d === "y" ? h / S : S : Math.max(S, h / S)) || 0) * (i === "edges" ? -1 : 1), f.b = h < 0 ? r - h : r, f.u = K(t.amount || t.each) || 0, a = a && h < 0 ? bo(a) : a;
    }
  ...
  return u = {
    ...
    wake: function() {
      Ar && (!Ja && mi() && (Ce = Ja = window, gi = Ce.document || {}, me.gsap = se, (Ce.gsapVersions || (Ce.gsapVersions = [])).push(se.version), Tr(ha || Ce.GreenSockGlobals || !Ce.gsap && Ce || {}), Wr.forEach(jr)), c = typeof requestAnimationFrame < "u" && requestAnimationFrame, l && u.sleep(), d = c || function(f) {
...
var yo = function(e, t, a, i, r, o, s) {
  var l = new ne(this._pt, e, t, 0, 1, rn, null, r), d = 0, c = 0, u, p, m, g, h, f, b, y;
  ...
  var i = e.vars, r = i.ease, o = i.startAt, s = i.immediateRender, l = i.lazy, d = i.onUpdate, c = i.runBackwards, u = i.yoyoEase, p = i.keyframes, m = i.autoRevert, g = e._dur, h = e._startAt, f = e._targets, b = e.parent, y = b && b.data === "nested" ? b.vars.targets : f, _ = e._overwrite === "auto" && !pi, v = e.timeline, x = i.easeReverse || u, A, k, C, S, E, B, L, I, N, M, G, z, te;
  if (v && (!p || !r) && (r = "none"), e._ease = pt(r, jt.ease), e._rEase = x && (pt(x) || e._ease), e._from = !v && !!i.runBackwards, e._from && (e.ratio = 1), !v || p && !i.stagger) {
    if (I = f[0] ? ct(f[0]).harness : 0, z = I && i[I.prop], A = ga(i, wi), h && (h._zTime < 0 && h.progress(1), t < 0 && c && s && !m ? h.render(-1, !0) : h.revert(c && g ? ca : jn), h._lazy = 0), o) {
      if (Xe(e._startAt = $.set(f, ge({
        data: "isStart",
        overwrite: !1,
        parent: b,
        immediateRender: !0,
    ...
    for (e._pt = e._ptCache = 0, l = g && ie(l) || l && !g, k = 0; k < f.length; k++) {
      if (E = f[k], L = E._gsap || yi(f)[k]._gsap, e._ptLookup[k] = M = {}, Qa[L.id] && je.length && ma(), G = y === f ? k : y.indexOf(E), I && (N = new I()).init(E, z || A, e, G, y) !== !1 && (e._pt = S = new ne(e._pt, E, N.name, 0, 1, N.render, N, 0, N.priority), N._props.forEach(function(we) {
        M[we] = S;
      }), N.priority && (B = 1)), !I || z)
        for (C in A)
...
var $ = /* @__PURE__ */ (function(n) {
  ...
  function e(a, i, r, o) {
    ...
    var l = s.vars, d = l.duration, c = l.delay, u = l.immediateRender, p = l.stagger, m = l.overwrite, g = l.keyframes, h = l.defaults, f = l.scrollTrigger, b = i.parent || V, y = (ee(a) || kr(a) ? qe(a[0]) : "length" in i) ? [a] : ve(a), _, v, x, A, k, C, S, E;
    if (s._targets = y.length ? yi(y) : Yt("GSAP target " + a + " not found. https://gsap.com", !he.nullTargetWarn) || [], s._ptLookup = [], s._overwrite = m, g || p || ta(d) || ta(c)) {
      ...
      s.timeline = 0;
    return m === !0 && !pi && (Ge = Re(s), V.killTweensOf(y), Ge = 0), Ae(b, Re(s), r), i.reversed && s.reverse(), i.paused && s.paused(!0), (u || !d && !g && s._start === U(b._time) && ie(u) && Zn(Re(s)) && b.data !== "nested") && (s._tTime = -O, s.render(Math.max(0, -c) || 0)), f && qr(Re(s), f), s;
  }
  var t = e.prototype;
  return t.render = function(i, r, o) {
    ...
    if (!d)
      ...
      if (this._from && (this.ratio = y = 1 - y), this._tTime = u, this._time = p, !this._act && this._ts && (this._act = 1, this._lazy = 0), !s && u && !r && !f && (ue(this, "onStart"), this._tTime !== u))
        return this;
      for (m = this._pt; m; )
        m.r(y, m.d), m = m._next;
      _ && _.render(i < 0 ? i : _._dur * _._ease(p / this._dur), r, o) || this._startAt && (this._zTime = i), this._onUpdate && !r && (c && Za(this, i, r, o), ue(this, "onUpdate")), this._repeat && g !== f && this.vars.onRepeat && !r && this.parent && ue(this, "onRepeat"), (u === this._tDur || !u) && this._tTime === u && (c && !this._onUpdate && Za(this, i, !0, !0), (i || !d) && (u === this._tDur && this._ts > 0 || !u && this._ts < 0) && Xe(this, 1), !r && !(c && !s) && (u || s || b) && (ue(this, u === l ? "onComplete" : "onReverseComplete", !0), this._prom && !(u < l && this.timeScale() > 0) && this._prom()));
    }
    return this;
  }, t.targets = function() {
...
var Vi, Ue, At, Ai, dt, Wi, Ti, Lo = function() {
  ...
  var r = parseFloat(a) || 0, o = (a + "").trim().substr((r + "").length) || "px", s = dt.style, l = qo.test(t), d = e.tagName.toLowerCase() === "svg", c = (d ? "client" : "offset") + (l ? "Width" : "Height"), u = 100, p = i === "px", m = i === "%", g, h, f, b;
  if (i === o || !r || Ji[i] || Ji[o])
    return r;
  if (o !== "px" && !p && (r = n(e, t, a, "px")), b = e.getCTM && hn(e), (m || o === "%") && (Oe[t] || ~t.indexOf("adius")))
    return g = b ? e.getBBox()[l ? "width" : "height"] : e[c], Y(m ? r / g * u : r / 100 * g);
  if (s[l ? "width" : "height"] = u + (p ? o : i), h = i !== "rem" && ~t.indexOf("adius") || i === "em" && e.appendChild && !d ? e : e.parentNode, b && (h = (e.ownerSVGElement || {}).parentNode), (!h || h === Ue || !h.appendChild) && (h = Ue.body), f = h._gsap, f && m && f.width && l && f.time === ce.time && !f.uncache)
  ...
  var s = new ne(this._pt, e.style, t, 0, 1, rn), l = 0, d = 0, c, u, p, m, g, h, f, b, y, _, v, x;
  if (s.b = a, s.e = i, a += "", i += "", i.substring(0, 6) === "var(--" && (i = pe(e, i.substring(4, i.indexOf(")")))), i === "auto" && (h = e.style[t], e.style[t] = i, i = pe(e, t) || i, h ? e.style[t] = h : Je(e, t)), c = [a, i], Xr(c), a = c[0], i = c[1], p = a.match(vt) || [], x = i.match(vt) || [], x.length) {
    for (; u = vt.exec(i); )
      f = u[0], y = i.substring(l, u.index), g ? g = (g + 1) % 5 : (y.substr(-5) === "rgba(" || y.substr(-5) === "hsla(") && (g = 1), f !== (h = p[d++] || "") && (m = parseFloat(h) || 0, v = h.substr((m + "").length), f.charAt(1) === "=" && (f = Ct(m, f) + v), b = parseFloat(f), _ = f.substr((b + "").length), l = vt.lastIndex - _.length, _ || (_ = _ || he.units[t] || v, l === i.length && (i += _, s.e += _)), v !== _ && (m = Qe(e, t, h, _) || 0), s._pt = {
        _next: s._pt,
        p: y || d === 1 ? y : ",",
        //note: SVG spec allows omission of comma/space when a negative sign is wedged between two numbers, like 2.5-5.3 instead of 2.5,-5.3 but when tweening, the negative value may switch to positive, so we insert the comma just in case.
        s: m,
      ...
      if (h !== "autoRound" && (c = t[h], !(de[h] && Zr(h, t, a, i, e, r)))) {
        if (m = typeof c, g = ba[h], m === "function" && (c = c.call(a, i, e, r), m = typeof c), m === "string" && ~c.indexOf("random(") && (c = Xt(c)), g)
          ...
          if (_ || (u || u === 0) && (p || p === 0) && !Oo.test(c) && h in s)
            f = (d + "").substr((p + "").length), u || (u = 0), b = K(c) || (h in he.units ? he.units[h] : f), f !== b && (p = Qe(e, h, d, b)), this._pt = new ne(this._pt, _ ? x : s, h, p, (y ? Ct(p, y + u) : u) - p, !_ && (b === "px" || h === "zIndex") && t.autoRound !== !1 ? Ho : ni), this._pt.u = b || 0, _ && S !== c ? (this._pt.b = d, this._pt.e = S, this._pt.r = Fo) : f !== b && b !== "%" && (this._pt.b = d, this._pt.r = zo);
          else if (h in s)
...
class As {
  ...
  measureComposerFullFrame() {
    w.set(this.composer, { clearProps: vs });
...
function ra(n, e, t) {
  ...
  const s = e.x - n.x, l = e.y - n.y, d = s / i, c = l / i, u = -c, p = d, m = a() > 0.5 ? 1 : -1, g = t.curve ?? 1, f = St(i * (o === "drag" ? 0.1 : o === "click" ? 0.17 : 0.22) * g, 18, 150) * m * (0.72 + a() * 0.44), b = i / Is[r] + 0.16, y = St(b * Rs[o] * Ns, 0.3, 1.66), _ = t.overshoot === !1 || i < 120 ? 0 : typeof t.overshoot == "number" ? t.overshoot : St(i * 0.026, 4, 18), v = _ > 0 ? {
    x: e.x + d * _,
    y: e.y + c * _
  } : e, x = {
