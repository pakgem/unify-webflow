...
var ge = {
  ...
  overwrite: !1,
  delay: 0
}, bi, X, G, xe = 1e8, q = 1 / xe, ai = Math.PI * 2, xo = ai / 4, _o = 0, Yn = Math.sqrt, Ao = Math.cos, vo = Math.sin, K = function(e) {
...
}, ee = Array.isArray, ko = /random\([^)]+\)/g, So = /,\s*/g, Fi = /(?:-?\.?\d|\.)+/gi, jn = /[-+=.]*\d+[.e\-+]*\d*[e\-+]*\d*/g, wt = /[-+=.]*\d+[.e-]*\d*[a-z%]*/g, Ra = /[-+=.]*\d+\.?\d*(?:e-|e\+)?\d*/gi, Kn = /[+-]=-?[.\d]+/, Co = /[^,'"\[\]\s]+/gi, To = /^[+\-=e\s\d]*\d+[.\d]*([a-z]*|%)\s*$/i, H, Ee, ii, _i, me = {}, pa = {}, Xn, Jn = function(e) {
  ...
  suppressEvents: !0
}, vi = {}, Xe = [], ni = {}, $n, de = {}, Ia = {}, Ui = 30, da = [], ki = "", Si = function(e) {
  var t = e[0], a, i;
  ...
  for (i = e.length; i--; )
    e[i] && (e[i]._gsap || (e[i]._gsap = new _r(e[i], a))) || e.splice(i, 1);
  return e;
}, ut = function(e) {
  ...
  var t = parseFloat(e);
  return (t || t === 0) && (e + "").match(Co).length < 2 ? t : K(e) ? e.trim() : e;
}, ir = function(e) {
  return e;
}, fe = function(e, t) {
  for (var a in t)
  ...
  var t = e.parent || H, a = e.keyframes ? Ro(ee(e.keyframes)) : fe;
  if (re(e.inherit))
    for (; t; )
  ...
  return t.parent && Ze(t), t._start = V((Ge(a) ? a : a || e !== H ? be(e, a, t) : e._time) + t._delay), t._end = V(t._start + (t.totalDuration() / Math.abs(t.timeScale()) || 0)), nr(e, t, "_first", "_last", e._sort ? "_start" : 0), oi(t) || (e._recent = t), i || rr(e, t), e._ts < 0 && Sa(e, e._tTime), e;
}, or = function(e, t) {
  return (me.ScrollTrigger || Ai("scrollTrigger", t)) && me.ScrollTrigger.create(t, e);
}, sr = function(e, t, a, i, n) {
  if (Ei(e, t, n), !e._initted)
    return 1;
  if (!a && e._pt && !X && (e._dur && e.vars.lazy !== !1 || !e._dur && e.vars.lazy) && $n !== ue.frame)
  ...
  var n = e.ratio, o = t < 0 || !t && (!e._start && No(e) && !(!e._initted && oi(e)) || (e._ts < 0 || e._dp._ts < 0) && !oi(e)) ? 0 : 1, s = e._rDelay, l = 0, c, d, u;
  ...
  var i = e.labels, n = e._recent || qo, o = e.duration() >= xe ? n.endTime(!1) : e._dur, s, l, c;
  ...
  return !K(e) || !(t = To.exec(e)) ? "" : t[1];
}, zo = function(e, t, a) {
  return tt(a, function(i) {
    return ea(e, t, i);
  });
}, si = [].slice, lr = function(e, t) {
  return e && Ie(e) && "length" in e && (!t && !e.length || e.length - 1 in e && Ie(e[0])) && !e.nodeType && e !== Ee;
}, Fo = function(e, t, a) {
  return a === void 0 && (a = []), e.forEach(function(i) {
    var n;
    return K(i) && !t || lr(i, 1) ? (n = a).push.apply(n, _e(i)) : a.push(i);
  }) || a;
}, _e = function(e, t, a) {
  return G && !t && G.selector ? G.selector(e) : K(e) && !a && (ii || !Tt()) ? si.call((t || _i).querySelectorAll(e), 0) : ee(e) ? Fo(e, a) : lr(e) ? si.call(e, 0) : e ? [e] : [];
}, li = function(e) {
  ...
  return K(i) ? d = u = {
    ...
    if (!w) {
      ...
      for (w = o[h] = [], b = l ? Math.min(S, h) * d - 0.5 : i % S, y = S === xe ? 0 : l ? h * u / S - 0.5 : i / S | 0, v = 0, C = xe, T = 0; T < h; T++)
        _ = T % S - b, A = y - (T / S | 0), w[T] = x = c ? Math.abs(c === "y" ? A : _) : Yn(_ * _ + A * A), x > v && (v = x), x < C && (C = x);
      i === "random" && cr(w), w.max = v - C, w.min = C, w.v = h = (parseFloat(t.amount) || parseFloat(t.each) * (S > h ? h - 1 : c ? c === "y" ? h / S : S : Math.max(S, h / S)) || 0) * (i === "edges" ? -1 : 1), w.b = h < 0 ? n - h : n, w.u = $(t.amount || t.each) || 0, a = a && h < 0 ? $o(a) : a;
    }
  ...
  var i = t - e;
  return ee(e) ? pr(e, r(0, e.length), t) : tt(a, function(n) {
    return (i + (n - e) % i) % i + e;
  });
}, Wo = function r(e, t, a) {
  var i = t - e, n = i * 2;
  return ee(e) ? pr(e, r(0, e.length - 1), t) : tt(a, function(o) {
    return o = (n + (o - e) % n) % n || 0, e + (o > i ? n - o : o);
  });
}, Yt = function(e) {
  return e.replace(ko, function(t) {
    var a = t.indexOf("[") + 1, i = t.substring(a || 7, a ? t.indexOf("]") : t.length - 1).split(So);
    return hr(a ? i : +i[0], a ? 0 : +i[1], +i[2] || 1e-5);
  });
  ...
  if (e)
    if (e = !e.name && e.default || e, xi() || e.headless) {
      ...
      Zn(t, i), e.register && e.register(ce, i, se);
    } else
      mr.push(e);
}, B = 255, Ot = {
  aqua: [0, B, B],
  ...
  if (!i) {
    if (e.substr(-1) === "," && (e = e.substr(0, e.length - 1)), Ot[e])
      ...
      if (i = f = e.match(Fi), !t)
        ...
        return i = e.match(jn), a && i.length < 4 && (i[3] = 1), i;
    } else
      i = e.match(Fi) || Ot.transparent;
    i = i.map(Number);
  }
  ...
  if (n = n.map(function(g) {
    return (g = wr(g, t, 1)) && o + (t ? g[0] + "," + g[1] + "%," + g[2] + "%," + g[3] : g.join(",")) + ")";
  }), a && (d = br(e), l = a.c, l.join(i) !== d.c.join(i)))
...
})(), Qo = /hsl[a]?\(/, yr = function(e) {
  var t = e.join(" "), a;
  if (Je.lastIndex = 0, Je.test(t))
    return a = Qo.test(t), e[1] = Yi(e[1], a), e[0] = Yi(e[0], a, br(e[1])), !0;
}, Qt, ue = (function() {
  ...
  return u = {
    ...
    wake: function() {
      Xn && (!ii && xi() && (Ee = ii = window, _i = Ee.document || {}, me.gsap = ce, (Ee.gsapVersions || (Ee.gsapVersions = [])).push(ce.version), Jn(pa || Ee.GreenSockGlobals || !Ee.gsap && Ee || {}), mr.forEach(fr)), d = typeof requestAnimationFrame < "u" && requestAnimationFrame, l && u.sleep(), c = d || function(w) {
  ...
  return !Qt && ue.wake();
}, R = {}, jo = /^[\d.\-M][\d.\-,\s]/, Ko = /["']/g, Xo = function(e) {
  for (var t = {}, a = e.substr(1, e.length - 3).split(":"), i = a[0], n = 1, o = a.length, s, l, c; n < o; n++)
    l = a[n], s = n !== o - 1 ? l.lastIndexOf(",") : l.length, c = l.substr(0, s), t[i] = isNaN(c) ? c.replace(Ko, "").trim() : +c, i = l.substr(s + 1).trim();
  return t;
}, Jo = function(e) {
  ...
  return a && t.length > 1 && a.config ? a.config.apply(null, ~e.indexOf("{") ? [Xo(t[1])] : Jo(e).split(",").map(ar)) : R._CE && jo.test(e) ? R._CE("", e) : a;
}, $o = function(e) {
  return function(t) {
    return 1 - e(1 - t);
  };
}, pt = function(e, t) {
  return e && (Y(e) ? e : R[e] || Zo(e)) || t;
}, mt = function(e, t, a, i) {
  ...
  var i = t >= 1 ? t : 1, n = (a || (e ? 0.3 : 0.45)) / (t < 1 ? t : 1), o = n / ai * (Math.asin(1 / i) || 0), s = function(d) {
    return d === 1 ? 1 : i * Math.pow(2, -10 * d) * vo((d - o) * n) + 1;
...
var _r = function(e, t) {
  this.id = _o++, e._gsap = this, this.target = e, this.harness = t, this.get = t ? t.get : er, this.set = t ? t.getSetter : Pi;
  ...
  return e.delay = function(a) {
    ...
    if (n && n.smoothChildTiming && this._ts) {
      for (Sa(this, a), !n._dp || n.parent || rr(n, this); n && n.parent; )
    ...
    return (this._tTime !== a || !this._dur && !i || this._initted && Math.abs(this._zTime) === q || !this._initted && this._dur && a || !a && !this._initted && (this.add || this._ptLookup)) && (this._ts || (this._pTime = a), tr(this, a, i)), this;
  }, e.time = function(a, i) {
    ...
    return this._rts = +a || 0, this._ts = this._ps || a === -q ? 0 : this._rts, this.totalTime(ea(-Math.abs(this._delay), this.totalDuration(), n), i !== !1), ka(this), Do(this);
  }, e.paused = function(a) {
...
var ne = /* @__PURE__ */ (function(r) {
  ...
  function e(a, i) {
    var n;
    return a === void 0 && (a = {}), n = r.call(this, a) || this, n.labels = {}, n.smoothChildTiming = !!a.smoothChildTiming, n.autoRemoveChildren = !!a.autoRemoveChildren, n._sort = re(a.sortChildren), H && Me(a.parent || H, Be(n), i), a.reversed && n.reverse(), a.paused && n.paused(!0), a.scrollTrigger && or(Be(n), a.scrollTrigger), n;
  }
  var t = e.prototype;
  return t.to = function(i, n, o) {
    ...
    return n.duration = 0, n.parent = this, zt(n).repeatDelay || (n.repeat = 0), n.immediateRender = !!n.immediateRender, new j(i, n, be(this, o), 1), this;
    ...
    if (this !== H && d > l && i >= 0 && (d = l), d !== this._tTime || o || u) {
      ...
      if (this._hasPause && !this._forcing && this._lock < 2 && (y = Bo(this, V(s), V(g)), y && (d -= g - (g = y._start))), this._tTime = d, this._time = g, this._act = !!_, this._initted || (this._onUpdate = this.vars.onUpdate, this._initted = 1, this._zTime = i, s = 0), !s && d && c && !n && !x && (he(this, "onStart"), this._tTime !== d))
        return this;
      if (g >= s && i >= 0)
        for (p = this._first; p; ) {
    ...
    for (var o = [], s = _e(i), l = this._first, c = Ge(n), d; l; )
      l instanceof j ? Po(l._targets, s) && (c ? (!Ye || l._initted && l._ts) && l.globalTime(0) <= n && l.globalTime(l.totalDuration()) > n : !n || l.isActive()) && o.push(l) : (d = l.getTweensOf(s, n)).length && o.push.apply(o, d), l = l._next;
    return o;
    ...
    if (H._ts && (tr(H, fa(i, H)), $n = ue.frame), ue.frame >= Ui) {
      Ui += ge.autoSleep || 120;
      var n = H._first;
...
var es = function(e, t, a, i, n, o, s) {
  var l = new se(this._pt, e, t, 0, 1, Tr, null, n), c = 0, d = 0, u, g, p, f, h, w, b, y;
  ...
  return l.c = c < i.length ? i.substring(c, i.length) : "", l.fp = s, (Kn.test(i) || b) && (l.e = 0), this._pt = l, l;
}, Ti = function(e, t, a, i, n, o, s, l, c, d) {
  Y(i) && (i = i(n || 0, e, o));
  var u = e[t], g = a !== "get" ? a : Y(u) ? c ? e[t.indexOf("set") || !Y(e["get" + t.substr(3)]) ? t : "get" + t.substr(3)](c) : e[t]() : u, p = Y(u) ? c ? rs : Sr : Mi, f;
  if (K(i) && (~i.indexOf("random(") && (i = Yt(i)), i.charAt(1) === "=" && (f = yt(g, i) + ($(g) || 0), (f || f === 0) && (i = f))), !d || g !== i || di)
    return !isNaN(g * i) && i !== "" ? (f = new se(this._pt, e, t, +g || 0, i - (g || 0), typeof u == "boolean" ? ss : Cr, 0, p), c && (f.fp = c), s && f.modifier(s, this, e), this._pt = f) : (!u && !(t in e) && Ai(t, i), es.call(this, e, t, g, i, p, l || ge.stringFilter, c));
}, ts = function(e, t, a, i, n) {
  if (Y(e) && (e = Ut(e, n, t, a, i)), !Ie(e) || e.style && e.nodeType || ee(e) || Qn(e))
    return K(e) ? Ut(e, n, t, a, i) : e;
  var o = {}, s;
  for (s in e)
    o[s] = Ut(e[s], n, t, a, i);
  return o;
}, Ar = function(e, t, a, i, n, o) {
  var s, l, c, d;
  if (de[e] && (s = new de[e]()).init(n, s.rawVars ? t[e] : ts(t[e], i, n, o, a), a, i, o) !== !1 && (a._pt = l = new se(a._pt, n, e, 0, 1, s.render, s, 0, s.priority), a !== bt))
    for (c = a._ptLookup[a._targets.indexOf(n)], d = s._props.length; d--; )
      c[s._props[d]] = l;
  return s;
}, Ye, di, Ei = function r(e, t, a) {
  var i = e.vars, n = i.ease, o = i.startAt, s = i.immediateRender, l = i.lazy, c = i.onUpdate, d = i.runBackwards, u = i.yoyoEase, g = i.keyframes, p = i.autoRevert, f = e._dur, h = e._startAt, w = e._targets, b = e.parent, y = b && b.data === "nested" ? b.vars.targets : w, _ = e._overwrite === "auto" && !bi, A = e.timeline, x = i.easeReverse || u, T, v, C, S, E, F, O, D, I, N, P, U, J;
  if (A && (!g || !n) && (n = "none"), e._ease = pt(n, Vt.ease), e._rEase = x && (pt(x) || e._ease), e._from = !A && !!i.runBackwards, e._from && (e.ratio = 1), !A || g && !i.stagger) {
    if (D = w[0] ? ut(w[0]).harness : 0, U = D && i[D.prop], T = ma(i, vi), h && (h._zTime < 0 && h.progress(1), t < 0 && d && s && !p ? h.render(-1, !0) : h.revert(d && f ? ca : Eo), h._lazy = 0), o) {
...
}, vr = ki + "repeat,repeatDelay,yoyo,repeatRefresh,yoyoEase,easeReverse,autoRevert", kr = {};
oe(vr + ",id,stagger,delay,duration,paused,scrollTrigger", function(r) {
  return kr[r] = 1;
});
var j = /* @__PURE__ */ (function(r) {
  ...
  function e(a, i, n, o) {
    ...
    var l = s.vars, c = l.duration, d = l.delay, u = l.immediateRender, g = l.stagger, p = l.overwrite, f = l.keyframes, h = l.defaults, w = l.scrollTrigger, b = i.parent || H, y = (ee(a) || Qn(a) ? Ge(a[0]) : "length" in i) ? [a] : _e(a), _, A, x, T, v, C, S, E;
    if (s._targets = y.length ? Si(y) : Ht("GSAP target " + a + " not found. https://gsap.com", !ge.nullTargetWarn) || [], s._ptLookup = [], s._overwrite = p, f || g || ta(c) || ta(d)) {
      ...
      if (_ = s.timeline = new ne({
        ...
        if (T = y.length, S = g && dr(g), Ie(g))
          for (v in g)
            ~vr.indexOf(v) && (E || (E = {}), E[v] = g[v]);
        for (A = 0; A < T; A++)
          x = ma(i, kr), x.stagger = 0, F && (x.easeReverse = F), E && kt(x, E), C = y[A], x.duration = +Ut(c, Be(s), A, C, y), x.delay = (+Ut(d, Be(s), A, C, y) || 0) - s._delay, !g && T === 1 && x.delay && (s._delay = d = x.delay, s._start += d, x.delay = 0), _.to(C, x, S ? S(A, C, y) : 0), _._ease = R.none;
        _.duration() ? c = d = 0 : s.timeline = 0;
      } else if (f) {
        zt(fe(_.vars.defaults, {
          ease: "none"
        ...
        if (ee(f))
          ...
          x = {};
          for (v in f)
            v === "ease" || v === "easeEach" || ns(v, f[v], x, f.easeEach);
          for (v in x)
      ...
      s.timeline = 0;
    return p === !0 && !bi && (Ye = Be(s), H.killTweensOf(y), Ye = 0), Me(b, Be(s), n), i.reversed && s.reverse(), i.paused && s.paused(!0), (u || !c && !f && s._start === V(b._time) && re(u) && Lo(Be(s)) && b.data !== "nested") && (s._tTime = -q, s.render(Math.max(0, -d) || 0)), w && or(Be(s), w), s;
  }
  var t = e.prototype;
  return t.render = function(i, n, o) {
    ...
    return this._initted || Ei(this, c), d = this._ease(c / this._dur), as(this, i, n, o, s, d, c, l) ? this.resetTo(i, n, o, s, 1) : (Sa(this, 0), this.parent || nr(this._dp, this, "_first", "_last", this._dp._sort ? "_start" : 0), this.render(0));
  }, t.kill = function(i, n) {
...
var Mi = function(e, t, a) {
  ...
  return Y(e[t]) ? Sr : yi(e[t]) && e.setAttribute ? os : Mi;
}, Cr = function(e, t) {
  ...
  function r(t, a, i, n, o, s, l, c, d) {
    this.t = a, this.s = n, this.c = o, this.p = i, this.r = s || Cr, this.d = l || this, this.set = c || Mi, this.pr = d || 0, this._next = t, t && (t._prev = this);
  }
  var e = r.prototype;
  return e.modifier = function(a, i, n) {
    this.mSet = this.mSet || this.set, this.set = ds, this.m = a, this.mt = n, this.tween = i;
  }, r;
})();
...
ge.stringFilter = yr;
var gt = [], ua = {}, us = [], Qi = 0, hs = 0, Oa = function(e) {
  return (ua[e] || us).map(function(t) {
    return t();
  });
}, ui = function() {
  var e = Date.now(), t = [];
  ...
  function r(t, a) {
    this.selector = a && li(a), this.data = [], this._r = [], this.isReverted = !1, this.id = hs++, t && this.add(t);
  }
  var e = r.prototype;
...
var gs = function(e, t) {
  ...
  for (i in t)
    for (n = a.length; n--; )
      o = e._ptLookup[n][i], o && (o = o.d) && (o._pt && (o = gs(o, i)), o && o.modifier && o.modifier(t[i], e, a[n], i));
}, Ba = function(e, t) {
  return {
    name: e,
    headless: 1,
...
}, Ba("roundProps", ci), Ba("modifiers"), Ba("snap", ur)) || wa;
...
R.Expo;
R.Circ;
var ji, Qe, xt, Ii, dt, Ki, Di, fs = function() {
  return typeof window < "u";
}, Ve = {}, lt = 180 / Math.PI, _t = Math.PI / 180, ft = Math.atan2, Xi = 1e8, Li = /([A-Z])/g, ws = /(left|right|width|margin|padding|x)/i, bs = /[\s,\(]\S/, Re = {
  ...
  if (this.tfm) {
    for (o in this.tfm)
      i[o] = this.tfm[o];
    i.svg && (i.renderTransform(), t.setAttribute("data-svg-origin", this.svgo || "")), n = Di(), (!n || !n.isStart) && !a[W] && (Ir(a), i.zOrigin && a[le] && (a[le] += " " + i.zOrigin + "px", i.zOrigin = 0, i.renderTransform()), i.uncache = 1);
  }
}, Dr = function(e, t) {
  var a = {
    target: e,
  ...
  fs() && window.document && (ji = window, Qe = ji.document, xt = Qe.documentElement, dt = pi("div") || {
    style: {}
  }, pi("div"), W = Et(W), le = W + "Origin", dt.style.cssText = "border-width:0;line-height:0;position:absolute;padding:0", Lr = !!Et("perspective"), Di = ce.core.reverting, Ii = 1);
}, Zi = function(e) {
  ...
  var s = new se(e._pt, t, a, 0, 1, o ? Rr : Pr);
  ...
  var n = parseFloat(a) || 0, o = (a + "").trim().substr((n + "").length) || "px", s = dt.style, l = ws.test(t), c = e.tagName.toLowerCase() === "svg", d = (c ? "client" : "offset") + (l ? "Width" : "Height"), u = 100, g = i === "px", p = i === "%", f, h, w, b;
  if (i === o || !n || en[i] || en[o])
    return n;
  if (o !== "px" && !g && (n = r(e, t, a, "px")), b = e.getCTM && Or(e), (p || o === "%") && (Ve[t] || ~t.indexOf("adius")))
  ...
  if (p && (t === "height" || t === "width")) {
    ...
    (p || o === "%") && !Rs[pe(h, "display")] && (s.position = pe(e, "position")), h === e && (s.position = "static"), h.appendChild(dt), f = dt[d], h.removeChild(dt), s.position = "absolute";
  return l && p && (w = ut(h), w.time = ue.time, w.width = h[d]), Q(g ? f * n / u : f && n ? u / f * n : 0);
}, ze = function(e, t, a, i) {
  var n;
  return Ii || gi(), t in Re && t !== "transform" && (t = Re[t], ~t.indexOf(",") && (t = t.split(",")[0])), Ve[t] && t !== "transform" ? (n = Xt(e, i), n = t !== "transformOrigin" ? n[t] : n.svg ? n.origin : ya(pe(e, le)) + " " + n.zOrigin + "px") : (n = e.style[t], (!n || n === "auto" || i || ~(n + "").indexOf("calc(")) && (n = ba[t] && ba[t](e, t, a) || pe(e, t) || er(e, t) || (t === "opacity" ? 1 : 0))), a && !~(n + "").trim().indexOf(" ") ? et(e, t, n, a) + a : n;
}, Is = function(e, t, a, i) {
  if (!a || a === "none") {
    var n = Et(t, e, 1), o = n && pe(e, n, 1);
    o && o !== a ? (t = n, a = o) : t === "borderColor" && (a = pe(e, "borderTopColor"));
  }
  var s = new se(this._pt, e.style, t, 0, 1, Tr), l = 0, c = 0, d, u, g, p, f, h, w, b, y, _, A, x;
  if (s.b = a, s.e = i, a += "", i += "", i.substring(0, 6) === "var(--" && (i = pe(e, i.substring(4, i.indexOf(")")))), i === "auto" && (h = e.style[t], e.style[t] = i, i = pe(e, t) || i, h ? e.style[t] = h : $e(e, t)), d = [a, i], yr(d), a = d[0], i = d[1], g = a.match(wt) || [], x = i.match(wt) || [], x.length) {
    for (; u = wt.exec(i); )
    ...
    s.r = t === "display" && i === "none" ? Rr : Pr;
  return Kn.test(i) && (s.e = 0), this._pt = s, s;
}, tn = {
  top: "0%",
  bottom: "100%",
  left: "0%",
  ...
  if (t.tween && t.tween._time === t.tween._dur) {
    ...
    l && ($e(a, W), o && (o.svg && a.removeAttribute("transform"), i.scale = i.rotate = i.translate = "none", Xt(a, 1), o.uncache = 1, Ir(i)));
  }
}, ba = {
  clearProps: function(e, t, a, i, n) {
    if (n.data !== "isFromStart") {
      var o = e._pt = new se(e._pt, t, a, 0, 0, Ls);
  ...
  */
}, Kt = [1, 0, 0, 1, 0, 0], Br = {}, qr = function(e) {
  return e === "matrix(1, 0, 0, 1, 0, 0)" || e === "none" || !e;
}, an = function(e) {
  var t = pe(e, W);
  return qr(t) ? Kt : t.substr(7).match(jn).map(Q);
}, Ni = function(e, t) {
  ...
  a ? l !== Kt && (v = p * w - f * h) && (C = A * (w / v) + x * (-h / v) + (h * y - w * b) / v, S = A * (-f / v) + x * (p / v) - (p * y - f * b) / v, A = C, x = S) : (T = Nr(e), A = T.x + (~_[0].indexOf("%") ? A / 100 * T.width : A), x = T.y + (~(_[1] || _[0]).indexOf("%") ? x / 100 * T.height : x)), i || i !== !1 && s.smooth ? (b = A - c, y = x - d, s.xOffset = u + (b * p + y * h) - b, s.yOffset = g + (b * f + y * w) - y) : s.xOffset = s.yOffset = 0, s.xOrigin = A, s.yOrigin = x, s.smooth = !!i, s.origin = t, s.originIsAbsolute = !!a, e.style[le] = "0px 0px", o && (je(o, s, "xOrigin", c, A), je(o, s, "yOrigin", d, x), je(o, s, "xOffset", u, s.xOffset), je(o, s, "yOffset", g, s.yOffset)), e.setAttribute("data-svg-origin", A + " " + x);
}, Xt = function(e, t) {
  var a = e._gsap || new _r(e);
  if ("x" in a && !t && !a.uncache)
    return a;
  var i = e.style, n = a.scaleX < 0, o = "px", s = "deg", l = getComputedStyle(e), c = pe(e, le) || "0", d, u, g, p, f, h, w, b, y, _, A, x, T, v, C, S, E, F, O, D, I, N, P, U, J, De, ve, Mt, at, zi, Le, it;
  return d = u = g = h = w = b = y = _ = A = 0, p = f = 1, a.svg = !!(e.getCTM && Or(e)), l.translate && ((l.translate !== "none" || l.scale !== "none" || l.rotate !== "none") && (i[W] = (l.translate !== "none" ? "translate3d(" + (l.translate + " 0 0").split(" ").slice(0, 3).join(", ") + ") " : "") + (l.rotate !== "none" ? "rotate(" + l.rotate + ") " : "") + (l.scale !== "none" ? "scale(" + l.scale.split(" ").join(",") + ") " : "") + (l[W] !== "none" ? l[W] : "")), i.scale = i.rotate = i.translate = "none"), v = Ni(e, a.svg), a.svg && (a.uncache ? (J = e.getBBox(), c = a.xOrigin - J.x + "px " + (a.yOrigin - J.y) + "px", U = "") : U = !t && e.getAttribute("data-svg-origin"), mi(e, U || c, !!U || a.originIsAbsolute, a.smooth !== !1, v)), x = a.xOrigin || 0, T = a.yOrigin || 0, v !== Kt && (F = v[0], O = v[1], D = v[2], I = v[3], d = N = v[4], u = P = v[5], v.length === 6 ? (p = Math.sqrt(F * F + O * O), f = Math.sqrt(I * I + D * D), h = F || O ? ft(O, F) * lt : 0, y = D || I ? ft(D, I) * lt + h : 0, y && (f *= Math.abs(Math.cos(y * _t))), a.svg && (d -= x - (x * F + T * D), u -= T - (x * O + T * I))) : (it = v[6], zi = v[7], ve = v[8], Mt = v[9], at = v[10], Le = v[11], d = v[12], u = v[13], g = v[14], C = ft(it, at), w = C * lt, C && (S = Math.cos(-C), E = Math.sin(-C), U = N * S + ve * E, J = P * S + Mt * E, De = it * S + at * E, ve = N * -E + ve * S, Mt = P * -E + Mt * S, at = it * -E + at * S, Le = zi * -E + Le * S, N = U, P = J, it = De), C = ft(-D, at), b = C * lt, C && (S = Math.cos(-C), E = Math.sin(-C), U = F * S - ve * E, J = O * S - Mt * E, De = D * S - at * E, Le = I * E + Le * S, F = U, O = J, D = De), C = ft(O, F), h = C * lt, C && (S = Math.cos(C), E = Math.sin(C), U = F * S + O * E, J = N * S + P * E, O = O * S - F * E, P = P * S - N * E, F = U, N = J), w && Math.abs(w) + Math.abs(h) > 359.9 && (w = h = 0, b = 180 - b), p = Q(Math.sqrt(F * F + O * O + D * D)), f = Q(Math.sqrt(P * P + it * it)), C = ft(N, P), y = Math.abs(C) > 2e-4 ? C * lt : 0, A = Le ? 1 / (Le < 0 ? -Le : Le) : 0), a.svg && (U = e.getAttribute("transform"), a.forceCSS = e.setAttribute("transform", "") || !qr(pe(e, W)), U && e.setAttribute("transform", U))), Math.abs(y) > 90 && Math.abs(y) < 270 && (n ? (p *= -1, y += h <= 0 ? 180 : -180, h += h <= 0 ? 180 : -180) : (f *= -1, y += y <= 0 ? 180 : -180)), t = t || a.uncache, a.x = d - ((a.xPercent = d && (!t && a.xPercent || (Math.round(e.offsetWidth / 2) === Math.round(-d) ? -50 : 0))) ? e.offsetWidth * a.xPercent / 100 : 0) + o, a.y = u - ((a.yPercent = u && (!t && a.yPercent || (Math.round(e.offsetHeight / 2) === Math.round(-u) ? -50 : 0))) ? e.offsetHeight * a.yPercent / 100 : 0) + o, a.z = g + o, a.scaleX = Q(p), a.scaleY = Q(f), a.rotation = Q(h) + s, a.rotationX = Q(w) + s, a.rotationY = Q(b) + s, a.skewX = y + s, a.skewY = _ + s, a.transformPerspective = A + o, (a.zOrigin = parseFloat(c.split(" ")[2]) || !t && a.zOrigin || 0) && (i[le] = ya(c)), a.xOffset = a.yOffset = 0, a.force3D = ge.force3D, a.renderTransform = a.svg ? Os : Lr ? zr : Ns, a.uncache = 0, a;
}, ya = function(e) {
...
}, nt = "0deg", Pt = "0px", rt = ") ", zr = function(e, t) {
  ...
  return s && (u = n.split("_")[1], u === "short" && (c %= o, c !== c % (o / 2) && (c += c < 0 ? o : -o)), u === "cw" && c < 0 ? c = (c + o * Xi) % o - ~~(c / o) * o : u === "ccw" && c > 0 && (c = (c - o * Xi) % o - ~~(c / o) * o)), e._pt = g = new se(e._pt, t, a, i, c, ys), g.e = d, g.u = "deg", e._props.push(a), g;
}, nn = function(e, t) {
  for (var a in t)
    e[a] = t[a];
  return e;
...
var Fr = {
  ...
  init: function(e, t, a, i, n) {
    ...
    Ii || gi(), this.styles = this.styles || Dr(e), C = this.styles.props, this.tween = a;
    for (h in t)
      if (h !== "autoRound" && (d = t[h], !(de[h] && Ar(h, t, a, i, e, n)))) {
        if (p = typeof d, f = ba[h], p === "function" && (d = d.call(a, i, e, n), p = typeof d), p === "string" && ~d.indexOf("random(") && (d = Yt(d)), f)
          ...
          if (l && h in l ? (c = typeof l[h] == "function" ? l[h].call(a, i, e, n) : l[h], K(c) && ~c.indexOf("random(") && (c = Yt(c)), $(c + "") || c === "auto" || (c += ge.units[h] || $(ze(e, h)) || ""), (c + "").charAt(1) === "=" && (c = ze(e, h))) : c = ze(e, h), g = parseFloat(c), y = p === "string" && d.charAt(1) === "=" && d.substr(0, 2), y && (d = d.substr(2)), u = parseFloat(d), h in Re && (h === "autoAlpha" && (g === 1 && ze(e, "visibility") === "hidden" && u && (g = 0), C.push("visibility", 0, s.visibility), je(this, s, "visibility", g ? "inherit" : "hidden", u ? "inherit" : "hidden", !u)), h !== "scale" && h !== "transform" && (h = Re[h], ~h.indexOf(",") && (h = h.split(",")[0]))), _ = h in Ve, _) {
            ...
            if (A || (x = e._gsap, x.renderTransform && !t.parseTransform || Xt(e, t.parseTransform), T = t.smoothOrigin !== !1 && x.smooth, A = this._pt = new se(this._pt, s, W, 0, 1, x.renderTransform, x, 0, -1), A.dep = 1), h === "scale")
              ...
              C.push(le, 0, s[le]), d = Ds(d), x.svg ? mi(e, d, 0, T, 0, this) : (b = parseFloat(d.split(" ")[2]) || 0, b !== x.zOrigin && je(this, x, "zOrigin", x.zOrigin, b), je(this, s, h, ya(c), ya(d)));
              continue;
            } else if (h === "svgOrigin") {
              mi(e, d, 1, T, 0, this);
              continue;
            } else if (h in Br) {
              Bs(this, x, h, g, y ? yt(g, y + d) : d);
              continue;
          ...
          if (_ || (u || u === 0) && (g || g === 0) && !bs.test(d) && h in s)
            w = (c + "").substr((g + "").length), u || (u = 0), b = $(d) || (h in ge.units ? ge.units[h] : w), w !== b && (g = et(e, h, c, b)), this._pt = new se(this._pt, _ ? x : s, h, g, (y ? yt(g, y + u) : u) - g, !_ && (b === "px" || h === "zIndex") && t.autoRound !== !1 ? As : hi), this._pt.u = b || 0, _ && S !== d ? (this._pt.b = c, this._pt.e = S, this._pt.r = _s) : w !== b && b !== "%" && (this._pt.b = c, this._pt.r = xs);
          else if (h in s)
            Is.call(this, e, h, c, y ? y + d : d);
          else if (h in e)
  ...
  getSetter: function(e, t, a) {
    var i = Re[t];
    return i && i.indexOf(",") < 0 && (t = i), t in Ve && t !== le && (e._gsap.x || ze(e, "x")) ? a && Ki === a ? t === "scale" ? Cs : Ss : (Ki = a || {}) && (t === "scale" ? Ts : Es) : e.style && !yi(e.style[t]) ? vs : ~t.indexOf("-") ? ks : Pi(e, t);
  },
  core: {
    _removeProperty: $e,
    _getMatrix: Ni
...
ce.core.getStyleSaver = Dr;
(function(r, e, t, a) {
  var i = oe(r + "," + e + "," + t, function(n) {
    Ve[n] = 1;
  });
  oe(e, function(n) {
    ge.units[n] = "deg", Br[n] = 1;
...
ce.registerPlugin(Fr);
var m = ce.registerPlugin(Fr) || ce;
m.core.Tween;
...
function ml(r) {
  const e = Ur(r).replace(/[^a-z0-9]+/g, "-").replace(/^-|-$/g, "");
  return e ? `${L}?u=${encodeURIComponent(e)}` : "";
}
function Ta(r, e) {
  const t = Ur(r), a = e?.trim() || void 0;
  return gl[t] ?? a ?? ml(r);
}
const Gr = `
...
const fl = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="52 42 88 66">
<path fill="#4285f4" d="M58 108h14V74L52 59v43c0 3.32 2.69 6 6 6"/>
<path fill="#34a853" d="M120 108h14c3.32 0 6-2.69 6-6V59l-20 15"/>
<path fill="#fbbc04" d="M120 48v26l20-15v-8c0-7.42-8.47-11.65-14.4-7.2"/>
<path fill="#ea4335" d="M72 74V48l24 18 24-18v26L96 92"/>
<path fill="#c5221f" d="M52 51v8l20 15V48l-5.6-4.2c-5.94-4.45-14.4-.22-14.4 7.2"/>
</svg>`, wl = `<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" viewBox="60 90.4 570.02 539.67">
<defs>
...
const bl = [
...
], yl = 1.28, k = (r) => Number((r * yl).toFixed(3)), xl = [2, 3, 2], ae = {
  ...
  settleHold: k(0.24)
}, dn = "Learning your style", _l = "Voice calibrated", un = "73 tone & tactic rules defined", Fa = [
  ...
  0,
  4
], kl = /* @__PURE__ */ new Set([5, 8, 10, 16]), Sl = [
  ...
  threadGap: 44
}, Ml = "left,right,bottom,width,height,minHeight,paddingTop,paddingRight,paddingBottom,paddingLeft,borderWidth,gap", Va = {
  paddingTop: "",
  paddingRight: "",
  paddingBottom: "",
  paddingLeft: "",
  ...
  contentWidth: 1881,
  height: 1280
}, Il = 96, wn = ".wa-cursor-file, .wa-file-landing-clone, .wa-file-landing-label, .wa-csv-drop, .wa-signup-logo-transfer", bn = "[data-marketing-data-sources-grid]", yn = "[data-data-table]", It = "[data-table-action]", xn = "[data-table-page-button]", Dl = "[data-table-page-range]", Ll = "https://cdn.jsdelivr.net/npm/simple-icons@latest/icons", Nl = "https://www.google.com/s2/favicons", Ol = {
  adyen: "adyen",
  airtable: "airtable",
  brex: "brex",
  "dbt labs": "dbt",
...
class ql {
  ...
  measureComposerFullFrame() {
    m.set(this.composer, { clearProps: Ml });
  ...
  strategyPlans(e) {
    ...
    const d = this.claimComponentMessage("strategy", a), u = m.timeline().add(this.revealMessage(d, n, mn)).addLabel(s, Pl).call(() => this.setMotionHints(c), void 0, s).to(t, { ...o.to }, s);
  ...
  connectMailbox(e) {
    ...
    return p.call(() => {
      ...
      i.dataset.mailboxLearningState = "ready", l.textContent = _l, d.textContent = i.dataset.mailboxLearningReadyDetail ?? un;
    }).fromTo(
      l,
      { autoAlpha: 0, y: 4 },
      {
  ...
  resetMessageClasses(e) {
    e.classList.remove(...bl), e.classList.remove("wa-message--first-active");
  }
  createCsvDropArea(e = {}) {
  ...
  streamThinkingHeader(e) {
    return this.streamThinkingChild(e, ".wa-thinking__title", El);
  }
  streamThinkingStepLabel(e) {
    return this.streamThinkingChild(e, ".wa-research-step__label", Tl);
  }
  ...
  renderSignupLogoTransfer(e, t) {
    if (!e) return;
    const a = e.target.getBoundingClientRect(), i = this.getElementLocalRect(a, this.chatBody), n = Wr(t);
  ...
  createMarketingDataSourcesGrid(e) {
    ...
    return t.classList.add("wa-data-source-grid--marketing"), t.dataset.marketingDataSourcesGrid = e.id, a.className = "wa-data-source-grid__scale", i.className = "wa-data-source-grid__groups", Rl.forEach((s) => {
      const l = document.createElement("div");
  ...
  createMailboxConnection(e) {
    ...
    f.className = "wa-mailbox-learning__detail", f.textContent = e.learningDetail ?? Fa[0].detail;
  ...
  createMailboxProviderIcon(e) {
    ...
    return t.className = "wa-mailbox-connection__provider-icon", t.src = Al[e], t.alt = "", t.decoding = "async", t.loading = "eager", t.setAttribute("aria-hidden", "true"), t;
  }
  ...
  createMailboxThumbprintGroup(e, t = !1) {
    ...
    return a.classList.add(e), Sl.forEach((i, n) => {
      const o = document.createElementNS("http://www.w3.org/2000/svg", "path");
  ...
  createSequenceEngagement(e) {
    const t = document.createElement("section"), a = Vr(e);
    ...
    e.sequences.forEach((p, f) => {
      ...
      const v = p.steps;
      if (v?.length) {
        const C = document.createElement("div"), S = v[0], E = document.createElement("div"), F = document.createElement("span"), O = document.createElement("strong"), D = document.createElement("p");
        ...
        }), E.className = "wa-sequence-copy-panel", E.dataset.sequenceCopyPanel = "", F.className = "wa-sequence-copy-panel__meta", F.dataset.sequenceCopyMeta = "", F.textContent = S ? `${S.channel} 1` : "Email", O.className = "wa-sequence-copy-panel__subject", O.dataset.sequenceCopySubject = "", O.textContent = p.subject, D.className = "wa-sequence-copy-panel__body", D.dataset.sequenceCopyBody = "", D.textContent = S ? this.getSequenceStepCopy(p, S) : p.personalization, E.append(F, O, D), h.append(C, E);
      } else
        h.append(w, x, T);
      o.append(h);
    });
  ...
  getSequenceStepWaitDays(e, t, a) {
    return t >= a - 1 ? null : e.waitDays ?? xl[t] ?? 1;
  }
...
`);
  ...
  requestMessageScroll(e) {
    ...
    this.scheduledScrollMessage = e, !(t - this.lastStreamScrollAt < Il) && (this.scheduledScrollFrame || (this.lastStreamScrollAt = t, this.scheduledScrollFrame = window.requestAnimationFrame(() => {
...
function zl(r, e) {
  const t = vl[r] ?? 0, a = 24 + r * 11 % 8, i = Math.min(100, t + a), n = Wr((e - t) / (i - t));
  if (n <= 0) return 0;
  const o = kl.has(r) ? 20 : 12;
...
function ia(r, e, t) {
  const a = Yr(t.seed), i = Fl(r, e), n = t.speed ?? "normal", o = t.intent ?? "hover";
  ...
  const s = e.x - r.x, l = e.y - r.y, c = s / i, d = l / i, u = -d, g = c, p = a() > 0.5 ? 1 : -1, f = t.curve ?? 1, w = Bt(i * (o === "drag" ? 0.1 : o === "click" ? 0.17 : 0.22) * f, 18, 150) * p * (0.72 + a() * 0.44), b = i / Gl[n] + 0.16, y = Bt(b * Vl[o] * Hl, 0.3, 1.66), _ = t.overshoot === !1 || i < 120 ? 0 : typeof t.overshoot == "number" ? t.overshoot : Bt(i * 0.026, 4, 18), A = _ > 0 ? {
    x: e.x + c * _,
    y: e.y + d * _
  } : e, x = {
...
class Ql {
  ...
  renderMimicRotation(e, t) {
    ...
    if (a * a + i * i < 4) return;
    const n = Math.atan2(i, a) * 180 / Math.PI, o = jl(n - Wl), s = this.rotationState + Kl(this.rotationState, o) * Yl;
...
function qt(r) {
  const e = /* @__PURE__ */ new Set(), t = (a) => Xl(e, a.values);
...
}, Xr = z("[data-signup-field]", "center", {
  desktop: -74,
  tablet: -66,
  mobile: -48
}), Jr = z("[data-signup-submit]", "center"), ec = z("[data-send-button]", "center"), Bi = {
  desktop: {
...
}, tc = 2.8, ac = 42, ic = 2, nc = 3, _a = "[data-chat-shell] [data-chat-thread]", rc = `${_a} [data-message-role="assistant"]:not(.wa-message--component) [data-message-body]`, oc = `${_a} [data-message-role="assistant"].wa-message--thinking .wa-research-step[data-step-state="current"] .wa-research-step__body, ${_a} [data-message-role="assistant"].wa-message--thinking .wa-research-step[data-step-state="complete"] .wa-research-step__label`, wi = 0.24, Zr = 0.3, Fe = {
...
function sc(r, e, t, a, i) {
  switch (t.kind) {
    ...
    case "transitionSignupToChat":
      ...
      return;
    case "assistant":
      r.add(e.chat.assistantMessage(t.text), t.at), pc(r, e, i, {
        kind: "assistant",
        key: t.text,
        text: t.text,
        selector: rc,
      ...
      return;
    case "thinking": {
      const n = lc(t), o = n.items.map((s) => s.label);
      t.statusBefore && r.add(e.chat.setStatus(t.statusBefore), t.at), r.add(e.chat.thinkingState(n, t.hold), t.statusBefore ? void 0 : t.at), hc(r, e, i, t.hold, o.length, o.join("|"), a);
      return;
    }
    case "dataTable":
      Lt(
    ...
    case "strategyPlans":
      {
        ...
        r.add(e.chat.strategyPlans(t.plans), t.at), r.add(uc(e, n, t.plans), "+=0.06");
      }
      return;
...
function cc(r, e, t, a) {
  ...
  r.add(e.chat.personalizationSwipeGame(t), a), t.signals.forEach((n, o) => {
    const s = `${i} [data-swipe-card="${ye(n.id)}"]`, l = n.decision === "use" ? 1 : -1, c = n.decision === "use" ? "right" : "left", d = z(s, c, {
...
function hc(r, e, t, a = M.thinkingShort, i = 1, n = "thinking", o = 0) {
  const s = a * Math.max(1, i), l = i >= 3 && io(e, t, {
    kind: "thinking",
    key: n,
    text: n,
    stepIndex: o,
...
function io(r, e, t) {
  ...
  if (a.length < i || e.textSkimCount >= nc) return !1;
  const n = e.textCandidateCount;
  e.textCandidateCount += 1;
  const o = e.textSkimCount === 0, s = t.stepIndex - e.lastTextSkimStep >= ic, l = mc(`${r.story.id}:${t.kind}:${n}:${t.key}`), c = n > 0 && n % 3 === 0, d = o || s && (l >= 0.58 || c);
...
function xc(r) {
  ...
  for (const t of r.steps) {
    ...
    const a = t.component;
    a.kind === "table" && qt(Zt(a, `${r.id}-${t.id}`)).forEach((i) => e.add(i)), a.kind === "dataSources" && Qr(so(a)).forEach((i) => e.add(i)), a.kind === "proximityList" && jr(ho(a)).forEach((i) => e.add(i)), a.kind === "sequenceEngagement" && Kr(qi(a, `${r.id}-${t.id}`)).forEach((i) => e.add(i));
  }
  return [...e];
}
function _c(r, e) {
  return r === "hit-ground-running" ? Xr : r === "data-marketplace" ? xa.dataMarketplace : r === "research-brief" ? xa.researchBrief : e.entry;
}
function Ac(r, e) {
  return r === "hit-ground-running" ? Zr : r === "data-marketplace" || r === "research-brief" ? wi : e.entryLeadTime;
}
function vc(r, e, t) {
  if (e.id === "hit-ground-running") return kc(r, e);
  if (e.id === "crm-update") return Sc(r, e);
  if (e.id === "research-brief") return Cc(r, e);
  if (e.id === "csv-import-cleanup") return Tc(r, e);
  const a = Rc(e);
  return a.length ? Pe(r, [...a, Ke(Fe.bottomRight, "+=0.18")]) : t.build(r);
}
function kc(r, e) {
  ...
  return Pe(r, [
    ...
    ...o ? [{ kind: "strategyPlans", plans: oo(o.component), at: "-=0.08" }] : [],
    Ke(Fe.right, "+=0.18")
  ]);
}
function Sc(r, e) {
  const t = $t(e, "mailboxConnection"), a = $t(e, "uploadedFiles"), i = [];
  if (t && uo(i, co(t.component)), a) {
    const n = lo(a.component), o = r.chat.prepareCsvDropArea({
      title: a.component.title,
      detail: n.map((d) => d.name).join(", ")
    }), s = n.length > 1 ? `${n.length} context files` : n[0]?.name ?? a.text, l = r.chat.prepareCursorFile(s, r.cursor, n[0]?.type ?? "DOC", n), c = z("[data-chat-shell]", "center", {
      desktop: { x: 0, y: 74 },
      tablet: { x: 0, y: 64 },
      mobile: { x: 0, y: 56 }
    });
  ...
  for (const n of e.steps)
    n === t || n === a || no(i, e.id, n);
  return i.push(Ke(Fe.bottomRight, "+=0.16")), Pe(r, i);
}
function Cc(r, e) {
  ...
  if (o && (o.scrollAlign = "equal-inset"), t && l.push({
    ...
    ao("website-visitors-sales", M.beat + 0.18, "+=0.08")
...
function Tc(r, e) {
  ...
  ), o = a ? e.steps.indexOf(a) : -1, s = n.find((f) => o >= 0 && e.steps.indexOf(f) < o), l = [...n].reverse().find((f) => f !== s), c = t?.text || "may_webinar_attendees.csv", d = Ec(t, s?.component ?? l?.component), u = r.chat.prepareCsvDropArea(), g = r.chat.prepareCursorFile(c, r.cursor), p = z("[data-chat-shell]", "center", {
    desktop: { x: 0, y: 82 },
    tablet: { x: 0, y: 72 },
    mobile: { x: 0, y: 64 }
  });
  return Pe(r, [
    ...
    ...l ? [{ kind: "dataTable", config: Bc(Zt(l.component, "cleaned-webinar-attendees")), at: "-=0.04" }] : [],
...
function Rc(r) {
  const e = [], t = r.id === "data-marketplace" ? Ic(r.steps) : r.steps;
  let a = 0;
  for (const i of t)
    a += i.kind === "user" ? 1 : 0, no(e, r.id, i, a === 1);
  return e;
}
function Ic(r) {
  const e = [];
...
function no(r, e, t, a = !1) {
  ...
  t.kind !== "component" || !t.component || Lc(r, e, t);
}
function Lc(r, e, t) {
  const a = t.component;
  if (a.kind === "table") {
    const i = Zt(a, `${e}-${t.id}`);
    e === "data-marketplace" && qc(i), Vc(e, t, i) && (i.scrollAlign = "equal-inset"), r.push({ kind: "dataTable", config: i, at: "-=0.04" });
    return;
  }
  if (a.kind === "strategyCards") {
    r.push({ kind: "strategyPlans", plans: oo(a), at: "-=0.04" });
    return;
  }
  if (a.kind === "enrichment") {
    r.push({ kind: "enrichmentPanel", config: Zc(a), at: "+=0.12" });
    return;
  }
  ...
  if (a.kind === "uploadedFiles") {
    r.push({ kind: "custom", build: (i) => i.chat.uploadedFilesMessage(lo(a)), at: "-=0.04" });
    return;
  }
  ...
  if (a.kind === "styleProfile") {
    ...
    r.push({
      ...
      at: "-=0.02"
    }), e === "crm-update" && r.push(...eo(i.id));
    return;
  }
  if (a.kind === "proximityList") {
    r.push({ kind: "custom", build: (i) => i.chat.proximityLeadList(ho(a)), at: "-=0.04" });
    return;
  }
...
function Pa(r, e = {}) {
  return {
    kind: "thinking",
    thinking: Nc(r.thinking, r.text, r.note),
    hold: e.hold,
    at: e.at
  };
}
...
function Zt(r, e) {
  const t = Hc(r, e), a = r.rows.filter((o) => o.some((s) => s.trim())).map((o, s) => jc(o, t, s)), i = r.pagination?.pageSize ?? Gc(r.pagination?.ranges) ?? Math.min(10, a.length || 10), n = r.pagination?.ranges.map((o, s) => ({
    page: s + 1,
    range: o,
  ...
  return {
    ...
    eyebrow: r.eyebrow,
    count: r.count,
    variant: Uc(e) ? "csv" : t.variant ?? td(r),
    columns: t.columns,
    rows: n[0]?.rows ?? a,
    actions: r.actions?.map(Jc),
    pagination: n.length > 1 ? {
      pageSize: i,
      totalRows: ad(r, a.length),
      activePage: 1,
      pages: n
    } : void 0
  };
...
function qc(r) {
  r.rows.forEach((e) => Mn(e.values)), r.pagination?.pages.forEach((e) => {
    e.rows.forEach((t) => Mn(t.values));
  });
}
function Mn(r) {
  r.name && "company" in r && (r.company = "Stripe"), r.prospectDetail && (r.prospectDetail = zc(r.prospectDetail)), r.connector && (r.connector = Fc(r.connector));
}
function zc(r) {
  const e = r.trim();
  return e ? /(?:@|\bat\s+)[A-Z][A-Za-z0-9& .-]+(?:\s*\([^()]*\))?$/i.test(e) ? e.replace(
    /(?:@|\bat\s+)([A-Z][A-Za-z0-9& .-]+?)(\s*\([^()]*\))?$/i,
    (t, a, i = "") => `at Stripe${Pn(i)}`
...
function jc(r, e, t) {
  ...
  if (e.columns.forEach((i, n) => {
    ...
    const i = ro(a[e.mutualConnectionKey] ?? ""), n = Kc(t);
...
function ro(r) {
  const [e = "", t = ""] = r.split(/\s+[—–]\s+/, 2), a = e.trim().match(/^(.+?)(?:\s*\((.+)\))?$/), i = a?.[1]?.trim() || r.trim(), n = t.trim(), o = Oc[te(i).replace(/-/g, " ")], s = Xc(a?.[2]?.trim() || "", o, n);
  return {
    name: i,
    title: s.title,
    context: n,
...
function Xc(r, e, t) {
  const a = Rn(t), i = a && !/^(?:Stanford GSB|Wharton)$/i.test(a);
...
const id = [
...
}, mo = [
  {
    ...
    build: (r) => Pe(r, [
      ...
      { kind: "strategyPlans", plans: nd, at: "-=0.08" },
      Ke(Fe.right, "+=0.18")
    ])
  },
  {
    ...
    build: (r) => Pe(r, [
      ...
      { kind: "dataTable", config: In, at: "-=0.04" },
      {
        kind: "prompt",
      ...
      { kind: "enrichmentPanel", config: od, at: "+=0.12" },
      { kind: "status", text: "Contacts enriched", at: "+=0.86" },
      { kind: "dataTable", config: Nn, at: "-=0.02" },
      { kind: "marketingDataSourcesGrid", config: Ln, at: "+=1.44" },
      Ke(Fe.bottomRight, "+=3")
    ])
  },
  {
    ...
    build: (r) => {
      ...
      }), t = r.chat.prepareCursorFile("4 context files", r.cursor, "DOC", On), a = {
        desktop: { target: "[data-chat-shell]", anchor: "right", outside: "right", offset: { x: 420, y: -74 }, humanOffset: !1 },
        tablet: { target: "[data-chat-shell]", anchor: "right", outside: "right", offset: { x: 360, y: -58 }, humanOffset: !1 },
        mobile: { target: "[data-chat-shell]", anchor: "right", outside: "right", offset: { x: 280, y: -42 }, humanOffset: !1 }
      ...
      return Pe(r, [
        ...
        { kind: "custom", build: () => t.landAsUploadedFiles(On), at: "<" },
        ...
        {
          kind: "custom",
          build: () => r.chat.outreachStyleProfile(Bn, { scrollAlign: "equal-inset" }),
          at: "-=0.02"
        },
        ...eo(Bn.id),
        {
        ...
        { kind: "custom", build: () => r.chat.proximityLeadList(qn), at: "-=0.04" },
  ...
  },
  {
    ...
    build: (r) => {
      ...
      return Pe(r, [
        ...
        { kind: "custom", build: () => r.chat.dataTableActionTooltip("website-visitors-sales", "email-sequence", !1), at: "<+=0.02" },
        { kind: "status", text: "building outreach sequence", at: "<" },
        { kind: "custom", build: () => r.chat.sequenceBuildThinking(ld), at: "+=0.06" },
  ...
  },
  {
    ...
    build: (r) => {
      ...
      return Pe(r, [
        ...
        { kind: "dataTable", config: ud, at: "+=0.08" },
        { kind: "status", text: "Cleaning CSV", at: "<" },
        {
          kind: "thinking",
          steps: [
...
class pd {
  ...
  followPointer = () => {
    ...
    if (this.mode === "return") {
      const t = this.getReturnHomePoint(), a = gd((e - this.returnStartedAt) / ti.durationMs), i = this.getReturnWavePoint(a, t), n = this.getReturnWavePoint(Math.min(1, a + 0.035), t);
  ...
  updatePlayTarget(e) {
    ...
    this.target = fd(n, this.pointer, He.minPointerDistance, He.viewportInset);
  }
  resumeFollowing(e) {
  ...
  getReturnWavePoint(e, t) {
    const a = this.returnStart ?? this.getCursorViewportPoint(), i = md(e), n = t.x - a.x, o = t.y - a.y, s = Math.hypot(n, o), l = {
      x: a.x + n * i,
      y: a.y + o * i
    };
    if (s < 1) return l;
  ...
  isCursorTooFarFromBrowser() {
    ...
    return bd(i, e) > Z.maxBrowserDistance;
  }
  getChatShell() {
    return this.chatShell?.isConnected ? this.chatShell : (this.chatShell = this.root.querySelector("[data-chat-shell]"), this.chatShell);
  }
  ...
  countAxisReversals(e) {
    ...
    for (let n = 1; n < e.length; n += 1) {
      const o = e[n - 1], s = e[n], l = Vn(s.x - o.x), c = Vn(s.y - o.y);
...
function Gn(r, e) {
  return {
    x: Un(r.x, e, window.innerWidth - e),
    y: Un(r.y, e, window.innerHeight - e)
  };
}
function fd(r, e, t, a) {
  const i = Gn(wd(r, e, t), a);
...
class xd {
  constructor(e, t, a, i, n, o) {
    this.root = e, this.stories = t, this.resolver = a, this.cursor = i, this.chat = n, this.options = o, this.storyProgress = this.stories.map(() => 0), this.pausedCursorMimic = new pd(this.root, this.cursor, {
  ...
  updateStories(e, t = {}) {
    if (!e.length) return;
    const a = this.stories[this.activeIndex]?.id, i = this.stories, n = new Map(this.stories.map((c, d) => [c.id, this.storyProgress[d] ?? 0])), o = this.cursor.getPosition(), s = this.playing, l = _d(i, e);
  ...
  attachChatHistoryScroll() {
    ...
    const a = (i) => {
      ...
      if (Math.abs(n) < Hn.minPixelDelta) return;
      const o = this.getThreadMaxScroll(t);
      if (o <= 0 || !(n < 0 || this.historyPaused)) return;
      const l = fo(t.scrollTop + n, 0, o);
      if (!(Math.abs(l - t.scrollTop) >= 0.5)) return;
      const d = Math.max(0, n - (o - t.scrollTop));
      i.preventDefault(), this.pauseForChatHistory(), t.scrollTop = l, d >= Hn.minPixelDelta && window.scrollBy({ top: d, left: 0, behavior: "auto" });
    };
...
class Ad {
  ...
  resolve(e, t = "target") {
    ...
    if (s = {
      ...
      const l = Yr(t), c = Math.min(o.width * 0.18, 18), d = Math.min(o.height * 0.18, 14);
...
const vd = 3, kd = /* @__PURE__ */ new Set([
  "user",
  "assistant",
  "thinking",
  "component",
...
function Sd(r) {
  ...
  const e = typeof r.schemaVersion == "number" ? r.schemaVersion : 1, t = r.stories.map((a) => Ed(a)).filter((a) => !!a);
...
function Ed(r) {
  ...
  const e = Ae(r.id), t = Ae(r.label), a = Ae(r.summary), i = r.steps.map((n) => Md(n)).filter((n) => !!n);
...
function Md(r) {
  ...
  return !e || !t || !Cd(t) ? null : {
    id: e,
    kind: t,
    text: a ?? "",
    note: i ?? "",
    thinking: vt(r.thinking) ? Pd(r.thinking, a ?? "", i ?? "") : t === "thinking" ? wo(a ?? "", i ?? "") : void 0,
    component: vt(r.component) ? Td(r.component) : void 0
  };
}
function Pd(r, e, t) {
  const i = (Array.isArray(r.items) ? r.items : []).map((n, o) => Rd(n, o)).filter((n) => !!n);
  return i.length ? {
    title: Ae(r.title) ?? qe,
...
async function Id(r, e) {
  try {
    ...
    if (!t.ok) return;
    const a = Sd(await t.json());
    if (!a || a.schemaVersion !== vd) return;
          ...
          <div class="wa-chat-shell" data-chat-shell>
            ...
            <div class="wa-chat-shell__body">
              <div class="wa-signup-scene" data-signup-scene>
                <span class="wa-signup-scene__logo" data-signup-logo-target aria-hidden="true">${Gr}</span>
...
function Ld(r, e = {}) {
  Dd(r);
  const t = e.stories?.length ? e.stories : mo, a = e.builderDraftEndpoint ?? "/api/story-draft", i = e.reducedMotion ?? window.matchMedia?.("(prefers-reduced-motion: reduce)").matches ?? !1, n = new Ad(r), o = new ql(r), s = new Ql(r, n, { reducedMotion: i }), l = new xd(r, t, n, s, o, {
...
function yo(r = "[data-chatbot-stories]", e = {}) {
  return e.injectStyles !== !1 && bo(), Ld(qd(r), e);
}
const zd = {
  init: yo,
  defaultStories: mo
...
if (typeof window < "u") {
  window.ChatbotStories = zd;
  const r = () => {
    document.querySelector("[data-chatbot-stories][data-auto-init]") && bo(), document.querySelectorAll("[data-chatbot-stories][data-auto-init]").forEach((e) => {
      e.dataset.chatbotStoriesMounted || (e.dataset.chatbotStoriesMounted = "true", yo(e));
    });
  };
