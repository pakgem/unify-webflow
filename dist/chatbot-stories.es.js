...
var we = {
  ...
  overwrite: !1,
  delay: 0
}, Ti, Z, H, Ae = 1e8, B = 1 / Ae, di = Math.PI * 2, Ro = di / 4, Do = 0, ir = Math.sqrt, Io = Math.cos, qo = Math.sin, X = function(e) {
...
}, ae = Array.isArray, Lo = /random\([^)]+\)/g, No = /,\s*/g, Ki = /(?:-?\.?\d|\.)+/gi, rr = /[-+=.]*\d+[.e\-+]*\d*[e\-+]*\d*/g, _t = /[-+=.]*\d+[.e-]*\d*[a-z%]*/g, Fa = /[-+=.]*\d+\.?\d*(?:e-|e\+)?\d*/gi, or = /[+-]=-?[.\d]+/, Oo = /[^,'"\[\]\s]+/gi, Bo = /^[+\-=e\s\d]*\d+[.\d]*([a-z]*|%)\s*$/i, G, Re, ui, Pi, be = {}, va = {}, sr, lr = function(e) {
  return (va = Pt(e, be)) && de;
}, Ri = function(e, t) {
  ...
  suppressEvents: !0
}, Di = {}, $e = [], hi = {}, dr, ue = {}, za = {}, Xi = 30, wa = [], Ii = "", qi = function(e) {
  var t = e[0], a, i;
  ...
  for (i = e.length; i--; )
    e[i] && (e[i]._gsap || (e[i]._gsap = new Dr(e[i], a))) || e.splice(i, 1);
  return e;
}, gt = function(e) {
  ...
  $e.length && !Z && _a(), e.render(t, a, !!(Z && t < 0 && Li(e))), $e.length && !Z && _a();
}, pr = function(e) {
  var t = parseFloat(e);
  return (t || t === 0) && (e + "").match(Oo).length < 2 ? t : X(e) ? e.trim() : e;
}, gr = function(e) {
  return e;
}, ye = function(e, t) {
  for (var a in t)
  ...
  var t = e.parent || G, a = e.keyframes ? Ho(ae(e.keyframes)) : ye;
  if (oe(e.inherit))
    for (; t; )
  ...
  var a = e._dp;
  return a && a.smoothChildTiming && e._ts && (e._start = V(a._time - (e._ts > 0 ? t / e._ts : ((e._dirty ? e.totalDuration() : e._tDur) - t) / -e._ts)), Ia(e), a._dirty || mt(a, e)), e;
}, fr = function(e, t) {
  var a;
  if ((t._time || !t._dur && t._initted || t._start < e._time && (t._dur || !t.add)) && (a = Sa(e.rawTime(), t), (!t._dur || aa(0, t.totalDuration(), a) - t._tTime > B) && t.render(a, !0)), mt(e, t)._dp && e._initted && e._time >= e._dur && e._ts) {
  ...
  return t.parent && tt(t), t._start = V((He(a) ? a : a || e !== G ? _e(e, a, t) : e._time) + t._delay), t._end = V(t._start + (t.totalDuration() / Math.abs(t.timeScale()) || 0)), mr(e, t, "_first", "_last", e._sort ? "_start" : 0), gi(t) || (e._recent = t), i || fr(e, t), e._ts < 0 && qa(e, e._tTime), e;
}, wr = function(e, t) {
  return (be.ScrollTrigger || Ri("scrollTrigger", t)) && be.ScrollTrigger.create(t, e);
}, br = function(e, t, a, i, n) {
  if (Oi(e, t, n), !e._initted)
    return 1;
  if (!a && e._pt && !Z && (e._dur && e.vars.lazy !== !1 || !e._dur && e.vars.lazy) && dr !== ge.frame)
  ...
  var n = e.ratio, r = t < 0 || !t && (!e._start && Yo(e) && !(!e._initted && gi(e)) || (e._ts < 0 || e._dp._ts < 0) && !gi(e)) ? 0 : 1, s = e._rDelay, l = 0, c, d, u;
  if (s && e._repeat && (l = aa(0, e._tDur, t), d = Rt(l, s), e._yoyo && d & 1 && (r = 1 - r), d !== Rt(e._tTime, s) && (n = 1 - r, e.vars.repeatRefresh && e._initted && e.invalidate())), r !== n || Z || i || e._zTime === B || !t && e._zTime) {
    if (!e._initted && br(e, t, i, a, l))
      return;
    for (u = e._zTime, e._zTime = t || (a ? B : 0), a || (a = t && !u), e.ratio = r, e._from && (r = 1 - r), e._time = 0, e._tTime = l, c = e._pt; c; )
      c.r(r, c.d), c = c._next;
    t < 0 && pi(e, t, a, !0), e._onUpdate && !a && me(e, "onUpdate"), l && e._repeat && !a && e.parent && me(e, "onRepeat"), (t >= e._tDur || t < 0) && e.ratio === r && (r && tt(e, 1), !a && !Z && (me(e, r ? "onComplete" : "onReverseComplete", !0), e._prom && e._prom()));
  ...
  return s && !i && (e._time *= r / e._dur), e._dur = r, e._tDur = n ? n < 0 ? 1e10 : V(r * (n + 1) + e._rDelay * n) : r, s > 0 && !i && qa(e, e._tTime = e._tDur * s), e.parent && Ia(e), a || mt(e.parent, e), e;
}, $i = function(e) {
  return e instanceof re ? mt(e) : Dt(e, e._dur);
}, Ko = {
  _start: 0,
  endTime: jt,
  totalDuration: jt
}, _e = function o(e, t, a) {
  var i = e.labels, n = e._recent || Ko, r = e.duration() >= Ae ? n.endTime(!1) : e._dur, s, l, c;
  ...
  var i = He(t[1]), n = (i ? 2 : 1) + (e < 2 ? 0 : 1), r = t[n], s, l;
  ...
  return !X(e) || !(t = Bo.exec(e)) ? "" : t[1];
}, Xo = function(e, t, a) {
  return nt(a, function(i) {
    return aa(e, t, i);
  });
}, mi = [].slice, yr = function(e, t) {
  return e && Le(e) && "length" in e && (!t && !e.length || e.length - 1 in e && Le(e[0])) && !e.nodeType && e !== Re;
}, Jo = function(e, t, a) {
  return a === void 0 && (a = []), e.forEach(function(i) {
    var n;
    return X(i) && !t || yr(i, 1) ? (n = a).push.apply(n, Se(i)) : a.push(i);
  }) || a;
}, Se = function(e, t, a) {
  return H && !t && H.selector ? H.selector(e) : X(e) && !a && (ui || !It()) ? mi.call((t || Pi).querySelectorAll(e), 0) : ae(e) ? Jo(e, a) : yr(e) ? mi.call(e, 0) : e ? [e] : [];
}, fi = function(e) {
  ...
  var t = Le(e) ? e : {
    each: e
  }, a = ft(t.ease), i = t.from || 0, n = parseFloat(t.base) || 0, r = {}, s = i > 0 && i < 1, l = isNaN(i) || s, c = t.axis, d = i, u = i;
  return X(i) ? d = u = {
    center: 0.5,
    edges: 0.5,
    end: 1
    ...
    if (!w) {
      ...
      for (w = r[p] = [], y = l ? Math.min(C, p) * d - 0.5 : i % C, b = C === Ae ? 0 : l ? p * u / C - 0.5 : i / C | 0, A = 0, k = Ae, T = 0; T < p; T++)
        x = T % C - y, _ = b - (T / C | 0), w[T] = v = c ? Math.abs(c === "y" ? _ : x) : ir(x * x + _ * _), v > A && (A = v), v < k && (k = v);
      i === "random" && xr(w), w.max = A - k, w.min = k, w.v = p = (parseFloat(t.amount) || parseFloat(t.each) * (C > p ? p - 1 : c ? c === "y" ? p / C : C : Math.max(C, p / C)) || 0) * (i === "edges" ? -1 : 1), w.b = p < 0 ? n - p : n, w.u = te(t.amount || t.each) || 0, a = a && p < 0 ? ds(a) : a;
    }
  ...
  var a = ae(e), i, n;
  return !a && Le(e) && (i = a = e.radius || Ae, e.values ? (e = Se(e.values), (n = !He(e[0])) && (i *= i)) : e = wi(e.increment)), nt(t, a ? Y(e) ? function(r) {
    ...
    return d = !i || c <= i ? e[d] : r, n || d === r || He(r) ? d : d + te(r);
  } : wi(e));
}, Ar = function(e, t, a, i) {
  ...
  var i = t - e;
  return ae(e) ? Sr(e, o(0, e.length), t) : nt(a, function(n) {
    return (i + (n - e) % i) % i + e;
  });
}, as = function o(e, t, a) {
  var i = t - e, n = i * 2;
  return ae(e) ? Sr(e, o(0, e.length - 1), t) : nt(a, function(r) {
    return r = (n + (r - e) % n) % n || 0, e + (r > i ? n - r : r);
  });
}, Kt = function(e) {
  return e.replace(Lo, function(t) {
    var a = t.indexOf("[") + 1, i = t.substring(a || 7, a ? t.indexOf("]") : t.length - 1).split(No);
    return Ar(a ? i : +i[0], a ? 0 : +i[1], +i[2] || 1e-5);
  });
}, Cr = function(e, t, a, i, n) {
  var r = t - e, s = i - a;
  return nt(n, function(l) {
    return a + ((l - e) / r * s || 0);
  });
}, is = function o(e, t, a, i) {
  ...
  if (n)
    return l = i[t + "Params"], c = i.callbackScope || e, a && $e.length && _a(), s && (H = s), d = l ? n.apply(c, l) : n.call(c), H = r, d;
}, zt = function(e) {
  return tt(e), e.scrollTrigger && e.scrollTrigger.kill(!!Z), e.progress() < 1 && me(e, "onInterrupt"), e;
}, At, kr = [], Tr = function(e) {
  if (e)
    if (e = !e.name && e.default || e, Mi() || e.headless) {
      ...
      if (It(), e !== i) {
        if (ue[t])
          return;
        ye(i, ye(Aa(e, n), r)), Pt(i.prototype, Pt(n, Aa(e, r))), ue[i.prop = t] = i, e.targetTest && (wa.push(i), Di[t] = 1), t = (t === "css" ? "CSS" : t.charAt(0).toUpperCase() + t.substr(1)) + "Plugin";
      }
      cr(t, i), e.register && e.register(de, i, le);
    } else
      kr.push(e);
}, O = 255, Ut = {
  aqua: [0, O, O],
  ...
  var i = e ? He(e) ? [e >> 16, e >> 8 & O, e & O] : 0 : Ut.black, n, r, s, l, c, d, u, h, g, m;
  if (!i) {
    if (e.substr(-1) === "," && (e = e.substr(0, e.length - 1)), Ut[e])
      ...
      if (i = m = e.match(Ki), !t)
        ...
        return i = e.match(rr), a && i.length < 4 && (i[3] = 1), i;
    } else
  ...
  var t = [], a = [], i = -1;
  return e.split(et).forEach(function(n) {
    var r = n.match(_t) || [];
    t.push.apply(t, r), a.push(i += r.length + 1);
  }), t.c = a, t;
}, tn = function(e, t, a) {
  var i = "", n = (e + i).match(et), r = t ? "hsla(" : "rgba(", s = 0, l, c, d, u;
  if (!n)
    return e;
  if (n = n.map(function(h) {
    return (h = Er(h, t, 1)) && r + (t ? h[0] + "," + h[1] + "%," + h[2] + "%," + h[3] : h.join(",")) + ")";
  }), a && (d = Mr(e), l = a.c, l.join(i) !== d.c.join(i)))
    for (c = e.replace(et, "1").split(_t), u = c.length - 1; s < u; s++)
      i += c[s] + (~l.indexOf(s) ? n.shift() || r + "0,0,0,0)" : (d.length ? d : n.length ? n : a).shift());
  if (!c)
    for (c = e.split(et), u = c.length - 1; s < u; s++)
      i += c[s] + n[s];
  return i + c[u];
}, et = (function() {
...
})(), ns = /hsl[a]?\(/, Pr = function(e) {
  var t = e.join(" "), a;
  if (et.lastIndex = 0, et.test(t))
    return a = ns.test(t), e[1] = tn(e[1], a), e[0] = tn(e[0], a, Mr(e[1])), !0;
}, Xt, ge = (function() {
  ...
  return u = {
    ...
    wake: function() {
      sr && (!ui && Mi() && (Re = ui = window, Pi = Re.document || {}, be.gsap = de, (Re.gsapVersions || (Re.gsapVersions = [])).push(de.version), lr(va || Re.GreenSockGlobals || !Re.gsap && Re || {}), kr.forEach(Tr)), d = typeof requestAnimationFrame < "u" && requestAnimationFrame, l && u.sleep(), c = d || function(w) {
    ...
    add: function(w, y, b) {
      ...
      return u.remove(w), s[b ? "unshift" : "push"](x), It(), x;
    },
    remove: function(w, y) {
  ...
  return !Xt && ge.wake();
}, R = {}, rs = /^[\d.\-M][\d.\-,\s]/, os = /["']/g, ss = function(e) {
  for (var t = {}, a = e.substr(1, e.length - 3).split(":"), i = a[0], n = 1, r = a.length, s, l, c; n < r; n++)
    l = a[n], s = n !== r - 1 ? l.lastIndexOf(",") : l.length, c = l.substr(0, s), t[i] = isNaN(c) ? c.replace(os, "").trim() : +c, i = l.substr(s + 1).trim();
  return t;
}, ls = function(e) {
  ...
  return a && t.length > 1 && a.config ? a.config.apply(null, ~e.indexOf("{") ? [ss(t[1])] : ls(e).split(",").map(pr)) : R._CE && rs.test(e) ? R._CE("", e) : a;
}, ds = function(e) {
  return function(t) {
    return 1 - e(1 - t);
  };
}, ft = function(e, t) {
  return e && (Y(e) ? e : R[e] || cs(e)) || t;
}, bt = function(e, t, a, i) {
  ...
  var i = t >= 1 ? t : 1, n = (a || (e ? 0.3 : 0.45)) / (t < 1 ? t : 1), r = n / di * (Math.asin(1 / i) || 0), s = function(d) {
    return d === 1 ? 1 : i * Math.pow(2, -10 * d) * qo((d - r) * n) + 1;
...
bt("Sine", function(o) {
  return o === 1 ? 1 : -Io(o * Ro) + 1;
});
bt("Back", Va("in"), Va("out"), Va());
...
var Dr = function(e, t) {
  this.id = Do++, e._gsap = this, this.target = e, this.harness = t, this.get = t ? t.get : ur, this.set = t ? t.getSetter : Fi;
  ...
  return e.delay = function(a) {
    ...
    if (n && n.smoothChildTiming && this._ts) {
      for (qa(this, a), !n._dp || n.parent || fr(n, this); n && n.parent; )
    ...
    return (this._tTime !== a || !this._dur && !i || this._initted && Math.abs(this._zTime) === B || !this._initted && this._dur && a || !a && !this._initted && (this.add || this._ptLookup)) && (this._ts || (this._pTime = a), hr(this, a, i)), this;
  }, e.time = function(a, i) {
    ...
    return arguments.length ? this.totalTime(this._time + (a - 1) * n, i) : this._repeat ? Rt(this._tTime, n) + 1 : 1;
    ...
    return this._rts = +a || 0, this._ts = this._ps || a === -B ? 0 : this._rts, this.totalTime(aa(-Math.abs(this._delay), this.totalDuration(), n), i !== !1), Ia(this), Go(this);
  }, e.paused = function(a) {
    return arguments.length ? (this._ps !== a && (this._ps = a, a ? (this._pTime = this._tTime || Math.max(-this._delay, this.rawTime()), this._ts = this._act = 0) : (It(), this._ts = this._rts, this.totalTime(this.parent && !this.parent.smoothChildTiming ? this.rawTime() : this._tTime || this._pTime, this.progress() === 1 && Math.abs(this._zTime) !== B && (this._tTime -= B)))), this) : this._ps;
...
var re = /* @__PURE__ */ (function(o) {
  ...
  function e(a, i) {
    var n;
    return a === void 0 && (a = {}), n = o.call(this, a) || this, n.labels = {}, n.smoothChildTiming = !!a.smoothChildTiming, n.autoRemoveChildren = !!a.autoRemoveChildren, n._sort = oe(a.sortChildren), G && De(a.parent || G, Oe(n), i), a.reversed && n.reverse(), a.paused && n.paused(!0), a.scrollTrigger && wr(Oe(n), a.scrollTrigger), n;
  }
  var t = e.prototype;
  return t.to = function(i, n, r) {
    ...
    return r.runBackwards = 1, Vt(r).immediateRender = oe(r.immediateRender), this.staggerTo(i, n, r, s, l, c, d);
  }, t.staggerFromTo = function(i, n, r, s, l, c, d, u) {
    return s.startAt = r, Vt(s).immediateRender = oe(s.immediateRender), this.staggerTo(i, n, s, l, c, d, u);
    ...
    if (this !== G && d > l && i >= 0 && (d = l), d !== this._tTime || r || u) {
      if (s !== this._time && c && (d += this._time - s, i += this._time - s), h = d, _ = this._start, x = this._ts, y = !x, u && (c || (s = this._zTime), (i || !n) && (this._zTime = i)), this._repeat) {
        ...
        if (h = V(d % w), d === l ? (p = this._repeat, h = c) : (v = V(d / w), p = ~~v, p && p === v && (h = c, p--), h > c && (h = c)), v = Rt(this._tTime, w), !s && this._tTime && v !== p && this._tTime - v * w - this._dur <= 0 && (v = p), T && p & 1 && (h = c - h, A = 1), p !== v && !this._lock) {
      ...
      if (this._hasPause && !this._forcing && this._lock < 2 && (b = jo(this, V(s), V(h)), b && (d -= h - (h = b._start))), this._tTime = d, this._time = h, this._act = !!x, this._initted || (this._onUpdate = this.vars.onUpdate, this._initted = 1, this._zTime = i, s = 0), !s && d && c && !n && !v && (me(this, "onStart"), this._tTime !== d))
        return this;
      if (h >= s && i >= 0)
        for (g = this._first; g; ) {
      ...
      if (b && !n && (this.pause(), b.render(h >= s ? 0 : -B)._zTime = h >= s ? 1 : -1, this._ts))
        return this._start = _, Ia(this), this.render(i, n, r);
      this._onUpdate && !n && me(this, "onUpdate", !0), (d === l && this._tTime >= this.totalDuration() || !d && s) && (_ === this._start || Math.abs(x) !== Math.abs(this._ts)) && (this._lock || ((i || !c) && (d === l && this._ts > 0 || !d && this._ts < 0) && tt(this, 1), !n && !(i < 0 && !s) && (d || s || !l) && (me(this, d === l && i >= 0 ? "onComplete" : "onReverseComplete", !0), this._prom && !(d < l && this.timeScale() > 0) && this._prom())));
    }
    return this;
  }, t.add = function(i, n) {
    var r = this;
    if (He(n) || (n = _e(this, n, i)), !(i instanceof Jt)) {
      if (ae(i))
    ...
    return X(i) ? this.removeLabel(i) : Y(i) ? this.killTweensOf(i) : (i.parent === this && Da(this, i), i === this._recent && (this._recent = this._last), mt(this));
    ...
    var n = this._first;
    for (i = _e(this, i); n; )
      n._start === i && n.data === "isPause" && tt(n), n = n._next;
  }, t.killTweensOf = function(i, n, r) {
    for (var s = this.getTweensOf(i, r), l = s.length; l--; )
      je !== s[l] && s[l].kill(i, n);
    return this;
  }, t.getTweensOf = function(i, n) {
    for (var r = [], s = Se(i), l = this._first, c = He(n), d; l; )
      l instanceof K ? Uo(l._targets, s) && (c ? (!je || l._initted && l._ts) && l.globalTime(0) <= n && l.globalTime(l.totalDuration()) > n : !n || l.isActive()) && r.push(l) : (d = l.getTweensOf(s, n)).length && r.push.apply(r, d), l = l._next;
    return r;
    ...
    return this._dp && (this._time = this._tTime = this._pTime = 0), i && (this.labels = {}), mt(this);
    ...
    if (G._ts && (hr(G, Sa(i, G)), dr = ge.frame), ge.frame >= Xi) {
      Xi += we.autoSleep || 120;
      var n = G._first;
...
var us = function(e, t, a, i, n, r, s) {
  var l = new le(this._pt, e, t, 0, 1, Br, null, n), c = 0, d = 0, u, h, g, m, p, w, y, b;
  ...
  return l.c = c < i.length ? i.substring(c, i.length) : "", l.fp = s, (or.test(i) || y) && (l.e = 0), this._pt = l, l;
}, Ni = function(e, t, a, i, n, r, s, l, c, d) {
  Y(i) && (i = i(n || 0, e, r));
  var u = e[t], h = a !== "get" ? a : Y(u) ? c ? e[t.indexOf("set") || !Y(e["get" + t.substr(3)]) ? t : "get" + t.substr(3)](c) : e[t]() : u, g = Y(u) ? c ? fs : Nr : Bi, m;
  if (X(i) && (~i.indexOf("random(") && (i = Kt(i)), i.charAt(1) === "=" && (m = Ct(h, i) + (te(h) || 0), (m || m === 0) && (i = m))), !d || h !== i || bi)
    return !isNaN(h * i) && i !== "" ? (m = new le(this._pt, e, t, +h || 0, i - (h || 0), typeof u == "boolean" ? bs : Or, 0, g), c && (m.fp = c), s && m.modifier(s, this, e), this._pt = m) : (!u && !(t in e) && Ri(t, i), us.call(this, e, t, h, i, g, l || we.stringFilter, c));
}, hs = function(e, t, a, i, n) {
  if (Y(e) && (e = Wt(e, n, t, a, i)), !Le(e) || e.style && e.nodeType || ae(e) || nr(e))
  ...
  var s, l, c, d;
  if (ue[e] && (s = new ue[e]()).init(n, s.rawVars ? t[e] : hs(t[e], i, n, r, a), a, i, r) !== !1 && (a._pt = l = new le(a._pt, n, e, 0, 1, s.render, s, 0, s.priority), a !== At))
    for (c = a._ptLookup[a._targets.indexOf(n)], d = s._props.length; d--; )
      c[s._props[d]] = l;
  return s;
}, je, bi, Oi = function o(e, t, a) {
  var i = e.vars, n = i.ease, r = i.startAt, s = i.immediateRender, l = i.lazy, c = i.onUpdate, d = i.runBackwards, u = i.yoyoEase, h = i.keyframes, g = i.autoRevert, m = e._dur, p = e._startAt, w = e._targets, y = e.parent, b = y && y.data === "nested" ? y.vars.targets : w, x = e._overwrite === "auto" && !Ti, _ = e.timeline, v = i.easeReverse || u, T, A, k, C, M, F, z, L, U, D, I, P, $;
  if (_ && (!h || !n) && (n = "none"), e._ease = ft(n, Yt.ease), e._rEase = v && (ft(v) || e._ease), e._from = !_ && !!i.runBackwards, e._from && (e.ratio = 1), !_ || h && !i.stagger) {
    if (L = w[0] ? gt(w[0]).harness : 0, P = L && i[L.prop], T = Aa(i, Di), p && (p._zTime < 0 && p.progress(1), t < 0 && d && s && !g ? p.render(-1, !0) : p.revert(d && m ? fa : Fo), p._lazy = 0), r) {
      if (tt(e._startAt = K.set(w, ye({
        data: "isStart",
        overwrite: !1,
        parent: y,
        immediateRender: !0,
      ...
      }, T), P && (k[L.prop] = P), tt(e._startAt = K.set(w, k)), e._startAt._dp = 0, e._startAt._sat = e, t < 0 && (Z ? e._startAt.revert(fa) : e._startAt.render(-1, !0)), e._zTime = t, !s)
        o(e._startAt, B, B);
      else if (!t)
        return;
    }
    for (e._pt = e._ptCache = 0, l = m && oe(l) || l && !m, A = 0; A < w.length; A++) {
      if (M = w[A], z = M._gsap || qi(w)[A]._gsap, e._ptLookup[A] = D = {}, hi[z.id] && $e.length && _a(), I = b === w ? A : b.indexOf(M), L && (U = new L()).init(M, P || T, e, I, b) !== !1 && (e._pt = C = new le(e._pt, M, U.name, 0, 1, U.render, U, 0, U.priority), U._props.forEach(function(Te) {
        D[Te] = C;
      }), U.priority && (F = 1)), !L || P)
        for (k in T)
          ue[k] && (U = Ir(k, T, e, I, M, b)) ? U.priority && (F = 1) : D[k] = C = Ni.call(e, M, k, "get", T[k], I, b, 0, i.stringFilter);
      e._op && e._op[A] && e.kill(M, e._op[A]), x && e._pt && (je = e, G.killTweensOf(M, D, e.globalTime(t)), $ = !e.parent, je = 0), e._pt && l && (hi[z.id] = 1);
    }
    F && Fr(e), e._onInit && e._onInit(e);
  }
  e._onUpdate = c, e._initted = (!e._op || e._pt) && !$, h && t <= 0 && _.render(Ae, !0, !0);
}, ps = function(e, t, a, i, n, r, s, l) {
  ...
  var a = e[0] ? gt(e[0]).harness : 0, i = a && a.aliases, n, r, s, l;
  if (!i)
    return t;
  n = Pt({}, t);
  for (r in i)
...
}, qr = Ii + "repeat,repeatDelay,yoyo,repeatRefresh,yoyoEase,easeReverse,autoRevert", Lr = {};
se(qr + ",id,stagger,delay,duration,paused,scrollTrigger", function(o) {
  return Lr[o] = 1;
});
var K = /* @__PURE__ */ (function(o) {
  ...
  function e(a, i, n, r) {
    ...
    var l = s.vars, c = l.duration, d = l.delay, u = l.immediateRender, h = l.stagger, g = l.overwrite, m = l.keyframes, p = l.defaults, w = l.scrollTrigger, y = i.parent || G, b = (ae(a) || nr(a) ? He(a[0]) : "length" in i) ? [a] : Se(a), x, _, v, T, A, k, C, M;
    if (s._targets = b.length ? qi(b) : Qt("GSAP target " + a + " not found. https://gsap.com", !we.nullTargetWarn) || [], s._ptLookup = [], s._overwrite = g, m || h || ra(c) || ra(d)) {
      ...
      }), x.kill(), x.parent = x._dp = Oe(s), x._start = 0, h || ra(c) || ra(d)) {
        if (T = b.length, C = h && vr(h), Le(h))
          for (A in h)
            ~qr.indexOf(A) && (M || (M = {}), M[A] = h[A]);
        for (_ = 0; _ < T; _++)
          v = Aa(i, Lr), v.stagger = 0, F && (v.easeReverse = F), M && Pt(v, M), k = b[_], v.duration = +Wt(c, Oe(s), _, k, b), v.delay = (+Wt(d, Oe(s), _, k, b) || 0) - s._delay, !h && T === 1 && v.delay && (s._delay = d = v.delay, s._start += d, v.delay = 0), x.to(k, v, C ? C(_, k, b) : 0), x._ease = R.none;
        x.duration() ? c = d = 0 : s.timeline = 0;
      } else if (m) {
        Vt(ye(x.vars.defaults, {
          ease: "none"
        })), x._ease = ft(m.ease || i.ease || "none");
        var z = 0, L, U, D;
        if (ae(m))
          ...
          v = {};
          for (A in m)
            A === "ease" || A === "easeEach" || ms(A, m[A], v, m.easeEach);
          for (A in v)
      ...
      s.timeline = 0;
    return g === !0 && !Ti && (je = Oe(s), G.killTweensOf(b), je = 0), De(y, Oe(s), n), i.reversed && s.reverse(), i.paused && s.paused(!0), (u || !c && !m && s._start === V(y._time) && oe(u) && Wo(Oe(s)) && y.data !== "nested") && (s._tTime = -B, s.render(Math.max(0, -d) || 0)), w && wr(Oe(s), w), s;
  }
  var t = e.prototype;
  return t.render = function(i, n, r) {
    ...
    if (!c)
      ...
      if (h = u, x = this.timeline, this._repeat) {
        ...
        if (h = V(u % p), u === l ? (m = this._repeat, h = c) : (w = V(u / p), m = ~~w, m && m === w ? (h = c, m--) : h > c && (h = c)), y = this._yoyo && m & 1, y && (h = c - h), w = Rt(this._tTime, p), h === s && !r && this._initted && m === w)
      ...
      for (g = this._pt; g; )
        g.r(b, g.d), g = g._next;
      x && x.render(i < 0 ? i : x._dur * x._ease(h / this._dur), n, r) || this._startAt && (this._zTime = i), this._onUpdate && !n && (d && pi(this, i, n, r), me(this, "onUpdate")), this._repeat && m !== w && this.vars.onRepeat && !n && this.parent && me(this, "onRepeat"), (u === this._tDur || !u) && this._tTime === u && (d && !this._onUpdate && pi(this, i, !0, !0), (i || !c) && (u === this._tDur && this._ts > 0 || !u && this._ts < 0) && tt(this, 1), !n && !(d && !s) && (u || s || y) && (me(this, u === l ? "onComplete" : "onReverseComplete", !0), this._prom && !(u < l && this.timeScale() > 0) && this._prom()));
    }
    return this;
  }, t.targets = function() {
    ...
    return this._initted || Oi(this, c), d = this._ease(c / this._dur), ps(this, i, n, r, s, d, c, l) ? this.resetTo(i, n, r, s, 1) : (qa(this, 0), this.parent || mr(this._dp, this, "_first", "_last", this._dp._sort ? "_start" : 0), this.render(0));
  }, t.kill = function(i, n) {
    if (n === void 0 && (n = "all"), !i && (!n || n === "all"))
      return this._lazy = this._pt = 0, this.parent ? zt(this) : this.scrollTrigger && this.scrollTrigger.kill(!!Z), this;
    if (this.timeline) {
      var r = this.timeline.totalDuration();
      return this.timeline.killTweensOf(i, n, je && je.vars.overwrite !== !0)._first || zt(this), this.parent && r !== this.timeline.totalDuration() && Dt(this, this._dur * this.timeline._tDur / r, 0, 1), this;
    }
    ...
    for (u = this._op = this._op || [], n !== "all" && (X(n) && (p = {}, se(n, function(b) {
      return p[b] = 1;
    }), n = p), n = gs(s, n)), y = s.length; y--; )
      if (~l.indexOf(s[y])) {
        h = c[y], n === "all" ? (u[y] = n, m = h, g = {}) : (g = u[y] = u[y] || {}, m = n);
        for (p in m)
          w = h && h[p], w && ((!("kill" in w.d) || w.d.kill(p) === !0) && Da(this, w, "_pt"), delete h[p]), g !== "all" && (g[p] = 1);
      }
...
var Bi = function(e, t, a) {
  ...
  return Y(e[t]) ? Nr : Ei(e[t]) && e.setAttribute ? ws : Bi;
}, Or = function(e, t) {
  ...
  for (var t = this._pt, a, i; t; )
    i = t._next, t.p === e && !t.op || t.op === e ? Da(this, t, "_pt") : t.dep || (a = 1), t = i;
  return !a;
}, vs = function(e, t, a, i) {
  ...
  function o(t, a, i, n, r, s, l, c, d) {
    this.t = a, this.s = n, this.c = r, this.p = i, this.r = s || Or, this.d = l || this, this.set = c || Bi, this.pr = d || 0, this._next = t, t && (t._prev = this);
  }
  var e = o.prototype;
  return e.modifier = function(a, i, n) {
    this.mSet = this.mSet || this.set, this.set = vs, this.m = a, this.mt = n, this.tween = i;
  }, o;
})();
se(Ii + "parent,duration,ease,delay,overwrite,runBackwards,startAt,yoyo,immediateRender,repeat,repeatDelay,data,paused,reversed,lazy,callbackScope,stringFilter,id,yoyoEase,stagger,inherit,repeatRefresh,keyframes,autoRevert,scrollTrigger,easeReverse", function(o) {
  return Di[o] = 1;
});
...
we.stringFilter = Pr;
var wt = [], ba = {}, _s = [], an = 0, As = 0, Ga = function(e) {
  return (ba[e] || _s).map(function(t) {
    return t();
  });
}, yi = function() {
  var e = Date.now(), t = [];
  e - an > 2 && (Ga("matchMediaInit"), wt.forEach(function(a) {
  ...
  function o(t, a) {
    this.selector = a && fi(a), this.data = [], this._r = [], this.isReverted = !1, this.id = As++, t && this.add(t);
  }
  var e = o.prototype;
  return e.add = function(a, i, n) {
    ...
    if (a ? (function() {
      ...
      for (var r = wt.length; r--; )
        wt[r].id === this.id && wt.splice(r, 1);
  }, e.revert = function(a) {
    this.kill(a || {});
  }, o;
  ...
  return e.add = function(a, i, n) {
    ...
    var r = new zr(0, n || this.scope), s = r.conditions = {}, l, c, d;
    H && !r.selector && (r.selector = H.selector), this.contexts.push(r), i = r.add("onMatch", i), r.queries = a;
    for (c in a)
      c === "all" ? d = 1 : (l = Re.matchMedia(a[c]), l && (wt.indexOf(r) < 0 && wt.push(r), (s[c] = l.matches) && (d = 1), l.addListener ? l.addListener(yi) : l.addEventListener("change", yi)));
  ...
  quickSetter: function(e, t, a) {
    ...
    e = e[0] || {};
    var r = ue[t], s = gt(e), l = s.harness && (s.harness.aliases || {})[t] || t, c = r ? function(d) {
      var u = new r();
      At._pt = 0, u.init(e, a ? d + a : d, At, 0, [e]), u.render(1, u), At._pt && zi(1, At);
    } : s.set(e, l);
  ...
  defaults: function(e) {
    return e && e.ease && (e.ease = ft(e.ease, Yt.ease)), Ji(Yt, e || {});
  },
  config: function(e) {
    return Ji(we, e || {});
  },
  ...
  parseEase: function(e, t) {
    return arguments.length ? ft(e, t) : R;
  },
  getById: function(e) {
    return G.getById(e);
  },
...
var Cs = function(e, t) {
  ...
  for (i in t)
    for (n = a.length; n--; )
      r = e._ptLookup[n][i], r && (r = r.d) && (r._pt && (r = Cs(r, i)), r && r.modifier && r.modifier(t[i], e, a[n], i));
}, Wa = function(e, t) {
  return {
    name: e,
    headless: 1,
...
}, Wa("roundProps", wi), Wa("modifiers"), Wa("snap", _r)) || Ca;
...
R.Expo;
R.Circ;
var nn, Ke, kt, Ui, pt, rn, Hi, Ts = function() {
  return typeof window < "u";
}, Ve = {}, ht = 180 / Math.PI, Tt = Math.PI / 180, yt = Math.atan2, on = 1e8, Vi = /([A-Z])/g, Es = /(left|right|width|margin|padding|x)/i, Ms = /[\s,\(]\S/, qe = {
  ...
  for (n = 0; n < e.length; n += 3)
    e[n + 1] ? e[n + 1] === 2 ? t[e[n]](e[n + 2]) : t[e[n]] = e[n + 2] : e[n + 2] ? a[e[n]] = e[n + 2] : a.removeProperty(e[n].substr(0, 2) === "--" ? e[n] : e[n].replace(Vi, "-$1").toLowerCase());
  if (this.tfm) {
    for (r in this.tfm)
      i[r] = this.tfm[r];
    i.svg && (i.renderTransform(), t.setAttribute("data-svg-origin", this.svgo || "")), n = Hi(), (!n || !n.isStart) && !a[W] && (Vr(a), i.zOrigin && a[ce] && (a[ce] += " " + i.zOrigin + "px", i.zOrigin = 0, i.renderTransform()), i.uncache = 1);
  }
}, Gr = function(e, t) {
  var a = {
    target: e,
  ...
  return i[t] || i.getPropertyValue(t.replace(Vi, "-$1").toLowerCase()) || i.getPropertyValue(t) || !a && o(e, qt(t) || t, 1) || "";
}, sn = "O,Moz,ms,Ms,Webkit".split(","), qt = function(e, t, a) {
  var i = t || pt, n = i.style, r = 5;
  if (e in n && !a)
    return e;
  ...
  Ts() && window.document && (nn = window, Ke = nn.document, kt = Ke.documentElement, pt = vi("div") || {
    style: {}
  }, vi("div"), W = qt(W), ce = W + "Origin", pt.style.cssText = "border-width:0;line-height:0;position:absolute;padding:0", Wr = !!qt("perspective"), Hi = de.core.reverting, Ui = 1);
}, ln = function(e) {
  var t = e.ownerSVGElement, a = vi("svg", t && t.getAttribute("xmlns") || "http://www.w3.org/2000/svg"), i = e.cloneNode(!0), n;
  i.style.display = "block", a.appendChild(i), kt.appendChild(a);
  try {
    n = i.getBBox();
  } catch {
  }
  return a.removeChild(i), kt.removeChild(a), n;
}, cn = function(e, t) {
  for (var a = t.length; a--; )
  ...
  if (t) {
    var a = e.style, i;
    t in Ve && t !== ce && (t = W), a.removeProperty ? (i = t.substr(0, 2), (i === "ms" || t.substr(0, 6) === "webkit") && (t = "-" + t), a.removeProperty(i === "--" ? t : t.replace(Vi, "-$1").toLowerCase())) : a.removeAttribute(t);
  }
}, Xe = function(e, t, a, i, n, r) {
  var s = new le(e._pt, t, a, 0, 1, r ? Hr : Ur);
  ...
  grid: 1,
  flex: 1
}, it = function o(e, t, a, i) {
  var n = parseFloat(a) || 0, r = (a + "").trim().substr((n + "").length) || "px", s = pt.style, l = Es.test(t), c = e.tagName.toLowerCase() === "svg", d = (c ? "client" : "offset") + (l ? "Width" : "Height"), u = 100, h = i === "px", g = i === "%", m, p, w, y;
  if (i === r || !n || dn[i] || dn[r])
    return n;
  if (r !== "px" && !h && (n = o(e, t, a, "px")), y = e.getCTM && Qr(e), (g || r === "%") && (Ve[t] || ~t.indexOf("adius")))
    return m = y ? e.getBBox()[l ? "width" : "height"] : e[d], Q(g ? n / m * u : n / 100 * m);
  if (s[l ? "width" : "height"] = u + (h ? r : i), p = i !== "rem" && ~t.indexOf("adius") || i === "em" && e.appendChild && !c ? e : e.parentNode, y && (p = (e.ownerSVGElement || {}).parentNode), (!p || p === Ke || !p.appendChild) && (p = Ke.body), w = p._gsap, w && g && w.width && l && w.time === ge.time && !w.uncache)
    return Q(n / w.width * u);
  if (g && (t === "height" || t === "width")) {
    var b = e.style[t];
    e.style[t] = u + i, m = e[d], b ? e.style[t] = b : at(e, t);
  } else
    (g || r === "%") && !Hs[fe(p, "display")] && (s.position = fe(e, "position")), p === e && (s.position = "static"), p.appendChild(pt), m = pt[d], p.removeChild(pt), s.position = "absolute";
  return l && g && (w = gt(p), w.time = ge.time, w.width = p[d]), Q(h ? m * n / u : m && n ? u / m * n : 0);
}, Fe = function(e, t, a, i) {
  var n;
  return Ui || _i(), t in qe && t !== "transform" && (t = qe[t], ~t.indexOf(",") && (t = t.split(",")[0])), Ve[t] && t !== "transform" ? (n = $t(e, i), n = t !== "transformOrigin" ? n[t] : n.svg ? n.origin : Ta(fe(e, ce)) + " " + n.zOrigin + "px") : (n = e.style[t], (!n || n === "auto" || i || ~(n + "").indexOf("calc(")) && (n = ka[t] && ka[t](e, t, a) || fe(e, t) || ur(e, t) || (t === "opacity" ? 1 : 0))), a && !~(n + "").trim().indexOf(" ") ? it(e, t, n, a) + a : n;
}, Vs = function(e, t, a, i) {
  if (!a || a === "none") {
    var n = qt(t, e, 1), r = n && fe(e, n, 1);
    r && r !== a ? (t = n, a = r) : t === "borderColor" && (a = fe(e, "borderTopColor"));
  }
  var s = new le(this._pt, e.style, t, 0, 1, Br), l = 0, c = 0, d, u, h, g, m, p, w, y, b, x, _, v;
  if (s.b = a, s.e = i, a += "", i += "", i.substring(0, 6) === "var(--" && (i = fe(e, i.substring(4, i.indexOf(")")))), i === "auto" && (p = e.style[t], e.style[t] = i, i = fe(e, t) || i, p ? e.style[t] = p : at(e, t)), d = [a, i], Pr(d), a = d[0], i = d[1], h = a.match(_t) || [], v = i.match(_t) || [], v.length) {
    for (; u = _t.exec(i); )
      w = u[0], b = i.substring(l, u.index), m ? m = (m + 1) % 5 : (b.substr(-5) === "rgba(" || b.substr(-5) === "hsla(") && (m = 1), w !== (p = h[c++] || "") && (g = parseFloat(p) || 0, _ = p.substr((g + "").length), w.charAt(1) === "=" && (w = Ct(g, w) + _), y = parseFloat(w), x = w.substr((y + "").length), l = _t.lastIndex - x.length, x || (x = x || we.units[t] || _, l === i.length && (i += x, s.e += x)), _ !== x && (g = it(e, t, p, x) || 0), s._pt = {
        _next: s._pt,
        p: b || c === 1 ? b : ",",
        //note: SVG spec allows omission of comma/space when a negative sign is wedged between two numbers, like 2.5-5.3 instead of 2.5,-5.3 but when tweening, the negative value may switch to positive, so we insert the comma just in case.
        s: g,
    ...
    s.r = t === "display" && i === "none" ? Hr : Ur;
  return or.test(i) && (s.e = 0), this._pt = s, s;
}, un = {
  top: "0%",
  bottom: "100%",
  left: "0%",
  ...
  if (t.tween && t.tween._time === t.tween._dur) {
    ...
    if (n === "all" || n === !0)
      ...
      for (n = n.split(","), c = n.length; --c > -1; )
        s = n[c], Ve[s] && (l = 1, s = s === "transformOrigin" ? ce : W), at(a, s);
    l && (at(a, W), r && (r.svg && a.removeAttribute("transform"), i.scale = i.rotate = i.translate = "none", $t(a, 1), r.uncache = 1, Vr(i)));
  }
}, ka = {
  clearProps: function(e, t, a, i, n) {
    if (n.data !== "isFromStart") {
      var r = e._pt = new le(e._pt, t, a, 0, 0, Ws);
  ...
  */
}, Zt = [1, 0, 0, 1, 0, 0], jr = {}, Kr = function(e) {
  return e === "matrix(1, 0, 0, 1, 0, 0)" || e === "none" || !e;
}, hn = function(e) {
  var t = fe(e, W);
  return Kr(t) ? Zt : t.substr(7).match(rr).map(Q);
}, Gi = function(e, t) {
  var a = e._gsap || gt(e), i = e.style, n = hn(e), r, s, l, c;
  return a.svg && e.getAttribute("transform") ? (l = e.transform.baseVal.consolidate().matrix, n = [l.a, l.b, l.c, l.d, l.e, l.f], n.join(",") === "1,0,0,1,0,0" ? Zt : n) : (n === Zt && !e.offsetParent && e !== kt && !a.svg && (l = i.display, i.display = "block", r = e.parentNode, (!r || !e.offsetParent && !e.getBoundingClientRect().width) && (c = 1, s = e.nextElementSibling, kt.appendChild(e)), n = hn(e), l ? i.display = l : at(e, "display"), c && (s ? r.insertBefore(e, s) : r ? r.appendChild(e) : kt.removeChild(e))), t && n.length > 6 ? [n[0], n[1], n[4], n[5], n[12], n[13]] : n);
}, Ai = function(e, t, a, i, n, r) {
  var s = e._gsap, l = n || Gi(e, !0), c = s.xOrigin || 0, d = s.yOrigin || 0, u = s.xOffset || 0, h = s.yOffset || 0, g = l[0], m = l[1], p = l[2], w = l[3], y = l[4], b = l[5], x = t.split(" "), _ = parseFloat(x[0]) || 0, v = parseFloat(x[1]) || 0, T, A, k, C;
  a ? l !== Zt && (A = g * w - m * p) && (k = _ * (w / A) + v * (-p / A) + (p * b - w * y) / A, C = _ * (-m / A) + v * (g / A) - (g * b - m * y) / A, _ = k, v = C) : (T = Yr(e), _ = T.x + (~x[0].indexOf("%") ? _ / 100 * T.width : _), v = T.y + (~(x[1] || x[0]).indexOf("%") ? v / 100 * T.height : v)), i || i !== !1 && s.smooth ? (y = _ - c, b = v - d, s.xOffset = u + (y * g + b * p) - y, s.yOffset = h + (y * m + b * w) - b) : s.xOffset = s.yOffset = 0, s.xOrigin = _, s.yOrigin = v, s.smooth = !!i, s.origin = t, s.originIsAbsolute = !!a, e.style[ce] = "0px 0px", r && (Xe(r, s, "xOrigin", c, _), Xe(r, s, "yOrigin", d, v), Xe(r, s, "xOffset", u, s.xOffset), Xe(r, s, "yOffset", h, s.yOffset)), e.setAttribute("data-svg-origin", _ + " " + v);
}, $t = function(e, t) {
  var a = e._gsap || new Dr(e);
  if ("x" in a && !t && !a.uncache)
    return a;
  var i = e.style, n = a.scaleX < 0, r = "px", s = "deg", l = getComputedStyle(e), c = fe(e, ce) || "0", d, u, h, g, m, p, w, y, b, x, _, v, T, A, k, C, M, F, z, L, U, D, I, P, $, Te, Ge, ke, rt, ji, Ne, ot;
  return d = u = h = p = w = y = b = x = _ = 0, g = m = 1, a.svg = !!(e.getCTM && Qr(e)), l.translate && ((l.translate !== "none" || l.scale !== "none" || l.rotate !== "none") && (i[W] = (l.translate !== "none" ? "translate3d(" + (l.translate + " 0 0").split(" ").slice(0, 3).join(", ") + ") " : "") + (l.rotate !== "none" ? "rotate(" + l.rotate + ") " : "") + (l.scale !== "none" ? "scale(" + l.scale.split(" ").join(",") + ") " : "") + (l[W] !== "none" ? l[W] : "")), i.scale = i.rotate = i.translate = "none"), A = Gi(e, a.svg), a.svg && (a.uncache ? ($ = e.getBBox(), c = a.xOrigin - $.x + "px " + (a.yOrigin - $.y) + "px", P = "") : P = !t && e.getAttribute("data-svg-origin"), Ai(e, P || c, !!P || a.originIsAbsolute, a.smooth !== !1, A)), v = a.xOrigin || 0, T = a.yOrigin || 0, A !== Zt && (F = A[0], z = A[1], L = A[2], U = A[3], d = D = A[4], u = I = A[5], A.length === 6 ? (g = Math.sqrt(F * F + z * z), m = Math.sqrt(U * U + L * L), p = F || z ? yt(z, F) * ht : 0, b = L || U ? yt(L, U) * ht + p : 0, b && (m *= Math.abs(Math.cos(b * Tt))), a.svg && (d -= v - (v * F + T * L), u -= T - (v * z + T * U))) : (ot = A[6], ji = A[7], Ge = A[8], ke = A[9], rt = A[10], Ne = A[11], d = A[12], u = A[13], h = A[14], k = yt(ot, rt), w = k * ht, k && (C = Math.cos(-k), M = Math.sin(-k), P = D * C + Ge * M, $ = I * C + ke * M, Te = ot * C + rt * M, Ge = D * -M + Ge * C, ke = I * -M + ke * C, rt = ot * -M + rt * C, Ne = ji * -M + Ne * C, D = P, I = $, ot = Te), k = yt(-L, rt), y = k * ht, k && (C = Math.cos(-k), M = Math.sin(-k), P = F * C - Ge * M, $ = z * C - ke * M, Te = L * C - rt * M, Ne = U * M + Ne * C, F = P, z = $, L = Te), k = yt(z, F), p = k * ht, k && (C = Math.cos(k), M = Math.sin(k), P = F * C + z * M, $ = D * C + I * M, z = z * C - F * M, I = I * C - D * M, F = P, D = $), w && Math.abs(w) + Math.abs(p) > 359.9 && (w = p = 0, y = 180 - y), g = Q(Math.sqrt(F * F + z * z + L * L)), m = Q(Math.sqrt(I * I + ot * ot)), k = yt(D, I), b = Math.abs(k) > 2e-4 ? k * ht : 0, _ = Ne ? 1 / (Ne < 0 ? -Ne : Ne) : 0), a.svg && (P = e.getAttribute("transform"), a.forceCSS = e.setAttribute("transform", "") || !Kr(fe(e, W)), P && e.setAttribute("transform", P))), Math.abs(b) > 90 && Math.abs(b) < 270 && (n ? (g *= -1, b += p <= 0 ? 180 : -180, p += p <= 0 ? 180 : -180) : (m *= -1, b += b <= 0 ? 180 : -180)), t = t || a.uncache, a.x = d - ((a.xPercent = d && (!t && a.xPercent || (Math.round(e.offsetWidth / 2) === Math.round(-d) ? -50 : 0))) ? e.offsetWidth * a.xPercent / 100 : 0) + r, a.y = u - ((a.yPercent = u && (!t && a.yPercent || (Math.round(e.offsetHeight / 2) === Math.round(-u) ? -50 : 0))) ? e.offsetHeight * a.yPercent / 100 : 0) + r, a.z = h + r, a.scaleX = Q(g), a.scaleY = Q(m), a.rotation = Q(p) + s, a.rotationX = Q(w) + s, a.rotationY = Q(y) + s, a.skewX = b + s, a.skewY = x + s, a.transformPerspective = _ + r, (a.zOrigin = parseFloat(c.split(" ")[2]) || !t && a.zOrigin || 0) && (i[ce] = Ta(c)), a.xOffset = a.yOffset = 0, a.force3D = we.force3D, a.renderTransform = a.svg ? Qs : Wr ? Xr : Ys, a.uncache = 0, a;
}, Ta = function(e) {
  return (e = e.split(" "))[0] + " " + e[1];
}, Ya = function(e, t, a) {
  var i = te(t);
  return Q(parseFloat(t) + parseFloat(it(e, "x", a + "px", i))) + i;
}, Ys = function(e, t) {
  t.z = "0px", t.rotationY = t.rotationX = "0deg", t.force3D = 0, Xr(e, t);
}, st = "0deg", Lt = "0px", lt = ") ", Xr = function(e, t) {
  ...
  if (x && (u !== st || d !== st)) {
    var T = parseFloat(d) * Tt, A = Math.sin(T), k = Math.cos(T), C;
    T = parseFloat(u) * Tt, C = Math.cos(T), r = Ya(b, r, A * C * -x), s = Ya(b, s, -Math.sin(T) * -x), l = Ya(b, l, k * C * -x + x);
  }
  w !== Lt && (_ += "perspective(" + w + lt), (i || n) && (_ += "translate(" + i + "%, " + n + "%) "), (v || r !== Lt || s !== Lt || l !== Lt) && (_ += l !== Lt || v ? "translate3d(" + r + ", " + s + ", " + l + ") " : "translate(" + r + ", " + s + lt), c !== st && (_ += "rotate(" + c + lt), d !== st && (_ += "rotateY(" + d + lt), u !== st && (_ += "rotateX(" + u + lt), (h !== st || g !== st) && (_ += "skew(" + h + ", " + g + lt), (m !== 1 || p !== 1) && (_ += "scale(" + m + ", " + p + lt), b.style[W] = _ || "translate(0, 0)";
}, Qs = function(e, t) {
  ...
  i.svg ? (c = a.getAttribute("transform"), a.setAttribute("transform", ""), r[W] = t, s = $t(a, 1), at(a, W), a.setAttribute("transform", c)) : (c = getComputedStyle(a)[W], r[W] = t, s = $t(a, 1), r[W] = c);
  for (l in Ve)
...
se("padding,margin,Width,Radius", function(o, e) {
  ...
  ka[e > 1 ? "border" + o : o] = function(s, l, c, d, u) {
    var h, g;
...
var Jr = {
  ...
  init: function(e, t, a, i, n) {
    ...
    Ui || _i(), this.styles = this.styles || Gr(e), k = this.styles.props, this.tween = a;
    for (p in t)
      if (p !== "autoRound" && (d = t[p], !(ue[p] && Ir(p, t, a, i, e, n)))) {
        if (g = typeof d, m = ka[p], g === "function" && (d = d.call(a, i, e, n), g = typeof d), g === "string" && ~d.indexOf("random(") && (d = Kt(d)), m)
          m(this, e, p, d, a) && (A = 1);
        else if (p.substr(0, 2) === "--")
          c = (getComputedStyle(e).getPropertyValue(p) + "").trim(), d += "", et.lastIndex = 0, et.test(c) || (w = te(c), y = te(d), y ? w !== y && (c = it(e, p, c, y) + y) : w && (d += w)), this.add(s, "setProperty", c, d, i, n, 0, 0, p), r.push(p), k.push(p, 0, s[p]);
        else if (g !== "undefined") {
          if (l && p in l ? (c = typeof l[p] == "function" ? l[p].call(a, i, e, n) : l[p], X(c) && ~c.indexOf("random(") && (c = Kt(c)), te(c + "") || c === "auto" || (c += we.units[p] || te(Fe(e, p)) || ""), (c + "").charAt(1) === "=" && (c = Fe(e, p))) : c = Fe(e, p), h = parseFloat(c), b = g === "string" && d.charAt(1) === "=" && d.substr(0, 2), b && (d = d.substr(2)), u = parseFloat(d), p in qe && (p === "autoAlpha" && (h === 1 && Fe(e, "visibility") === "hidden" && u && (h = 0), k.push("visibility", 0, s.visibility), Xe(this, s, "visibility", h ? "inherit" : "hidden", u ? "inherit" : "hidden", !u)), p !== "scale" && p !== "transform" && (p = qe[p], ~p.indexOf(",") && (p = p.split(",")[0]))), x = p in Ve, x) {
            if (this.styles.save(p), C = d, g === "string" && d.substring(0, 6) === "var(--") {
              if (d = fe(e, d.substring(4, d.indexOf(")"))), d.substring(0, 5) === "calc(") {
                ...
                e.style.perspective = d, d = fe(e, "perspective"), M ? e.style.perspective = M : at(e, "perspective");
              }
              u = parseFloat(d);
            }
            if (_ || (v = e._gsap, v.renderTransform && !t.parseTransform || $t(e, t.parseTransform), T = t.smoothOrigin !== !1 && v.smooth, _ = this._pt = new le(this._pt, s, W, 0, 1, v.renderTransform, v, 0, -1), _.dep = 1), p === "scale")
              ...
              k.push(ce, 0, s[ce]), d = Gs(d), v.svg ? Ai(e, d, 0, T, 0, this) : (y = parseFloat(d.split(" ")[2]) || 0, y !== v.zOrigin && Xe(this, v, "zOrigin", v.zOrigin, y), Xe(this, s, p, Ta(c), Ta(d)));
              continue;
            } else if (p === "svgOrigin") {
              Ai(e, d, 1, T, 0, this);
              continue;
            } else if (p in jr) {
              js(this, v, p, h, b ? Ct(h, b + d) : d);
              continue;
            } else if (p === "smoothOrigin") {
              Xe(this, v, "smooth", v.smooth, d);
              continue;
            } else if (p === "force3D") {
              v[p] = d;
              continue;
          ...
          if (x || (u || u === 0) && (h || h === 0) && !Ms.test(d) && p in s)
            w = (c + "").substr((h + "").length), u || (u = 0), y = te(d) || (p in we.units ? we.units[p] : w), w !== y && (h = it(e, p, c, y)), this._pt = new le(this._pt, x ? v : s, p, h, (b ? Ct(h, b + u) : u) - h, !x && (y === "px" || p === "zIndex") && t.autoRound !== !1 ? Is : xi), this._pt.u = y || 0, x && C !== d ? (this._pt.b = c, this._pt.e = C, this._pt.r = Ds) : w !== y && y !== "%" && (this._pt.b = c, this._pt.r = Rs);
          else if (p in s)
            Vs.call(this, e, p, c, b ? b + d : d);
          else if (p in e)
  ...
  getSetter: function(e, t, a) {
    var i = qe[t];
    return i && i.indexOf(",") < 0 && (t = i), t in Ve && t !== ce && (e._gsap.x || Fe(e, "x")) ? a && rn === a ? t === "scale" ? Os : Ns : (rn = a || {}) && (t === "scale" ? Bs : Fs) : e.style && !Ei(e.style[t]) ? qs : ~t.indexOf("-") ? Ls : Fi(e, t);
  },
  core: {
    _removeProperty: at,
    _getMatrix: Gi
...
de.registerPlugin(Jr);
var f = de.registerPlugin(Jr) || de;
f.core.Tween;
const Be = "Thinking", St = "Show more", ya = "Show less";
function Wi(o, e) {
...
function kl(o) {
  const e = Zr(o).replace(/[^a-z0-9]+/g, "-").replace(/^-|-$/g, "");
  return e ? `${q}?u=${encodeURIComponent(e)}` : "";
}
function Na(o, e) {
  const t = Zr(o), a = e?.trim() || void 0;
  return Cl[t] ?? a ?? kl(o);
}
const $r = `
...
const Tl = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="52 42 88 66">
<path fill="#4285f4" d="M58 108h14V74L52 59v43c0 3.32 2.69 6 6 6"/>
<path fill="#34a853" d="M120 108h14c3.32 0 6-2.69 6-6V59l-20 15"/>
<path fill="#fbbc04" d="M120 48v26l20-15v-8c0-7.42-8.47-11.65-14.4-7.2"/>
<path fill="#ea4335" d="M72 74V48l24 18 24-18v26L96 92"/>
<path fill="#c5221f" d="M52 51v8l20 15V48l-5.6-4.2c-5.94-4.45-14.4-.22-14.4 7.2"/>
</svg>`, El = `<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" viewBox="60 90.4 570.02 539.67">
<defs>
...
const Ml = [
...
], Pl = 1.28, S = (o) => Number((o * Pl).toFixed(3)), Rl = {
  ...
  settleHold: S(0.24)
}, yn = "Learning your style", ql = "Voice calibrated", xn = "73 tone & tactic rules defined", ja = [
  ...
  0,
  4
], Ol = /* @__PURE__ */ new Set([5, 8, 10, 16]), Bl = [
  ...
  threadGap: 44
}, Hl = "left,right,bottom,width,height,minHeight,paddingTop,paddingRight,paddingBottom,paddingLeft,borderWidth,gap", Xa = {
  paddingTop: "",
  paddingRight: "",
  paddingBottom: "",
  paddingLeft: "",
  ...
  contentWidth: 1881,
  height: 1280
}, Yl = 96, Tn = ".wa-cursor-file, .wa-file-landing-clone, .wa-file-landing-label, .wa-csv-drop, .wa-signup-logo-transfer", En = "[data-marketing-data-sources-grid]", Mn = "[data-data-table]", Ot = "[data-table-action]", Za = "[data-table-page-button]", $a = "[data-table-page-range]", Pn = "[data-sequence-engagement]", Ql = "[data-sequence-card]", jl = "[data-sequence-person-card]", Rn = "[data-sequence-people-rail]", j = {
  duration: S(0.12),
  incomingLag: S(0.1),
  rowStagger: S(0.03),
...
class $l {
  ...
  animateStorySwitchExit() {
    ...
    const a = this.getThreadBottomScrollTarget(), i = Math.min(a, this.thread.scrollTop + dt.scrollDistance);
    return f.killTweensOf(e), i > this.thread.scrollTop + 0.5 && t.to(
      this.thread,
      {
        scrollTop: i,
        duration: dt.scrollDuration,
        ease: "power2.inOut",
        overwrite: "auto"
      },
      0
  ...
  measureComposerFullFrame() {
    f.set(this.composer, { clearProps: Hl });
  ...
  getSignupScrollOutDistance() {
    ...
    return -Math.max(Nt.minScrollOut, Math.round(e * Nt.scrollOutRatio));
  }
  stopScrollMotion() {
  ...
  dataTableActionTooltip(e, t, a) {
    return f.timeline().call(() => {
      ...
      const n = this.queryElements(i, Ot);
      n.forEach((l) => {
  ...
  strategyPlans(e) {
    ...
    const d = this.claimComponentMessage("strategy", a), u = f.timeline().add(this.revealMessage(d, n, Cn)).addLabel(s, Gl).call(() => this.setMotionHints(c), void 0, s).to(t, { ...r.to }, s);
    return t.forEach((h, g) => {
      ...
      () => this.animateMessageScrollIntoView(d, J.followDuration, n, Cn),
      void 0,
      "+=0.02"
    );
  }
  ...
  connectMailbox(e) {
    ...
    return g.call(() => {
      ...
      i.dataset.mailboxLearningState = "ready", l.textContent = ql, d.textContent = i.dataset.mailboxLearningReadyDetail ?? xn;
    }).fromTo(
      l,
      { autoAlpha: 0, y: 4 },
      {
  ...
  enrollmentProgress(e = {}) {
    const t = Math.max(1, Math.round(e.total ?? 50)), a = { value: 0 }, i = this.createThinkingStep(
      {
        label: e.label ?? ct.label,
        detail: e.detail ?? ct.detail,
        disclosure: St
      },
      0
    ...
    return f.timeline().call(() => {
      ...
      onUpdate: () => {
        ...
        this.setThinkingTitle(n, ct.title(s, t)), this.requestMessageScroll(n.message);
      }
    }, "+=0.04").add(this.completeProgressThinking(n, [i], ct.title(t, t))).to({}, { duration: ct.finalHold });
  }
  ...
  getWindowSceneAvailableHeight() {
    ...
    return Math.max(1, e * Rl.maxViewportHeightRatio);
  }
  ...
  resetMessageClasses(e) {
    e.classList.remove(...Ml), e.classList.remove("wa-message--first-active");
  }
  createCsvDropArea(e = {}) {
  ...
  streamThinkingHeader(e) {
    return this.streamThinkingChild(e, ".wa-thinking__title", Ul);
  }
  streamThinkingStepLabel(e) {
    return this.streamThinkingChild(e, ".wa-research-step__label", zl);
  }
  streamThinkingStepDetail(e) {
    return this.streamThinkingChild(e, ".wa-research-step__detail", Et);
  }
  ...
  renderSignupLogoTransfer(e, t) {
    if (!e) return;
    const a = e.target.getBoundingClientRect(), i = this.getElementLocalRect(a, this.chatBody), n = ao(t);
  ...
  addThinkingStepReveal(e, t, a = {}) {
    return e.to(
      ...
      a.position ?? "<"
    ).add(this.streamThinkingStepLabel(t), Et.startOverlap).add(this.streamThinkingStepDetail(t), "-=0.02");
  }
  ...
  addThinkingStepStreams(e, t) {
    t.forEach((a, i) => {
      e.add(this.streamThinkingStepLabel(a), i === 0 ? Et.startOverlap : "<");
    }), t.forEach((a, i) => {
  ...
  normalizeThinkingItem(e, t) {
    ...
    return {
      ...
      disclosure: typeof e == "string" ? t === 0 ? St : ya : e.disclosure || (t === 0 ? St : ya)
    };
  }
  ...
  hideDataTableControlTooltip() {
    this.tableControlTooltip.dataset.visible = "false", this.tableControlTooltip.dataset.hasBadge = "false", this.queryElements(this.chatShell, Ot).forEach((e) => {
      e.dataset.tooltipVisible = "false";
    });
  }
  setDataTableControlTooltipVisible(e) {
    const t = e.closest(Mn);
    (t ? this.queryElements(t, Ot) : this.queryElements(this.chatShell, Ot)).forEach((i) => {
  ...
  findDataTableControl(e) {
    return e instanceof Element ? e.closest(Ot) : null;
  }
  findDataTablePageButton(e) {
    return e instanceof Element ? e.closest(Za) : null;
  }
  getDataTablePageButtonRuntime(e) {
    const t = e.closest(Mn), a = t?.dataset.dataTable, i = this.parseFiniteNumber(e.dataset.tablePageButton);
  ...
  getCompanyLogoUrl(e, t) {
    ...
    if (a) return a;
    const i = this.getCompanyKey(e), n = Sl[i];
    if (n) return n;
  ...
  createMarketingDataSourcesGrid(e) {
    ...
    return t.classList.add("wa-data-source-grid--marketing"), t.dataset.marketingDataSourcesGrid = e.id, a.className = "wa-data-source-grid__scale", i.className = "wa-data-source-grid__groups", Wl.forEach((s) => {
      const l = document.createElement("div");
  ...
  createMailboxProviderIcon(e) {
    ...
    return t.className = "wa-mailbox-connection__provider-icon", t.src = Ll[e], t.alt = "", t.decoding = "async", t.loading = "eager", t.setAttribute("aria-hidden", "true"), t;
  }
  ...
  createMailboxThumbprintGroup(e, t = !1) {
    ...
    return a.classList.add(e), Bl.forEach((i, n) => {
    ...
    e.sequences.forEach((m, p) => {
      ...
      if (k?.length) {
        ...
        C.className = "wa-sequence-steps", k.forEach((D, I) => {
          const P = document.createElement("button"), $ = document.createElement("span"), Te = document.createElement("span"), Ge = document.createElement("strong"), ke = this.getSequenceStepWaitDays(D, I, k.length);
          ...
          ), Te.className = "wa-sequence-step__copy", Ge.textContent = this.formatSequenceStepTitle(D.label), Te.append(Ge), P.append($, Te), C.append(P), ke && C.append(this.createSequenceWaitRow(ke, I));
  ...
  getSequenceRailRuntime(e, t) {
    const a = e.querySelector(Rn), i = a?.querySelector(`[data-sequence-person-index="${t}"]`);
  ...
  getSequenceStepWaitDays(e, t, a) {
    return t >= a - 1 ? null : e.waitDays ?? Dl[t] ?? 1;
  }
...
`);
  ...
  requestMessageScroll(e) {
    ...
    this.scheduledScrollMessage = e, !(t - this.lastStreamScrollAt < Yl) && (this.scheduledScrollFrame || (this.lastStreamScrollAt = t, this.scheduledScrollFrame = window.requestAnimationFrame(() => {
...
function ec(o, e) {
  const t = Nl[o] ?? 0, a = 24 + o * 11 % 8, i = Math.min(100, t + a), n = ao((e - t) / (i - t));
  if (n <= 0) return 0;
  const r = Ol.has(o) ? 20 : 12;
...
function ca(o, e, t) {
  const a = no(t.seed), i = io(o, e), n = t.speed ?? "normal", r = t.intent ?? "hover";
  ...
  const s = e.x - o.x, l = e.y - o.y, c = s / i, d = l / i, u = -d, h = c, g = a() > 0.5 ? 1 : -1, m = t.curve ?? 1, w = Je(i * (r === "drag" ? 0.1 : r === "click" ? 0.17 : 0.22), 18, 150) * m * g * (0.72 + a() * 0.44), y = i / ac[n] + 0.16, b = Je(
    y * ic[r] * nc * (t.durationScale ?? 1),
    0.3,
    1.98
  ), x = t.overshoot === !1 || i < 120 ? 0 : typeof t.overshoot == "number" ? t.overshoot : Je(i * 0.026, 4, 18), _ = x > 0 ? {
    x: e.x + c * x,
    y: e.y + d * x
  } : e, v = {
...
class sc {
  ...
  createElement() {
    ...
    const a = document.createElement("div");
    return a.className = "wa-cursor__glyph", a.append(qn()), t.append(a), e.append(t), this.root.append(e), e;
  }
  ensureFloatLayer() {
    const e = this.el.querySelector("[data-cursor-float]");
    if (e) return e;
    const t = this.el.querySelector(".wa-cursor__glyph") ?? document.createElement("div");
    t.classList.contains("wa-cursor__glyph") || (t.className = "wa-cursor__glyph"), t.querySelector(".wa-cursor__mimic-head") || t.append(qn());
    const a = document.createElement("div");
...
const Nn = /* @__PURE__ */ new Set(), ua = /* @__PURE__ */ new Set(), uc = ["avatarUrl", "mutualConnectionAvatarUrl"], hc = ["name", "contact", "prospect", "fullName", "mutualConnection", "connector"];
function On(o, e) {
  o.length && (Bn(o[e]), Bn(o[(e + 1) % o.length]));
}
function Bn(o) {
...
}, lo = N("[data-signup-field]", "center", {
  desktop: -74,
  tablet: -66,
  mobile: -48
}), co = N("[data-signup-submit]", "center"), xc = N("[data-send-button]", "center"), Yi = {
  desktop: {
...
}, vc = 2.8, _c = 42, Ac = 2, Sc = 3, Ma = "[data-chat-shell] [data-chat-thread]", Cc = `${Ma} [data-message-role="assistant"]:not(.wa-message--component) [data-message-body]`, kc = `${Ma} [data-message-role="assistant"].wa-message--thinking .wa-research-step[data-step-state="current"] .wa-research-step__body, ${Ma} [data-message-role="assistant"].wa-message--thinking .wa-research-step[data-step-state="complete"] .wa-research-step__label`, Pa = 0.24, uo = 0.3, ze = {
...
function po(o) {
  const e = Qe(`[data-style-profile="${pe(o)}"]`), t = Ra(o);
  return go([
    {
...
function mo(o, e, t = "+=0.08") {
  return e.flatMap((a, i) => {
    const n = `[data-sequence-engagement="${pe(o)}"] .wa-sequence-card[data-active="true"] .wa-sequence-step[data-step-index="${a}"]`;
    return [
      {
        kind: "cursorMove",
        target: N(n, "center", {}, !1),
      ...
      {
        kind: "custom",
        build: (r) => r.chat.sequenceStep(o, a),
        at: "-=0.03"
      },
      {
        kind: "custom",
        build: (r) => r.timeline().to({}, { duration: E.beat + 0.18 }),
        at: "+=0.02"
      }
    ];
  });
}
function fo(o, e = E.beat + 0.18, t, a = {}) {
  return {
    kind: "custom",
    build: (i) => {
      const n = ia(i);
...
function Tc(o, e, t, a, i) {
  switch (t.kind) {
    ...
    case "thinking": {
      ...
      t.statusBefore && o.add(e.chat.setStatus(t.statusBefore), t.at), o.add(e.chat.thinkingState(n, t.hold), t.statusBefore ? void 0 : t.at), Dc(o, e, i, t.hold, r.length, r.join("|"), a);
      return;
    }
    case "dataTable":
      Ft(
        ...
        t.at,
        Qe(`[data-data-table="${pe(t.config.id)}"]`),
        `table-${t.config.id}`
      );
      return;
    case "enrichmentPanel":
      Ft(
        ...
        t.at,
        Qe(`[data-enrichment-panel="${pe(t.config.id)}"]`),
        `enrichment-${t.config.id}`
      );
      return;
    case "strategyPlans":
      {
        const n = Qe(`[data-strategy-plans~="${pe(t.plans[0]?.id ?? "strategy")}"]`);
    ...
    case "dataSourcesGrid":
      Ft(
        ...
        t.at,
        Qe(`[data-data-sources-grid="${pe(t.config.id)}"]`),
        `sources-${t.config.id}`
      );
      return;
    case "marketingDataSourcesGrid":
      Ft(
        ...
        t.at,
        Qe(`[data-marketing-data-sources-grid="${pe(t.config.id)}"]`),
    ...
    case "sequenceEngagement":
      Ft(
        ...
        t.at,
        Qe(`[data-sequence-engagement="${pe(t.config.id)}"]`),
...
function Ec(o) {
  return "thinking" in o && o.thinking ? o.thinking : Array.isArray(o.steps) ? { items: o.steps.map(Fn) } : { items: [Fn(o.label ?? "")] };
}
function Fn(o) {
...
function Dc(o, e, t, a = E.thinkingShort, i = 1, n = "thinking", r = 0) {
  const s = a * Math.max(1, i), l = i >= 3 && wo(e, t, {
    kind: "thinking",
    key: n,
    text: n,
    stepIndex: r,
    ...
    if (!(t.kind !== "component" || !t.component))
      switch (t.component.kind) {
        case "table":
          ...
          break;
        case "dataSources":
          ha(e, ro(vo(t.component)));
          break;
        case "proximityList":
          ha(e, oo(Co(t.component)));
          break;
        case "sequenceEngagement":
          ha(e, so(Qi(t.component, `${o.id}-${t.id}`)));
          break;
      }
  return [...e];
}
...
function Wc(o, e, t) {
  ...
  const a = $c(e);
  return a.length ? Ie(o, [...a, Ze(ze.bottomRight, "+=0.18")]) : t.build(o);
}
function Yc(o, e) {
  const t = Ue(e, "status"), a = Ue(e, "user"), i = Ue(e, "thinking"), n = Ue(e, "assistant"), r = ta(e, "strategyCards");
  return Ie(o, [
    ...
    ...r ? [{ kind: "strategyPlans", plans: xo(r.component), at: "-=0.08" }] : [],
    Ze(ze.right, "+=0.18")
  ]);
}
function Qc(o, e) {
  const t = ta(e, "mailboxConnection"), a = ta(e, "uploadedFiles"), i = [];
  if (t && So(i, Ao(t.component)), a) {
  ...
  for (const n of e.steps)
    n === t || n === a || bo(i, e.id, n);
  return i.push(Ze(ze.bottomRight, "+=0.16")), Ie(o, i);
}
function jc(o, e) {
  const t = Ue(e, "user"), a = ta(e, "table"), i = Ue(e, "thinking"), n = ta(e, "sequenceEngagement"), r = a ? ea(a.component, "website-visitors-sales") : null, s = n ? Qi(n.component, "visitor-outreach-sequences") : null, l = [];
  if (r && (r.scrollAlign = "equal-inset"), t && l.push({
    ...
    fo("website-visitors-sales", E.beat + 0.42, "+=0.08", {
      align: "top",
      offset: -190,
      settleDelay: 0.32
    }),
  ...
  if (i && l.push(Ba(i, { hold: E.thinkingMedium, at: "+=0.06" })), s) {
    ...
    l.push(
      ...
      ...mo("visitor-outreach-sequences", [1, 2, 3], "+=0.08"),
      {
        kind: "cursorMove",
        target: g,
...
function $c(o) {
  ...
  let a = 0;
  for (const i of t)
    a += i.kind === "user" ? 1 : 0, bo(e, o.id, i, a === 1);
  return e;
}
function ed(o) {
  const e = [];
...
function ad(o, e, t) {
  ...
  if (a.kind === "strategyCards") {
    o.push({ kind: "strategyPlans", plans: xo(a), at: "-=0.04" });
    return;
  }
  ...
  if (a.kind === "styleProfile") {
    ...
    o.push({
      ...
      at: "-=0.02"
    }), e === "crm-update" && o.push(...po(i.id));
    return;
  }
  if (a.kind === "proximityList") {
    o.push({ kind: "custom", build: (i) => i.chat.proximityLeadList(Co(a)), at: "-=0.04" });
    return;
  }
...
function sd(o) {
  o.rows.forEach((e) => zn(e.values)), o.pagination?.pages.forEach((e) => {
    e.rows.forEach((t) => zn(t.values));
  });
}
function zn(o) {
...
function pd(o, e) {
  const t = o.columns, a = t.findIndex((d) => d.trim().toLowerCase() === "name"), i = a >= 0 ? t.findIndex((d, u) => u > a && /^role\b/i.test(d.trim())) : -1, n = a >= 0 && i >= 0, r = yo(e) ? t.findIndex((d) => d.trim().toLowerCase() === "title") : -1, s = n ? i : r >= 0 ? r : void 0, l = t.map((d, u) => u).filter((d) => d !== i && d !== r), c = l.map((d) => {
...
function bd(o, e, t) {
  ...
  if (e.columns.forEach((i, n) => {
    ...
    const i = Ci(a[e.mutualConnectionKey] ?? ""), n = yd(t);
  ...
  if (e.connectorPersonKey) {
    const i = Ci(a[e.connectorPersonKey] ?? "");
...
function xd(o, e, t) {
  const a = Hn(t), i = a && !/^(?:Stanford GSB|Wharton)$/i.test(a);
...
const Dd = {
  ...
  pagination: {
    ...
    activePage: 1,
    pages: [
      { page: 1, range: "1-10 of 50 people", rows: Xn },
  ...
  },
  {
    ...
    build: (o) => Ie(o, [
      ...
      { kind: "dataTable", config: Vn, at: "-=0.04" },
      {
        kind: "prompt",
      ...
      { kind: "dataTable", config: Yn, at: "-=0.02" },
      { kind: "marketingDataSourcesGrid", config: Wn, at: "+=1.44" },
      Ze(ze.bottomRight, "+=3")
    ])
  },
  {
    ...
    build: (o) => {
      ...
      }), t = o.chat.prepareCursorFile("4 context files", o.cursor, "DOC", Qn), a = {
        desktop: { target: "[data-chat-shell]", anchor: "right", outside: "right", offset: { x: 420, y: -74 }, humanOffset: !1 },
        tablet: { target: "[data-chat-shell]", anchor: "right", outside: "right", offset: { x: 360, y: -58 }, humanOffset: !1 },
        mobile: { target: "[data-chat-shell]", anchor: "right", outside: "right", offset: { x: 280, y: -42 }, humanOffset: !1 }
      ...
      return Ie(o, [
        ...
        { kind: "custom", build: () => t.landAsUploadedFiles(Qn), at: "<" },
        ...
        {
          kind: "custom",
          build: () => o.chat.outreachStyleProfile(jn, { scrollAlign: "equal-inset" }),
          at: "-=0.02"
        },
        ...po(jn.id),
        {
        ...
        { kind: "custom", build: () => o.chat.proximityLeadList(Kn), at: "-=0.04" },
        Ze(ze.bottomRight, "+=0.16")
      ]);
    }
  },
  {
    ...
    build: (o) => {
      ...
      return Ie(o, [
        ...
        { kind: "dataTable", config: Jn, at: "-=0.02" },
        fo("website-visitors-sales", E.beat + 0.42, "+=0.08", {
          align: "top",
          offset: -190,
          settleDelay: 0.32
        ...
        { kind: "cursorClick", at: "+=0.18" },
        { kind: "status", text: "building outreach sequence", at: "<" },
        { kind: "custom", build: () => o.chat.sequenceBuildThinking(Dd), at: "+=0.06" },
...
class Od {
  ...
  followPointer = () => {
    ...
    if (this.mode === "return") {
      ...
      if (this.target = t, this.cursor.mimicViewportPoint(i, 1, a < 1 ? n : t), a >= 1 || Ye(this.getCursorViewportPoint(), t) <= li.arriveDistance) {
  ...
  updateFollowTarget(e) {
    ...
    if (this.lastPointer) {
      ...
      i > 1.5 && (this.trailDirection = {
        x: a.x / i,
        y: a.y / i
      }, this.velocity = Vd(a, ee.maxMomentumStep));
    }
    const t = {
      x: e.x - this.trailDirection.x * ee.trailDistance,
      y: e.y - this.trailDirection.y * ee.trailDistance
    };
    Ye(e, t) < ee.minPointerDistance && (t.x = e.x - this.trailDirection.x * ee.minPointerDistance, t.y = e.y - this.trailDirection.y * ee.minPointerDistance), this.target = t, this.pointer = e, this.lastPointer = e;
  }
  startPlayfulIdle(e) {
  ...
  updatePlayTarget(e) {
    ...
    this.target = zd(n, this.pointer, We.minPointerDistance, We.viewportInset);
  }
  resumeFollowing(e) {
  ...
  trackDismissShake(e, t) {
    this.dismissSamples.push({ ...e, time: t }), this.pruneSampleList(this.dismissSamples, t, ut.sampleWindowMs);
  }
  ...
  isDismissShakeWindow(e) {
    const t = e[0], a = e[e.length - 1], i = Math.max(1, a.time - t.time), n = e.reduce((l, c, d) => {
      const u = e[d - 1];
      return u ? l + Ye(c, u) : l;
    }, 0), r = Ye(t, a), s = n / Math.max(r, 1);
    return i >= ut.minDurationMs && n >= ut.minTravel && r <= ut.maxNetDistance && n / i >= ut.minAverageSpeed && s >= ut.minTravelToNetRatio && this.countAxisReversals(e) >= ut.minAxisReversals;
  }
  countAxisReversals(e) {
    let t = 0, a = 0, i = 0;
    for (let n = 1; n < e.length; n += 1) {
      const r = e[n - 1], s = e[n], l = er(s.x - r.x), c = er(s.y - r.y);
...
function $n(o, e) {
  return {
    x: Zn(o.x, e, window.innerWidth - e),
    y: Zn(o.y, e, window.innerHeight - e)
  };
}
function zd(o, e, t, a) {
  const i = $n(Ud(o, e, t), a);
  if (Ye(i, e) >= t * 0.86) return i;
  const n = {
...
class Wd {
  ...
  updateStories(e, t = {}) {
    ...
    this.updateStoryMeta(), this.updateAllTabProgress(), On(this.stories, this.activeIndex);
  }
  goTo(e, t = {}) {
  ...
  rebuildActiveStoryTimeline(e, t, a = 0) {
    this.activeIndex = e, On(this.stories, this.activeIndex), this.activeTimeline = this.buildTimeline(this.activeIndex, t), this.renderActiveTimelineProgress(a), this.updateStoryMeta();
  }
  stopTimeline() {
  ...
  attachChatHistoryScroll() {
    ...
    const a = (i) => {
      ...
      if (Math.abs(n) < tr.minPixelDelta) return;
      const r = this.getThreadMaxScroll(t);
      if (r <= 0 || !(n < 0 || this.historyPaused)) return;
      const l = Mo(t.scrollTop + n, 0, r);
      if (!(Math.abs(l - t.scrollTop) >= 0.5)) return;
      const d = Math.max(0, n - (r - t.scrollTop));
      i.preventDefault(), this.pauseForChatHistory(), t.scrollTop = l, d >= tr.minPixelDelta && window.scrollBy({ top: d, left: 0, behavior: "auto" });
    };
...
class Qd {
  ...
  resolve(e, t = "target") {
    ...
    if (s = {
      ...
      const l = no(t), c = Math.min(r.width * 0.18, 18), d = Math.min(r.height * 0.18, 14);
...
function jd(o, e = {}) {
  const t = e.stories?.length ? e.stories : Eo, a = e.builderDraftEndpoint ?? "/api/story-draft", i = e.reducedMotion ?? window.matchMedia?.("(prefers-reduced-motion: reduce)").matches ?? !1, n = new Qd(o), r = new $l(o), s = new sc(o, n, { reducedMotion: i }), l = new Wd(o, t, n, s, r, {
...
function eu(o) {
  ...
  const e = Ce(o.id), t = Ce(o.label), a = Ce(o.summary), i = o.steps.map((n) => tu(n)).filter((n) => !!n);
...
function tu(o) {
  ...
  return !e || !t || !Zd(t) ? null : {
    ...
    text: a ?? "",
    note: i ?? "",
    thinking: Mt(o.thinking) ? au(o.thinking, a ?? "", i ?? "") : t === "thinking" ? Po(a ?? "", i ?? "") : void 0,
    component: Mt(o.component) ? $d(o.component) : void 0
  };
}
function au(o, e, t) {
  ...
  return i.length ? {
    title: Ce(o.title) ?? Be,
    elapsed: Ce(o.elapsed) ?? La(i.length),
    items: i
  } : Po(e, t);
}
function iu(o, e) {
  ...
  return t ? {
    label: t,
    detail: Ce(o.detail) ?? Wi(t, e),
    disclosure: Ce(o.disclosure) ?? (e === 0 ? St : ya)
  } : null;
}
function Po(o, e = "") {
  return {
          ...
          <div class="wa-chat-shell" data-chat-shell>
            ...
            <div class="wa-chat-shell__body">
              <div class="wa-signup-scene" data-signup-scene>
                <span class="wa-signup-scene__logo" data-signup-logo-target aria-hidden="true">${$r}</span>
...
const ki = cu(ou, { injectStyles: pu });
...
typeof window < "u" && (window.ChatbotStories = mu, document.readyState === "loading" ? document.addEventListener("DOMContentLoaded", ki.autoInit, { once: !0 }) : ki.autoInit());
export {
  Eo as defaultStories,
  gu as init
};
