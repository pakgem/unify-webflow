...
var we = {
  ...
  overwrite: !1,
  delay: 0
}, Ei, Z, H, Ae = 1e8, B = 1 / Ae, ui = Math.PI * 2, Do = ui / 4, Io = 0, nr = Math.sqrt, qo = Math.cos, Lo = Math.sin, X = function(e) {
...
}, ae = Array.isArray, No = /random\([^)]+\)/g, Oo = /,\s*/g, Xi = /(?:-?\.?\d|\.)+/gi, or = /[-+=.]*\d+[.e\-+]*\d*[e\-+]*\d*/g, At = /[-+=.]*\d+[.e-]*\d*[a-z%]*/g, za = /[-+=.]*\d+\.?\d*(?:e-|e\+)?\d*/gi, sr = /[+-]=-?[.\d]+/, Bo = /[^,'"\[\]\s]+/gi, Fo = /^[+\-=e\s\d]*\d+[.\d]*([a-z]*|%)\s*$/i, G, Re, hi, Ri, be = {}, _a = {}, lr, cr = function(e) {
  ...
  suppressEvents: !0
}, Ii = {}, et = [], pi = {}, ur, ue = {}, Ua = {}, Ji = 30, ba = [], qi = "", Li = function(e) {
  var t = e[0], a, i;
  if (Le(t) || Y(t) || (e = [e]), !(a = (t._gsap || {}).harness)) {
    for (i = ba.length; i-- && !ba[i].targetTest(t); )
      ;
    a = ba[i];
  }
  for (i = e.length; i--; )
    e[i] && (e[i]._gsap || (e[i]._gsap = new Ir(e[i], a))) || e.splice(i, 1);
  return e;
}, mt = function(e) {
  return e._gsap || Li(Se(e))[0]._gsap;
}, hr = function(e, t, a) {
  return (a = e[t]) && Y(a) ? e[t]() : Mi(a) && e.getAttribute && e.getAttribute(t) || a;
}, se = function(e, t) {
  ...
  for (pi = {}, et.length = 0, a = 0; a < e; a++)
    i = t[a], i && i._lazy && (i.render(i._lazy[0], i._lazy[1], !0)._lazy = 0);
}, Ni = function(e) {
  return !!(e._initted || e._startAt || e.add);
}, pr = function(e, t, a, i) {
  et.length && !Z && Aa(), e.render(t, a, !!(Z && t < 0 && Ni(e))), et.length && !Z && Aa();
}, gr = function(e) {
  var t = parseFloat(e);
  return (t || t === 0) && (e + "").match(Bo).length < 2 ? t : X(e) ? e.trim() : e;
}, mr = function(e) {
  return e;
}, ye = function(e, t) {
  for (var a in t)
  ...
  var t = e.parent || G, a = e.keyframes ? Vo(ae(e.keyframes)) : ye;
  if (oe(e.inherit))
    for (; t; )
  ...
  return e._startAt && (Z ? e._startAt.revert(wa) : e.vars.immediateRender && !e.vars.autoRevert || e._startAt.render(t, !0, i));
}, Yo = function o(e) {
  ...
  var a = e._dp;
  return a && a.smoothChildTiming && e._ts && (e._start = V(a._time - (e._ts > 0 ? t / e._ts : ((e._dirty ? e.totalDuration() : e._tDur) - t) / -e._ts)), qa(e), a._dirty || ft(a, e)), e;
}, wr = function(e, t) {
  var a;
  if ((t._time || !t._dur && t._initted || t._start < e._time && (t._dur || !t.add)) && (a = Ca(e.rawTime(), t), (!t._dur || ia(0, t.totalDuration(), a) - t._tTime > B) && t.render(a, !0)), ft(e, t)._dp && e._initted && e._time >= e._dur && e._ts) {
  ...
  return t.parent && at(t), t._start = V((Ve(a) ? a : a || e !== G ? _e(e, a, t) : e._time) + t._delay), t._end = V(t._start + (t.totalDuration() / Math.abs(t.timeScale()) || 0)), fr(e, t, "_first", "_last", e._sort ? "_start" : 0), mi(t) || (e._recent = t), i || wr(e, t), e._ts < 0 && La(e, e._tTime), e;
}, br = function(e, t) {
  return (be.ScrollTrigger || Di("scrollTrigger", t)) && be.ScrollTrigger.create(t, e);
}, yr = function(e, t, a, i, n) {
  if (Bi(e, t, n), !e._initted)
    return 1;
  if (!a && e._pt && !Z && (e._dur && e.vars.lazy !== !1 || !e._dur && e.vars.lazy) && ur !== ge.frame)
  ...
  var n = e.ratio, r = t < 0 || !t && (!e._start && Qo(e) && !(!e._initted && mi(e)) || (e._ts < 0 || e._dp._ts < 0) && !mi(e)) ? 0 : 1, s = e._rDelay, l = 0, c, d, u;
  if (s && e._repeat && (l = ia(0, e._tDur, t), d = Dt(l, s), e._yoyo && d & 1 && (r = 1 - r), d !== Dt(e._tTime, s) && (n = 1 - r, e.vars.repeatRefresh && e._initted && e.invalidate())), r !== n || Z || i || e._zTime === B || !t && e._zTime) {
    if (!e._initted && yr(e, t, i, a, l))
      return;
    for (u = e._zTime, e._zTime = t || (a ? B : 0), a || (a = t && !u), e.ratio = r, e._from && (r = 1 - r), e._time = 0, e._tTime = l, c = e._pt; c; )
      c.r(r, c.d), c = c._next;
    t < 0 && gi(e, t, a, !0), e._onUpdate && !a && me(e, "onUpdate"), l && e._repeat && !a && e.parent && me(e, "onRepeat"), (t >= e._tDur || t < 0) && e.ratio === r && (r && at(e, 1), !a && !Z && (me(e, r ? "onComplete" : "onReverseComplete", !0), e._prom && e._prom()));
  ...
  return s && !i && (e._time *= r / e._dur), e._dur = r, e._tDur = n ? n < 0 ? 1e10 : V(r * (n + 1) + e._rDelay * n) : r, s > 0 && !i && La(e, e._tTime = e._tDur * s), e.parent && qa(e), a || ft(e.parent, e), e;
}, en = function(e) {
  return e instanceof re ? ft(e) : It(e, e._dur);
}, Xo = {
  _start: 0,
  endTime: Kt,
  totalDuration: Kt
}, _e = function o(e, t, a) {
  var i = e.labels, n = e._recent || Xo, r = e.duration() >= Ae ? n.endTime(!1) : e._dur, s, l, c;
  ...
  return !X(e) || !(t = Fo.exec(e)) ? "" : t[1];
}, Jo = function(e, t, a) {
  return rt(a, function(i) {
    return ia(e, t, i);
  });
}, fi = [].slice, xr = function(e, t) {
  return e && Le(e) && "length" in e && (!t && !e.length || e.length - 1 in e && Le(e[0])) && !e.nodeType && e !== Re;
}, Zo = function(e, t, a) {
  return a === void 0 && (a = []), e.forEach(function(i) {
    var n;
    return X(i) && !t || xr(i, 1) ? (n = a).push.apply(n, Se(i)) : a.push(i);
  }) || a;
}, Se = function(e, t, a) {
  return H && !t && H.selector ? H.selector(e) : X(e) && !a && (hi || !qt()) ? fi.call((t || Ri).querySelectorAll(e), 0) : ae(e) ? Zo(e, a) : xr(e) ? fi.call(e, 0) : e ? [e] : [];
}, wi = function(e) {
  return e = Se(e)[0] || jt("Invalid scope") || {}, function(t) {
    var a = e.current || e.nativeElement || e;
    return Se(t, a.querySelectorAll ? a : a === e ? jt("Invalid scope") || Ri.createElement("div") : e);
  };
}, vr = function(e) {
  ...
  return X(i) ? d = u = {
    ...
    var p = (m || t).length, w = r[p], y, b, x, _, v, T, A, k, C;
    if (!w) {
      if (C = t.grid === "auto" ? 0 : (t.grid || [1, Ae])[1], !C) {
        for (A = -Ae; A < (A = m[C++].getBoundingClientRect().left) && C < p; )
          ;
        C < p && C--;
      }
      for (w = r[p] = [], y = l ? Math.min(C, p) * d - 0.5 : i % C, b = C === Ae ? 0 : l ? p * u / C - 0.5 : i / C | 0, A = 0, k = Ae, T = 0; T < p; T++)
        x = T % C - y, _ = b - (T / C | 0), w[T] = v = c ? Math.abs(c === "y" ? _ : x) : nr(x * x + _ * _), v > A && (A = v), v < k && (k = v);
      i === "random" && vr(w), w.max = A - k, w.min = k, w.v = p = (parseFloat(t.amount) || parseFloat(t.each) * (C > p ? p - 1 : c ? c === "y" ? p / C : C : Math.max(C, p / C)) || 0) * (i === "edges" ? -1 : 1), w.b = p < 0 ? n - p : n, w.u = te(t.amount || t.each) || 0, a = a && p < 0 ? us(a) : a;
    }
  ...
  var a = ae(e), i, n;
  return !a && Le(e) && (i = a = e.radius || Ae, e.values ? (e = Se(e.values), (n = !Ve(e[0])) && (i *= i)) : e = bi(e.increment)), rt(t, a ? Y(e) ? function(r) {
  ...
  var i = t - e;
  return ae(e) ? Cr(e, o(0, e.length), t) : rt(a, function(n) {
    return (i + (n - e) % i) % i + e;
  });
}, is = function o(e, t, a) {
  var i = t - e, n = i * 2;
  return ae(e) ? Cr(e, o(0, e.length - 1), t) : rt(a, function(r) {
    return r = (n + (r - e) % n) % n || 0, e + (r > i ? n - r : r);
  });
}, Xt = function(e) {
  return e.replace(No, function(t) {
    var a = t.indexOf("[") + 1, i = t.substring(a || 7, a ? t.indexOf("]") : t.length - 1).split(Oo);
    return Sr(a ? i : +i[0], a ? 0 : +i[1], +i[2] || 1e-5);
  });
  ...
  if (!n) {
    ...
    if (!d) {
      for (l in t)
        Oi.call(s, e, l, "get", t[l]);
      n = function(m) {
        return Ui(m, s) || (r ? e.p : e);
      };
    }
  }
  return rt(a, n);
  ...
  if (n)
    return l = i[t + "Params"], c = i.callbackScope || e, a && et.length && Aa(), s && (H = s), d = l ? n.apply(c, l) : n.call(c), H = r, d;
}, Ut = function(e) {
  ...
  if (e)
    if (e = !e.name && e.default || e, Pi() || e.headless) {
      ...
      if (qt(), e !== i) {
        if (ue[t])
          return;
        ye(i, ye(Sa(e, n), r)), Rt(i.prototype, Rt(n, Sa(e, r))), ue[i.prop = t] = i, e.targetTest && (ba.push(i), Ii[t] = 1), t = (t === "css" ? "CSS" : t.charAt(0).toUpperCase() + t.substr(1)) + "Plugin";
      }
      dr(t, i), e.register && e.register(de, i, le);
    } else
      Tr.push(e);
}, O = 255, Ht = {
  aqua: [0, O, O],
  ...
  var i = e ? Ve(e) ? [e >> 16, e >> 8 & O, e & O] : 0 : Ht.black, n, r, s, l, c, d, u, h, g, m;
  if (!i) {
    if (e.substr(-1) === "," && (e = e.substr(0, e.length - 1)), Ht[e])
      ...
      if (i = m = e.match(Xi), !t)
        l = +i[0] % 360 / 360, c = +i[1] / 100, d = +i[2] / 100, r = d <= 0.5 ? d * (c + 1) : d + c - d * c, n = d * 2 - r, i.length > 3 && (i[3] *= 1), i[0] = Ha(l + 1 / 3, n, r), i[1] = Ha(l, n, r), i[2] = Ha(l - 1 / 3, n, r);
      else if (~e.indexOf("="))
        return i = e.match(or), a && i.length < 4 && (i[3] = 1), i;
    } else
      i = e.match(Xi) || Ht.transparent;
    i = i.map(Number);
  }
  ...
  if (n = n.map(function(h) {
    return (h = Mr(h, t, 1)) && r + (t ? h[0] + "," + h[1] + "%," + h[2] + "%," + h[3] : h.join(",")) + ")";
  }), a && (d = Pr(e), l = a.c, l.join(i) !== d.c.join(i)))
...
})(), rs = /hsl[a]?\(/, Rr = function(e) {
  var t = e.join(" "), a;
  if (tt.lastIndex = 0, tt.test(t))
    return a = rs.test(t), e[1] = an(e[1], a), e[0] = an(e[0], a, Pr(e[1])), !0;
}, Jt, ge = (function() {
  ...
  return u = {
    ...
    wake: function() {
      lr && (!hi && Pi() && (Re = hi = window, Ri = Re.document || {}, be.gsap = de, (Re.gsapVersions || (Re.gsapVersions = [])).push(de.version), cr(_a || Re.GreenSockGlobals || !Re.gsap && Re || {}), Tr.forEach(Er)), d = typeof requestAnimationFrame < "u" && requestAnimationFrame, l && u.sleep(), c = d || function(w) {
        return setTimeout(w, r - u.time * 1e3 + 1 | 0);
      }, Jt = 1, m(2));
    },
    sleep: function() {
      (d ? cancelAnimationFrame : clearTimeout)(l), Jt = 0, c = Kt;
    },
  ...
  return !Jt && ge.wake();
}, R = {}, os = /^[\d.\-M][\d.\-,\s]/, ss = /["']/g, ls = function(e) {
  for (var t = {}, a = e.substr(1, e.length - 3).split(":"), i = a[0], n = 1, r = a.length, s, l, c; n < r; n++)
    l = a[n], s = n !== r - 1 ? l.lastIndexOf(",") : l.length, c = l.substr(0, s), t[i] = isNaN(c) ? c.replace(ss, "").trim() : +c, i = l.substr(s + 1).trim();
  return t;
}, cs = function(e) {
  ...
  return a && t.length > 1 && a.config ? a.config.apply(null, ~e.indexOf("{") ? [ls(t[1])] : cs(e).split(",").map(gr)) : R._CE && os.test(e) ? R._CE("", e) : a;
}, us = function(e) {
  return function(t) {
    return 1 - e(1 - t);
  };
}, wt = function(e, t) {
  return e && (Y(e) ? e : R[e] || ds(e)) || t;
}, yt = function(e, t, a, i) {
  ...
  var i = t >= 1 ? t : 1, n = (a || (e ? 0.3 : 0.45)) / (t < 1 ? t : 1), r = n / ui * (Math.asin(1 / i) || 0), s = function(d) {
    return d === 1 ? 1 : i * Math.pow(2, -10 * d) * Lo((d - r) * n) + 1;
...
R.SteppedEase = R.steps = be.SteppedEase = {
  config: function(e, t) {
    ...
    return function(s) {
      return ((i * ia(0, r, s) | 0) + n) * a;
    };
  }
};
Qt.ease = R["quad.out"];
se("onComplete,onUpdate,onStart,onRepeat,onReverseComplete,onInterrupt", function(o) {
  return qi += o + "," + o + "Params,";
});
var Ir = function(e, t) {
  this.id = Io++, e._gsap = this, this.target = e, this.harness = t, this.get = t ? t.get : hr, this.set = t ? t.getSetter : zi;
}, Zt = /* @__PURE__ */ (function() {
  function o(t) {
    this.vars = t, this._delay = +t.delay || 0, (this._repeat = t.repeat === 1 / 0 ? -2 : t.repeat || 0) && (this._rDelay = t.repeatDelay || 0, this._yoyo = !!t.yoyo || !!t.yoyoEase), this._ts = 1, It(this, +t.duration, 1, 1), this.data = t.data, H && (this._ctx = H, H.data.push(this)), Jt || ge.wake();
  }
  var e = o.prototype;
  return e.delay = function(a) {
    ...
    return arguments.length ? (this._dirty = 0, It(this, this._repeat < 0 ? a : (a - this._repeat * this._rDelay) / (this._repeat + 1))) : this._tDur;
  }, e.totalTime = function(a, i) {
    if (qt(), !arguments.length)
      return this._tTime;
    var n = this._dp;
    if (n && n.smoothChildTiming && this._ts) {
      for (La(this, a), !n._dp || n.parent || wr(n, this); n && n.parent; )
        n.parent._time !== n._start + (n._ts >= 0 ? n._tTime / n._ts : (n.totalDuration() - n._tTime) / -n._ts) && n.totalTime(n._tTime, !0), n = n.parent;
      !this.parent && this._dp.autoRemoveChildren && (this._ts > 0 && a < this._tDur || this._ts < 0 && a > 0 || !this._tDur && !a) && De(this._dp, this, this._start - this._delay);
    }
    return (this._tTime !== a || !this._dur && !i || this._initted && Math.abs(this._zTime) === B || !this._initted && this._dur && a || !a && !this._initted && (this.add || this._ptLookup)) && (this._ts || (this._pTime = a), pr(this, a, i)), this;
  }, e.time = function(a, i) {
    return arguments.length ? this.totalTime(Math.min(this.totalDuration(), a + $i(this)) % (this._dur + this._rDelay) || (a ? this._dur : 0), i) : this._time;
    ...
    return arguments.length ? this.totalTime(this.duration() * (this._yoyo && !(this.iteration() & 1) ? 1 - a : a) + $i(this), i) : this.duration() ? Math.min(1, this._time / this._dur) : this.rawTime() > 0 ? 1 : 0;
  }, e.iteration = function(a, i) {
    var n = this.duration() + this._rDelay;
    return arguments.length ? this.totalTime(this._time + (a - 1) * n, i) : this._repeat ? Dt(this._tTime, n) + 1 : 1;
  }, e.timeScale = function(a, i) {
    if (!arguments.length)
      return this._rts === -B ? 0 : this._rts;
    if (this._rts === a)
      return this;
    var n = this.parent && this._ts ? Ca(this.parent._time, this) : this._tTime;
    return this._rts = +a || 0, this._ts = this._ps || a === -B ? 0 : this._rts, this.totalTime(ia(-Math.abs(this._delay), this.totalDuration(), n), i !== !1), qa(this), Wo(this);
  }, e.paused = function(a) {
    ...
    var i = this.parent || this._dp;
    return i ? a && (!this._ts || this._repeat && this._time && this.totalProgress() < 1) ? this._tTime % (this._dur + this._rDelay) : this._ts ? Ca(i.rawTime(a), this) : this._tTime : this._tTime;
  }, e.revert = function(a) {
    a === void 0 && (a = Uo);
    var i = Z;
    return Z = a, Ni(this) && (this.timeline && this.timeline.revert(a), this.totalTime(-0.01, a.suppressEvents)), this.data !== "nested" && a.kill !== !1 && this.kill(), Z = i, this;
    ...
    return arguments.length ? (this._repeat = a === 1 / 0 ? -2 : a, en(this)) : this._repeat === -2 ? 1 / 0 : this._repeat;
  }, e.repeatDelay = function(a) {
    if (arguments.length) {
      var i = this._time;
      return this._rDelay = a, en(this), i ? this.time(i) : this;
    }
    return this._rDelay;
  }, e.yoyo = function(a) {
...
var re = /* @__PURE__ */ (function(o) {
  ...
  function e(a, i) {
    var n;
    return a === void 0 && (a = {}), n = o.call(this, a) || this, n.labels = {}, n.smoothChildTiming = !!a.smoothChildTiming, n.autoRemoveChildren = !!a.autoRemoveChildren, n._sort = oe(a.sortChildren), G && De(a.parent || G, Be(n), i), a.reversed && n.reverse(), a.paused && n.paused(!0), a.scrollTrigger && br(Be(n), a.scrollTrigger), n;
  }
  var t = e.prototype;
  return t.to = function(i, n, r) {
    ...
    return De(this, K.delayedCall(0, i, n), r);
    ...
    if (this !== G && d > l && i >= 0 && (d = l), d !== this._tTime || r || u) {
      if (s !== this._time && c && (d += this._time - s, i += this._time - s), h = d, _ = this._start, x = this._ts, y = !x, u && (c || (s = this._zTime), (i || !n) && (this._zTime = i)), this._repeat) {
        ...
        if (h = V(d % w), d === l ? (p = this._repeat, h = c) : (v = V(d / w), p = ~~v, p && p === v && (h = c, p--), h > c && (h = c)), v = Dt(this._tTime, w), !s && this._tTime && v !== p && this._tTime - v * w - this._dur <= 0 && (v = p), T && p & 1 && (h = c - h, A = 1), p !== v && !this._lock) {
          var k = T && v & 1, C = k === (T && p & 1);
          if (p < v && (k = !k), s = k ? 0 : d % c ? c : d, this._lock = 1, this.render(s || (A ? 0 : V(p * w)), n, !c)._lock = 0, this._tTime = d, !n && this.parent && me(this, "onRepeat"), this.vars.repeatRefresh && !A && (this.invalidate()._lock = 1, v = p), s && s !== this._time || y !== !this._ts || this.vars.onRepeat && !this.parent && !this._act)
            return this;
          if (c = this._dur, l = this._tDur, C && (this._lock = 2, s = k ? c : -1e-4, this.render(s, !0), this.vars.repeatRefresh && !A && this.invalidate()), this._lock = 0, !this._ts && !y)
            return this;
        }
      }
      if (this._hasPause && !this._forcing && this._lock < 2 && (b = Ko(this, V(s), V(h)), b && (d -= h - (h = b._start))), this._tTime = d, this._time = h, this._act = !!x, this._initted || (this._onUpdate = this.vars.onUpdate, this._initted = 1, this._zTime = i, s = 0), !s && d && c && !n && !v && (me(this, "onStart"), this._tTime !== d))
        return this;
      if (h >= s && i >= 0)
        for (g = this._first; g; ) {
        ...
        for (var M = i < 0 ? i : h; g; ) {
          if (m = g._prev, (g._act || M <= g._end) && g._ts && b !== g) {
            if (g.parent !== this)
              return this.render(i, n, r);
            if (g.render(g._ts > 0 ? (M - g._start) * g._ts : (g._dirty ? g.totalDuration() : g._tDur) + (M - g._start) * g._ts, n, r || Z && Ni(g)), h !== this._time || !this._ts && !y) {
      ...
      if (b && !n && (this.pause(), b.render(h >= s ? 0 : -B)._zTime = h >= s ? 1 : -1, this._ts))
        return this._start = _, qa(this), this.render(i, n, r);
    ...
    var r = this;
    if (Ve(n) || (n = _e(this, n, i)), !(i instanceof Zt)) {
      if (ae(i))
    ...
    return this !== i ? De(this, i, n) : this;
    ...
    return arguments.length ? (this._forcing = 1, !this._dp && this._ts && (this._start = V(ge.time - (this._ts > 0 ? i / this._ts : (this.totalDuration() - i) / -this._ts))), o.prototype.totalTime.call(this, i, n), this._forcing = 0, this) : this._tTime;
  }, t.addLabel = function(i, n) {
    return this.labels[i] = _e(this, n), this;
  }, t.removeLabel = function(i) {
    return delete this.labels[i], this;
  }, t.addPause = function(i, n, r) {
    var s = K.delayedCall(0, n || Kt, r);
    return s.data = "isPause", this._hasPause = 1, De(this, s, _e(this, i));
    ...
    for (var r = [], s = Se(i), l = this._first, c = Ve(n), d; l; )
      l instanceof K ? Ho(l._targets, s) && (c ? (!Ke || l._initted && l._ts) && l.globalTime(0) <= n && l.globalTime(l.totalDuration()) > n : !n || l.isActive()) && r.push(l) : (d = l.getTweensOf(s, n)).length && r.push.apply(r, d), l = l._next;
    return r;
    ...
    var r = this, s = _e(r, i), l = n, c = l.startAt, d = l.onStart, u = l.onStartParams, h = l.immediateRender, g, m = K.to(r, ye({
      ...
      onStart: function() {
        if (r.pause(), !g) {
          ...
          m._dur !== w && It(m, w, 0, 1).render(m._time, !0, !0), g = 1;
        }
        d && d.apply(m, u || []);
      }
    }, n));
    ...
    return i === void 0 && (i = this._time), tn(this, _e(this, i));
  }, t.previousLabel = function(i) {
    return i === void 0 && (i = this._time), tn(this, _e(this, i), 1);
    ...
    if (r._dirty) {
      for (u = r.parent; s; )
        c = s._prev, s._dirty && s.totalDuration(), d = s._start, d > l && r._sort && s._ts && !r._lock ? (r._lock = 1, De(r, s, d - s._delay, 1)._lock = 0) : l = d, d < 0 && s._ts && (n -= d, (!u && !r._dp || u && u.smoothChildTiming) && (r._start += V(d / r._ts), r._time -= d, r._tTime -= d), r.shiftChildren(-d, !1, -1 / 0), l = 0), s._end > n && s._ts && (n = s._end), s = c;
      It(r, r === G && r._time > n ? r._time : n, 1, 1), r._dirty = 0;
    }
    return r._tDur;
  }, e.updateRoot = function(i) {
    if (G._ts && (pr(G, Ca(i, G)), ur = ge.frame), ge.frame >= Ji) {
      Ji += we.autoSleep || 120;
      var n = G._first;
...
var hs = function(e, t, a, i, n, r, s) {
  var l = new le(this._pt, e, t, 0, 1, Fr, null, n), c = 0, d = 0, u, h, g, m, p, w, y, b;
  for (l.b = a, l.e = i, a += "", i += "", (y = ~i.indexOf("random(")) && (i = Xt(i)), r && (b = [a, i], r(b, e, t), a = b[0], i = b[1]), h = a.match(za) || []; u = za.exec(i); )
    m = u[0], p = i.substring(c, u.index), g ? g = (g + 1) % 5 : p.substr(-5) === "rgba(" && (g = 1), m !== h[d++] && (w = parseFloat(h[d - 1]) || 0, l._pt = {
      ...
      s: w,
      c: m.charAt(1) === "=" ? kt(w, m) - w : parseFloat(m) - w,
      m: g && g < 4 ? Math.round : 0
    }, c = za.lastIndex);
  return l.c = c < i.length ? i.substring(c, i.length) : "", l.fp = s, (sr.test(i) || y) && (l.e = 0), this._pt = l, l;
}, Oi = function(e, t, a, i, n, r, s, l, c, d) {
  Y(i) && (i = i(n || 0, e, r));
  var u = e[t], h = a !== "get" ? a : Y(u) ? c ? e[t.indexOf("set") || !Y(e["get" + t.substr(3)]) ? t : "get" + t.substr(3)](c) : e[t]() : u, g = Y(u) ? c ? ws : Or : Fi, m;
  if (X(i) && (~i.indexOf("random(") && (i = Xt(i)), i.charAt(1) === "=" && (m = kt(h, i) + (te(h) || 0), (m || m === 0) && (i = m))), !d || h !== i || yi)
    return !isNaN(h * i) && i !== "" ? (m = new le(this._pt, e, t, +h || 0, i - (h || 0), typeof u == "boolean" ? ys : Br, 0, g), c && (m.fp = c), s && m.modifier(s, this, e), this._pt = m) : (!u && !(t in e) && Di(t, i), hs.call(this, e, t, h, i, g, l || we.stringFilter, c));
}, ps = function(e, t, a, i, n) {
  if (Y(e) && (e = Yt(e, n, t, a, i)), !Le(e) || e.style && e.nodeType || ae(e) || rr(e))
    return X(e) ? Yt(e, n, t, a, i) : e;
  var r = {}, s;
  for (s in e)
    r[s] = Yt(e[s], n, t, a, i);
  return r;
}, qr = function(e, t, a, i, n, r) {
  var s, l, c, d;
  if (ue[e] && (s = new ue[e]()).init(n, s.rawVars ? t[e] : ps(t[e], i, n, r, a), a, i, r) !== !1 && (a._pt = l = new le(a._pt, n, e, 0, 1, s.render, s, 0, s.priority), a !== St))
    for (c = a._ptLookup[a._targets.indexOf(n)], d = s._props.length; d--; )
      c[s._props[d]] = l;
  return s;
}, Ke, yi, Bi = function o(e, t, a) {
  var i = e.vars, n = i.ease, r = i.startAt, s = i.immediateRender, l = i.lazy, c = i.onUpdate, d = i.runBackwards, u = i.yoyoEase, h = i.keyframes, g = i.autoRevert, m = e._dur, p = e._startAt, w = e._targets, y = e.parent, b = y && y.data === "nested" ? y.vars.targets : w, x = e._overwrite === "auto" && !Ei, _ = e.timeline, v = i.easeReverse || u, T, A, k, C, M, F, z, L, U, D, I, P, $;
  if (_ && (!h || !n) && (n = "none"), e._ease = wt(n, Qt.ease), e._rEase = v && (wt(v) || e._ease), e._from = !_ && !!i.runBackwards, e._from && (e.ratio = 1), !_ || h && !i.stagger) {
    if (L = w[0] ? mt(w[0]).harness : 0, P = L && i[L.prop], T = Sa(i, Ii), p && (p._zTime < 0 && p.progress(1), t < 0 && d && s && !g ? p.render(-1, !0) : p.revert(d && m ? wa : zo), p._lazy = 0), r) {
      if (at(e._startAt = K.set(w, ye({
        ...
        stagger: 0
      }, r))), e._startAt._dp = 0, e._startAt._sat = e, t < 0 && (Z || !s && !g) && e._startAt.revert(wa), s && m && t <= 0 && a <= 0) {
        t && (e._zTime = t);
        return;
      }
    } else if (d && m && !p) {
      ...
      }, T), P && (k[L.prop] = P), at(e._startAt = K.set(w, k)), e._startAt._dp = 0, e._startAt._sat = e, t < 0 && (Z ? e._startAt.revert(wa) : e._startAt.render(-1, !0)), e._zTime = t, !s)
        o(e._startAt, B, B);
      else if (!t)
        return;
    }
    for (e._pt = e._ptCache = 0, l = m && oe(l) || l && !m, A = 0; A < w.length; A++) {
      if (M = w[A], z = M._gsap || Li(w)[A]._gsap, e._ptLookup[A] = D = {}, pi[z.id] && et.length && Aa(), I = b === w ? A : b.indexOf(M), L && (U = new L()).init(M, P || T, e, I, b) !== !1 && (e._pt = C = new le(e._pt, M, U.name, 0, 1, U.render, U, 0, U.priority), U._props.forEach(function(Te) {
        D[Te] = C;
      }), U.priority && (F = 1)), !L || P)
        for (k in T)
          ue[k] && (U = qr(k, T, e, I, M, b)) ? U.priority && (F = 1) : D[k] = C = Oi.call(e, M, k, "get", T[k], I, b, 0, i.stringFilter);
      e._op && e._op[A] && e.kill(M, e._op[A]), x && e._pt && (Ke = e, G.killTweensOf(M, D, e.globalTime(t)), $ = !e.parent, Ke = 0), e._pt && l && (pi[z.id] = 1);
    }
    F && zr(e), e._onInit && e._onInit(e);
  }
  e._onUpdate = c, e._initted = (!e._op || e._pt) && !$, h && t <= 0 && _.render(Ae, !0, !0);
}, gs = function(e, t, a, i, n, r, s, l) {
    ...
    for (c = e._ptCache[t] = [], h = e._ptLookup, g = e._targets.length; g--; ) {
      if (d = h[g][t], d && d.d && d.d._pt)
        for (d = d.d._pt; d && d.p !== t && d.fp !== t; )
          d = d._next;
      if (!d)
        return yi = 1, e.vars[t] = "+=0", Bi(e, s), yi = 0, l ? jt(t + " not eligible for reset. Try splitting into individual properties") : 1;
      c.push(d);
    }
  for (g = c.length; g--; )
...
}, Yt = function(e, t, a, i, n) {
  return Y(e) ? e.call(t, a, i, n) : X(e) && ~e.indexOf("random(") ? Xt(e) : e;
}, Lr = qi + "repeat,repeatDelay,yoyo,repeatRefresh,yoyoEase,easeReverse,autoRevert", Nr = {};
se(Lr + ",id,stagger,delay,duration,paused,scrollTrigger", function(o) {
  return Nr[o] = 1;
});
var K = /* @__PURE__ */ (function(o) {
  ...
  function e(a, i, n, r) {
    ...
    var l = s.vars, c = l.duration, d = l.delay, u = l.immediateRender, h = l.stagger, g = l.overwrite, m = l.keyframes, p = l.defaults, w = l.scrollTrigger, y = i.parent || G, b = (ae(a) || rr(a) ? Ve(a[0]) : "length" in i) ? [a] : Se(a), x, _, v, T, A, k, C, M;
    if (s._targets = b.length ? Li(b) : jt("GSAP target " + a + " not found. https://gsap.com", !we.nullTargetWarn) || [], s._ptLookup = [], s._overwrite = g, m || h || oa(c) || oa(d)) {
      i = s.vars;
      ...
      if (x = s.timeline = new re({
      ...
      }), x.kill(), x.parent = x._dp = Be(s), x._start = 0, h || oa(c) || oa(d)) {
        if (T = b.length, C = h && _r(h), Le(h))
          for (A in h)
            ~Lr.indexOf(A) && (M || (M = {}), M[A] = h[A]);
        for (_ = 0; _ < T; _++)
          v = Sa(i, Nr), v.stagger = 0, F && (v.easeReverse = F), M && Rt(v, M), k = b[_], v.duration = +Yt(c, Be(s), _, k, b), v.delay = (+Yt(d, Be(s), _, k, b) || 0) - s._delay, !h && T === 1 && v.delay && (s._delay = d = v.delay, s._start += d, v.delay = 0), x.to(k, v, C ? C(_, k, b) : 0), x._ease = R.none;
        ...
        if (ae(m))
          ...
          v = {};
          for (A in m)
            A === "ease" || A === "easeEach" || fs(A, m[A], v, m.easeEach);
          for (A in v)
            for (L = v[A].sort(function(I, P) {
              return I.t - P.t;
      ...
      s.timeline = 0;
    return g === !0 && !Ei && (Ke = Be(s), G.killTweensOf(b), Ke = 0), De(y, Be(s), n), i.reversed && s.reverse(), i.paused && s.paused(!0), (u || !c && !m && s._start === V(y._time) && oe(u) && Yo(Be(s)) && y.data !== "nested") && (s._tTime = -B, s.render(Math.max(0, -d) || 0)), w && br(Be(s), w), s;
  }
  var t = e.prototype;
  return t.render = function(i, n, r) {
    ...
    if (!c)
      ...
      if (h = u, x = this.timeline, this._repeat) {
        ...
        if (h = V(u % p), u === l ? (m = this._repeat, h = c) : (w = V(u / p), m = ~~w, m && m === w ? (h = c, m--) : h > c && (h = c)), y = this._yoyo && m & 1, y && (h = c - h), w = Dt(this._tTime, p), h === s && !r && this._initted && m === w)
      ...
      for (g = this._pt; g; )
        g.r(b, g.d), g = g._next;
      x && x.render(i < 0 ? i : x._dur * x._ease(h / this._dur), n, r) || this._startAt && (this._zTime = i), this._onUpdate && !n && (d && gi(this, i, n, r), me(this, "onUpdate")), this._repeat && m !== w && this.vars.onRepeat && !n && this.parent && me(this, "onRepeat"), (u === this._tDur || !u) && this._tTime === u && (d && !this._onUpdate && gi(this, i, !0, !0), (i || !c) && (u === this._tDur && this._ts > 0 || !u && this._ts < 0) && at(this, 1), !n && !(d && !s) && (u || s || y) && (me(this, u === l ? "onComplete" : "onReverseComplete", !0), this._prom && !(u < l && this.timeScale() > 0) && this._prom()));
    }
    return this;
  }, t.targets = function() {
    ...
    Jt || ge.wake(), this._ts || this.play();
    var c = Math.min(this._dur, (this._dp._time - this._start) * this._ts), d;
    return this._initted || Bi(this, c), d = this._ease(c / this._dur), gs(this, i, n, r, s, d, c, l) ? this.resetTo(i, n, r, s, 1) : (La(this, 0), this.parent || fr(this._dp, this, "_first", "_last", this._dp._sort ? "_start" : 0), this.render(0));
  }, t.kill = function(i, n) {
    if (n === void 0 && (n = "all"), !i && (!n || n === "all"))
      return this._lazy = this._pt = 0, this.parent ? Ut(this) : this.scrollTrigger && this.scrollTrigger.kill(!!Z), this;
    if (this.timeline) {
      var r = this.timeline.totalDuration();
      return this.timeline.killTweensOf(i, n, Ke && Ke.vars.overwrite !== !0)._first || Ut(this), this.parent && r !== this.timeline.totalDuration() && It(this, this._dur * this.timeline._tDur / r, 0, 1), this;
    }
    var s = this._targets, l = i ? Se(i) : s, c = this._ptLookup, d = this._pt, u, h, g, m, p, w, y;
    if ((!n || n === "all") && Go(s, l))
      return n === "all" && (this._pt = 0), Ut(this);
    for (u = this._op = this._op || [], n !== "all" && (X(n) && (p = {}, se(n, function(b) {
      return p[b] = 1;
    }), n = p), n = ms(s, n)), y = s.length; y--; )
      if (~l.indexOf(s[y])) {
        h = c[y], n === "all" ? (u[y] = n, m = h, g = {}) : (g = u[y] = u[y] || {}, m = n);
        for (p in m)
          w = h && h[p], w && ((!("kill" in w.d) || w.d.kill(p) === !0) && Ia(this, w, "_pt"), delete h[p]), g !== "all" && (g[p] = 1);
      }
    return this._initted && !this._pt && d && Ut(this), this;
  }, e.to = function(i, n) {
...
var Fi = function(e, t, a) {
  ...
  return Y(e[t]) ? Or : Mi(e[t]) && e.setAttribute ? bs : Fi;
}, Br = function(e, t) {
  ...
  function o(t, a, i, n, r, s, l, c, d) {
    this.t = a, this.s = n, this.c = r, this.p = i, this.r = s || Br, this.d = l || this, this.set = c || Fi, this.pr = d || 0, this._next = t, t && (t._prev = this);
  }
  var e = o.prototype;
  return e.modifier = function(a, i, n) {
    this.mSet = this.mSet || this.set, this.set = _s, this.m = a, this.mt = n, this.tween = i;
  }, o;
})();
se(qi + "parent,duration,ease,delay,overwrite,runBackwards,startAt,yoyo,immediateRender,repeat,repeatDelay,data,paused,reversed,lazy,callbackScope,stringFilter,id,yoyoEase,stagger,inherit,repeatRefresh,keyframes,autoRevert,scrollTrigger,easeReverse", function(o) {
  return Ii[o] = 1;
});
...
we.stringFilter = Rr;
var bt = [], ya = {}, As = [], nn = 0, Ss = 0, Wa = function(e) {
  return (ya[e] || As).map(function(t) {
    return t();
  });
}, xi = function() {
  var e = Date.now(), t = [];
  e - nn > 2 && (Wa("matchMediaInit"), bt.forEach(function(a) {
    var i = a.queries, n = a.conditions, r, s, l, c;
    for (s in i)
      r = Re.matchMedia(i[s]).matches, r && (l = 1), r !== n[s] && (n[s] = r, c = 1);
    c && (a.revert(), l && t.push(a));
  }), Wa("matchMediaRevert"), t.forEach(function(a) {
  ...
  function o(t, a) {
    this.selector = a && wi(a), this.data = [], this._r = [], this.isReverted = !1, this.id = Ss++, t && this.add(t);
  }
  var e = o.prototype;
  return e.add = function(a, i, n) {
    ...
    var r = this, s = function() {
      ...
      return c && c !== r && c.data.push(r), n && (r.selector = wi(n)), H = r, u = i.apply(r, arguments), Y(u) && r._r.push(u), H = c, r.selector = d, r.isReverted = !1, u;
    };
  ...
  return e.add = function(a, i, n) {
    ...
    var r = new Ur(0, n || this.scope), s = r.conditions = {}, l, c, d;
    H && !r.selector && (r.selector = H.selector), this.contexts.push(r), i = r.add("onMatch", i), r.queries = a;
    for (c in a)
      c === "all" ? d = 1 : (l = Re.matchMedia(a[c]), l && (bt.indexOf(r) < 0 && bt.push(r), (s[c] = l.matches) && (d = 1), l.addListener ? l.addListener(xi) : l.addEventListener("change", xi)));
  ...
  quickSetter: function(e, t, a) {
    ...
    var r = ue[t], s = mt(e), l = s.harness && (s.harness.aliases || {})[t] || t, c = r ? function(d) {
      var u = new r();
      St._pt = 0, u.init(e, a ? d + a : d, St, 0, [e]), u.render(1, u), St._pt && Ui(1, St);
    } : s.set(e, l);
  ...
  defaults: function(e) {
    return e && e.ease && (e.ease = wt(e.ease, Qt.ease)), Zi(Qt, e || {});
  },
  config: function(e) {
    return Zi(we, e || {});
  },
  registerEffect: function(e) {
    ...
    (i || "").split(",").forEach(function(s) {
      return s && !ue[s] && !be[s] && jt(t + " effect requires " + s + " plugin.");
    }), Ua[t] = function(s, l, c) {
      return a(Se(s), ye(l || {}, n), c);
    }, r && (re.prototype[t] = function(s, l, c) {
      return this.add(Ua[t](s, Le(l) ? l : (c = l) && {}, this), c);
    });
  },
  ...
  exportRoot: function(e, t) {
    ...
    for (a.smoothChildTiming = oe(e.smoothChildTiming), G.remove(a), a._dp = 0, a._time = a._tTime = G._time, i = G._first; i; )
      n = i._next, (t || !(!i._dur && i instanceof K && i.vars.onComplete === i._targets[0])) && De(a, i, i._start - i._delay), i = n;
    return De(G, a, 0), a;
  },
  context: function(e, t) {
    return e ? new Ur(e, t) : H;
  },
...
var ks = function(e, t) {
  ...
  for (i in t)
    for (n = a.length; n--; )
      r = e._ptLookup[n][i], r && (r = r.d) && (r._pt && (r = ks(r, i)), r && r.modifier && r.modifier(t[i], e, a[n], i));
}, Ya = function(e, t) {
  return {
    name: e,
    headless: 1,
...
}, Ya("roundProps", bi), Ya("modifiers"), Ya("snap", Ar)) || ka;
...
R.Expo;
R.Circ;
var rn, Xe, Tt, Hi, gt, on, Vi, Es = function() {
  return typeof window < "u";
}, Ge = {}, pt = 180 / Math.PI, Et = Math.PI / 180, xt = Math.atan2, sn = 1e8, Gi = /([A-Z])/g, Ms = /(left|right|width|margin|padding|x)/i, Ps = /[\s,\(]\S/, qe = {
  ...
  if (this.tfm) {
    for (r in this.tfm)
      i[r] = this.tfm[r];
    i.svg && (i.renderTransform(), t.setAttribute("data-svg-origin", this.svgo || "")), n = Vi(), (!n || !n.isStart) && !a[W] && (Gr(a), i.zOrigin && a[ce] && (a[ce] += " " + i.zOrigin + "px", i.zOrigin = 0, i.renderTransform()), i.uncache = 1);
  }
}, Wr = function(e, t) {
  var a = {
    target: e,
...
}, ln = "O,Moz,ms,Ms,Webkit".split(","), Lt = function(e, t, a) {
  var i = t || gt, n = i.style, r = 5;
  if (e in n && !a)
    return e;
  for (e = e.charAt(0).toUpperCase() + e.substr(1); r-- && !(ln[r] + e in n); )
    ;
  return r < 0 ? null : (r === 3 ? "ms" : r >= 0 ? ln[r] : "") + e;
}, Ai = function() {
  Es() && window.document && (rn = window, Xe = rn.document, Tt = Xe.documentElement, gt = _i("div") || {
    style: {}
  }, _i("div"), W = Lt(W), ce = W + "Origin", gt.style.cssText = "border-width:0;line-height:0;position:absolute;padding:0", Yr = !!Lt("perspective"), Vi = de.core.reverting, Hi = 1);
}, cn = function(e) {
  ...
  return t && (t.width || t.height) || a || (t = cn(e)), t && !t.width && !t.x && !t.y ? {
    x: +dn(e, ["x", "cx", "x1"]) || 0,
    y: +dn(e, ["y", "cy", "y1"]) || 0,
    width: 0,
    height: 0
  ...
  if (t) {
    var a = e.style, i;
    t in Ge && t !== ce && (t = W), a.removeProperty ? (i = t.substr(0, 2), (i === "ms" || t.substr(0, 6) === "webkit") && (t = "-" + t), a.removeProperty(i === "--" ? t : t.replace(Gi, "-$1").toLowerCase())) : a.removeAttribute(t);
  }
}, Je = function(e, t, a, i, n, r) {
  var s = new le(e._pt, t, a, 0, 1, r ? Vr : Hr);
  ...
  var n = parseFloat(a) || 0, r = (a + "").trim().substr((n + "").length) || "px", s = gt.style, l = Ms.test(t), c = e.tagName.toLowerCase() === "svg", d = (c ? "client" : "offset") + (l ? "Width" : "Height"), u = 100, h = i === "px", g = i === "%", m, p, w, y;
  if (i === r || !n || un[i] || un[r])
    return n;
  if (r !== "px" && !h && (n = o(e, t, a, "px")), y = e.getCTM && jr(e), (g || r === "%") && (Ge[t] || ~t.indexOf("adius")))
  ...
  if (g && (t === "height" || t === "width")) {
    ...
    (g || r === "%") && !Vs[fe(p, "display")] && (s.position = fe(e, "position")), p === e && (s.position = "static"), p.appendChild(gt), m = gt[d], p.removeChild(gt), s.position = "absolute";
  return l && g && (w = mt(p), w.time = ge.time, w.width = p[d]), Q(h ? m * n / u : m && n ? u / m * n : 0);
}, ze = function(e, t, a, i) {
  var n;
  return Hi || Ai(), t in qe && t !== "transform" && (t = qe[t], ~t.indexOf(",") && (t = t.split(",")[0])), Ge[t] && t !== "transform" ? (n = ea(e, i), n = t !== "transformOrigin" ? n[t] : n.svg ? n.origin : Ea(fe(e, ce)) + " " + n.zOrigin + "px") : (n = e.style[t], (!n || n === "auto" || i || ~(n + "").indexOf("calc(")) && (n = Ta[t] && Ta[t](e, t, a) || fe(e, t) || hr(e, t) || (t === "opacity" ? 1 : 0))), a && !~(n + "").trim().indexOf(" ") ? nt(e, t, n, a) + a : n;
}, Gs = function(e, t, a, i) {
  if (!a || a === "none") {
    var n = Lt(t, e, 1), r = n && fe(e, n, 1);
    r && r !== a ? (t = n, a = r) : t === "borderColor" && (a = fe(e, "borderTopColor"));
  }
  var s = new le(this._pt, e.style, t, 0, 1, Fr), l = 0, c = 0, d, u, h, g, m, p, w, y, b, x, _, v;
  if (s.b = a, s.e = i, a += "", i += "", i.substring(0, 6) === "var(--" && (i = fe(e, i.substring(4, i.indexOf(")")))), i === "auto" && (p = e.style[t], e.style[t] = i, i = fe(e, t) || i, p ? e.style[t] = p : it(e, t)), d = [a, i], Rr(d), a = d[0], i = d[1], h = a.match(At) || [], v = i.match(At) || [], v.length) {
    for (; u = At.exec(i); )
      w = u[0], b = i.substring(l, u.index), m ? m = (m + 1) % 5 : (b.substr(-5) === "rgba(" || b.substr(-5) === "hsla(") && (m = 1), w !== (p = h[c++] || "") && (g = parseFloat(p) || 0, _ = p.substr((g + "").length), w.charAt(1) === "=" && (w = kt(g, w) + _), y = parseFloat(w), x = w.substr((y + "").length), l = At.lastIndex - x.length, x || (x = x || we.units[t] || _, l === i.length && (i += x, s.e += x)), _ !== x && (g = nt(e, t, p, x) || 0), s._pt = {
        _next: s._pt,
        p: b || c === 1 ? b : ",",
        //note: SVG spec allows omission of comma/space when a negative sign is wedged between two numbers, like 2.5-5.3 instead of 2.5,-5.3 but when tweening, the negative value may switch to positive, so we insert the comma just in case.
        s: g,
    ...
    s.r = t === "display" && i === "none" ? Vr : Hr;
  return sr.test(i) && (s.e = 0), this._pt = s, s;
}, hn = {
  top: "0%",
  bottom: "100%",
  left: "0%",
  ...
  return (a === "top" || a === "bottom" || i === "left" || i === "right") && (e = a, a = i, i = e), t[0] = hn[a] || a, t[1] = hn[i] || i, t.join(" ");
}, Ys = function(e, t) {
  if (t.tween && t.tween._time === t.tween._dur) {
    ...
    if (n === "all" || n === !0)
      ...
      for (n = n.split(","), c = n.length; --c > -1; )
        s = n[c], Ge[s] && (l = 1, s = s === "transformOrigin" ? ce : W), it(a, s);
    l && (it(a, W), r && (r.svg && a.removeAttribute("transform"), i.scale = i.rotate = i.translate = "none", ea(a, 1), r.uncache = 1, Gr(i)));
  }
}, Ta = {
  clearProps: function(e, t, a, i, n) {
    if (n.data !== "isFromStart") {
      var r = e._pt = new le(e._pt, t, a, 0, 0, Ys);
  ...
  */
}, $t = [1, 0, 0, 1, 0, 0], Kr = {}, Xr = function(e) {
  return e === "matrix(1, 0, 0, 1, 0, 0)" || e === "none" || !e;
}, pn = function(e) {
  var t = fe(e, W);
  return Xr(t) ? $t : t.substr(7).match(or).map(Q);
}, Wi = function(e, t) {
  var a = e._gsap || mt(e), i = e.style, n = pn(e), r, s, l, c;
  return a.svg && e.getAttribute("transform") ? (l = e.transform.baseVal.consolidate().matrix, n = [l.a, l.b, l.c, l.d, l.e, l.f], n.join(",") === "1,0,0,1,0,0" ? $t : n) : (n === $t && !e.offsetParent && e !== Tt && !a.svg && (l = i.display, i.display = "block", r = e.parentNode, (!r || !e.offsetParent && !e.getBoundingClientRect().width) && (c = 1, s = e.nextElementSibling, Tt.appendChild(e)), n = pn(e), l ? i.display = l : it(e, "display"), c && (s ? r.insertBefore(e, s) : r ? r.appendChild(e) : Tt.removeChild(e))), t && n.length > 6 ? [n[0], n[1], n[4], n[5], n[12], n[13]] : n);
}, Si = function(e, t, a, i, n, r) {
  var s = e._gsap, l = n || Wi(e, !0), c = s.xOrigin || 0, d = s.yOrigin || 0, u = s.xOffset || 0, h = s.yOffset || 0, g = l[0], m = l[1], p = l[2], w = l[3], y = l[4], b = l[5], x = t.split(" "), _ = parseFloat(x[0]) || 0, v = parseFloat(x[1]) || 0, T, A, k, C;
  a ? l !== $t && (A = g * w - m * p) && (k = _ * (w / A) + v * (-p / A) + (p * b - w * y) / A, C = _ * (-m / A) + v * (g / A) - (g * b - m * y) / A, _ = k, v = C) : (T = Qr(e), _ = T.x + (~x[0].indexOf("%") ? _ / 100 * T.width : _), v = T.y + (~(x[1] || x[0]).indexOf("%") ? v / 100 * T.height : v)), i || i !== !1 && s.smooth ? (y = _ - c, b = v - d, s.xOffset = u + (y * g + b * p) - y, s.yOffset = h + (y * m + b * w) - b) : s.xOffset = s.yOffset = 0, s.xOrigin = _, s.yOrigin = v, s.smooth = !!i, s.origin = t, s.originIsAbsolute = !!a, e.style[ce] = "0px 0px", r && (Je(r, s, "xOrigin", c, _), Je(r, s, "yOrigin", d, v), Je(r, s, "xOffset", u, s.xOffset), Je(r, s, "yOffset", h, s.yOffset)), e.setAttribute("data-svg-origin", _ + " " + v);
}, ea = function(e, t) {
  var a = e._gsap || new Ir(e);
  if ("x" in a && !t && !a.uncache)
    return a;
  var i = e.style, n = a.scaleX < 0, r = "px", s = "deg", l = getComputedStyle(e), c = fe(e, ce) || "0", d, u, h, g, m, p, w, y, b, x, _, v, T, A, k, C, M, F, z, L, U, D, I, P, $, Te, We, ke, ot, Ki, Ne, st;
  return d = u = h = p = w = y = b = x = _ = 0, g = m = 1, a.svg = !!(e.getCTM && jr(e)), l.translate && ((l.translate !== "none" || l.scale !== "none" || l.rotate !== "none") && (i[W] = (l.translate !== "none" ? "translate3d(" + (l.translate + " 0 0").split(" ").slice(0, 3).join(", ") + ") " : "") + (l.rotate !== "none" ? "rotate(" + l.rotate + ") " : "") + (l.scale !== "none" ? "scale(" + l.scale.split(" ").join(",") + ") " : "") + (l[W] !== "none" ? l[W] : "")), i.scale = i.rotate = i.translate = "none"), A = Wi(e, a.svg), a.svg && (a.uncache ? ($ = e.getBBox(), c = a.xOrigin - $.x + "px " + (a.yOrigin - $.y) + "px", P = "") : P = !t && e.getAttribute("data-svg-origin"), Si(e, P || c, !!P || a.originIsAbsolute, a.smooth !== !1, A)), v = a.xOrigin || 0, T = a.yOrigin || 0, A !== $t && (F = A[0], z = A[1], L = A[2], U = A[3], d = D = A[4], u = I = A[5], A.length === 6 ? (g = Math.sqrt(F * F + z * z), m = Math.sqrt(U * U + L * L), p = F || z ? xt(z, F) * pt : 0, b = L || U ? xt(L, U) * pt + p : 0, b && (m *= Math.abs(Math.cos(b * Et))), a.svg && (d -= v - (v * F + T * L), u -= T - (v * z + T * U))) : (st = A[6], Ki = A[7], We = A[8], ke = A[9], ot = A[10], Ne = A[11], d = A[12], u = A[13], h = A[14], k = xt(st, ot), w = k * pt, k && (C = Math.cos(-k), M = Math.sin(-k), P = D * C + We * M, $ = I * C + ke * M, Te = st * C + ot * M, We = D * -M + We * C, ke = I * -M + ke * C, ot = st * -M + ot * C, Ne = Ki * -M + Ne * C, D = P, I = $, st = Te), k = xt(-L, ot), y = k * pt, k && (C = Math.cos(-k), M = Math.sin(-k), P = F * C - We * M, $ = z * C - ke * M, Te = L * C - ot * M, Ne = U * M + Ne * C, F = P, z = $, L = Te), k = xt(z, F), p = k * pt, k && (C = Math.cos(k), M = Math.sin(k), P = F * C + z * M, $ = D * C + I * M, z = z * C - F * M, I = I * C - D * M, F = P, D = $), w && Math.abs(w) + Math.abs(p) > 359.9 && (w = p = 0, y = 180 - y), g = Q(Math.sqrt(F * F + z * z + L * L)), m = Q(Math.sqrt(I * I + st * st)), k = xt(D, I), b = Math.abs(k) > 2e-4 ? k * pt : 0, _ = Ne ? 1 / (Ne < 0 ? -Ne : Ne) : 0), a.svg && (P = e.getAttribute("transform"), a.forceCSS = e.setAttribute("transform", "") || !Xr(fe(e, W)), P && e.setAttribute("transform", P))), Math.abs(b) > 90 && Math.abs(b) < 270 && (n ? (g *= -1, b += p <= 0 ? 180 : -180, p += p <= 0 ? 180 : -180) : (m *= -1, b += b <= 0 ? 180 : -180)), t = t || a.uncache, a.x = d - ((a.xPercent = d && (!t && a.xPercent || (Math.round(e.offsetWidth / 2) === Math.round(-d) ? -50 : 0))) ? e.offsetWidth * a.xPercent / 100 : 0) + r, a.y = u - ((a.yPercent = u && (!t && a.yPercent || (Math.round(e.offsetHeight / 2) === Math.round(-u) ? -50 : 0))) ? e.offsetHeight * a.yPercent / 100 : 0) + r, a.z = h + r, a.scaleX = Q(g), a.scaleY = Q(m), a.rotation = Q(p) + s, a.rotationX = Q(w) + s, a.rotationY = Q(y) + s, a.skewX = b + s, a.skewY = x + s, a.transformPerspective = _ + r, (a.zOrigin = parseFloat(c.split(" ")[2]) || !t && a.zOrigin || 0) && (i[ce] = Ea(c)), a.xOffset = a.yOffset = 0, a.force3D = we.force3D, a.renderTransform = a.svg ? js : Yr ? Jr : Qs, a.uncache = 0, a;
}, Ea = function(e) {
...
}, lt = "0deg", Nt = "0px", ct = ") ", Jr = function(e, t) {
  ...
  if (x && (u !== lt || d !== lt)) {
    var T = parseFloat(d) * Et, A = Math.sin(T), k = Math.cos(T), C;
    T = parseFloat(u) * Et, C = Math.cos(T), r = Qa(b, r, A * C * -x), s = Qa(b, s, -Math.sin(T) * -x), l = Qa(b, l, k * C * -x + x);
  }
  ...
  var a = t || this, i = a.xPercent, n = a.yPercent, r = a.x, s = a.y, l = a.rotation, c = a.skewX, d = a.skewY, u = a.scaleX, h = a.scaleY, g = a.target, m = a.xOrigin, p = a.yOrigin, w = a.xOffset, y = a.yOffset, b = a.forceCSS, x = parseFloat(r), _ = parseFloat(s), v, T, A, k, C;
  l = parseFloat(l), c = parseFloat(c), d = parseFloat(d), d && (d = parseFloat(d), c += d, l += d), l || c ? (l *= Et, c *= Et, v = Math.cos(l) * u, T = Math.sin(l) * u, A = Math.sin(l - c) * -h, k = Math.cos(l - c) * h, c && (d *= Et, C = Math.tan(c - d), C = Math.sqrt(1 + C * C), A *= C, k *= C, d && (C = Math.tan(d), C = Math.sqrt(1 + C * C), v *= C, T *= C)), v = Q(v), T = Q(T), A = Q(A), k = Q(k)) : (v = u, k = h, T = A = 0), (x && !~(r + "").indexOf("px") || _ && !~(s + "").indexOf("px")) && (x = nt(g, "x", r, "px"), _ = nt(g, "y", s, "px")), (m || p || w || y) && (x = Q(x + m - (m * v + p * A) + w), _ = Q(_ + p - (m * T + p * k) + y)), (i || n) && (C = g.getBBox(), x = Q(x + i / 100 * C.width), _ = Q(_ + n / 100 * C.height)), C = "matrix(" + v + "," + T + "," + A + "," + k + "," + x + "," + _ + ")", g.setAttribute("transform", C), b && (g.style[W] = C);
}, Ks = function(e, t, a, i, n) {
  var r = 360, s = X(n), l = parseFloat(n) * (s && ~n.indexOf("rad") ? pt : 1), c = l - i, d = i + c + "deg", u, h;
  return s && (u = n.split("_")[1], u === "short" && (c %= r, c !== c % (r / 2) && (c += c < 0 ? r : -r)), u === "cw" && c < 0 ? c = (c + r * sn) % r - ~~(c / r) * r : u === "ccw" && c > 0 && (c = (c - r * sn) % r - ~~(c / r) * r)), e._pt = h = new le(e._pt, t, a, i, c, Rs), h.e = d, h.u = "deg", e._props.push(a), h;
}, gn = function(e, t) {
  for (var a in t)
    e[a] = t[a];
  return e;
}, Xs = function(e, t, a) {
  var i = gn({}, a._gsap), n = "perspective,force3D,transformOrigin,svgOrigin", r = a.style, s, l, c, d, u, h, g, m;
  i.svg ? (c = a.getAttribute("transform"), a.setAttribute("transform", ""), r[W] = t, s = ea(a, 1), it(a, W), a.setAttribute("transform", c)) : (c = getComputedStyle(a)[W], r[W] = t, s = ea(a, 1), r[W] = c);
  for (l in Ge)
    c = i[l], d = s[l], c !== d && n.indexOf(l) < 0 && (g = te(c), m = te(d), u = g !== m ? nt(a, l, c, m) : parseFloat(c), h = parseFloat(d), e._pt = new le(e._pt, s, l, u, h - u, vi), e._pt.u = m || 0, e._props.push(l));
  gn(s, i);
};
se("padding,margin,Width,Radius", function(o, e) {
  ...
  Ta[e > 1 ? "border" + o : o] = function(s, l, c, d, u) {
    var h, g;
...
var Zr = {
  ...
  init: function(e, t, a, i, n) {
    var r = this._props, s = e.style, l = a.vars.startAt, c, d, u, h, g, m, p, w, y, b, x, _, v, T, A, k, C;
    Hi || Ai(), this.styles = this.styles || Wr(e), k = this.styles.props, this.tween = a;
    for (p in t)
      if (p !== "autoRound" && (d = t[p], !(ue[p] && qr(p, t, a, i, e, n)))) {
        if (g = typeof d, m = Ta[p], g === "function" && (d = d.call(a, i, e, n), g = typeof d), g === "string" && ~d.indexOf("random(") && (d = Xt(d)), m)
          m(this, e, p, d, a) && (A = 1);
        else if (p.substr(0, 2) === "--")
          c = (getComputedStyle(e).getPropertyValue(p) + "").trim(), d += "", tt.lastIndex = 0, tt.test(c) || (w = te(c), y = te(d), y ? w !== y && (c = nt(e, p, c, y) + y) : w && (d += w)), this.add(s, "setProperty", c, d, i, n, 0, 0, p), r.push(p), k.push(p, 0, s[p]);
        else if (g !== "undefined") {
          if (l && p in l ? (c = typeof l[p] == "function" ? l[p].call(a, i, e, n) : l[p], X(c) && ~c.indexOf("random(") && (c = Xt(c)), te(c + "") || c === "auto" || (c += we.units[p] || te(ze(e, p)) || ""), (c + "").charAt(1) === "=" && (c = ze(e, p))) : c = ze(e, p), h = parseFloat(c), b = g === "string" && d.charAt(1) === "=" && d.substr(0, 2), b && (d = d.substr(2)), u = parseFloat(d), p in qe && (p === "autoAlpha" && (h === 1 && ze(e, "visibility") === "hidden" && u && (h = 0), k.push("visibility", 0, s.visibility), Je(this, s, "visibility", h ? "inherit" : "hidden", u ? "inherit" : "hidden", !u)), p !== "scale" && p !== "transform" && (p = qe[p], ~p.indexOf(",") && (p = p.split(",")[0]))), x = p in Ge, x) {
            if (this.styles.save(p), C = d, g === "string" && d.substring(0, 6) === "var(--") {
            ...
            if (_ || (v = e._gsap, v.renderTransform && !t.parseTransform || ea(e, t.parseTransform), T = t.smoothOrigin !== !1 && v.smooth, _ = this._pt = new le(this._pt, s, W, 0, 1, v.renderTransform, v, 0, -1), _.dep = 1), p === "scale")
              this._pt = new le(this._pt, v, "scaleY", v.scaleY, (b ? kt(v.scaleY, b + u) : u) - v.scaleY || 0, vi), this._pt.u = 0, r.push("scaleY", p), p += "X";
            else if (p === "transformOrigin") {
              k.push(ce, 0, s[ce]), d = Ws(d), v.svg ? Si(e, d, 0, T, 0, this) : (y = parseFloat(d.split(" ")[2]) || 0, y !== v.zOrigin && Je(this, v, "zOrigin", v.zOrigin, y), Je(this, s, p, Ea(c), Ea(d)));
              continue;
            } else if (p === "svgOrigin") {
              Si(e, d, 1, T, 0, this);
              continue;
            } else if (p in Kr) {
              Ks(this, v, p, h, b ? kt(h, b + d) : d);
              continue;
          ...
          if (x || (u || u === 0) && (h || h === 0) && !Ps.test(d) && p in s)
            w = (c + "").substr((h + "").length), u || (u = 0), y = te(d) || (p in we.units ? we.units[p] : w), w !== y && (h = nt(e, p, c, y)), this._pt = new le(this._pt, x ? v : s, p, h, (b ? kt(h, b + u) : u) - h, !x && (y === "px" || p === "zIndex") && t.autoRound !== !1 ? qs : vi), this._pt.u = y || 0, x && C !== d ? (this._pt.b = c, this._pt.e = C, this._pt.r = Is) : w !== y && y !== "%" && (this._pt.b = c, this._pt.r = Ds);
          else if (p in s)
            Gs.call(this, e, p, c, b ? b + d : d);
          else if (p in e)
          ...
          x || (p in s ? k.push(p, 0, s[p]) : typeof e[p] == "function" ? k.push(p, 2, e[p]()) : k.push(p, 1, c || e[p])), r.push(p);
        }
      }
    A && zr(this);
  },
  ...
  getSetter: function(e, t, a) {
    var i = qe[t];
    return i && i.indexOf(",") < 0 && (t = i), t in Ge && t !== ce && (e._gsap.x || ze(e, "x")) ? a && on === a ? t === "scale" ? Bs : Os : (on = a || {}) && (t === "scale" ? Fs : zs) : e.style && !Mi(e.style[t]) ? Ls : ~t.indexOf("-") ? Ns : zi(e, t);
  },
  core: {
    _removeProperty: it,
    _getMatrix: Wi
...
de.core.getStyleSaver = Wr;
(function(o, e, t, a) {
  var i = se(o + "," + e + "," + t, function(n) {
    Ge[n] = 1;
  });
  se(e, function(n) {
    we.units[n] = "deg", Kr[n] = 1;
...
de.registerPlugin(Zr);
var f = de.registerPlugin(Zr) || de;
f.core.Tween;
const Fe = "Thinking", Ct = "Show more", xa = "Show less";
function Yi(o, e) {
...
const $s = "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABAAAAAQCAYAAAAf8/9hAAAAeUlEQVQ4jd3TsRFAYAyG4Td+1rGFRm8CnbOO0gL0GgOomcEWjmg07jj86aRN8tyXIsJYKN9rAXoceeCxDBABKavUvsBRmhgBInk1NhYNkF21rAkImcpLGXQmroZnQLfmptcCj4D5hB8A4vkLpwSLEZDeBjjNgc43yQ5kyxoFPrhHWwAAAABJRU5ErkJggg==", el = "data:image/png;base64,", ja = "data:image/png;base64,", tl = "data:image/png;base64,", mn = "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABAAAAAQCAIAAACQkWg2AAAAFklEQVR4nGNQOhpHEmIY1TCqYfhqAACML0UQHuDXpwAAAABJRU5ErkJggg==", al = "data:image/png;base64,", il = "data:image/png;base64,", fn = "data:image/png;base64,", nl = "data:image/png;base64,", rl = "data:image/png;base64,", ol = "data:image/png;base64,", sl = "data:image/png;base64,", ll = "data:image/png;base64,", cl = "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABAAAAAQCAIAAACQkWg2AAAAFklEQVR4nGPojvlGEmIY1TCqYfhqAAAq1t0QMabSpAAAAABJRU5ErkJggg==", dl = "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABAAAAAQCAIAAACQkWg2AAAAFklEQVR4nGOwbvpGEmIY1TCqYfhqAACHB7MQtEO1oAAAAABJRU5ErkJggg==", ul = "data:image/png;base64,", hl = "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABAAAAAQCAIAAACQkWg2AAAAFklEQVR4nGP4Oo+bJMQwqmFUw/DVAAACRZ4QdD+g5wAAAABJRU5ErkJggg==", pl = "data:image/png;base64,", gl = "data:image/png;base64,", ml = "data:image/png;base64,", fl = "data:image/png;base64,", wl = "data:image/png;base64,", bl = "data:image/png;base64,", yl = "data:image/png;base64,", wn = "data:image/png;base64,", xl = "data:image/png;base64,", vl = "data:image/png;base64,", bn = "data:image/png;base64,", _l = "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABAAAAAQCAMAAAAoLQ9TAAAAKlBMVEUAAAD///8nJye3t7cyMjKHh4f8/Pz39/ecnJwaGhoSEhI5OTnW1tbT09NHEhmuAAAAOklEQVQYlWNgoB5gZUUTYGNH5XMwMnIg8zkZgYALSYAZJMCM4HMzggE3XIAHIsALF2BhAgMWSt0OAwBMcQCayCv/8QAAAABJRU5ErkJggg==", Al = "data:image/png;base64,", Sl = "data:image/png;base64,", Cl = {
  adyen: $s,
  airtable: el,
  apollo: ja,
  "apollo io": ja,
...
function Tl(o) {
  const e = $r(o).replace(/[^a-z0-9]+/g, "-").replace(/^-|-$/g, "");
  return e ? `${q}?u=${encodeURIComponent(e)}` : "";
}
function Oa(o, e) {
  const t = $r(o), a = e?.trim() || void 0;
  return kl[t] ?? a ?? Tl(o);
}
const eo = `
...
const El = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="52 42 88 66">
<path fill="#4285f4" d="M58 108h14V74L52 59v43c0 3.32 2.69 6 6 6"/>
<path fill="#34a853" d="M120 108h14c3.32 0 6-2.69 6-6V59l-20 15"/>
<path fill="#fbbc04" d="M120 48v26l20-15v-8c0-7.42-8.47-11.65-14.4-7.2"/>
<path fill="#ea4335" d="M72 74V48l24 18 24-18v26L96 92"/>
<path fill="#c5221f" d="M52 51v8l20 15V48l-5.6-4.2c-5.94-4.45-14.4-.22-14.4 7.2"/>
</svg>`, Ml = `<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" viewBox="60 90.4 570.02 539.67">
<defs>
...
const Pl = [
...
], Rl = 1.28, S = (o) => Number((o * Rl).toFixed(3)), Dl = {
  ...
  settleHold: S(0.24)
}, xn = "Learning your style", Ll = "Voice calibrated", vn = "73 tone & tactic rules defined", Ka = [
  ...
  0,
  4
], Bl = /* @__PURE__ */ new Set([5, 8, 10, 16]), Fl = [
  ...
  threadGap: 44
}, Vl = "left,right,bottom,width,height,minHeight,paddingTop,paddingRight,paddingBottom,paddingLeft,borderWidth,gap", Ja = {
  paddingTop: "",
  paddingRight: "",
  paddingBottom: "",
  paddingLeft: "",
  ...
  contentWidth: 1881,
  height: 1280
}, Ql = 96, En = ".wa-cursor-file, .wa-file-landing-clone, .wa-file-landing-label, .wa-csv-drop, .wa-signup-logo-transfer", Mn = "[data-marketing-data-sources-grid]", Pn = "[data-data-table]", Bt = "[data-table-action]", $a = "[data-table-page-button]", ei = "[data-table-page-range]", Rn = "[data-sequence-engagement]", jl = "[data-sequence-card]", Kl = "[data-sequence-person-card]", Dn = "[data-sequence-people-rail]", j = {
  duration: S(0.12),
  incomingLag: S(0.1),
  rowStagger: S(0.03),
...
}, Xl = "https://cdn.jsdelivr.net/npm/simple-icons@latest/icons", Jl = "https://www.google.com/s2/favicons", Zl = {
  adyen: "adyen",
  airtable: "airtable",
  brex: "brex",
  "dbt labs": "dbt",
...
class ec {
  ...
  showComposer() {
    ...
    return e.set(this.composer, {
      ...
      paddingBottom: () => Math.max(Cn, this.getComposerThreadInsetForFrame(t))
    ...
    return f.timeline().set(this.composer, {
      ...
      onComplete: () => {
        f.set(this.composerContents, { visibility: "hidden" }), f.set(this.composer, {
          visibility: "hidden"
        }), f.set(this.thread, { paddingBottom: Cn }), this.pinThreadToBottom();
      }
    }, 0);
  }
  clearComposer() {
  ...
  measureComposerFullFrame() {
    f.set(this.composer, { clearProps: Vl });
  ...
  dataTableActionTooltip(e, t, a) {
    return f.timeline().call(() => {
      ...
      const n = this.queryElements(i, Bt);
      n.forEach((l) => {
        const c = l.dataset.tableAction === t && a;
        l.dataset.tooltipVisible = String(c);
      });
      const r = a ? n.find((l) => l.dataset.tableAction === t) : void 0;
      if (!r) {
        this.hideDataTableControlTooltip();
        return;
      }
      const s = this.getDataTableControlTooltipText(r);
      if (!s) {
        this.hideDataTableControlTooltip();
        return;
      }
      this.showDataTableControlTooltip(r, s);
    });
  }
  enrichmentPanel(e) {
  ...
  strategyPlans(e) {
    ...
    a.className = "wa-result-grid has-strategy-plans", a.dataset.strategyPlans = e.map((h) => h.id).join(" "), a.append(...t), t.length && f.set(t, { ...r.from }), f.set(i, { ...Tn.from });
    const d = this.claimComponentMessage("strategy", a), u = f.timeline().add(this.revealMessage(d, n, kn)).addLabel(s, Wl).call(() => this.setMotionHints(c), void 0, s).to(t, { ...r.to }, s);
    return t.forEach((h, g) => {
      const m = this.queryElements(h, ".wa-strategy-plan__bullets li");
      m.length && u.to(m, { ...Tn.to }, `${s}+=${g * l}`);
  ...
  connectMailbox(e) {
    ...
    return g.call(() => {
      ...
      i.dataset.mailboxLearningState = "ready", l.textContent = Ll, d.textContent = i.dataset.mailboxLearningReadyDetail ?? vn;
    }).fromTo(
      l,
      { autoAlpha: 0, y: 4 },
      {
  ...
  sequenceBuildThinking(e) {
    ...
    return this.addThinkingStepReveal(d, t, { position: "<" }), d.to({}, { duration: Xa.templateHold }).add(this.foldThinkingStep(t)).call(() => {
      a.forEach((u) => {
    ...
    }, "+=0.14").to({}, { duration: Xa.finalHold }), a.forEach((u, h) => {
  ...
  getWindowSceneAvailableHeight() {
    ...
    return Math.max(1, e * Dl.maxViewportHeightRatio);
  }
  ...
  resetMessageClasses(e) {
    e.classList.remove(...Pl), e.classList.remove("wa-message--first-active");
  }
  createCsvDropArea(e = {}) {
  ...
  getCursorFileEntryOffset(e, t) {
    const a = e.offsetWidth || 154, i = t.readPosition(), n = this.root.getBoundingClientRect(), r = window.innerWidth - n.left, s = i.x - a * 0.5, l = r + ti.offscreenMargin;
    return {
      x: Math.max(0, l - s),
      y: 0
    };
  ...
  streamThinkingHeader(e) {
    return this.streamThinkingChild(e, ".wa-thinking__title", Hl);
  }
  streamThinkingStepLabel(e) {
    return this.streamThinkingChild(e, ".wa-research-step__label", Ul);
  }
  ...
  renderSignupLogoTransfer(e, t) {
    if (!e) return;
    const a = e.target.getBoundingClientRect(), i = this.getElementLocalRect(a, this.chatBody), n = io(t);
    e.setX(this.interpolate(e.startX, i.left, n)), e.setY(this.interpolate(e.startY, i.top, n)), e.setWidth(this.interpolate(e.startWidth, a.width, n)), e.setHeight(this.interpolate(e.startHeight, a.height, n)), f.set(e.el, {
      color: t > 0.78 ? Za.targetColor : getComputedStyle(this.signupLogo).color
    });
  }
  ...
  addThinkingElapsedTimer(e, t, a) {
    Zs(e, t, a, { reducedMotion: this.prefersReducedMotion });
  }
  createThinkingLogo(e = "wa-thinking__glyph") {
    const t = document.createElement("span");
    return t.className = e, t.dataset.logoMode = "thinking", t.setAttribute("aria-hidden", "true"), t.append(yn("wa-thinking__logo-mark")), t;
  }
  ...
  normalizeThinkingItem(e, t) {
    ...
    return {
      ...
      disclosure: typeof e == "string" ? t === 0 ? Ct : xa : e.disclosure || (t === 0 ? Ct : xa)
    };
  }
  ...
  showDataTableControlTooltip(e, t) {
    const a = this.chatShell.getBoundingClientRect(), i = e.getBoundingClientRect(), n = i.left - a.left + i.width * 0.5, r = i.top - a.top - 7, s = document.createElement("span"), l = e.dataset.tooltipBadge?.trim();
  ...
  hideDataTableControlTooltip() {
    this.tableControlTooltip.dataset.visible = "false", this.tableControlTooltip.dataset.hasBadge = "false", this.queryElements(this.chatShell, Bt).forEach((e) => {
      e.dataset.tooltipVisible = "false";
    });
  }
  setDataTableControlTooltipVisible(e) {
    const t = e.closest(Pn);
    (t ? this.queryElements(t, Bt) : this.queryElements(this.chatShell, Bt)).forEach((i) => {
  ...
  findDataTableControl(e) {
    return e instanceof Element ? e.closest(Bt) : null;
  }
  findDataTablePageButton(e) {
    return e instanceof Element ? e.closest($a) : null;
  }
  getDataTablePageButtonRuntime(e) {
    const t = e.closest(Pn), a = t?.dataset.dataTable, i = this.parseFiniteNumber(e.dataset.tablePageButton);
  ...
  getDataTablePageRuntime(e, t) {
    ...
    if (!a) return null;
    const i = this.queryElements(a, $a);
    return {
      table: a,
  ...
  getCompanyLogoUrl(e, t) {
    ...
    if (a) return a;
    const i = this.getCompanyKey(e), n = Cl[i];
    if (n) return n;
    const r = t.companyLogoSlug || this.getCompanyLogoIconSlug(e);
    if (r) return `${Xl}/${encodeURIComponent(r)}.svg`;
  ...
  getCompanyLogoDomain(e) {
    return e ? $l[this.getCompanyKey(e)] ?? "" : "";
  }
  getCompanyKey(e) {
  ...
  appendWaterfallServiceIcon(e, t) {
    if (t === "on-prem") {
      e.append(yn("wa-waterfall-chip__mark"));
      return;
    }
  ...
  createMarketingDataSourcesGrid(e) {
    ...
    return t.classList.add("wa-data-source-grid--marketing"), t.dataset.marketingDataSourcesGrid = e.id, a.className = "wa-data-source-grid__scale", i.className = "wa-data-source-grid__groups", Yl.forEach((s) => {
      const l = document.createElement("div");
  ...
  updateMarketingDataGridScales() {
    this.queryElements(this.thread, Mn).forEach((e) => {
  ...
  createMailboxConnection(e) {
    ...
    c.className = "wa-mailbox-learning", c.dataset.mailboxLearning = "", c.dataset.mailboxLearningReadyDetail = e.learningReadyDetail ?? vn;
    ...
    const h = document.createElement("span");
    h.dataset.mailboxLearningTitleText = "", h.textContent = e.learningTitle ?? xn;
    ...
    m.className = "wa-mailbox-learning__detail", m.textContent = e.learningDetail ?? Ka[0].detail;
  ...
  createMailboxProviderIcon(e) {
    ...
    return t.className = "wa-mailbox-connection__provider-icon", t.src = Nl[e], t.alt = "", t.decoding = "async", t.loading = "eager", t.setAttribute("aria-hidden", "true"), t;
  }
  ...
  createMailboxThumbprintGroup(e, t = !1) {
    ...
    return a.classList.add(e), Fl.forEach((i, n) => {
  ...
  createSequenceEngagement(e) {
    ...
    if (r) {
      ...
      m.className = "wa-sequence-people-wrap", p.className = "wa-sequence-people", p.dataset.sequencePeopleRail = e.id, p.setAttribute("aria-label", "Sequence people"), m.append(p), e.sequences.forEach((w, y) => {
        ...
        const k = this.createSequenceCompanyBadge(w.company);
        k && x.append(k), v.className = "wa-sequence-person-card__copy", T.textContent = w.name, A.textContent = [w.title, w.company].filter(Boolean).join(", "), v.append(T, A), b.append(x, v), p.append(b);
      }), s = m;
    }
    e.sequences.forEach((m, p) => {
      ...
      const k = m.steps;
      if (k?.length) {
        const C = document.createElement("div"), M = this.getInitialSequenceStepIndex(e, k.length), F = document.createElement("div"), z = document.createElement("span"), L = document.createElement("strong"), U = document.createElement("div");
        C.className = "wa-sequence-steps", k.forEach((D, I) => {
          const P = document.createElement("button"), $ = document.createElement("span"), Te = document.createElement("span"), We = document.createElement("strong"), ke = this.getSequenceStepWaitDays(D, I, k.length);
          P.className = "wa-sequence-step", P.type = "button", P.tabIndex = -1, P.dataset.stepIndex = String(I), P.dataset.stepOpen = String(I === M), P.dataset.stepSelected = String(I === M), P.dataset.channel = this.slugChannelName(D.channel), P.dataset.stepSubject = I === 0 ? m.subject : D.label, P.dataset.stepBody = this.getSequenceStepCopy(m, D), P.dataset.stepTemplateChannel = D.channel, P.dataset.stepTemplateLabel = D.label, P.dataset.stepTemplateSubject = I === 0 ? m.subject : D.label, P.dataset.stepTemplateBody = this.getSequenceStepCopy(m, D), ke && (P.dataset.waitDays = String(ke), P.dataset.stepTemplateWaitDays = String(ke)), P.setAttribute("aria-pressed", String(I === 0)), P.addEventListener("click", () => {
          ...
          ), Te.className = "wa-sequence-step__copy", We.textContent = this.formatSequenceStepTitle(D.label), Te.append(We), P.append($, Te), C.append(P), ke && C.append(this.createSequenceWaitRow(ke, I));
        }), F.className = "wa-sequence-copy-panel", F.dataset.sequenceCopyPanel = "", z.className = "wa-sequence-copy-panel__meta", z.dataset.sequenceCopyMeta = "", L.className = "wa-sequence-copy-panel__subject", L.dataset.sequenceCopySubject = "", U.className = "wa-sequence-copy-panel__body", U.dataset.sequenceCopyBody = "", F.append(z, L, U), w.append(C, F), this.selectSequenceStep(w, M);
      } else
        w.append(y, T, A);
      n.append(w);
    });
  ...
  findSequenceEngagement(e) {
    return this.queryElements(this.root, Rn).find((t) => t.dataset.sequenceEngagement === e) ?? null;
  }
  ...
  getSequencePersonCards(e) {
    return this.queryElements(e, Kl);
  }
  ...
  getSequenceRailRuntime(e, t) {
    const a = e.querySelector(Dn), i = a?.querySelector(`[data-sequence-person-index="${t}"]`);
  ...
  getSequenceStepWaitDays(e, t, a) {
    return t >= a - 1 ? null : e.waitDays ?? Il[t] ?? 1;
  }
  ...
  centerSequencePersonCard(e, t) {
    ...
    i.dataset.sequenceCentering = "true", f.to(i, {
      scrollLeft: r,
      duration: Sn.railCenterDuration,
      ease: Sn.railCenterEase,
      overwrite: "auto",
      onComplete: () => {
  ...
  cancelSequencePersonTransitionForCard(e) {
    const a = e.closest(Rn)?.dataset.sequenceEngagement;
    if (!a) return;
...
`);
  ...
  clearTransientElements() {
    ...
    this.transientCleanups = [], this.removeElements(En);
  }
  removeElements(e) {
  ...
  requestMessageScroll(e) {
    ...
    this.scheduledScrollMessage = e, !(t - this.lastStreamScrollAt < Ql) && (this.scheduledScrollFrame || (this.lastStreamScrollAt = t, this.scheduledScrollFrame = window.requestAnimationFrame(() => {
...
function tc(o, e) {
  const t = Ol[o] ?? 0, a = 24 + o * 11 % 8, i = Math.min(100, t + a), n = io((e - t) / (i - t));
  if (n <= 0) return 0;
  const r = Bl.has(o) ? 20 : 12;
...
function da(o, e, t) {
  const a = ro(t.seed), i = no(o, e), n = t.speed ?? "normal", r = t.intent ?? "hover";
  ...
  const s = e.x - o.x, l = e.y - o.y, c = s / i, d = l / i, u = -d, h = c, g = a() > 0.5 ? 1 : -1, m = t.curve ?? 1, w = Ze(i * (r === "drag" ? 0.1 : r === "click" ? 0.17 : 0.22), 18, 150) * m * g * (0.72 + a() * 0.44), y = i / ic[n] + 0.16, b = Ze(
    y * nc[r] * rc * (t.durationScale ?? 1),
    0.3,
    1.98
...
class lc {
  ...
  moveTo(e, t = {}) {
    const a = t.label ?? `move-${this.moveIndex}`, i = t.mode ?? "default", n = `${this.storyId}:${a}:${this.resolver.getBreakpoint()}`, r = this.resolver.resolve(e, n), s = { ...this.plannedPosition }, l = t.ease ?? "power2.inOut", c = da(s, r, {
      seed: n,
      intent: t.intent,
      speed: t.speed,
      curve: t.curve,
    ...
    return this.moveIndex += 1, this.plannedPosition = { ...r }, d.call(() => {
      ...
      this.pathTweenFromFactory(
        () => {
          ...
          return u = da(this.currentPosition, h, {
            seed: n,
            intent: t.intent,
            speed: t.speed,
            curve: t.curve,
  ...
  parkForChatHistory() {
    const e = `history-park-${this.moveIndex}`, t = `${this.storyId}:${e}:${this.resolver.getBreakpoint()}`, a = { ...this.currentPosition }, i = this.resolveHistoryParkPoint(), n = da(a, i, {
      seed: t,
      intent: "hover",
      speed: "quick",
      overshoot: !1,
  ...
  pathTweenFromFactory(e, t, a = "power2.inOut") {
    ...
    return f.fromTo(
      ...
      { t: 0 },
      {
        ...
        onUpdate: () => {
          if (!n) return;
          const r = qn(n.start, n.c1, n.c2, n.end, i.t);
  ...
  createHistoryParkPlan(e) {
    this.resolver.refresh();
    const t = this.resolveHistoryParkPoint(), a = da(this.currentPosition, t, {
      seed: e,
      intent: "hover",
      speed: "quick",
      overshoot: !1,
  ...
  resolveHistoryParkPoint() {
    ...
    const a = Ze(
      t.height * ua.topRatio,
      ua.minTopInset,
      ua.maxTopInset
    );
    return {
      x: t.right - e.left + ua.outsideOffset,
      y: t.top - e.top + a
    };
  }
  ...
  renderMimicRotation(e, t) {
    ...
    if (a * a + i * i < 4) return;
    const n = Math.atan2(i, a) * 180 / Math.PI, r = dc(n - oc), s = this.rotationState + uc(this.rotationState, r) * sc;
  ...
  maybeSyncModeToPoint(e) {
    const t = performance.now(), a = e.x - this.lastModeSyncPoint.x, i = e.y - this.lastModeSyncPoint.y, n = Number.isNaN(this.lastModeSamplePoint.x) ? 0 : e.x - this.lastModeSamplePoint.x, r = Number.isNaN(this.lastModeSamplePoint.y) ? 0 : e.y - this.lastModeSamplePoint.y, s = Number.isNaN(a) || a * a + i * i >= Ft.minDistance * Ft.minDistance;
    this.lastModeSamplePoint = { ...e }, !(!s && t - this.lastModeSyncAt < Ft.minInterval) && (this.lastModeSyncAt = t, this.lastModeSyncPoint = { ...e }, this.syncModeToPoint(e, { x: n, y: r }));
  }
  updateModeWatch() {
  ...
  getModeForPoint(e, t = { x: 0, y: 0 }) {
    ...
    return i <= 0.25 ? "default" : this.getModeForExactPoint({
      x: e.x + t.x / i * Ft.lookahead,
      y: e.y + t.y / i * Ft.lookahead
    });
  }
  ...
  createElement() {
    ...
    const a = document.createElement("div");
    return a.className = "wa-cursor__glyph", a.append(Ln()), t.append(a), e.append(t), this.root.append(e), e;
  }
  ensureFloatLayer() {
    const e = this.el.querySelector("[data-cursor-float]");
    if (e) return e;
    const t = this.el.querySelector(".wa-cursor__glyph") ?? document.createElement("div");
    t.classList.contains("wa-cursor__glyph") || (t.className = "wa-cursor__glyph"), t.querySelector(".wa-cursor__mimic-head") || t.append(Ln());
    const a = document.createElement("div");
...
const On = /* @__PURE__ */ new Set(), ha = /* @__PURE__ */ new Set(), hc = ["avatarUrl", "mutualConnectionAvatarUrl"], pc = ["name", "contact", "prospect", "fullName", "mutualConnection", "connector"];
function Bn(o, e) {
  o.length && (Fn(o[e]), Fn(o[(e + 1) % o.length]));
}
function Fn(o) {
  if (o?.assetUrls?.length)
    for (const e of o.assetUrls) wc(e);
}
function Vt(o) {
  return Ba(gc(o).flatMap((e) => mc(e.values)));
}
function oo(o) {
  return Ba(o.sources.map((e) => e.logoSrc));
}
function so(o) {
  return Ba(o.leads.map((e) => Oa(e.name, e.avatarUrl)));
}
function lo(o) {
  return Ba(o.sequences.map((e) => Oa(e.name, e.avatarUrl)));
}
function gc(o) {
  return [
    ...o.rows,
...
function mc(o) {
  const e = hc.map((t) => o[t]);
  for (const t of pc) {
    const a = o[t];
    if (!a || !fc(t, o)) continue;
...
function N(o, e, t = {}, a = !0) {
  return {
    desktop: { target: o, anchor: e, offset: si(t.desktop), humanOffset: a },
    tablet: { target: o, anchor: e, offset: si(t.tablet), humanOffset: a },
    mobile: { target: o, anchor: e, offset: si(t.mobile), humanOffset: a }
  };
}
const Ma = {
...
}, co = N("[data-signup-field]", "center", {
  desktop: -74,
  tablet: -66,
  mobile: -48
}), uo = N("[data-signup-submit]", "center"), vc = N("[data-send-button]", "center"), Qi = {
  desktop: {
...
}, _c = 2.8, Ac = 42, Sc = 2, Cc = 3, Pa = "[data-chat-shell] [data-chat-thread]", kc = `${Pa} [data-message-role="assistant"]:not(.wa-message--component) [data-message-body]`, Tc = `${Pa} [data-message-role="assistant"].wa-message--thinking .wa-research-step[data-step-state="current"] .wa-research-step__body, ${Pa} [data-message-role="assistant"].wa-message--thinking .wa-research-step[data-step-state="complete"] .wa-research-step__label`, Ra = 0.24, ho = 0.3, Ue = {
...
function go(o) {
  const e = je(`[data-style-profile="${pe(o)}"]`), t = Da(o);
  return mo([
    {
...
function fo(o, e, t = Oe.firstMoveDelay) {
...
function wo(o, e = E.beat + 0.18, t, a = {}) {
  return {
    kind: "custom",
    build: (i) => {
      const n = na(i);
      return n.call(() => i.chat.scrollDataTableFooterIntoView(o, e, a)), n.to({}, { duration: e }), a.settleDelay && (n.to({}, { duration: a.settleDelay }), n.call(() => i.chat.scrollDataTableFooterIntoView(o, e, a)), n.to({}, { duration: e })), ra(n);
    },
    at: t
  };
}
...
function Ec(o, e, t, a, i) {
  switch (t.kind) {
    ...
    case "transitionSignupToChat":
      ...
      return;
    case "assistant":
      o.add(e.chat.assistantMessage(t.text), t.at), qc(o, e, i, {
        kind: "assistant",
        key: t.text,
        text: t.text,
        selector: kc,
        label: `assistant-${Da(t.text)}`,
        stepIndex: a
      });
      return;
    case "thinking": {
      const n = Mc(t), r = n.items.map((s) => s.label);
    ...
    case "strategyPlans":
      {
        ...
        o.add(e.chat.strategyPlans(t.plans), t.at), o.add(Dc(e, n, t.plans), "+=0.06");
      }
      return;
...
function Mc(o) {
  return "thinking" in o && o.thinking ? o.thinking : Array.isArray(o.steps) ? { items: o.steps.map(zn) } : { items: [zn(o.label ?? "")] };
}
function zn(o) {
  return typeof o == "string" ? { label: o } : o;
}
function zt(o, e, t, a, i, n) {
  o.add(t, a), o.add(Rc(e, i, n), "+=0.06");
}
function Pc(o, e, t, a) {
  const i = je(
...
function Rc(o, e, t) {
  const a = na(o).add(o.cursor.scanAcross(e, { label: t }));
  return ra(a);
}
function Dc(o, e, t) {
  const a = na(o), i = t.map(
...
function Ic(o, e, t, a = E.thinkingShort, i = 1, n = "thinking", r = 0) {
  const s = a * Math.max(1, i), l = i >= 3 && bo(e, t, {
    kind: "thinking",
    key: n,
    text: n,
    stepIndex: r,
  ...
  l && o.add(
    e.cursor.scanAcross(Tc, {
      label: `thinking-skim-${Da(n)}`,
      match: "last",
      duration: 0.72
    }),
    "<+=0.58"
...
function bo(o, e, t) {
  const a = t.text.trim(), i = t.minChars ?? Ac;
  if (a.length < i || e.textSkimCount >= Cc) return !1;
  const n = e.textCandidateCount;
  e.textCandidateCount += 1;
  const r = e.textSkimCount === 0, s = t.stepIndex - e.lastTextSkimStep >= Sc, l = Nc(`${o.story.id}:${t.kind}:${n}:${t.key}`), c = n > 0 && n % 3 === 0, d = r || s && (l >= 0.58 || c);
...
function Oc(o, e) {
  ...
  return e.statusBefore && t.add(o.chat.setStatus(e.statusBefore)), t.add(o.chat.showComposer(), e.statusBefore ? "-=0.02" : void 0), e.fromEntry || t.add(
    ...
    "-=0.12"
  ), e.statusAfter && t.add(o.chat.setStatus(e.statusAfter), "<"), ra(t);
}
function na(o) {
  const e = o.timeline();
  return e.pause(0), e;
...
const Bc = {
  ...
  "data-marketplace": Ma.dataMarketplace,
  "research-brief": Ma.researchBrief
}, zc = {
  "hit-ground-running": ho,
  "data-marketplace": Ra,
  "research-brief": Ra
}, he = {
  ...
  for (const t of o.steps)
    if (!(t.kind !== "component" || !t.component))
      switch (t.component.kind) {
        case "table":
          pa(e, Vt(ta(t.component, `${o.id}-${t.id}`)));
          break;
        case "dataSources":
          pa(e, oo(_o(t.component)));
          break;
        case "proximityList":
          pa(e, so(ko(t.component)));
          break;
        case "sequenceEngagement":
          pa(e, lo(ji(t.component, `${o.id}-${t.id}`)));
          break;
      }
  return [...e];
}
...
function Wc(o, e) {
  return zc[o] ?? e.entryLeadTime;
}
function Yc(o, e, t) {
  if (e.id === "hit-ground-running") return Qc(o, e);
  if (e.id === "crm-update") return jc(o, e);
  if (e.id === "research-brief") return Kc(o, e);
  if (e.id === "csv-import-cleanup") return Xc(o, e);
  const a = ed(e);
  return a.length ? Ie(o, [...a, $e(Ue.bottomRight, "+=0.18")]) : t.build(o);
}
function Qc(o, e) {
  const t = He(e, "status"), a = He(e, "user"), i = He(e, "thinking"), n = He(e, "assistant"), r = aa(e, "strategyCards");
  return Ie(o, [
    ...
    ...r ? [{ kind: "strategyPlans", plans: vo(r.component), at: "-=0.08" }] : [],
    $e(Ue.right, "+=0.18")
  ]);
}
function jc(o, e) {
  const t = aa(e, "mailboxConnection"), a = aa(e, "uploadedFiles"), i = [];
  if (t && Co(i, So(t.component)), a) {
    const n = Ao(a.component), r = o.chat.prepareCsvDropArea({
  ...
  for (const n of e.steps)
    n === t || n === a || yo(i, e.id, n);
  return i.push($e(Ue.bottomRight, "+=0.16")), Ie(o, i);
}
function Kc(o, e) {
  const t = He(e, "user"), a = aa(e, "table"), i = He(e, "thinking"), n = aa(e, "sequenceEngagement"), r = a ? ta(a.component, "website-visitors-sales") : null, s = n ? ji(n.component, "visitor-outreach-sequences") : null, l = [];
  if (r && (r.scrollAlign = "equal-inset"), t && l.push({
    ...
    wo("website-visitors-sales", E.beat + 0.42, "+=0.08", {
      align: "top",
      offset: -190,
      settleDelay: 0.32
    }),
    ...
    l.push(
      ...
      { kind: "custom", build: () => o.chat.dataTableActionTooltip("website-visitors-sales", "power-dialer", !1) },
      {
        kind: "cursorMove",
        target: u,
  ...
  if (i && l.push(Fa(i, { hold: E.thinkingMedium, at: "+=0.06" })), s) {
    const [c, d] = ao(s, 2), u = N(
    ...
    l.push(
      ...
      ...fo("visitor-outreach-sequences", [1, 2, 3], "+=0.22"),
      {
        kind: "cursorMove",
        target: g,
...
function Xc(o, e) {
  ...
  return Ie(o, [
    ...
    ...s ? [{ kind: "dataTable", config: ta(s.component, "raw-webinar-attendees"), at: "+=0.08" }] : [],
    { kind: "status", text: "Cleaning CSV", at: "<" },
    ...a ? [Fa(a, { hold: 0.34, at: `+=${E.beat}` })] : [],
    ...i ? [{ kind: "assistant", text: i.text }] : [],
    ...l ? [{ kind: "dataTable", config: sd(ta(l.component, "cleaned-webinar-attendees")), at: "-=0.04" }] : [],
...
function ed(o) {
  const e = [], t = o.id === "data-marketplace" ? td(o.steps) : o.steps;
  let a = 0;
  for (const i of t)
    a += i.kind === "user" ? 1 : 0, yo(e, o.id, i, a === 1);
  return e;
}
function td(o) {
  const e = [];
...
function yo(o, e, t, a = !1) {
  ...
  if (t.kind === "thinking") {
    o.push(Fa(t, { hold: E.thinkingMedium }));
    return;
  }
  ...
  t.kind !== "component" || !t.component || id(o, e, t);
}
function id(o, e, t) {
  const a = t.component;
  if (a.kind === "table") {
    const i = ta(a, `${e}-${t.id}`);
    e === "data-marketplace" && ld(i), pd(e, t, i) && (i.scrollAlign = "equal-inset"), o.push({ kind: "dataTable", config: i, at: "-=0.04" });
    return;
  }
  if (a.kind === "strategyCards") {
    o.push({ kind: "strategyPlans", plans: vo(a), at: "-=0.04" });
    return;
  }
  if (a.kind === "enrichment") {
    o.push({ kind: "enrichmentPanel", config: Ad(a), at: "+=0.12" });
    return;
  }
  ...
  if (a.kind === "uploadedFiles") {
    o.push({ kind: "custom", build: (i) => i.chat.uploadedFilesMessage(Ao(a)), at: "-=0.04" });
    return;
  }
  ...
  if (a.kind === "styleProfile") {
    ...
    o.push({
      ...
      at: "-=0.02"
    }), e === "crm-update" && o.push(...go(i.id));
    return;
  }
  if (a.kind === "proximityList") {
    o.push({ kind: "custom", build: (i) => i.chat.proximityLeadList(ko(a)), at: "-=0.04" });
    return;
  }
  if (a.kind === "personalizationSwipeGame") {
    o.push({ kind: "personalizationSwipeGame", config: Cd(a), at: "+=0.06" });
    return;
  }
  if (a.kind === "sequenceEngagement") {
    o.push({ kind: "sequenceEngagement", config: ji(a, `${e}-${t.id}`), at: "-=0.02" });
    return;
  }
...
function Fa(o, e = {}) {
  return {
    kind: "thinking",
    thinking: nd(o.thinking, o.text, o.note),
    hold: e.hold,
    at: e.at
  };
}
...
function ta(o, e) {
  const t = gd(o, e), a = o.rows.filter((r) => r.some((s) => s.trim())).map((r, s) => yd(r, t, s)), i = o.pagination?.pageSize ?? ud(o.pagination?.ranges) ?? Math.min(10, a.length || 10), n = o.pagination?.ranges.map((r, s) => ({
    page: s + 1,
    range: r,
    rows: hd(a, r, s, i)
...
function ld(o) {
  o.rows.forEach((e) => Un(e.values)), o.pagination?.pages.forEach((e) => {
    e.rows.forEach((t) => Un(t.values));
  });
}
function Un(o) {
  o.name && "company" in o && (o.company = "Stripe"), o.prospectDetail && (o.prospectDetail = cd(o.prospectDetail)), o.connector && !o.connectorDetail && (o.connector = dd(o.connector));
}
function cd(o) {
  const e = o.trim();
  return e ? /(?:@|\bat\s+)[A-Z][A-Za-z0-9& .-]+(?:\s*\([^()]*\))?$/i.test(e) ? e.replace(
    /(?:@|\bat\s+)([A-Z][A-Za-z0-9& .-]+?)(\s*\([^()]*\))?$/i,
    (t, a, i = "") => `at Stripe${Hn(i)}`
...
function gd(o, e) {
  const t = o.columns, a = t.findIndex((d) => d.trim().toLowerCase() === "name"), i = a >= 0 ? t.findIndex((d, u) => u > a && /^role\b/i.test(d.trim())) : -1, n = a >= 0 && i >= 0, r = xo(e) ? t.findIndex((d) => d.trim().toLowerCase() === "title") : -1, s = n ? i : r >= 0 ? r : void 0, l = t.map((d, u) => u).filter((d) => d !== i && d !== r), c = l.map((d) => {
    ...
    const h = fd(e, u), g = h.key ?? ne(u || `column-${d + 1}`);
    return {
      key: g,
      label: u,
      width: h.width ?? md(u, n),
      cellType: h.cellType ?? wd(e, u, g),
      person: h.person
    };
  });
  return {
...
function yd(o, e, t) {
  ...
  if (e.columns.forEach((i, n) => {
    ...
    const i = ki(a[e.mutualConnectionKey] ?? ""), n = xd(t);
...
function ki(o) {
  const [e = "", t = ""] = o.split(/\s+[—–]\s+/, 2), a = e.trim().match(/^(.+?)(?:\s*\((.+)\))?$/), i = a?.[1]?.trim() || o.trim(), n = t.trim(), r = od[ne(i).replace(/-/g, " ")], s = vd(a?.[2]?.trim() || "", r, n);
  return {
    name: i,
    title: s.title,
    context: n,
...
function vd(o, e, t) {
  const a = Vn(t), i = a && !/^(?:Stanford GSB|Wharton)$/i.test(a);
...
const Id = {
  ...
  },
  {
    ...
    build: (o) => Ie(o, [
      ...
      { kind: "dataTable", config: Wn, at: "-=0.04" },
      {
        kind: "prompt",
      ...
      { kind: "enrichmentPanel", config: Rd, at: "+=0.12" },
      { kind: "status", text: "Contacts enriched", at: "+=0.86" },
      { kind: "dataTable", config: Qn, at: "-=0.02" },
      { kind: "marketingDataSourcesGrid", config: Yn, at: "+=1.44" },
      $e(Ue.bottomRight, "+=3")
    ])
  },
  {
    ...
    build: (o) => {
      ...
      }), t = o.chat.prepareCursorFile("4 context files", o.cursor, "DOC", jn), a = {
        desktop: { target: "[data-chat-shell]", anchor: "right", outside: "right", offset: { x: 420, y: -74 }, humanOffset: !1 },
        tablet: { target: "[data-chat-shell]", anchor: "right", outside: "right", offset: { x: 360, y: -58 }, humanOffset: !1 },
        mobile: { target: "[data-chat-shell]", anchor: "right", outside: "right", offset: { x: 280, y: -42 }, humanOffset: !1 }
      ...
      return Ie(o, [
        ...
        { kind: "custom", build: () => t.landAsUploadedFiles(jn), at: "<" },
        ...
        {
          kind: "custom",
          build: () => o.chat.outreachStyleProfile(Kn, { scrollAlign: "equal-inset" }),
          at: "-=0.02"
        },
        ...go(Kn.id),
        {
        ...
        { kind: "custom", build: () => o.chat.proximityLeadList(Xn), at: "-=0.04" },
  ...
  },
  {
    ...
    build: (o) => {
      ...
      return Ie(o, [
        ...
        { kind: "dataTable", config: Zn, at: "-=0.02" },
        wo("website-visitors-sales", E.beat + 0.42, "+=0.08", {
          align: "top",
          offset: -190,
          settleDelay: 0.32
        ...
        { kind: "sequenceEngagement", config: va, at: "-=0.02" },
        { kind: "custom", build: () => o.timeline().to({}, { duration: E.beat + 0.24 }), at: "+=0.04" },
        {
          kind: "cursorMove",
          target: r,
  ...
  },
  {
    ...
    build: (o) => {
      ...
      return Ie(o, [
        ...
        { kind: "dataTable", config: Nd, at: "+=0.08" },
        { kind: "status", text: "Cleaning CSV", at: "<" },
        {
          kind: "thinking",
          steps: [
...
class Bd {
  ...
  followPointer = () => {
    ...
    if (this.mode === "sniff") {
      this.updateSniffTarget(e), this.target && this.cursor.mimicViewportPoint(this.target, ma.smoothing, this.target), e - this.sniffStartedAt >= ma.durationMs && this.startReturnAfterPause(), this.scheduleFollow();
      return;
    }
    if (this.mode === "play") {
      if (!this.pointer) {
    ...
    if (this.mode === "return") {
      const t = this.getReturnHomePoint(), a = Fd((e - this.returnStartedAt) / ci.durationMs), i = this.getReturnWavePoint(a, t), n = this.getReturnWavePoint(Math.min(1, a + 0.035), t);
      if (this.target = t, this.cursor.mimicViewportPoint(i, 1, a < 1 ? n : t), a >= 1 || Qe(this.getCursorViewportPoint(), t) <= ci.arriveDistance) {
  ...
  updatePlayTarget(e) {
    ...
    this.target = Ud(n, this.pointer, Ye.minPointerDistance, Ye.viewportInset);
  }
  resumeFollowing(e) {
  ...
  updateSniffTarget(e) {
    ...
    const t = this.sniffIndex, a = t * 1.92, i = ma.radius * (t % 2 === 0 ? 1 : 0.58);
    this.target = {
      x: this.sniffAnchor.x + Math.cos(a) * i,
      y: this.sniffAnchor.y + Math.sin(a) * i * 0.62
    }, this.sniffIndex += 1, this.nextSniffAt = e + ma.pointIntervalMs;
  }
  applyMomentum(e) {
  ...
  getReturnWavePoint(e, t) {
    const a = this.returnStart ?? this.getCursorViewportPoint(), i = zd(e), n = t.x - a.x, r = t.y - a.y, s = Math.hypot(n, r), l = {
      x: a.x + n * i,
      y: a.y + r * i
    };
    if (s < 1) return l;
  ...
  isCursorTooFarFromBrowser() {
    ...
    return Vd(i, e) > ee.maxBrowserDistance;
  }
  getChatShell() {
    return this.chatShell?.isConnected ? this.chatShell : (this.chatShell = this.root.querySelector("[data-chat-shell]"), this.chatShell);
  }
  isPointNearStoryCursor(e, t = ga.radius) {
  ...
  pruneSamples(e) {
    this.pruneSampleList(this.samples, e, ga.sampleWindowMs);
  }
  ...
  hasMimicGesture() {
    return this.samples.length < 4 ? !1 : this.samples.reduce((t, a, i) => {
      ...
      return n ? t + Qe(a, n) : t;
    }, 0) >= ga.minTravel && this.countAxisReversals(this.samples) >= ga.minAxisReversals;
  }
  hasDismissShake() {
  ...
  countAxisReversals(e) {
    ...
    for (let n = 1; n < e.length; n += 1) {
      const r = e[n - 1], s = e[n], l = tr(s.x - r.x), c = tr(s.y - r.y);
...
function er(o, e) {
  return {
    x: $n(o.x, e, window.innerWidth - e),
    y: $n(o.y, e, window.innerHeight - e)
  };
}
function Ud(o, e, t, a) {
  const i = er(Hd(o, e, t), a);
...
class Yd {
  constructor(e, t, a, i, n, r) {
    this.root = e, this.stories = t, this.resolver = a, this.cursor = i, this.chat = n, this.options = r, this.storyProgress = this.stories.map(() => 0), this.pausedCursorMimic = new Bd(this.root, this.cursor, {
  ...
  updateStories(e, t = {}) {
    if (!e.length) return;
    const a = this.stories[this.activeIndex]?.id, i = this.stories, n = new Map(this.stories.map((c, d) => [c.id, this.storyProgress[d] ?? 0])), r = this.cursor.getPosition(), s = this.playing, l = Qd(i, e);
  ...
  rebuildActiveStoryTimeline(e, t, a = 0) {
    this.activeIndex = e, Bn(this.stories, this.activeIndex), this.activeTimeline = this.buildTimeline(this.activeIndex, t), this.renderActiveTimelineProgress(a), this.updateStoryMeta();
  }
  stopTimeline() {
  ...
  seekTo(e) {
    ...
    this.autoAdvance?.kill(), this.seekTween?.kill(), this.seekTween = null, this.setHistoryPaused(!1), this.chat.stopScrollMotion(), this.cursor.clearTransientInteraction(), this.playing = t, this.renderActiveTimelineProgress(e), t && (this.seekTween = f.delayedCall(Wd.resumeDelay, () => {
  ...
  renderActiveTimelineProgress(e) {
    this.activeTimeline && (this.activeTimeline.progress(di(e), !1).pause(), this.updateProgress());
  }
  ...
  attachChatHistoryScroll() {
    ...
    const a = (i) => {
      ...
      if (Math.abs(n) < ar.minPixelDelta) return;
      const r = this.getThreadMaxScroll(t);
      if (r <= 0 || !(n < 0 || this.historyPaused)) return;
      const l = Po(t.scrollTop + n, 0, r);
      if (!(Math.abs(l - t.scrollTop) >= 0.5)) return;
      const d = Math.max(0, n - (r - t.scrollTop));
      i.preventDefault(), this.pauseForChatHistory(), t.scrollTop = l, d >= ar.minPixelDelta && window.scrollBy({ top: d, left: 0, behavior: "auto" });
    };
...
const fa = ["mobile", "tablet", "desktop", "wide"];
class jd {
  constructor(e) {
    this.root = e;
  }
  ...
  resolve(e, t = "target") {
    ...
    if (s = {
      ...
      const l = ro(t), c = Math.min(r.width * 0.18, 18), d = Math.min(r.height * 0.18, 14);
  ...
  pickTarget(e) {
    if (this.isBreakpointMap(e)) {
      const t = this.getBreakpoint(), a = fa.indexOf(t), i = [
        t,
        ...fa.slice(0, a).reverse(),
        ...fa.slice(a + 1)
      ];
      for (const n of i)
        if (e[n]) return e[n];
...
function Kd(o, e = {}) {
  const t = e.stories?.length ? e.stories : Mo, a = e.builderDraftEndpoint ?? "/api/story-draft", i = e.reducedMotion ?? window.matchMedia?.("(prefers-reduced-motion: reduce)").matches ?? !1, n = new jd(o), r = new ec(o), s = new lc(o, n, { reducedMotion: i }), l = new Yd(o, t, n, s, r, {
...
const Xd = 3, Jd = /* @__PURE__ */ new Set([
  "user",
  "assistant",
  "thinking",
  "component",
...
function Zd(o) {
  ...
  const e = typeof o.schemaVersion == "number" ? o.schemaVersion : 1, t = o.stories.map((a) => tu(a)).filter((a) => !!a);
...
function tu(o) {
  ...
  const e = Ce(o.id), t = Ce(o.label), a = Ce(o.summary), i = o.steps.map((n) => au(n)).filter((n) => !!n);
...
function au(o) {
  if (!Pt(o)) return null;
  const e = Ce(o.id), t = Ce(o.kind), a = Ce(o.text), i = Ce(o.note);
  return !e || !t || !$d(t) ? null : {
    id: e,
    kind: t,
    text: a ?? "",
    note: i ?? "",
    thinking: Pt(o.thinking) ? iu(o.thinking, a ?? "", i ?? "") : t === "thinking" ? Ro(a ?? "", i ?? "") : void 0,
    component: Pt(o.component) ? eu(o.component) : void 0
  };
}
function iu(o, e, t) {
  const i = (Array.isArray(o.items) ? o.items : []).map((n, r) => nu(n, r)).filter((n) => !!n);
  return i.length ? {
    title: Ce(o.title) ?? Fe,
    elapsed: Ce(o.elapsed) ?? Na(i.length),
    items: i
  } : Ro(e, t);
}
function nu(o, e) {
  ...
  return t ? {
    label: t,
    detail: Ce(o.detail) ?? Yi(t, e),
    disclosure: Ce(o.disclosure) ?? (e === 0 ? Ct : xa)
  } : null;
}
function Ro(o, e = "") {
  return {
...
async function ru(o, e) {
  try {
    ...
    if (!t.ok) return;
    const a = Zd(await t.json());
    if (!a || a.schemaVersion !== Xd) return;
          ...
          <div class="wa-chat-shell" data-chat-shell>
            ...
            <div class="wa-chat-shell__body">
              <div class="wa-signup-scene" data-signup-scene>
                <span class="wa-signup-scene__logo" data-signup-logo-target aria-hidden="true">${eo}</span>
...
function su(o, e = {}) {
  ou(o);
  const t = Kd(o, e);
  return t.controller.mount(), t.draftEndpoint && ru(t.draftEndpoint, t.applyBuilderStories), t.toInstance();
}
const lu = "[data-chatbot-stories]", cu = "[data-chatbot-stories][data-auto-init]";
function du(o, {
  autoInitSelector: e = cu,
  defaultTarget: t = lu,
  injectStyles: a
} = {}) {
...
typeof window < "u" && (window.ChatbotStories = fu, document.readyState === "loading" ? document.addEventListener("DOMContentLoaded", Ti.autoInit, { once: !0 }) : Ti.autoInit());
export {
  Mo as defaultStories,
  mu as init
};
