...
var pe = {
  ...
  overwrite: !1,
  delay: 0
}, fi, K, U, ye = 1e8, z = 1 / ye, ei = Math.PI * 2, no = ei / 4, ro = 0, qn = Math.sqrt, oo = Math.cos, so = Math.sin, $ = function(e) {
...
}, ee = Array.isArray, lo = /random\([^)]+\)/g, co = /,\s*/g, Bi = /(?:-?\.?\d|\.)+/gi, Bn = /[-+=.]*\d+[.e\-+]*\d*[e\-+]*\d*/g, wt = /[-+=.]*\d+[.e-]*\d*[a-z%]*/g, Pa = /[-+=.]*\d+\.?\d*(?:e-|e\+)?\d*/gi, zn = /[+-]=-?[.\d]+/, uo = /[^,'"\[\]\s]+/gi, ho = /^[+\-=e\s\d]*\d+[.\d]*([a-z]*|%)\s*$/i, W, Se, ti, yi, ge = {}, pa = {}, Fn, Hn = function(e) {
  return (pa = At(e, ge)) && se;
}, _i = function(e, t) {
  ...
  suppressEvents: !0
}, xi = {}, Xe = [], ai = {}, Gn, ce = {}, Ra = {}, zi = 30, da = [], vi = "", ki = function(e) {
  var t = e[0], a, i;
  ...
  Xe.length && !K && ga(), e.render(t, a, !!(K && t < 0 && Ai(e))), Xe.length && !K && ga();
}, Yn = function(e) {
  var t = parseFloat(e);
  return (t || t === 0) && (e + "").match(uo).length < 2 ? t : $(e) ? e.trim() : e;
}, jn = function(e) {
  return e;
}, me = function(e, t) {
  for (var a in t)
  ...
  var t = e.parent || W, a = e.keyframes ? fo(ee(e.keyframes)) : me;
  if (ie(e.inherit))
    for (; t; )
  ...
  var a = e._dp;
  return a && a.smoothChildTiming && e._ts && (e._start = G(a._time - (e._ts > 0 ? t / e._ts : ((e._dirty ? e.totalDuration() : e._tDur) - t) / -e._ts)), ka(e), a._dirty || dt(a, e)), e;
}, $n = function(e, t) {
  var a;
  if ((t._time || !t._dur && t._initted || t._start < e._time && (t._dur || !t.add)) && (a = fa(e.rawTime(), t), (!t._dur || ea(0, t.totalDuration(), a) - t._tTime > z) && t.render(a, !0)), dt(e, t)._dp && e._initted && e._time >= e._dur && e._ts) {
  ...
  return t.parent && Ke(t), t._start = G((Fe(a) ? a : a || e !== W ? be(e, a, t) : e._time) + t._delay), t._end = G(t._start + (t.totalDuration() / Math.abs(t.timeScale()) || 0)), Xn(e, t, "_first", "_last", e._sort ? "_start" : 0), ni(t) || (e._recent = t), i || $n(e, t), e._ts < 0 && Aa(e, e._tTime), e;
}, Kn = function(e, t) {
  return (ge.ScrollTrigger || _i("scrollTrigger", t)) && ge.ScrollTrigger.create(t, e);
}, Qn = function(e, t, a, i, n) {
  if (Ci(e, t, n), !e._initted)
    return 1;
  if (!a && e._pt && !K && (e._dur && e.vars.lazy !== !1 || !e._dur && e.vars.lazy) && Gn !== de.frame)
  ...
  var n = e.ratio, o = t < 0 || !t && (!e._start && _o(e) && !(!e._initted && ni(e)) || (e._ts < 0 || e._dp._ts < 0) && !ni(e)) ? 0 : 1, s = e._rDelay, l = 0, c, d, u;
  if (s && e._repeat && (l = ea(0, e._tDur, t), d = St(l, s), e._yoyo && d & 1 && (o = 1 - o), d !== St(e._tTime, s) && (n = 1 - o, e.vars.repeatRefresh && e._initted && e.invalidate())), o !== n || K || i || e._zTime === z || !t && e._zTime) {
    ...
    for (u = e._zTime, e._zTime = t || (a ? z : 0), a || (a = t && !u), e.ratio = o, e._from && (o = 1 - o), e._time = 0, e._tTime = l, c = e._pt; c; )
      c.r(o, c.d), c = c._next;
    t < 0 && ii(e, t, a, !0), e._onUpdate && !a && ue(e, "onUpdate"), l && e._repeat && !a && e.parent && ue(e, "onRepeat"), (t >= e._tDur || t < 0) && e.ratio === o && (o && Ke(e, 1), !a && !K && (ue(e, o ? "onComplete" : "onReverseComplete", !0), e._prom && e._prom()));
  ...
  return s && !i && (e._time *= o / e._dur), e._dur = o, e._tDur = n ? n < 0 ? 1e10 : G(o * (n + 1) + e._rDelay * n) : o, s > 0 && !i && Aa(e, e._tTime = e._tDur * s), e.parent && ka(e), a || dt(e.parent, e), e;
}, Ui = function(e) {
  ...
  var i = e.labels, n = e._recent || ko, o = e.duration() >= ye ? n.endTime(!1) : e._dur, s, l, c;
  ...
  return !$(e) || !(t = ho.exec(e)) ? "" : t[1];
}, Ao = function(e, t, a) {
  return Je(a, function(i) {
    return ea(e, t, i);
  });
}, ri = [].slice, Zn = function(e, t) {
  return e && Me(e) && "length" in e && (!t && !e.length || e.length - 1 in e && Me(e[0])) && !e.nodeType && e !== Se;
}, So = function(e, t, a) {
  return a === void 0 && (a = []), e.forEach(function(i) {
    var n;
    return $(i) && !t || Zn(i, 1) ? (n = a).push.apply(n, _e(i)) : a.push(i);
  }) || a;
}, _e = function(e, t, a) {
  return U && !t && U.selector ? U.selector(e) : $(e) && !a && (ti || !Tt()) ? ri.call((t || yi).querySelectorAll(e), 0) : ee(e) ? So(e, a) : Zn(e) ? ri.call(e, 0) : e ? [e] : [];
}, oi = function(e) {
  return e = _e(e)[0] || Wt("Invalid scope") || {}, function(t) {
    var a = e.current || e.nativeElement || e;
    return _e(t, a.querySelectorAll ? a : a === e ? Wt("Invalid scope") || yi.createElement("div") : e);
  };
}, Jn = function(e) {
  ...
  return $(i) ? d = u = {
    ...
    if (!w) {
      ...
      i === "random" && Jn(w), w.max = k - C, w.min = C, w.v = h = (parseFloat(t.amount) || parseFloat(t.each) * (S > h ? h - 1 : c ? c === "y" ? h / S : S : Math.max(S, h / S)) || 0) * (i === "edges" ? -1 : 1), w.b = h < 0 ? n - h : n, w.u = J(t.amount || t.each) || 0, a = a && h < 0 ? Bo(a) : a;
    }
  ...
  var a = ee(e), i, n;
  return !a && Me(e) && (i = a = e.radius || ye, e.values ? (e = _e(e.values), (n = !Fe(e[0])) && (i *= i)) : e = si(e.increment)), Je(t, a ? Y(e) ? function(o) {
  ...
  var i = t - e;
  return ee(e) ? ir(e, r(0, e.length), t) : Je(a, function(n) {
    return (i + (n - e) % i) % i + e;
  });
}, Po = function r(e, t, a) {
  var i = t - e, n = i * 2;
  return ee(e) ? ir(e, r(0, e.length - 1), t) : Je(a, function(o) {
  ...
  if (e)
    if (e = !e.name && e.default || e, bi() || e.headless) {
      ...
      if (Tt(), e !== i) {
        if (ce[t])
          return;
        me(i, me(ma(e, n), o)), At(i.prototype, At(n, ma(e, o))), ce[i.prop = t] = i, e.targetTest && (da.push(i), xi[t] = 1), t = (t === "css" ? "CSS" : t.charAt(0).toUpperCase() + t.substr(1)) + "Plugin";
      }
      Un(t, i), e.register && e.register(se, i, re);
    } else
      rr.push(e);
}, B = 255, Nt = {
  aqua: [0, B, B],
  ...
  var i = e ? Fe(e) ? [e >> 16, e >> 8 & B, e & B] : 0 : Nt.black, n, o, s, l, c, d, u, g, p, f;
  if (!i) {
    if (e.substr(-1) === "," && (e = e.substr(0, e.length - 1)), Nt[e])
      ...
      if (i = f = e.match(Bi), !t)
        ...
        return i = e.match(Bn), a && i.length < 4 && (i[3] = 1), i;
    } else
  ...
  if (n = n.map(function(g) {
    return (g = sr(g, t, 1)) && o + (t ? g[0] + "," + g[1] + "%," + g[2] + "%," + g[3] : g.join(",")) + ")";
  }), a && (d = lr(e), l = a.c, l.join(i) !== d.c.join(i)))
...
})(), Io = /hsl[a]?\(/, cr = function(e) {
  var t = e.join(" "), a;
  if ($e.lastIndex = 0, $e.test(t))
    return a = Io.test(t), e[1] = Wi(e[1], a), e[0] = Wi(e[0], a, lr(e[1])), !0;
}, jt, de = (function() {
  ...
  return u = {
    ...
    wake: function() {
      Fn && (!ti && bi() && (Se = ti = window, yi = Se.document || {}, ge.gsap = se, (Se.gsapVersions || (Se.gsapVersions = [])).push(se.version), Hn(pa || Se.GreenSockGlobals || !Se.gsap && Se || {}), rr.forEach(or)), d = typeof requestAnimationFrame < "u" && requestAnimationFrame, l && u.sleep(), c = d || function(w) {
  ...
  return !jt && de.wake();
}, R = {}, Lo = /^[\d.\-M][\d.\-,\s]/, Do = /["']/g, No = function(e) {
  for (var t = {}, a = e.substr(1, e.length - 3).split(":"), i = a[0], n = 1, o = a.length, s, l, c; n < o; n++)
    l = a[n], s = n !== o - 1 ? l.lastIndexOf(",") : l.length, c = l.substr(0, s), t[i] = isNaN(c) ? c.replace(Do, "").trim() : +c, i = l.substr(s + 1).trim();
  return t;
}, qo = function(e) {
  ...
  return a && t.length > 1 && a.config ? a.config.apply(null, ~e.indexOf("{") ? [No(t[1])] : qo(e).split(",").map(Yn)) : R._CE && Lo.test(e) ? R._CE("", e) : a;
}, Bo = function(e) {
  return function(t) {
    return 1 - e(1 - t);
  };
}, ut = function(e, t) {
  return e && (Y(e) ? e : R[e] || Oo(e)) || t;
}, pt = function(e, t, a, i) {
  ...
  var i = t >= 1 ? t : 1, n = (a || (e ? 0.3 : 0.45)) / (t < 1 ? t : 1), o = n / ei * (Math.asin(1 / i) || 0), s = function(d) {
    return d === 1 ? 1 : i * Math.pow(2, -10 * d) * so((d - o) * n) + 1;
...
pt("Sine", function(r) {
  return r === 1 ? 1 : -oo(r * no) + 1;
});
pt("Back", Da("in"), Da("out"), Da());
...
var ur = function(e, t) {
  this.id = ro++, e._gsap = this, this.target = e, this.harness = t, this.get = t ? t.get : Wn, this.set = t ? t.getSetter : Ei;
}, Xt = /* @__PURE__ */ (function() {
  function r(t) {
    this.vars = t, this._delay = +t.delay || 0, (this._repeat = t.repeat === 1 / 0 ? -2 : t.repeat || 0) && (this._rDelay = t.repeatDelay || 0, this._yoyo = !!t.yoyo || !!t.yoyoEase), this._ts = 1, Ct(this, +t.duration, 1, 1), this.data = t.data, U && (this._ctx = U, U.data.push(this)), jt || de.wake();
  }
  var e = r.prototype;
  return e.delay = function(a) {
    ...
    if (n && n.smoothChildTiming && this._ts) {
      for (Aa(this, a), !n._dp || n.parent || $n(n, this); n && n.parent; )
    ...
    return (this._tTime !== a || !this._dur && !i || this._initted && Math.abs(this._zTime) === z || !this._initted && this._dur && a || !a && !this._initted && (this.add || this._ptLookup)) && (this._ts || (this._pTime = a), Vn(this, a, i)), this;
  }, e.time = function(a, i) {
    ...
    return this._rts = +a || 0, this._ts = this._ps || a === -z ? 0 : this._rts, this.totalTime(ea(-Math.abs(this._delay), this.totalDuration(), n), i !== !1), ka(this), bo(this);
  }, e.paused = function(a) {
...
var ae = /* @__PURE__ */ (function(r) {
  ...
  function e(a, i) {
    var n;
    return a === void 0 && (a = {}), n = r.call(this, a) || this, n.labels = {}, n.smoothChildTiming = !!a.smoothChildTiming, n.autoRemoveChildren = !!a.autoRemoveChildren, n._sort = ie(a.sortChildren), W && Ce(a.parent || W, De(n), i), a.reversed && n.reverse(), a.paused && n.paused(!0), a.scrollTrigger && Kn(De(n), a.scrollTrigger), n;
  }
  var t = e.prototype;
  return t.to = function(i, n, o) {
    ...
    return n.duration = 0, n.parent = this, zt(n).repeatDelay || (n.repeat = 0), n.immediateRender = !!n.immediateRender, new X(i, n, be(this, o), 1), this;
    ...
    return o.runBackwards = 1, zt(o).immediateRender = ie(o.immediateRender), this.staggerTo(i, n, o, s, l, c, d);
  }, t.staggerFromTo = function(i, n, o, s, l, c, d, u) {
    return s.startAt = o, zt(s).immediateRender = ie(s.immediateRender), this.staggerTo(i, n, s, l, c, d, u);
    ...
    if (this !== W && d > l && i >= 0 && (d = l), d !== this._tTime || o || u) {
      ...
      if (this._hasPause && !this._forcing && this._lock < 2 && (y = vo(this, G(s), G(g)), y && (d -= g - (g = y._start))), this._tTime = d, this._time = g, this._act = !!x, this._initted || (this._onUpdate = this.vars.onUpdate, this._initted = 1, this._zTime = i, s = 0), !s && d && c && !n && !_ && (ue(this, "onStart"), this._tTime !== d))
        return this;
      if (g >= s && i >= 0)
        for (p = this._first; p; ) {
    ...
    var o = this;
    if (Fe(n) || (n = be(this, n, i)), !(i instanceof Xt)) {
      if (ee(i))
    ...
    return $(i) ? this.removeLabel(i) : Y(i) ? this.killTweensOf(i) : (i.parent === this && va(this, i), i === this._recent && (this._recent = this._last), dt(this));
    ...
    for (var o = [], s = _e(i), l = this._first, c = Fe(n), d; l; )
      l instanceof X ? mo(l._targets, s) && (c ? (!We || l._initted && l._ts) && l.globalTime(0) <= n && l.globalTime(l.totalDuration()) > n : !n || l.isActive()) && o.push(l) : (d = l.getTweensOf(s, n)).length && o.push.apply(o, d), l = l._next;
    return o;
    ...
    if (W._ts && (Vn(W, fa(i, W)), Gn = de.frame), de.frame >= zi) {
      zi += pe.autoSleep || 120;
      var n = W._first;
...
var zo = function(e, t, a, i, n, o, s) {
  var l = new re(this._pt, e, t, 0, 1, wr, null, n), c = 0, d = 0, u, g, p, f, h, w, b, y;
  for (l.b = a, l.e = i, a += "", i += "", (b = ~i.indexOf("random(")) && (i = Yt(i)), o && (y = [a, i], o(y, e, t), a = y[0], i = y[1]), g = a.match(Pa) || []; u = Pa.exec(i); )
  ...
  Y(i) && (i = i(n || 0, e, o));
  var u = e[t], g = a !== "get" ? a : Y(u) ? c ? e[t.indexOf("set") || !Y(e["get" + t.substr(3)]) ? t : "get" + t.substr(3)](c) : e[t]() : u, p = Y(u) ? c ? Wo : mr : Ti, f;
  if ($(i) && (~i.indexOf("random(") && (i = Yt(i)), i.charAt(1) === "=" && (f = yt(g, i) + (J(g) || 0), (f || f === 0) && (i = f))), !d || g !== i || li)
    return !isNaN(g * i) && i !== "" ? (f = new re(this._pt, e, t, +g || 0, i - (g || 0), typeof u == "boolean" ? Yo : fr, 0, p), c && (f.fp = c), s && f.modifier(s, this, e), this._pt = f) : (!u && !(t in e) && _i(t, i), zo.call(this, e, t, g, i, p, l || pe.stringFilter, c));
}, Fo = function(e, t, a, i, n) {
  if (Y(e) && (e = Ht(e, n, t, a, i)), !Me(e) || e.style && e.nodeType || ee(e) || On(e))
    return $(e) ? Ht(e, n, t, a, i) : e;
  var o = {}, s;
  for (s in e)
    o[s] = Ht(e[s], n, t, a, i);
  return o;
}, hr = function(e, t, a, i, n, o) {
  var s, l, c, d;
  if (ce[e] && (s = new ce[e]()).init(n, s.rawVars ? t[e] : Fo(t[e], i, n, o, a), a, i, o) !== !1 && (a._pt = l = new re(a._pt, n, e, 0, 1, s.render, s, 0, s.priority), a !== bt))
    for (c = a._ptLookup[a._targets.indexOf(n)], d = s._props.length; d--; )
      c[s._props[d]] = l;
  return s;
}, We, li, Ci = function r(e, t, a) {
  var i = e.vars, n = i.ease, o = i.startAt, s = i.immediateRender, l = i.lazy, c = i.onUpdate, d = i.runBackwards, u = i.yoyoEase, g = i.keyframes, p = i.autoRevert, f = e._dur, h = e._startAt, w = e._targets, b = e.parent, y = b && b.data === "nested" ? b.vars.targets : w, x = e._overwrite === "auto" && !fi, v = e.timeline, _ = i.easeReverse || u, T, k, C, S, E, F, O, L, I, N, P, H, Q;
  if (v && (!g || !n) && (n = "none"), e._ease = ut(n, Gt.ease), e._rEase = _ && (ut(_) || e._ease), e._from = !v && !!i.runBackwards, e._from && (e.ratio = 1), !v || g && !i.stagger) {
    if (L = w[0] ? ct(w[0]).harness : 0, H = L && i[L.prop], T = ma(i, xi), h && (h._zTime < 0 && h.progress(1), t < 0 && d && s && !p ? h.render(-1, !0) : h.revert(d && f ? ca : po), h._lazy = 0), o) {
      ...
      }, T), H && (C[L.prop] = H), Ke(e._startAt = X.set(w, C)), e._startAt._dp = 0, e._startAt._sat = e, t < 0 && (K ? e._startAt.revert(ca) : e._startAt.render(-1, !0)), e._zTime = t, !s)
        r(e._startAt, z, z);
      else if (!t)
        return;
    }
    for (e._pt = e._ptCache = 0, l = f && ie(l) || l && !f, k = 0; k < w.length; k++) {
      if (E = w[k], O = E._gsap || ki(w)[k]._gsap, e._ptLookup[k] = N = {}, ai[O.id] && Xe.length && ga(), P = y === w ? k : y.indexOf(E), L && (I = new L()).init(E, H || T, e, P, y) !== !1 && (e._pt = S = new re(e._pt, E, I.name, 0, 1, I.render, I, 0, I.priority), I._props.forEach(function(Pe) {
        N[Pe] = S;
      }), I.priority && (F = 1)), !L || H)
        for (C in T)
          ce[C] && (I = hr(C, T, e, P, E, y)) ? I.priority && (F = 1) : N[C] = S = Si.call(e, E, C, "get", T[C], P, y, 0, i.stringFilter);
      e._op && e._op[k] && e.kill(E, e._op[k]), x && e._pt && (We = e, W.killTweensOf(E, N, e.globalTime(t)), Q = !e.parent, We = 0), e._pt && l && (ai[O.id] = 1);
    }
    F && br(e), e._onInit && e._onInit(e);
  }
  e._onUpdate = c, e._initted = (!e._op || e._pt) && !Q, g && t <= 0 && v.render(ye, !0, !0);
}, Ho = function(e, t, a, i, n, o, s, l) {
    ...
    for (c = e._ptCache[t] = [], g = e._ptLookup, p = e._targets.length; p--; ) {
      if (d = g[p][t], d && d.d && d.d._pt)
        for (d = d.d._pt; d && d.p !== t && d.fp !== t; )
          d = d._next;
      if (!d)
        return li = 1, e.vars[t] = "+=0", Ci(e, s), li = 0, l ? Wt(t + " not eligible for reset. Try splitting into individual properties") : 1;
      c.push(d);
    }
  for (p = c.length; p--; )
  ...
  return Y(e) ? e.call(t, a, i, n) : $(e) && ~e.indexOf("random(") ? Yt(e) : e;
}, pr = vi + "repeat,repeatDelay,yoyo,repeatRefresh,yoyoEase,easeReverse,autoRevert", gr = {};
ne(pr + ",id,stagger,delay,duration,paused,scrollTrigger", function(r) {
  return gr[r] = 1;
});
var X = /* @__PURE__ */ (function(r) {
  ...
  function e(a, i, n, o) {
    ...
    var l = s.vars, c = l.duration, d = l.delay, u = l.immediateRender, g = l.stagger, p = l.overwrite, f = l.keyframes, h = l.defaults, w = l.scrollTrigger, b = i.parent || W, y = (ee(a) || On(a) ? Fe(a[0]) : "length" in i) ? [a] : _e(a), x, v, _, T, k, C, S, E;
    if (s._targets = y.length ? ki(y) : Wt("GSAP target " + a + " not found. https://gsap.com", !pe.nullTargetWarn) || [], s._ptLookup = [], s._overwrite = p, f || g || ta(c) || ta(d)) {
      i = s.vars;
      ...
      if (x = s.timeline = new ae({
      ...
      }), x.kill(), x.parent = x._dp = De(s), x._start = 0, g || ta(c) || ta(d)) {
        if (T = y.length, S = g && er(g), Me(g))
          for (k in g)
            ~pr.indexOf(k) && (E || (E = {}), E[k] = g[k]);
        for (v = 0; v < T; v++)
          _ = ma(i, gr), _.stagger = 0, F && (_.easeReverse = F), E && At(_, E), C = y[v], _.duration = +Ht(c, De(s), v, C, y), _.delay = (+Ht(d, De(s), v, C, y) || 0) - s._delay, !g && T === 1 && _.delay && (s._delay = d = _.delay, s._start += d, _.delay = 0), x.to(C, _, S ? S(v, C, y) : 0), x._ease = R.none;
        x.duration() ? c = d = 0 : s.timeline = 0;
      } else if (f) {
        zt(me(x.vars.defaults, {
          ease: "none"
        ...
        if (ee(f))
          ...
          _ = {};
          for (k in f)
            k === "ease" || k === "easeEach" || Go(k, f[k], _, f.easeEach);
          for (k in _)
      ...
      s.timeline = 0;
    return p === !0 && !fi && (We = De(s), W.killTweensOf(y), We = 0), Ce(b, De(s), n), i.reversed && s.reverse(), i.paused && s.paused(!0), (u || !c && !f && s._start === G(b._time) && ie(u) && yo(De(s)) && b.data !== "nested") && (s._tTime = -z, s.render(Math.max(0, -d) || 0)), w && Kn(De(s), w), s;
  }
  var t = e.prototype;
  return t.render = function(i, n, o) {
    ...
    if (!c)
      ...
      for (p = this._pt; p; )
        p.r(y, p.d), p = p._next;
      x && x.render(i < 0 ? i : x._dur * x._ease(g / this._dur), n, o) || this._startAt && (this._zTime = i), this._onUpdate && !n && (d && ii(this, i, n, o), ue(this, "onUpdate")), this._repeat && f !== w && this.vars.onRepeat && !n && this.parent && ue(this, "onRepeat"), (u === this._tDur || !u) && this._tTime === u && (d && !this._onUpdate && ii(this, i, !0, !0), (i || !c) && (u === this._tDur && this._ts > 0 || !u && this._ts < 0) && Ke(this, 1), !n && !(d && !s) && (u || s || b) && (ue(this, u === l ? "onComplete" : "onReverseComplete", !0), this._prom && !(u < l && this.timeScale() > 0) && this._prom()));
    }
    return this;
  }, t.targets = function() {
    ...
    return this._initted || Ci(this, c), d = this._ease(c / this._dur), Ho(this, i, n, o, s, d, c, l) ? this.resetTo(i, n, o, s, 1) : (Aa(this, 0), this.parent || Xn(this._dp, this, "_first", "_last", this._dp._sort ? "_start" : 0), this.render(0));
  }, t.kill = function(i, n) {
    if (n === void 0 && (n = "all"), !i && (!n || n === "all"))
      return this._lazy = this._pt = 0, this.parent ? Dt(this) : this.scrollTrigger && this.scrollTrigger.kill(!!K), this;
    if (this.timeline) {
      var o = this.timeline.totalDuration();
      return this.timeline.killTweensOf(i, n, We && We.vars.overwrite !== !0)._first || Dt(this), this.parent && o !== this.timeline.totalDuration() && Ct(this, this._dur * this.timeline._tDur / o, 0, 1), this;
    }
...
ne("staggerTo,staggerFrom,staggerFromTo", function(r) {
  X[r] = function() {
    var e = new ae(), t = ri.call(arguments, 0);
...
var Ti = function(e, t, a) {
  ...
  return Y(e[t]) ? mr : wi(e[t]) && e.setAttribute ? Vo : Ti;
}, fr = function(e, t) {
  ...
  function r(t, a, i, n, o, s, l, c, d) {
    this.t = a, this.s = n, this.c = o, this.p = i, this.r = s || fr, this.d = l || this, this.set = c || Ti, this.pr = d || 0, this._next = t, t && (t._prev = this);
  }
  var e = r.prototype;
  return e.modifier = function(a, i, n) {
    this.mSet = this.mSet || this.set, this.set = $o, this.m = a, this.mt = n, this.tween = i;
  }, r;
})();
ne(vi + "parent,duration,ease,delay,overwrite,runBackwards,startAt,yoyo,immediateRender,repeat,repeatDelay,data,paused,reversed,lazy,callbackScope,stringFilter,id,yoyoEase,stagger,inherit,repeatRefresh,keyframes,autoRevert,scrollTrigger,easeReverse", function(r) {
  return xi[r] = 1;
});
...
pe.stringFilter = cr;
var ht = [], ua = {}, Ko = [], Vi = 0, Qo = 0, Na = function(e) {
  return (ua[e] || Ko).map(function(t) {
    return t();
  });
}, ci = function() {
  var e = Date.now(), t = [];
  e - Vi > 2 && (Na("matchMediaInit"), ht.forEach(function(a) {
  ...
  function r(t, a) {
    this.selector = a && oi(a), this.data = [], this._r = [], this.isReverted = !1, this.id = Qo++, t && this.add(t);
  }
  var e = r.prototype;
  ...
  return e.add = function(a, i, n) {
    ...
    var o = new yr(0, n || this.scope), s = o.conditions = {}, l, c, d;
    U && !o.selector && (o.selector = U.selector), this.contexts.push(o), i = o.add("onMatch", i), o.queries = a;
    for (c in a)
      c === "all" ? d = 1 : (l = Se.matchMedia(a[c]), l && (ht.indexOf(o) < 0 && ht.push(o), (s[c] = l.matches) && (d = 1), l.addListener ? l.addListener(ci) : l.addEventListener("change", ci)));
  ...
  quickSetter: function(e, t, a) {
    ...
    var o = ce[t], s = ct(e), l = s.harness && (s.harness.aliases || {})[t] || t, c = o ? function(d) {
      var u = new o();
      bt._pt = 0, u.init(e, a ? d + a : d, bt, 0, [e]), u.render(1, u), bt._pt && Mi(1, bt);
    } : s.set(e, l);
  ...
  defaults: function(e) {
    return e && e.ease && (e.ease = ut(e.ease, Gt.ease)), Fi(Gt, e || {});
  },
  config: function(e) {
    return Fi(pe, e || {});
  },
  registerEffect: function(e) {
    ...
    (i || "").split(",").forEach(function(s) {
      return s && !ce[s] && !ge[s] && Wt(t + " effect requires " + s + " plugin.");
    }), Ra[t] = function(s, l, c) {
      return a(_e(s), me(l || {}, n), c);
    }, o && (ae.prototype[t] = function(s, l, c) {
      return this.add(Ra[t](s, Me(l) ? l : (c = l) && {}, this), c);
    });
  },
...
}, qa("roundProps", si), qa("modifiers"), qa("snap", tr)) || wa;
...
R.Expo;
R.Circ;
var Yi, Ve, _t, Pi, lt, ji, Ri, ts = function() {
  return typeof window < "u";
}, He = {}, st = 180 / Math.PI, xt = Math.PI / 180, gt = Math.atan2, Xi = 1e8, Ii = /([A-Z])/g, as = /(left|right|width|margin|padding|x)/i, is = /[\s,\(]\S/, Ee = {
...
}, V = "transform", oe = V + "Origin", gs = function r(e, t) {
  ...
  if (this.tfm) {
    for (o in this.tfm)
      i[o] = this.tfm[o];
    i.svg && (i.renderTransform(), t.setAttribute("data-svg-origin", this.svgo || "")), n = Ri(), (!n || !n.isStart) && !a[V] && (vr(a), i.zOrigin && a[oe] && (a[oe] += " " + i.zOrigin + "px", i.zOrigin = 0, i.renderTransform()), i.uncache = 1);
  }
}, kr = function(e, t) {
  var a = {
    target: e,
  ...
  return i[t] || i.getPropertyValue(t.replace(Ii, "-$1").toLowerCase()) || i.getPropertyValue(t) || !a && r(e, Et(t) || t, 1) || "";
}, $i = "O,Moz,ms,Ms,Webkit".split(","), Et = function(e, t, a) {
  ...
  ts() && window.document && (Yi = window, Ve = Yi.document, _t = Ve.documentElement, lt = ui("div") || {
    style: {}
  }, ui("div"), V = Et(V), oe = V + "Origin", lt.style.cssText = "border-width:0;line-height:0;position:absolute;padding:0", Ar = !!Et("perspective"), Ri = se.core.reverting, Pi = 1);
}, Ki = function(e) {
  ...
  if (t) {
    var a = e.style, i;
    t in He && t !== oe && (t = V), a.removeProperty ? (i = t.substr(0, 2), (i === "ms" || t.substr(0, 6) === "webkit") && (t = "-" + t), a.removeProperty(i === "--" ? t : t.replace(Ii, "-$1").toLowerCase())) : a.removeAttribute(t);
  }
}, Ye = function(e, t, a, i, n, o) {
  var s = new re(e._pt, t, a, 0, 1, o ? xr : _r);
  ...
  var n = parseFloat(a) || 0, o = (a + "").trim().substr((n + "").length) || "px", s = lt.style, l = as.test(t), c = e.tagName.toLowerCase() === "svg", d = (c ? "client" : "offset") + (l ? "Width" : "Height"), u = 100, g = i === "px", p = i === "%", f, h, w, b;
  if (i === o || !n || Zi[i] || Zi[o])
    return n;
  if (o !== "px" && !g && (n = r(e, t, a, "px")), b = e.getCTM && Cr(e), (p || o === "%") && (He[t] || ~t.indexOf("adius")))
  ...
  if (p && (t === "height" || t === "width")) {
    ...
    (p || o === "%") && !fs[he(h, "display")] && (s.position = he(e, "position")), h === e && (s.position = "static"), h.appendChild(lt), f = lt[d], h.removeChild(lt), s.position = "absolute";
  return l && p && (w = ct(h), w.time = de.time, w.width = h[d]), j(g ? f * n / u : f && n ? u / f * n : 0);
}, qe = function(e, t, a, i) {
  var n;
  return Pi || hi(), t in Ee && t !== "transform" && (t = Ee[t], ~t.indexOf(",") && (t = t.split(",")[0])), He[t] && t !== "transform" ? (n = Kt(e, i), n = t !== "transformOrigin" ? n[t] : n.svg ? n.origin : ya(he(e, oe)) + " " + n.zOrigin + "px") : (n = e.style[t], (!n || n === "auto" || i || ~(n + "").indexOf("calc(")) && (n = ba[t] && ba[t](e, t, a) || he(e, t) || Wn(e, t) || (t === "opacity" ? 1 : 0))), a && !~(n + "").trim().indexOf(" ") ? Ze(e, t, n, a) + a : n;
}, ws = function(e, t, a, i) {
  if (!a || a === "none") {
    var n = Et(t, e, 1), o = n && he(e, n, 1);
    o && o !== a ? (t = n, a = o) : t === "borderColor" && (a = he(e, "borderTopColor"));
  }
  var s = new re(this._pt, e.style, t, 0, 1, wr), l = 0, c = 0, d, u, g, p, f, h, w, b, y, x, v, _;
  if (s.b = a, s.e = i, a += "", i += "", i.substring(0, 6) === "var(--" && (i = he(e, i.substring(4, i.indexOf(")")))), i === "auto" && (h = e.style[t], e.style[t] = i, i = he(e, t) || i, h ? e.style[t] = h : Qe(e, t)), d = [a, i], cr(d), a = d[0], i = d[1], g = a.match(wt) || [], _ = i.match(wt) || [], _.length) {
    for (; u = wt.exec(i); )
  ...
  if (t.tween && t.tween._time === t.tween._dur) {
    ...
    l && (Qe(a, V), o && (o.svg && a.removeAttribute("transform"), i.scale = i.rotate = i.translate = "none", Kt(a, 1), o.uncache = 1, vr(i)));
  }
}, ba = {
  clearProps: function(e, t, a, i, n) {
    if (n.data !== "isFromStart") {
      var o = e._pt = new re(e._pt, t, a, 0, 0, ys);
  ...
  */
}, $t = [1, 0, 0, 1, 0, 0], Tr = {}, Er = function(e) {
  return e === "matrix(1, 0, 0, 1, 0, 0)" || e === "none" || !e;
}, en = function(e) {
  var t = he(e, V);
  return Er(t) ? $t : t.substr(7).match(Bn).map(j);
}, Li = function(e, t) {
  var a = e._gsap || ct(e), i = e.style, n = en(e), o, s, l, c;
  return a.svg && e.getAttribute("transform") ? (l = e.transform.baseVal.consolidate().matrix, n = [l.a, l.b, l.c, l.d, l.e, l.f], n.join(",") === "1,0,0,1,0,0" ? $t : n) : (n === $t && !e.offsetParent && e !== _t && !a.svg && (l = i.display, i.display = "block", o = e.parentNode, (!o || !e.offsetParent && !e.getBoundingClientRect().width) && (c = 1, s = e.nextElementSibling, _t.appendChild(e)), n = en(e), l ? i.display = l : Qe(e, "display"), c && (s ? o.insertBefore(e, s) : o ? o.appendChild(e) : _t.removeChild(e))), t && n.length > 6 ? [n[0], n[1], n[4], n[5], n[12], n[13]] : n);
  ...
  a ? l !== $t && (k = p * w - f * h) && (C = v * (w / k) + _ * (-h / k) + (h * y - w * b) / k, S = v * (-f / k) + _ * (p / k) - (p * y - f * b) / k, v = C, _ = S) : (T = Sr(e), v = T.x + (~x[0].indexOf("%") ? v / 100 * T.width : v), _ = T.y + (~(x[1] || x[0]).indexOf("%") ? _ / 100 * T.height : _)), i || i !== !1 && s.smooth ? (b = v - c, y = _ - d, s.xOffset = u + (b * p + y * h) - b, s.yOffset = g + (b * f + y * w) - y) : s.xOffset = s.yOffset = 0, s.xOrigin = v, s.yOrigin = _, s.smooth = !!i, s.origin = t, s.originIsAbsolute = !!a, e.style[oe] = "0px 0px", o && (Ye(o, s, "xOrigin", c, v), Ye(o, s, "yOrigin", d, _), Ye(o, s, "xOffset", u, s.xOffset), Ye(o, s, "yOffset", g, s.yOffset)), e.setAttribute("data-svg-origin", v + " " + _);
}, Kt = function(e, t) {
  var a = e._gsap || new ur(e);
  if ("x" in a && !t && !a.uncache)
    return a;
  var i = e.style, n = a.scaleX < 0, o = "px", s = "deg", l = getComputedStyle(e), c = he(e, oe) || "0", d, u, g, p, f, h, w, b, y, x, v, _, T, k, C, S, E, F, O, L, I, N, P, H, Q, Pe, ve, Mt, et, Oi, Re, tt;
  return d = u = g = h = w = b = y = x = v = 0, p = f = 1, a.svg = !!(e.getCTM && Cr(e)), l.translate && ((l.translate !== "none" || l.scale !== "none" || l.rotate !== "none") && (i[V] = (l.translate !== "none" ? "translate3d(" + (l.translate + " 0 0").split(" ").slice(0, 3).join(", ") + ") " : "") + (l.rotate !== "none" ? "rotate(" + l.rotate + ") " : "") + (l.scale !== "none" ? "scale(" + l.scale.split(" ").join(",") + ") " : "") + (l[V] !== "none" ? l[V] : "")), i.scale = i.rotate = i.translate = "none"), k = Li(e, a.svg), a.svg && (a.uncache ? (Q = e.getBBox(), c = a.xOrigin - Q.x + "px " + (a.yOrigin - Q.y) + "px", H = "") : H = !t && e.getAttribute("data-svg-origin"), pi(e, H || c, !!H || a.originIsAbsolute, a.smooth !== !1, k)), _ = a.xOrigin || 0, T = a.yOrigin || 0, k !== $t && (F = k[0], O = k[1], L = k[2], I = k[3], d = N = k[4], u = P = k[5], k.length === 6 ? (p = Math.sqrt(F * F + O * O), f = Math.sqrt(I * I + L * L), h = F || O ? gt(O, F) * st : 0, y = L || I ? gt(L, I) * st + h : 0, y && (f *= Math.abs(Math.cos(y * xt))), a.svg && (d -= _ - (_ * F + T * L), u -= T - (_ * O + T * I))) : (tt = k[6], Oi = k[7], ve = k[8], Mt = k[9], et = k[10], Re = k[11], d = k[12], u = k[13], g = k[14], C = gt(tt, et), w = C * st, C && (S = Math.cos(-C), E = Math.sin(-C), H = N * S + ve * E, Q = P * S + Mt * E, Pe = tt * S + et * E, ve = N * -E + ve * S, Mt = P * -E + Mt * S, et = tt * -E + et * S, Re = Oi * -E + Re * S, N = H, P = Q, tt = Pe), C = gt(-L, et), b = C * st, C && (S = Math.cos(-C), E = Math.sin(-C), H = F * S - ve * E, Q = O * S - Mt * E, Pe = L * S - et * E, Re = I * E + Re * S, F = H, O = Q, L = Pe), C = gt(O, F), h = C * st, C && (S = Math.cos(C), E = Math.sin(C), H = F * S + O * E, Q = N * S + P * E, O = O * S - F * E, P = P * S - N * E, F = H, N = Q), w && Math.abs(w) + Math.abs(h) > 359.9 && (w = h = 0, b = 180 - b), p = j(Math.sqrt(F * F + O * O + L * L)), f = j(Math.sqrt(P * P + tt * tt)), C = gt(N, P), y = Math.abs(C) > 2e-4 ? C * st : 0, v = Re ? 1 / (Re < 0 ? -Re : Re) : 0), a.svg && (H = e.getAttribute("transform"), a.forceCSS = e.setAttribute("transform", "") || !Er(he(e, V)), H && e.setAttribute("transform", H))), Math.abs(y) > 90 && Math.abs(y) < 270 && (n ? (p *= -1, y += h <= 0 ? 180 : -180, h += h <= 0 ? 180 : -180) : (f *= -1, y += y <= 0 ? 180 : -180)), t = t || a.uncache, a.x = d - ((a.xPercent = d && (!t && a.xPercent || (Math.round(e.offsetWidth / 2) === Math.round(-d) ? -50 : 0))) ? e.offsetWidth * a.xPercent / 100 : 0) + o, a.y = u - ((a.yPercent = u && (!t && a.yPercent || (Math.round(e.offsetHeight / 2) === Math.round(-u) ? -50 : 0))) ? e.offsetHeight * a.yPercent / 100 : 0) + o, a.z = g + o, a.scaleX = j(p), a.scaleY = j(f), a.rotation = j(h) + s, a.rotationX = j(w) + s, a.rotationY = j(b) + s, a.skewX = y + s, a.skewY = x + s, a.transformPerspective = v + o, (a.zOrigin = parseFloat(c.split(" ")[2]) || !t && a.zOrigin || 0) && (i[oe] = ya(c)), a.xOffset = a.yOffset = 0, a.force3D = pe.force3D, a.renderTransform = a.svg ? xs : Ar ? Mr : _s, a.uncache = 0, a;
}, ya = function(e) {
...
}, at = "0deg", Pt = "0px", it = ") ", Mr = function(e, t) {
  ...
  if (x && (u !== at || d !== at)) {
    ...
    T = parseFloat(u) * xt, S = Math.cos(T), o = Oa(y, o, k * S * -x), s = Oa(y, s, -Math.sin(T) * -x), l = Oa(y, l, C * S * -x + x);
  }
  ...
  return s && (u = n.split("_")[1], u === "short" && (c %= o, c !== c % (o / 2) && (c += c < 0 ? o : -o)), u === "cw" && c < 0 ? c = (c + o * Xi) % o - ~~(c / o) * o : u === "ccw" && c > 0 && (c = (c - o * Xi) % o - ~~(c / o) * o)), e._pt = g = new re(e._pt, t, a, i, c, ns), g.e = d, g.u = "deg", e._props.push(a), g;
}, tn = function(e, t) {
  for (var a in t)
    e[a] = t[a];
  return e;
  ...
  for (l in He)
    c = i[l], d = s[l], c !== d && n.indexOf(l) < 0 && (p = J(c), f = J(d), u = p !== f ? Ze(a, l, c, f) : parseFloat(c), g = parseFloat(d), e._pt = new re(e._pt, s, l, u, g - u, di), e._pt.u = f || 0, e._props.push(l));
  tn(s, i);
};
...
var Pr = {
  ...
  init: function(e, t, a, i, n) {
    ...
    Pi || hi(), this.styles = this.styles || kr(e), C = this.styles.props, this.tween = a;
    for (h in t)
      if (h !== "autoRound" && (d = t[h], !(ce[h] && hr(h, t, a, i, e, n)))) {
        if (p = typeof d, f = ba[h], p === "function" && (d = d.call(a, i, e, n), p = typeof d), p === "string" && ~d.indexOf("random(") && (d = Yt(d)), f)
          ...
          if (l && h in l ? (c = typeof l[h] == "function" ? l[h].call(a, i, e, n) : l[h], $(c) && ~c.indexOf("random(") && (c = Yt(c)), J(c + "") || c === "auto" || (c += pe.units[h] || J(qe(e, h)) || ""), (c + "").charAt(1) === "=" && (c = qe(e, h))) : c = qe(e, h), g = parseFloat(c), y = p === "string" && d.charAt(1) === "=" && d.substr(0, 2), y && (d = d.substr(2)), u = parseFloat(d), h in Ee && (h === "autoAlpha" && (g === 1 && qe(e, "visibility") === "hidden" && u && (g = 0), C.push("visibility", 0, s.visibility), Ye(this, s, "visibility", g ? "inherit" : "hidden", u ? "inherit" : "hidden", !u)), h !== "scale" && h !== "transform" && (h = Ee[h], ~h.indexOf(",") && (h = h.split(",")[0]))), x = h in He, x) {
            ...
            if (v || (_ = e._gsap, _.renderTransform && !t.parseTransform || Kt(e, t.parseTransform), T = t.smoothOrigin !== !1 && _.smooth, v = this._pt = new re(this._pt, s, V, 0, 1, _.renderTransform, _, 0, -1), v.dep = 1), h === "scale")
              this._pt = new re(this._pt, _, "scaleY", _.scaleY, (y ? yt(_.scaleY, y + u) : u) - _.scaleY || 0, di), this._pt.u = 0, o.push("scaleY", h), h += "X";
            else if (h === "transformOrigin") {
              C.push(oe, 0, s[oe]), d = bs(d), _.svg ? pi(e, d, 0, T, 0, this) : (b = parseFloat(d.split(" ")[2]) || 0, b !== _.zOrigin && Ye(this, _, "zOrigin", _.zOrigin, b), Ye(this, s, h, ya(c), ya(d)));
              continue;
            } else if (h === "svgOrigin") {
              pi(e, d, 1, T, 0, this);
              continue;
            } else if (h in Tr) {
              vs(this, _, h, g, y ? yt(g, y + d) : d);
              continue;
          ...
          if (x || (u || u === 0) && (g || g === 0) && !is.test(d) && h in s)
            w = (c + "").substr((g + "").length), u || (u = 0), b = J(d) || (h in pe.units ? pe.units[h] : w), w !== b && (g = Ze(e, h, c, b)), this._pt = new re(this._pt, x ? _ : s, h, g, (y ? yt(g, y + u) : u) - g, !x && (b === "px" || h === "zIndex") && t.autoRound !== !1 ? ss : di), this._pt.u = b || 0, x && S !== d ? (this._pt.b = c, this._pt.e = S, this._pt.r = os) : w !== b && b !== "%" && (this._pt.b = c, this._pt.r = rs);
          else if (h in s)
            ws.call(this, e, h, c, y ? y + d : d);
          else if (h in e)
  ...
  getSetter: function(e, t, a) {
    var i = Ee[t];
    return i && i.indexOf(",") < 0 && (t = i), t in He && t !== oe && (e._gsap.x || qe(e, "x")) ? a && ji === a ? t === "scale" ? us : ds : (ji = a || {}) && (t === "scale" ? hs : ps) : e.style && !wi(e.style[t]) ? ls : ~t.indexOf("-") ? cs : Ei(e, t);
  },
  core: {
    _removeProperty: Qe,
    _getMatrix: Li
...
se.registerPlugin(Pr);
var m = se.registerPlugin(Pr) || se;
m.core.Tween;
const Ne = "Thinking", Ut = "Show more", ha = "Show less";
function Di(r, e) {
...
const D = "https://i.pravatar.cc/96", Cs = {
  "andre park": `${D}?img=52`,
  "ava garcia": `${D}?img=46`,
...
function Ts(r) {
  const e = Rr(r).replace(/[^a-z0-9]+/g, "-").replace(/^-|-$/g, "");
  return e ? `${D}?u=${encodeURIComponent(e)}` : "";
}
function Ca(r, e) {
  const t = Rr(r), a = e?.trim() || void 0;
  return Cs[t] ?? a ?? Ts(r);
}
const Ir = `
...
const Es = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="52 42 88 66">
<path fill="#4285f4" d="M58 108h14V74L52 59v43c0 3.32 2.69 6 6 6"/>
<path fill="#34a853" d="M120 108h14c3.32 0 6-2.69 6-6V59l-20 15"/>
<path fill="#fbbc04" d="M120 48v26l20-15v-8c0-7.42-8.47-11.65-14.4-7.2"/>
<path fill="#ea4335" d="M72 74V48l24 18 24-18v26L96 92"/>
<path fill="#c5221f" d="M52 51v8l20 15V48l-5.6-4.2c-5.94-4.45-14.4-.22-14.4 7.2"/>
</svg>`, Ms = `<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" viewBox="60 90.4 570.02 539.67">
<defs>
...
const Ps = [
...
], Rs = 1.28, A = (r) => Number((r * Rs).toFixed(3)), Is = [2, 3, 2], te = {
  ...
  settleHold: A(0.24)
}, nn = "Learning your style", Ls = "Voice calibrated", rn = "73 tone & tactic rules defined", Ba = [
  ...
  0,
  4
], qs = /* @__PURE__ */ new Set([5, 8, 10, 16]), Os = [
  ...
  threadGap: 44
}, Hs = "left,right,bottom,width,height,minHeight,paddingTop,paddingRight,paddingBottom,paddingLeft,borderWidth,gap", Ha = {
  paddingTop: "",
  paddingRight: "",
  paddingBottom: "",
  paddingLeft: "",
  ...
  contentWidth: 1881,
  height: 1280
}, Ws = 96, un = ".wa-cursor-file, .wa-file-landing-clone, .wa-file-landing-label, .wa-csv-drop, .wa-signup-logo-transfer", hn = "[data-marketing-data-sources-grid]", pn = "[data-data-table]", It = "[data-table-action]", gn = "[data-table-page-button]", Vs = "[data-table-page-range]", Ys = {
...
class js {
  ...
  measureComposerFullFrame() {
    m.set(this.composer, { clearProps: Hs });
  ...
  strategyPlans(e) {
    ...
    const d = this.claimComponentMessage("strategy", a), u = m.timeline().add(this.revealMessage(d, n, cn)).addLabel(s, Us).call(() => this.setMotionHints(c), void 0, s).to(t, { ...o.to }, s);
    return t.forEach((g, p) => {
      ...
      () => this.animateMessageScrollIntoView(d, Ie.followDuration, n, cn),
      void 0,
      "+=0.02"
    );
  }
  ...
  connectMailbox(e) {
    ...
    return p.call(() => {
      ...
      i.dataset.mailboxLearningState = "ready", l.textContent = Ls, d.textContent = i.dataset.mailboxLearningReadyDetail ?? rn;
    }).fromTo(
      l,
      { autoAlpha: 0, y: 4 },
      {
  ...
  resetMessageClasses(e) {
    e.classList.remove(...Ps), e.classList.remove("wa-message--first-active");
  }
  createCsvDropArea(e = {}) {
  ...
  streamThinkingHeader(e) {
    return this.streamThinkingChild(e, ".wa-thinking__title", Fs);
  }
  ...
  renderSignupLogoTransfer(e, t) {
    if (!e) return;
    const a = e.target.getBoundingClientRect(), i = this.getElementLocalRect(a, this.chatBody), n = Nr(t);
  ...
  getCompanyLogoDomain(e) {
    return e ? Ys[this.getCompanyKey(e)] ?? "" : "";
  }
  getCompanyKey(e) {
  ...
  createMailboxProviderIcon(e) {
    ...
    return t.className = "wa-mailbox-connection__provider-icon", t.src = Ds[e], t.alt = "", t.decoding = "async", t.loading = "eager", t.setAttribute("aria-hidden", "true"), t;
  }
  ...
  createMailboxThumbprintGroup(e, t = !1) {
    ...
    return a.classList.add(e), Os.forEach((i, n) => {
  ...
  getSequenceStepWaitDays(e, t, a) {
    return t >= a - 1 ? null : e.waitDays ?? Is[t] ?? 1;
  }
...
`);
  ...
  requestMessageScroll(e) {
    ...
    this.scheduledScrollMessage = e, !(t - this.lastStreamScrollAt < Ws) && (this.scheduledScrollFrame || (this.lastStreamScrollAt = t, this.scheduledScrollFrame = window.requestAnimationFrame(() => {
...
function Xs(r, e) {
  const t = Ns[r] ?? 0, a = 24 + r * 11 % 8, i = Math.min(100, t + a), n = Nr((e - t) / (i - t));
  if (n <= 0) return 0;
...
function ia(r, e, t) {
  const a = qr(t.seed), i = $s(r, e), n = t.speed ?? "normal", o = t.intent ?? "hover";
  ...
  const s = e.x - r.x, l = e.y - r.y, c = s / i, d = l / i, u = -d, g = c, p = a() > 0.5 ? 1 : -1, f = t.curve ?? 1, w = Ot(i * (o === "drag" ? 0.1 : o === "click" ? 0.17 : 0.22) * f, 18, 150) * p * (0.72 + a() * 0.44), b = i / Qs[n] + 0.16, y = Ot(b * Zs[o] * Js, 0.3, 1.66), x = t.overshoot === !1 || i < 120 ? 0 : typeof t.overshoot == "number" ? t.overshoot : Ot(i * 0.026, 4, 18), v = x > 0 ? {
    x: e.x + c * x,
    y: e.y + d * x
  } : e, _ = {
...
class al {
  ...
  renderMimicRotation(e, t) {
    ...
    if (a * a + i * i < 4) return;
    const n = Math.atan2(i, a) * 180 / Math.PI, o = il(n - el), s = this.rotationState + nl(this.rotationState, o) * tl;
  ...
  getModeForElement(e) {
    return e ? e.closest(ja) ? "pointer" : e.closest(Xa) ? "text" : "default" : "default";
  }
  getModeForLocalPoint(e, t) {
    return this.refreshModeTargetCache(), this.findLocalHit(this.pointerTargets, e, t, ja) ? "pointer" : this.findLocalHit(this.textTargets, e, t, Xa) ? "text" : "default";
  }
  ...
  refreshModeTargetCache() {
    this.modeTargetsDirty && (this.pointerTargets = Array.from(this.root.querySelectorAll(ja)).reverse(), this.textTargets = Array.from(this.root.querySelectorAll(Xa)).reverse(), this.modeTargetsDirty = !1);
  }
  observeModeTargets() {
...
function xn(r) {
  if (r?.assetUrls?.length)
    for (const e of r.assetUrls) ol(e);
}
function Bt(r) {
  const e = /* @__PURE__ */ new Set(), t = (a) => rl(e, a.values);
...
function Br(r) {
  return r.leads.map((e) => Ca(e.name, e.avatarUrl)).filter(Qt);
}
function zr(r) {
  return r.sequences.map((e) => Ca(e.name, e.avatarUrl)).filter(Qt);
}
function rl(r, e) {
...
}, Fr = q("[data-signup-field]", "center", {
  desktop: -74,
  tablet: -66,
  mobile: -48
}), Hr = q("[data-signup-submit]", "center"), cl = q("[data-send-button]", "center"), Ni = {
  desktop: {
...
}, dl = 2.8, ul = 42, hl = 2, pl = 3, xa = "[data-chat-shell] [data-chat-thread]", gl = `${xa} [data-message-role="assistant"]:not(.wa-message--component) [data-message-body]`, ml = `${xa} [data-message-role="assistant"].wa-message--thinking .wa-research-step[data-step-state="current"] .wa-research-step__body, ${xa} [data-message-role="assistant"].wa-message--thinking .wa-research-step[data-step-state="complete"] .wa-research-step__label`, gi = 0.24, Ur = 0.3, Be = {
...
function fl(r, e, t, a, i) {
  switch (t.kind) {
    ...
    case "transitionSignupToChat":
      ...
      return;
    case "assistant":
      r.add(e.chat.assistantMessage(t.text), t.at), vl(r, e, i, {
        kind: "assistant",
        key: t.text,
        text: t.text,
        selector: gl,
        label: `assistant-${mi(t.text)}`,
        stepIndex: a
      });
      return;
    case "thinking": {
      const n = wl(t), o = n.items.map((s) => s.label);
      t.statusBefore && r.add(e.chat.setStatus(t.statusBefore), t.at), r.add(e.chat.thinkingState(n, t.hold), t.statusBefore ? void 0 : t.at), xl(r, e, i, t.hold, o.length, o.join("|"), a);
      return;
    }
    case "dataTable":
      Lt(
    ...
    case "strategyPlans":
      {
        ...
        r.add(e.chat.strategyPlans(t.plans), t.at), r.add(_l(e, n, t.plans), "+=0.06");
      }
      return;
...
function xl(r, e, t, a = M.thinkingShort, i = 1, n = "thinking", o = 0) {
  const s = a * Math.max(1, i), l = i >= 3 && Gr(e, t, {
    kind: "thinking",
    key: n,
    text: n,
    stepIndex: o,
...
function Gr(r, e, t) {
  const a = t.text.trim(), i = t.minChars ?? ul;
  if (a.length < i || e.textSkimCount >= pl) return !1;
  const n = e.textCandidateCount;
  e.textCandidateCount += 1;
  const o = e.textSkimCount === 0, s = t.stepIndex - e.lastTextSkimStep >= hl, l = Al(`${r.story.id}:${t.kind}:${n}:${t.key}`), c = n > 0 && n % 3 === 0, d = o || s && (l >= 0.58 || c);
...
function Ml(r) {
  ...
  for (const t of r.steps) {
    ...
    const a = t.component;
    a.kind === "table" && Bt(Zt(a, `${r.id}-${t.id}`)).forEach((i) => e.add(i)), a.kind === "dataSources" && Or(Yr(a)).forEach((i) => e.add(i)), a.kind === "proximityList" && Br(Kr(a)).forEach((i) => e.add(i)), a.kind === "sequenceEngagement" && zr(qi(a, `${r.id}-${t.id}`)).forEach((i) => e.add(i));
  }
  return [...e];
}
function Pl(r, e) {
  return r === "hit-ground-running" ? Fr : r === "data-marketplace" ? _a.dataMarketplace : r === "research-brief" ? _a.researchBrief : e.entry;
}
function Rl(r, e) {
  return r === "hit-ground-running" ? Ur : r === "data-marketplace" || r === "research-brief" ? gi : e.entryLeadTime;
}
function Il(r, e, t) {
  if (e.id === "hit-ground-running") return Ll(r, e);
  if (e.id === "crm-update") return Dl(r, e);
  if (e.id === "research-brief") return Nl(r, e);
  if (e.id === "csv-import-cleanup") return ql(r, e);
  const a = Fl(e);
  return a.length ? Te(r, [...a, je(Be.bottomRight, "+=0.18")]) : t.build(r);
}
function Ll(r, e) {
  const t = ze(e, "status"), a = ze(e, "user"), i = ze(e, "thinking"), n = ze(e, "assistant"), o = Jt(e, "strategyCards");
  return Te(r, [
    ...
    ...o ? [{ kind: "strategyPlans", plans: Vr(o.component), at: "-=0.08" }] : [],
    je(Be.right, "+=0.18")
  ]);
}
function Dl(r, e) {
  const t = Jt(e, "mailboxConnection"), a = Jt(e, "uploadedFiles"), i = [];
  if (t && $r(i, Xr(t.component)), a) {
    const n = jr(a.component), o = r.chat.prepareCsvDropArea({
...
function Nl(r, e) {
  const t = ze(e, "user"), a = Jt(e, "table"), i = ze(e, "thinking"), n = Jt(e, "sequenceEngagement"), o = a ? Zt(a.component, "website-visitors-sales") : null, s = n ? qi(n.component, "visitor-outreach-sequences") : null, l = [];
  if (t && l.push({
    kind: "prompt",
    text: t.text,
    duration: Qr(t.text),
...
function ql(r, e) {
  ...
  ), o = a ? e.steps.indexOf(a) : -1, s = n.find((f) => o >= 0 && e.steps.indexOf(f) < o), l = [...n].reverse().find((f) => f !== s), c = t?.text || "may_webinar_attendees.csv", d = Ol(t, s?.component ?? l?.component), u = r.chat.prepareCsvDropArea(), g = r.chat.prepareCursorFile(c, r.cursor), p = q("[data-chat-shell]", "center", {
    desktop: { x: 0, y: 82 },
    tablet: { x: 0, y: 72 },
    mobile: { x: 0, y: 64 }
  });
  return Te(r, [
    ...
    ...l ? [{ kind: "dataTable", config: Vl(Zt(l.component, "cleaned-webinar-attendees")), at: "-=0.04" }] : [],
...
function Fl(r) {
  const e = [], t = r.id === "data-marketplace" ? Hl(r.steps) : r.steps;
  let a = 0;
  for (const i of t)
    a += i.kind === "user" ? 1 : 0, Wr(e, r.id, i, a === 1);
  return e;
}
function Hl(r) {
  const e = [];
...
function Wr(r, e, t, a = !1) {
  ...
  t.kind !== "component" || !t.component || Gl(r, e, t);
}
function Gl(r, e, t) {
  const a = t.component;
  if (a.kind === "table") {
  ...
  if (a.kind === "strategyCards") {
    r.push({ kind: "strategyPlans", plans: Vr(a), at: "-=0.04" });
    return;
  }
  if (a.kind === "enrichment") {
    r.push({ kind: "enrichmentPanel", config: ec(a), at: "+=0.12" });
    return;
  }
  ...
  if (a.kind === "uploadedFiles") {
    r.push({ kind: "custom", build: (i) => i.chat.uploadedFilesMessage(jr(a)), at: "-=0.04" });
    return;
  }
  ...
  if (a.kind === "styleProfile") {
    r.push({ kind: "custom", build: (i) => i.chat.outreachStyleProfile(tc(a)), at: "-=0.02" });
    return;
  }
  if (a.kind === "proximityList") {
    r.push({ kind: "custom", build: (i) => i.chat.proximityLeadList(Kr(a)), at: "-=0.04" });
    return;
  }
  if (a.kind === "personalizationSwipeGame") {
    r.push({ kind: "personalizationSwipeGame", config: ac(a), at: "+=0.06" });
    return;
  }
...
function Ma(r, e = {}) {
  return {
    kind: "thinking",
    thinking: Wl(r.thinking, r.text, r.note),
    hold: e.hold,
    at: e.at
  };
}
...
function Zt(r, e) {
  const t = Xl(r.columns), a = r.rows.filter((o) => o.some((s) => s.trim())).map((o, s) => Kl(o, t, s)), i = r.pagination?.pageSize ?? Yl(r.pagination?.ranges) ?? Math.min(10, a.length || 10), n = r.pagination?.ranges.map((o, s) => ({
    page: s + 1,
    range: o,
  ...
  return {
    ...
    eyebrow: r.eyebrow,
    count: r.count,
    variant: t.variant ?? ic(r),
    columns: t.columns,
    rows: n[0]?.rows ?? a,
    actions: r.actions?.map(Jl),
    pagination: n.length > 1 ? {
      pageSize: i,
      totalRows: nc(r, a.length),
      activePage: 1,
      pages: n
    } : void 0
  };
...
function Kl(r, e, t) {
  ...
  if (e.columns.forEach((i, n) => {
    ...
    const i = Zl(a[e.mutualConnectionKey] ?? ""), n = Ql(t);
...
const rc = [
  ...
  pagination: {
    ...
    activePage: 1,
    pages: [
      { page: 1, range: "1-10 of 50 people", rows: Mn },
      { page: 2, range: "11-20 of 50 people", rows: hc }
    ]
  },
  actions: [
    {
  ...
  },
  {
    ...
    build: (r) => Te(r, [
      ...
      { kind: "enrichmentPanel", config: lc, at: "+=0.12" },
      { kind: "status", text: "Contacts enriched", at: "+=0.86" },
      { kind: "dataTable", config: Cn, at: "-=0.02" },
      { kind: "marketingDataSourcesGrid", config: Sn, at: "+=0.44" },
      je(Be.bottomRight, "+=3")
    ])
  },
  {
    ...
    build: (r) => {
      ...
      }), t = r.chat.prepareCursorFile("4 context files", r.cursor, "DOC", Tn), a = q(
      ...
      return Te(r, [
        ...
        { kind: "custom", build: () => r.chat.outreachStyleProfile(cc), at: "-=0.02" },
        {
          kind: "prompt",
        ...
        { kind: "custom", build: () => r.chat.proximityLeadList(En), at: "-=0.04" },
  ...
  },
  {
    ...
    build: (r) => {
      ...
      return Te(r, [
        ...
        { kind: "dataTable", config: Pn, at: "-=0.02" },
        {
          kind: "cursorMove",
          target: e,
          options: { mode: "pointer", intent: "click", speed: "normal", label: "open-visitor-page-2" },
        ...
        { kind: "custom", build: () => r.chat.dataTableActionTooltip("website-visitors-sales", "email-sequence", !1), at: "<+=0.02" },
        { kind: "status", text: "building outreach sequence", at: "<" },
        { kind: "custom", build: () => r.chat.sequenceBuildThinking(dc), at: "+=0.06" },
  ...
  },
  {
    ...
    build: (r) => {
      ...
      return Te(r, [
        ...
        { kind: "dataTable", config: pc, at: "+=0.08" },
        { kind: "status", text: "Cleaning CSV", at: "<" },
        {
          kind: "thinking",
          steps: [
        ...
        { kind: "dataTable", config: gc, at: "-=0.04" },
        je(Be.bottomRight, "+=0.18")
      ]);
    }
  }
...
class mc {
  ...
  followPointer = () => {
    ...
    if (this.mode === "return") {
      const t = this.getReturnHomePoint(), a = fc((e - this.returnStartedAt) / Ja.durationMs), i = this.getReturnWavePoint(a, t), n = this.getReturnWavePoint(Math.min(1, a + 0.035), t);
      if (this.target = t, this.cursor.mimicViewportPoint(i, 1, a < 1 ? n : t), a >= 1 || Ge(this.getCursorViewportPoint(), t) <= Ja.arriveDistance) {
  ...
  updateFollowTarget(e) {
    ...
    if (this.lastPointer) {
      ...
      i > 1.5 && (this.trailDirection = {
        x: a.x / i,
        y: a.y / i
      }, this.velocity = xc(a, Z.maxMomentumStep));
    }
    const t = {
  ...
  updatePlayTarget(e) {
    ...
    this.target = bc(n, this.pointer, Ue.minPointerDistance, Ue.viewportInset);
  }
  resumeFollowing(e) {
  ...
  getReturnWavePoint(e, t) {
    const a = this.returnStart ?? this.getCursorViewportPoint(), i = wc(e), n = t.x - a.x, o = t.y - a.y, s = Math.hypot(n, o), l = {
      x: a.x + n * i,
      y: a.y + o * i
    };
    if (s < 1) return l;
  ...
  isCursorTooFarFromBrowser() {
    ...
    return _c(i, e) > Z.maxBrowserDistance;
  }
  getChatShell() {
    return this.chatShell?.isConnected ? this.chatShell : (this.chatShell = this.root.querySelector("[data-chat-shell]"), this.chatShell);
  }
...
function In(r, e) {
  return {
    x: Rn(r.x, e, window.innerWidth - e),
    y: Rn(r.y, e, window.innerHeight - e)
  };
}
function bc(r, e, t, a) {
  const i = In(yc(r, e, t), a);
...
class vc {
  constructor(e, t, a, i, n, o) {
    this.root = e, this.stories = t, this.resolver = a, this.cursor = i, this.chat = n, this.options = o, this.storyProgress = this.stories.map(() => 0), this.pausedCursorMimic = new mc(this.root, this.cursor, {
  ...
  updateStories(e, t = {}) {
    if (!e.length) return;
    const a = this.stories[this.activeIndex]?.id, i = this.stories, n = new Map(this.stories.map((c, d) => [c.id, this.storyProgress[d] ?? 0])), o = this.cursor.getPosition(), s = this.playing, l = kc(i, e);
  ...
  attachChatHistoryScroll() {
    ...
    const a = (i) => {
      ...
      if (Math.abs(n) < Dn.minPixelDelta) return;
      ...
      i.preventDefault(), this.pauseForChatHistory(), t.scrollTop = l, d >= Dn.minPixelDelta && window.scrollBy({ top: d, left: 0, behavior: "auto" });
    };
...
const Sc = 3, Cc = /* @__PURE__ */ new Set([
  "user",
  "assistant",
  "thinking",
  "component",
...
function Tc(r) {
  ...
  const e = typeof r.schemaVersion == "number" ? r.schemaVersion : 1, t = r.stories.map((a) => Pc(a)).filter((a) => !!a);
...
function Pc(r) {
  ...
  const e = xe(r.id), t = xe(r.label), a = xe(r.summary), i = r.steps.map((n) => Rc(n)).filter((n) => !!n);
...
function Rc(r) {
  ...
  return !e || !t || !Ec(t) ? null : {
    id: e,
    kind: t,
    text: a ?? "",
    note: i ?? "",
    thinking: kt(r.thinking) ? Ic(r.thinking, a ?? "", i ?? "") : t === "thinking" ? to(a ?? "", i ?? "") : void 0,
    component: kt(r.component) ? Mc(r.component) : void 0
  };
}
function Ic(r, e, t) {
  const i = (Array.isArray(r.items) ? r.items : []).map((n, o) => Lc(n, o)).filter((n) => !!n);
  return i.length ? {
    title: xe(r.title) ?? Ne,
    elapsed: xe(r.elapsed) ?? Sa(i.length),
    items: i
  } : to(e, t);
}
function Lc(r, e) {
...
async function Dc(r, e) {
  try {
    ...
    if (!t.ok) return;
    const a = Tc(await t.json());
    if (!a || a.schemaVersion !== Sc) return;
          ...
          <div class="wa-chat-shell" data-chat-shell>
            ...
            <div class="wa-chat-shell__body">
              <div class="wa-signup-scene" data-signup-scene>
                <span class="wa-signup-scene__logo" data-signup-logo-target aria-hidden="true">${Ir}</span>
...
function qc(r, e = {}) {
  Nc(r);
  const t = e.stories?.length ? e.stories : Jr, a = e.builderDraftEndpoint ?? "/api/story-draft", i = e.reducedMotion ?? window.matchMedia?.("(prefers-reduced-motion: reduce)").matches ?? !1, n = new Ac(r), o = new js(r), s = new al(r, n, { reducedMotion: i }), l = new vc(r, t, n, s, o, {
    ...
    l.updateStories(Tl(d, t), {
      restartActive: u.source === "load"
    });
  };
  return l.mount(), a && Dc(a, c), {
    play: l.play.bind(l),
...
function io(r = "[data-chatbot-stories]", e = {}) {
  return e.injectStyles !== !1 && ao(), qc(Fc(r), e);
}
const Hc = {
  init: io,
  defaultStories: Jr
...
if (typeof window < "u") {
  window.ChatbotStories = Hc;
  const r = () => {
    document.querySelector("[data-chatbot-stories][data-auto-init]") && ao(), document.querySelectorAll("[data-chatbot-stories][data-auto-init]").forEach((e) => {
      e.dataset.chatbotStoriesMounted || (e.dataset.chatbotStoriesMounted = "true", io(e));
    });
  };
