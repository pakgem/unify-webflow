...
var ce = {
...
}, K = Array.isArray, qn = /random\([^)]+\)/g, Ln = /,\s*/g, Ni = /(?:-?\.?\d|\.)+/gi, br = /[-+=.]*\d+[.e\-+]*\d*[e\-+]*\d*/g, xt = /[-+=.]*\d+[.e-]*\d*[a-z%]*/g, Ca = /[-+=.]*\d+\.?\d*(?:e-|e\+)?\d*/gi, _r = /[+-]=-?[.\d]+/, On = /[^,'"\[\]\s]+/gi, Bn = /^[+\-=e\s\d]*\d+[.\d]*([a-z]*|%)\s*$/i, V, ke, Ya, pi, ue = {}, pa = {}, yr, xr = function(e) {
  return (pa = Et(e, ue)) && ne;
}, hi = function(e, t) {
  return console.warn("Invalid property", e, "set to", t, "Missing plugin? gsap.registerPlugin()");
}, jt = function(e, t) {
  return !t && console.warn(e);
}, vr = function(e, t) {
  return e && (ue[e] = t) && pa && (pa[e] = t) || ue;
}, Yt = function() {
  return 0;
}, Fn = {
  suppressEvents: !0,
  ...
  Ue.length && !$ && ha(), e.render(t, a, !!($ && t < 0 && wi(e))), Ue.length && !$ && ha();
}, Cr = function(e) {
  var t = parseFloat(e);
  ...
  var t = e.parent || V, a = e.keyframes ? Gn(K(e.keyframes)) : pe;
  if (te(e.inherit))
    for (; t; )
  ...
  return (ue.ScrollTrigger || hi("scrollTrigger", t)) && ue.ScrollTrigger.create(t, e);
  ...
  return z && !t && z.selector ? z.selector(e) : X(e) && !a && (Ya || !It()) ? Qa.call((t || pi).querySelectorAll(e), 0) : K(e) ? Qn(e, a) : Rr(e) ? Qa.call(e, 0) : e ? [e] : [];
}, Ka = function(e) {
  return e = _e(e)[0] || jt("Invalid scope") || {}, function(t) {
    var a = e.current || e.nativeElement || e;
    return _e(t, a.querySelectorAll ? a : a === e ? jt("Invalid scope") || pi.createElement("div") : e);
  };
}, Nr = function(e) {
  ...
  return X(i) ? c = u = {
    ...
    var h = (g || t).length, f = o[h], b, _, x, v, y, C, k, A, S;
    if (!f) {
      if (S = t.grid === "auto" ? 0 : (t.grid || [1, be])[1], !S) {
        for (k = -be; k < (k = g[S++].getBoundingClientRect().left) && S < h; )
          ;
        S < h && S--;
      }
      for (f = o[h] = [], b = l ? Math.min(S, h) * c - 0.5 : i % S, _ = S === be ? 0 : l ? h * u / S - 0.5 : i / S | 0, k = 0, A = be, C = 0; C < h; C++)
        x = C % S - b, v = _ - (C / S | 0), f[C] = y = d ? Math.abs(d === "y" ? v : x) : fr(x * x + v * v), y > k && (k = y), y < A && (A = y);
      i === "random" && Nr(f), f.max = k - A, f.min = A, f.v = h = (parseFloat(t.amount) || parseFloat(t.each) * (S > h ? h - 1 : d ? d === "y" ? h / S : S : Math.max(S, h / S)) || 0) * (i === "edges" ? -1 : 1), f.b = h < 0 ? r - h : r, f.u = Q(t.amount || t.each) || 0, a = a && h < 0 ? uo(a) : a;
    }
    return h = (f[p] - f.min) / f.max || 0, G(f.b + (a ? a(h) : h) * f.v) + f.u;
  };
}, Za = function(e) {
  ...
  return !a && Te(e) && (i = a = e.radius || be, e.values ? (e = _e(e.values), (r = !De(e[0])) && (i *= i)) : e = Za(e.increment)), Qe(t, a ? U(e) ? function(o) {
    ...
    for (var s = parseFloat(r ? o.x : o), l = parseFloat(r ? o.y : 0), d = be, c = 0, u = e.length, p, m; u--; )
  ...
  if (r)
    return l = i[t + "Params"], d = i.callbackScope || e, a && Ue.length && ha(), s && (z = s), c = l ? r.apply(d, l) : r.call(d), z = o, c;
}, zt = function(e) {
  ...
  if (e)
    if (e = !e.name && e.default || e, ui() || e.headless) {
      ...
      if (It(), e !== i) {
        if (oe[t])
          return;
        pe(i, pe(ma(e, r), o)), Et(i.prototype, Et(r, ma(e, o))), oe[i.prop = t] = i, e.targetTest && (ca.push(i), mi[t] = 1), t = (t === "css" ? "CSS" : t.charAt(0).toUpperCase() + t.substr(1)) + "Plugin";
      }
  ...
  var i = e ? De(e) ? [e >> 16, e >> 8 & q, e & q] : 0 : Ht.black, r, o, s, l, d, c, u, p, m, g;
  if (!i) {
  ...
  if (r = r.map(function(p) {
    return (p = Hr(p, t, 1)) && o + (t ? p[0] + "," + p[1] + "%," + p[2] + "%," + p[3] : p.join(",")) + ")";
  ...
  var n = Date.now, e = 500, t = 33, a = n(), i = a, r = 1e3 / 240, o = r, s = [], l, d, c, u, p, m, g = function h(f) {
    ...
    if ((b > e || b < 0) && (a += b - t), i += b, y = i - a, x = y - o, (x > 0 || _) && (C = ++u.frame, p = y - u.time * 1e3, u.time = y = y / 1e3, o += x + (x >= r ? 4 : r - x), v = 1), _ || (l = d(h)), v)
  ...
  return u = {
    ...
    wake: function() {
      yr && (!Ya && ui() && (ke = Ya = window, pi = ke.document || {}, ue.gsap = ne, (ke.gsapVersions || (ke.gsapVersions = [])).push(ne.version), xr(pa || ke.GreenSockGlobals || !ke.gsap && ke || {}), Fr.forEach(zr)), c = typeof requestAnimationFrame < "u" && requestAnimationFrame, l && u.sleep(), d = c || function(f) {
...
var ee = /* @__PURE__ */ (function(n) {
  ...
  return t.to = function(i, r, o) {
    ...
    var s = this._time, l = this._dirty ? this.totalDuration() : this._tDur, d = this._dur, c = i <= 0 ? 0 : G(i), u = this._zTime < 0 != i < 0 && (this._initted || !d), p, m, g, h, f, b, _, x, v, y, C, k;
    if (this !== V && c > l && i >= 0 && (c = l), c !== this._tTime || o || u) {
      if (s !== this._time && d && (c += this._time - s, i += this._time - s), p = c, v = this._start, x = this._ts, b = !x, u && (d || (s = this._zTime), (i || !r) && (this._zTime = i)), this._repeat) {
        if (C = this._yoyo, f = d + this._rDelay, this._repeat < -1 && i < 0)
          return this.totalTime(f * 100 + i, r, o);
        if (p = G(c % f), c === l ? (h = this._repeat, p = d) : (y = G(c / f), h = ~~y, h && h === y && (p = d, h--), p > d && (p = d)), y = Pt(this._tTime, f), !s && this._tTime && y !== h && this._tTime - y * f - this._dur <= 0 && (y = h), C && h & 1 && (p = d - p, k = 1), h !== y && !this._lock) {
          var A = C && y & 1, S = A === (C && h & 1);
          if (h < y && (A = !A), s = A ? 0 : c % d ? d : c, this._lock = 1, this.render(s || (k ? 0 : G(h * f)), r, !d)._lock = 0, this._tTime = c, !r && this.parent && le(this, "onRepeat"), this.vars.repeatRefresh && !k && (this.invalidate()._lock = 1, y = h), s && s !== this._time || b !== !this._ts || this.vars.onRepeat && !this.parent && !this._act)
            return this;
      ...
      if (this._hasPause && !this._forcing && this._lock < 2 && (_ = Xn(this, G(s), G(p)), _ && (c -= p - (p = _._start))), this._tTime = c, this._time = p, this._act = !!x, this._initted || (this._onUpdate = this.vars.onUpdate, this._initted = 1, this._zTime = i, s = 0), !s && c && d && !r && !y && (le(this, "onStart"), this._tTime !== c))
        return this;
      if (p >= s && i >= 0)
        for (m = this._first; m; ) {
        ...
        for (var E = i < 0 ? i : p; m; ) {
          if (g = m._prev, (m._act || E <= m._end) && m._ts && _ !== m) {
            if (m.parent !== this)
              return this.render(i, r, o);
            if (m.render(m._ts > 0 ? (E - m._start) * m._ts : (m._dirty ? m.totalDuration() : m._tDur) + (E - m._start) * m._ts, r, o || $ && wi(m)), p !== this._time || !this._ts && !b) {
      ...
      if (_ && !r && (this.pause(), _.render(p >= s ? 0 : -L)._zTime = p >= s ? 1 : -1, this._ts))
    ...
    r = r || {};
    var o = this, s = we(o, i), l = r, d = l.startAt, c = l.onStart, u = l.onStartParams, p = l.immediateRender, m, g = Y.to(o, pe({
      ease: r.ease || "none",
      lazy: !1,
      immediateRender: !1,
      time: s,
...
var po = function(e, t, a, i, r, o, s) {
  var l = new ie(this._pt, e, t, 0, 1, Qr, null, r), d = 0, c = 0, u, p, m, g, h, f, b, _;
  for (l.b = a, l.e = i, a += "", i += "", (b = ~i.indexOf("random(")) && (i = Xt(i)), o && (_ = [a, i], o(_, e, t), a = _[0], i = _[1]), p = a.match(Ca) || []; u = Ca.exec(i); )
  ...
  U(i) && (i = i(r || 0, e, o));
  var u = e[t], p = a !== "get" ? a : U(u) ? d ? e[t.indexOf("set") || !U(e["get" + t.substr(3)]) ? t : "get" + t.substr(3)](d) : e[t]() : u, m = U(u) ? d ? wo : $r : yi, g;
  if (X(i) && (~i.indexOf("random(") && (i = Xt(i)), i.charAt(1) === "=" && (g = St(p, i) + (Q(p) || 0), (g || g === 0) && (i = g))), !c || p !== i || ei)
    return !isNaN(p * i) && i !== "" ? (g = new ie(this._pt, e, t, +p || 0, i - (p || 0), typeof u == "boolean" ? _o : Jr, 0, m), d && (g.fp = d), s && g.modifier(s, this, e), this._pt = g) : (!u && !(t in e) && hi(t, i), po.call(this, e, t, p, i, m, l || ce.stringFilter, d));
  ...
  var s, l, d, c;
  if (oe[e] && (s = new oe[e]()).init(r, s.rawVars ? t[e] : ho(t[e], i, r, o, a), a, i, o) !== !1 && (a._pt = l = new ie(a._pt, r, e, 0, 1, s.render, s, 0, s.priority), a !== vt))
    for (d = a._ptLookup[a._targets.indexOf(r)], c = s._props.length; c--; )
      d[s._props[c]] = l;
  return s;
}, He, ei, _i = function n(e, t, a) {
  var i = e.vars, r = i.ease, o = i.startAt, s = i.immediateRender, l = i.lazy, d = i.onUpdate, c = i.runBackwards, u = i.yoyoEase, p = i.keyframes, m = i.autoRevert, g = e._dur, h = e._startAt, f = e._targets, b = e.parent, _ = b && b.data === "nested" ? b.vars.targets : f, x = e._overwrite === "auto" && !di, v = e.timeline, y = i.easeReverse || u, C, k, A, S, E, O, D, I, N, M, H, B, Z;
  if (v && (!p || !r) && (r = "none"), e._ease = ut(r, Ut.ease), e._rEase = y && (ut(y) || e._ease), e._from = !v && !!i.runBackwards, e._from && (e.ratio = 1), !v || p && !i.stagger) {
    if (I = f[0] ? dt(f[0]).harness : 0, B = I && i[I.prop], C = ma(i, mi), h && (h._zTime < 0 && h.progress(1), t < 0 && c && s && !m ? h.render(-1, !0) : h.revert(c && g ? da : Fn), h._lazy = 0), o) {
      if (Xe(e._startAt = Y.set(f, pe({
        data: "isStart",
        overwrite: !1,
        parent: b,
        immediateRender: !0,
    ...
    for (e._pt = e._ptCache = 0, l = g && te(l) || l && !g, k = 0; k < f.length; k++) {
      if (E = f[k], D = E._gsap || fi(f)[k]._gsap, e._ptLookup[k] = M = {}, Xa[D.id] && Ue.length && ha(), H = _ === f ? k : _.indexOf(E), I && (N = new I()).init(E, B || C, e, H, _) !== !1 && (e._pt = S = new ie(e._pt, E, N.name, 0, 1, N.render, N, 0, N.priority), N._props.forEach(function(me) {
        M[me] = S;
      }), N.priority && (O = 1)), !I || B)
        for (A in C)
  ...
  e._onUpdate = d, e._initted = (!e._op || e._pt) && !Z, p && t <= 0 && v.render(be, !0, !0);
...
var Y = /* @__PURE__ */ (function(n) {
  ...
  function e(a, i, r, o) {
    ...
    var l = s.vars, d = l.duration, c = l.delay, u = l.immediateRender, p = l.stagger, m = l.overwrite, g = l.keyframes, h = l.defaults, f = l.scrollTrigger, b = i.parent || V, _ = (K(a) || wr(a) ? De(a[0]) : "length" in i) ? [a] : _e(a), x, v, y, C, k, A, S, E;
    if (s._targets = _.length ? fi(_) : jt("GSAP target " + a + " not found. https://gsap.com", !ce.nullTargetWarn) || [], s._ptLookup = [], s._overwrite = m, g || p || ea(d) || ea(c)) {
      i = s.vars;
      ...
      }), x.kill(), x.parent = x._dp = Me(s), x._start = 0, p || ea(d) || ea(c)) {
        if (C = _.length, S = p && Dr(p), Te(p))
          for (k in p)
            ~Yr.indexOf(k) && (E || (E = {}), E[k] = p[k]);
        for (v = 0; v < C; v++)
          y = ma(i, Xr), y.stagger = 0, O && (y.easeReverse = O), E && Et(y, E), A = _[v], y.duration = +Wt(d, Me(s), v, A, _), y.delay = (+Wt(c, Me(s), v, A, _) || 0) - s._delay, !p && C === 1 && y.delay && (s._delay = c = y.delay, s._start += c, y.delay = 0), x.to(A, y, S ? S(v, A, _) : 0), x._ease = R.none;
        x.duration() ? d = c = 0 : s.timeline = 0;
      } else if (g) {
        Gt(pe(x.vars.defaults, {
          ease: "none"
  ...
  return t.render = function(i, r, o) {
    var s = this._time, l = this._tDur, d = this._dur, c = i < 0, u = i > l - L && !c ? l : i < L ? 0 : i, p, m, g, h, f, b, _, x;
    if (!d)
      Yn(this, i, r, o);
      ...
      if (p = u, x = this.timeline, this._repeat) {
        ...
        if (p = G(u % h), u === l ? (g = this._repeat, p = d) : (f = G(u / h), g = ~~f, g && g === f ? (p = d, g--) : p > d && (p = d)), b = this._yoyo && g & 1, b && (p = d - p), f = Pt(this._tTime, h), p === s && !o && this._initted && g === f)
          return this._tTime = u, this;
        g !== f && this.vars.repeatRefresh && !b && !this._lock && p !== h && this._initted && (this._lock = o = 1, this.render(G(h * g), !0).invalidate()._lock = 0);
      }
      if (!this._initted) {
        if (Ir(this, c ? i : p, o, r, u))
    ...
    var s = this._targets, l = i ? _e(i) : s, d = this._ptLookup, c = this._pt, u, p, m, g, h, f, b;
    if ((!r || r === "all") && Vn(s, l))
      return r === "all" && (this._pt = 0), zt(this);
    for (u = this._op = this._op || [], r !== "all" && (X(r) && (h = {}, ae(r, function(_) {
      return h[_] = 1;
    }), r = h), r = go(s, r)), b = s.length; b--; )
      if (~l.indexOf(s[b])) {
        p = d[b], r === "all" ? (u[b] = r, g = p, m = {}) : (m = u[b] = u[b] || {}, g = r);
        for (h in g)
          f = p && p[h], f && ((!("kill" in f.d) || f.d.kill(h) === !0) && xa(this, f, "_pt"), delete p[h]), m !== "all" && (m[h] = 1);
      }
...
ce.stringFilter = Vr;
var pt = [], ua = {}, ko = [], zi = 0, So = 0, Ia = function(e) {
  return (ua[e] || ko).map(function(t) {
    return t();
  });
}, ti = function() {
  var e = Date.now(), t = [];
  e - zi > 2 && (Ia("matchMediaInit"), pt.forEach(function(a) {
  ...
  return e.add = function(a, i, r) {
    ...
    for (d in a)
      d === "all" ? c = 1 : (l = ke.matchMedia(a[d]), l && (pt.indexOf(o) < 0 && pt.push(o), (s[d] = l.matches) && (c = 1), l.addListener ? l.addListener(ti) : l.addEventListener("change", ti)));
  ...
  quickTo: function(e, t, a) {
    var i, r = ne.to(e, pe((i = {}, i[t] = "+=0.1", i.paused = !0, i.stagger = 0, i), a || {})), o = function(l, d, c) {
...
var Hi, Ge, At, ki, lt, Gi, Si, Eo = function() {
  ...
  var r = parseFloat(a) || 0, o = (a + "").trim().substr((r + "").length) || "px", s = lt.style, l = Po.test(t), d = e.tagName.toLowerCase() === "svg", c = (d ? "client" : "offset") + (l ? "Width" : "Height"), u = 100, p = i === "px", m = i === "%", g, h, f, b;
  if (i === o || !r || Yi[i] || Yi[o])
    return r;
  if (o !== "px" && !p && (r = n(e, t, a, "px")), b = e.getCTM && sn(e), (m || o === "%") && (qe[t] || ~t.indexOf("adius")))
    return g = b ? e.getBBox()[l ? "width" : "height"] : e[c], j(m ? r / g * u : r / 100 * g);
  if (s[l ? "width" : "height"] = u + (p ? o : i), h = i !== "rem" && ~t.indexOf("adius") || i === "em" && e.appendChild && !d ? e : e.parentNode, b && (h = (e.ownerSVGElement || {}).parentNode), (!h || h === Ge || !h.appendChild) && (h = Ge.body), f = h._gsap, f && m && f.width && l && f.time === se.time && !f.uncache)
    return j(r / f.width * u);
  if (m && (t === "height" || t === "width")) {
    var _ = e.style[t];
    e.style[t] = u + i, g = e[c], _ ? e.style[t] = _ : $e(e, t);
  } else
    (m || o === "%") && !Vo[de(h, "display")] && (s.position = de(e, "position")), h === e && (s.position = "static"), h.appendChild(lt), g = lt[c], h.removeChild(lt), s.position = "absolute";
  return l && m && (f = dt(h), f.time = se.time, f.width = h[c]), j(p ? g * r / u : g && r ? u / g * r : 0);
}, Ie = function(e, t, a, i) {
  var r;
  ...
  var s = new ie(this._pt, e.style, t, 0, 1, Qr), l = 0, d = 0, c, u, p, m, g, h, f, b, _, x, v, y;
  if (s.b = a, s.e = i, a += "", i += "", i.substring(0, 6) === "var(--" && (i = de(e, i.substring(4, i.indexOf(")")))), i === "auto" && (h = e.style[t], e.style[t] = i, i = de(e, t) || i, h ? e.style[t] = h : $e(e, t)), c = [a, i], Vr(c), a = c[0], i = c[1], p = a.match(xt) || [], y = i.match(xt) || [], y.length) {
    for (; u = xt.exec(i); )
      f = u[0], _ = i.substring(l, u.index), g ? g = (g + 1) % 5 : (_.substr(-5) === "rgba(" || _.substr(-5) === "hsla(") && (g = 1), f !== (h = p[d++] || "") && (m = parseFloat(h) || 0, v = h.substr((m + "").length), f.charAt(1) === "=" && (f = St(m, f) + v), b = parseFloat(f), x = f.substr((b + "").length), l = xt.lastIndex - x.length, x || (x = x || ce.units[t] || v, l === i.length && (i += x, s.e += x)), v !== x && (m = Je(e, t, h, x) || 0), s._pt = {
        _next: s._pt,
        p: _ || d === 1 ? _ : ",",
        //note: SVG spec allows omission of comma/space when a negative sign is wedged between two numbers, like 2.5-5.3 instead of 2.5,-5.3 but when tweening, the negative value may switch to positive, so we insert the comma just in case.
        s: m,
  ...
  */
  ...
  var s = e._gsap, l = r || Ci(e, !0), d = s.xOrigin || 0, c = s.yOrigin || 0, u = s.xOffset || 0, p = s.yOffset || 0, m = l[0], g = l[1], h = l[2], f = l[3], b = l[4], _ = l[5], x = t.split(" "), v = parseFloat(x[0]) || 0, y = parseFloat(x[1]) || 0, C, k, A, S;
  a ? l !== Qt && (k = m * f - g * h) && (A = v * (f / k) + y * (-h / k) + (h * _ - f * b) / k, S = v * (-g / k) + y * (m / k) - (m * _ - g * b) / k, v = A, y = S) : (C = on(e), v = C.x + (~x[0].indexOf("%") ? v / 100 * C.width : v), y = C.y + (~(x[1] || x[0]).indexOf("%") ? y / 100 * C.height : y)), i || i !== !1 && s.smooth ? (b = v - d, _ = y - c, s.xOffset = u + (b * m + _ * h) - b, s.yOffset = p + (b * g + _ * f) - _) : s.xOffset = s.yOffset = 0, s.xOrigin = v, s.yOrigin = y, s.smooth = !!i, s.origin = t, s.originIsAbsolute = !!a, e.style[re] = "0px 0px", o && (Ve(o, s, "xOrigin", d, v), Ve(o, s, "yOrigin", c, y), Ve(o, s, "xOffset", u, s.xOffset), Ve(o, s, "yOffset", p, s.yOffset)), e.setAttribute("data-svg-origin", v + " " + y);
}, Kt = function(e, t) {
  var a = e._gsap || new Ur(e);
  if ("x" in a && !t && !a.uncache)
    return a;
  var i = e.style, r = a.scaleX < 0, o = "px", s = "deg", l = getComputedStyle(e), d = de(e, re) || "0", c, u, p, m, g, h, f, b, _, x, v, y, C, k, A, S, E, O, D, I, N, M, H, B, Z, me, Lt, Ot, Ke, Ri, Ee, Ze;
  return c = u = p = h = f = b = _ = x = v = 0, m = g = 1, a.svg = !!(e.getCTM && sn(e)), l.translate && ((l.translate !== "none" || l.scale !== "none" || l.rotate !== "none") && (i[W] = (l.translate !== "none" ? "translate3d(" + (l.translate + " 0 0").split(" ").slice(0, 3).join(", ") + ") " : "") + (l.rotate !== "none" ? "rotate(" + l.rotate + ") " : "") + (l.scale !== "none" ? "scale(" + l.scale.split(" ").join(",") + ") " : "") + (l[W] !== "none" ? l[W] : "")), i.scale = i.rotate = i.translate = "none"), k = Ci(e, a.svg), a.svg && (a.uncache ? (Z = e.getBBox(), d = a.xOrigin - Z.x + "px " + (a.yOrigin - Z.y) + "px", B = "") : B = !t && e.getAttribute("data-svg-origin"), ni(e, B || d, !!B || a.originIsAbsolute, a.smooth !== !1, k)), y = a.xOrigin || 0, C = a.yOrigin || 0, k !== Qt && (O = k[0], D = k[1], I = k[2], N = k[3], c = M = k[4], u = H = k[5], k.length === 6 ? (m = Math.sqrt(O * O + D * D), g = Math.sqrt(N * N + I * I), h = O || D ? ft(D, O) * ot : 0, _ = I || N ? ft(I, N) * ot + h : 0, _ && (g *= Math.abs(Math.cos(_ * Ct))), a.svg && (c -= y - (y * O + C * I), u -= C - (y * D + C * N))) : (Ze = k[6], Ri = k[7], Lt = k[8], Ot = k[9], Ke = k[10], Ee = k[11], c = k[12], u = k[13], p = k[14], A = ft(Ze, Ke), f = A * ot, A && (S = Math.cos(-A), E = Math.sin(-A), B = M * S + Lt * E, Z = H * S + Ot * E, me = Ze * S + Ke * E, Lt = M * -E + Lt * S, Ot = H * -E + Ot * S, Ke = Ze * -E + Ke * S, Ee = Ri * -E + Ee * S, M = B, H = Z, Ze = me), A = ft(-I, Ke), b = A * ot, A && (S = Math.cos(-A), E = Math.sin(-A), B = O * S - Lt * E, Z = D * S - Ot * E, me = I * S - Ke * E, Ee = N * E + Ee * S, O = B, D = Z, I = me), A = ft(D, O), h = A * ot, A && (S = Math.cos(A), E = Math.sin(A), B = O * S + D * E, Z = M * S + H * E, D = D * S - O * E, H = H * S - M * E, O = B, M = Z), f && Math.abs(f) + Math.abs(h) > 359.9 && (f = h = 0, b = 180 - b), m = j(Math.sqrt(O * O + D * D + I * I)), g = j(Math.sqrt(H * H + Ze * Ze)), A = ft(M, H), _ = Math.abs(A) > 2e-4 ? A * ot : 0, v = Ee ? 1 / (Ee < 0 ? -Ee : Ee) : 0), a.svg && (B = e.getAttribute("transform"), a.forceCSS = e.setAttribute("transform", "") || !dn(de(e, W)), B && e.setAttribute("transform", B))), Math.abs(_) > 90 && Math.abs(_) < 270 && (r ? (m *= -1, _ += h <= 0 ? 180 : -180, h += h <= 0 ? 180 : -180) : (g *= -1, _ += _ <= 0 ? 180 : -180)), t = t || a.uncache, a.x = c - ((a.xPercent = c && (!t && a.xPercent || (Math.round(e.offsetWidth / 2) === Math.round(-c) ? -50 : 0))) ? e.offsetWidth * a.xPercent / 100 : 0) + o, a.y = u - ((a.yPercent = u && (!t && a.yPercent || (Math.round(e.offsetHeight / 2) === Math.round(-u) ? -50 : 0))) ? e.offsetHeight * a.yPercent / 100 : 0) + o, a.z = p + o, a.scaleX = j(m), a.scaleY = j(g), a.rotation = j(h) + s, a.rotationX = j(f) + s, a.rotationY = j(b) + s, a.skewX = _ + s, a.skewY = x + s, a.transformPerspective = v + o, (a.zOrigin = parseFloat(d.split(" ")[2]) || !t && a.zOrigin || 0) && (i[re] = ba(d)), a.xOffset = a.yOffset = 0, a.force3D = ce.force3D, a.renderTransform = a.svg ? Xo : nn ? cn : Yo, a.uncache = 0, a;
}, ba = function(e) {
  ...
  var a = t || this, i = a.xPercent, r = a.yPercent, o = a.x, s = a.y, l = a.z, d = a.rotation, c = a.rotationY, u = a.rotationX, p = a.skewX, m = a.skewY, g = a.scaleX, h = a.scaleY, f = a.transformPerspective, b = a.force3D, _ = a.target, x = a.zOrigin, v = "", y = b === "auto" && e && e !== 1 || b === !0;
  if (x && (u !== et || c !== et)) {
  ...
  f !== Bt && (v += "perspective(" + f + tt), (i || r) && (v += "translate(" + i + "%, " + r + "%) "), (y || o !== Bt || s !== Bt || l !== Bt) && (v += l !== Bt || y ? "translate3d(" + o + ", " + s + ", " + l + ") " : "translate(" + o + ", " + s + tt), d !== et && (v += "rotate(" + d + tt), c !== et && (v += "rotateY(" + c + tt), u !== et && (v += "rotateX(" + u + tt), (p !== et || m !== et) && (v += "skew(" + p + ", " + m + tt), (g !== 1 || h !== 1) && (v += "scale(" + g + ", " + h + tt), _.style[W] = v || "translate(0, 0)";
}, Xo = function(e, t) {
  var a = t || this, i = a.xPercent, r = a.yPercent, o = a.x, s = a.y, l = a.rotation, d = a.skewX, c = a.skewY, u = a.scaleX, p = a.scaleY, m = a.target, g = a.xOrigin, h = a.yOrigin, f = a.xOffset, b = a.yOffset, _ = a.forceCSS, x = parseFloat(o), v = parseFloat(s), y, C, k, A, S;
  l = parseFloat(l), d = parseFloat(d), c = parseFloat(c), c && (c = parseFloat(c), d += c, l += c), l || d ? (l *= Ct, d *= Ct, y = Math.cos(l) * u, C = Math.sin(l) * u, k = Math.sin(l - d) * -p, A = Math.cos(l - d) * p, d && (c *= Ct, S = Math.tan(d - c), S = Math.sqrt(1 + S * S), k *= S, A *= S, c && (S = Math.tan(c), S = Math.sqrt(1 + S * S), y *= S, C *= S)), y = j(y), C = j(C), k = j(k), A = j(A)) : (y = u, A = p, C = k = 0), (x && !~(o + "").indexOf("px") || v && !~(s + "").indexOf("px")) && (x = Je(m, "x", o, "px"), v = Je(m, "y", s, "px")), (g || h || f || b) && (x = j(x + g - (g * y + h * k) + f), v = j(v + h - (g * C + h * A) + b)), (i || r) && (S = m.getBBox(), x = j(x + i / 100 * S.width), v = j(v + r / 100 * S.height)), S = "matrix(" + y + "," + C + "," + k + "," + A + "," + x + "," + v + ")", m.setAttribute("transform", S), _ && (m.style[W] = S);
}, $o = function(e, t, a, i, r) {
  var o = 360, s = X(r), l = parseFloat(r) * (s && ~r.indexOf("rad") ? ot : 1), d = l - i, c = i + d + "deg", u, p;
  return s && (u = r.split("_")[1], u === "short" && (d %= o, d !== d % (o / 2) && (d += d < 0 ? o : -o)), u === "cw" && d < 0 ? d = (d + o * Vi) % o - ~~(d / o) * o : u === "ccw" && d > 0 && (d = (d - o * Vi) % o - ~~(d / o) * o)), e._pt = p = new ie(e._pt, t, a, i, d, Io), p.e = c, p.u = "deg", e._props.push(a), p;
}, Ji = function(e, t) {
  for (var a in t)
    e[a] = t[a];
  return e;
}, Jo = function(e, t, a) {
  var i = Ji({}, a._gsap), r = "perspective,force3D,transformOrigin,svgOrigin", o = a.style, s, l, d, c, u, p, m, g;
  ...
  for (l in qe)
    d = i[l], c = s[l], d !== c && r.indexOf(l) < 0 && (m = Q(d), g = Q(c), u = m !== g ? Je(a, l, d, g) : parseFloat(d), p = parseFloat(c), e._pt = new ie(e._pt, s, l, u, p - u, ai), e._pt.u = g || 0, e._props.push(l));
  Ji(s, i);
};
...
var un = {
  ...
  init: function(e, t, a, i, r) {
    var o = this._props, s = e.style, l = a.vars.startAt, d, c, u, p, m, g, h, f, b, _, x, v, y, C, k, A, S;
    ki || ri(), this.styles = this.styles || rn(e), A = this.styles.props, this.tween = a;
    for (h in t)
      if (h !== "autoRound" && (c = t[h], !(oe[h] && jr(h, t, a, i, e, r)))) {
        if (m = typeof c, g = wa[h], m === "function" && (c = c.call(a, i, e, r), m = typeof c), m === "string" && ~c.indexOf("random(") && (c = Xt(c)), g)
          g(this, e, h, c, a) && (k = 1);
        else if (h.substr(0, 2) === "--")
          d = (getComputedStyle(e).getPropertyValue(h) + "").trim(), c += "", je.lastIndex = 0, je.test(d) || (f = Q(d), b = Q(c), b ? f !== b && (d = Je(e, h, d, b) + b) : f && (c += f)), this.add(s, "setProperty", d, c, i, r, 0, 0, h), o.push(h), A.push(h, 0, s[h]);
        else if (m !== "undefined") {
          if (l && h in l ? (d = typeof l[h] == "function" ? l[h].call(a, i, e, r) : l[h], X(d) && ~d.indexOf("random(") && (d = Xt(d)), Q(d + "") || d === "auto" || (d += ce.units[h] || Q(Ie(e, h)) || ""), (d + "").charAt(1) === "=" && (d = Ie(e, h))) : d = Ie(e, h), p = parseFloat(d), _ = m === "string" && c.charAt(1) === "=" && c.substr(0, 2), _ && (c = c.substr(2)), u = parseFloat(c), h in Ce && (h === "autoAlpha" && (p === 1 && Ie(e, "visibility") === "hidden" && u && (p = 0), A.push("visibility", 0, s.visibility), Ve(this, s, "visibility", p ? "inherit" : "hidden", u ? "inherit" : "hidden", !u)), h !== "scale" && h !== "transform" && (h = Ce[h], ~h.indexOf(",") && (h = h.split(",")[0]))), x = h in qe, x) {
            ...
            if (v || (y = e._gsap, y.renderTransform && !t.parseTransform || Kt(e, t.parseTransform), C = t.smoothOrigin !== !1 && y.smooth, v = this._pt = new ie(this._pt, s, W, 0, 1, y.renderTransform, y, 0, -1), v.dep = 1), h === "scale")
              this._pt = new ie(this._pt, y, "scaleY", y.scaleY, (_ ? St(y.scaleY, _ + u) : u) - y.scaleY || 0, ai), this._pt.u = 0, o.push("scaleY", h), h += "X";
            else if (h === "transformOrigin") {
              A.push(re, 0, s[re]), c = Uo(c), y.svg ? ni(e, c, 0, C, 0, this) : (b = parseFloat(c.split(" ")[2]) || 0, b !== y.zOrigin && Ve(this, y, "zOrigin", y.zOrigin, b), Ve(this, s, h, ba(d), ba(c)));
              continue;
            } else if (h === "svgOrigin") {
              ni(e, c, 1, C, 0, this);
              continue;
            } else if (h in ln) {
              $o(this, y, h, p, _ ? St(p, _ + c) : c);
              continue;
          ...
          if (x || (u || u === 0) && (p || p === 0) && !Mo.test(c) && h in s)
            f = (d + "").substr((p + "").length), u || (u = 0), b = Q(c) || (h in ce.units ? ce.units[h] : f), f !== b && (p = Je(e, h, d, b)), this._pt = new ie(this._pt, x ? y : s, h, p, (_ ? St(p, _ + u) : u) - p, !x && (b === "px" || h === "zIndex") && t.autoRound !== !1 ? Do : ai), this._pt.u = b || 0, x && S !== c ? (this._pt.b = d, this._pt.e = S, this._pt.r = No) : f !== b && b !== "%" && (this._pt.b = d, this._pt.r = Ro);
          else if (h in s)
            Wo.call(this, e, h, d, _ ? _ + c : c);
          else if (h in e)
...
w.core.Tween;
const ze = "Thinking", Ye = "Show more", ht = "Show less";
function pn(n) {
  return n.map((e, t) => ({
    label: e,
    detail: qt(e, t),
    disclosure: t === 0 ? Ye : ht
  }));
}
function qt(n, e) {
...
class ps {
  ...
  sequenceBuildThinking(e) {
    ...
    ).to({}, { duration: aa.finalHold }), a.forEach((u, p) => {
  ...
  renderFileLandingClones(e, t) {
    ...
    for (const i of e) {
      const r = i.target.getBoundingClientRect(), o = r.left - a.left, s = r.top - a.top, l = hn(
  ...
  normalizeThinkingItem(e, t) {
    ...
    return {
      ...
      disclosure: typeof e == "string" ? t === 0 ? Ye : ht : e.disclosure || (t === 0 ? Ye : ht)
    };
  }
  ...
  createMailboxConnection(e) {
    ...
    const p = document.createElement("span");
    p.className = "wa-mailbox-connection__spinner", p.setAttribute("aria-hidden", "true"), l.append(d, c, u, p);
    ...
    const h = this.createMailboxThumbprint(e.id), f = document.createElement("div");
    ...
    return v.dataset.mailboxLearningProgress = "", x.append(v), g.append(h, f, x), t.append(a, l, g, m), t;
  }
  ...
  createSequenceEngagement(e) {
    ...
    if (o) {
      ...
      p.className = "wa-sequence-person-button", p.type = "button", p.tabIndex = -1, p.dataset.sequencePersonButton = `${e.id}:prev`, p.dataset.direction = "prev", p.dataset.currentIndex = "0", p.setAttribute("aria-label", "Previous person"), p.textContent = "‹", p.addEventListener("click", () => {
        const k = (Number(p.dataset.currentIndex ?? "0") - 1 + e.sequences.length) % e.sequences.length;
        ...
        this.sequencePerson(e.id, k).play();
      }), x.className = "wa-sequence-person-actions", x.append(p, v), s.append(m, x);
    }
    e.sequences.forEach((p, m) => {
      ...
      if (C?.length) {
        ...
        }), S.className = "wa-sequence-copy-panel", S.dataset.sequenceCopyPanel = "", E.className = "wa-sequence-copy-panel__meta", E.dataset.sequenceCopyMeta = "", E.textContent = A ? `${A.channel} 1` : "Email", O.className = "wa-sequence-copy-panel__subject", O.dataset.sequenceCopySubject = "", O.textContent = p.subject, D.className = "wa-sequence-copy-panel__body", D.dataset.sequenceCopyBody = "", D.textContent = A ? this.getSequenceStepCopy(p, A) : p.personalization, S.append(E, O, D), g.append(k, S);
      } else
        g.append(h, v, y);
      r.append(g);
    });
...
function ms(n, e) {
  const t = as[n] ?? 0, a = 24 + n * 11 % 8, i = Math.min(100, t + a), r = hs((e - t) / (i - t));
  if (r <= 0) return 0;
...
function ia(n, e, t) {
  ...
  const s = e.x - n.x, l = e.y - n.y, d = s / i, c = l / i, u = -c, p = d, m = a() > 0.5 ? 1 : -1, g = t.curve ?? 1, f = kt(i * (o === "drag" ? 0.1 : o === "click" ? 0.17 : 0.22) * g, 18, 150) * m * (0.72 + a() * 0.44), b = i / ws[r] + 0.16, _ = kt(b * bs[o] * _s, 0.3, 1.66), x = t.overshoot === !1 || i < 120 ? 0 : typeof t.overshoot == "number" ? t.overshoot : kt(i * 0.026, 4, 18), v = x > 0 ? {
    x: e.x + d * x,
    y: e.y + c * x
  } : e, y = {
...
function Nt(n, e = "") {
  const t = pn([n || "Thinking"]).map((a, i) => ({
    ...
    disclosure: a.disclosure || (i === 0 ? Ye : ht)
  }));
  return {
    title: ze,
    elapsed: Sa(t.length),
...
function rl(n, e) {
  ...
  return t ? {
    ...
    disclosure: ye(n.disclosure) ?? (e === 0 ? Ye : ht)
  } : null;
}
function mt(n) {
...
}, dl = 2.8, cl = 42, ul = 2, pl = 3, ya = "[data-chat-shell] [data-chat-thread]", hl = `${ya} [data-message-role="assistant"]:not(.wa-message--component) [data-message-body]`, ml = `${ya} [data-message-role="assistant"].wa-message--thinking .wa-research-step[data-step-state="current"] .wa-research-step__body, ${ya} [data-message-role="assistant"].wa-message--thinking .wa-research-step[data-step-state="complete"] .wa-research-step__label`, si = 0.24, wn = 0.3, Re = {
...
function bn(n, e, t) {
  ...
  if (a.length < i || e.textSkimCount >= pl) return !1;
...
function Ii(n, e) {
  ...
  return {
    id: e === "website-visitors-sales" ? e : he(n.title || e),
    title: n.title,
    eyebrow: n.eyebrow,
    count: n.count,
    variant: Vl(n),
...
function yn(n) {
  return n.cards.map((e, t) => ({
    id: he(e.label || e.title || `strategy-${t + 1}`),
    label: e.label,
    title: e.title,
    summary: e.summary
  }));
...
function Fl(n) {
  return {
    id: he(n.title || "data-sources"),
    title: n.title,
    subtitle: n.subtitle,
    sources: n.sources.map((e, t) => ({
      id: he(e.name || `source-${t + 1}`),
      category: e.category,
      name: e.name,
      detail: e.detail,
      logoSrc: e.logoSrc
...
function vn(n) {
  return {
    id: he(n.title || "mailbox-connection"),
    title: n.title,
    subtitle: n.subtitle,
    provider: n.provider,
    account: n.account,
...
function Gl(n) {
  return {
    id: he(n.title || "personalization-swipe"),
    title: n.title,
    subtitle: n.subtitle,
    prompt: n.prompt,
...
class ld {
  ...
  isCursorTooFarFromBrowser() {
    ...
    return hd(i, e) > J.maxBrowserDistance;
  }
  ...
  countAxisReversals(e) {
    ...
    for (let r = 1; r < e.length; r += 1) {
      const o = e[r - 1], s = e[r], l = hr(s.x - o.x), d = hr(s.y - o.y);
...
function yd(n, e = {}) {
  ...
  const t = e.stories?.length ? e.stories : Tn, a = e.builderDraftEndpoint ?? "/api/story-draft", i = e.reducedMotion ?? window.matchMedia?.("(prefers-reduced-motion: reduce)").matches ?? !1, r = new bd(n), o = new Cs(n, r, { reducedMotion: i }), s = new ps(n, { logo: o }), l = new vs(n, r, { reducedMotion: i }), d = new fd(n, t, r, l, o, s, {
  ...
  }, u = d.destroy.bind(d), p = e.showBuilder === !1 ? null : new Is(n, t, {
    onStorySelect: (m) => d.goTo(m),
    onStoriesChange: c,
    draftEndpoint: a,
    draftAutoSave: e.builderDraftAutoSave
  });
  return d.mount(), p?.mount(), !p && a && xd(a, c), {
    play: d.play.bind(d),
