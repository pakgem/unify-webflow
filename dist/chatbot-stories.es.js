...
var ce = {
...
}, Z = Array.isArray, Gr = /random\([^)]+\)/g, Ur = /,\s*/g, ai = /(?:-?\.?\d|\.)+/gi, Li = /[-+=.]*\d+[.e\-+]*\d*[e\-+]*\d*/g, nt = /[-+=.]*\d+[.e-]*\d*[a-z%]*/g, ra = /[-+=.]*\d+\.?\d*(?:e-|e\+)?\d*/gi, Fi = /[+-]=-?[.\d]+/, Vr = /[^,'"\[\]\s]+/gi, Yr = /^[+\-=e\s\d]*\d+[.\d]*([a-z]*|%)\s*$/i, W, ye, ya, za, ue = {}, jt = {}, Hi, Wi = function(e) {
  ...
  var a = Z(e), i, r;
  return !a && Se(e) && (i = a = e.radius || fe, e.values ? (e = we(e.values), (r = !Ee(e[0])) && (i *= i)) : e = Ca(e.increment)), Le(t, a ? U(e) ? function(n) {
...
var ee = /* @__PURE__ */ (function(l) {
  ...
  return t.to = function(i, r, n) {
    ...
    return j(i) ? this.removeLabel(i) : U(i) ? this.killTweensOf(i) : (i.parent === this && ta(this, i), i === this._recent && (this._recent = this._last), Ke(this));
...
var yn = function(e, t, a, i, r, n, s) {
  ...
  if (U(e) && (e = Tt(e, r, t, a, i)), !Se(e) || e.style && e.nodeType || Z(e) || Bi(e))
...
const os = [
  ...
  threadGap: 44
}, hs = "left,right,bottom,width,height,minHeight", bt = {
  scrollOutRatio: 0.74,
  minScrollOut: 280,
  duration: T(0.58),
  threadOverlap: "-=0.36"
...
class fs {
  ...
  hideComposer() {
    const e = this.measureComposerFullFrame(), t = this.getComposerCompactFrame(e);
...
const Mi = {
  ...
  tablet: -66,
  mobile: -48
}), Qs = Q("[data-send-button]", "center"), Za = {
  desktop: {
...
}, Ks = 2.8, Zs = 42, $s = 2, eo = 3, ea = "[data-chat-shell] [data-chat-thread]", to = `${ea} [data-message-role="assistant"]:not(.wa-message--component) [data-message-body]`, ao = `${ea} [data-message-role="assistant"].wa-message--thinking .wa-research-step[data-step-state="current"] .wa-research-step__body, ${ea} [data-message-role="assistant"].wa-message--thinking .wa-research-step[data-step-state="complete"] .wa-research-step__label`, Ri = 0.24, io = 0.3, At = {
