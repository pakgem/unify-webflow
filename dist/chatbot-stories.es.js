...
var le = {
  ...
  overwrite: !1,
  delay: 0
}, Ta, J, R, pe = 1e8, M = 1 / pe, ha = Math.PI * 2, Li = ha / 4, Fi = 0, Nr = Math.sqrt, Bi = Math.cos, qi = Math.sin, W = function(e) {
...
}, Z = Array.isArray, Hi = /random\([^)]+\)/g, Gi = /,\s*/g, Ja = /(?:-?\.?\d|\.)+/gi, Dr = /[-+=.]*\d+[.e\-+]*\d*[e\-+]*\d*/g, Ke = /[-+=.]*\d+[.e-]*\d*[a-z%]*/g, ta = /[-+=.]*\d+\.?\d*(?:e-|e\+)?\d*/gi, Or = /[+-]=-?[.\d]+/, Ui = /[^,'"\[\]\s]+/gi, Yi = /^[+\-=e\s\d]*\d+[.\d]*([a-z]*|%)\s*$/i, z, fe, pa, Ia, de = {}, Yt = {}, zr, Lr = function(e) {
  ...
  suppressEvents: !0
}, Na = {}, Ie = [], ma = {}, Br, ie = {}, aa = {}, Xa = 30, Gt = [], Ra = "", Da = function(e) {
  var t = e[0], a, r;
  ...
  return (a = e[t]) && q(a) ? e[t]() : Ea(a) && e.getAttribute && e.getAttribute(t) || a;
}, ee = function(e, t) {
  ...
  var e = Ie.length, t = Ie.slice(0), a, r;
  for (ma = {}, Ie.length = 0, a = 0; a < e; a++)
    r = t[a], r && r._lazy && (r.render(r._lazy[0], r._lazy[1], !0)._lazy = 0);
}, Oa = function(e) {
  return !!(e._initted || e._startAt || e.add);
}, Hr = function(e, t, a, r) {
  Ie.length && !J && Vt(), e.render(t, a, !!(J && t < 0 && Oa(e))), Ie.length && !J && Vt();
}, Gr = function(e) {
  var t = parseFloat(e);
  return (t || t === 0) && (e + "").match(Ui).length < 2 ? t : W(e) ? e.trim() : e;
}, Ur = function(e) {
  return e;
}, ce = function(e, t) {
  for (var a in t)
  ...
  var t = e.parent || z, a = e.keyframes ? Ji(Z(e.keyframes)) : ce;
  if ($(e.inherit))
    for (; t; )
  ...
  return e._startAt && (J ? e._startAt.revert(Ht) : e.vars.immediateRender && !e.vars.autoRevert || e._startAt.render(t, !0, r));
}, Zi = function o(e) {
  ...
  var a = e._dp;
  return a && a.smoothChildTiming && e._ts && (e._start = O(a._time - (e._ts > 0 ? t / e._ts : ((e._dirty ? e.totalDuration() : e._tDur) - t) / -e._ts)), $t(e), a._dirty || Ve(a, e)), e;
}, Vr = function(e, t) {
  var a;
  if ((t._time || !t._dur && t._initted || t._start < e._time && (t._dur || !t.add)) && (a = Wt(e.rawTime(), t), (!t._dur || Rt(0, t.totalDuration(), a) - t._tTime > M) && t.render(a, !0)), Ve(e, t)._dp && e._initted && e._time >= e._dur && e._ts) {
  ...
  return t.parent && Ne(t), t._start = O((Ce(a) ? a : a || e !== z ? he(e, a, t) : e._time) + t._delay), t._end = O(t._start + (t.totalDuration() / Math.abs(t.timeScale()) || 0)), Yr(e, t, "_first", "_last", e._sort ? "_start" : 0), fa(t) || (e._recent = t), r || Vr(e, t), e._ts < 0 && ea(e, e._tTime), e;
}, jr = function(e, t) {
  return (de.ScrollTrigger || Ma("scrollTrigger", t)) && de.ScrollTrigger.create(t, e);
}, Wr = function(e, t, a, r, i) {
  if (La(e, t, i), !e._initted)
    return 1;
  if (!a && e._pt && !J && (e._dur && e.vars.lazy !== !1 || !e._dur && e.vars.lazy) && Br !== ne.frame)
    return Ie.push(e), e._lazy = [i, r], 1;
}, Ki = function o(e) {
  var t = e.parent;
  ...
  if (s && e._repeat && (l = Rt(0, e._tDur, t), c = it(l, s), e._yoyo && c & 1 && (n = 1 - n), c !== it(e._tTime, s) && (i = 1 - n, e.vars.repeatRefresh && e._initted && e.invalidate())), n !== i || J || r || e._zTime === M || !t && e._zTime) {
    if (!e._initted && Wr(e, t, r, a, l))
      return;
    for (u = e._zTime, e._zTime = t || (a ? M : 0), a || (a = t && !u), e.ratio = n, e._from && (n = 1 - n), e._time = 0, e._tTime = l, d = e._pt; d; )
      d.r(n, d.d), d = d._next;
    t < 0 && ga(e, t, a, !0), e._onUpdate && !a && se(e, "onUpdate"), l && e._repeat && !a && e.parent && se(e, "onRepeat"), (t >= e._tDur || t < 0) && e.ratio === n && (n && Ne(e, 1), !a && !J && (se(e, n ? "onComplete" : "onReverseComplete", !0), e._prom && e._prom()));
  ...
  return s && !r && (e._time *= n / e._dur), e._dur = n, e._tDur = i ? i < 0 ? 1e10 : O(n * (i + 1) + e._rDelay * i) : n, s > 0 && !r && ea(e, e._tTime = e._tDur * s), e.parent && $t(e), a || Ve(e.parent, e), e;
}, Ka = function(e) {
  ...
  return W(t) && (isNaN(t) || t in r) ? (l = t.charAt(0), d = t.substr(-1) === "%", s = t.indexOf("="), l === "<" || l === ">" ? (s >= 0 && (t = t.replace(/=/, "")), (l === "<" ? i._start : i.endTime(i._repeat >= 0)) + (parseFloat(t.substr(1)) || 0) * (d ? (s < 0 ? i : a).totalDuration() / 100 : 1)) : s < 0 ? (t in r || (r[t] = n), r[t]) : (l = parseFloat(t.charAt(s - 1) + t.substr(s + 1)), d && a && (l = l / 100 * (Z(a) ? a[0] : a).totalDuration()), s > 1 ? o(e, t.substr(0, s - 1), a) + l : n + l)) : t == null ? n : +t;
}, vt = function(e, t, a) {
  ...
  return a === void 0 && (a = []), e.forEach(function(r) {
    var i;
    return W(r) && !t || Jr(r, 1) ? (i = a).push.apply(i, me(r)) : a.push(r);
  }) || a;
}, me = function(e, t, a) {
  return R && !t && R.selector ? R.selector(e) : W(e) && !a && (pa || !st()) ? wa.call((t || Ia).querySelectorAll(e), 0) : Z(e) ? rn(e, a) : Jr(e) ? wa.call(e, 0) : e ? [e] : [];
}, ba = function(e) {
  return e = me(e)[0] || St("Invalid scope") || {}, function(t) {
    var a = e.current || e.nativeElement || e;
    return me(t, a.querySelectorAll ? a : a === e ? St("Invalid scope") || Ia.createElement("div") : e);
  };
}, Xr = function(e) {
  ...
  var a = Z(e), r, i;
  return !a && _e(e) && (r = a = e.radius || pe, e.values ? (e = me(e.values), (i = !Ce(e[0])) && (r *= r)) : e = _a(e.increment)), Oe(t, a ? q(e) ? function(n) {
  ...
  if (i)
    return l = r[t + "Params"], d = r.callbackScope || e, a && Ie.length && Vt(), s && (R = s), c = l ? i.apply(d, l) : i.call(d), R = n, c;
}, bt = function(e) {
  ...
  var r = e ? Ce(e) ? [e >> 16, e >> 8 & I, e & I] : 0 : _t.black, i, n, s, l, d, c, u, p, m, g;
  if (!r) {
  ...
  return u = {
    ...
    wake: function() {
      zr && (!pa && Pa() && (fe = pa = window, Ia = fe.document || {}, de.gsap = re, (fe.gsapVersions || (fe.gsapVersions = [])).push(re.version), Lr(Yt || fe.GreenSockGlobals || !fe.gsap && fe || {}), ti.forEach(ai)), c = typeof requestAnimationFrame < "u" && requestAnimationFrame, l && u.sleep(), d = c || function(f) {
...
var oi = function(e, t) {
  ...
  return e.delay = function(a) {
    ...
    return (this._tTime !== a || !this._dur && !r || this._initted && Math.abs(this._zTime) === M || !this._initted && this._dur && a || !a && !this._initted && (this.add || this._ptLookup)) && (this._ts || (this._pTime = a), Hr(this, a, r)), this;
  }, e.time = function(a, r) {
    ...
    return this._rts = +a || 0, this._ts = this._ps || a === -M ? 0 : this._rts, this.totalTime(Rt(-Math.abs(this._delay), this.totalDuration(), i), r !== !1), $t(this), Qi(this);
  }, e.paused = function(a) {
    return arguments.length ? (this._ps !== a && (this._ps = a, a ? (this._pTime = this._tTime || Math.max(-this._delay, this.rawTime()), this._ts = this._act = 0) : (st(), this._ts = this._rts, this.totalTime(this.parent && !this.parent.smoothChildTiming ? this.rawTime() : this._tTime || this._pTime, this.progress() === 1 && Math.abs(this._zTime) !== M && (this._tTime -= M)))), this) : this._ps;
    ...
    a === void 0 && (a = ji);
    var r = J;
    return J = a, Oa(this) && (this.timeline && this.timeline.revert(a), this.totalTime(-0.01, a.suppressEvents)), this.data !== "nested" && a.kill !== !1 && this.kill(), J = r, this;
...
var K = /* @__PURE__ */ (function(o) {
  ...
  function e(a, r) {
    var i;
    return a === void 0 && (a = {}), i = o.call(this, a) || this, i.labels = {}, i.smoothChildTiming = !!a.smoothChildTiming, i.autoRemoveChildren = !!a.autoRemoveChildren, i._sort = $(a.sortChildren), z && we(a.parent || z, ve(i), r), a.reversed && i.reverse(), a.paused && i.paused(!0), a.scrollTrigger && jr(ve(i), a.scrollTrigger), i;
  }
  var t = e.prototype;
  return t.to = function(r, i, n) {
    ...
    return i.duration = 0, i.parent = this, yt(i).repeatDelay || (i.repeat = 0), i.immediateRender = !!i.immediateRender, new Y(r, i, he(this, n), 1), this;
  }, t.call = function(r, i, n) {
    return we(this, Y.delayedCall(0, r, i), n);
    ...
    var s = this._time, l = this._dirty ? this.totalDuration() : this._tDur, d = this._dur, c = r <= 0 ? 0 : O(r), u = this._zTime < 0 != r < 0 && (this._initted || !d), p, m, g, h, f, _, w, x, y, b, S, A;
    if (this !== z && c > l && r >= 0 && (c = l), c !== this._tTime || n || u) {
      if (s !== this._time && d && (c += this._time - s, r += this._time - s), p = c, y = this._start, x = this._ts, _ = !x, u && (d || (s = this._zTime), (r || !i) && (this._zTime = r)), this._repeat) {
        ...
        if (p = O(c % f), c === l ? (h = this._repeat, p = d) : (b = O(c / f), h = ~~b, h && h === b && (p = d, h--), p > d && (p = d)), b = it(this._tTime, f), !s && this._tTime && b !== h && this._tTime - b * f - this._dur <= 0 && (b = h), S && h & 1 && (p = d - p, A = 1), h !== b && !this._lock) {
          var C = S && b & 1, k = C === (S && h & 1);
          if (h < b && (C = !C), s = C ? 0 : c % d ? d : c, this._lock = 1, this.render(s || (A ? 0 : O(h * f)), i, !d)._lock = 0, this._tTime = c, !i && this.parent && se(this, "onRepeat"), this.vars.repeatRefresh && !A && (this.invalidate()._lock = 1, b = h), s && s !== this._time || _ !== !this._ts || this.vars.onRepeat && !this.parent && !this._act)
            return this;
      ...
      if (this._hasPause && !this._forcing && this._lock < 2 && (w = en(this, O(s), O(p)), w && (c -= p - (p = w._start))), this._tTime = c, this._time = p, this._act = !!x, this._initted || (this._onUpdate = this.vars.onUpdate, this._initted = 1, this._zTime = r, s = 0), !s && c && d && !i && !b && (se(this, "onStart"), this._tTime !== c))
        return this;
      if (p >= s && r >= 0)
        for (m = this._first; m; ) {
        ...
        for (var T = r < 0 ? r : p; m; ) {
          if (g = m._prev, (m._act || T <= m._end) && m._ts && w !== m) {
            if (m.parent !== this)
              return this.render(r, i, n);
            if (m.render(m._ts > 0 ? (T - m._start) * m._ts : (m._dirty ? m.totalDuration() : m._tDur) + (T - m._start) * m._ts, i, n || J && Oa(m)), p !== this._time || !this._ts && !_) {
      ...
      if (w && !i && (this.pause(), w.render(p >= s ? 0 : -M)._zTime = p >= s ? 1 : -1, this._ts))
    ...
    var n = this;
    if (Ce(i) || (i = he(this, i, r)), !(r instanceof It)) {
      if (Z(r))
    ...
    return W(r) ? this.removeLabel(r) : q(r) ? this.killTweensOf(r) : (r.parent === this && Kt(this, r), r === this._recent && (this._recent = this._last), Ve(this));
    ...
    for (var n = [], s = me(r), l = this._first, d = Ce(i), c; l; )
      l instanceof Y ? Wi(l._targets, s) && (d ? (!Te || l._initted && l._ts) && l.globalTime(0) <= i && l.globalTime(l.totalDuration()) > i : !i || l.isActive()) && n.push(l) : (c = l.getTweensOf(s, i)).length && n.push.apply(n, c), l = l._next;
    return n;
    ...
    if (n._dirty) {
      for (u = n.parent; s; )
        d = s._prev, s._dirty && s.totalDuration(), c = s._start, c > l && n._sort && s._ts && !n._lock ? (n._lock = 1, we(n, s, c - s._delay, 1)._lock = 0) : l = c, c < 0 && s._ts && (i -= c, (!u && !n._dp || u && u.smoothChildTiming) && (n._start += O(c / n._ts), n._time -= c, n._tTime -= c), n.shiftChildren(-c, !1, -1 / 0), l = 0), s._end > i && s._ts && (i = s._end), s = d;
      nt(n, n === z && n._time > i ? n._time : i, 1, 1), n._dirty = 0;
    }
    return n._tDur;
  }, e.updateRoot = function(r) {
    if (z._ts && (Hr(z, Wt(r, z)), Br = ne.frame), ne.frame >= Xa) {
      Xa += le.autoSleep || 120;
      var i = z._first;
...
var bn = function(e, t, a, r, i, n, s) {
  ...
  q(r) && (r = r(i || 0, e, n));
  var u = e[t], p = a !== "get" ? a : q(u) ? d ? e[t.indexOf("set") || !q(e["get" + t.substr(3)]) ? t : "get" + t.substr(3)](d) : e[t]() : u, m = q(u) ? d ? An : ui : Fa, g;
  if (W(r) && (~r.indexOf("random(") && (r = Et(r)), r.charAt(1) === "=" && (g = et(p, r) + (Q(p) || 0), (g || g === 0) && (r = g))), !c || p !== r || xa)
    return !isNaN(p * r) && r !== "" ? (g = new te(this._pt, e, t, +p || 0, r - (p || 0), typeof u == "boolean" ? Cn : hi, 0, m), d && (g.fp = d), s && g.modifier(s, this, e), this._pt = g) : (!u && !(t in e) && Ma(t, r), bn.call(this, e, t, p, r, m, l || le.stringFilter, d));
}, _n = function(e, t, a, r, i) {
  if (q(e) && (e = At(e, i, t, a, r)), !_e(e) || e.style && e.nodeType || Z(e) || Rr(e))
    return W(e) ? At(e, i, t, a, r) : e;
  var n = {}, s;
  for (s in e)
    n[s] = At(e[s], i, t, a, r);
  return n;
  ...
  var r = e.vars, i = r.ease, n = r.startAt, s = r.immediateRender, l = r.lazy, d = r.onUpdate, c = r.runBackwards, u = r.yoyoEase, p = r.keyframes, m = r.autoRevert, g = e._dur, h = e._startAt, f = e._targets, _ = e.parent, w = _ && _.data === "nested" ? _.vars.targets : f, x = e._overwrite === "auto" && !Ta, y = e.timeline, b = r.easeReverse || u, S, A, C, k, T, H, F, N, B, j, V, G, ue;
  if (y && (!p || !i) && (i = "none"), e._ease = je(i, Ct.ease), e._rEase = b && (je(b) || e._ease), e._from = !y && !!r.runBackwards, e._from && (e.ratio = 1), !y || p && !r.stagger) {
    if (N = f[0] ? Ye(f[0]).harness : 0, G = N && r[N.prop], S = jt(r, Na), h && (h._zTime < 0 && h.progress(1), t < 0 && c && s && !m ? h.render(-1, !0) : h.revert(c && g ? Ht : Vi), h._lazy = 0), n) {
      if (Ne(e._startAt = Y.set(f, ce({
        ...
        stagger: 0
      }, n))), e._startAt._dp = 0, e._startAt._sat = e, t < 0 && (J || !s && !m) && e._startAt.revert(Ht), s && g && t <= 0 && a <= 0) {
        t && (e._zTime = t);
        return;
      }
    } else if (c && g && !h) {
      ...
      }, S), G && (C[N.prop] = G), Ne(e._startAt = Y.set(f, C)), e._startAt._dp = 0, e._startAt._sat = e, t < 0 && (J ? e._startAt.revert(Ht) : e._startAt.render(-1, !0)), e._zTime = t, !s)
        o(e._startAt, M, M);
      else if (!t)
        return;
    }
    for (e._pt = e._ptCache = 0, l = g && $(l) || l && !g, A = 0; A < f.length; A++) {
      if (T = f[A], F = T._gsap || Da(f)[A]._gsap, e._ptLookup[A] = j = {}, ma[F.id] && Ie.length && Vt(), V = w === f ? A : w.indexOf(T), N && (B = new N()).init(T, G || S, e, V, w) !== !1 && (e._pt = k = new te(e._pt, T, B.name, 0, 1, B.render, B, 0, B.priority), B._props.forEach(function(Xe) {
        j[Xe] = k;
      }), B.priority && (H = 1)), !N || G)
        for (C in S)
          ie[C] && (B = li(C, S, e, V, T, w)) ? B.priority && (H = 1) : j[C] = k = za.call(e, T, C, "get", S[C], V, w, 0, r.stringFilter);
      e._op && e._op[A] && e.kill(T, e._op[A]), x && e._pt && (Te = e, z.killTweensOf(T, j, e.globalTime(t)), ue = !e.parent, Te = 0), e._pt && l && (ma[F.id] = 1);
    }
    H && mi(e), e._onInit && e._onInit(e);
  }
  ...
  return q(e) ? e.call(t, a, r, i) : W(e) && ~e.indexOf("random(") ? Et(e) : e;
...
var Y = /* @__PURE__ */ (function(o) {
  ...
  function e(a, r, i, n) {
    ...
    var l = s.vars, d = l.duration, c = l.delay, u = l.immediateRender, p = l.stagger, m = l.overwrite, g = l.keyframes, h = l.defaults, f = l.scrollTrigger, _ = r.parent || z, w = (Z(a) || Rr(a) ? Ce(a[0]) : "length" in r) ? [a] : me(a), x, y, b, S, A, C, k, T;
    if (s._targets = w.length ? Da(w) : St("GSAP target " + a + " not found. https://gsap.com", !le.nullTargetWarn) || [], s._ptLookup = [], s._overwrite = m, g || p || Dt(d) || Dt(c)) {
      ...
      if (x = s.timeline = new K({
        ...
        for (y = 0; y < S; y++)
          b = jt(r, ci), b.stagger = 0, H && (b.easeReverse = H), T && rt(b, T), C = w[y], b.duration = +At(d, ve(s), y, C, w), b.delay = (+At(c, ve(s), y, C, w) || 0) - s._delay, !p && S === 1 && b.delay && (s._delay = c = b.delay, s._start += c, b.delay = 0), x.to(C, b, k ? k(y, C, w) : 0), x._ease = E.none;
        ...
        if (Z(g))
          ...
          for (A in b)
            for (N = b[A].sort(function(V, G) {
              ...
              }, j[A] = B.v, x.to(w, j, F), F += j.duration;
          x.duration() < d && x.to({}, {
      ...
      s.timeline = 0;
    return m === !0 && !Ta && (Te = ve(s), z.killTweensOf(w), Te = 0), we(_, ve(s), i), r.reversed && s.reverse(), r.paused && s.paused(!0), (u || !d && !g && s._start === O(_._time) && $(u) && Zi(ve(s)) && _.data !== "nested") && (s._tTime = -M, s.render(Math.max(0, -c) || 0)), f && jr(ve(s), f), s;
  }
  var t = e.prototype;
  return t.render = function(r, i, n) {
    var s = this._time, l = this._tDur, d = this._dur, c = r < 0, u = r > l - M && !c ? l : r < M ? 0 : r, p, m, g, h, f, _, w, x;
    if (!d)
      $i(this, r, i, n);
      ...
      if (p = u, x = this.timeline, this._repeat) {
        ...
        if (p = O(u % h), u === l ? (g = this._repeat, p = d) : (f = O(u / h), g = ~~f, g && g === f ? (p = d, g--) : p > d && (p = d)), _ = this._yoyo && g & 1, _ && (p = d - p), f = it(this._tTime, h), p === s && !n && this._initted && g === f)
    ...
    for (u = this._op = this._op || [], i !== "all" && (W(i) && (h = {}, ee(i, function(w) {
      return h[w] = 1;
...
var Fa = function(e, t, a) {
  ...
  return q(e[t]) ? ui : Ea(e[t]) && e.setAttribute ? kn : Fa;
}, hi = function(e, t) {
...
le.stringFilter = ni;
var We = [], Ut = {}, Pn = [], tr = 0, In = 0, sa = function(e) {
  ...
  function o(t, a) {
    this.selector = a && ba(a), this.data = [], this._r = [], this.isReverted = !1, this.id = In++, t && this.add(t);
  }
  var e = o.prototype;
  return e.add = function(a, r, i) {
    ...
    var n = this, s = function() {
      ...
      return d && d !== n && d.data.push(n), i && (n.selector = ba(i)), R = n, u = r.apply(n, arguments), q(u) && n._r.push(u), R = d, n.selector = c, n.isReverted = !1, u;
    };
  ...
  exportRoot: function(e, t) {
    ...
    for (a.smoothChildTiming = $(e.smoothChildTiming), z.remove(a), a._dp = 0, a._time = a._tTime = z._time, r = z._first; r; )
      i = r._next, (t || !(!r._dur && r instanceof Y && r.vars.onComplete === r._targets[0])) && we(a, r, r._start - r._delay), r = i;
    return we(z, a, 0), a;
  },
...
var ar, Ee, tt, Ha, Ue, rr, Ga, Dn = function() {
...
}, L = "transform", ae = L + "Origin", Wn = function o(e, t) {
  ...
  if (this.tfm) {
    for (n in this.tfm)
      r[n] = this.tfm[n];
    r.svg && (r.renderTransform(), t.setAttribute("data-svg-origin", this.svgo || "")), i = Ga(), (!i || !i.isStart) && !a[L] && (bi(a), r.zOrigin && a[ae] && (a[ae] += " " + r.zOrigin + "px", r.zOrigin = 0, r.renderTransform()), r.uncache = 1);
  }
}, _i = function(e, t) {
  var a = {
    target: e,
  ...
  Dn() && window.document && (ar = window, Ee = ar.document, tt = Ee.documentElement, Ue = Aa("div") || {
    style: {}
  }, Aa("div"), L = ot(L), ae = L + "Origin", Ue.style.cssText = "border-width:0;line-height:0;position:absolute;padding:0", xi = !!ot("perspective"), Ga = re.core.reverting, Ha = 1);
}, sr = function(e) {
  ...
  if (t) {
    var a = e.style, r;
    t in Se && t !== ae && (t = L), a.removeProperty ? (r = t.substr(0, 2), (r === "ms" || t.substr(0, 6) === "webkit") && (t = "-" + t), a.removeProperty(r === "--" ? t : t.replace(Ua, "-$1").toLowerCase())) : a.removeAttribute(t);
  }
  ...
  if (n !== "px" && !p && (i = o(e, t, a, "px")), _ = e.getCTM && vi(e), (m || n === "%") && (Se[t] || ~t.indexOf("adius")))
    return g = _ ? e.getBBox()[l ? "width" : "height"] : e[c], U(m ? i / g * u : i / 100 * g);
  ...
  return l && m && (f = Ye(h), f.time = ne.time, f.width = h[c]), U(p ? g * i / u : g && i ? u / g * i : 0);
}, Ae = function(e, t, a, r) {
  var i;
  ...
  if (t.tween && t.tween._time === t.tween._dur) {
    ...
    if (i === "all" || i === !0)
      ...
      for (i = i.split(","), d = i.length; --d > -1; )
        s = i[d], Se[s] && (l = 1, s = s === "transformOrigin" ? ae : L), Re(a, s);
    l && (Re(a, L), n && (n.svg && a.removeAttribute("transform"), r.scale = r.rotate = r.translate = "none", Nt(a, 1), n.uncache = 1, bi(r)));
  }
}, Xt = {
  ...
  */
}, Mt = [1, 0, 0, 1, 0, 0], Ai = {}, ki = function(e) {
  return e === "matrix(1, 0, 0, 1, 0, 0)" || e === "none" || !e;
}, cr = function(e) {
  var t = oe(e, L);
  return ki(t) ? Mt : t.substr(7).match(Dr).map(U);
}, Ya = function(e, t) {
  var a = e._gsap || Ye(e), r = e.style, i = cr(e), n, s, l, d;
  return a.svg && e.getAttribute("transform") ? (l = e.transform.baseVal.consolidate().matrix, i = [l.a, l.b, l.c, l.d, l.e, l.f], i.join(",") === "1,0,0,1,0,0" ? Mt : i) : (i === Mt && !e.offsetParent && e !== tt && !a.svg && (l = r.display, r.display = "block", n = e.parentNode, (!n || !e.offsetParent && !e.getBoundingClientRect().width) && (d = 1, s = e.nextElementSibling, tt.appendChild(e)), i = cr(e), l ? r.display = l : Re(e, "display"), d && (s ? n.insertBefore(e, s) : n ? n.appendChild(e) : tt.removeChild(e))), t && i.length > 6 ? [i[0], i[1], i[4], i[5], i[12], i[13]] : i);
  ...
  a ? l !== Mt && (A = m * f - g * h) && (C = y * (f / A) + b * (-h / A) + (h * w - f * _) / A, k = y * (-g / A) + b * (m / A) - (m * w - g * _) / A, y = C, b = k) : (S = yi(e), y = S.x + (~x[0].indexOf("%") ? y / 100 * S.width : y), b = S.y + (~(x[1] || x[0]).indexOf("%") ? b / 100 * S.height : b)), r || r !== !1 && s.smooth ? (_ = y - d, w = b - c, s.xOffset = u + (_ * m + w * h) - _, s.yOffset = p + (_ * g + w * f) - w) : s.xOffset = s.yOffset = 0, s.xOrigin = y, s.yOrigin = b, s.smooth = !!r, s.origin = t, s.originIsAbsolute = !!a, e.style[ae] = "0px 0px", n && (Pe(n, s, "xOrigin", d, y), Pe(n, s, "yOrigin", c, b), Pe(n, s, "xOffset", u, s.xOffset), Pe(n, s, "yOffset", p, s.yOffset)), e.setAttribute("data-svg-origin", y + " " + b);
}, Nt = function(e, t) {
  var a = e._gsap || new oi(e);
  if ("x" in a && !t && !a.uncache)
    return a;
  var r = e.style, i = a.scaleX < 0, n = "px", s = "deg", l = getComputedStyle(e), d = oe(e, ae) || "0", c, u, p, m, g, h, f, _, w, x, y, b, S, A, C, k, T, H, F, N, B, j, V, G, ue, Xe, lt, dt, ze, Wa, xe, Le;
  return c = u = p = h = f = _ = w = x = y = 0, m = g = 1, a.svg = !!(e.getCTM && vi(e)), l.translate && ((l.translate !== "none" || l.scale !== "none" || l.rotate !== "none") && (r[L] = (l.translate !== "none" ? "translate3d(" + (l.translate + " 0 0").split(" ").slice(0, 3).join(", ") + ") " : "") + (l.rotate !== "none" ? "rotate(" + l.rotate + ") " : "") + (l.scale !== "none" ? "scale(" + l.scale.split(" ").join(",") + ") " : "") + (l[L] !== "none" ? l[L] : "")), r.scale = r.rotate = r.translate = "none"), A = Ya(e, a.svg), a.svg && (a.uncache ? (ue = e.getBBox(), d = a.xOrigin - ue.x + "px " + (a.yOrigin - ue.y) + "px", G = "") : G = !t && e.getAttribute("data-svg-origin"), Ca(e, G || d, !!G || a.originIsAbsolute, a.smooth !== !1, A)), b = a.xOrigin || 0, S = a.yOrigin || 0, A !== Mt && (H = A[0], F = A[1], N = A[2], B = A[3], c = j = A[4], u = V = A[5], A.length === 6 ? (m = Math.sqrt(H * H + F * F), g = Math.sqrt(B * B + N * N), h = H || F ? Qe(F, H) * He : 0, w = N || B ? Qe(N, B) * He + h : 0, w && (g *= Math.abs(Math.cos(w * at))), a.svg && (c -= b - (b * H + S * N), u -= S - (b * F + S * B))) : (Le = A[6], Wa = A[7], lt = A[8], dt = A[9], ze = A[10], xe = A[11], c = A[12], u = A[13], p = A[14], C = Qe(Le, ze), f = C * He, C && (k = Math.cos(-C), T = Math.sin(-C), G = j * k + lt * T, ue = V * k + dt * T, Xe = Le * k + ze * T, lt = j * -T + lt * k, dt = V * -T + dt * k, ze = Le * -T + ze * k, xe = Wa * -T + xe * k, j = G, V = ue, Le = Xe), C = Qe(-N, ze), _ = C * He, C && (k = Math.cos(-C), T = Math.sin(-C), G = H * k - lt * T, ue = F * k - dt * T, Xe = N * k - ze * T, xe = B * T + xe * k, H = G, F = ue, N = Xe), C = Qe(F, H), h = C * He, C && (k = Math.cos(C), T = Math.sin(C), G = H * k + F * T, ue = j * k + V * T, F = F * k - H * T, V = V * k - j * T, H = G, j = ue), f && Math.abs(f) + Math.abs(h) > 359.9 && (f = h = 0, _ = 180 - _), m = U(Math.sqrt(H * H + F * F + N * N)), g = U(Math.sqrt(V * V + Le * Le)), C = Qe(j, V), w = Math.abs(C) > 2e-4 ? C * He : 0, y = xe ? 1 / (xe < 0 ? -xe : xe) : 0), a.svg && (G = e.getAttribute("transform"), a.forceCSS = e.setAttribute("transform", "") || !ki(oe(e, L)), G && e.setAttribute("transform", G))), Math.abs(w) > 90 && Math.abs(w) < 270 && (i ? (m *= -1, w += h <= 0 ? 180 : -180, h += h <= 0 ? 180 : -180) : (g *= -1, w += w <= 0 ? 180 : -180)), t = t || a.uncache, a.x = c - ((a.xPercent = c && (!t && a.xPercent || (Math.round(e.offsetWidth / 2) === Math.round(-c) ? -50 : 0))) ? e.offsetWidth * a.xPercent / 100 : 0) + n, a.y = u - ((a.yPercent = u && (!t && a.yPercent || (Math.round(e.offsetHeight / 2) === Math.round(-u) ? -50 : 0))) ? e.offsetHeight * a.yPercent / 100 : 0) + n, a.z = p + n, a.scaleX = U(m), a.scaleY = U(g), a.rotation = U(h) + s, a.rotationX = U(f) + s, a.rotationY = U(_) + s, a.skewX = w + s, a.skewY = x + s, a.transformPerspective = y + n, (a.zOrigin = parseFloat(d.split(" ")[2]) || !t && a.zOrigin || 0) && (r[ae] = Qt(d)), a.xOffset = a.yOffset = 0, a.force3D = le.force3D, a.renderTransform = a.svg ? es : xi ? Ci : $n, a.uncache = 0, a;
}, Qt = function(e) {
  return (e = e.split(" "))[0] + " " + e[1];
}, la = function(e, t, a) {
  var r = Q(t);
  return U(parseFloat(t) + parseFloat(De(e, "x", a + "px", r))) + r;
}, $n = function(e, t) {
  ...
  f !== ct && (y += "perspective(" + f + Be), (r || i) && (y += "translate(" + r + "%, " + i + "%) "), (b || n !== ct || s !== ct || l !== ct) && (y += l !== ct || b ? "translate3d(" + n + ", " + s + ", " + l + ") " : "translate(" + n + ", " + s + Be), d !== Fe && (y += "rotate(" + d + Be), c !== Fe && (y += "rotateY(" + c + Be), u !== Fe && (y += "rotateX(" + u + Be), (p !== Fe || m !== Fe) && (y += "skew(" + p + ", " + m + Be), (g !== 1 || h !== 1) && (y += "scale(" + g + ", " + h + Be), w.style[L] = y || "translate(0, 0)";
}, es = function(e, t) {
  ...
  l = parseFloat(l), d = parseFloat(d), c = parseFloat(c), c && (c = parseFloat(c), d += c, l += c), l || d ? (l *= at, d *= at, b = Math.cos(l) * u, S = Math.sin(l) * u, A = Math.sin(l - d) * -p, C = Math.cos(l - d) * p, d && (c *= at, k = Math.tan(d - c), k = Math.sqrt(1 + k * k), A *= k, C *= k, c && (k = Math.tan(c), k = Math.sqrt(1 + k * k), b *= k, S *= k)), b = U(b), S = U(S), A = U(A), C = U(C)) : (b = u, C = p, S = A = 0), (x && !~(n + "").indexOf("px") || y && !~(s + "").indexOf("px")) && (x = De(m, "x", n, "px"), y = De(m, "y", s, "px")), (g || h || f || _) && (x = U(x + g - (g * b + h * A) + f), y = U(y + h - (g * S + h * C) + _)), (r || i) && (k = m.getBBox(), x = U(x + r / 100 * k.width), y = U(y + i / 100 * k.height)), k = "matrix(" + b + "," + S + "," + A + "," + C + "," + x + "," + y + ")", m.setAttribute("transform", k), w && (m.style[L] = k);
}, ts = function(e, t, a, r, i) {
  var n = 360, s = W(i), l = parseFloat(i) * (s && ~i.indexOf("rad") ? He : 1), d = l - r, c = r + d + "deg", u, p;
  ...
  r.svg ? (d = a.getAttribute("transform"), a.setAttribute("transform", ""), n[L] = t, s = Nt(a, 1), Re(a, L), a.setAttribute("transform", d)) : (d = getComputedStyle(a)[L], n[L] = t, s = Nt(a, 1), n[L] = d);
  for (l in Se)
    ...
    for (h in t)
      if (h !== "autoRound" && (c = t[h], !(ie[h] && li(h, t, a, r, e, i)))) {
        if (m = typeof c, g = Xt[h], m === "function" && (c = c.call(a, r, e, i), m = typeof c), m === "string" && ~c.indexOf("random(") && (c = Et(c)), g)
          ...
          d = (getComputedStyle(e).getPropertyValue(h) + "").trim(), c += "", Me.lastIndex = 0, Me.test(d) || (f = Q(d), _ = Q(c), _ ? f !== _ && (d = De(e, h, d, _) + _) : f && (c += f)), this.add(s, "setProperty", d, c, r, i, 0, 0, h), n.push(h), C.push(h, 0, s[h]);
        else if (m !== "undefined") {
          if (l && h in l ? (d = typeof l[h] == "function" ? l[h].call(a, r, e, i) : l[h], W(d) && ~d.indexOf("random(") && (d = Et(d)), Q(d + "") || d === "auto" || (d += le.units[h] || Q(Ae(e, h)) || ""), (d + "").charAt(1) === "=" && (d = Ae(e, h))) : d = Ae(e, h), p = parseFloat(d), w = m === "string" && c.charAt(1) === "=" && c.substr(0, 2), w && (c = c.substr(2)), u = parseFloat(c), h in be && (h === "autoAlpha" && (p === 1 && Ae(e, "visibility") === "hidden" && u && (p = 0), C.push("visibility", 0, s.visibility), Pe(this, s, "visibility", p ? "inherit" : "hidden", u ? "inherit" : "hidden", !u)), h !== "scale" && h !== "transform" && (h = be[h], ~h.indexOf(",") && (h = h.split(",")[0]))), x = h in Se, x) {
            ...
            if (y || (b = e._gsap, b.renderTransform && !t.parseTransform || Nt(e, t.parseTransform), S = t.smoothOrigin !== !1 && b.smooth, y = this._pt = new te(this._pt, s, L, 0, 1, b.renderTransform, b, 0, -1), y.dep = 1), h === "scale")
...
function Tr(o, e, t, a = D.thinkingShort, r = 1, i = "thinking", n = 0) {
  const s = a * Math.max(1, r), l = r >= 3 && Ii(e, t, {
    kind: "thinking",
    key: i,
    text: i,
    stepIndex: n,
...
class go {
  ...
  handlePointerMove = (e) => {
    ...
    if (this.active) {
      this.mode === "follow" ? (this.updateFollowTarget(t), this.lastMoveAt = performance.now()) : this.isPointNearStoryCursor(t, X.reengageRadius) && this.resumeFollowing(t), this.scheduleFollow();
      return;
    }
  ...
  updateFollowTarget(e) {
    ...
    if (this.lastPointer) {
      ...
      r > 1.5 && (this.trailDirection = {
        x: a.x / r,
        y: a.y / r
      }, this.velocity = wo(a, X.maxMomentumStep));
    }
    const t = {
      x: e.x - this.trailDirection.x * X.trailDistance,
      y: e.y - this.trailDirection.y * X.trailDistance
    };
    Bt(e, t) < X.minPointerDistance && (t.x = e.x - this.trailDirection.x * X.minPointerDistance, t.y = e.y - this.trailDirection.y * X.minPointerDistance), this.target = t, this.pointer = e, this.lastPointer = e;
  }
  resumeFollowing(e) {
    this.mode = "follow", this.sniffAnchor = null, this.nextSniffAt = 0, this.sniffIndex = 0, this.returnAt = 0, this.lastPointer = e, this.updateFollowTarget(e), this.lastMoveAt = performance.now();
  }
  startSniffing() {
  ...
  startReturnAfterPause() {
    this.active && (this.mode = "returnWait", this.target = null, this.pointer = null, this.lastPointer = null, this.velocity = { x: 0, y: 0 }, window.cancelAnimationFrame(this.frame), this.frame = 0, this.returnAt = performance.now() + X.returnDelayMs, this.scheduleFollow());
  }
  completeReturn() {
  ...
  isCursorTooFarFromBrowser() {
    ...
    return fo(r, e) > X.maxBrowserDistance;
  }
  isPointNearStoryCursor(e, t = Lt.radius) {
