...
var pe = {
  ...
  var t = e[0], a, i;
  if (Me(t) || j(t) || (e = [e]), !(a = (t._gsap || {}).harness)) {
  ...
  for (var a in t)
    a !== "__proto__" && a !== "constructor" && a !== "prototype" && (e[a] = Me(t[a]) ? n(e[a] || (e[a] = {}), t[a]) : t[a]);
  return e;
}, ma = function(e, t) {
  var a = {}, i;
  for (i in e)
  ...
  return H && !t && H.selector ? H.selector(e) : X(e) && !a && (Xa || !Pt()) ? Za.call((t || mi).querySelectorAll(e), 0) : Z(e) ? ro(e, a) : Lr(e) ? Za.call(e, 0) : e ? [e] : [];
}, ei = function(e) {
  ...
  var a = Z(e), i, r;
  return !a && Me(e) && (i = a = e.radius || _e, e.values ? (e = xe(e.values), (r = !qe(e[0])) && (i *= i)) : e = ti(e.increment)), Je(t, a ? j(e) ? function(o) {
...
var yo = function(e, t, a, i, r, o, s) {
  ...
  if (j(e) && (e = Vt(e, r, t, a, i)), !Me(e) || e.style && e.nodeType || Z(e) || _r(e))
  ...
  if (v && (!p || !r) && (r = "none"), e._ease = ut(r, Wt.ease), e._rEase = x && (ut(x) || e._ease), e._from = !v && !!i.runBackwards, e._from && (e.ratio = 1), !v || p && !i.stagger) {
    ...
    for (e._pt = e._ptCache = 0, l = g && ae(l) || l && !g, k = 0; k < f.length; k++) {
      if (E = f[k], L = E._gsap || bi(f)[k]._gsap, e._ptLookup[k] = P = {}, Ka[L.id] && We.length && ha(), G = y === f ? k : y.indexOf(E), I && (N = new I()).init(E, z || T, e, G, y) !== !1 && (e._pt = S = new re(e._pt, E, N.name, 0, 1, N.render, N, 0, N.priority), N._props.forEach(function(fe) {
        P[fe] = S;
      }), N.priority && (B = 1)), !I || z)
        for (C in T)
          le[C] && (N = Xr(C, T, e, G, E, y)) ? N.priority && (B = 1) : P[C] = S = _i.call(e, E, C, "get", T[C], G, y, 0, i.stringFilter);
      e._op && e._op[k] && e.kill(E, e._op[k]), _ && e._pt && (He = e, V.killTweensOf(E, P, e.globalTime(t)), ee = !e.parent, He = 0), e._pt && l && (Ka[L.id] = 1);
    }
...
pe.stringFilter = jr;
var pt = [], ua = {}, Po = [], Hi = 0, Io = 0, Ia = function(e) {
  return (ua[e] || Po).map(function(t) {
    return t();
  });
}, ii = function() {
  var e = Date.now(), t = [];
  ...
  registerEffect: function(e) {
    ...
    (i || "").split(",").forEach(function(s) {
      ...
      return this.add(Ta[t](s, Me(l) ? l : (d = l) && {}, this), d);
    });
  },
...
function Ul(n, e) {
  ...
  if (i && l.push(Ca(i, { hold: M.thinkingMedium, at: "+=0.06" })), s) {
    const d = F(
...
function An(n, e, t, a = !1) {
  ...
  if (t.kind === "thinking") {
    n.push(Ca(t, { hold: M.thinkingMedium }));
    return;
  }
...
function Dd(n, e = {}) {
  ...
  const t = e.stories?.length ? e.stories : Dn, a = e.builderDraftEndpoint ?? "/api/story-draft", i = e.reducedMotion ?? window.matchMedia?.("(prefers-reduced-motion: reduce)").matches ?? !1, r = new Rd(n), o = new As(n), s = new qs(n, r, { reducedMotion: i }), l = new Pd(n, t, r, s, o, {
