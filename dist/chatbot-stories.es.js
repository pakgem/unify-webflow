...
var le = {
  ...
  overwrite: !1,
  delay: 0
}, Na, X, D, me = 1e8, I = 1 / me, wa = Math.PI * 2, Gr = wa / 4, Ur = 0, Fi = Math.sqrt, Yr = Math.cos, Vr = Math.sin, j = function(e) {
...
}, Z = Array.isArray, Wr = /random\([^)]+\)/g, jr = /,\s*/g, ei = /(?:-?\.?\d|\.)+/gi, qi = /[-+=.]*\d+[.e\-+]*\d*[e\-+]*\d*/g, st = /[-+=.]*\d+[.e-]*\d*[a-z%]*/g, na = /[-+=.]*\d+\.?\d*(?:e-|e\+)?\d*/gi, Hi = /[+-]=-?[.\d]+/, Xr = /[^,'"\[\]\s]+/gi, Jr = /^[+\-=e\s\d]*\d+[.\d]*([a-z]*|%)\s*$/i, z, _e, ba, Oa, de = {}, Xt = {}, Gi, Ui = function(e) {
  return (Xt = ut(e, de)) && ie;
}, za = function(e, t) {
  return console.warn("Invalid property", e, "set to", t, "Missing plugin? gsap.registerPlugin()");
}, It = function(e, t) {
  return !t && console.warn(e);
}, Yi = function(e, t) {
  return e && (de[e] = t) && Xt && (Xt[e] = t) || de;
}, Nt = function() {
  return 0;
}, Qr = {
  suppressEvents: !0,
  ...
  suppressEvents: !0
}, La = {}, Re = [], _a = {}, Vi, re = {}, sa = {}, ti = 30, Wt = [], Fa = "", Ba = function(e) {
  var t = e[0], a, i;
  if (ve(t) || q(t) || (e = [e]), !(a = (t._gsap || {}).harness)) {
    for (i = Wt.length; i-- && !Wt[i].targetTest(t); )
      ;
    a = Wt[i];
  }
  for (i = e.length; i--; )
  ...
  return e._gsap || Ba(ge(e))[0]._gsap;
}, Wi = function(e, t, a) {
  ...
  var e = Re.length, t = Re.slice(0), a, i;
  for (_a = {}, Re.length = 0, a = 0; a < e; a++)
    i = t[a], i && i._lazy && (i.render(i._lazy[0], i._lazy[1], !0)._lazy = 0);
}, qa = function(e) {
  return !!(e._initted || e._startAt || e.add);
}, ji = function(e, t, a, i) {
  Re.length && !X && Jt(), e.render(t, a, !!(X && t < 0 && qa(e))), Re.length && !X && Jt();
}, Xi = function(e) {
  var t = parseFloat(e);
  return (t || t === 0) && (e + "").match(Xr).length < 2 ? t : j(e) ? e.trim() : e;
}, Ji = function(e) {
  return e;
}, ce = function(e, t) {
  for (var a in t)
  ...
  var t = e.parent || z, a = e.keyframes ? $r(Z(e.keyframes)) : ce;
  if ($(e.inherit))
    for (; t; )
  ...
  return e._startAt && (X ? e._startAt.revert(Vt) : e.vars.immediateRender && !e.vars.autoRevert || e._startAt.render(t, !0, i));
}, an = function o(e) {
  ...
  return e._end = O(e._start + (e._tDur / Math.abs(e._ts || e._rts || I) || 0));
}, ra = function(e, t) {
  var a = e._dp;
  return a && a.smoothChildTiming && e._ts && (e._start = O(a._time - (e._ts > 0 ? t / e._ts : ((e._dirty ? e.totalDuration() : e._tDur) - t) / -e._ts)), ia(e), a._dirty || Xe(a, e)), e;
}, Zi = function(e, t) {
  var a;
  if ((t._time || !t._dur && t._initted || t._start < e._time && (t._dur || !t.add)) && (a = Zt(e.rawTime(), t), (!t._dur || Ft(0, t.totalDuration(), a) - t._tTime > I) && t.render(a, !0)), Xe(e, t)._dp && e._initted && e._time >= e._dur && e._ts) {
  ...
  return t.parent && Oe(t), t._start = O((Te(a) ? a : a || e !== z ? he(e, a, t) : e._time) + t._delay), t._end = O(t._start + (t.totalDuration() / Math.abs(t.timeScale()) || 0)), Qi(e, t, "_first", "_last", e._sort ? "_start" : 0), xa(t) || (e._recent = t), i || Zi(e, t), e._ts < 0 && ra(e, e._tTime), e;
}, Ki = function(e, t) {
  return (de.ScrollTrigger || za("scrollTrigger", t)) && de.ScrollTrigger.create(t, e);
}, $i = function(e, t, a, i, r) {
  if (Ga(e, t, r), !e._initted)
    return 1;
  if (!a && e._pt && !X && (e._dur && e.vars.lazy !== !1 || !e._dur && e.vars.lazy) && Vi !== ne.frame)
    return Re.push(e), e._lazy = [r, i], 1;
}, rn = function o(e) {
  var t = e.parent;
  ...
  var r = e.ratio, n = t < 0 || !t && (!e._start && rn(e) && !(!e._initted && xa(e)) || (e._ts < 0 || e._dp._ts < 0) && !xa(e)) ? 0 : 1, s = e._rDelay, l = 0, d, c, u;
  if (s && e._repeat && (l = Ft(0, e._tDur, t), c = pt(l, s), e._yoyo && c & 1 && (n = 1 - n), c !== pt(e._tTime, s) && (r = 1 - n, e.vars.repeatRefresh && e._initted && e.invalidate())), n !== r || X || i || e._zTime === I || !t && e._zTime) {
    if (!e._initted && $i(e, t, i, a, l))
      return;
    for (u = e._zTime, e._zTime = t || (a ? I : 0), a || (a = t && !u), e.ratio = n, e._from && (n = 1 - n), e._time = 0, e._tTime = l, d = e._pt; d; )
      d.r(n, d.d), d = d._next;
    t < 0 && ya(e, t, a, !0), e._onUpdate && !a && se(e, "onUpdate"), l && e._repeat && !a && e.parent && se(e, "onRepeat"), (t >= e._tDur || t < 0) && e.ratio === n && (n && Oe(e, 1), !a && !X && (se(e, n ? "onComplete" : "onReverseComplete", !0), e._prom && e._prom()));
  ...
  return s && !i && (e._time *= n / e._dur), e._dur = n, e._tDur = r ? r < 0 ? 1e10 : O(n * (r + 1) + e._rDelay * r) : n, s > 0 && !i && ra(e, e._tTime = e._tDur * s), e.parent && ia(e), a || Xe(e.parent, e), e;
}, ri = function(e) {
  return e instanceof K ? Xe(e) : ht(e, e._dur);
}, on = {
  _start: 0,
  endTime: Nt,
  totalDuration: Nt
}, he = function o(e, t, a) {
  var i = e.labels, r = e._recent || on, n = e.duration() >= me ? r.endTime(!1) : e._dur, s, l, d;
  ...
  return Fe(a, function(i) {
    return Ft(e, t, i);
  });
}, va = [].slice, er = function(e, t) {
  return e && ve(e) && "length" in e && (!t && !e.length || e.length - 1 in e && ve(e[0])) && !e.nodeType && e !== _e;
}, dn = function(e, t, a) {
  return a === void 0 && (a = []), e.forEach(function(i) {
    var r;
    return j(i) && !t || er(i, 1) ? (r = a).push.apply(r, ge(i)) : a.push(i);
  }) || a;
}, ge = function(e, t, a) {
  return D && !t && D.selector ? D.selector(e) : j(e) && !a && (ba || !mt()) ? va.call((t || Oa).querySelectorAll(e), 0) : Z(e) ? dn(e, a) : er(e) ? va.call(e, 0) : e ? [e] : [];
}, Aa = function(e) {
  return e = ge(e)[0] || It("Invalid scope") || {}, function(t) {
    var a = e.current || e.nativeElement || e;
    return ge(t, a.querySelectorAll ? a : a === e ? It("Invalid scope") || Oa.createElement("div") : e);
  };
}, tr = function(e) {
  ...
  var t = ve(e) ? e : {
    each: e
  }, a = Je(t.ease), i = t.from || 0, r = parseFloat(t.base) || 0, n = {}, s = i > 0 && i < 1, l = isNaN(i) || s, d = t.axis, c = i, u = i;
  return j(i) ? c = u = {
    center: 0.5,
    edges: 0.5,
    end: 1
  }[i] || 0 : !s && l && (c = i[0], u = i[1]), function(h, m, g) {
    var p = (g || t).length, f = n[p], b, _, x, v, y, k, A, S, C;
    if (!f) {
      if (C = t.grid === "auto" ? 0 : (t.grid || [1, me])[1], !C) {
        for (A = -me; A < (A = g[C++].getBoundingClientRect().left) && C < p; )
          ;
        C < p && C--;
      }
      for (f = n[p] = [], b = l ? Math.min(C, p) * c - 0.5 : i % C, _ = C === me ? 0 : l ? p * u / C - 0.5 : i / C | 0, A = 0, S = me, k = 0; k < p; k++)
        x = k % C - b, v = _ - (k / C | 0), f[k] = y = d ? Math.abs(d === "y" ? v : x) : Fi(x * x + v * v), y > A && (A = y), y < S && (S = y);
      i === "random" && tr(f), f.max = A - S, f.min = S, f.v = p = (parseFloat(t.amount) || parseFloat(t.each) * (C > p ? p - 1 : d ? d === "y" ? p / C : C : Math.max(C, p / C)) || 0) * (i === "edges" ? -1 : 1), f.b = p < 0 ? r - p : r, f.u = Q(t.amount || t.each) || 0, a = a && p < 0 ? vn(a) : a;
    }
    return p = (f[h] - f.min) / f.max || 0, O(f.b + (a ? a(p) : p) * f.v) + f.u;
  };
}, Ca = function(e) {
  var t = Math.pow(10, ((e + "").split(".")[1] || "").length);
  return function(a) {
    var i = O(Math.round(parseFloat(a) / e) * e * t);
    return (i - i % 1) / t + (Te(a) ? 0 : Q(a));
  };
}, ir = function(e, t) {
  var a = Z(e), i, r;
  return !a && ve(e) && (i = a = e.radius || me, e.values ? (e = ge(e.values), (r = !Te(e[0])) && (i *= i)) : e = Ca(e.increment)), Fe(t, a ? q(e) ? function(n) {
    return r = e(n), Math.abs(r - n) <= i ? r : n;
  } : function(n) {
    for (var s = parseFloat(r ? n.x : n), l = parseFloat(r ? n.y : 0), d = me, c = 0, u = e.length, h, m; u--; )
      r ? (h = e[u].x - s, m = e[u].y - l, h = h * h + m * m) : h = Math.abs(e[u] - s), h < d && (d = h, c = u);
    return c = !i || d <= i ? e[c] : n, r || c === n || Te(n) ? c : c + Q(n);
  } : Ca(e));
}, rr = function(e, t, a, i) {
  return Fe(Z(e) ? !t : a === !0 ? !!(a = 0) : !i, function() {
  ...
  var i = t - e;
  return Z(e) ? nr(e, o(0, e.length), t) : Fe(a, function(r) {
    return (i + (r - e) % i) % i + e;
  });
}, mn = function o(e, t, a) {
  var i = t - e, r = i * 2;
  return Z(e) ? nr(e, o(0, e.length - 1), t) : Fe(a, function(n) {
    return n = (r + (n - e) % r) % r || 0, e + (n > i ? r - n : n);
  });
}, Rt = function(e) {
  return e.replace(Wr, function(t) {
    var a = t.indexOf("[") + 1, i = t.substring(a || 7, a ? t.indexOf("]") : t.length - 1).split(jr);
...
}, gn = function o(e, t, a, i) {
  var r = isNaN(e + t) ? 0 : function(m) {
    return (1 - m) * e + m * t;
  };
  if (!r) {
    var n = j(e), s = {}, l, d, c, u, h;
    if (a === !0 && (i = 1) && (a = null), n)
      e = {
        p: e
      }, t = {
    ...
    if (!c) {
      for (l in t)
        Ha.call(s, e, l, "get", t[l]);
      r = function(g) {
        return Va(g, s) || (n ? e.p : e);
      };
    }
  }
  return Fe(a, r);
}, ni = function(e, t, a) {
  var i = e.labels, r = me, n, s, l;
  for (n in i)
    s = i[n] - t, s < 0 == !!a && s && r > (s = Math.abs(s)) && (l = n, r = s);
  return l;
}, se = function(e, t, a) {
  var i = e.vars, r = i[t], n = D, s = e._ctx, l, d, c;
  if (r)
    return l = i[t + "Params"], d = i.callbackScope || e, a && Re.length && Jt(), s && (D = s), c = l ? r.apply(d, l) : r.call(d), D = n, c;
}, At = function(e) {
  return Oe(e), e.scrollTrigger && e.scrollTrigger.kill(!!X), e.progress() < 1 && se(e, "onInterrupt"), e;
}, ot, or = [], lr = function(e) {
  if (e)
    if (e = !e.name && e.default || e, Da() || e.headless) {
      ...
      if (mt(), e !== i) {
        if (re[t])
          return;
        ce(i, ce(Qt(e, r), n)), ut(i.prototype, ut(r, Qt(e, n))), re[i.prop = t] = i, e.targetTest && (Wt.push(i), La[t] = 1), t = (t === "css" ? "CSS" : t.charAt(0).toUpperCase() + t.substr(1)) + "Plugin";
      }
      Yi(t, i), e.register && e.register(ie, i, te);
    } else
      or.push(e);
}, M = 255, Ct = {
  aqua: [0, M, M],
  ...
  var i = e ? Te(e) ? [e >> 16, e >> 8 & M, e & M] : 0 : Ct.black, r, n, s, l, d, c, u, h, m, g;
  if (!i) {
    if (e.substr(-1) === "," && (e = e.substr(0, e.length - 1)), Ct[e])
      ...
      if (i = g = e.match(ei), !t)
        l = +i[0] % 360 / 360, d = +i[1] / 100, c = +i[2] / 100, n = c <= 0.5 ? c * (d + 1) : c + d - c * d, r = c * 2 - n, i.length > 3 && (i[3] *= 1), i[0] = oa(l + 1 / 3, r, n), i[1] = oa(l, r, n), i[2] = oa(l - 1 / 3, r, n);
      else if (~e.indexOf("="))
        return i = e.match(qi), a && i.length < 4 && (i[3] = 1), i;
    } else
      i = e.match(ei) || Ct.transparent;
    i = i.map(Number);
  }
  return t && !g && (r = i[0] / M, n = i[1] / M, s = i[2] / M, u = Math.max(r, n, s), h = Math.min(r, n, s), c = (u + h) / 2, u === h ? l = d = 0 : (m = u - h, d = c > 0.5 ? m / (2 - u - h) : m / (u + h), l = u === r ? (n - s) / m + (n < s ? 6 : 0) : u === n ? (s - r) / m + 2 : (r - n) / m + 4, l *= 60), i[0] = ~~(l + 0.5), i[1] = ~~(d * 100 + 0.5), i[2] = ~~(c * 100 + 0.5)), a && i.length < 4 && (i[3] = 1), i;
}, cr = function(e) {
  var t = [], a = [], i = -1;
  ...
  if (r = r.map(function(h) {
    return (h = dr(h, t, 1)) && n + (t ? h[0] + "," + h[1] + "%," + h[2] + "%," + h[3] : h.join(",")) + ")";
  }), a && (c = cr(e), l = a.c, l.join(i) !== c.c.join(i)))
    for (d = e.replace(De, "1").split(st), u = d.length - 1; s < u; s++)
...
})(), fn = /hsl[a]?\(/, ur = function(e) {
  var t = e.join(" "), a;
  if (De.lastIndex = 0, De.test(t))
    return a = fn.test(t), e[1] = si(e[1], a), e[0] = si(e[0], a, cr(e[1])), !0;
}, Dt, ne = (function() {
  var o = Date.now, e = 500, t = 33, a = o(), i = a, r = 1e3 / 240, n = r, s = [], l, d, c, u, h, m, g = function p(f) {
    var b = o() - i, _ = f === !0, x, v, y, k;
    if ((b > e || b < 0) && (a += b - t), i += b, y = i - a, x = y - n, (x > 0 || _) && (k = ++u.frame, h = y - u.time * 1e3, u.time = y = y / 1e3, n += x + (x >= r ? 4 : r - x), v = 1), _ || (l = d(p)), v)
  ...
  return u = {
    ...
    wake: function() {
      Gi && (!ba && Da() && (_e = ba = window, Oa = _e.document || {}, de.gsap = ie, (_e.gsapVersions || (_e.gsapVersions = [])).push(ie.version), Ui(Xt || _e.GreenSockGlobals || !_e.gsap && _e || {}), or.forEach(lr)), c = typeof requestAnimationFrame < "u" && requestAnimationFrame, l && u.sleep(), d = c || function(f) {
        return setTimeout(f, n - u.time * 1e3 + 1 | 0);
      }, Dt = 1, g(2));
    },
    sleep: function() {
      (c ? cancelAnimationFrame : clearTimeout)(l), Dt = 0, d = Nt;
    },
    ...
    add: function(f, b, _) {
      var x = b ? function(v, y, k, A) {
        f(v, y, k, A), u.remove(x);
      } : f;
  ...
  return !Dt && ne.wake();
}, P = {}, wn = /^[\d.\-M][\d.\-,\s]/, bn = /["']/g, _n = function(e) {
  for (var t = {}, a = e.substr(1, e.length - 3).split(":"), i = a[0], r = 1, n = a.length, s, l, d; r < n; r++)
    l = a[r], s = r !== n - 1 ? l.lastIndexOf(",") : l.length, d = l.substr(0, s), t[i] = isNaN(d) ? d.replace(bn, "").trim() : +d, i = l.substr(s + 1).trim();
  return t;
}, yn = function(e) {
  ...
  return a && t.length > 1 && a.config ? a.config.apply(null, ~e.indexOf("{") ? [_n(t[1])] : yn(e).split(",").map(Xi)) : P._CE && wn.test(e) ? P._CE("", e) : a;
}, vn = function(e) {
  return function(t) {
    return 1 - e(1 - t);
  };
}, Je = function(e, t) {
  return e && (q(e) ? e : P[e] || xn(e)) || t;
}, Ze = function(e, t, a, i) {
  ...
  return ee(e, function(s) {
    P[s] = de[s] = r, P[n = s.toLowerCase()] = a;
    for (var l in r)
  ...
  var i = t >= 1 ? t : 1, r = (a || (e ? 0.3 : 0.45)) / (t < 1 ? t : 1), n = r / wa * (Math.asin(1 / i) || 0), s = function(c) {
    return c === 1 ? 1 : i * Math.pow(2, -10 * c) * Vr((c - n) * r) + 1;
...
Ze("Sine", function(o) {
  return o === 1 ? 1 : -Yr(o * Gr) + 1;
});
Ze("Back", da("in"), da("out"), da());
P.SteppedEase = P.steps = de.SteppedEase = {
  config: function(e, t) {
    e === void 0 && (e = 1);
    var a = 1 / e, i = e + (t ? 0 : 1), r = t ? 1 : 0, n = 1 - I;
    return function(s) {
      return ((i * Ft(0, n, s) | 0) + r) * a;
    };
  }
};
Mt.ease = P["quad.out"];
...
var hr = function(e, t) {
  this.id = Ur++, e._gsap = this, this.target = e, this.harness = t, this.get = t ? t.get : Wi, this.set = t ? t.getSetter : Ya;
}, Ot = /* @__PURE__ */ (function() {
  function o(t) {
    this.vars = t, this._delay = +t.delay || 0, (this._repeat = t.repeat === 1 / 0 ? -2 : t.repeat || 0) && (this._rDelay = t.repeatDelay || 0, this._yoyo = !!t.yoyo || !!t.yoyoEase), this._ts = 1, ht(this, +t.duration, 1, 1), this.data = t.data, D && (this._ctx = D, D.data.push(this)), Dt || ne.wake();
  }
  var e = o.prototype;
  return e.delay = function(a) {
    ...
    return arguments.length ? (this._dirty = 0, ht(this, this._repeat < 0 ? a : (a - this._repeat * this._rDelay) / (this._repeat + 1))) : this._tDur;
  }, e.totalTime = function(a, i) {
    if (mt(), !arguments.length)
      return this._tTime;
    var r = this._dp;
    if (r && r.smoothChildTiming && this._ts) {
      for (ra(this, a), !r._dp || r.parent || Zi(r, this); r && r.parent; )
    ...
    return (this._tTime !== a || !this._dur && !i || this._initted && Math.abs(this._zTime) === I || !this._initted && this._dur && a || !a && !this._initted && (this.add || this._ptLookup)) && (this._ts || (this._pTime = a), ji(this, a, i)), this;
  }, e.time = function(a, i) {
    return arguments.length ? this.totalTime(Math.min(this.totalDuration(), a + ii(this)) % (this._dur + this._rDelay) || (a ? this._dur : 0), i) : this._time;
    ...
    return arguments.length ? this.totalTime(this.duration() * (this._yoyo && !(this.iteration() & 1) ? 1 - a : a) + ii(this), i) : this.duration() ? Math.min(1, this._time / this._dur) : this.rawTime() > 0 ? 1 : 0;
    ...
    return this._rts = +a || 0, this._ts = this._ps || a === -I ? 0 : this._rts, this.totalTime(Ft(-Math.abs(this._delay), this.totalDuration(), r), i !== !1), ia(this), tn(this);
  }, e.paused = function(a) {
    return arguments.length ? (this._ps !== a && (this._ps = a, a ? (this._pTime = this._tTime || Math.max(-this._delay, this.rawTime()), this._ts = this._act = 0) : (mt(), this._ts = this._rts, this.totalTime(this.parent && !this.parent.smoothChildTiming ? this.rawTime() : this._tTime || this._pTime, this.progress() === 1 && Math.abs(this._zTime) !== I && (this._tTime -= I)))), this) : this._ps;
    ...
    var i = this.parent || this._dp;
    return i ? a && (!this._ts || this._repeat && this._time && this.totalProgress() < 1) ? this._tTime % (this._dur + this._rDelay) : this._ts ? Zt(i.rawTime(a), this) : this._tTime : this._tTime;
  }, e.revert = function(a) {
    a === void 0 && (a = Zr);
    var i = X;
    return X = a, qa(this) && (this.timeline && this.timeline.revert(a), this.totalTime(-0.01, a.suppressEvents)), this.data !== "nested" && a.kill !== !1 && this.kill(), X = i, this;
    ...
    return arguments.length ? (this._repeat = a === 1 / 0 ? -2 : a, ri(this)) : this._repeat === -2 ? 1 / 0 : this._repeat;
  }, e.repeatDelay = function(a) {
    if (arguments.length) {
      var i = this._time;
      return this._rDelay = a, ri(this), i ? this.time(i) : this;
    }
    return this._rDelay;
  }, e.yoyo = function(a) {
    ...
    return this.play().totalTime(a ? -this._delay : 0, $(i)), this._dur || (this._zTime = -I), this;
  }, e.play = function(a, i) {
    ...
    return arguments.length ? (!!a !== this.reversed() && this.timeScale(-this._rts || (a ? -I : 0)), this) : this._rts < 0;
  }, e.invalidate = function() {
    return this._initted = this._act = 0, this._zTime = -I, this;
  }, e.isActive = function() {
    var a = this.parent || this._dp, i = this._start, r;
    return !!(!a || this._ts && this._initted && a.isActive() && (r = a.rawTime(!0)) >= i && r < this.endTime(!0) - I);
...
var K = /* @__PURE__ */ (function(o) {
  ...
  function e(a, i) {
    var r;
    return a === void 0 && (a = {}), r = o.call(this, a) || this, r.labels = {}, r.smoothChildTiming = !!a.smoothChildTiming, r.autoRemoveChildren = !!a.autoRemoveChildren, r._sort = $(a.sortChildren), z && ye(a.parent || z, Se(r), i), a.reversed && r.reverse(), a.paused && r.paused(!0), a.scrollTrigger && Ki(Se(r), a.scrollTrigger), r;
  }
  var t = e.prototype;
  return t.to = function(i, r, n) {
    ...
    return r.duration = 0, r.parent = this, kt(r).repeatDelay || (r.repeat = 0), r.immediateRender = !!r.immediateRender, new Y(i, r, he(this, n), 1), this;
    ...
    return n.runBackwards = 1, kt(n).immediateRender = $(n.immediateRender), this.staggerTo(i, r, n, s, l, d, c);
  }, t.staggerFromTo = function(i, r, n, s, l, d, c, u) {
    return s.startAt = n, kt(s).immediateRender = $(s.immediateRender), this.staggerTo(i, r, s, l, d, c, u);
  }, t.render = function(i, r, n) {
    var s = this._time, l = this._dirty ? this.totalDuration() : this._tDur, d = this._dur, c = i <= 0 ? 0 : O(i), u = this._zTime < 0 != i < 0 && (this._initted || !d), h, m, g, p, f, b, _, x, v, y, k, A;
    if (this !== z && c > l && i >= 0 && (c = l), c !== this._tTime || n || u) {
      if (s !== this._time && d && (c += this._time - s, i += this._time - s), h = c, v = this._start, x = this._ts, b = !x, u && (d || (s = this._zTime), (i || !r) && (this._zTime = i)), this._repeat) {
        if (k = this._yoyo, f = d + this._rDelay, this._repeat < -1 && i < 0)
          return this.totalTime(f * 100 + i, r, n);
        if (h = O(c % f), c === l ? (p = this._repeat, h = d) : (y = O(c / f), p = ~~y, p && p === y && (h = d, p--), h > d && (h = d)), y = pt(this._tTime, f), !s && this._tTime && y !== p && this._tTime - y * f - this._dur <= 0 && (y = p), k && p & 1 && (h = d - h, A = 1), p !== y && !this._lock) {
          var S = k && y & 1, C = S === (k && p & 1);
          if (p < y && (S = !S), s = S ? 0 : c % d ? d : c, this._lock = 1, this.render(s || (A ? 0 : O(p * f)), r, !d)._lock = 0, this._tTime = c, !r && this.parent && se(this, "onRepeat"), this.vars.repeatRefresh && !A && (this.invalidate()._lock = 1, y = p), s && s !== this._time || b !== !this._ts || this.vars.onRepeat && !this.parent && !this._act)
            return this;
          if (d = this._dur, l = this._tDur, C && (this._lock = 2, s = S ? d : -1e-4, this.render(s, !0), this.vars.repeatRefresh && !A && this.invalidate()), this._lock = 0, !this._ts && !b)
            return this;
        }
      }
      if (this._hasPause && !this._forcing && this._lock < 2 && (_ = sn(this, O(s), O(h)), _ && (c -= h - (h = _._start))), this._tTime = c, this._time = h, this._act = !!x, this._initted || (this._onUpdate = this.vars.onUpdate, this._initted = 1, this._zTime = i, s = 0), !s && c && d && !r && !y && (se(this, "onStart"), this._tTime !== c))
        return this;
      if (h >= s && i >= 0)
        for (m = this._first; m; ) {
          if (g = m._next, (m._act || h >= m._start) && m._ts && _ !== m) {
            ...
            if (m.render(m._ts > 0 ? (h - m._start) * m._ts : (m._dirty ? m.totalDuration() : m._tDur) + (h - m._start) * m._ts, r, n), h !== this._time || !this._ts && !b) {
              _ = 0, g && (c += this._zTime = -I);
              break;
            }
          }
          m = g;
        ...
        for (var E = i < 0 ? i : h; m; ) {
          if (g = m._prev, (m._act || E <= m._end) && m._ts && _ !== m) {
            if (m.parent !== this)
              return this.render(i, r, n);
            if (m.render(m._ts > 0 ? (E - m._start) * m._ts : (m._dirty ? m.totalDuration() : m._tDur) + (E - m._start) * m._ts, r, n || X && qa(m)), h !== this._time || !this._ts && !b) {
              _ = 0, g && (c += this._zTime = E ? -I : I);
              break;
            }
          }
          m = g;
      ...
      if (_ && !r && (this.pause(), _.render(h >= s ? 0 : -I)._zTime = h >= s ? 1 : -1, this._ts))
        return this._start = v, ia(this), this.render(i, r, n);
      this._onUpdate && !r && se(this, "onUpdate", !0), (c === l && this._tTime >= this.totalDuration() || !c && s) && (v === this._start || Math.abs(x) !== Math.abs(this._ts)) && (this._lock || ((i || !d) && (c === l && this._ts > 0 || !c && this._ts < 0) && Oe(this, 1), !r && !(i < 0 && !s) && (c || s || !l) && (se(this, c === l && i >= 0 ? "onComplete" : "onReverseComplete", !0), this._prom && !(c < l && this.timeScale() > 0) && this._prom())));
    }
    return this;
  }, t.add = function(i, r) {
    var n = this;
    if (Te(r) || (r = he(this, r, i)), !(i instanceof Ot)) {
      if (Z(i))
    ...
    i === void 0 && (i = !0), r === void 0 && (r = !0), n === void 0 && (n = !0), s === void 0 && (s = -me);
    ...
    return j(i) ? this.removeLabel(i) : q(i) ? this.killTweensOf(i) : (i.parent === this && aa(this, i), i === this._recent && (this._recent = this._last), Xe(this));
    ...
    var s = Y.delayedCall(0, r || Nt, n);
    return s.data = "isPause", this._hasPause = 1, ye(this, s, he(this, i));
    ...
    for (var n = [], s = ge(i), l = this._first, d = Te(r), c; l; )
      l instanceof Y ? Kr(l._targets, s) && (d ? (!Me || l._initted && l._ts) && l.globalTime(0) <= r && l.globalTime(l.totalDuration()) > r : !r || l.isActive()) && n.push(l) : (c = l.getTweensOf(s, r)).length && n.push.apply(n, c), l = l._next;
    return n;
  }, t.tweenTo = function(i, r) {
    r = r || {};
    var n = this, s = he(n, i), l = r, d = l.startAt, c = l.onStart, u = l.onStartParams, h = l.immediateRender, m, g = Y.to(n, ce({
      ease: r.ease || "none",
      lazy: !1,
      immediateRender: !1,
      time: s,
      overwrite: "auto",
      duration: r.duration || Math.abs((s - (d && "time" in d ? d.time : n._time)) / n.timeScale()) || I,
      onStart: function() {
        if (n.pause(), !m) {
          var f = r.duration || Math.abs((s - (d && "time" in d ? d.time : n._time)) / n.timeScale());
          g._dur !== f && ht(g, f, 0, 1).render(g._time, !0, !0), m = 1;
        }
        c && c.apply(g, u || []);
      }
    }, r));
    ...
    return i === void 0 && (i = this._time), ni(this, he(this, i));
  }, t.previousLabel = function(i) {
    return i === void 0 && (i = this._time), ni(this, he(this, i), 1);
    ...
    var r = 0, n = this, s = n._last, l = me, d, c, u;
    if (arguments.length)
      return n.timeScale((n._repeat < 0 ? n.duration() : n.totalDuration()) / (n.reversed() ? -i : i));
    if (n._dirty) {
      for (u = n.parent; s; )
        d = s._prev, s._dirty && s.totalDuration(), c = s._start, c > l && n._sort && s._ts && !n._lock ? (n._lock = 1, ye(n, s, c - s._delay, 1)._lock = 0) : l = c, c < 0 && s._ts && (r -= c, (!u && !n._dp || u && u.smoothChildTiming) && (n._start += O(c / n._ts), n._time -= c, n._tTime -= c), n.shiftChildren(-c, !1, -1 / 0), l = 0), s._end > r && s._ts && (r = s._end), s = d;
      ht(n, n === z && n._time > r ? n._time : r, 1, 1), n._dirty = 0;
    }
    return n._tDur;
  }, e.updateRoot = function(i) {
    if (z._ts && (ji(z, Zt(i, z)), Vi = ne.frame), ne.frame >= ti) {
      ti += le.autoSleep || 120;
      var r = z._first;
...
var An = function(e, t, a, i, r, n, s) {
  var l = new te(this._pt, e, t, 0, 1, _r, null, r), d = 0, c = 0, u, h, m, g, p, f, b, _;
  for (l.b = a, l.e = i, a += "", i += "", (b = ~i.indexOf("random(")) && (i = Rt(i)), n && (_ = [a, i], n(_, e, t), a = _[0], i = _[1]), h = a.match(na) || []; u = na.exec(i); )
    g = u[0], p = i.substring(d, u.index), m ? m = (m + 1) % 5 : p.substr(-5) === "rgba(" && (m = 1), g !== h[c++] && (f = parseFloat(h[c - 1]) || 0, l._pt = {
      ...
      s: f,
      c: g.charAt(1) === "=" ? lt(f, g) - f : parseFloat(g) - f,
      m: m && m < 4 ? Math.round : 0
    }, d = na.lastIndex);
  return l.c = d < i.length ? i.substring(d, i.length) : "", l.fp = s, (Hi.test(i) || b) && (l.e = 0), this._pt = l, l;
}, Ha = function(e, t, a, i, r, n, s, l, d, c) {
  q(i) && (i = i(r || 0, e, n));
  var u = e[t], h = a !== "get" ? a : q(u) ? d ? e[t.indexOf("set") || !q(e["get" + t.substr(3)]) ? t : "get" + t.substr(3)](d) : e[t]() : u, m = q(u) ? d ? En : wr : Ua, g;
  if (j(i) && (~i.indexOf("random(") && (i = Rt(i)), i.charAt(1) === "=" && (g = lt(h, i) + (Q(h) || 0), (g || g === 0) && (i = g))), !c || h !== i || Sa)
    return !isNaN(h * i) && i !== "" ? (g = new te(this._pt, e, t, +h || 0, i - (h || 0), typeof u == "boolean" ? Mn : br, 0, m), d && (g.fp = d), s && g.modifier(s, this, e), this._pt = g) : (!u && !(t in e) && za(t, i), An.call(this, e, t, h, i, m, l || le.stringFilter, d));
}, Cn = function(e, t, a, i, r) {
  if (q(e) && (e = Et(e, r, t, a, i)), !ve(e) || e.style && e.nodeType || Z(e) || Bi(e))
    return j(e) ? Et(e, r, t, a, i) : e;
  var n = {}, s;
  for (s in e)
    n[s] = Et(e[s], r, t, a, i);
  return n;
  ...
  var s, l, d, c;
  if (re[e] && (s = new re[e]()).init(r, s.rawVars ? t[e] : Cn(t[e], i, r, n, a), a, i, n) !== !1 && (a._pt = l = new te(a._pt, r, e, 0, 1, s.render, s, 0, s.priority), a !== ot))
    for (d = a._ptLookup[a._targets.indexOf(r)], c = s._props.length; c--; )
      d[s._props[c]] = l;
  return s;
}, Me, Sa, Ga = function o(e, t, a) {
  var i = e.vars, r = i.ease, n = i.startAt, s = i.immediateRender, l = i.lazy, d = i.onUpdate, c = i.runBackwards, u = i.yoyoEase, h = i.keyframes, m = i.autoRevert, g = e._dur, p = e._startAt, f = e._targets, b = e.parent, _ = b && b.data === "nested" ? b.vars.targets : f, x = e._overwrite === "auto" && !Na, v = e.timeline, y = i.easeReverse || u, k, A, S, C, E, H, F, N, B, W, V, G, ue;
  if (v && (!h || !r) && (r = "none"), e._ease = Je(r, Mt.ease), e._rEase = y && (Je(y) || e._ease), e._from = !v && !!i.runBackwards, e._from && (e.ratio = 1), !v || h && !i.stagger) {
    if (N = f[0] ? je(f[0]).harness : 0, G = N && i[N.prop], k = Qt(i, La), p && (p._zTime < 0 && p.progress(1), t < 0 && c && s && !m ? p.render(-1, !0) : p.revert(c && g ? Vt : Qr), p._lazy = 0), n) {
      if (Oe(e._startAt = Y.set(f, ce({
        data: "isStart",
        overwrite: !1,
        parent: b,
        immediateRender: !0,
        ...
        stagger: 0
      }, n))), e._startAt._dp = 0, e._startAt._sat = e, t < 0 && (X || !s && !m) && e._startAt.revert(Vt), s && g && t <= 0 && a <= 0) {
        t && (e._zTime = t);
        return;
      }
    } else if (c && g && !p) {
      ...
      }, k), G && (S[N.prop] = G), Oe(e._startAt = Y.set(f, S)), e._startAt._dp = 0, e._startAt._sat = e, t < 0 && (X ? e._startAt.revert(Vt) : e._startAt.render(-1, !0)), e._zTime = t, !s)
        o(e._startAt, I, I);
      else if (!t)
        return;
    }
    for (e._pt = e._ptCache = 0, l = g && $(l) || l && !g, A = 0; A < f.length; A++) {
      if (E = f[A], F = E._gsap || Ba(f)[A]._gsap, e._ptLookup[A] = W = {}, _a[F.id] && Re.length && Jt(), V = _ === f ? A : _.indexOf(E), N && (B = new N()).init(E, G || k, e, V, _) !== !1 && (e._pt = C = new te(e._pt, E, B.name, 0, 1, B.render, B, 0, B.priority), B._props.forEach(function(Ke) {
        W[Ke] = C;
      }), B.priority && (H = 1)), !N || G)
        for (S in k)
          re[S] && (B = mr(S, k, e, V, E, _)) ? B.priority && (H = 1) : W[S] = C = Ha.call(e, E, S, "get", k[S], V, _, 0, i.stringFilter);
      e._op && e._op[A] && e.kill(E, e._op[A]), x && e._pt && (Me = e, z.killTweensOf(E, W, e.globalTime(t)), ue = !e.parent, Me = 0), e._pt && l && (_a[F.id] = 1);
    }
    H && yr(e), e._onInit && e._onInit(e);
  }
  e._onUpdate = d, e._initted = (!e._op || e._pt) && !ue, h && t <= 0 && v.render(me, !0, !0);
}, Sn = function(e, t, a, i, r, n, s, l) {
    ...
    for (d = e._ptCache[t] = [], h = e._ptLookup, m = e._targets.length; m--; ) {
      if (c = h[m][t], c && c.d && c.d._pt)
        for (c = c.d._pt; c && c.p !== t && c.fp !== t; )
          c = c._next;
      if (!c)
        return Sa = 1, e.vars[t] = "+=0", Ga(e, s), Sa = 0, l ? It(t + " not eligible for reset. Try splitting into individual properties") : 1;
      d.push(c);
    }
  for (m = d.length; m--; )
...
}, Et = function(e, t, a, i, r) {
  return q(e) ? e.call(t, a, i, r) : j(e) && ~e.indexOf("random(") ? Rt(e) : e;
}, gr = Fa + "repeat,repeatDelay,yoyo,repeatRefresh,yoyoEase,easeReverse,autoRevert", fr = {};
ee(gr + ",id,stagger,delay,duration,paused,scrollTrigger", function(o) {
  return fr[o] = 1;
});
var Y = /* @__PURE__ */ (function(o) {
  ...
  function e(a, i, r, n) {
    ...
    var l = s.vars, d = l.duration, c = l.delay, u = l.immediateRender, h = l.stagger, m = l.overwrite, g = l.keyframes, p = l.defaults, f = l.scrollTrigger, b = i.parent || z, _ = (Z(a) || Bi(a) ? Te(a[0]) : "length" in i) ? [a] : ge(a), x, v, y, k, A, S, C, E;
    if (s._targets = _.length ? Ba(_) : It("GSAP target " + a + " not found. https://gsap.com", !le.nullTargetWarn) || [], s._ptLookup = [], s._overwrite = m, g || h || Bt(d) || Bt(c)) {
      i = s.vars;
      ...
      }), x.kill(), x.parent = x._dp = Se(s), x._start = 0, h || Bt(d) || Bt(c)) {
        if (k = _.length, C = h && ar(h), ve(h))
          for (A in h)
            ~gr.indexOf(A) && (E || (E = {}), E[A] = h[A]);
        for (v = 0; v < k; v++)
          y = Qt(i, fr), y.stagger = 0, H && (y.easeReverse = H), E && ut(y, E), S = _[v], y.duration = +Et(d, Se(s), v, S, _), y.delay = (+Et(c, Se(s), v, S, _) || 0) - s._delay, !h && k === 1 && y.delay && (s._delay = c = y.delay, s._start += c, y.delay = 0), x.to(S, y, C ? C(v, S, _) : 0), x._ease = P.none;
        x.duration() ? d = c = 0 : s.timeline = 0;
      } else if (g) {
        kt(ce(x.vars.defaults, {
          ease: "none"
        })), x._ease = Je(g.ease || i.ease || "none");
        var F = 0, N, B, W;
        if (Z(g))
          ...
          y = {};
          for (A in g)
            A === "ease" || A === "easeEach" || Tn(A, g[A], y, g.easeEach);
          for (A in y)
            for (N = y[A].sort(function(V, G) {
              return V.t - G.t;
            }), F = 0, v = 0; v < N.length; v++)
              B = N[v], W = {
                ease: B.e,
                duration: (B.t - (v ? N[v - 1].t : 0)) / 100 * d
              }, W[A] = B.v, x.to(_, W, F), F += W.duration;
          x.duration() < d && x.to({}, {
      ...
      s.timeline = 0;
    return m === !0 && !Na && (Me = Se(s), z.killTweensOf(_), Me = 0), ye(b, Se(s), r), i.reversed && s.reverse(), i.paused && s.paused(!0), (u || !d && !g && s._start === O(b._time) && $(u) && an(Se(s)) && b.data !== "nested") && (s._tTime = -I, s.render(Math.max(0, -c) || 0)), f && Ki(Se(s), f), s;
  }
  var t = e.prototype;
  return t.render = function(i, r, n) {
    var s = this._time, l = this._tDur, d = this._dur, c = i < 0, u = i > l - I && !c ? l : i < I ? 0 : i, h, m, g, p, f, b, _, x;
    if (!d)
      nn(this, i, r, n);
      ...
      if (h = u, x = this.timeline, this._repeat) {
        if (p = d + this._rDelay, this._repeat < -1 && c)
          return this.totalTime(p * 100 + i, r, n);
        if (h = O(u % p), u === l ? (g = this._repeat, h = d) : (f = O(u / p), g = ~~f, g && g === f ? (h = d, g--) : h > d && (h = d)), b = this._yoyo && g & 1, b && (h = d - h), f = pt(this._tTime, p), h === s && !n && this._initted && g === f)
          return this._tTime = u, this;
        g !== f && this.vars.repeatRefresh && !b && !this._lock && h !== p && this._initted && (this._lock = n = 1, this.render(O(p * g), !0).invalidate()._lock = 0);
      }
      if (!this._initted) {
        if ($i(this, c ? i : h, n, r, u))
      ...
      if (this._from && (this.ratio = _ = 1 - _), this._tTime = u, this._time = h, !this._act && this._ts && (this._act = 1, this._lazy = 0), !s && u && !r && !f && (se(this, "onStart"), this._tTime !== u))
        return this;
      for (m = this._pt; m; )
        m.r(_, m.d), m = m._next;
      x && x.render(i < 0 ? i : x._dur * x._ease(h / this._dur), r, n) || this._startAt && (this._zTime = i), this._onUpdate && !r && (c && ya(this, i, r, n), se(this, "onUpdate")), this._repeat && g !== f && this.vars.onRepeat && !r && this.parent && se(this, "onRepeat"), (u === this._tDur || !u) && this._tTime === u && (c && !this._onUpdate && ya(this, i, !0, !0), (i || !d) && (u === this._tDur && this._ts > 0 || !u && this._ts < 0) && Oe(this, 1), !r && !(c && !s) && (u || s || b) && (se(this, u === l ? "onComplete" : "onReverseComplete", !0), this._prom && !(u < l && this.timeScale() > 0) && this._prom()));
    }
    return this;
  }, t.targets = function() {
    ...
    Dt || ne.wake(), this._ts || this.play();
    var d = Math.min(this._dur, (this._dp._time - this._start) * this._ts), c;
    return this._initted || Ga(this, d), c = this._ease(d / this._dur), Sn(this, i, r, n, s, c, d, l) ? this.resetTo(i, r, n, s, 1) : (ra(this, 0), this.parent || Qi(this._dp, this, "_first", "_last", this._dp._sort ? "_start" : 0), this.render(0));
  }, t.kill = function(i, r) {
    if (r === void 0 && (r = "all"), !i && (!r || r === "all"))
      return this._lazy = this._pt = 0, this.parent ? At(this) : this.scrollTrigger && this.scrollTrigger.kill(!!X), this;
    if (this.timeline) {
      var n = this.timeline.totalDuration();
      return this.timeline.killTweensOf(i, r, Me && Me.vars.overwrite !== !0)._first || At(this), this.parent && n !== this.timeline.totalDuration() && ht(this, this._dur * this.timeline._tDur / n, 0, 1), this;
    }
    var s = this._targets, l = i ? ge(i) : s, d = this._ptLookup, c = this._pt, u, h, m, g, p, f, b;
    if ((!r || r === "all") && en(s, l))
      return r === "all" && (this._pt = 0), At(this);
    for (u = this._op = this._op || [], r !== "all" && (j(r) && (p = {}, ee(r, function(_) {
      return p[_] = 1;
    }), r = p), r = kn(s, r)), b = s.length; b--; )
      if (~l.indexOf(s[b])) {
        h = d[b], r === "all" ? (u[b] = r, g = h, m = {}) : (m = u[b] = u[b] || {}, g = r);
        for (p in g)
          f = h && h[p], f && ((!("kill" in f.d) || f.d.kill(p) === !0) && aa(this, f, "_pt"), delete h[p]), m !== "all" && (m[p] = 1);
      }
    return this._initted && !this._pt && c && At(this), this;
  }, e.to = function(i, r) {
...
ee("staggerTo,staggerFrom,staggerFromTo", function(o) {
  Y[o] = function() {
    var e = new K(), t = va.call(arguments, 0);
    return t.splice(o === "staggerFromTo" ? 5 : 4, 0, 0), e[o].apply(e, t);
  };
});
var Ua = function(e, t, a) {
  return e[t] = a;
}, wr = function(e, t, a) {
  return e[t](a);
}, En = function(e, t, a, i) {
  ...
  return q(e[t]) ? wr : Ra(e[t]) && e.setAttribute ? Pn : Ua;
}, br = function(e, t) {
  ...
  function o(t, a, i, r, n, s, l, d, c) {
    this.t = a, this.s = r, this.c = n, this.p = i, this.r = s || br, this.d = l || this, this.set = d || Ua, this.pr = c || 0, this._next = t, t && (t._prev = this);
  }
  var e = o.prototype;
  return e.modifier = function(a, i, r) {
    this.mSet = this.mSet || this.set, this.set = Rn, this.m = a, this.mt = r, this.tween = i;
  }, o;
})();
ee(Fa + "parent,duration,ease,delay,overwrite,runBackwards,startAt,yoyo,immediateRender,repeat,repeatDelay,data,paused,reversed,lazy,callbackScope,stringFilter,id,yoyoEase,stagger,inherit,repeatRefresh,keyframes,autoRevert,scrollTrigger,easeReverse", function(o) {
  return La[o] = 1;
});
...
le.stringFilter = ur;
var Qe = [], jt = {}, Dn = [], oi = 0, On = 0, ca = function(e) {
  return (jt[e] || Dn).map(function(t) {
    return t();
  });
}, ka = function() {
  var e = Date.now(), t = [];
  e - oi > 2 && (ca("matchMediaInit"), Qe.forEach(function(a) {
  ...
  function o(t, a) {
    this.selector = a && Aa(a), this.data = [], this._r = [], this.isReverted = !1, this.id = On++, t && this.add(t);
  }
  var e = o.prototype;
  return e.add = function(a, i, r) {
    q(a) && (r = i, i = a, a = q);
    var n = this, s = function() {
      var d = D, c = n.selector, u;
      return d && d !== n && d.data.push(n), r && (n.selector = Aa(r)), D = n, u = i.apply(n, arguments), q(u) && n._r.push(u), D = d, n.selector = c, n.isReverted = !1, u;
    };
  ...
  return e.add = function(a, i, r) {
    ...
    var n = new xr(0, r || this.scope), s = n.conditions = {}, l, d, c;
    D && !n.selector && (n.selector = D.selector), this.contexts.push(n), i = n.add("onMatch", i), n.queries = a;
    for (d in a)
      d === "all" ? c = 1 : (l = _e.matchMedia(a[d]), l && (Qe.indexOf(n) < 0 && Qe.push(n), (s[d] = l.matches) && (c = 1), l.addListener ? l.addListener(ka) : l.addEventListener("change", ka)));
  ...
  quickSetter: function(e, t, a) {
    ...
    e = e[0] || {};
    var n = re[t], s = je(e), l = s.harness && (s.harness.aliases || {})[t] || t, d = n ? function(c) {
      var u = new n();
      ot._pt = 0, u.init(e, a ? c + a : c, ot, 0, [e]), u.render(1, u), ot._pt && Va(1, ot);
    } : s.set(e, l);
  ...
  defaults: function(e) {
    return e && e.ease && (e.ease = Je(e.ease, Mt.ease)), ai(Mt, e || {});
  },
  config: function(e) {
    return ai(le, e || {});
  },
  registerEffect: function(e) {
    ...
    (i || "").split(",").forEach(function(s) {
      return s && !re[s] && !de[s] && It(t + " effect requires " + s + " plugin.");
    }), sa[t] = function(s, l, d) {
      return a(ge(s), ce(l || {}, r), d);
    }, n && (K.prototype[t] = function(s, l, d) {
      return this.add(sa[t](s, ve(l) ? l : (d = l) && {}, this), d);
    });
  },
...
var Ln = function(e, t) {
  ...
  for (i in t)
    for (r = a.length; r--; )
      n = e._ptLookup[r][i], n && (n = n.d) && (n._pt && (n = Ln(n, i)), n && n.modifier && n.modifier(t[i], e, a[r], i));
}, ua = function(e, t) {
  return {
    name: e,
    headless: 1,
...
}, ua("roundProps", Ca), ua("modifiers"), ua("snap", ir)) || Kt;
...
P.Expo;
P.Circ;
var li, Ie, dt, Wa, We, di, ja, Bn = function() {
  return typeof window < "u";
}, Ee = {}, Ye = 180 / Math.PI, ct = Math.PI / 180, $e = Math.atan2, ci = 1e8, Xa = /([A-Z])/g, qn = /(left|right|width|margin|padding|x)/i, Hn = /[\s,\(]\S/, xe = {
  ...
  for (r = 0; r < e.length; r += 3)
    e[r + 1] ? e[r + 1] === 2 ? t[e[r]](e[r + 2]) : t[e[r]] = e[r + 2] : e[r + 2] ? a[e[r]] = e[r + 2] : a.removeProperty(e[r].substr(0, 2) === "--" ? e[r] : e[r].replace(Xa, "-$1").toLowerCase());
  if (this.tfm) {
    for (n in this.tfm)
      i[n] = this.tfm[n];
    i.svg && (i.renderTransform(), t.setAttribute("data-svg-origin", this.svgo || "")), r = ja(), (!r || !r.isStart) && !a[L] && (Cr(a), i.zOrigin && a[ae] && (a[ae] += " " + i.zOrigin + "px", i.zOrigin = 0, i.renderTransform()), i.uncache = 1);
  }
}, Sr = function(e, t) {
  var a = {
    target: e,
  ...
  var a = Ie.createElementNS ? Ie.createElementNS((t || "http://www.w3.org/1999/xhtml").replace(/^https/, "http"), e) : Ie.createElement(e);
  return a && a.style ? a : Ie.createElement(e);
}, oe = function o(e, t, a) {
  var i = getComputedStyle(e);
  return i[t] || i.getPropertyValue(t.replace(Xa, "-$1").toLowerCase()) || i.getPropertyValue(t) || !a && o(e, gt(t) || t, 1) || "";
}, ui = "O,Moz,ms,Ms,Webkit".split(","), gt = function(e, t, a) {
  var i = t || We, r = i.style, n = 5;
  if (e in r && !a)
    return e;
  for (e = e.charAt(0).toUpperCase() + e.substr(1); n-- && !(ui[n] + e in r); )
    ;
  return n < 0 ? null : (n === 3 ? "ms" : n >= 0 ? ui[n] : "") + e;
}, Pa = function() {
  Bn() && window.document && (li = window, Ie = li.document, dt = Ie.documentElement, We = Ea("div") || {
    style: {}
  }, Ea("div"), L = gt(L), ae = L + "Origin", We.style.cssText = "border-width:0;line-height:0;position:absolute;padding:0", kr = !!gt("perspective"), ja = ie.core.reverting, Wa = 1);
}, pi = function(e) {
  var t = e.ownerSVGElement, a = Ea("svg", t && t.getAttribute("xmlns") || "http://www.w3.org/2000/svg"), i = e.cloneNode(!0), r;
  i.style.display = "block", a.appendChild(i), dt.appendChild(a);
  try {
    r = i.getBBox();
  } catch {
  }
  return a.removeChild(i), dt.removeChild(a), r;
}, hi = function(e, t) {
  for (var a = t.length; a--; )
  ...
  return t && (t.width || t.height) || a || (t = pi(e)), t && !t.width && !t.x && !t.y ? {
    x: +hi(e, ["x", "cx", "x1"]) || 0,
    y: +hi(e, ["y", "cy", "y1"]) || 0,
    width: 0,
    height: 0
  ...
  if (t) {
    var a = e.style, i;
    t in Ee && t !== ae && (t = L), a.removeProperty ? (i = t.substr(0, 2), (i === "ms" || t.substr(0, 6) === "webkit") && (t = "-" + t), a.removeProperty(i === "--" ? t : t.replace(Xa, "-$1").toLowerCase())) : a.removeAttribute(t);
  }
}, Ne = function(e, t, a, i, r, n) {
  var s = new te(e._pt, t, a, 0, 1, n ? Ar : vr);
  ...
  grid: 1,
  flex: 1
}, Le = function o(e, t, a, i) {
  var r = parseFloat(a) || 0, n = (a + "").trim().substr((r + "").length) || "px", s = We.style, l = qn.test(t), d = e.tagName.toLowerCase() === "svg", c = (d ? "client" : "offset") + (l ? "Width" : "Height"), u = 100, h = i === "px", m = i === "%", g, p, f, b;
  if (i === n || !r || mi[i] || mi[n])
    return r;
  if (n !== "px" && !h && (r = o(e, t, a, "px")), b = e.getCTM && Er(e), (m || n === "%") && (Ee[t] || ~t.indexOf("adius")))
    return g = b ? e.getBBox()[l ? "width" : "height"] : e[c], U(m ? r / g * u : r / 100 * g);
  if (s[l ? "width" : "height"] = u + (h ? n : i), p = i !== "rem" && ~t.indexOf("adius") || i === "em" && e.appendChild && !d ? e : e.parentNode, b && (p = (e.ownerSVGElement || {}).parentNode), (!p || p === Ie || !p.appendChild) && (p = Ie.body), f = p._gsap, f && m && f.width && l && f.time === ne.time && !f.uncache)
    return U(r / f.width * u);
  if (m && (t === "height" || t === "width")) {
    var _ = e.style[t];
    e.style[t] = u + i, g = e[c], _ ? e.style[t] = _ : ze(e, t);
  } else
    (m || n === "%") && !es[oe(p, "display")] && (s.position = oe(e, "position")), p === e && (s.position = "static"), p.appendChild(We), g = We[c], p.removeChild(We), s.position = "absolute";
  return l && m && (f = je(p), f.time = ne.time, f.width = p[c]), U(h ? g * r / u : g && r ? u / g * r : 0);
}, ke = function(e, t, a, i) {
  var r;
  return Wa || Pa(), t in xe && t !== "transform" && (t = xe[t], ~t.indexOf(",") && (t = t.split(",")[0])), Ee[t] && t !== "transform" ? (r = Lt(e, i), r = t !== "transformOrigin" ? r[t] : r.svg ? r.origin : ea(oe(e, ae)) + " " + r.zOrigin + "px") : (r = e.style[t], (!r || r === "auto" || i || ~(r + "").indexOf("calc(")) && (r = $t[t] && $t[t](e, t, a) || oe(e, t) || Wi(e, t) || (t === "opacity" ? 1 : 0))), a && !~(r + "").trim().indexOf(" ") ? Le(e, t, r, a) + a : r;
}, ts = function(e, t, a, i) {
  if (!a || a === "none") {
    var r = gt(t, e, 1), n = r && oe(e, r, 1);
    n && n !== a ? (t = r, a = n) : t === "borderColor" && (a = oe(e, "borderTopColor"));
  }
  var s = new te(this._pt, e.style, t, 0, 1, _r), l = 0, d = 0, c, u, h, m, g, p, f, b, _, x, v, y;
  if (s.b = a, s.e = i, a += "", i += "", i.substring(0, 6) === "var(--" && (i = oe(e, i.substring(4, i.indexOf(")")))), i === "auto" && (p = e.style[t], e.style[t] = i, i = oe(e, t) || i, p ? e.style[t] = p : ze(e, t)), c = [a, i], ur(c), a = c[0], i = c[1], h = a.match(st) || [], y = i.match(st) || [], y.length) {
    for (; u = st.exec(i); )
      f = u[0], _ = i.substring(l, u.index), g ? g = (g + 1) % 5 : (_.substr(-5) === "rgba(" || _.substr(-5) === "hsla(") && (g = 1), f !== (p = h[d++] || "") && (m = parseFloat(p) || 0, v = p.substr((m + "").length), f.charAt(1) === "=" && (f = lt(m, f) + v), b = parseFloat(f), x = f.substr((b + "").length), l = st.lastIndex - x.length, x || (x = x || le.units[t] || v, l === i.length && (i += x, s.e += x)), v !== x && (m = Le(e, t, p, x) || 0), s._pt = {
        _next: s._pt,
        p: _ || d === 1 ? _ : ",",
        //note: SVG spec allows omission of comma/space when a negative sign is wedged between two numbers, like 2.5-5.3 instead of 2.5,-5.3 but when tweening, the negative value may switch to positive, so we insert the comma just in case.
        s: m,
  ...
  if (t.tween && t.tween._time === t.tween._dur) {
    ...
    if (r === "all" || r === !0)
      ...
      for (r = r.split(","), d = r.length; --d > -1; )
        s = r[d], Ee[s] && (l = 1, s = s === "transformOrigin" ? ae : L), ze(a, s);
    l && (ze(a, L), n && (n.svg && a.removeAttribute("transform"), i.scale = i.rotate = i.translate = "none", Lt(a, 1), n.uncache = 1, Cr(i)));
  }
}, $t = {
  clearProps: function(e, t, a, i, r) {
    if (r.data !== "isFromStart") {
      var n = e._pt = new te(e._pt, t, a, 0, 0, is);
  ...
  */
}, zt = [1, 0, 0, 1, 0, 0], Pr = {}, Mr = function(e) {
  return e === "matrix(1, 0, 0, 1, 0, 0)" || e === "none" || !e;
}, fi = function(e) {
  var t = oe(e, L);
  return Mr(t) ? zt : t.substr(7).match(qi).map(U);
}, Ja = function(e, t) {
  var a = e._gsap || je(e), i = e.style, r = fi(e), n, s, l, d;
  return a.svg && e.getAttribute("transform") ? (l = e.transform.baseVal.consolidate().matrix, r = [l.a, l.b, l.c, l.d, l.e, l.f], r.join(",") === "1,0,0,1,0,0" ? zt : r) : (r === zt && !e.offsetParent && e !== dt && !a.svg && (l = i.display, i.display = "block", n = e.parentNode, (!n || !e.offsetParent && !e.getBoundingClientRect().width) && (d = 1, s = e.nextElementSibling, dt.appendChild(e)), r = fi(e), l ? i.display = l : ze(e, "display"), d && (s ? n.insertBefore(e, s) : n ? n.appendChild(e) : dt.removeChild(e))), t && r.length > 6 ? [r[0], r[1], r[4], r[5], r[12], r[13]] : r);
}, Ma = function(e, t, a, i, r, n) {
  var s = e._gsap, l = r || Ja(e, !0), d = s.xOrigin || 0, c = s.yOrigin || 0, u = s.xOffset || 0, h = s.yOffset || 0, m = l[0], g = l[1], p = l[2], f = l[3], b = l[4], _ = l[5], x = t.split(" "), v = parseFloat(x[0]) || 0, y = parseFloat(x[1]) || 0, k, A, S, C;
  a ? l !== zt && (A = m * f - g * p) && (S = v * (f / A) + y * (-p / A) + (p * _ - f * b) / A, C = v * (-g / A) + y * (m / A) - (m * _ - g * b) / A, v = S, y = C) : (k = Tr(e), v = k.x + (~x[0].indexOf("%") ? v / 100 * k.width : v), y = k.y + (~(x[1] || x[0]).indexOf("%") ? y / 100 * k.height : y)), i || i !== !1 && s.smooth ? (b = v - d, _ = y - c, s.xOffset = u + (b * m + _ * p) - b, s.yOffset = h + (b * g + _ * f) - _) : s.xOffset = s.yOffset = 0, s.xOrigin = v, s.yOrigin = y, s.smooth = !!i, s.origin = t, s.originIsAbsolute = !!a, e.style[ae] = "0px 0px", n && (Ne(n, s, "xOrigin", d, v), Ne(n, s, "yOrigin", c, y), Ne(n, s, "xOffset", u, s.xOffset), Ne(n, s, "yOffset", h, s.yOffset)), e.setAttribute("data-svg-origin", v + " " + y);
}, Lt = function(e, t) {
  var a = e._gsap || new hr(e);
  if ("x" in a && !t && !a.uncache)
    return a;
  var i = e.style, r = a.scaleX < 0, n = "px", s = "deg", l = getComputedStyle(e), d = oe(e, ae) || "0", c, u, h, m, g, p, f, b, _, x, v, y, k, A, S, C, E, H, F, N, B, W, V, G, ue, Ke, ft, wt, Be, $a, Ae, qe;
  return c = u = h = p = f = b = _ = x = v = 0, m = g = 1, a.svg = !!(e.getCTM && Er(e)), l.translate && ((l.translate !== "none" || l.scale !== "none" || l.rotate !== "none") && (i[L] = (l.translate !== "none" ? "translate3d(" + (l.translate + " 0 0").split(" ").slice(0, 3).join(", ") + ") " : "") + (l.rotate !== "none" ? "rotate(" + l.rotate + ") " : "") + (l.scale !== "none" ? "scale(" + l.scale.split(" ").join(",") + ") " : "") + (l[L] !== "none" ? l[L] : "")), i.scale = i.rotate = i.translate = "none"), A = Ja(e, a.svg), a.svg && (a.uncache ? (ue = e.getBBox(), d = a.xOrigin - ue.x + "px " + (a.yOrigin - ue.y) + "px", G = "") : G = !t && e.getAttribute("data-svg-origin"), Ma(e, G || d, !!G || a.originIsAbsolute, a.smooth !== !1, A)), y = a.xOrigin || 0, k = a.yOrigin || 0, A !== zt && (H = A[0], F = A[1], N = A[2], B = A[3], c = W = A[4], u = V = A[5], A.length === 6 ? (m = Math.sqrt(H * H + F * F), g = Math.sqrt(B * B + N * N), p = H || F ? $e(F, H) * Ye : 0, _ = N || B ? $e(N, B) * Ye + p : 0, _ && (g *= Math.abs(Math.cos(_ * ct))), a.svg && (c -= y - (y * H + k * N), u -= k - (y * F + k * B))) : (qe = A[6], $a = A[7], ft = A[8], wt = A[9], Be = A[10], Ae = A[11], c = A[12], u = A[13], h = A[14], S = $e(qe, Be), f = S * Ye, S && (C = Math.cos(-S), E = Math.sin(-S), G = W * C + ft * E, ue = V * C + wt * E, Ke = qe * C + Be * E, ft = W * -E + ft * C, wt = V * -E + wt * C, Be = qe * -E + Be * C, Ae = $a * -E + Ae * C, W = G, V = ue, qe = Ke), S = $e(-N, Be), b = S * Ye, S && (C = Math.cos(-S), E = Math.sin(-S), G = H * C - ft * E, ue = F * C - wt * E, Ke = N * C - Be * E, Ae = B * E + Ae * C, H = G, F = ue, N = Ke), S = $e(F, H), p = S * Ye, S && (C = Math.cos(S), E = Math.sin(S), G = H * C + F * E, ue = W * C + V * E, F = F * C - H * E, V = V * C - W * E, H = G, W = ue), f && Math.abs(f) + Math.abs(p) > 359.9 && (f = p = 0, b = 180 - b), m = U(Math.sqrt(H * H + F * F + N * N)), g = U(Math.sqrt(V * V + qe * qe)), S = $e(W, V), _ = Math.abs(S) > 2e-4 ? S * Ye : 0, v = Ae ? 1 / (Ae < 0 ? -Ae : Ae) : 0), a.svg && (G = e.getAttribute("transform"), a.forceCSS = e.setAttribute("transform", "") || !Mr(oe(e, L)), G && e.setAttribute("transform", G))), Math.abs(_) > 90 && Math.abs(_) < 270 && (r ? (m *= -1, _ += p <= 0 ? 180 : -180, p += p <= 0 ? 180 : -180) : (g *= -1, _ += _ <= 0 ? 180 : -180)), t = t || a.uncache, a.x = c - ((a.xPercent = c && (!t && a.xPercent || (Math.round(e.offsetWidth / 2) === Math.round(-c) ? -50 : 0))) ? e.offsetWidth * a.xPercent / 100 : 0) + n, a.y = u - ((a.yPercent = u && (!t && a.yPercent || (Math.round(e.offsetHeight / 2) === Math.round(-u) ? -50 : 0))) ? e.offsetHeight * a.yPercent / 100 : 0) + n, a.z = h + n, a.scaleX = U(m), a.scaleY = U(g), a.rotation = U(p) + s, a.rotationX = U(f) + s, a.rotationY = U(b) + s, a.skewX = _ + s, a.skewY = x + s, a.transformPerspective = v + n, (a.zOrigin = parseFloat(d.split(" ")[2]) || !t && a.zOrigin || 0) && (i[ae] = ea(d)), a.xOffset = a.yOffset = 0, a.force3D = le.force3D, a.renderTransform = a.svg ? ns : kr ? Ir : rs, a.uncache = 0, a;
}, ea = function(e) {
  return (e = e.split(" "))[0] + " " + e[1];
}, pa = function(e, t, a) {
  var i = Q(t);
  return U(parseFloat(t) + parseFloat(Le(e, "x", a + "px", i))) + i;
}, rs = function(e, t) {
  t.z = "0px", t.rotationY = t.rotationX = "0deg", t.force3D = 0, Ir(e, t);
}, He = "0deg", bt = "0px", Ge = ") ", Ir = function(e, t) {
  var a = t || this, i = a.xPercent, r = a.yPercent, n = a.x, s = a.y, l = a.z, d = a.rotation, c = a.rotationY, u = a.rotationX, h = a.skewX, m = a.skewY, g = a.scaleX, p = a.scaleY, f = a.transformPerspective, b = a.force3D, _ = a.target, x = a.zOrigin, v = "", y = b === "auto" && e && e !== 1 || b === !0;
  if (x && (u !== He || c !== He)) {
    var k = parseFloat(c) * ct, A = Math.sin(k), S = Math.cos(k), C;
    k = parseFloat(u) * ct, C = Math.cos(k), n = pa(_, n, A * C * -x), s = pa(_, s, -Math.sin(k) * -x), l = pa(_, l, S * C * -x + x);
  }
  f !== bt && (v += "perspective(" + f + Ge), (i || r) && (v += "translate(" + i + "%, " + r + "%) "), (y || n !== bt || s !== bt || l !== bt) && (v += l !== bt || y ? "translate3d(" + n + ", " + s + ", " + l + ") " : "translate(" + n + ", " + s + Ge), d !== He && (v += "rotate(" + d + Ge), c !== He && (v += "rotateY(" + c + Ge), u !== He && (v += "rotateX(" + u + Ge), (h !== He || m !== He) && (v += "skew(" + h + ", " + m + Ge), (g !== 1 || p !== 1) && (v += "scale(" + g + ", " + p + Ge), _.style[L] = v || "translate(0, 0)";
}, ns = function(e, t) {
  var a = t || this, i = a.xPercent, r = a.yPercent, n = a.x, s = a.y, l = a.rotation, d = a.skewX, c = a.skewY, u = a.scaleX, h = a.scaleY, m = a.target, g = a.xOrigin, p = a.yOrigin, f = a.xOffset, b = a.yOffset, _ = a.forceCSS, x = parseFloat(n), v = parseFloat(s), y, k, A, S, C;
  l = parseFloat(l), d = parseFloat(d), c = parseFloat(c), c && (c = parseFloat(c), d += c, l += c), l || d ? (l *= ct, d *= ct, y = Math.cos(l) * u, k = Math.sin(l) * u, A = Math.sin(l - d) * -h, S = Math.cos(l - d) * h, d && (c *= ct, C = Math.tan(d - c), C = Math.sqrt(1 + C * C), A *= C, S *= C, c && (C = Math.tan(c), C = Math.sqrt(1 + C * C), y *= C, k *= C)), y = U(y), k = U(k), A = U(A), S = U(S)) : (y = u, S = h, k = A = 0), (x && !~(n + "").indexOf("px") || v && !~(s + "").indexOf("px")) && (x = Le(m, "x", n, "px"), v = Le(m, "y", s, "px")), (g || p || f || b) && (x = U(x + g - (g * y + p * A) + f), v = U(v + p - (g * k + p * S) + b)), (i || r) && (C = m.getBBox(), x = U(x + i / 100 * C.width), v = U(v + r / 100 * C.height)), C = "matrix(" + y + "," + k + "," + A + "," + S + "," + x + "," + v + ")", m.setAttribute("transform", C), _ && (m.style[L] = C);
}, ss = function(e, t, a, i, r) {
  var n = 360, s = j(r), l = parseFloat(r) * (s && ~r.indexOf("rad") ? Ye : 1), d = l - i, c = i + d + "deg", u, h;
  return s && (u = r.split("_")[1], u === "short" && (d %= n, d !== d % (n / 2) && (d += d < 0 ? n : -n)), u === "cw" && d < 0 ? d = (d + n * ci) % n - ~~(d / n) * n : u === "ccw" && d > 0 && (d = (d - n * ci) % n - ~~(d / n) * n)), e._pt = h = new te(e._pt, t, a, i, d, Gn), h.e = c, h.u = "deg", e._props.push(a), h;
}, wi = function(e, t) {
  for (var a in t)
    e[a] = t[a];
  return e;
}, os = function(e, t, a) {
  var i = wi({}, a._gsap), r = "perspective,force3D,transformOrigin,svgOrigin", n = a.style, s, l, d, c, u, h, m, g;
  i.svg ? (d = a.getAttribute("transform"), a.setAttribute("transform", ""), n[L] = t, s = Lt(a, 1), ze(a, L), a.setAttribute("transform", d)) : (d = getComputedStyle(a)[L], n[L] = t, s = Lt(a, 1), n[L] = d);
  for (l in Ee)
    d = i[l], c = s[l], d !== c && r.indexOf(l) < 0 && (m = Q(d), g = Q(c), u = m !== g ? Le(a, l, d, g) : parseFloat(d), h = parseFloat(c), e._pt = new te(e._pt, s, l, u, h - u, Ta), e._pt.u = g || 0, e._props.push(l));
  wi(s, i);
};
ee("padding,margin,Width,Radius", function(o, e) {
  ...
  $t[e > 1 ? "border" + o : o] = function(s, l, d, c, u) {
    var h, m;
    if (arguments.length < 4)
      return h = n.map(function(g) {
        return ke(s, g, d);
      }), m = h.join(" "), m.split(h[0]).length === 5 ? h[0] : m;
    h = (c + "").split(" "), m = {}, n.forEach(function(g, p) {
...
var Nr = {
  ...
  init: function(e, t, a, i, r) {
    var n = this._props, s = e.style, l = a.vars.startAt, d, c, u, h, m, g, p, f, b, _, x, v, y, k, A, S, C;
    Wa || Pa(), this.styles = this.styles || Sr(e), S = this.styles.props, this.tween = a;
    for (p in t)
      if (p !== "autoRound" && (c = t[p], !(re[p] && mr(p, t, a, i, e, r)))) {
        if (m = typeof c, g = $t[p], m === "function" && (c = c.call(a, i, e, r), m = typeof c), m === "string" && ~c.indexOf("random(") && (c = Rt(c)), g)
          g(this, e, p, c, a) && (A = 1);
        else if (p.substr(0, 2) === "--")
          d = (getComputedStyle(e).getPropertyValue(p) + "").trim(), c += "", De.lastIndex = 0, De.test(d) || (f = Q(d), b = Q(c), b ? f !== b && (d = Le(e, p, d, b) + b) : f && (c += f)), this.add(s, "setProperty", d, c, i, r, 0, 0, p), n.push(p), S.push(p, 0, s[p]);
        else if (m !== "undefined") {
          if (l && p in l ? (d = typeof l[p] == "function" ? l[p].call(a, i, e, r) : l[p], j(d) && ~d.indexOf("random(") && (d = Rt(d)), Q(d + "") || d === "auto" || (d += le.units[p] || Q(ke(e, p)) || ""), (d + "").charAt(1) === "=" && (d = ke(e, p))) : d = ke(e, p), h = parseFloat(d), _ = m === "string" && c.charAt(1) === "=" && c.substr(0, 2), _ && (c = c.substr(2)), u = parseFloat(c), p in xe && (p === "autoAlpha" && (h === 1 && ke(e, "visibility") === "hidden" && u && (h = 0), S.push("visibility", 0, s.visibility), Ne(this, s, "visibility", h ? "inherit" : "hidden", u ? "inherit" : "hidden", !u)), p !== "scale" && p !== "transform" && (p = xe[p], ~p.indexOf(",") && (p = p.split(",")[0]))), x = p in Ee, x) {
            if (this.styles.save(p), C = c, m === "string" && c.substring(0, 6) === "var(--") {
              if (c = oe(e, c.substring(4, c.indexOf(")"))), c.substring(0, 5) === "calc(") {
                var E = e.style.perspective;
                e.style.perspective = c, c = oe(e, "perspective"), E ? e.style.perspective = E : ze(e, "perspective");
              }
              u = parseFloat(c);
            }
            if (v || (y = e._gsap, y.renderTransform && !t.parseTransform || Lt(e, t.parseTransform), k = t.smoothOrigin !== !1 && y.smooth, v = this._pt = new te(this._pt, s, L, 0, 1, y.renderTransform, y, 0, -1), v.dep = 1), p === "scale")
              this._pt = new te(this._pt, y, "scaleY", y.scaleY, (_ ? lt(y.scaleY, _ + u) : u) - y.scaleY || 0, Ta), this._pt.u = 0, n.push("scaleY", p), p += "X";
            else if (p === "transformOrigin") {
              S.push(ae, 0, s[ae]), c = as(c), y.svg ? Ma(e, c, 0, k, 0, this) : (b = parseFloat(c.split(" ")[2]) || 0, b !== y.zOrigin && Ne(this, y, "zOrigin", y.zOrigin, b), Ne(this, s, p, ea(d), ea(c)));
              continue;
            } else if (p === "svgOrigin") {
              Ma(e, c, 1, k, 0, this);
              continue;
            } else if (p in Pr) {
              ss(this, y, p, h, _ ? lt(h, _ + c) : c);
              continue;
          ...
          } else p in s || (p = gt(p) || p);
          if (x || (u || u === 0) && (h || h === 0) && !Hn.test(c) && p in s)
            f = (d + "").substr((h + "").length), u || (u = 0), b = Q(c) || (p in le.units ? le.units[p] : f), f !== b && (h = Le(e, p, d, b)), this._pt = new te(this._pt, x ? y : s, p, h, (_ ? lt(h, _ + u) : u) - h, !x && (b === "px" || p === "zIndex") && t.autoRound !== !1 ? Vn : Ta), this._pt.u = b || 0, x && C !== c ? (this._pt.b = d, this._pt.e = C, this._pt.r = Yn) : f !== b && b !== "%" && (this._pt.b = d, this._pt.r = Un);
          else if (p in s)
            ts.call(this, e, p, d, _ ? _ + c : c);
          else if (p in e)
          ...
          x || (p in s ? S.push(p, 0, s[p]) : typeof e[p] == "function" ? S.push(p, 2, e[p]()) : S.push(p, 1, d || e[p])), n.push(p);
        }
      }
    A && yr(this);
  },
  ...
  getSetter: function(e, t, a) {
    var i = xe[t];
    return i && i.indexOf(",") < 0 && (t = i), t in Ee && t !== ae && (e._gsap.x || ke(e, "x")) ? a && di === a ? t === "scale" ? Jn : Xn : (di = a || {}) && (t === "scale" ? Qn : Zn) : e.style && !Ra(e.style[t]) ? Wn : ~t.indexOf("-") ? jn : Ya(e, t);
  },
  core: {
    _removeProperty: ze,
    _getMatrix: Ja
...
ie.utils.checkPrefix = gt;
ie.core.getStyleSaver = Sr;
(function(o, e, t, a) {
  var i = ee(o + "," + e + "," + t, function(r) {
    Ee[r] = 1;
  });
  ee(e, function(r) {
    le.units[r] = "deg", Pr[r] = 1;
  }), xe[i[13]] = o + "," + e, ee(a, function(r) {
    var n = r.split(":");
    xe[n[1]] = i[n[0]];
  });
...
const ls = [
...
], ds = 1.28, T = (o) => Number((o * ds).toFixed(3)), cs = {
  duration: T(0.44),
  ease: "back.out(1.7)"
}, bi = {
  startOverlap: "-=0.08",
  ...
  revealEase: "power3.inOut",
  cardDuration: T(0.28)
}, hs = 96, xi = ".wa-cursor-file, .wa-file-landing-clone, .wa-csv-drop", ms = "[data-marketing-data-sources-grid]", ha = {
  offscreenMargin: 96,
...
class gs {
  ...
  showComposer() {
    ...
    return e.to(this.composer, {
      ...
      this.thread,
      {
        paddingBottom: () => Math.max(yi, this.getComposerThreadInset()),
        duration: fe.showDuration,
        ease: "power3.out",
        overwrite: "auto",
  ...
  hideComposer() {
    return w.timeline().to(this.composer, {
      y: fe.hiddenY,
      scaleX: fe.hiddenScaleX,
      scaleY: fe.hiddenScaleY,
      opacity: 1,
  ...
  getComposerThreadInset() {
    ...
    return Math.ceil(a + fe.threadGap);
  }
  showSignup(e = "") {
    return w.timeline().call(() => {
  ...
  getSignupScrollOutDistance() {
    ...
    return -Math.max(_t.minScrollOut, Math.round(e * _t.scrollOutRatio));
  }
  stopScrollMotion() {
  ...
  dataTable(e) {
    ...
    return this.revealComponentItems("table", t, ".wa-data-table__row", we.tableRow);
  }
  enrichmentPanel(e) {
    const t = this.createEnrichmentPanel(e);
    return this.revealComponentItems("enrichment", t, ".wa-waterfall-row", we.waterfallRow);
  }
  strategyPlans(e) {
    ...
    return a.className = "wa-result-grid has-strategy-plans", a.dataset.strategyPlans = e.map((r) => r.id).join(" "), a.append(...t), w.set(i, { autoAlpha: 0, y: 8 }), this.revealComponentItems("strategy", a, t, we.strategyCard).to(
      i,
      {
        autoAlpha: 1,
        y: 0,
  ...
  dataSourcesGrid(e) {
    ...
    return this.revealComponentItems("sources", t, ".wa-data-source-card", we.smallCard);
  }
  ...
  proximityLeadList(e) {
    ...
    return this.revealComponentItems("proximity", t, ".wa-proximity-lead", {
      ...we.stackCard,
      to: { ...we.stackCard.to, duration: T(0.25), stagger: 0.06 }
    });
  }
  ...
  swipePersonalizationCard(e, t, a) {
    ...
    ), r = i?.querySelector(`[data-swipe-card="${this.escapeSelectorValue(t)}"]`), n = this.getSwipeCards(i), s = r ? n.indexOf(r) : -1, l = n[s + 1], d = a === "use" ? 1 : -1, c = i?.querySelector(`[data-swipe-action="${a}"]`), u = i?.querySelector("[data-swipe-complete]"), h = i?.querySelector(".wa-swipe-game__actions"), m = w.timeline();
  ...
  uploadedFilesMessage(e) {
    ...
    return this.revealUserComponentItems("file", t, ".wa-uploaded-file", {
      ...we.compactRow,
      from: { ...we.compactRow.from, scale: 0.99 },
      to: { ...we.compactRow.to, scale: 1 },
      position: "-=0.24"
    });
  }
  ...
  renderFileLandingClones(e, t) {
    ...
    for (const i of e) {
      const r = i.target.getBoundingClientRect(), n = r.left - a.left, s = r.top - a.top, l = fs(
        (t - pe.detailStart) / pe.detailSpan
      );
  ...
  getFileLandingShadow(e) {
    const t = 1 - e;
    return `0 ${this.interpolate(pe.shadowY, 0, e).toFixed(2)}px ${this.interpolate(
      pe.shadowBlur,
      0,
      e
    ).toFixed(2)}px rgba(23, 23, 20, ${(pe.shadowAlpha * t).toFixed(3)})`;
  }
  ...
  followCursorWithFile(e, t, a) {
    const i = e.offsetWidth || 154, r = e.offsetHeight || 42, n = w.quickSetter(e, "x", "px"), s = w.quickSetter(e, "y", "px"), l = { x: -120, y: -120 }, d = () => {
      ...
      u !== l.x && (l.x = u, n(u)), h !== l.y && (l.y = h, s(h));
    };
  ...
  streamThinkingStepDetail(e) {
    ...
    return !t || !a ? w.timeline() : this.streamText(t, a, {
      duration: this.getStreamDuration(a, Pt),
      targetForScroll: e.closest(".wa-message") ?? e
    });
  }
  streamText(e, t, a) {
  ...
  runThinkingSequence(e, t) {
    ...
    return a.call(() => {
      ...
      }), w.set(r.header, { autoAlpha: 0, y: 5 }), w.set(r.steps, { display: "grid", autoAlpha: 1, y: 0 }), w.set(i, { autoAlpha: 0, y: t.itemStartY });
      ...
      a.call(() => this.activateThinkingStep(i, s), void 0, d).to(
        ...
        "<"
      ).add(this.streamThinkingStepLabel(l), Pt.startOverlap).add(this.streamThinkingStepDetail(l), "-=0.02").to({}, { duration: t.afterStepHold }).add(this.foldThinkingStep(l));
    }), a.call(() => {
      i.forEach((n) => {
  ...
  createDataVendorLogo(e) {
    ...
    const a = document.createElement("span");
    return a.className = "wa-data-vendor-logo__mark", a.textContent = e.name, t.append(a), t;
  }
  groupDataSources(e) {
  ...
  createProximityLeadList(e) {
    ...
    return i.className = "wa-proximity-list__rows", e.leads.forEach((r) => {
      ...
      const h = document.createElement("span");
      h.textContent = `${r.title}, ${r.company}`, c.append(u, h);
      ...
      p.className = "wa-proximity-lead__proximity", p.textContent = r.proximity, l.append(d, g, p), n.append(s, l), i.append(n);
    }), t.append(a, i), t;
  }
  ...
  createSequenceEngagement(e) {
    ...
    r.className = "wa-sequence-engagement__sequences", e.sequences.forEach((s) => {
      ...
      const h = document.createElement("span");
      h.textContent = s.company, c.append(u, h);
      const m = document.createElement("span");
      ...
      p.className = "wa-sequence-card__personalization", p.textContent = s.personalization, l.append(d, g, p), r.append(l);
    });
    const n = document.createElement("div");
    return n.className = "wa-engage-channels", e.channels.forEach((s) => {
      ...
      if (u.textContent = s.detail, d.append(c, u), l.append(d), s.badge) {
        const h = document.createElement("span");
        h.className = "wa-engage-channel__badge", h.textContent = s.badge, l.dataset.badge = s.badge.toLowerCase(), l.append(h);
      }
      n.append(l);
    }), t.append(i, r, n), t;
  }
...
function qt(o, e, t) {
  const a = Rr(t.seed), i = ws(o, e), r = t.speed ?? "normal", n = t.intent ?? "hover";
  ...
  const s = e.x - o.x, l = e.y - o.y, d = s / i, c = l / i, u = -c, h = d, m = a() > 0.5 ? 1 : -1, g = t.curve ?? 1, f = St(i * (n === "drag" ? 0.1 : n === "click" ? 0.17 : 0.22) * g, 18, 150) * m * (0.72 + a() * 0.44), b = i / _s[r] + 0.16, _ = St(b * ys[n] * xs, 0.3, 1.66), x = t.overshoot === !1 || i < 120 ? 0 : typeof t.overshoot == "number" ? t.overshoot : St(i * 0.026, 4, 18), v = x > 0 ? {
    x: e.x + d * x,
    y: e.y + c * x
  } : e, y = {
    x: o.x + s * (0.25 + a() * 0.08) + u * f,
    y: o.y + l * (0.25 + a() * 0.08) + h * f
  }, k = {
    x: o.x + s * (0.68 + a() * 0.12) - u * f * 0.42,
    y: o.y + l * (0.68 + a() * 0.12) - h * f * 0.42
  }, A = t.settle !== !1 && x > 0;
  return {
    start: o,
    c1: y,
...
const Ai = "button, a, [role='button'], [data-send-button], [data-result-action]", Ci = "[data-chat-input], [data-signup-field], input, textarea, [contenteditable='true']", ma = {
  delay: 0.42,
  returnDuration: 0.18,
  segments: [
  ...
  minTopInset: 74,
  maxTopInset: 190
}, et = "http://www.w3.org/2000/svg", vs = -135, As = 0.34;
class Cs {
  constructor(e, t, a = {}) {
  ...
  moveTo(e, t = {}) {
    const a = t.label ?? `move-${this.moveIndex}`, i = t.mode ?? "default", r = `${this.storyId}:${a}:${this.resolver.getBreakpoint()}`, n = this.resolver.resolve(e, r), s = { ...this.plannedPosition }, l = qt(s, n, {
      seed: r,
      intent: t.intent,
      speed: t.speed,
      curve: t.curve,
    ...
    return this.moveIndex += 1, this.plannedPosition = { ...n }, d.call(() => {
      ...
      this.pathTweenFromFactory(
        () => {
          ...
          return c = qt(this.currentPosition, u, {
            seed: r,
            intent: t.intent,
            speed: t.speed,
            curve: t.curve,
  ...
  parkForChatHistory() {
    const e = `history-park-${this.moveIndex}`, t = `${this.storyId}:${e}:${this.resolver.getBreakpoint()}`, a = { ...this.currentPosition }, i = this.resolveHistoryParkPoint(), r = qt(a, i, {
      seed: t,
      intent: "hover",
      speed: "quick",
      overshoot: !1,
  ...
  pathTweenFromFactory(e, t, a = "power2.inOut") {
    ...
    return w.fromTo(
      ...
      { t: 0 },
      {
        ...
        onUpdate: () => {
          if (!r) return;
          const n = vi(r.start, r.c1, r.c2, r.end, i.t);
  ...
  createHistoryParkPlan(e) {
    this.resolver.refresh();
    const t = this.resolveHistoryParkPoint(), a = qt(this.currentPosition, t, {
      seed: e,
      intent: "hover",
      speed: "quick",
      overshoot: !1,
  ...
  resolveHistoryParkPoint() {
    ...
    const a = St(
      t.height * Ht.topRatio,
      Ht.minTopInset,
      Ht.maxTopInset
    );
    return {
      x: t.right - e.left + Ht.outsideOffset,
      y: t.top - e.top + a
    };
  }
  ...
  renderMimicRotation(e, t) {
    ...
    if (a * a + i * i < 4) return;
    const r = Math.atan2(i, a) * 180 / Math.PI, n = Ss(r - vs), s = this.rotationState + ks(this.rotationState, n) * As;
  ...
  getModeForElement(e) {
    return e ? e.closest(Ai) ? "pointer" : e.closest(Ci) ? "text" : "default" : "default";
  }
  ...
  refreshModeTargetCache() {
    this.modeTargetsDirty && (this.pointerTargets = Array.from(this.root.querySelectorAll(Ai)).reverse(), this.textTargets = Array.from(this.root.querySelectorAll(Ci)).reverse(), this.modeTargetsDirty = !1);
  }
  observeModeTargets() {
  ...
  createElement() {
    ...
    const a = document.createElement("div");
    return a.className = "wa-cursor__glyph", a.append(this.createMimicCursorSvg()), t.append(a), e.append(t), this.root.append(e), e;
  }
  ensureFloatLayer() {
    const e = this.el.querySelector("[data-cursor-float]");
    if (e) return e;
    const t = this.el.querySelector(".wa-cursor__glyph") ?? document.createElement("div");
    t.classList.contains("wa-cursor__glyph") || (t.className = "wa-cursor__glyph"), t.querySelector(".wa-cursor-svg") || t.append(this.createMimicCursorSvg());
    const a = document.createElement("div");
    return a.className = "wa-cursor__float", a.dataset.cursorFloat = "", a.append(t), this.el.append(a), a;
  }
  createMimicCursorSvg() {
    const e = document.createElementNS(et, "svg");
    e.classList.add("wa-cursor-svg"), e.setAttribute("viewBox", "0 0 24 38"), e.setAttribute("aria-hidden", "true"), e.setAttribute("focusable", "false");
    const t = document.createElementNS(et, "g");
    t.classList.add("wa-cursor-svg__tail");
    const a = document.createElementNS(et, "path");
    a.classList.add("wa-cursor-svg__tail-shape"), a.setAttribute("d", "M9.7 20.8L14.8 20.8L18.3 34.3L14.2 35.8Z");
    const i = document.createElementNS(et, "path");
    i.classList.add("wa-cursor-svg__tail-outline"), i.setAttribute("d", "M9.7 20.8L14.2 35.8L18.3 34.3L14.8 20.8"), t.append(a, i);
    const r = document.createElementNS(et, "path");
    r.classList.add("wa-cursor-svg__body"), r.setAttribute("d", "M2.4 1.7L2.4 30.4L10.9 21.1L22.9 21.1Z");
    const n = document.createElementNS(et, "path");
    return n.classList.add("wa-cursor-svg__body-outline"), n.setAttribute("d", "M22.9 21.1L2.4 1.7L2.4 30.4L10.9 21.1"), e.append(t, r, n), e;
  }
}
function Si(o, e, t) {
  return {
...
class Es {
  ...
  renderAddRail() {
    ...
    const t = Ts.map((a) => {
      ...
      return i.className = "wa-builder-add-button", i.type = "button", i.dataset.builderAdd = a, i.textContent = `+ ${Ve[a]}`, i;
    });
  ...
  renderPanel() {
    ...
    if (r.className = "wa-builder-panel__divider", i.append(r), a) {
      ...
      for (const d of Object.keys(Ve)) {
        const c = document.createElement("option");
        c.value = d, c.textContent = Ve[d], c.selected = a.kind === d, l.append(c);
      }
  ...
  createStepBody(e, t = !1) {
    ...
    const i = document.createElement("span");
    return i.className = "wa-builder-step__kind", i.textContent = Ve[e.kind], a.append(i, this.createInlineTextarea(e)), a;
  }
  createThinkingBody(e, t = !1) {
    ...
    const h = document.createElement("div");
    h.className = "wa-research-step__label", h.append(this.createInlineTextarea(e));
    const m = document.createElement("div");
    return m.className = "wa-research-step__detail", m.textContent = e.note || "Add the evidence, source, or transformation this thinking step should reveal.", u.append(h, m), d.append(c, u), l.append(d), i.append(r, n, s), t ? (a.dataset.thinkingHeaderSuppressed = "true", a.append(l)) : a.append(i, l), a;
  }
  ...
  createTableComponentBody(e, t) {
    ...
    return l.className = "wa-builder-table-editor__row", l.dataset.header = "true", t.columns.forEach((d, c) => {
      ...
      const u = document.createElement("div");
      u.className = "wa-builder-table-editor__row", t.columns.forEach((h, m) => {
        u.append(
  ...
  createInlineTextarea(e) {
    ...
    return t.className = "wa-builder-step__textarea", t.dataset.builderStepField = e.id, t.value = e.text, t.rows = 1, t.spellcheck = !0, t.setAttribute("aria-label", `${Ve[e.kind]} message text`), t;
  }
  ...
  addStep(e) {
    const t = Is(e, Ns(e), ""), a = this.activeStory.steps, i = a.findIndex((n) => n.id === this.selectedStepId), r = i >= 0 ? i + 1 : a.length;
    a.splice(r, 0, t), this.selectedStepId = t.id, this.render(), this.emitChange(`Added ${Ve[e]} message`);
  }
  updateStep(e, t, a = {}) {
  ...
  handleDragStart(e) {
    ...
    if (Ws(t) && !t?.closest("[data-builder-drag-handle]")) {
      e.preventDefault();
      return;
    }
  ...
  handleComponentInput(e) {
    ...
    !i?.component || !a || (Gs(i.component, a, e.value, {
      rowIndex: yt(e.dataset.builderComponentRow),
      columnIndex: yt(e.dataset.builderComponentColumn),
      cardIndex: yt(e.dataset.builderComponentCard),
      fieldIndex: yt(e.dataset.builderComponentGroup),
      itemIndex: yt(e.dataset.builderComponentItem)
  ...
  return ({
    ...
    "data-marketplace": [
      ...
      { kind: "thinking", text: "Searching hiring signals across data sources", note: "Companies, contacts, jobs, LinkedIn, funding, and technographics." },
      {
        ...
        component: ki("Matching new hires", [
      ...
      { kind: "thinking", text: "Checking recent funding events", note: "Keep the earlier table visible above this transformation." },
      {
        ...
        component: ki("Recently funded matches", [
          ["Jamie Chen", "Ramp", "VP of Sales"],
          ["Andre Park", "Ramp", "Head of Growth"],
          ["David Kim", "Ramp", "Head of Revenue"]
        ])
    ...
    "research-brief": [
      { kind: "user", text: "Start with these 10 best-fit buyers.", note: "" },
      {
        ...
        component: Ti("10 best-fit buyers", [
      ...
      },
      {
        ...
        component: Ti("50-person expanded list", [
          ["Maya Patel", "OrbitGrid", "VP Revenue", "High"],
          ["Evan Brooks", "Northstar Dev", "Head of Growth", "High"],
          ["Clara Wong", "BrightLayer", "RevOps Lead", "Med"],
          ["Sam Hollis", "Apollo", "Growth Lead", "Med"],
...
function Ys(o) {
  return {
    ...o,
    id: Dr("step"),
    component: o.component ? Vs(o.component) : void 0
  };
}
function Vs(o) {
...
function Pi(o) {
  ...
  if (e.setAttribute("viewBox", "0 0 20 20"), e.setAttribute("aria-hidden", "true"), e.setAttribute("focusable", "false"), o === "copy" && Mi(e, "M7 7.5h8v8H7z M5 13H4.5a1 1 0 0 1-1-1V4.5a1 1 0 0 1 1-1H12a1 1 0 0 1 1 1V5"), o === "x" && Mi(e, "M5.5 5.5l9 9 M14.5 5.5l-9 9"), o === "grip")
    for (const t of [7, 13])
...
function be(o, e, t = {}, a = !0) {
  return {
    desktop: { target: o, anchor: e, offset: fa(t.desktop), humanOffset: a },
    tablet: { target: o, anchor: e, offset: fa(t.tablet), humanOffset: a },
    mobile: { target: o, anchor: e, offset: fa(t.mobile), humanOffset: a }
  };
}
const Ii = {
  hitGroundRunning: be("[data-chat-input]", "center", { desktop: -72, tablet: -68, mobile: -54 }),
  dataMarketplace: be("[data-chat-input]", "center", { desktop: -54, tablet: -52, mobile: -44 }),
  crmUpdate: be("[data-chat-input]", "center", { desktop: -42, tablet: -46, mobile: -36 }),
  researchBrief: be("[data-chat-input]", "center", { desktop: -70, tablet: -62, mobile: -50 }),
  supportResolution: be("[data-chat-input]", "center", { desktop: -62, tablet: -58, mobile: -46 })
}, js = be("[data-signup-field]", "center", {
  desktop: -74,
  tablet: -66,
  mobile: -48
}), Xs = be("[data-send-button]", "center"), Qa = {
  desktop: {
...
}, Js = 2.8, Qs = 42, Zs = 2, Ks = 3, ta = "[data-chat-shell] [data-chat-thread]", $s = `${ta} [data-message-role="assistant"]:not(.wa-message--component) [data-message-body]`, eo = `${ta} [data-message-role="assistant"].wa-message--thinking .wa-research-step[data-step-state="current"] .wa-research-step__body, ${ta} [data-message-role="assistant"].wa-message--thinking .wa-research-step[data-step-state="complete"] .wa-research-step__label`, Ni = 0.24, to = 0.3, rt = {
...
function ao(o, e, t, a, i) {
  switch (t.kind) {
    ...
    case "assistant":
      ...
      return;
    case "thinking":
      t.statusBefore && o.add(e.chat.setStatus(t.statusBefore), t.at), o.add(e.chat.thinkingState(t.label, t.hold), t.statusBefore ? void 0 : t.at), Ri(o, e, i, t.hold, 1, t.label, a);
      return;
    case "research":
      t.statusBefore && o.add(e.chat.setStatus(t.statusBefore), t.at), o.add(e.chat.researchSequence(t.steps, t.hold), t.statusBefore ? void 0 : t.at), Ri(o, e, i, t.hold, t.steps.length, t.steps.join("|"), a);
      return;
    case "dataTable":
      tt(
        o,
        ...
        t.at,
        nt(`[data-data-table="${Pe(t.config.id)}"]`),
        `table-${t.config.id}`
      );
      return;
    case "enrichmentPanel":
      tt(
        ...
        t.at,
        nt(`[data-enrichment-panel="${Pe(t.config.id)}"]`),
    ...
    case "strategyPlans":
      tt(
        ...
        t.at,
        nt(`[data-strategy-plans~="${Pe(t.plans[0]?.id ?? "strategy")}"]`),
    ...
    case "dataSourcesGrid":
      tt(
        ...
        t.at,
        nt(`[data-data-sources-grid="${Pe(t.config.id)}"]`),
        `sources-${t.config.id}`
      );
      return;
    ...
    case "sequenceEngagement":
      tt(
        ...
        t.at,
        nt(`[data-sequence-engagement="${Pe(t.config.id)}"]`),
...
function tt(o, e, t, a, i, r) {
  o.add(t, a), o.add(ro(e, i, r), "+=0.06");
}
function io(o, e, t, a) {
  const i = nt(
  ...
  o.add(e.chat.personalizationSwipeGame(t), a), t.signals.forEach((r, n) => {
    const s = `${i} [data-swipe-card="${Pe(r.id)}"]`, l = r.decision === "use" ? 1 : -1, d = r.decision === "use" ? "right" : "left", c = be(s, d, {
      desktop: { x: l * 154, y: n % 2 === 0 ? -18 : 16 },
      tablet: { x: l * 132, y: n % 2 === 0 ? -14 : 14 },
      mobile: { x: l * 86, y: n % 2 === 0 ? -10 : 10 }
    }, !1);
    o.add(
      e.cursor.moveTo(be(s, "center", {}, !1), {
        intent: "hover",
        mode: "default",
...
function ro(o, e, t) {
  const a = Za(o).add(o.cursor.scanAcross(e, { label: t }));
  return Ka(a);
}
function Ri(o, e, t, a = R.thinkingShort, i = 1, r = "thinking", n = 0) {
...
function Or(o, e, t) {
  ...
  if (a.length < i || e.textSkimCount >= Ks) return !1;
  const r = e.textCandidateCount;
  e.textCandidateCount += 1;
  const n = e.textSkimCount === 0, s = t.stepIndex - e.lastTextSkimStep >= Zs, l = oo(`${o.story.id}:${t.kind}:${r}:${t.key}`), d = r > 0 && r % 3 === 0, c = n || s && (l >= 0.58 || d);
...
function lo(o, e) {
  ...
  return e.statusBefore && t.add(o.chat.setStatus(e.statusBefore)), t.add(o.chat.showComposer(), e.statusBefore ? "-=0.02" : void 0), e.fromEntry || t.add(
    ...
    "-=0.18"
  ), t.add(o.cursor.click("text"), "-=0.02").add(o.chat.setComposerFocus(!0), "-=0.14").add(o.chat.typeComposer(e.text, e.duration ?? R.typeMedium)).add(
    o.cursor.moveTo(Xs, {
      mode: "pointer",
      intent: "click",
      speed: "quick",
    ...
    "-=0.12"
  ), e.statusAfter && t.add(o.chat.setStatus(e.statusAfter), "<"), Ka(t);
}
function Za(o) {
  const e = o.timeline();
  return e.pause(0), e;
...
const co = [
  ...
  },
  {
    ...
    build: (o) => {
      ...
      }), t = o.chat.prepareCursorFile("4 context files", o.cursor, "DOC"), a = be("[data-chat-shell]", "center", {
        desktop: { x: 0, y: 74 },
        tablet: { x: 0, y: 64 },
        mobile: { x: 0, y: 56 }
      });
  ...
  },
  {
    ...
    build: (o) => vt(o, [
      ...
      { kind: "dataTable", config: vo, at: "-=0.04" },
      ...
      { kind: "sequenceEngagement", config: Ao, at: "-=0.04" },
      xt(rt.bottomRight, "+=0.14")
    ])
  },
  {
    ...
    entryLeadTime: 0.18,
    build: (o) => {
      const e = o.chat.prepareCsvDropArea(), t = o.chat.prepareCursorFile("webinar_attendees.csv", o.cursor), a = be("[data-chat-shell]", "center", {
        desktop: { x: 0, y: 82 },
        tablet: { x: 0, y: 72 },
        mobile: { x: 0, y: 64 }
      });
...
class So {
  ...
  followPointer = () => {
    ...
    if (this.mode === "sniff") {
      this.updateSniffTarget(e), this.target && this.cursor.mimicViewportPoint(this.target, Ut.smoothing, this.target), e - this.sniffStartedAt >= Ut.durationMs && this.startReturnAfterPause(), this.scheduleFollow();
      return;
    }
    if (this.mode === "return") {
      const t = this.homePoint ?? this.getCursorViewportPoint();
      if (this.target = t, this.cursor.mimicViewportPoint(t, Di.smoothing, t), it(this.getCursorViewportPoint(), t) <= Di.arriveDistance) {
        this.completeReturn();
        return;
      }
      this.scheduleFollow();
  ...
  updateFollowTarget(e) {
    ...
    if (this.lastPointer) {
      ...
      i > 1.5 && (this.trailDirection = {
        x: a.x / i,
        y: a.y / i
      }, this.velocity = To(a, J.maxMomentumStep));
    }
    const t = {
  ...
  updateSniffTarget(e) {
    ...
    const t = this.sniffIndex, a = t * 1.92, i = Ut.radius * (t % 2 === 0 ? 1 : 0.58);
    this.target = {
      x: this.sniffAnchor.x + Math.cos(a) * i,
      y: this.sniffAnchor.y + Math.sin(a) * i * 0.62
    }, this.sniffIndex += 1, this.nextSniffAt = e + Ut.pointIntervalMs;
  }
  applyMomentum(e) {
  ...
  isCursorTooFarFromBrowser() {
    ...
    return ko(i, e) > J.maxBrowserDistance;
  }
  isPointNearStoryCursor(e, t = Gt.radius) {
  ...
  pruneSamples(e) {
    this.samples = this.samples.filter((t) => e - t.time <= Gt.sampleWindowMs);
  }
  trackDismissShake(e, t) {
    this.dismissSamples.push({ ...e, time: t }), this.dismissSamples = this.dismissSamples.filter((a) => t - a.time <= at.sampleWindowMs);
  }
  hasMimicGesture() {
    return this.samples.length < 4 ? !1 : this.samples.reduce((t, a, i) => {
      const r = this.samples[i - 1];
      return r ? t + it(a, r) : t;
    }, 0) >= Gt.minTravel && this.countAxisReversals(this.samples) >= Gt.minAxisReversals;
  }
  hasDismissShake() {
  ...
  isDismissShakeWindow(e) {
    ...
    return r >= at.minTravel && n <= at.maxNetDistance && r / i >= at.minAverageSpeed && s >= at.minTravelToNetRatio && this.countAxisReversals(e) >= at.minAxisReversals;
  }
  countAxisReversals(e) {
    let t = 0, a = 0, i = 0;
    for (let r = 1; r < e.length; r += 1) {
      const n = e[r - 1], s = e[r], l = Oi(s.x - n.x), d = Oi(s.y - n.y);
...
class Po {
  constructor(e, t, a, i, r, n) {
    this.root = e, this.stories = t, this.resolver = a, this.cursor = i, this.chat = r, this.options = n, this.storyProgress = this.stories.map(() => 0), this.pausedCursorMimic = new So(this.root, this.cursor, {
  ...
  seekTo(e, t = 0.28) {
    ...
    const a = Mo(e), i = this.activeTimeline.duration();
...
const Yt = ["mobile", "tablet", "desktop", "wide"];
class Io {
  constructor(e) {
    this.root = e;
  }
  ...
  pickTarget(e) {
    if (this.isBreakpointMap(e)) {
      const t = this.getBreakpoint(), a = Yt.indexOf(t), i = [
        t,
        ...Yt.slice(0, a).reverse(),
        ...Yt.slice(a + 1)
      ];
      for (const r of i)
        if (e[r]) return e[r];
...
function Ro(o, e = {}) {
  No(o, { showBuilder: e.showBuilder !== !1 });
  const t = e.stories?.length ? e.stories : Br, a = new Io(o), i = new gs(o), r = new Cs(o, a, {
  ...
  }), s = n.destroy.bind(n), l = e.showBuilder === !1 ? null : new Es(o, t, {
...
function Hr(o = "[data-chatbot-stories]", e = {}) {
  return e.injectStyles !== !1 && Oo(), Ro(zo(o), e);
}
const Lo = {
  init: Hr,
  defaultStories: Br
