...
var pe = {
...
}, Z = Array.isArray, Gn = /random\([^)]+\)/g, Un = /,\s*/g, Di = /(?:-?\.?\d|\.)+/gi, xr = /[-+=.]*\d+[.e\-+]*\d*[e\-+]*\d*/g, xt = /[-+=.]*\d+[.e-]*\d*[a-z%]*/g, Aa = /[-+=.]*\d+\.?\d*(?:e-|e\+)?\d*/gi, vr = /[+-]=-?[.\d]+/, Vn = /[^,'"\[\]\s]+/gi, Wn = /^[+\-=e\s\d]*\d+[.\d]*([a-z]*|%)\s*$/i, V, Se, Xa, mi, he = {}, ha = {}, kr, Sr = function(e) {
  return (ha = Tt(e, he)) && oe;
}, gi = function(e, t) {
  ...
  suppressEvents: !0
}, fi = {}, We = [], Ka = {}, Ar, le = {}, Ta = {}, Li = 30, ua = [], wi = "", bi = function(e) {
  var t = e[0], a, i;
  ...
  We.length && !K && ma(), e.render(t, a, !!(K && t < 0 && yi(e))), We.length && !K && ma();
}, Mr = function(e) {
  var t = parseFloat(e);
  ...
  var a = e._dp;
  return a && a.smoothChildTiming && e._ts && (e._start = U(a._time - (e._ts > 0 ? t / e._ts : ((e._dirty ? e.totalDuration() : e._tDur) - t) / -e._ts)), ka(e), a._dirty || ct(a, e)), e;
}, Rr = function(e, t) {
  var a;
  if ((t._time || !t._dur && t._initted || t._start < e._time && (t._dur || !t.add)) && (a = fa(e.rawTime(), t), (!t._dur || Zt(0, t.totalDuration(), a) - t._tTime > O) && t.render(a, !0)), ct(e, t)._dp && e._initted && e._time >= e._dur && e._ts) {
  ...
  return t.parent && $e(t), t._start = U((qe(a) ? a : a || e !== V ? ye(e, a, t) : e._time) + t._delay), t._end = U(t._start + (t.totalDuration() / Math.abs(t.timeScale()) || 0)), Ir(e, t, "_first", "_last", e._sort ? "_start" : 0), Qa(t) || (e._recent = t), i || Rr(e, t), e._ts < 0 && Sa(e, e._tTime), e;
}, Nr = function(e, t) {
  ...
  return s && !i && (e._time *= o / e._dur), e._dur = o, e._tDur = r ? r < 0 ? 1e10 : U(o * (r + 1) + e._rDelay * r) : o, s > 0 && !i && Sa(e, e._tTime = e._tDur * s), e.parent && ka(e), a || ct(e.parent, e), e;
}, Bi = function(e) {
  ...
  if (r)
    return l = i[t + "Params"], d = i.callbackScope || e, a && We.length && ma(), s && (H = s), c = l ? r.apply(d, l) : r.call(d), H = o, c;
}, zt = function(e) {
  ...
  if (e)
    if (e = !e.name && e.default || e, hi() || e.headless) {
      ...
      if (Pt(), e !== i) {
        if (le[t])
          return;
        me(i, me(ga(e, r), o)), Tt(i.prototype, Tt(r, ga(e, o))), le[i.prop = t] = i, e.targetTest && (ua.push(i), fi[t] = 1), t = (t === "css" ? "CSS" : t.charAt(0).toUpperCase() + t.substr(1)) + "Plugin";
      }
  ...
  return u = {
    ...
    wake: function() {
      kr && (!Xa && hi() && (Se = Xa = window, mi = Se.document || {}, he.gsap = oe, (Se.gsapVersions || (Se.gsapVersions = [])).push(oe.version), Sr(ha || Se.GreenSockGlobals || !Se.gsap && Se || {}), Gr.forEach(Ur)), c = typeof requestAnimationFrame < "u" && requestAnimationFrame, l && u.sleep(), d = c || function(f) {
...
var $r = function(e, t) {
  ...
  return e.delay = function(a) {
    ...
    return this._rts = +a || 0, this._ts = this._ps || a === -O ? 0 : this._rts, this.totalTime(Zt(-Math.abs(this._delay), this.totalDuration(), r), i !== !1), ka(this), Jn(this);
  }, e.paused = function(a) {
...
var te = /* @__PURE__ */ (function(n) {
  ...
  return t.to = function(i, r, o) {
    ...
    return X(i) ? this.removeLabel(i) : j(i) ? this.killTweensOf(i) : (i.parent === this && va(this, i), i === this._recent && (this._recent = this._last), ct(this));
...
var yo = function(e, t, a, i, r, o, s) {
  ...
  if (v && (!p || !r) && (r = "none"), e._ease = ut(r, Wt.ease), e._rEase = x && (ut(x) || e._ease), e._from = !v && !!i.runBackwards, e._from && (e.ratio = 1), !v || p && !i.stagger) {
    if (I = f[0] ? dt(f[0]).harness : 0, z = I && i[I.prop], T = ga(i, fi), h && (h._zTime < 0 && h.progress(1), t < 0 && c && s && !m ? h.render(-1, !0) : h.revert(c && g ? ca : jn), h._lazy = 0), o) {
      ...
      }, T), z && (C[I.prop] = z), $e(e._startAt = $.set(f, C)), e._startAt._dp = 0, e._startAt._sat = e, t < 0 && (K ? e._startAt.revert(ca) : e._startAt.render(-1, !0)), e._zTime = t, !s)
        n(e._startAt, O, O);
      else if (!t)
        return;
    }
    for (e._pt = e._ptCache = 0, l = g && ae(l) || l && !g, k = 0; k < f.length; k++) {
      if (E = f[k], L = E._gsap || bi(f)[k]._gsap, e._ptLookup[k] = P = {}, Ka[L.id] && We.length && ma(), G = y === f ? k : y.indexOf(E), I && (N = new I()).init(E, z || T, e, G, y) !== !1 && (e._pt = S = new re(e._pt, E, N.name, 0, 1, N.render, N, 0, N.priority), N._props.forEach(function(fe) {
        P[fe] = S;
      }), N.priority && (B = 1)), !I || z)
        for (C in T)
...
var $ = /* @__PURE__ */ (function(n) {
  ...
  function e(a, i, r, o) {
    ...
    if (s._targets = y.length ? bi(y) : jt("GSAP target " + a + " not found. https://gsap.com", !pe.nullTargetWarn) || [], s._ptLookup = [], s._overwrite = m, g || p || ta(d) || ta(c)) {
      i = s.vars;
      ...
      if (_ = s.timeline = new te({
        ...
        for (v = 0; v < T; v++)
          x = ga(i, Jr), x.stagger = 0, B && (x.easeReverse = B), E && Tt(x, E), C = y[v], x.duration = +Vt(d, Re(s), v, C, y), x.delay = (+Vt(c, Re(s), v, C, y) || 0) - s._delay, !p && T === 1 && x.delay && (s._delay = c = x.delay, s._start += c, x.delay = 0), _.to(C, x, S ? S(v, C, y) : 0), _._ease = R.none;
...
pe.stringFilter = jr;
var pt = [], pa = {}, Po = [], Hi = 0, Io = 0, Ia = function(e) {
...
var Gi, Ge, St, Ci, lt, Ui, Ai, Lo = function() {
  ...
  var r;
  return Ci || oi(), t in Ee && t !== "transform" && (t = Ee[t], ~t.indexOf(",") && (t = t.split(",")[0])), Oe[t] && t !== "transform" ? (r = Qt(e, i), r = t !== "transformOrigin" ? r[t] : r.svg ? r.origin : ya(ue(e, ne)) + " " + r.zOrigin + "px") : (r = e.style[t], (!r || r === "auto" || i || ~(r + "").indexOf("calc(")) && (r = ba[t] && ba[t](e, t, a) || ue(e, t) || Tr(e, t) || (t === "opacity" ? 1 : 0))), a && !~(r + "").trim().indexOf(" ") ? Ke(e, t, r, a) + a : r;
}, Jo = function(e, t, a, i) {
  if (!a || a === "none") {
  ...
  init: function(e, t, a, i, r) {
    ...
    for (h in t)
      if (h !== "autoRound" && (c = t[h], !(le[h] && Xr(h, t, a, i, e, r)))) {
        if (m = typeof c, g = ba[h], m === "function" && (c = c.call(a, i, e, r), m = typeof c), m === "string" && ~c.indexOf("random(") && (c = $t(c)), g)
          g(this, e, h, c, a) && (k = 1);
          ...
          if (l && h in l ? (d = typeof l[h] == "function" ? l[h].call(a, i, e, r) : l[h], X(d) && ~d.indexOf("random(") && (d = $t(d)), Q(d + "") || d === "auto" || (d += pe.units[h] || Q(Ne(e, h)) || ""), (d + "").charAt(1) === "=" && (d = Ne(e, h))) : d = Ne(e, h), p = parseFloat(d), y = m === "string" && c.charAt(1) === "=" && c.substr(0, 2), y && (c = c.substr(2)), u = parseFloat(c), h in Ee && (h === "autoAlpha" && (p === 1 && Ne(e, "visibility") === "hidden" && u && (p = 0), C.push("visibility", 0, s.visibility), Ue(this, s, "visibility", p ? "inherit" : "hidden", u ? "inherit" : "hidden", !u)), h !== "scale" && h !== "transform" && (h = Ee[h], ~h.indexOf(",") && (h = h.split(",")[0]))), _ = h in Oe, _) {
            ...
            if (v || (x = e._gsap, x.renderTransform && !t.parseTransform || Qt(e, t.parseTransform), T = t.smoothOrigin !== !1 && x.smooth, v = this._pt = new re(this._pt, s, W, 0, 1, x.renderTransform, x, 0, -1), v.dep = 1), h === "scale")
              ...
              C.push(ne, 0, s[ne]), c = Qo(c), x.svg ? si(e, c, 0, T, 0, this) : (b = parseFloat(c.split(" ")[2]) || 0, b !== x.zOrigin && Ue(this, x, "zOrigin", x.zOrigin, b), Ue(this, s, h, ya(d), ya(c)));
              continue;
            } else if (h === "svgOrigin") {
              si(e, c, 1, T, 0, this);
              continue;
...
class As {
  ...
  moveThinkingLogoTo(e, t, a = ia.duration, i) {
  ...
  moveThinkingLogoToStep(e, t) {
    ...
    return a ? this.moveThinkingLogoTo(e, a, ia.duration, t) : w.timeline();
  }
  collapseThinkingToHeader(e, t) {
    ...
    }).add(this.moveThinkingLogoTo(e, e.headerGlyph, ia.returnDuration), 0).to(e.steps, {
      autoAlpha: 0,
      y: La.y,
      height: 0,
...
function ml(n, e, t) {
  ...
  return i.length ? {
    title: ve(n.title) ?? Ce,
    elapsed: ve(n.elapsed) ?? ea(i.length),
    items: i
  } : Rt(e, t);
}
function gl(n, e) {
...
}, _l = 2.8, xl = 42, vl = 2, kl = 3, xa = "[data-chat-shell] [data-chat-thread]", Sl = `${xa} [data-message-role="assistant"]:not(.wa-message--component) [data-message-body]`, Cl = `${xa} [data-message-role="assistant"].wa-message--thinking .wa-research-step[data-step-state="current"] .wa-research-step__body, ${xa} [data-message-role="assistant"].wa-message--thinking .wa-research-step[data-step-state="complete"] .wa-research-step__label`, di = 0.24, Sn = 0.3, De = {
