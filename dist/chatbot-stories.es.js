...
var he = {
  ...
  overwrite: !1,
  delay: 0
}, bi, J, H, _e = 1e8, B = 1 / _e, ti = Math.PI * 2, Xr = ti / 4, Jr = 0, En = Math.sqrt, Kr = Math.cos, Zr = Math.sin, X = function(e) {
...
}, Q = Array.isArray, Qr = /random\([^)]+\)/g, eo = /,\s*/g, Bi = /(?:-?\.?\d|\.)+/gi, Pn = /[-+=.]*\d+[.e\-+]*\d*[e\-+]*\d*/g, xt = /[-+=.]*\d+[.e-]*\d*[a-z%]*/g, Ia = /[-+=.]*\d+\.?\d*(?:e-|e\+)?\d*/gi, In = /[+-]=-?[.\d]+/, to = /[^,'"\[\]\s]+/gi, ao = /^[+\-=e\s\d]*\d+[.\d]*([a-z]*|%)\s*$/i, V, Ce, ai, xi, me = {}, ga = {}, Rn, Ln = function(e) {
  ...
  suppressEvents: !0
}, ki = {}, Ye = [], ii = {}, Nn, de = {}, Ra = {}, zi = 30, ha = [], Si = "", Ci = function(e) {
  var t = e[0], a, i;
  if (Pe(t) || j(t) || (e = [e]), !(a = (t._gsap || {}).harness)) {
    for (i = ha.length; i-- && !ha[i].targetTest(t); )
      ;
    a = ha[i];
  }
  for (i = e.length; i--; )
  ...
  return e._gsap || Ci(xe(e))[0]._gsap;
}, qn = function(e, t, a) {
  return (a = e[t]) && j(a) ? e[t]() : yi(a) && e.getAttribute && e.getAttribute(t) || a;
}, ne = function(e, t) {
  ...
  for (ii = {}, Ye.length = 0, a = 0; a < e; a++)
    i = t[a], i && i._lazy && (i.render(i._lazy[0], i._lazy[1], !0)._lazy = 0);
}, Ai = function(e) {
  return !!(e._initted || e._startAt || e.add);
}, On = function(e, t, a, i) {
  Ye.length && !J && fa(), e.render(t, a, !!(J && t < 0 && Ai(e))), Ye.length && !J && fa();
}, Bn = function(e) {
  var t = parseFloat(e);
  return (t || t === 0) && (e + "").match(to).length < 2 ? t : X(e) ? e.trim() : e;
}, zn = function(e) {
  return e;
}, ge = function(e, t) {
  for (var a in t)
  ...
  for (var a in t)
    a !== "__proto__" && a !== "constructor" && a !== "prototype" && (e[a] = Pe(t[a]) ? r(e[a] || (e[a] = {}), t[a]) : t[a]);
  return e;
}, wa = function(e, t) {
  var a = {}, i;
  for (i in e)
  ...
  var t = e.parent || V, a = e.keyframes ? oo(Q(e.keyframes)) : ge;
  if (ie(e.inherit))
    for (; t; )
  ...
  return e._startAt && (J ? e._startAt.revert(pa) : e.vars.immediateRender && !e.vars.autoRevert || e._startAt.render(t, !0, i));
}, co = function r(e) {
  ...
  return e._end = U(e._start + (e._tDur / Math.abs(e._ts || e._rts || B) || 0));
}, Ta = function(e, t) {
  var a = e._dp;
  return a && a.smoothChildTiming && e._ts && (e._start = U(a._time - (e._ts > 0 ? t / e._ts : ((e._dirty ? e.totalDuration() : e._tDur) - t) / -e._ts)), Aa(e), a._dirty || ut(a, e)), e;
}, Hn = function(e, t) {
  var a;
  if ((t._time || !t._dur && t._initted || t._start < e._time && (t._dur || !t.add)) && (a = ba(e.rawTime(), t), (!t._dur || aa(0, t.totalDuration(), a) - t._tTime > B) && t.render(a, !0)), ut(e, t)._dp && e._initted && e._time >= e._dur && e._ts) {
  ...
  return t.parent && Je(t), t._start = U((Be(a) ? a : a || e !== V ? ye(e, a, t) : e._time) + t._delay), t._end = U(t._start + (t.totalDuration() / Math.abs(t.timeScale()) || 0)), Fn(e, t, "_first", "_last", e._sort ? "_start" : 0), ri(t) || (e._recent = t), i || Hn(e, t), e._ts < 0 && Ta(e, e._tTime), e;
}, Gn = function(e, t) {
  return (me.ScrollTrigger || vi("scrollTrigger", t)) && me.ScrollTrigger.create(t, e);
}, Un = function(e, t, a, i, n) {
  if (Ei(e, t, n), !e._initted)
    return 1;
  if (!a && e._pt && !J && (e._dur && e.vars.lazy !== !1 || !e._dur && e.vars.lazy) && Nn !== ce.frame)
  ...
  var n = e.ratio, o = t < 0 || !t && (!e._start && uo(e) && !(!e._initted && ri(e)) || (e._ts < 0 || e._dp._ts < 0) && !ri(e)) ? 0 : 1, s = e._rDelay, l = 0, d, c, u;
  if (s && e._repeat && (l = aa(0, e._tDur, t), c = Et(l, s), e._yoyo && c & 1 && (o = 1 - o), c !== Et(e._tTime, s) && (n = 1 - o, e.vars.repeatRefresh && e._initted && e.invalidate())), o !== n || J || i || e._zTime === B || !t && e._zTime) {
    if (!e._initted && Un(e, t, i, a, l))
      return;
    for (u = e._zTime, e._zTime = t || (a ? B : 0), a || (a = t && !u), e.ratio = o, e._from && (o = 1 - o), e._time = 0, e._tTime = l, d = e._pt; d; )
      d.r(o, d.d), d = d._next;
    t < 0 && ni(e, t, a, !0), e._onUpdate && !a && ue(e, "onUpdate"), l && e._repeat && !a && e.parent && ue(e, "onRepeat"), (t >= e._tDur || t < 0) && e.ratio === o && (o && Je(e, 1), !a && !J && (ue(e, o ? "onComplete" : "onReverseComplete", !0), e._prom && e._prom()));
  ...
  var n = e._repeat, o = U(t) || 0, s = e._tTime / e._tDur;
  return s && !i && (e._time *= o / e._dur), e._dur = o, e._tDur = n ? n < 0 ? 1e10 : U(o * (n + 1) + e._rDelay * n) : o, s > 0 && !i && Ta(e, e._tTime = e._tDur * s), e.parent && Aa(e), a || ut(e.parent, e), e;
}, Gi = function(e) {
  return e instanceof ae ? ut(e) : Mt(e, e._dur);
}, mo = {
  _start: 0,
  endTime: Xt,
  totalDuration: Xt
}, ye = function r(e, t, a) {
  var i = e.labels, n = e._recent || mo, o = e.duration() >= _e ? n.endTime(!1) : e._dur, s, l, d;
  ...
  return !X(e) || !(t = ao.exec(e)) ? "" : t[1];
}, go = function(e, t, a) {
  return Qe(a, function(i) {
    return aa(e, t, i);
  });
}, oi = [].slice, Vn = function(e, t) {
  ...
  return H && !t && H.selector ? H.selector(e) : X(e) && !a && (ai || !Pt()) ? oi.call((t || xi).querySelectorAll(e), 0) : Q(e) ? fo(e, a) : Vn(e) ? oi.call(e, 0) : e ? [e] : [];
}, si = function(e) {
  return e = xe(e)[0] || $t("Invalid scope") || {}, function(t) {
    var a = e.current || e.nativeElement || e;
    return xe(t, a.querySelectorAll ? a : a === e ? $t("Invalid scope") || xi.createElement("div") : e);
  };
}, Wn = function(e) {
  ...
  var t = Pe(e) ? e : {
    each: e
  }, a = pt(t.ease), i = t.from || 0, n = parseFloat(t.base) || 0, o = {}, s = i > 0 && i < 1, l = isNaN(i) || s, d = t.axis, c = i, u = i;
  return X(i) ? c = u = {
    center: 0.5,
    edges: 0.5,
    end: 1
  }[i] || 0 : !s && l && (c = i[0], u = i[1]), function(p, m, g) {
    var h = (g || t).length, w = o[h], b, y, _, v, x, T, k, A, S;
    if (!w) {
      ...
      for (w = o[h] = [], b = l ? Math.min(S, h) * c - 0.5 : i % S, y = S === _e ? 0 : l ? h * u / S - 0.5 : i / S | 0, k = 0, A = _e, T = 0; T < h; T++)
        _ = T % S - b, v = y - (T / S | 0), w[T] = x = d ? Math.abs(d === "y" ? v : _) : En(_ * _ + v * v), x > k && (k = x), x < A && (A = x);
      i === "random" && Wn(w), w.max = k - A, w.min = A, w.v = h = (parseFloat(t.amount) || parseFloat(t.each) * (S > h ? h - 1 : d ? d === "y" ? h / S : S : Math.max(S, h / S)) || 0) * (i === "edges" ? -1 : 1), w.b = h < 0 ? n - h : n, w.u = Z(t.amount || t.each) || 0, a = a && h < 0 ? Mo(a) : a;
    }
    return h = (w[p] - w.min) / w.max || 0, U(w.b + (a ? a(h) : h) * w.v) + w.u;
  };
}, li = function(e) {
  var t = Math.pow(10, ((e + "").split(".")[1] || "").length);
  return function(a) {
    var i = U(Math.round(parseFloat(a) / e) * e * t);
    return (i - i % 1) / t + (Be(a) ? 0 : Z(a));
  };
}, Yn = function(e, t) {
  var a = Q(e), i, n;
  return !a && Pe(e) && (i = a = e.radius || _e, e.values ? (e = xe(e.values), (n = !Be(e[0])) && (i *= i)) : e = li(e.increment)), Qe(t, a ? j(e) ? function(o) {
    return n = e(o), Math.abs(n - o) <= i ? n : o;
  } : function(o) {
    for (var s = parseFloat(n ? o.x : o), l = parseFloat(n ? o.y : 0), d = _e, c = 0, u = e.length, p, m; u--; )
      n ? (p = e[u].x - s, m = e[u].y - l, p = p * p + m * m) : p = Math.abs(e[u] - s), p < d && (d = p, c = u);
    return c = !i || d <= i ? e[c] : o, n || c === o || Be(o) ? c : c + Z(o);
  } : li(e));
}, $n = function(e, t, a, i) {
  return Qe(Q(e) ? !t : a === !0 ? !!(a = 0) : !i, function() {
    return Q(e) ? e[~~(Math.random() * e.length)] : (a = a || 1e-5) && (i = a < 1 ? Math.pow(10, (a + "").length - 2) : 1) && Math.floor(Math.round((e - a / 2 + Math.random() * (t - e + a * 0.99)) / a) * a * i) / i;
  });
}, wo = function() {
  ...
  var i = t - e;
  return Q(e) ? Xn(e, r(0, e.length), t) : Qe(a, function(n) {
    return (i + (n - e) % i) % i + e;
  });
}, xo = function r(e, t, a) {
  var i = t - e, n = i * 2;
  return Q(e) ? Xn(e, r(0, e.length - 1), t) : Qe(a, function(o) {
  ...
  return e.replace(Qr, function(t) {
    ...
    return $n(a ? i : +i[0], a ? 0 : +i[1], +i[2] || 1e-5);
  });
  ...
  if (!n) {
    ...
    if (!c) {
      for (l in t)
        Ti.call(s, e, l, "get", t[l]);
      n = function(g) {
        return Ii(g, s) || (o ? e.p : e);
      };
    }
  }
  return Qe(a, n);
  ...
  var i = e.vars, n = i[t], o = H, s = e._ctx, l, d, c;
  if (n)
    return l = i[t + "Params"], d = i.callbackScope || e, a && Ye.length && fa(), s && (H = s), c = l ? n.apply(d, l) : n.call(d), H = o, c;
}, Ft = function(e) {
  return Je(e), e.scrollTrigger && e.scrollTrigger.kill(!!J), e.progress() < 1 && ue(e, "onInterrupt"), e;
}, vt, Kn = [], Zn = function(e) {
  if (e)
    if (e = !e.name && e.default || e, _i() || e.headless) {
      ...
      if (Pt(), e !== i) {
        if (de[t])
          return;
        ge(i, ge(wa(e, n), o)), Tt(i.prototype, Tt(n, wa(e, o))), de[i.prop = t] = i, e.targetTest && (ha.push(i), ki[t] = 1), t = (t === "css" ? "CSS" : t.charAt(0).toUpperCase() + t.substr(1)) + "Plugin";
      }
      Dn(t, i), e.register && e.register(se, i, re);
    } else
      Kn.push(e);
}, O = 255, Ht = {
  aqua: [0, O, O],
  ...
  var i = e ? Be(e) ? [e >> 16, e >> 8 & O, e & O] : 0 : Ht.black, n, o, s, l, d, c, u, p, m, g;
  if (!i) {
    if (e.substr(-1) === "," && (e = e.substr(0, e.length - 1)), Ht[e])
      ...
      if (i = g = e.match(Bi), !t)
        l = +i[0] % 360 / 360, d = +i[1] / 100, c = +i[2] / 100, o = c <= 0.5 ? c * (d + 1) : c + d - c * d, n = c * 2 - o, i.length > 3 && (i[3] *= 1), i[0] = La(l + 1 / 3, n, o), i[1] = La(l, n, o), i[2] = La(l - 1 / 3, n, o);
      else if (~e.indexOf("="))
        return i = e.match(Pn), a && i.length < 4 && (i[3] = 1), i;
    } else
      i = e.match(Bi) || Ht.transparent;
    i = i.map(Number);
  }
  return t && !g && (n = i[0] / O, o = i[1] / O, s = i[2] / O, u = Math.max(n, o, s), p = Math.min(n, o, s), c = (u + p) / 2, u === p ? l = d = 0 : (m = u - p, d = c > 0.5 ? m / (2 - u - p) : m / (u + p), l = u === n ? (o - s) / m + (o < s ? 6 : 0) : u === o ? (s - n) / m + 2 : (n - o) / m + 4, l *= 60), i[0] = ~~(l + 0.5), i[1] = ~~(d * 100 + 0.5), i[2] = ~~(c * 100 + 0.5)), a && i.length < 4 && (i[3] = 1), i;
}, er = function(e) {
  var t = [], a = [], i = -1;
  ...
  if (n = n.map(function(p) {
    return (p = Qn(p, t, 1)) && o + (t ? p[0] + "," + p[1] + "%," + p[2] + "%," + p[3] : p.join(",")) + ")";
  }), a && (c = er(e), l = a.c, l.join(i) !== c.c.join(i)))
    for (d = e.replace($e, "1").split(xt), u = d.length - 1; s < u; s++)
      i += d[s] + (~l.indexOf(s) ? n.shift() || o + "0,0,0,0)" : (c.length ? c : n.length ? n : a).shift());
  if (!d)
...
})(), ko = /hsl[a]?\(/, tr = function(e) {
  var t = e.join(" "), a;
  if ($e.lastIndex = 0, $e.test(t))
    return a = ko.test(t), e[1] = Vi(e[1], a), e[0] = Vi(e[0], a, er(e[1])), !0;
}, Kt, ce = (function() {
  var r = Date.now, e = 500, t = 33, a = r(), i = a, n = 1e3 / 240, o = n, s = [], l, d, c, u, p, m, g = function h(w) {
    var b = r() - i, y = w === !0, _, v, x, T;
    if ((b > e || b < 0) && (a += b - t), i += b, x = i - a, _ = x - o, (_ > 0 || y) && (T = ++u.frame, p = x - u.time * 1e3, u.time = x = x / 1e3, o += _ + (_ >= n ? 4 : n - _), v = 1), y || (l = d(h)), v)
  ...
  return u = {
    ...
    wake: function() {
      Rn && (!ai && _i() && (Ce = ai = window, xi = Ce.document || {}, me.gsap = se, (Ce.gsapVersions || (Ce.gsapVersions = [])).push(se.version), Ln(ga || Ce.GreenSockGlobals || !Ce.gsap && Ce || {}), Kn.forEach(Zn)), c = typeof requestAnimationFrame < "u" && requestAnimationFrame, l && u.sleep(), d = c || function(w) {
    ...
    add: function(w, b, y) {
      var _ = b ? function(v, x, T, k) {
        w(v, x, T, k), u.remove(_);
      } : w;
      return u.remove(w), s[y ? "unshift" : "push"](_), Pt(), _;
    },
    remove: function(w, b) {
  ...
  return !Kt && ce.wake();
}, R = {}, So = /^[\d.\-M][\d.\-,\s]/, Co = /["']/g, Ao = function(e) {
  for (var t = {}, a = e.substr(1, e.length - 3).split(":"), i = a[0], n = 1, o = a.length, s, l, d; n < o; n++)
    l = a[n], s = n !== o - 1 ? l.lastIndexOf(",") : l.length, d = l.substr(0, s), t[i] = isNaN(d) ? d.replace(Co, "").trim() : +d, i = l.substr(s + 1).trim();
  return t;
}, To = function(e) {
  ...
  return a && t.length > 1 && a.config ? a.config.apply(null, ~e.indexOf("{") ? [Ao(t[1])] : To(e).split(",").map(Bn)) : R._CE && So.test(e) ? R._CE("", e) : a;
}, Mo = function(e) {
  return function(t) {
    return 1 - e(1 - t);
  };
}, pt = function(e, t) {
  return e && (j(e) ? e : R[e] || Eo(e)) || t;
}, ft = function(e, t, a, i) {
  ...
  return ne(e, function(s) {
    R[s] = me[s] = n, R[o = s.toLowerCase()] = a;
    for (var l in n)
  ...
  var i = t >= 1 ? t : 1, n = (a || (e ? 0.3 : 0.45)) / (t < 1 ? t : 1), o = n / ti * (Math.asin(1 / i) || 0), s = function(c) {
    return c === 1 ? 1 : i * Math.pow(2, -10 * c) * Zr((c - o) * n) + 1;
  }, l = e === "out" ? s : e === "in" ? function(d) {
    return 1 - s(1 - d);
  } : ar(s);
  return n = ti / n, l.config = function(d, c) {
    return r(e, d, c);
  }, l;
}, Na = function r(e, t) {
  t === void 0 && (t = 1.70158);
...
ft("Sine", function(r) {
  return r === 1 ? 1 : -Kr(r * Xr) + 1;
});
ft("Back", Na("in"), Na("out"), Na());
R.SteppedEase = R.steps = me.SteppedEase = {
  config: function(e, t) {
    e === void 0 && (e = 1);
...
ne("onComplete,onUpdate,onStart,onRepeat,onReverseComplete,onInterrupt", function(r) {
  return Si += r + "," + r + "Params,";
});
var ir = function(e, t) {
  this.id = Jr++, e._gsap = this, this.target = e, this.harness = t, this.get = t ? t.get : qn, this.set = t ? t.getSetter : Pi;
}, Zt = /* @__PURE__ */ (function() {
  function r(t) {
    this.vars = t, this._delay = +t.delay || 0, (this._repeat = t.repeat === 1 / 0 ? -2 : t.repeat || 0) && (this._rDelay = t.repeatDelay || 0, this._yoyo = !!t.yoyo || !!t.yoyoEase), this._ts = 1, Mt(this, +t.duration, 1, 1), this.data = t.data, H && (this._ctx = H, H.data.push(this)), Kt || ce.wake();
  }
  var e = r.prototype;
  return e.delay = function(a) {
    ...
    if (n && n.smoothChildTiming && this._ts) {
      for (Ta(this, a), !n._dp || n.parent || Hn(n, this); n && n.parent; )
    ...
    return (this._tTime !== a || !this._dur && !i || this._initted && Math.abs(this._zTime) === B || !this._initted && this._dur && a || !a && !this._initted && (this.add || this._ptLookup)) && (this._ts || (this._pTime = a), On(this, a, i)), this;
  }, e.time = function(a, i) {
    return arguments.length ? this.totalTime(Math.min(this.totalDuration(), a + Hi(this)) % (this._dur + this._rDelay) || (a ? this._dur : 0), i) : this._time;
    ...
    return arguments.length ? this.totalTime(this.duration() * (this._yoyo && !(this.iteration() & 1) ? 1 - a : a) + Hi(this), i) : this.duration() ? Math.min(1, this._time / this._dur) : this.rawTime() > 0 ? 1 : 0;
    ...
    if (this._rts === a)
      return this;
    var n = this.parent && this._ts ? ba(this.parent._time, this) : this._tTime;
    return this._rts = +a || 0, this._ts = this._ps || a === -B ? 0 : this._rts, this.totalTime(aa(-Math.abs(this._delay), this.totalDuration(), n), i !== !1), Aa(this), lo(this);
  }, e.paused = function(a) {
    ...
    var i = this.parent || this._dp;
    return i ? a && (!this._ts || this._repeat && this._time && this.totalProgress() < 1) ? this._tTime % (this._dur + this._rDelay) : this._ts ? ba(i.rawTime(a), this) : this._tTime : this._tTime;
  }, e.revert = function(a) {
    a === void 0 && (a = no);
    var i = J;
    return J = a, Ai(this) && (this.timeline && this.timeline.revert(a), this.totalTime(-0.01, a.suppressEvents)), this.data !== "nested" && a.kill !== !1 && this.kill(), J = i, this;
    ...
    return this.play().totalTime(a ? -this._delay : 0, ie(i)), this._dur || (this._zTime = -B), this;
  }, e.play = function(a, i) {
    ...
    return new Promise(function(o) {
      var s = j(a) ? a : zn, l = function() {
        var c = i.then;
        i.then = null, n && n(), j(s) && (s = s(i)) && (s.then || s === i) && (i.then = c), o(s), i.then = c;
      };
...
var ae = /* @__PURE__ */ (function(r) {
  ...
  function e(a, i) {
    var n;
    return a === void 0 && (a = {}), n = r.call(this, a) || this, n.labels = {}, n.smoothChildTiming = !!a.smoothChildTiming, n.autoRemoveChildren = !!a.autoRemoveChildren, n._sort = ie(a.sortChildren), V && Te(a.parent || V, Le(n), i), a.reversed && n.reverse(), a.paused && n.paused(!0), a.scrollTrigger && Gn(Le(n), a.scrollTrigger), n;
  }
  var t = e.prototype;
  return t.to = function(i, n, o) {
    ...
    var s = this._time, l = this._dirty ? this.totalDuration() : this._tDur, d = this._dur, c = i <= 0 ? 0 : U(i), u = this._zTime < 0 != i < 0 && (this._initted || !d), p, m, g, h, w, b, y, _, v, x, T, k;
    if (this !== V && c > l && i >= 0 && (c = l), c !== this._tTime || o || u) {
      if (s !== this._time && d && (c += this._time - s, i += this._time - s), p = c, v = this._start, _ = this._ts, b = !_, u && (d || (s = this._zTime), (i || !n) && (this._zTime = i)), this._repeat) {
        if (T = this._yoyo, w = d + this._rDelay, this._repeat < -1 && i < 0)
          return this.totalTime(w * 100 + i, n, o);
        if (p = U(c % w), c === l ? (h = this._repeat, p = d) : (x = U(c / w), h = ~~x, h && h === x && (p = d, h--), p > d && (p = d)), x = Et(this._tTime, w), !s && this._tTime && x !== h && this._tTime - x * w - this._dur <= 0 && (x = h), T && h & 1 && (p = d - p, k = 1), h !== x && !this._lock) {
          var A = T && x & 1, S = A === (T && h & 1);
          if (h < x && (A = !A), s = A ? 0 : c % d ? d : c, this._lock = 1, this.render(s || (k ? 0 : U(h * w)), n, !d)._lock = 0, this._tTime = c, !n && this.parent && ue(this, "onRepeat"), this.vars.repeatRefresh && !k && (this.invalidate()._lock = 1, x = h), s && s !== this._time || b !== !this._ts || this.vars.onRepeat && !this.parent && !this._act)
            return this;
      ...
      if (this._hasPause && !this._forcing && this._lock < 2 && (y = ho(this, U(s), U(p)), y && (c -= p - (p = y._start))), this._tTime = c, this._time = p, this._act = !!_, this._initted || (this._onUpdate = this.vars.onUpdate, this._initted = 1, this._zTime = i, s = 0), !s && c && d && !n && !x && (ue(this, "onStart"), this._tTime !== c))
        return this;
      if (p >= s && i >= 0)
        for (m = this._first; m; ) {
          if (g = m._next, (m._act || p >= m._start) && m._ts && y !== m) {
            ...
            if (m.render(m._ts > 0 ? (p - m._start) * m._ts : (m._dirty ? m.totalDuration() : m._tDur) + (p - m._start) * m._ts, n, o), p !== this._time || !this._ts && !b) {
              y = 0, g && (c += this._zTime = -B);
              break;
            }
          }
          m = g;
        ...
        for (var E = i < 0 ? i : p; m; ) {
          if (g = m._prev, (m._act || E <= m._end) && m._ts && y !== m) {
            if (m.parent !== this)
              return this.render(i, n, o);
            if (m.render(m._ts > 0 ? (E - m._start) * m._ts : (m._dirty ? m.totalDuration() : m._tDur) + (E - m._start) * m._ts, n, o || J && Ai(m)), p !== this._time || !this._ts && !b) {
              y = 0, g && (c += this._zTime = E ? -B : B);
              break;
            }
          }
          m = g;
      ...
      if (y && !n && (this.pause(), y.render(p >= s ? 0 : -B)._zTime = p >= s ? 1 : -1, this._ts))
        return this._start = v, Aa(this), this.render(i, n, o);
      this._onUpdate && !n && ue(this, "onUpdate", !0), (c === l && this._tTime >= this.totalDuration() || !c && s) && (v === this._start || Math.abs(_) !== Math.abs(this._ts)) && (this._lock || ((i || !d) && (c === l && this._ts > 0 || !c && this._ts < 0) && Je(this, 1), !n && !(i < 0 && !s) && (c || s || !l) && (ue(this, c === l && i >= 0 ? "onComplete" : "onReverseComplete", !0), this._prom && !(c < l && this.timeScale() > 0) && this._prom())));
    }
    return this;
  }, t.add = function(i, n) {
    var o = this;
    if (Be(n) || (n = ye(this, n, i)), !(i instanceof Zt)) {
      if (Q(i))
    ...
    for (var l = [], d = this._first; d; )
      d._start >= s && (d instanceof $ ? n && l.push(d) : (o && l.push(d), i && l.push.apply(l, d.getChildren(!0, n, o)))), d = d._next;
    return l;
    ...
    return X(i) ? this.removeLabel(i) : j(i) ? this.killTweensOf(i) : (i.parent === this && Ca(this, i), i === this._recent && (this._recent = this._last), ut(this));
  }, t.totalTime = function(i, n) {
    return arguments.length ? (this._forcing = 1, !this._dp && this._ts && (this._start = U(ce.time - (this._ts > 0 ? i / this._ts : (this.totalDuration() - i) / -this._ts))), r.prototype.totalTime.call(this, i, n), this._forcing = 0, this) : this._tTime;
  }, t.addLabel = function(i, n) {
    return this.labels[i] = ye(this, n), this;
  }, t.removeLabel = function(i) {
    return delete this.labels[i], this;
  }, t.addPause = function(i, n, o) {
    var s = $.delayedCall(0, n || Xt, o);
    ...
    for (var o = [], s = xe(i), l = this._first, d = Be(n), c; l; )
      l instanceof $ ? ro(l._targets, s) && (d ? (!Ue || l._initted && l._ts) && l.globalTime(0) <= n && l.globalTime(l.totalDuration()) > n : !n || l.isActive()) && o.push(l) : (c = l.getTweensOf(s, n)).length && o.push.apply(o, c), l = l._next;
    return o;
  }, t.tweenTo = function(i, n) {
    n = n || {};
    var o = this, s = ye(o, i), l = n, d = l.startAt, c = l.onStart, u = l.onStartParams, p = l.immediateRender, m, g = $.to(o, ge({
      ease: n.ease || "none",
      lazy: !1,
      immediateRender: !1,
      time: s,
      overwrite: "auto",
      duration: n.duration || Math.abs((s - (d && "time" in d ? d.time : o._time)) / o.timeScale()) || B,
      onStart: function() {
        if (o.pause(), !m) {
          var w = n.duration || Math.abs((s - (d && "time" in d ? d.time : o._time)) / o.timeScale());
          g._dur !== w && Mt(g, w, 0, 1).render(g._time, !0, !0), m = 1;
        }
        c && c.apply(g, u || []);
      }
    }, n));
    ...
    return i === void 0 && (i = this._time), Ui(this, ye(this, i));
  }, t.previousLabel = function(i) {
    return i === void 0 && (i = this._time), Ui(this, ye(this, i), 1);
    ...
    var n = 0, o = this, s = o._last, l = _e, d, c, u;
    if (arguments.length)
    ...
    if (V._ts && (On(V, ba(i, V)), Nn = ce.frame), ce.frame >= zi) {
      zi += he.autoSleep || 120;
      var n = V._first;
...
var Po = function(e, t, a, i, n, o, s) {
  var l = new re(this._pt, e, t, 0, 1, dr, null, n), d = 0, c = 0, u, p, m, g, h, w, b, y;
  for (l.b = a, l.e = i, a += "", i += "", (b = ~i.indexOf("random(")) && (i = Jt(i)), o && (y = [a, i], o(y, e, t), a = y[0], i = y[1]), p = a.match(Ia) || []; u = Ia.exec(i); )
    g = u[0], h = i.substring(d, u.index), m ? m = (m + 1) % 5 : h.substr(-5) === "rgba(" && (m = 1), g !== p[c++] && (w = parseFloat(p[c - 1]) || 0, l._pt = {
      _next: l._pt,
      p: h || c === 1 ? h : ",",
      //note: SVG spec allows omission of comma/space when a negative sign is wedged between two numbers, like 2.5-5.3 instead of 2.5,-5.3 but when tweening, the negative value may switch to positive, so we insert the comma just in case.
      s: w,
      c: g.charAt(1) === "=" ? kt(w, g) - w : parseFloat(g) - w,
      m: m && m < 4 ? Math.round : 0
    }, d = Ia.lastIndex);
  return l.c = d < i.length ? i.substring(d, i.length) : "", l.fp = s, (In.test(i) || b) && (l.e = 0), this._pt = l, l;
}, Ti = function(e, t, a, i, n, o, s, l, d, c) {
  j(i) && (i = i(n || 0, e, o));
  var u = e[t], p = a !== "get" ? a : j(u) ? d ? e[t.indexOf("set") || !j(e["get" + t.substr(3)]) ? t : "get" + t.substr(3)](d) : e[t]() : u, m = j(u) ? d ? No : sr : Mi, g;
  if (X(i) && (~i.indexOf("random(") && (i = Jt(i)), i.charAt(1) === "=" && (g = kt(p, i) + (Z(p) || 0), (g || g === 0) && (i = g))), !c || p !== i || di)
    return !isNaN(p * i) && i !== "" ? (g = new re(this._pt, e, t, +p || 0, i - (p || 0), typeof u == "boolean" ? Oo : lr, 0, m), d && (g.fp = d), s && g.modifier(s, this, e), this._pt = g) : (!u && !(t in e) && vi(t, i), Po.call(this, e, t, p, i, m, l || he.stringFilter, d));
}, Io = function(e, t, a, i, n) {
  if (j(e) && (e = jt(e, n, t, a, i)), !Pe(e) || e.style && e.nodeType || Q(e) || Mn(e))
    return X(e) ? jt(e, n, t, a, i) : e;
  var o = {}, s;
  for (s in e)
    o[s] = jt(e[s], n, t, a, i);
  return o;
}, nr = function(e, t, a, i, n, o) {
  var s, l, d, c;
  if (de[e] && (s = new de[e]()).init(n, s.rawVars ? t[e] : Io(t[e], i, n, o, a), a, i, o) !== !1 && (a._pt = l = new re(a._pt, n, e, 0, 1, s.render, s, 0, s.priority), a !== vt))
    for (d = a._ptLookup[a._targets.indexOf(n)], c = s._props.length; c--; )
      d[s._props[c]] = l;
  return s;
}, Ue, di, Ei = function r(e, t, a) {
  var i = e.vars, n = i.ease, o = i.startAt, s = i.immediateRender, l = i.lazy, d = i.onUpdate, c = i.runBackwards, u = i.yoyoEase, p = i.keyframes, m = i.autoRevert, g = e._dur, h = e._startAt, w = e._targets, b = e.parent, y = b && b.data === "nested" ? b.vars.targets : w, _ = e._overwrite === "auto" && !bi, v = e.timeline, x = i.easeReverse || u, T, k, A, S, E, z, q, I, L, P, G, F, ee;
  if (v && (!p || !n) && (n = "none"), e._ease = pt(n, Yt.ease), e._rEase = x && (pt(x) || e._ease), e._from = !v && !!i.runBackwards, e._from && (e.ratio = 1), !v || p && !i.stagger) {
    if (I = w[0] ? ct(w[0]).harness : 0, F = I && i[I.prop], T = wa(i, ki), h && (h._zTime < 0 && h.progress(1), t < 0 && c && s && !m ? h.render(-1, !0) : h.revert(c && g ? pa : io), h._lazy = 0), o) {
      if (Je(e._startAt = $.set(w, ge({
        data: "isStart",
        overwrite: !1,
        parent: b,
        immediateRender: !0,
        ...
        stagger: 0
      }, o))), e._startAt._dp = 0, e._startAt._sat = e, t < 0 && (J || !s && !m) && e._startAt.revert(pa), s && g && t <= 0 && a <= 0) {
        t && (e._zTime = t);
        return;
      }
    } else if (c && g && !h) {
      ...
      }, T), F && (A[I.prop] = F), Je(e._startAt = $.set(w, A)), e._startAt._dp = 0, e._startAt._sat = e, t < 0 && (J ? e._startAt.revert(pa) : e._startAt.render(-1, !0)), e._zTime = t, !s)
        r(e._startAt, B, B);
      else if (!t)
        return;
    }
    for (e._pt = e._ptCache = 0, l = g && ie(l) || l && !g, k = 0; k < w.length; k++) {
      if (E = w[k], q = E._gsap || Ci(w)[k]._gsap, e._ptLookup[k] = P = {}, ii[q.id] && Ye.length && fa(), G = y === w ? k : y.indexOf(E), I && (L = new I()).init(E, F || T, e, G, y) !== !1 && (e._pt = S = new re(e._pt, E, L.name, 0, 1, L.render, L, 0, L.priority), L._props.forEach(function(fe) {
        P[fe] = S;
      }), L.priority && (z = 1)), !I || F)
        for (A in T)
          de[A] && (L = nr(A, T, e, G, E, y)) ? L.priority && (z = 1) : P[A] = S = Ti.call(e, E, A, "get", T[A], G, y, 0, i.stringFilter);
      e._op && e._op[k] && e.kill(E, e._op[k]), _ && e._pt && (Ue = e, V.killTweensOf(E, P, e.globalTime(t)), ee = !e.parent, Ue = 0), e._pt && l && (ii[q.id] = 1);
    }
    z && cr(e), e._onInit && e._onInit(e);
  }
  e._onUpdate = d, e._initted = (!e._op || e._pt) && !ee, p && t <= 0 && v.render(_e, !0, !0);
}, Ro = function(e, t, a, i, n, o, s, l) {
    ...
    for (d = e._ptCache[t] = [], p = e._ptLookup, m = e._targets.length; m--; ) {
      if (c = p[m][t], c && c.d && c.d._pt)
        for (c = c.d._pt; c && c.p !== t && c.fp !== t; )
          c = c._next;
      if (!c)
        return di = 1, e.vars[t] = "+=0", Ei(e, s), di = 0, l ? $t(t + " not eligible for reset. Try splitting into individual properties") : 1;
      d.push(c);
    }
  for (m = d.length; m--; )
    u = d[m], c = u._pt || u, c.s = (i || i === 0) && !n ? i : c.s + (i || 0) + o * c.c, c.c = a - c.s, u.e && (u.e = Y(a) + Z(u.e)), u.b && (u.b = c.s + Z(u.b));
}, Lo = function(e, t) {
  var a = e[0] ? ct(e[0]).harness : 0, i = a && a.aliases, n, o, s, l;
  if (!i)
    return t;
  n = Tt({}, t);
  for (o in i)
...
}, jt = function(e, t, a, i, n) {
  return j(e) ? e.call(t, a, i, n) : X(e) && ~e.indexOf("random(") ? Jt(e) : e;
}, rr = Si + "repeat,repeatDelay,yoyo,repeatRefresh,yoyoEase,easeReverse,autoRevert", or = {};
ne(rr + ",id,stagger,delay,duration,paused,scrollTrigger", function(r) {
  return or[r] = 1;
});
var $ = /* @__PURE__ */ (function(r) {
  ...
  function e(a, i, n, o) {
    ...
    var l = s.vars, d = l.duration, c = l.delay, u = l.immediateRender, p = l.stagger, m = l.overwrite, g = l.keyframes, h = l.defaults, w = l.scrollTrigger, b = i.parent || V, y = (Q(a) || Mn(a) ? Be(a[0]) : "length" in i) ? [a] : xe(a), _, v, x, T, k, A, S, E;
    if (s._targets = y.length ? Ci(y) : $t("GSAP target " + a + " not found. https://gsap.com", !he.nullTargetWarn) || [], s._ptLookup = [], s._overwrite = m, g || p || na(d) || na(c)) {
      i = s.vars;
      var z = i.easeReverse || i.yoyoEase;
      if (_ = s.timeline = new ae({
        data: "nested",
        defaults: h || {},
        targets: b && b.data === "nested" ? b.vars.targets : y
      }), _.kill(), _.parent = _._dp = Le(s), _._start = 0, p || na(d) || na(c)) {
        if (T = y.length, S = p && jn(p), Pe(p))
          for (k in p)
            ~rr.indexOf(k) && (E || (E = {}), E[k] = p[k]);
        for (v = 0; v < T; v++)
          x = wa(i, or), x.stagger = 0, z && (x.easeReverse = z), E && Tt(x, E), A = y[v], x.duration = +jt(d, Le(s), v, A, y), x.delay = (+jt(c, Le(s), v, A, y) || 0) - s._delay, !p && T === 1 && x.delay && (s._delay = c = x.delay, s._start += c, x.delay = 0), _.to(A, x, S ? S(v, A, y) : 0), _._ease = R.none;
        _.duration() ? d = c = 0 : s.timeline = 0;
      } else if (g) {
        Vt(ge(_.vars.defaults, {
          ease: "none"
        })), _._ease = pt(g.ease || i.ease || "none");
        var q = 0, I, L, P;
        if (Q(g))
          ...
          x = {};
          for (k in g)
            k === "ease" || k === "easeEach" || Do(k, g[k], x, g.easeEach);
          for (k in x)
            for (I = x[k].sort(function(G, F) {
              ...
              L = I[v], P = {
                ease: L.e,
                duration: (L.t - (v ? I[v - 1].t : 0)) / 100 * d
              }, P[k] = L.v, _.to(y, P, q), q += P.duration;
          _.duration() < d && _.to({}, {
      ...
      s.timeline = 0;
    return m === !0 && !bi && (Ue = Le(s), V.killTweensOf(y), Ue = 0), Te(b, Le(s), n), i.reversed && s.reverse(), i.paused && s.paused(!0), (u || !d && !g && s._start === U(b._time) && ie(u) && co(Le(s)) && b.data !== "nested") && (s._tTime = -B, s.render(Math.max(0, -c) || 0)), w && Gn(Le(s), w), s;
  }
  var t = e.prototype;
  return t.render = function(i, n, o) {
    var s = this._time, l = this._tDur, d = this._dur, c = i < 0, u = i > l - B && !c ? l : i < B ? 0 : i, p, m, g, h, w, b, y, _;
    if (!d)
      po(this, i, n, o);
      ...
      if (p = u, _ = this.timeline, this._repeat) {
        ...
        if (p = U(u % h), u === l ? (g = this._repeat, p = d) : (w = U(u / h), g = ~~w, g && g === w ? (p = d, g--) : p > d && (p = d)), b = this._yoyo && g & 1, b && (p = d - p), w = Et(this._tTime, h), p === s && !o && this._initted && g === w)
          return this._tTime = u, this;
        g !== w && this.vars.repeatRefresh && !b && !this._lock && p !== h && this._initted && (this._lock = o = 1, this.render(U(h * g), !0).invalidate()._lock = 0);
      }
      if (!this._initted) {
        if (Un(this, c ? i : p, o, n, u))
      ...
      if (this._from && (this.ratio = y = 1 - y), this._tTime = u, this._time = p, !this._act && this._ts && (this._act = 1, this._lazy = 0), !s && u && !n && !w && (ue(this, "onStart"), this._tTime !== u))
        return this;
      for (m = this._pt; m; )
        m.r(y, m.d), m = m._next;
      _ && _.render(i < 0 ? i : _._dur * _._ease(p / this._dur), n, o) || this._startAt && (this._zTime = i), this._onUpdate && !n && (c && ni(this, i, n, o), ue(this, "onUpdate")), this._repeat && g !== w && this.vars.onRepeat && !n && this.parent && ue(this, "onRepeat"), (u === this._tDur || !u) && this._tTime === u && (c && !this._onUpdate && ni(this, i, !0, !0), (i || !d) && (u === this._tDur && this._ts > 0 || !u && this._ts < 0) && Je(this, 1), !n && !(c && !s) && (u || s || b) && (ue(this, u === l ? "onComplete" : "onReverseComplete", !0), this._prom && !(u < l && this.timeScale() > 0) && this._prom()));
    }
    return this;
  }, t.targets = function() {
    ...
    return this._initted || Ei(this, d), c = this._ease(d / this._dur), Ro(this, i, n, o, s, c, d, l) ? this.resetTo(i, n, o, s, 1) : (Ta(this, 0), this.parent || Fn(this._dp, this, "_first", "_last", this._dp._sort ? "_start" : 0), this.render(0));
  }, t.kill = function(i, n) {
    if (n === void 0 && (n = "all"), !i && (!n || n === "all"))
      return this._lazy = this._pt = 0, this.parent ? Ft(this) : this.scrollTrigger && this.scrollTrigger.kill(!!J), this;
    if (this.timeline) {
      var o = this.timeline.totalDuration();
      return this.timeline.killTweensOf(i, n, Ue && Ue.vars.overwrite !== !0)._first || Ft(this), this.parent && o !== this.timeline.totalDuration() && Mt(this, this._dur * this.timeline._tDur / o, 0, 1), this;
    }
    var s = this._targets, l = i ? xe(i) : s, d = this._ptLookup, c = this._pt, u, p, m, g, h, w, b;
    if ((!n || n === "all") && so(s, l))
      return n === "all" && (this._pt = 0), Ft(this);
    for (u = this._op = this._op || [], n !== "all" && (X(n) && (h = {}, ne(n, function(y) {
      return h[y] = 1;
    }), n = h), n = Lo(s, n)), b = s.length; b--; )
      if (~l.indexOf(s[b])) {
        p = d[b], n === "all" ? (u[b] = n, g = p, m = {}) : (m = u[b] = u[b] || {}, g = n);
        for (h in g)
          w = p && p[h], w && ((!("kill" in w.d) || w.d.kill(h) === !0) && Ca(this, w, "_pt"), delete p[h]), m !== "all" && (m[h] = 1);
      }
    return this._initted && !this._pt && c && Ft(this), this;
  }, e.to = function(i, n) {
...
ne("staggerTo,staggerFrom,staggerFromTo", function(r) {
  $[r] = function() {
    var e = new ae(), t = oi.call(arguments, 0);
...
var Mi = function(e, t, a) {
  ...
  return j(e[t]) ? sr : yi(e[t]) && e.setAttribute ? qo : Mi;
}, lr = function(e, t) {
  ...
  function r(t, a, i, n, o, s, l, d, c) {
    this.t = a, this.s = n, this.c = o, this.p = i, this.r = s || lr, this.d = l || this, this.set = d || Mi, this.pr = c || 0, this._next = t, t && (t._prev = this);
  }
  var e = r.prototype;
  return e.modifier = function(a, i, n) {
    this.mSet = this.mSet || this.set, this.set = Fo, this.m = a, this.mt = n, this.tween = i;
  }, r;
})();
ne(Si + "parent,duration,ease,delay,overwrite,runBackwards,startAt,yoyo,immediateRender,repeat,repeatDelay,data,paused,reversed,lazy,callbackScope,stringFilter,id,yoyoEase,stagger,inherit,repeatRefresh,keyframes,autoRevert,scrollTrigger,easeReverse", function(r) {
  return ki[r] = 1;
});
...
he.stringFilter = tr;
var ht = [], ma = {}, Ho = [], Wi = 0, Go = 0, qa = function(e) {
  return (ma[e] || Ho).map(function(t) {
    return t();
  });
}, ci = function() {
  var e = Date.now(), t = [];
  e - Wi > 2 && (qa("matchMediaInit"), ht.forEach(function(a) {
    var i = a.queries, n = a.conditions, o, s, l, d;
    for (s in i)
      o = Ce.matchMedia(i[s]).matches, o && (l = 1), o !== n[s] && (n[s] = o, d = 1);
    d && (a.revert(), l && t.push(a));
  }), qa("matchMediaRevert"), t.forEach(function(a) {
  ...
  function r(t, a) {
    this.selector = a && si(a), this.data = [], this._r = [], this.isReverted = !1, this.id = Go++, t && this.add(t);
  }
  var e = r.prototype;
  return e.add = function(a, i, n) {
    ...
    var o = this, s = function() {
      ...
      return d && d !== o && d.data.push(o), n && (o.selector = si(n)), H = o, u = i.apply(o, arguments), j(u) && o._r.push(u), H = d, o.selector = c, o.isReverted = !1, u;
    };
    ...
    var n = this;
    if (a ? (function() {
      for (var s = n.getTweens(), l = n.data.length, d; l--; )
        d = n.data[l], d.data === "isFlip" && (d.revert(), d.getChildren(!0, !0, !1).forEach(function(c) {
      ...
      for (s.map(function(c) {
        ...
        d = n.data[l], d instanceof ae ? d.data !== "nested" && (d.scrollTrigger && d.scrollTrigger.revert(), d.kill()) : !(d instanceof $) && d.revert && d.revert(a);
  ...
  return e.add = function(a, i, n) {
    ...
    var o = new ur(0, n || this.scope), s = o.conditions = {}, l, d, c;
    H && !o.selector && (o.selector = H.selector), this.contexts.push(o), i = o.add("onMatch", i), o.queries = a;
    for (d in a)
      d === "all" ? c = 1 : (l = Ce.matchMedia(a[d]), l && (ht.indexOf(o) < 0 && ht.push(o), (s[d] = l.matches) && (c = 1), l.addListener ? l.addListener(ci) : l.addEventListener("change", ci)));
  ...
  getProperty: function(e, t, a, i) {
    X(e) && (e = xe(e)[0]);
    var n = ct(e || {}).get, o = a ? zn : Bn;
    return a === "native" && (a = ""), e && (t ? o((de[t] && de[t].get || n)(e, t, a, i)) : function(s, l, d) {
      return o((de[s] && de[s].get || n)(e, s, l, d));
    });
  },
  quickSetter: function(e, t, a) {
    ...
    var o = de[t], s = ct(e), l = s.harness && (s.harness.aliases || {})[t] || t, d = o ? function(c) {
      var u = new o();
      vt._pt = 0, u.init(e, a ? c + a : c, vt, 0, [e]), u.render(1, u), vt._pt && Ii(1, vt);
    } : s.set(e, l);
  ...
  quickTo: function(e, t, a) {
    var i, n = se.to(e, ge((i = {}, i[t] = "+=0.1", i.paused = !0, i.stagger = 0, i), a || {})), o = function(l, d, c) {
      return n.resetTo(t, l, d, c);
    };
    return o.tween = n, o;
  },
  ...
  defaults: function(e) {
    return e && e.ease && (e.ease = pt(e.ease, Yt.ease)), Fi(Yt, e || {});
  },
  config: function(e) {
    return Fi(he, e || {});
  },
  registerEffect: function(e) {
    ...
    (i || "").split(",").forEach(function(s) {
      ...
      return a(xe(s), ge(l || {}, n), d);
    }, o && (ae.prototype[t] = function(s, l, d) {
      return this.add(Ra[t](s, Pe(l) ? l : (d = l) && {}, this), d);
    });
  },
...
}, Oa("roundProps", li), Oa("modifiers"), Oa("snap", Yn)) || ya;
...
R.Expo;
R.Circ;
var ji, Ve, St, Ri, dt, Yi, Li, jo = function() {
  return typeof window < "u";
}, ze = {}, st = 180 / Math.PI, Ct = Math.PI / 180, wt = Math.atan2, $i = 1e8, Di = /([A-Z])/g, Yo = /(left|right|width|margin|padding|x)/i, $o = /[\s,\(]\S/, Me = {
...
}, W = "transform", oe = W + "Origin", rs = function r(e, t) {
  var a = this, i = this.target, n = i.style, o = i._gsap;
  if (e in ze && n) {
    if (this.tfm = this.tfm || {}, e !== "transform")
      e = Me[e] || e, ~e.indexOf(",") ? e.split(",").forEach(function(s) {
        return a.tfm[s] = De(i, s);
      }) : this.tfm[e] = o.x ? o[e] : De(i, e), e === oe && (this.tfm.zOrigin = o.zOrigin);
    else
  ...
  if (this.tfm) {
    for (o in this.tfm)
      i[o] = this.tfm[o];
    i.svg && (i.renderTransform(), t.setAttribute("data-svg-origin", this.svgo || "")), n = Li(), (!n || !n.isStart) && !a[W] && (mr(a), i.zOrigin && a[oe] && (a[oe] += " " + i.zOrigin + "px", i.zOrigin = 0, i.renderTransform()), i.uncache = 1);
  }
}, gr = function(e, t) {
  var a = {
    target: e,
  ...
  return i[t] || i.getPropertyValue(t.replace(Di, "-$1").toLowerCase()) || i.getPropertyValue(t) || !a && r(e, It(t) || t, 1) || "";
}, Xi = "O,Moz,ms,Ms,Webkit".split(","), It = function(e, t, a) {
  var i = t || dt, n = i.style, o = 5;
  if (e in n && !a)
    return e;
  ...
  jo() && window.document && (ji = window, Ve = ji.document, St = Ve.documentElement, dt = pi("div") || {
    style: {}
  }, pi("div"), W = It(W), oe = W + "Origin", dt.style.cssText = "border-width:0;line-height:0;position:absolute;padding:0", fr = !!It("perspective"), Li = se.core.reverting, Ri = 1);
}, Ji = function(e) {
  var t = e.ownerSVGElement, a = pi("svg", t && t.getAttribute("xmlns") || "http://www.w3.org/2000/svg"), i = e.cloneNode(!0), n;
  i.style.display = "block", a.appendChild(i), St.appendChild(a);
  try {
    n = i.getBBox();
  } catch {
  }
  return a.removeChild(i), St.removeChild(a), n;
}, Ki = function(e, t) {
  for (var a = t.length; a--; )
  ...
  if (t) {
    var a = e.style, i;
    t in ze && t !== oe && (t = W), a.removeProperty ? (i = t.substr(0, 2), (i === "ms" || t.substr(0, 6) === "webkit") && (t = "-" + t), a.removeProperty(i === "--" ? t : t.replace(Di, "-$1").toLowerCase())) : a.removeAttribute(t);
  }
}, We = function(e, t, a, i, n, o) {
  var s = new re(e._pt, t, a, 0, 1, o ? hr : pr);
  ...
  var n = parseFloat(a) || 0, o = (a + "").trim().substr((n + "").length) || "px", s = dt.style, l = Yo.test(t), d = e.tagName.toLowerCase() === "svg", c = (d ? "client" : "offset") + (l ? "Width" : "Height"), u = 100, p = i === "px", m = i === "%", g, h, w, b;
  if (i === o || !n || Zi[i] || Zi[o])
    return n;
  if (o !== "px" && !p && (n = r(e, t, a, "px")), b = e.getCTM && br(e), (m || o === "%") && (ze[t] || ~t.indexOf("adius")))
    return g = b ? e.getBBox()[l ? "width" : "height"] : e[c], Y(m ? n / g * u : n / 100 * g);
  if (s[l ? "width" : "height"] = u + (p ? o : i), h = i !== "rem" && ~t.indexOf("adius") || i === "em" && e.appendChild && !d ? e : e.parentNode, b && (h = (e.ownerSVGElement || {}).parentNode), (!h || h === Ve || !h.appendChild) && (h = Ve.body), w = h._gsap, w && m && w.width && l && w.time === ce.time && !w.uncache)
    return Y(n / w.width * u);
  if (m && (t === "height" || t === "width")) {
    var y = e.style[t];
    e.style[t] = u + i, g = e[c], y ? e.style[t] = y : Ke(e, t);
  } else
    (m || o === "%") && !ss[pe(h, "display")] && (s.position = pe(e, "position")), h === e && (s.position = "static"), h.appendChild(dt), g = dt[c], h.removeChild(dt), s.position = "absolute";
  return l && m && (w = ct(h), w.time = ce.time, w.width = h[c]), Y(p ? g * n / u : g && n ? u / g * n : 0);
}, De = function(e, t, a, i) {
  var n;
  return Ri || hi(), t in Me && t !== "transform" && (t = Me[t], ~t.indexOf(",") && (t = t.split(",")[0])), ze[t] && t !== "transform" ? (n = ea(e, i), n = t !== "transformOrigin" ? n[t] : n.svg ? n.origin : xa(pe(e, oe)) + " " + n.zOrigin + "px") : (n = e.style[t], (!n || n === "auto" || i || ~(n + "").indexOf("calc(")) && (n = _a[t] && _a[t](e, t, a) || pe(e, t) || qn(e, t) || (t === "opacity" ? 1 : 0))), a && !~(n + "").trim().indexOf(" ") ? Ze(e, t, n, a) + a : n;
}, ls = function(e, t, a, i) {
  if (!a || a === "none") {
    var n = It(t, e, 1), o = n && pe(e, n, 1);
    o && o !== a ? (t = n, a = o) : t === "borderColor" && (a = pe(e, "borderTopColor"));
  }
  var s = new re(this._pt, e.style, t, 0, 1, dr), l = 0, d = 0, c, u, p, m, g, h, w, b, y, _, v, x;
  if (s.b = a, s.e = i, a += "", i += "", i.substring(0, 6) === "var(--" && (i = pe(e, i.substring(4, i.indexOf(")")))), i === "auto" && (h = e.style[t], e.style[t] = i, i = pe(e, t) || i, h ? e.style[t] = h : Ke(e, t)), c = [a, i], tr(c), a = c[0], i = c[1], p = a.match(xt) || [], x = i.match(xt) || [], x.length) {
    for (; u = xt.exec(i); )
      w = u[0], y = i.substring(l, u.index), g ? g = (g + 1) % 5 : (y.substr(-5) === "rgba(" || y.substr(-5) === "hsla(") && (g = 1), w !== (h = p[d++] || "") && (m = parseFloat(h) || 0, v = h.substr((m + "").length), w.charAt(1) === "=" && (w = kt(m, w) + v), b = parseFloat(w), _ = w.substr((b + "").length), l = xt.lastIndex - _.length, _ || (_ = _ || he.units[t] || v, l === i.length && (i += _, s.e += _)), v !== _ && (m = Ze(e, t, h, _) || 0), s._pt = {
        _next: s._pt,
        p: y || d === 1 ? y : ",",
        //note: SVG spec allows omission of comma/space when a negative sign is wedged between two numbers, like 2.5-5.3 instead of 2.5,-5.3 but when tweening, the negative value may switch to positive, so we insert the comma just in case.
        s: m,
    ...
    s.r = t === "display" && i === "none" ? hr : pr;
  return In.test(i) && (s.e = 0), this._pt = s, s;
}, Qi = {
  top: "0%",
  bottom: "100%",
  left: "0%",
  ...
  return (a === "top" || a === "bottom" || i === "left" || i === "right") && (e = a, a = i, i = e), t[0] = Qi[a] || a, t[1] = Qi[i] || i, t.join(" ");
}, cs = function(e, t) {
  if (t.tween && t.tween._time === t.tween._dur) {
    var a = t.t, i = a.style, n = t.u, o = a._gsap, s, l, d;
    if (n === "all" || n === !0)
      i.cssText = "", l = 1;
    else
      for (n = n.split(","), d = n.length; --d > -1; )
        s = n[d], ze[s] && (l = 1, s = s === "transformOrigin" ? oe : W), Ke(a, s);
    l && (Ke(a, W), o && (o.svg && a.removeAttribute("transform"), i.scale = i.rotate = i.translate = "none", ea(a, 1), o.uncache = 1, mr(i)));
  }
}, _a = {
  clearProps: function(e, t, a, i, n) {
    if (n.data !== "isFromStart") {
      var o = e._pt = new re(e._pt, t, a, 0, 0, cs);
  ...
  */
}, Qt = [1, 0, 0, 1, 0, 0], yr = {}, _r = function(e) {
  return e === "matrix(1, 0, 0, 1, 0, 0)" || e === "none" || !e;
}, en = function(e) {
  var t = pe(e, W);
  return _r(t) ? Qt : t.substr(7).match(Pn).map(Y);
}, Ni = function(e, t) {
  var a = e._gsap || ct(e), i = e.style, n = en(e), o, s, l, d;
  return a.svg && e.getAttribute("transform") ? (l = e.transform.baseVal.consolidate().matrix, n = [l.a, l.b, l.c, l.d, l.e, l.f], n.join(",") === "1,0,0,1,0,0" ? Qt : n) : (n === Qt && !e.offsetParent && e !== St && !a.svg && (l = i.display, i.display = "block", o = e.parentNode, (!o || !e.offsetParent && !e.getBoundingClientRect().width) && (d = 1, s = e.nextElementSibling, St.appendChild(e)), n = en(e), l ? i.display = l : Ke(e, "display"), d && (s ? o.insertBefore(e, s) : o ? o.appendChild(e) : St.removeChild(e))), t && n.length > 6 ? [n[0], n[1], n[4], n[5], n[12], n[13]] : n);
}, mi = function(e, t, a, i, n, o) {
  var s = e._gsap, l = n || Ni(e, !0), d = s.xOrigin || 0, c = s.yOrigin || 0, u = s.xOffset || 0, p = s.yOffset || 0, m = l[0], g = l[1], h = l[2], w = l[3], b = l[4], y = l[5], _ = t.split(" "), v = parseFloat(_[0]) || 0, x = parseFloat(_[1]) || 0, T, k, A, S;
  a ? l !== Qt && (k = m * w - g * h) && (A = v * (w / k) + x * (-h / k) + (h * y - w * b) / k, S = v * (-g / k) + x * (m / k) - (m * y - g * b) / k, v = A, x = S) : (T = wr(e), v = T.x + (~_[0].indexOf("%") ? v / 100 * T.width : v), x = T.y + (~(_[1] || _[0]).indexOf("%") ? x / 100 * T.height : x)), i || i !== !1 && s.smooth ? (b = v - d, y = x - c, s.xOffset = u + (b * m + y * h) - b, s.yOffset = p + (b * g + y * w) - y) : s.xOffset = s.yOffset = 0, s.xOrigin = v, s.yOrigin = x, s.smooth = !!i, s.origin = t, s.originIsAbsolute = !!a, e.style[oe] = "0px 0px", o && (We(o, s, "xOrigin", d, v), We(o, s, "yOrigin", c, x), We(o, s, "xOffset", u, s.xOffset), We(o, s, "yOffset", p, s.yOffset)), e.setAttribute("data-svg-origin", v + " " + x);
}, ea = function(e, t) {
  var a = e._gsap || new ir(e);
  if ("x" in a && !t && !a.uncache)
    return a;
  var i = e.style, n = a.scaleX < 0, o = "px", s = "deg", l = getComputedStyle(e), d = pe(e, oe) || "0", c, u, p, m, g, h, w, b, y, _, v, x, T, k, A, S, E, z, q, I, L, P, G, F, ee, fe, Dt, Nt, et, Oi, Ie, tt;
  return c = u = p = h = w = b = y = _ = v = 0, m = g = 1, a.svg = !!(e.getCTM && br(e)), l.translate && ((l.translate !== "none" || l.scale !== "none" || l.rotate !== "none") && (i[W] = (l.translate !== "none" ? "translate3d(" + (l.translate + " 0 0").split(" ").slice(0, 3).join(", ") + ") " : "") + (l.rotate !== "none" ? "rotate(" + l.rotate + ") " : "") + (l.scale !== "none" ? "scale(" + l.scale.split(" ").join(",") + ") " : "") + (l[W] !== "none" ? l[W] : "")), i.scale = i.rotate = i.translate = "none"), k = Ni(e, a.svg), a.svg && (a.uncache ? (ee = e.getBBox(), d = a.xOrigin - ee.x + "px " + (a.yOrigin - ee.y) + "px", F = "") : F = !t && e.getAttribute("data-svg-origin"), mi(e, F || d, !!F || a.originIsAbsolute, a.smooth !== !1, k)), x = a.xOrigin || 0, T = a.yOrigin || 0, k !== Qt && (z = k[0], q = k[1], I = k[2], L = k[3], c = P = k[4], u = G = k[5], k.length === 6 ? (m = Math.sqrt(z * z + q * q), g = Math.sqrt(L * L + I * I), h = z || q ? wt(q, z) * st : 0, y = I || L ? wt(I, L) * st + h : 0, y && (g *= Math.abs(Math.cos(y * Ct))), a.svg && (c -= x - (x * z + T * I), u -= T - (x * q + T * L))) : (tt = k[6], Oi = k[7], Dt = k[8], Nt = k[9], et = k[10], Ie = k[11], c = k[12], u = k[13], p = k[14], A = wt(tt, et), w = A * st, A && (S = Math.cos(-A), E = Math.sin(-A), F = P * S + Dt * E, ee = G * S + Nt * E, fe = tt * S + et * E, Dt = P * -E + Dt * S, Nt = G * -E + Nt * S, et = tt * -E + et * S, Ie = Oi * -E + Ie * S, P = F, G = ee, tt = fe), A = wt(-I, et), b = A * st, A && (S = Math.cos(-A), E = Math.sin(-A), F = z * S - Dt * E, ee = q * S - Nt * E, fe = I * S - et * E, Ie = L * E + Ie * S, z = F, q = ee, I = fe), A = wt(q, z), h = A * st, A && (S = Math.cos(A), E = Math.sin(A), F = z * S + q * E, ee = P * S + G * E, q = q * S - z * E, G = G * S - P * E, z = F, P = ee), w && Math.abs(w) + Math.abs(h) > 359.9 && (w = h = 0, b = 180 - b), m = Y(Math.sqrt(z * z + q * q + I * I)), g = Y(Math.sqrt(G * G + tt * tt)), A = wt(P, G), y = Math.abs(A) > 2e-4 ? A * st : 0, v = Ie ? 1 / (Ie < 0 ? -Ie : Ie) : 0), a.svg && (F = e.getAttribute("transform"), a.forceCSS = e.setAttribute("transform", "") || !_r(pe(e, W)), F && e.setAttribute("transform", F))), Math.abs(y) > 90 && Math.abs(y) < 270 && (n ? (m *= -1, y += h <= 0 ? 180 : -180, h += h <= 0 ? 180 : -180) : (g *= -1, y += y <= 0 ? 180 : -180)), t = t || a.uncache, a.x = c - ((a.xPercent = c && (!t && a.xPercent || (Math.round(e.offsetWidth / 2) === Math.round(-c) ? -50 : 0))) ? e.offsetWidth * a.xPercent / 100 : 0) + o, a.y = u - ((a.yPercent = u && (!t && a.yPercent || (Math.round(e.offsetHeight / 2) === Math.round(-u) ? -50 : 0))) ? e.offsetHeight * a.yPercent / 100 : 0) + o, a.z = p + o, a.scaleX = Y(m), a.scaleY = Y(g), a.rotation = Y(h) + s, a.rotationX = Y(w) + s, a.rotationY = Y(b) + s, a.skewX = y + s, a.skewY = _ + s, a.transformPerspective = v + o, (a.zOrigin = parseFloat(d.split(" ")[2]) || !t && a.zOrigin || 0) && (i[oe] = xa(d)), a.xOffset = a.yOffset = 0, a.force3D = he.force3D, a.renderTransform = a.svg ? ps : fr ? xr : us, a.uncache = 0, a;
}, xa = function(e) {
  return (e = e.split(" "))[0] + " " + e[1];
}, Ba = function(e, t, a) {
  var i = Z(t);
  return Y(parseFloat(t) + parseFloat(Ze(e, "x", a + "px", i))) + i;
}, us = function(e, t) {
  t.z = "0px", t.rotationY = t.rotationX = "0deg", t.force3D = 0, xr(e, t);
}, at = "0deg", qt = "0px", it = ") ", xr = function(e, t) {
  var a = t || this, i = a.xPercent, n = a.yPercent, o = a.x, s = a.y, l = a.z, d = a.rotation, c = a.rotationY, u = a.rotationX, p = a.skewX, m = a.skewY, g = a.scaleX, h = a.scaleY, w = a.transformPerspective, b = a.force3D, y = a.target, _ = a.zOrigin, v = "", x = b === "auto" && e && e !== 1 || b === !0;
  if (_ && (u !== at || c !== at)) {
    var T = parseFloat(c) * Ct, k = Math.sin(T), A = Math.cos(T), S;
    T = parseFloat(u) * Ct, S = Math.cos(T), o = Ba(y, o, k * S * -_), s = Ba(y, s, -Math.sin(T) * -_), l = Ba(y, l, A * S * -_ + _);
  }
  w !== qt && (v += "perspective(" + w + it), (i || n) && (v += "translate(" + i + "%, " + n + "%) "), (x || o !== qt || s !== qt || l !== qt) && (v += l !== qt || x ? "translate3d(" + o + ", " + s + ", " + l + ") " : "translate(" + o + ", " + s + it), d !== at && (v += "rotate(" + d + it), c !== at && (v += "rotateY(" + c + it), u !== at && (v += "rotateX(" + u + it), (p !== at || m !== at) && (v += "skew(" + p + ", " + m + it), (g !== 1 || h !== 1) && (v += "scale(" + g + ", " + h + it), y.style[W] = v || "translate(0, 0)";
}, ps = function(e, t) {
  var a = t || this, i = a.xPercent, n = a.yPercent, o = a.x, s = a.y, l = a.rotation, d = a.skewX, c = a.skewY, u = a.scaleX, p = a.scaleY, m = a.target, g = a.xOrigin, h = a.yOrigin, w = a.xOffset, b = a.yOffset, y = a.forceCSS, _ = parseFloat(o), v = parseFloat(s), x, T, k, A, S;
  l = parseFloat(l), d = parseFloat(d), c = parseFloat(c), c && (c = parseFloat(c), d += c, l += c), l || d ? (l *= Ct, d *= Ct, x = Math.cos(l) * u, T = Math.sin(l) * u, k = Math.sin(l - d) * -p, A = Math.cos(l - d) * p, d && (c *= Ct, S = Math.tan(d - c), S = Math.sqrt(1 + S * S), k *= S, A *= S, c && (S = Math.tan(c), S = Math.sqrt(1 + S * S), x *= S, T *= S)), x = Y(x), T = Y(T), k = Y(k), A = Y(A)) : (x = u, A = p, T = k = 0), (_ && !~(o + "").indexOf("px") || v && !~(s + "").indexOf("px")) && (_ = Ze(m, "x", o, "px"), v = Ze(m, "y", s, "px")), (g || h || w || b) && (_ = Y(_ + g - (g * x + h * k) + w), v = Y(v + h - (g * T + h * A) + b)), (i || n) && (S = m.getBBox(), _ = Y(_ + i / 100 * S.width), v = Y(v + n / 100 * S.height)), S = "matrix(" + x + "," + T + "," + k + "," + A + "," + _ + "," + v + ")", m.setAttribute("transform", S), y && (m.style[W] = S);
}, hs = function(e, t, a, i, n) {
  var o = 360, s = X(n), l = parseFloat(n) * (s && ~n.indexOf("rad") ? st : 1), d = l - i, c = i + d + "deg", u, p;
  return s && (u = n.split("_")[1], u === "short" && (d %= o, d !== d % (o / 2) && (d += d < 0 ? o : -o)), u === "cw" && d < 0 ? d = (d + o * $i) % o - ~~(d / o) * o : u === "ccw" && d > 0 && (d = (d - o * $i) % o - ~~(d / o) * o)), e._pt = p = new re(e._pt, t, a, i, d, Xo), p.e = c, p.u = "deg", e._props.push(a), p;
}, tn = function(e, t) {
  for (var a in t)
    e[a] = t[a];
  return e;
}, ms = function(e, t, a) {
  var i = tn({}, a._gsap), n = "perspective,force3D,transformOrigin,svgOrigin", o = a.style, s, l, d, c, u, p, m, g;
  ...
  for (l in ze)
    d = i[l], c = s[l], d !== c && n.indexOf(l) < 0 && (m = Z(d), g = Z(c), u = m !== g ? Ze(a, l, d, g) : parseFloat(d), p = parseFloat(c), e._pt = new re(e._pt, s, l, u, p - u, ui), e._pt.u = g || 0, e._props.push(l));
  tn(s, i);
};
ne("padding,margin,Width,Radius", function(r, e) {
  ...
  _a[e > 1 ? "border" + r : r] = function(s, l, d, c, u) {
    var p, m;
...
var vr = {
  ...
  init: function(e, t, a, i, n) {
    var o = this._props, s = e.style, l = a.vars.startAt, d, c, u, p, m, g, h, w, b, y, _, v, x, T, k, A, S;
    Ri || hi(), this.styles = this.styles || gr(e), A = this.styles.props, this.tween = a;
    for (h in t)
      if (h !== "autoRound" && (c = t[h], !(de[h] && nr(h, t, a, i, e, n)))) {
        if (m = typeof c, g = _a[h], m === "function" && (c = c.call(a, i, e, n), m = typeof c), m === "string" && ~c.indexOf("random(") && (c = Jt(c)), g)
          g(this, e, h, c, a) && (k = 1);
        else if (h.substr(0, 2) === "--")
          d = (getComputedStyle(e).getPropertyValue(h) + "").trim(), c += "", $e.lastIndex = 0, $e.test(d) || (w = Z(d), b = Z(c), b ? w !== b && (d = Ze(e, h, d, b) + b) : w && (c += w)), this.add(s, "setProperty", d, c, i, n, 0, 0, h), o.push(h), A.push(h, 0, s[h]);
        else if (m !== "undefined") {
          if (l && h in l ? (d = typeof l[h] == "function" ? l[h].call(a, i, e, n) : l[h], X(d) && ~d.indexOf("random(") && (d = Jt(d)), Z(d + "") || d === "auto" || (d += he.units[h] || Z(De(e, h)) || ""), (d + "").charAt(1) === "=" && (d = De(e, h))) : d = De(e, h), p = parseFloat(d), y = m === "string" && c.charAt(1) === "=" && c.substr(0, 2), y && (c = c.substr(2)), u = parseFloat(c), h in Me && (h === "autoAlpha" && (p === 1 && De(e, "visibility") === "hidden" && u && (p = 0), A.push("visibility", 0, s.visibility), We(this, s, "visibility", p ? "inherit" : "hidden", u ? "inherit" : "hidden", !u)), h !== "scale" && h !== "transform" && (h = Me[h], ~h.indexOf(",") && (h = h.split(",")[0]))), _ = h in ze, _) {
            ...
            if (v || (x = e._gsap, x.renderTransform && !t.parseTransform || ea(e, t.parseTransform), T = t.smoothOrigin !== !1 && x.smooth, v = this._pt = new re(this._pt, s, W, 0, 1, x.renderTransform, x, 0, -1), v.dep = 1), h === "scale")
              this._pt = new re(this._pt, x, "scaleY", x.scaleY, (y ? kt(x.scaleY, y + u) : u) - x.scaleY || 0, ui), this._pt.u = 0, o.push("scaleY", h), h += "X";
            else if (h === "transformOrigin") {
              A.push(oe, 0, s[oe]), c = ds(c), x.svg ? mi(e, c, 0, T, 0, this) : (b = parseFloat(c.split(" ")[2]) || 0, b !== x.zOrigin && We(this, x, "zOrigin", x.zOrigin, b), We(this, s, h, xa(d), xa(c)));
              continue;
            } else if (h === "svgOrigin") {
              mi(e, c, 1, T, 0, this);
              continue;
            } else if (h in yr) {
              hs(this, x, h, p, y ? kt(p, y + c) : c);
              continue;
          ...
          } else h in s || (h = It(h) || h);
          if (_ || (u || u === 0) && (p || p === 0) && !$o.test(c) && h in s)
            w = (d + "").substr((p + "").length), u || (u = 0), b = Z(c) || (h in he.units ? he.units[h] : w), w !== b && (p = Ze(e, h, d, b)), this._pt = new re(this._pt, _ ? x : s, h, p, (y ? kt(p, y + u) : u) - p, !_ && (b === "px" || h === "zIndex") && t.autoRound !== !1 ? Zo : ui), this._pt.u = b || 0, _ && S !== c ? (this._pt.b = d, this._pt.e = S, this._pt.r = Ko) : w !== b && b !== "%" && (this._pt.b = d, this._pt.r = Jo);
          else if (h in s)
            ls.call(this, e, h, d, y ? y + c : c);
          else if (h in e)
            this.add(e, h, d || e[h], y ? y + c : c, i, n);
          else if (h !== "parseTransform") {
            vi(h, c);
            continue;
          }
          _ || (h in s ? A.push(h, 0, s[h]) : typeof e[h] == "function" ? A.push(h, 2, e[h]()) : A.push(h, 1, d || e[h])), o.push(h);
        }
      }
    k && cr(this);
  },
  ...
  getSetter: function(e, t, a) {
    var i = Me[t];
    return i && i.indexOf(",") < 0 && (t = i), t in ze && t !== oe && (e._gsap.x || De(e, "x")) ? a && Yi === a ? t === "scale" ? as : ts : (Yi = a || {}) && (t === "scale" ? is : ns) : e.style && !yi(e.style[t]) ? Qo : ~t.indexOf("-") ? es : Pi(e, t);
  },
  core: {
    _removeProperty: Ke,
    _getMatrix: Ni
...
se.utils.checkPrefix = It;
se.core.getStyleSaver = gr;
(function(r, e, t, a) {
  var i = ne(r + "," + e + "," + t, function(n) {
    ze[n] = 1;
  });
  ne(e, function(n) {
    he.units[n] = "deg", yr[n] = 1;
  }), Me[i[13]] = r + "," + e, ne(a, function(n) {
    var o = n.split(":");
    Me[o[1]] = i[o[0]];
  });
...
se.registerPlugin(vr);
var f = se.registerPlugin(vr) || se;
f.core.Tween;
...
const D = "https://i.pravatar.cc/96", ws = {
  "andre park": `${D}?img=52`,
  "ava garcia": `${D}?img=46`,
...
function bs(r) {
  const e = Sr(r).replace(/[^a-z0-9]+/g, "-").replace(/^-|-$/g, "");
  return e ? `${D}?u=${encodeURIComponent(e)}` : "";
}
function ys(r, e) {
  const t = Sr(r), a = e?.trim() || void 0;
  return ws[t] ?? a ?? bs(r);
}
const Cr = `
...
const _s = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="52 42 88 66">
<path fill="#4285f4" d="M58 108h14V74L52 59v43c0 3.32 2.69 6 6 6"/>
<path fill="#34a853" d="M120 108h14c3.32 0 6-2.69 6-6V59l-20 15"/>
<path fill="#fbbc04" d="M120 48v26l20-15v-8c0-7.42-8.47-11.65-14.4-7.2"/>
<path fill="#ea4335" d="M72 74V48l24 18 24-18v26L96 92"/>
<path fill="#c5221f" d="M52 51v8l20 15V48l-5.6-4.2c-5.94-4.45-14.4-.22-14.4 7.2"/>
</svg>`, xs = `<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" viewBox="60 90.4 570.02 539.67">
<defs>
...
<path style=" stroke:none;fill-rule:nonzero;fill:rgb(100%,100%,100%);fill-opacity:1;" d="M 179.332031 535.847656 C 159.5625 535.847656 143.332031 529.472656 130.640625 516.71875 C 117.953125 503.964844 111.605469 487.320312 111.605469 466.789062 C 111.605469 445.105469 118.046875 427.570312 130.929688 414.179688 C 143.8125 400.785156 160.679688 394.089844 181.53125 394.089844 C 201.234375 394.089844 217.273438 400.5 229.644531 413.316406 C 242.082031 426.136719 248.296875 443.035156 248.296875 464.015625 C 248.296875 485.566406 241.855469 502.945312 228.976562 516.144531 C 216.15625 529.28125 199.609375 535.847656 179.332031 535.847656 Z M 179.902344 508.78125 C 190.679688 508.78125 199.355469 504.984375 205.921875 497.398438 C 212.492188 489.808594 215.773438 479.253906 215.773438 465.734375 C 215.773438 451.640625 212.585938 440.675781 206.210938 432.832031 C 199.832031 424.988281 191.320312 421.066406 180.671875 421.066406 C 169.699219 421.066406 160.867188 425.113281 154.171875 433.214844 C 147.476562 441.246094 144.128906 451.898438 144.128906 465.160156 C 144.128906 478.617188 147.476562 489.265625 154.171875 497.109375 C 160.867188 504.890625 169.445312 508.78125 179.902344 508.78125 Z M 179.902344 508.78125 "/>
...
], ks = 1.28, C = (r) => Number((r * ks).toFixed(3)), Ss = [2, 3, 2], te = {
  pressDuration: C(0.09),
  releaseDuration: C(0.2),
  loadingHoldDuration: C(0.78),
  successHoldDuration: C(0.12),
  learningRevealDuration: C(0.34),
  detailSwapDuration: 0.16,
  readyPopUpDuration: 0.12,
  readyPopSettleDuration: 0.22,
  settleHold: C(0.24)
}, an = "Learning your style", Cs = "Voice calibrated", nn = "73 tone & tactic rules defined", za = [
  ...
  0,
  4
], Es = /* @__PURE__ */ new Set([5, 8, 10, 16]), Ms = [
  ...
  showDuration: C(0.42),
  hideDuration: C(0.32),
  contentShowDelay: C(0.1),
  contentHideDuration: C(0.1),
  showEase: "expo.out",
  hideEase: "power3.in",
  contentEase: "power2.out",
  threadGap: 44
}, Ls = "left,right,bottom,width,height,minHeight,paddingTop,paddingRight,paddingBottom,paddingLeft,borderWidth,gap", Ga = {
  paddingTop: "",
  paddingRight: "",
  paddingBottom: "",
  paddingLeft: "",
  ...
  revealDuration: C(0.42),
  revealEase: "power3.inOut",
  followDuration: C(0.24),
  followEase: "power2.out"
}, Re = {
  threadY: -176,
  threadOpacity: 0,
  revealDuration: C(0.62),
  revealEase: "power3.inOut",
  cardDuration: C(0.28)
}, Ds = 4, Ns = [
  ...
  contentWidth: 1881,
  height: 1280
}, qs = 96, ln = ".wa-cursor-file, .wa-file-landing-clone, .wa-file-landing-label, .wa-csv-drop, .wa-signup-logo-transfer", Os = "[data-marketing-data-sources-grid]", dn = "[data-data-table]", Bt = "[data-table-action]", cn = "[data-table-page-button]", Bs = "[data-table-page-range]", Wa = {
  offscreenMargin: 96,
...
class zs {
  ...
  handleDataTableControlClick = (e) => {
    ...
    if (!t) return;
    const i = t.closest(dn)?.dataset.dataTable, n = Number(t.dataset.tablePageButton);
  ...
  measureComposerFullFrame() {
    f.set(this.composer, { clearProps: Ls });
  ...
  scrollToLive(e = Fe.followDuration) {
  ...
  assistantMessage(e) {
    ...
    return a ? i.add(
      this.streamText(a, e, {
        duration: this.getStreamDuration(e, rn),
        targetForScroll: t
      }),
      rn.startOverlap
    ) : i;
  ...
  dataTable(e) {
    ...
    return this.revealComponentItems("table", t, ".wa-data-table__row", Se.tableRow, a);
  }
  dataTablePage(e, t, a = {}) {
    const i = f.timeline(), n = { value: 0 }, o = { value: 0 }, s = a.updateExpected ?? !0, l = {
      canSwitch: !1,
      table: null,
      currentRows: [],
      targetRows: [],
    ...
    return i.to(n, {
      ...
      ease: "power1.out",
      onStart: () => {
        l.table = this.findDataTable(e), s && this.expectedDataTablePages.set(e, t), l.currentRows = l.table ? this.getVisibleDataTableRows(l.table) : [], l.targetRows = l.table ? this.queryElements(l.table, `.wa-data-table__row[data-page="${t}"]`) : [], l.buttons = l.table ? this.queryElements(l.table, cn) : [], l.targetButton = l.buttons.find((d) => Number(d.dataset.tablePageButton) === t), l.range = l.table?.querySelector(Bs) ?? null, l.canSwitch = !!(l.table && l.targetRows.length && l.table.dataset.activePage !== String(t)), l.canSwitch && f.set(l.currentRows, { autoAlpha: 1, y: 0 });
      },
      onUpdate: () => {
        if (!l.canSwitch) return;
        const d = n.value, c = this.interpolate(0, -4, d);
  ...
  enrichmentPanel(e) {
    const t = this.createEnrichmentPanel(e), a = this.revealComponentItems("enrichment", t, ".wa-waterfall-row", Se.waterfallRow), i = t.querySelector(".wa-thinking__elapsed"), n = t.querySelector(".wa-thinking__glyph");
  ...
  strategyPlans(e) {
    ...
    a.className = "wa-result-grid has-strategy-plans", a.dataset.strategyPlans = e.map((s) => s.id).join(" "), a.append(...t), f.set(i, { autoAlpha: 0, y: 5 });
    ...
    return m.call(() => {
      ...
      w > 0 && m.to(c, {
        ...
        g,
        {
          ...
          duration: h.duration,
          ease: "power2.inOut",
          onUpdate: () => this.updateMailboxThumbprintFill(n, g.value)
        },
        w === 0 ? "-=0.04" : void 0
      ).to(
        o,
      ...
      i.dataset.mailboxLearningState = "ready", l.textContent = Cs, c.textContent = i.dataset.mailboxLearningReadyDetail ?? nn;
    }).fromTo(
      l,
      { autoAlpha: 0, y: 4 },
      {
  ...
  swipePersonalizationCard(e, t, a) {
    ...
    ), n = i?.querySelector(`[data-swipe-card="${this.escapeSelectorValue(t)}"]`), o = this.getSwipeCards(i), s = n ? o.indexOf(n) : -1, l = o[s + 1], d = a === "use" ? 1 : -1, c = i?.querySelector(`[data-swipe-action="${a}"]`), u = i?.querySelector("[data-swipe-complete]"), p = i?.querySelector(".wa-swipe-game__actions"), m = f.timeline();
    return !i || !n || s < 0 || (m.call(() => {
      ...
      () => {
        delete i.dataset.swipeDecision, c && delete c.dataset.active, n.dataset.swipeState = "done", f.set(n, { display: "none" }), this.layoutSwipeGameCards(i, s + 1);
      },
      void 0,
      "-=0.12"
    ), l ? m.fromTo(
  ...
  sequenceBuildThinking(e) {
    ...
    return this.addThinkingStepReveal(c, t, { position: "<" }), c.to({}, { duration: Ha.templateHold }).add(this.foldThinkingStep(t)).call(() => {
      a.forEach((u) => {
      ...
      onUpdate: () => {
        ...
        l.forEach(({ label: m, bar: g }) => {
          m && (m.textContent = `${u}/${e.total}`), g && f.set(g, { scaleX: p });
        }), this.requestMessageScroll(o.message);
      }
    }, "+=0.14").to({}, { duration: Ha.finalHold }), a.forEach((u, p) => {
      c.add(this.foldThinkingStep(u), p === 0 ? void 0 : "<");
    }), c.add(this.collapseThinkingToHeader(o, i)), this.addThinkingElapsedTimer(c, o.elapsed, n), c;
  }
  sequencePerson(e, t) {
    const a = this.findSequenceEngagement(e), i = f.timeline();
    if (!a) return i;
    const n = this.queryElements(a, "[data-sequence-card]"), o = this.getSequenceDisplayCard(a), s = n.find((c) => Number(c.dataset.sequenceIndex) === t), l = Number(a.dataset.activeSequenceIndex ?? "0");
    if (!s || !o || l === t)
      return this.setActiveSequencePerson(a, t, !0), i;
    const d = this.getSequenceTransitionTargets(o);
    return i.to(d, {
      autoAlpha: 0,
      y: -3,
      duration: C(0.14),
      ...
      this.setActiveSequencePerson(a, t, !0), f.set(d, { y: 4 });
    }).to(d, {
      autoAlpha: 1,
      y: 0,
      duration: C(0.24),
  ...
  prepareCursorFile(e, t, a = "CSV", i = []) {
    ...
    return this.registerTransientElement(n, () => {
      ...
      startFollow: () => f.timeline().call(() => {
        o?.();
        const d = this.getCursorFileEntryOffset(n, t);
        s.x = d.x, s.y = d.y, o = this.followCursorWithFile(n, t, s);
      }).to(s, {
        x: 0,
        y: 0,
      ...
      landAsUploadedFile: (d, c = "CSV uploaded") => f.timeline().call(l).add(this.uploadedFileMessageFromCursorFile(n, d, c)),
      landAsUploadedFiles: (d) => f.timeline().call(l).add(this.uploadedFilesMessageFromCursorFile(n, d))
    };
  }
  ...
  revealDroppedFilesMessage(e, t, a, i = [], n = {}) {
    ...
    return !a.length || !e.isConnected ? this.revealMessageWithChildren(t, o, {
      ...
      }), c = this.getMessageScrollTarget(t), s = this.createFileLandingClones(e, a, c), l = this.createFileLandingLabel(n.landingLabel, s), f.set(e, { autoAlpha: 0 });
    }).to(
      this.thread,
      {
        scrollTop: () => c,
      ...
      d,
      {
        ...
        ease: be.ease,
        onUpdate: () => {
          this.renderFileLandingClones(s, d.value), this.renderFileLandingLabel(l, d.value);
        }
      },
      0
    ).to(
      ...
      this.renderFileLandingClones(s, 1), this.renderFileLandingLabel(l, 1), f.set(o, { autoAlpha: 1, y: 0, scale: 1 }), f.set(t, { opacity: 1, visibility: "visible" }), s.forEach((u) => u.el.remove()), l?.el.remove(), e.remove(), this.animateMessageScrollIntoView(t);
    }));
  }
  createFileLandingClones(e, t, a) {
    const i = this.getCursorFileCards(e), n = this.chatBody;
    return t.map((o, s) => {
      const l = i[Math.min(s, i.length - 1)], d = l.getBoundingClientRect(), c = o.getBoundingClientRect(), u = this.getElementLocalRect(d, n), p = this.getFinalFileLandingTargetRect(o, c, n, a), m = o.cloneNode(!0), g = this.getCursorFileCardRotation(s, i.length), h = window.getComputedStyle(l), w = window.getComputedStyle(o), b = this.parseCssColor(h.backgroundColor) ?? { r: 255, g: 255, b: 249, a: 0.96 }, y = this.parseCssColor(w.backgroundColor) ?? b, _ = this.parseCssColor(h.borderTopColor) ?? { r: 23, g: 23, b: 20, a: 0.12 }, v = this.parseCssColor(w.borderTopColor) ?? _, x = this.queryElements(m, ".wa-uploaded-file__body span");
      return m.classList.add("wa-file-landing-clone"), m.dataset.fileLandingClone = "", n.append(m), f.set(m, {
        position: "absolute",
        zIndex: 21,
        top: 0,
        left: 0,
        ...
        endBorderColor: v,
        detailEls: x,
        setX: f.quickSetter(m, "x", "px"),
        setY: f.quickSetter(m, "y", "px"),
        setRotation: f.quickSetter(m, "rotation", "deg"),
        setBackgroundColor: f.quickSetter(m, "backgroundColor"),
        setBorderColor: f.quickSetter(m, "borderColor")
      };
    });
  }
  ...
  createFileLandingLabel(e, t) {
    ...
    const i = a.offsetWidth, n = a.offsetHeight, o = 9, s = this.getFileLandingCloneBounds(t, "start"), l = this.getFileLandingCloneBounds(t, "end"), d = s.left + s.width / 2 - i / 2, c = l.left + l.width / 2 - i / 2;
    return {
      el: a,
      startX: d,
      startY: s.top - n - o,
      endX: c,
      endY: l.top - n - o,
      setX: f.quickSetter(a, "x", "px"),
      setY: f.quickSetter(a, "y", "px"),
      setOpacity: f.quickSetter(a, "opacity")
    };
  }
  renderFileLandingLabel(e, t) {
    if (!e) return;
    const a = Gt(t / 0.16), i = Gt((1 - t) / 0.16);
  ...
  getFileLandingCloneBounds(e, t) {
    const a = e.map((u) => t === "start" ? u.startX : u.endX), i = e.map((u) => t === "start" ? u.startY : u.endY), n = e.map((u, p) => a[p] + u.el.offsetWidth), o = e.map((u, p) => i[p] + u.el.offsetHeight), s = Math.min(...a), l = Math.min(...i), d = Math.max(...n), c = Math.max(...o);
    return {
      left: s,
      top: l,
      width: d - s,
  ...
  getFinalFileLandingTargetRect(e, t, a, i) {
    const n = this.getElementLocalRect(t, a);
    return this.thread.contains(e) ? {
      left: n.left,
      top: n.top + this.thread.scrollTop - i
    } : n;
  }
  interpolate(e, t, a) {
    return e + (t - e) * a;
  ...
  parseOklchColor(e) {
    ...
    const o = this.parseCssColorComponent(n[0], 1), s = Number(n[1]), l = Number.parseFloat(n[2]), d = i ? this.parseCssColorComponent(i.trim(), 1) : 1;
    if (![o, s, l, d].every(Number.isFinite)) return null;
    const c = l * Math.PI / 180, u = s * Math.cos(c), p = s * Math.sin(c), m = o + 0.3963377774 * u + 0.2158037573 * p, g = o - 0.1055613458 * u - 0.0638541728 * p, h = o - 0.0894841775 * u - 1.291485548 * p, w = m ** 3, b = g ** 3, y = h ** 3, _ = 4.0767416621 * w - 3.3077115913 * b + 0.2309699292 * y, v = -1.2684380046 * w + 2.6097574011 * b - 0.3413193965 * y, x = -0.0041960863 * w - 0.7034186147 * b + 1.707614701 * y;
    return {
      r: this.oklchLinearToSrgb(_) * 255,
      g: this.oklchLinearToSrgb(v) * 255,
      b: this.oklchLinearToSrgb(x) * 255,
      a: Gt(d)
    };
  }
  ...
  revealMessageWithChildren(e, t, a, i = "-=0.22", n = null, o = 0) {
    return f.timeline().add(this.revealMessage(e, n, o)).to(t, a, i);
  }
  ...
  revealPreparedItems(e, t, a, i = null, n = 0) {
    return t.length && f.set(t, { ...a.from }), this.revealMessageWithChildren(
      e,
      t,
      { ...a.to },
      a.position,
      ...
      () => this.animateMessageScrollIntoView(e, Fe.followDuration, i, n),
      void 0,
      "+=0.02"
    );
  }
  ...
  resetMessageClasses(e) {
    e.classList.remove(...vs), e.classList.remove("wa-message--first-active");
  }
  createCsvDropArea(e = {}) {
  ...
  followCursorWithFile(e, t, a) {
    const i = e.offsetWidth || 154, n = e.offsetHeight || 42, o = f.quickSetter(e, "x", "px"), s = f.quickSetter(e, "y", "px"), l = { x: -120, y: -120 }, d = () => {
      const c = t.readPosition(), u = c.x - i * 0.5 + a.x, p = c.y - n * 0.5 + a.y;
      u !== l.x && (l.x = u, o(u)), p !== l.y && (l.y = p, s(p));
    };
    return d(), f.ticker.add(d), () => f.ticker.remove(d);
  }
  getCursorFileEntryOffset(e, t) {
    const a = e.offsetWidth || 154, i = t.readPosition(), n = this.root.getBoundingClientRect().width || window.innerWidth, o = i.x + a * 0.5, s = n + Wa.offscreenMargin;
    return {
      x: Math.max(0, s - o),
      y: 0
    };
  ...
  createUploadedFile(e, t, a) {
    ...
    return d.textContent = t, s.append(l, d), n.append(o, s), n;
  }
  ...
  streamThinkingHeader(e) {
    return this.streamThinkingChild(e, ".wa-thinking__title", Rs);
  }
  streamThinkingStepLabel(e) {
    return this.streamThinkingChild(e, ".wa-research-step__label", Is);
  }
  ...
  streamText(e, t, a) {
    ...
    return f.timeline().call(() => {
      ...
      e.textContent = t, delete e.dataset.streaming, this.cancelScheduledScroll(), this.animateMessageScrollIntoView(a.targetForScroll, Fe.followDuration * 0.7);
    });
  }
  foldThinkingStep(e) {
  ...
  revealThinkingHeaderFromSignupLogo(e, t) {
    ...
    }).add(this.streamThinkingHeader(e.header), C(Math.min(t, 0.16))).to(i, {
      value: 1,
  ...
  renderSignupLogoTransfer(e, t) {
    if (!e) return;
    const a = e.target.getBoundingClientRect(), i = this.getElementLocalRect(a, this.chatBody), n = Tr(t);
    e.setX(this.interpolate(e.startX, i.left, n)), e.setY(this.interpolate(e.startY, i.top, n)), e.setWidth(this.interpolate(e.startWidth, a.width, n)), e.setHeight(this.interpolate(e.startHeight, a.height, n)), f.set(e.el, {
      color: t > 0.78 ? Ua.targetColor : getComputedStyle(this.signupLogo).color
    });
  }
  ...
  getThinkingLogoTargetPosition(e, t, a) {
    const n = (e.message.querySelector(".wa-thinking-block") ?? e.message).getBoundingClientRect(), o = t.getBoundingClientRect(), s = e.traveler.offsetWidth || e.headerGlyph.offsetWidth || 18, l = e.traveler.offsetHeight || e.headerGlyph.offsetHeight || 11, d = a && Number(f.getProperty(a, "x")) || 0, c = a && Number(f.getProperty(a, "y")) || 0;
    return {
      x: o.left - n.left + (o.width - s) / 2 - d,
      y: o.top - n.top + (o.height - l) / 2 - c
    };
  }
  ...
  moveThinkingLogoToStep(e, t) {
    ...
    return a ? f.timeline().add(this.moveThinkingLogoTo(e, a, ke.duration, t), 0).add(this.moveThinkingGuideTo(e, a, ke.duration, t), 0) : f.timeline();
  }
  ...
  claimThinkingMessage(e, t, a = Ae) {
    ...
    return u.className = "wa-research-steps", u.dataset.researchSteps = "", u.append(...e), n.append(o, l, c), i.append(n, u, s), {
  ...
  addThinkingElapsedTimer(e, t, a) {
    fs(e, t, a, { reducedMotion: this.prefersReducedMotion });
  }
  createThinkingLogo(e = "wa-thinking__glyph") {
    const t = document.createElement("span");
    return t.className = e, t.dataset.logoMode = "thinking", t.setAttribute("aria-hidden", "true"), t.append(Ar("wa-thinking__logo-mark")), t;
  }
  ...
  createThinkingStep(e, t) {
    ...
    const d = document.createElement("span");
    return d.className = "wa-research-step__chevron", d.setAttribute("aria-hidden", "true"), o.append(s, d), n.append(o, l), a.append(i, n), a;
  }
  ...
  createDataTable(e) {
    ...
    if (s.className = "wa-data-table__title", s.textContent = e.title, n.append(o, s), e.count) {
      const d = document.createElement("span");
      d.className = "wa-data-table__count", d.textContent = e.count, n.append(d);
    }
  ...
  findDataTablePageButton(e) {
    return e instanceof Element ? e.closest(cn) : null;
  }
  findDataTable(e) {
  ...
  createMarketingDataSourcesGrid(e) {
    ...
    return t.classList.add("wa-data-source-grid--marketing"), t.dataset.marketingDataSourcesGrid = e.id, a.className = "wa-data-source-grid__scale", i.className = "wa-data-source-grid__groups", Ns.forEach((s) => {
      const l = document.createElement("div");
  ...
  createMailboxConnection(e) {
    ...
    const s = this.createMailboxProviderButton({
      id: e.id,
      icon: "gmail",
      label: ja("gmail", e.ctaLabel),
      loadingLabel: e.loadingLabel ?? "Connecting",
      connectedLabel: ja("gmail", e.status, "connected"),
      isPrimary: !0
    }), l = this.createMailboxProviderButton({
      icon: "outlook",
      label: ja("outlook", e.secondaryCtaLabel)
    });
    o.append(s, l), a.append(i, o);
    const d = document.createElement("div");
    d.className = "wa-mailbox-learning", d.dataset.mailboxLearning = "", d.dataset.mailboxLearningReadyDetail = e.learningReadyDetail ?? nn;
    ...
    const p = document.createElement("span");
    p.dataset.mailboxLearningTitleText = "", p.textContent = e.learningTitle ?? an;
    ...
    g.className = "wa-mailbox-learning__detail", g.textContent = e.learningDetail ?? za[0].detail;
    const h = document.createElement("div");
    h.className = "wa-mailbox-learning__progress";
    const w = document.createElement("span");
    return w.dataset.mailboxLearningProgress = "", h.append(w), d.append(c, u, h, g), t.append(a, d), t;
  }
  ...
  createMailboxProviderIcon(e) {
    ...
    return t.className = "wa-mailbox-connection__provider-icon", t.src = As[e], t.alt = "", t.decoding = "async", t.loading = "eager", t.setAttribute("aria-hidden", "true"), t;
  }
  ...
  createMailboxThumbprintGroup(e, t = !1) {
    ...
    return a.classList.add(e), Ms.forEach((i, n) => {
  ...
  createPersonalizationSwipeGame(e) {
    ...
    u.className = "wa-swipe-game__glow", u.setAttribute("aria-hidden", "true"), c.append(u), e.signals.forEach((g, h) => {
      ...
      w.className = "wa-swipe-card", w.dataset.swipeCard = g.id, w.dataset.swipeDecision = g.decision, w.dataset.cardIndex = String(h);
      const b = document.createElement("strong");
      b.className = "wa-swipe-card__label", b.textContent = g.label;
      const y = document.createElement("span");
      y.className = "wa-swipe-card__detail", y.textContent = g.detail, w.append(b, y), c.append(w);
    });
    const p = document.createElement("div");
    p.className = "wa-swipe-game__complete", p.dataset.swipeComplete = "", p.textContent = e.completeLabel ?? `${e.signals.length} choices captured`, c.append(p), f.set(p, { autoAlpha: 0, y: 12, scale: 0.96 });
    ...
    ), t.append(a, n, o, c, m), this.updateSwipeGameProgress(t, 0), t;
  }
  ...
  createSequenceEngagement(e) {
    ...
    const i = this.createSectionHeader("wa-sequence-engagement", e.title, e.subtitle, a), n = document.createElement("div");
    n.className = "wa-sequence-engagement__sequences";
    const o = e.sequences.some((p) => p.steps?.length);
    let s = null;
    if (o) {
      const p = document.createElement("div");
      p.className = "wa-sequence-people", p.dataset.sequencePeopleRail = e.id, p.setAttribute("aria-label", "Sequence people"), e.sequences.forEach((m, g) => {
        const h = document.createElement("button"), w = document.createElement("span"), b = document.createElement("span"), y = document.createElement("strong"), _ = document.createElement("span");
        h.className = "wa-sequence-person-card", h.type = "button", h.tabIndex = -1, h.dataset.sequencePersonCard = `${e.id}:${g}`, h.dataset.sequencePersonIndex = String(g), h.dataset.active = String(g === 0), h.setAttribute("aria-pressed", String(g === 0)), h.setAttribute("aria-label", `Preview sequence for ${m.name}`), h.addEventListener("click", () => {
          this.sequencePerson(e.id, g).play();
        }), w.className = "wa-sequence-person-card__avatar", w.dataset.avatarTone = String(g % 9 + 1), this.setProfileAvatar(w, m.name, m.avatarUrl), b.className = "wa-sequence-person-card__copy", y.textContent = m.name, _.textContent = [m.title, m.company].filter(Boolean).join(", "), b.append(y, _), h.append(w, b), p.append(h);
      }), s = p;
    }
    e.sequences.forEach((p, m) => {
      const g = document.createElement("article");
      g.className = "wa-sequence-card", g.dataset.sequenceCard = `${e.id}:${m}`, g.dataset.sequenceIndex = String(m), g.dataset.active = String(m === 0), g.dataset.sequenceName = p.name, g.dataset.sequenceMeta = [p.title, p.company].filter(Boolean).join(", "), g.dataset.sequenceTemplateName = p.name, g.dataset.sequenceTemplateMeta = [p.title, p.company].filter(Boolean).join(", "), g.dataset.sequenceTemplateAvatarUrl = p.avatarUrl ?? "", m !== 0 && (g.style.display = "none", f.set(g, { autoAlpha: 0, y: 8 }));
      const h = document.createElement("div");
      ...
      const y = document.createElement("span");
      y.textContent = [p.title, p.company].filter(Boolean).join(", "), w.append(b, y);
      const _ = document.createElement("span");
      _.className = "wa-sequence-card__label", _.textContent = p.signal ?? "Personalized", h.append(w, _);
      ...
      const T = p.steps;
      if (T?.length) {
        const k = document.createElement("div"), A = T[0], S = document.createElement("div"), E = document.createElement("span"), z = document.createElement("strong"), q = document.createElement("p");
        k.className = "wa-sequence-steps", T.forEach((I, L) => {
          const P = document.createElement("button"), G = document.createElement("span"), F = document.createElement("span"), ee = document.createElement("strong"), fe = this.getSequenceStepWaitDays(I, L, T.length);
          P.className = "wa-sequence-step", P.type = "button", P.tabIndex = -1, P.dataset.stepIndex = String(L), P.dataset.stepOpen = String(L === 0), P.dataset.stepSelected = String(L === 0), P.dataset.channel = this.slugChannelName(I.channel), P.dataset.stepSubject = L === 0 ? p.subject : I.label, P.dataset.stepBody = this.getSequenceStepCopy(p, I), P.dataset.stepTemplateChannel = I.channel, P.dataset.stepTemplateLabel = I.label, P.dataset.stepTemplateSubject = L === 0 ? p.subject : I.label, P.dataset.stepTemplateBody = this.getSequenceStepCopy(p, I), fe && (P.dataset.waitDays = String(fe), P.dataset.stepTemplateWaitDays = String(fe)), P.setAttribute("aria-pressed", String(L === 0)), P.addEventListener("click", () => {
            this.selectSequenceStep(g, L);
          }), G.className = "wa-sequence-step__channel", G.textContent = I.channel, F.className = "wa-sequence-step__copy", ee.textContent = I.label, F.append(ee), P.append(G, F), k.append(P), fe && k.append(this.createSequenceWaitRow(fe, L));
        }), S.className = "wa-sequence-copy-panel", S.dataset.sequenceCopyPanel = "", E.className = "wa-sequence-copy-panel__meta", E.dataset.sequenceCopyMeta = "", E.textContent = A ? `${A.channel} 1` : "Email", z.className = "wa-sequence-copy-panel__subject", z.dataset.sequenceCopySubject = "", z.textContent = p.subject, q.className = "wa-sequence-copy-panel__body", q.dataset.sequenceCopyBody = "", q.textContent = A ? this.getSequenceStepCopy(p, A) : p.personalization, S.append(E, z, q), g.append(k, S);
      } else
        g.append(h, v, x);
      n.append(g);
    });
    ...
    l.className = "wa-engage-channels", e.channels.forEach((p) => {
      ...
      const w = document.createElement("span");
      if (w.textContent = p.detail, g.append(h, w), m.append(g), p.badge) {
    ...
    }), o ? t.append(...this.compactElements(i, s, n, d)) : t.append(i, n, l), t;
  }
  ...
  setActiveSequencePerson(e, t, a = !1) {
    ...
    !s || !l || (i.forEach((d) => {
      const c = d === s;
      d.dataset.active = String(c), d.style.display = c ? "grid" : "none", f.set(d, { autoAlpha: c ? 1 : 0, y: 0 });
    }), e.dataset.activeSequenceIndex = String(t), this.applySequenceTemplateToDisplayCard(e, s, l, t), n.forEach((d) => {
      const c = Number(d.dataset.sequencePersonIndex) === t;
      d.dataset.active = String(c), d.setAttribute("aria-pressed", String(c));
  ...
  centerSequencePersonCard(e, t) {
    ...
    if (!a || !i) return;
    const n = Math.max(0, a.scrollWidth - a.clientWidth), o = Math.min(n, Math.max(0, i.offsetLeft - (a.clientWidth - i.offsetWidth) / 2));
    if (this.prefersReducedMotion || Math.abs(a.scrollLeft - o) < 1) {
      a.scrollLeft = o;
      return;
    }
    f.to(a, {
  ...
  applySequenceTemplateToDisplayCard(e, t, a, i) {
    ...
    t.dataset.sequenceName = a.dataset.sequenceTemplateName ?? a.dataset.sequenceName ?? "", t.dataset.sequenceMeta = a.dataset.sequenceTemplateMeta ?? a.dataset.sequenceMeta ?? "", o.forEach((d, c) => {
      ...
      const g = s[c], h = Number(d.dataset.waitDays), w = g?.querySelector(".wa-sequence-wait__label");
      g && (g.style.display = Number.isFinite(h) && h > 0 ? "grid" : "none", g.dataset.waitDays = String(h)), w && Number.isFinite(h) && h > 0 && (w.textContent = this.formatSequenceWaitLabel(h));
    }), e.dataset.activeSequenceIndex = String(i), this.selectSequenceStep(t, Math.min(n, Math.max(0, o.length - 1)));
  }
  selectSequenceStep(e, t) {
    const a = this.queryElements(e, ".wa-sequence-step"), i = a.find((d) => Number(d.dataset.stepIndex) === t) ?? a[0], n = e.querySelector("[data-sequence-copy-meta]"), o = e.querySelector("[data-sequence-copy-subject]"), s = e.querySelector("[data-sequence-copy-body]"), l = i?.querySelector(".wa-sequence-step__channel")?.textContent?.trim() ?? "email";
    a.forEach((d) => {
      const c = d === i;
...
`);
  ...
  clearTransientElements() {
    ...
    this.transientCleanups = [], this.removeElements(ln);
  }
  removeElements(e) {
  ...
  animateMessageScrollIntoView(e, t = Fe.followDuration, a = null, i = 0) {
  ...
  requestMessageScroll(e) {
    ...
    this.scheduledScrollMessage = e, !(t - this.lastStreamScrollAt < qs) && (this.scheduledScrollFrame || (this.lastStreamScrollAt = t, this.scheduledScrollFrame = window.requestAnimationFrame(() => {
...
function Fs(r, e) {
  const t = Ts[r] ?? 0, a = 24 + r * 11 % 8, i = Math.min(100, t + a), n = Tr((e - t) / (i - t));
  if (n <= 0) return 0;
  const o = Es.has(r) ? 20 : 12;
...
function pn(r, e, t, a, i) {
  const n = 1 - i, o = i * i, s = n * n, l = s * n, d = o * i;
  return {
    x: l * r.x + 3 * s * i * e.x + 3 * n * o * t.x + d * a.x,
    y: l * r.y + 3 * s * i * e.y + 3 * n * o * t.y + d * a.y
  };
}
function Gs(r) {
  let e = 2166136261;
...
function oa(r, e, t) {
  const a = Er(t.seed), i = Hs(r, e), n = t.speed ?? "normal", o = t.intent ?? "hover";
  ...
  const s = e.x - r.x, l = e.y - r.y, d = s / i, c = l / i, u = -c, p = d, m = a() > 0.5 ? 1 : -1, g = t.curve ?? 1, w = Ut(i * (o === "drag" ? 0.1 : o === "click" ? 0.17 : 0.22) * g, 18, 150) * m * (0.72 + a() * 0.44), b = i / Us[n] + 0.16, y = Ut(b * Vs[o] * Ws, 0.3, 1.66), _ = t.overshoot === !1 || i < 120 ? 0 : typeof t.overshoot == "number" ? t.overshoot : Ut(i * 0.026, 4, 18), v = _ > 0 ? {
    x: e.x + d * _,
    y: e.y + c * _
  } : e, x = {
    x: r.x + s * (0.25 + a() * 0.08) + u * w,
    y: r.y + l * (0.25 + a() * 0.08) + p * w
  }, T = {
    x: r.x + s * (0.68 + a() * 0.12) - u * w * 0.42,
    y: r.y + l * (0.68 + a() * 0.12) - p * w * 0.42
  }, k = t.settle !== !1 && _ > 0;
  return {
    start: r,
    c1: x,
    ...
    settle: k ? {
      start: v,
      c1: {
        x: v.x - d * _ * 0.45 + u * w * 0.04,
        y: v.y - c * _ * 0.45 + p * w * 0.04
      },
      c2: {
        x: e.x + d * _ * 0.16,
        y: e.y + c * _ * 0.16
      ...
      duration: Ut(y * 0.18, 0.1, 0.24)
    } : void 0
  };
}
const Ya = "button, a, [role='button'], [data-send-button], [data-result-action]", $a = "[data-chat-input][data-visible='true'], [data-signup-field], input, textarea, [contenteditable='true']", Xa = {
  delay: 0.42,
  returnDuration: 0.18,
  segments: [
...
class $s {
  ...
  moveTo(e, t = {}) {
    const a = t.label ?? `move-${this.moveIndex}`, i = t.mode ?? "default", n = `${this.storyId}:${a}:${this.resolver.getBreakpoint()}`, o = this.resolver.resolve(e, n), s = { ...this.plannedPosition }, l = oa(s, o, {
      seed: n,
      intent: t.intent,
      speed: t.speed,
      curve: t.curve,
    ...
    return this.moveIndex += 1, this.plannedPosition = { ...o }, d.call(() => {
      ...
      this.pathTweenFromFactory(
        () => {
          ...
          return c = oa(this.currentPosition, u, {
            seed: n,
            intent: t.intent,
            speed: t.speed,
            curve: t.curve,
  ...
  parkForChatHistory() {
    const e = `history-park-${this.moveIndex}`, t = `${this.storyId}:${e}:${this.resolver.getBreakpoint()}`, a = { ...this.currentPosition }, i = this.resolveHistoryParkPoint(), n = oa(a, i, {
      seed: t,
      intent: "hover",
      speed: "quick",
      overshoot: !1,
    ...
    return this.moveIndex += 1, this.plannedPosition = { ...i }, o.call(() => {
      this.stopIdleFloat(!0), f.killTweensOf([this.el, this.floatLayer]), this.resetRotation(!0), this.modeOverride = "default", this.setMode("default");
    }, void 0, 0), o.add(
      this.pathTweenFromFactory(
  ...
  pathTweenFromFactory(e, t, a = "power2.inOut") {
    ...
    return f.fromTo(
      ...
      { t: 0 },
      {
        ...
        onUpdate: () => {
          if (!n) return;
          const o = pn(n.start, n.c1, n.c2, n.end, i.t);
  ...
  createHistoryParkPlan(e) {
    this.resolver.refresh();
    const t = this.resolveHistoryParkPoint(), a = oa(this.currentPosition, t, {
      seed: e,
      intent: "hover",
      speed: "quick",
      overshoot: !1,
  ...
  resolveHistoryParkPoint() {
    ...
    const a = Ut(
      t.height * sa.topRatio,
      sa.minTopInset,
      sa.maxTopInset
    );
    return {
      x: t.right - e.left + sa.outsideOffset,
      y: t.top - e.top + a
    };
  }
  ...
  resolveScanPoint(e, t, a, i = "first") {
    ...
    this.resolver.refresh();
    const o = this.seededScanRandom(t), s = this.root.getBoundingClientRect(), l = n.getBoundingClientRect(), d = this.getChatShellRect(), c = d ? Math.max(l.left, d.left + 18) : l.left, u = d ? Math.min(l.right, d.right - 18) : l.right, p = d ? Math.max(l.top, d.top + 58) : l.top, m = d ? Math.min(l.bottom, d.bottom - 34) : l.bottom, g = Math.max(1, u - c), h = Math.max(1, m - p), w = a === "start" ? 0.16 + o() * 0.08 : 0.76 + o() * 0.12, b = 0.34 + o() * 0.32;
    return {
      x: c - s.left + g * w,
      y: p - s.top + h * b
    };
  ...
  renderMimicRotation(e, t) {
    ...
    if (a * a + i * i < 4) return;
    const n = Math.atan2(i, a) * 180 / Math.PI, o = Xs(n - js), s = this.rotationState + Js(this.rotationState, o) * Ys;
  ...
  getModeForElement(e) {
    return e ? e.closest(Ya) ? "pointer" : e.closest($a) ? "text" : "default" : "default";
  }
  getModeForLocalPoint(e, t) {
    return this.refreshModeTargetCache(), this.findLocalHit(this.pointerTargets, e, t, Ya) ? "pointer" : this.findLocalHit(this.textTargets, e, t, $a) ? "text" : "default";
  }
  findLocalHit(e, t, a, i) {
    for (const n of e) {
      ...
      if (t.x >= s && t.x <= l && t.y >= d && t.y <= c) return n;
    }
    return null;
  }
  refreshModeTargetCache() {
    this.modeTargetsDirty && (this.pointerTargets = Array.from(this.root.querySelectorAll(Ya)).reverse(), this.textTargets = Array.from(this.root.querySelectorAll($a)).reverse(), this.modeTargetsDirty = !1);
  }
  observeModeTargets() {
  ...
  createElement() {
    ...
    const a = document.createElement("div");
    return a.className = "wa-cursor__glyph", a.append(hn()), t.append(a), e.append(t), this.root.append(e), e;
  }
  ensureFloatLayer() {
    const e = this.el.querySelector("[data-cursor-float]");
    if (e) return e;
    const t = this.el.querySelector(".wa-cursor__glyph") ?? document.createElement("div");
    t.classList.contains("wa-cursor__glyph") || (t.className = "wa-cursor__glyph"), t.querySelector(".wa-cursor__mimic-head") || t.append(hn());
    const a = document.createElement("div");
...
const lt = {
  ...
  status: "State",
  file: "File"
}, Ks = ["user", "assistant", "thinking", "component", "cursor", "file"], Zs = "/api/story-draft", Qs = 800, Mr = "73 tone & tactic rules defined", yt = 3;
class el {
  constructor(e, t, a = {}) {
    this.root = e, this.sourceStories = t, this.options = a, this.stories = gn(t), this.selectedStepId = this.stories[0]?.steps[0]?.id ?? null, this.draftEndpoint = a.draftEndpoint ?? Zs, this.draftAutoSave = a.draftAutoSave ?? !0;
  }
  root;
  sourceStories;
  options;
  ...
  attachEvents() {
    ...
    e && (this.on(e.tabs, "click", (t) => {
      const a = Ja(t.target, "[data-builder-story-tab]");
      a && this.selectStory(Number(a.dataset.builderStoryTab));
    }), this.on(e.addRail, "click", (t) => {
      const i = Ja(t.target, "[data-builder-add]")?.dataset.builderAdd;
      !i || !gi(i) || this.addStep(i);
    }), this.on(e.copyJson, "click", () => {
      this.copyExportJson();
    }), this.on(e.thread, "click", (t) => {
      const a = Ja(t.target, "[data-builder-action]");
      if (a) {
      ...
      const n = t.target?.closest("[data-builder-step-field]");
      if (!n) return;
      const o = n.dataset.builderStepField;
      o && (this.updateStep(o, { text: n.value }, { renderThread: !1 }), this.autoSize(n));
  ...
  renderTabs() {
    ...
    const t = this.stories.map((a, i) => {
      ...
      n.className = "wa-builder-tab", n.type = "button", n.dataset.builderStoryTab = String(i), n.classList.toggle("is-active", i === this.activeStoryIndex), n.setAttribute("aria-pressed", String(i === this.activeStoryIndex));
      const o = document.createElement("span");
      o.className = "wa-builder-tab__title", o.textContent = a.label;
      const s = document.createElement("span");
      return s.className = "wa-builder-tab__count", s.textContent = `${a.steps.length} messages`, n.append(o, s), n;
    });
  ...
  renderThread() {
    ...
    const t = this.activeStory, a = t.steps.map(
      (i, n) => this.createStepNode(i, n, t.steps.length, t.steps[n - 1]?.kind)
    );
  ...
  renderPanel() {
    ...
    if (t) {
      ...
      const n = document.createElement("span");
      n.className = "wa-builder-field__label", n.textContent = "Selected message";
  ...
  createStepNode(e, t, a, i) {
    ...
    n.className = "wa-builder-step", n.dataset.builderStep = e.id, n.dataset.builderKind = e.kind, n.draggable = !0, n.setAttribute("aria-grabbed", "false"), n.classList.toggle("is-selected", e.id === this.selectedStepId);
    const o = document.createElement("div");
    ...
    const l = document.createElement("div");
    return l.className = "wa-message__body wa-builder-message__body", l.dataset.messageBody = "", l.append(this.createStepBody(e, i === "thinking")), o.append(s, l), n.append(o, this.createStepToolbar(e, a)), n;
  }
  ...
  createThinkingBody(e, t = !1) {
    ...
    const n = document.createElement("span");
    n.className = "wa-thinking__glyph", n.dataset.logoRole = "shadow", n.setAttribute("aria-hidden", "true"), n.append(Ar("wa-thinking__logo-mark"));
    const o = document.createElement("span");
    ...
    }), i.append(n, o, s), t ? (a.dataset.thinkingHeaderSuppressed = "true", a.append(l)) : a.append(i, l), a;
  }
  createComponentBody(e) {
    if (e.component ??= rl(e.text), e.component.kind === "table") return this.createTableComponentBody(e, e.component);
    ...
    const n = this.createComponentField(e.id, "title", e.component.title, {
  ...
  createTableComponentBody(e, t) {
    ...
    const n = document.createElement("span");
    n.className = "wa-builder-step__kind", n.textContent = "Table";
    ...
    c.className = "wa-builder-table-editor__row", c.dataset.header = "true", t.columns.forEach((p, m) => {
      ...
      const g = document.createElement("div");
      g.className = "wa-builder-table-editor__row", t.columns.forEach((h, w) => {
        g.append(
          this.createComponentInput(e.id, "cell", p[w] ?? "", {
            rowIndex: m,
            columnIndex: w,
            className: "wa-builder-table-editor__cell"
          })
    ...
    }), i.append(n, o, s, l, d, u), a.append(i), a;
  }
  createStrategyComponentBody(e, t) {
    ...
    i.className = "wa-builder-component-card__content";
    const n = document.createElement("span");
    n.className = "wa-builder-step__kind", n.textContent = "Strategy cards";
    const o = this.createComponentField(e.id, "title", t.title, {
      className: "wa-builder-component-card__title"
  ...
  createEnrichmentComponentBody(e, t) {
    ...
    i.className = "wa-builder-component-card__content";
    const n = document.createElement("span");
    n.className = "wa-builder-step__kind", n.textContent = "Enrichment";
    const o = this.createComponentField(e.id, "title", t.title, {
      className: "wa-builder-component-card__title"
  ...
  createDataSourcesComponentBody(e, t) {
    ...
    i.className = "wa-builder-component-card__content";
    const n = document.createElement("span");
    n.className = "wa-builder-step__kind", n.textContent = "Data sources";
    const o = this.createComponentField(e.id, "title", t.title, {
      className: "wa-builder-component-card__title"
    }), s = this.createComponentField(e.id, "subtitle", t.subtitle, {
      className: "wa-builder-component-card__subtitle"
  ...
  createUploadedFilesComponentBody(e, t) {
    const a = this.createStructuredComponentCard("Files"), i = a.querySelector(".wa-builder-component-card__content"), n = this.createComponentField(e.id, "title", t.title, {
      className: "wa-builder-component-card__title"
    }), o = document.createElement("div");
  ...
  createMailboxConnectionComponentBody(e, t) {
    const a = this.createStructuredComponentCard("Mailbox connection"), i = a.querySelector(".wa-builder-component-card__content"), n = this.createComponentField(e.id, "title", t.title, {
      className: "wa-builder-component-card__title"
  ...
  createProximityListComponentBody(e, t) {
    const a = this.createStructuredComponentCard("Proximity list"), i = a.querySelector(".wa-builder-component-card__content"), n = this.createComponentField(e.id, "title", t.title, {
      className: "wa-builder-component-card__title"
    }), o = this.createComponentField(e.id, "subtitle", t.subtitle, {
      className: "wa-builder-component-card__subtitle"
    }), s = document.createElement("div");
  ...
  createPersonalizationSwipeComponentBody(e, t) {
    const a = this.createStructuredComponentCard("Personalization swipe game"), i = a.querySelector(".wa-builder-component-card__content"), n = this.createComponentField(e.id, "title", t.title, {
      className: "wa-builder-component-card__title"
    }), o = this.createComponentField(e.id, "subtitle", t.subtitle, {
      className: "wa-builder-component-card__subtitle"
  ...
  createSequenceEngagementComponentBody(e, t) {
    const a = this.createStructuredComponentCard("Sequence engagement"), i = a.querySelector(".wa-builder-component-card__content"), n = this.createComponentField(e.id, "title", t.title, {
      className: "wa-builder-component-card__title"
    }), o = this.createComponentField(e.id, "subtitle", t.subtitle, {
      className: "wa-builder-component-card__subtitle"
  ...
  createThinkingField(e, t, a, i) {
    ...
    return n.className = i.className, n.dataset.builderThinkingField = t, n.dataset.builderThinkingStep = e, n.value = a, n.rows = 1, n.spellcheck = !0, i.itemIndex !== void 0 && (n.dataset.builderThinkingItem = String(i.itemIndex)), n;
  }
  createThinkingInput(e, t, a, i) {
    const n = document.createElement("input");
    return n.className = i.className, n.dataset.builderThinkingField = t, n.dataset.builderThinkingStep = e, n.value = a, n.type = "text", n.spellcheck = !0, i.itemIndex !== void 0 && (n.dataset.builderThinkingItem = String(i.itemIndex)), n;
  }
  createComponentField(e, t, a, i) {
    const n = document.createElement("textarea");
    return n.className = i.className, n.dataset.builderComponentField = t, n.dataset.builderComponentStep = e, n.value = a, n.rows = 1, n.spellcheck = !0, this.applyComponentIndexes(n, i), n;
  }
  createComponentInput(e, t, a, i) {
    const n = document.createElement("input");
    return n.className = i.className, n.dataset.builderComponentField = t, n.dataset.builderComponentStep = e, n.value = a, n.type = "text", n.spellcheck = !0, this.applyComponentIndexes(n, i), n;
  }
  ...
  createDragHandle(e) {
    const t = document.createElement("button");
    return t.className = "wa-builder-step__action wa-builder-step__drag", t.type = "button", t.draggable = !0, t.dataset.builderDragHandle = e, t.setAttribute("aria-label", "Drag to reorder message"), t.append(wn("grip")), t;
  }
  createActionButton(e, t, a, i, n = !1) {
    const o = document.createElement("button");
    return o.className = "wa-builder-step__action", o.type = "button", o.dataset.builderAction = t, o.dataset.builderActionStep = e, o.disabled = n, o.setAttribute("aria-label", a), o.append(wn(i)), o;
  }
  createField(e, t, a, i) {
    ...
    return s.className = "wa-builder-field__control", s.dataset.builderPanelInput = a, s.value = i, s instanceof HTMLInputElement && (s.type = t === "color" ? "color" : "text"), s instanceof HTMLTextAreaElement && (s.rows = 2), n.append(o, s), n;
  }
  selectStory(e) {
  ...
  addStep(e) {
    const t = al(e, nl(e), ""), a = this.activeStory.steps, i = a.findIndex((o) => o.id === this.selectedStepId), n = i >= 0 ? i + 1 : a.length;
    a.splice(n, 0, t), this.selectedStepId = t.id, this.render(), this.emitChange(`Added ${lt[e]} message`);
  }
  updateStep(e, t, a = {}) {
    const i = this.activeStory.steps.find((n) => n.id === e);
    i && (Object.assign(i, t), i.kind === "thinking" && bl(i, t), this.renderExport(), this.emitChange("Draft updated", !1), a.renderThread !== !1 && (this.renderThread(), this.renderPanel()));
  }
  handleStepAction(e) {
    const t = e.dataset.builderAction, a = e.dataset.builderActionStep;
    if (!t || !a) return;
    const i = this.activeStory.steps, n = i.findIndex((o) => o.id === a);
    n < 0 || (t === "duplicate" && (i.splice(n + 1, 0, vl(i[n])), this.selectedStepId = i[n + 1]?.id ?? a), t === "delete" && i.length > 1 && (i.splice(n, 1), this.selectedStepId = i[Math.min(n, i.length - 1)]?.id ?? null), this.render(), this.emitChange("Draft updated"));
  }
  handleDragStart(e) {
    ...
    if (Ml(t) && !t?.closest("[data-builder-drag-handle]")) {
      e.preventDefault();
      return;
    }
  ...
  moveStep(e, t, a) {
    const i = this.activeStory.steps, n = i.findIndex((l) => l.id === e);
    if (n < 0) return;
    const [o] = i.splice(n, 1);
  ...
  handleThinkingInput(e) {
    const t = e.dataset.builderThinkingStep, a = e.dataset.builderThinkingField, i = rt(e.dataset.builderThinkingItem), n = t ? this.activeStory.steps.find((o) => o.id === t) : null;
    !n || !a || (n.thinking ??= Rt(n.text, n.note), fl(n.thinking, a, e.value, i), wl(n), this.selectedStepId === n.id && (this.syncPanelStepText(n.text), this.syncPanelStepNote(n.note)), this.renderExport(), this.emitChange("Thinking updated", !1));
  }
  handleComponentInput(e) {
    const t = e.dataset.builderComponentStep, a = e.dataset.builderComponentField, i = t ? this.activeStory.steps.find((n) => n.id === t) : null;
    !i?.component || !a || (_l(i.component, a, e.value, {
    ...
    }), i.text = xl(i.component), this.selectedStepId === i.id && this.syncPanelStepText(i.text), this.renderExport(), this.emitChange("Component updated", !1));
  }
  handlePanelInput(e) {
  ...
  handlePanelSelect(e) {
    e.dataset.builderPanelSelect !== "step-kind" || !this.selectedStep || !gi(e.value) || this.updateStep(this.selectedStep.id, { kind: e.value });
  }
  setStatus(e) {
    const t = this.refs;
  ...
  syncThreadThinking(e) {
    ...
    !t || !e.thinking || t.thread.querySelectorAll(
      ...
      const i = a.dataset.builderThinkingField, n = rt(a.dataset.builderThinkingItem), o = yl(e.thinking, i, n);
  ...
  async loadRemoteDraft() {
    if (this.draftEndpoint) {
      ...
      try {
        ...
        const t = await e.json(), a = Pr(t), i = a?.stories;
        if (!a || !i?.length)
          throw new Error("draft payload did not include stories");
        this.stories = a.schemaVersion === yt ? i : gn(this.sourceStories), this.activeStoryIndex = Math.min(this.activeStoryIndex, Math.max(0, this.stories.length - 1)), this.selectedStepId = this.activeStory.steps[0]?.id ?? null, this.render(), this.setStatus(a.schemaVersion === yt ? "draft loaded" : "draft upgraded"), this.options.onStoriesChange?.(this.stories, { source: "load" }), a.schemaVersion !== yt && this.queueRemoteSave();
      } catch {
...
function tl(r, e) {
  return ({
    ...
    "data-marketplace": [
      ...
      nt(["Searching hiring signals, headcount, and company data"]),
      {
        kind: "component",
        text: "Table: New hires at dev-tool companies",
        note: "No chrome around the table.",
        component: fn("New hires at dev-tool companies", [
    ...
    "crm-update": [
      ...
      nt(["Scoring shared schools, fields of study, mutual contacts, and warm signals"]),
      {
        kind: "component",
    ...
    "research-brief": [
      { kind: "user", text: "Show me 50 sales leaders that have recently visited my website.", note: "" },
      {
        ...
        component: ol("Recent website visitors", [
  ...
  }[r] ?? [{ kind: "assistant", text: e, note: "" }]).map((i, n) => ({
    ...i,
    id: `${r}-step-${n + 1}`
  }));
}
function al(r, e, t) {
  ...
  return r === "thinking" && (a.thinking = Rt(e, t)), a;
}
function Rt(r, e = "") {
  const t = kr([r || "Thinking"]).map((a, i) => ({
    label: a.label,
...
function fl(r, e, t, a) {
  if (e === "title" && (r.title = t), e === "elapsed" && (r.elapsed = t), a === null) return;
  const i = r.items[a];
  i && (e === "label" && (i.label = t), e === "detail" && (i.detail = t), e === "disclosure" && (i.disclosure = t));
}
function wl(r) {
  if (!r.thinking) return;
  const e = r.thinking.items[0];
  r.text = e?.label ?? "", r.note = e?.detail ?? "";
}
function bl(r, e) {
  r.kind === "thinking" && (r.thinking ??= Rt(r.text, r.note), r.thinking.items[0] ??= {
    label: r.text,
    detail: r.note || Lt(r.text, 0),
    disclosure: Xe
  }, e.text !== void 0 && (r.thinking.items[0].label = e.text), e.note !== void 0 && (r.thinking.items[0].detail = e.note));
}
function yl(r, e, t) {
  if (e === "title") return r.title;
  if (e === "elapsed") return r.elapsed;
  if (t === null) return null;
  const a = r.items[t];
  return a ? e === "label" ? a.label : e === "detail" ? a.detail : e === "disclosure" ? a.disclosure : null : null;
}
function _l(r, e, t, a) {
  if (e === "title" && (r.title = t), r.kind === "generic" && e === "item" && a.itemIndex !== null && (r.items[a.itemIndex] = t), r.kind === "dataSources" && (e === "subtitle" && (r.subtitle = t), a.itemIndex !== null)) {
    const i = r.sources[a.itemIndex];
    if (!i) return;
    e === "sourceCategory" && (i.category = t), e === "sourceName" && (i.name = t), e === "sourceDetail" && (i.detail = t);
  }
  if (r.kind === "uploadedFiles" && a.itemIndex !== null) {
    const i = r.files[a.itemIndex];
    if (!i) return;
    e === "fileType" && (i.type = t), e === "fileName" && (i.name = t), e === "fileDetail" && (i.detail = t);
  }
  if (r.kind === "mailboxConnection" && (e === "subtitle" && (r.subtitle = t), e === "mailboxProvider" && (r.provider = t), e === "mailboxAccount" && (r.account = t), e === "mailboxStatus" && (r.status = t), e === "mailboxCtaLabel" && (r.ctaLabel = t), e === "mailboxSecondaryCtaLabel" && (r.secondaryCtaLabel = t), e === "mailboxLoadingLabel" && (r.loadingLabel = t), e === "mailboxLearningTitle" && (r.learningTitle = t), e === "mailboxLearningDetail" && (r.learningDetail = t), e === "mailboxLearningReadyDetail" && (r.learningReadyDetail = t), e === "mailboxSignal" && a.itemIndex !== null && (r.signals[a.itemIndex] = t)), r.kind === "styleProfile" && (e === "subtitle" && (r.subtitle = t), a.itemIndex !== null)) {
    const i = r.signals[a.itemIndex];
    i && (e === "signalLabel" && (i.label = t), e === "signalValue" && (i.value = t)), e === "styleExample" && (r.examples[a.itemIndex] = t);
  }
  if (r.kind === "proximityList" && (e === "subtitle" && (r.subtitle = t), a.itemIndex !== null)) {
    const i = r.leads[a.itemIndex];
    if (!i) return;
  ...
  if (r.kind === "personalizationSwipeGame" && (e === "subtitle" && (r.subtitle = t), e === "prompt" && (r.prompt = t), a.itemIndex !== null)) {
    const i = r.signals[a.itemIndex];
    if (!i) return;
    e === "swipeDecision" && (i.decision = t === "avoid" ? "avoid" : "use"), e === "swipeLabel" && (i.label = t), e === "swipeDetail" && (i.detail = t);
  }
  if (r.kind === "sequenceEngagement" && (e === "subtitle" && (r.subtitle = t), e === "peopleCount" && (r.peopleCount = t), e === "launchLabel" && (r.launchLabel = t), a.itemIndex !== null)) {
    const i = r.sequences[a.itemIndex];
    if (i) {
    ...
    const n = r.channels[a.itemIndex];
    n && (e === "channelLabel" && (n.label = t), e === "channelDetail" && (n.detail = t), e === "channelBadge" && (n.badge = t));
  }
  if (r.kind === "table" && (e === "eyebrow" && (r.eyebrow = t), e === "count" && (r.count = t), e === "column" && a.columnIndex !== null && (r.columns[a.columnIndex] = t), e === "cell" && a.rowIndex !== null && a.columnIndex !== null && (r.rows[a.rowIndex] ??= [], r.rows[a.rowIndex][a.columnIndex] = t), a.itemIndex !== null)) {
    const i = r.actions?.[a.itemIndex];
    i && (e === "actionLabel" && (i.label = t), e === "actionTooltip" && (i.tooltip = t), e === "actionBadge" && (i.badge = t)), e === "pageRange" && r.pagination && (r.pagination.ranges[a.itemIndex] = t);
  }
  if (r.kind === "strategyCards" && a.cardIndex !== null) {
    const i = r.cards[a.cardIndex];
    if (!i) return;
    e === "cardLabel" && (i.label = t), e === "cardTitle" && (i.title = t), e === "cardSummary" && (i.summary = t);
  }
  if (r.kind === "enrichment") {
    if (e === "subtitle" && (r.subtitle = t), e === "fieldTitle" && a.fieldIndex !== null) {
      const i = r.fields[a.fieldIndex];
      i && (i.title = t);
    }
...
function xl(r) {
  return r.kind === "table" ? `Table: ${r.title}` : (r.kind === "strategyCards" || r.kind === "enrichment" || r.kind === "dataSources" || r.kind === "uploadedFiles" || r.kind === "mailboxConnection" || r.kind === "styleProfile" || r.kind === "proximityList" || r.kind === "personalizationSwipeGame" || r.kind === "sequenceEngagement", r.title);
}
function vl(r) {
  return {
    ...r,
    id: Rr("step"),
    component: r.component ? kl(r.component) : void 0
  };
}
function kl(r) {
  return Ir(r);
...
function Pr(r) {
  if (!gt(r) || !Array.isArray(r.stories)) return null;
  const e = typeof r.schemaVersion == "number" ? r.schemaVersion : 1, t = r.stories.map((a) => Cl(a)).filter((a) => !!a);
...
function Cl(r) {
  if (!gt(r) || !Array.isArray(r.steps)) return null;
  const e = ve(r.id), t = ve(r.label), a = ve(r.summary), i = r.steps.map((n) => Al(n)).filter((n) => !!n);
...
function Al(r) {
  if (!gt(r)) return null;
  const e = ve(r.id), t = ve(r.kind), a = ve(r.text), i = ve(r.note);
  return !e || !t || !gi(t) ? null : {
    id: e,
    kind: t,
    text: a ?? "",
    note: i ?? "",
    thinking: gt(r.thinking) ? Tl(r.thinking, a ?? "", i ?? "") : t === "thinking" ? Rt(a ?? "", i ?? "") : void 0,
    component: gt(r.component) ? Ir(r.component) : void 0
  };
}
function Ir(r) {
...
function Tl(r, e, t) {
  const i = (Array.isArray(r.items) ? r.items : []).map((n, o) => El(n, o)).filter((n) => !!n);
  return i.length ? {
    title: ve(r.title) ?? Ae,
    elapsed: ve(r.elapsed) ?? ia(i.length),
    items: i
  } : Rt(e, t);
}
function El(r, e) {
  ...
  return t ? {
    label: t,
    detail: ve(r.detail) ?? Lt(t, e),
    disclosure: ve(r.disclosure) ?? (e === 0 ? Xe : mt)
  } : null;
}
function gt(r) {
...
function Rr(r) {
  return typeof crypto < "u" && "randomUUID" in crypto ? `${r}-${crypto.randomUUID()}` : `${r}-${Date.now().toString(36)}-${Math.random().toString(36).slice(2, 8)}`;
}
function Ja(r, e) {
  return r instanceof Element ? r.closest(e) : null;
}
function Ml(r) {
  return !!r?.closest("textarea, input, select, button, [contenteditable='true']");
}
function gi(r) {
  return r in lt;
}
function Pl() {
  const r = Il();
  return r ? { "x-story-draft-token": r } : {};
}
function Il() {
  try {
...
function wn(r) {
  const e = document.createElementNS("http://www.w3.org/2000/svg", "svg");
  if (e.setAttribute("viewBox", "0 0 20 20"), e.setAttribute("aria-hidden", "true"), e.setAttribute("focusable", "false"), r === "copy" && bn(e, "M7 7.5h8v8H7z M5 13H4.5a1 1 0 0 1-1-1V4.5a1 1 0 0 1 1-1H12a1 1 0 0 1 1 1V5"), r === "x" && bn(e, "M5.5 5.5l9 9 M14.5 5.5l-9 9"), r === "grip")
    for (const t of [7, 13])
...
function bn(r, e) {
  ...
  t.setAttribute("d", e), t.setAttribute("fill", "none"), t.setAttribute("stroke", "currentColor"), t.setAttribute("stroke-width", "1.7"), t.setAttribute("stroke-linecap", "round"), t.setAttribute("stroke-linejoin", "round"), r.append(t);
}
const M = {
  typeShort: 0.92,
  typeMedium: 1.16,
...
function N(r, e, t = {}, a = !0) {
  return {
    desktop: { target: r, anchor: e, offset: Ka(t.desktop), humanOffset: a },
    tablet: { target: r, anchor: e, offset: Ka(t.tablet), humanOffset: a },
    mobile: { target: r, anchor: e, offset: Ka(t.mobile), humanOffset: a }
  };
}
const va = {
...
}, Lr = N("[data-signup-field]", "center", {
  desktop: -74,
  tablet: -66,
  mobile: -48
}), Dr = N("[data-signup-submit]", "center"), Rl = N("[data-send-button]", "center"), qi = {
  desktop: {
...
}, Ll = 2.8, Dl = 42, Nl = 2, ql = 3, ka = "[data-chat-shell] [data-chat-thread]", Ol = `${ka} [data-message-role="assistant"]:not(.wa-message--component) [data-message-body]`, Bl = `${ka} [data-message-role="assistant"].wa-message--thinking .wa-research-step[data-step-state="current"] .wa-research-step__body, ${ka} [data-message-role="assistant"].wa-message--thinking .wa-research-step[data-step-state="complete"] .wa-research-step__label`, fi = 0.24, Nr = 0.3, qe = {
...
function zl(r, e, t, a, i) {
  switch (t.kind) {
    ...
    case "transitionSignupToChat":
      ...
      return;
    case "assistant":
      r.add(e.chat.assistantMessage(t.text), t.at), Wl(r, e, i, {
        kind: "assistant",
        key: t.text,
        text: t.text,
        selector: Ol,
        label: `assistant-${wi(t.text)}`,
        stepIndex: a
      });
      return;
    case "thinking": {
      const n = Fl(t), o = n.items.map((s) => s.label);
    ...
    case "dataTable":
      zt(
        ...
        t.at,
        _t(`[data-data-table="${Ne(t.config.id)}"]`),
        `table-${t.config.id}`
      );
      return;
    case "enrichmentPanel":
      zt(
        ...
        t.at,
        _t(`[data-enrichment-panel="${Ne(t.config.id)}"]`),
    ...
    case "strategyPlans":
      {
        ...
        r.add(e.chat.strategyPlans(t.plans), t.at), r.add(Ul(e, n, t.plans), "+=0.06");
      }
      return;
    case "dataSourcesGrid":
      zt(
        ...
        t.at,
        _t(`[data-data-sources-grid="${Ne(t.config.id)}"]`),
        `sources-${t.config.id}`
      );
      return;
    case "marketingDataSourcesGrid":
      zt(
        ...
        t.at,
        `[data-marketing-data-sources-grid="${Ne(t.config.id)}"]`,
        `marketing-sources-${t.config.id}`
      );
      return;
    case "personalizationSwipeGame":
      Hl(r, e, t.config, t.at);
      return;
    case "sequenceEngagement":
      zt(
        ...
        t.at,
        _t(`[data-sequence-engagement="${Ne(t.config.id)}"]`),
...
function Fl(r) {
  return "thinking" in r && r.thinking ? r.thinking : Array.isArray(r.steps) ? { items: r.steps.map(yn) } : { items: [yn(r.label ?? "")] };
}
function yn(r) {
  return typeof r == "string" ? { label: r } : r;
}
function zt(r, e, t, a, i, n) {
  r.add(t, a), r.add(Gl(e, i, n), "+=0.06");
}
function Hl(r, e, t, a) {
  const i = _t(
    `[data-personalization-swipe-game="${Ne(t.id)}"]`
  );
  r.add(e.chat.personalizationSwipeGame(t), a), t.signals.forEach((n, o) => {
    const s = `${i} [data-swipe-card="${Ne(n.id)}"]`, l = n.decision === "use" ? 1 : -1, d = n.decision === "use" ? "right" : "left", c = N(s, d, {
...
function Vl(r, e, t, a = M.thinkingShort, i = 1, n = "thinking", o = 0) {
  const s = a * Math.max(1, i), l = i >= 3 && qr(e, t, {
    kind: "thinking",
    key: n,
    text: n,
    stepIndex: o,
  ...
  l && r.add(
    e.cursor.scanAcross(Bl, {
      label: `thinking-skim-${wi(n)}`,
      match: "last",
      duration: 0.72
    }),
    "<+=0.58"
...
function qr(r, e, t) {
  const a = t.text.trim(), i = t.minChars ?? Dl;
  if (a.length < i || e.textSkimCount >= ql) return !1;
  const n = e.textCandidateCount;
  e.textCandidateCount += 1;
  const o = e.textSkimCount === 0, s = t.stepIndex - e.lastTextSkimStep >= Nl, l = Yl(`${r.story.id}:${t.kind}:${n}:${t.key}`), d = n > 0 && n % 3 === 0, c = o || s && (l >= 0.58 || d);
...
function Zl(r, e) {
  return r === "hit-ground-running" ? Lr : r === "data-marketplace" ? va.dataMarketplace : r === "research-brief" ? va.researchBrief : e.entry;
}
function Ql(r, e) {
  return r === "hit-ground-running" ? Nr : r === "data-marketplace" || r === "research-brief" ? fi : e.entryLeadTime;
}
function ed(r, e, t) {
  if (e.id === "hit-ground-running") return td(r, e);
  if (e.id === "crm-update") return ad(r, e);
  if (e.id === "research-brief") return id(r, e);
  if (e.id === "csv-import-cleanup") return nd(r, e);
  const a = ld(e);
  return a.length ? Ee(r, [...a, je(qe.bottomRight, "+=0.18")]) : t.build(r);
}
function td(r, e) {
  const t = Oe(e, "status"), a = Oe(e, "user"), i = Oe(e, "thinking"), n = Oe(e, "assistant"), o = ta(e, "strategyCards");
  return Ee(r, [
    ...
    ...o ? [{ kind: "strategyPlans", plans: Br(o.component), at: "-=0.08" }] : [],
    je(qe.right, "+=0.18")
  ]);
}
function ad(r, e) {
  const t = ta(e, "mailboxConnection"), a = ta(e, "uploadedFiles"), i = [];
  if (t && Hr(i, Fr(t.component)), a) {
    const n = zr(a.component), o = r.chat.prepareCsvDropArea({
      title: a.component.title,
      detail: n.map((c) => c.name).join(", ")
    }), s = n.length > 1 ? `${n.length} context files` : n[0]?.name ?? a.text, l = r.chat.prepareCursorFile(s, r.cursor, n[0]?.type ?? "DOC", n), d = N("[data-chat-shell]", "center", {
      desktop: { x: 0, y: 74 },
      tablet: { x: 0, y: 64 },
      mobile: { x: 0, y: 56 }
    });
  ...
  for (const n of e.steps)
    n === t || n === a || Or(i, e.id, n);
  return i.push(je(qe.bottomRight, "+=0.16")), Ee(r, i);
}
function id(r, e) {
  const t = Oe(e, "user"), a = ta(e, "table"), i = Oe(e, "thinking"), n = ta(e, "sequenceEngagement"), o = a ? Sa(a.component, "website-visitors-sales") : null, s = n ? Gr(n.component, "visitor-outreach-sequences") : null, l = [];
  if (t && l.push({
    kind: "prompt",
    text: t.text,
    duration: Ur(t.text),
  ...
  if (i && l.push(Pa(i, { hold: M.thinkingMedium, at: "+=0.06" })), s) {
    ...
    l.push(
      ...
      { kind: "cursorClick", at: "-=0.02" },
      { kind: "custom", build: () => r.chat.sequencePerson("visitor-outreach-sequences", 1), at: "-=0.03" },
      { kind: "custom", build: () => r.timeline().to({}, { duration: M.beat + 0.24 }), at: "+=0.04" },
      {
        kind: "cursorMove",
        target: c,
      ...
      { kind: "cursorClick", at: "-=0.02" },
      { kind: "custom", build: () => r.chat.sequencePerson("visitor-outreach-sequences", 2), at: "-=0.03" },
...
function nd(r, e) {
  const t = Oe(e, "file"), a = Oe(e, "thinking"), i = Oe(e, "assistant"), n = e.steps.filter(
    (g) => g.kind === "component" && g.component?.kind === "table"
  ), o = a ? e.steps.indexOf(a) : -1, s = n.find((g) => o >= 0 && e.steps.indexOf(g) < o), l = [...n].reverse().find((g) => g !== s), d = t?.text || "may_webinar_attendees.csv", c = rd(t, s?.component ?? l?.component), u = r.chat.prepareCsvDropArea(), p = r.chat.prepareCursorFile(d, r.cursor), m = N("[data-chat-shell]", "center", {
    desktop: { x: 0, y: 82 },
    tablet: { x: 0, y: 72 },
    mobile: { x: 0, y: 64 }
  });
  return Ee(r, [
    ...
    { kind: "custom", build: () => p.startFollow(), at: "+=0.04" },
    ...
    { kind: "custom", build: () => u.complete(), at: "-=0.24" },
    { kind: "custom", build: () => p.landAsUploadedFile(d, c), at: "<" },
    ...s ? [{ kind: "dataTable", config: Sa(s.component, "raw-webinar-attendees"), at: "+=0.08" }] : [],
    { kind: "status", text: "Cleaning CSV", at: "<" },
    ...a ? [Pa(a, { hold: 0.34, at: `+=${M.beat}` })] : [],
    ...i ? [{ kind: "assistant", text: i.text }] : [],
    ...l ? [{ kind: "dataTable", config: hd(Sa(l.component, "cleaned-webinar-attendees")), at: "-=0.04" }] : [],
    je(qe.bottomRight, "+=0.18")
  ]);
}
function rd(r, e) {
  const t = od(e);
...
function ld(r) {
  const e = [], t = r.id === "data-marketplace" ? dd(r.steps) : r.steps;
  let a = 0;
  for (const i of t)
    a += i.kind === "user" ? 1 : 0, Or(e, r.id, i, a === 1);
  return e;
}
function dd(r) {
  const e = [];
...
function Or(r, e, t, a = !1) {
  ...
  t.kind !== "component" || !t.component || ud(r, e, t);
}
function ud(r, e, t) {
  const a = t.component;
  if (a.kind === "table") {
    const i = Sa(a, `${e}-${t.id}`);
    gd(e, t, i) && (i.scrollAlign = "equal-inset"), r.push({ kind: "dataTable", config: i, at: "-=0.04" });
    return;
  }
  if (a.kind === "strategyCards") {
    r.push({ kind: "strategyPlans", plans: Br(a), at: "-=0.04" });
    return;
  }
  if (a.kind === "enrichment") {
    r.push({ kind: "enrichmentPanel", config: vd(a), at: "+=0.12" });
    return;
  }
  ...
  if (a.kind === "uploadedFiles") {
    r.push({ kind: "custom", build: (i) => i.chat.uploadedFilesMessage(zr(a)), at: "-=0.04" });
    return;
  }
  ...
  if (a.kind === "styleProfile") {
    r.push({ kind: "custom", build: (i) => i.chat.outreachStyleProfile(Sd(a)), at: "-=0.02" });
    return;
  }
  if (a.kind === "proximityList") {
    r.push({ kind: "custom", build: (i) => i.chat.proximityLeadList(Cd(a)), at: "-=0.04" });
    return;
  }
  if (a.kind === "personalizationSwipeGame") {
    r.push({ kind: "personalizationSwipeGame", config: Ad(a), at: "+=0.06" });
    return;
  }
  if (a.kind === "sequenceEngagement") {
    r.push({ kind: "sequenceEngagement", config: Gr(a, `${e}-${t.id}`), at: "-=0.02" });
    return;
  }
...
function Pa(r, e = {}) {
  return {
    kind: "thinking",
    thinking: pd(r.thinking, r.text, r.note),
    hold: e.hold,
    at: e.at
  };
}
...
function Sa(r, e) {
  const t = fd(r.columns), a = r.rows.filter((o) => o.some((s) => s.trim())).map((o, s) => bd(o, t, s)), i = r.pagination?.pageSize ?? md(r.pagination?.ranges) ?? Math.min(10, a.length || 10), n = r.pagination?.ranges.map((o, s) => ({
    page: s + 1,
    range: o,
  ...
  return {
    ...
    eyebrow: r.eyebrow,
    count: r.count,
    variant: t.variant ?? Td(r),
    columns: t.columns,
    rows: n[0]?.rows ?? a,
    actions: r.actions?.map(xd),
    pagination: n.length > 1 ? {
      pageSize: i,
      totalRows: Ed(r, a.length),
      activePage: 1,
      pages: n
    } : void 0
  };
...
function bd(r, e, t) {
  ...
  if (e.columns.forEach((i, n) => {
    ...
    const i = _d(a[e.mutualConnectionKey] ?? ""), n = yd(t);
...
const Md = [
  ...
  pagination: {
    ...
    pages: [
      ...
      { page: 2, range: "11-20 of 50 people", rows: Gd }
    ]
  },
  actions: [
    {
  ...
  pagination: {
    ...
    activePage: 1,
    pages: [
      { page: 1, range: "1-6 of 54 records", rows: Za.slice(0, 6) },
      { page: 2, range: "7-12 of 54 records", rows: Za.slice(6, 12) }
    ]
  }
}, Wd = {
...
}, Wr = [
  {
    ...
    build: (r) => Ee(r, [
      ...
      { kind: "thinking", steps: Md, hold: 0.46, at: "<" },
  ...
  },
  {
    ...
    build: (r) => Ee(r, [
      ...
      { kind: "dataTable", config: Rd, at: "-=0.04" },
      {
        kind: "prompt",
      ...
      { kind: "enrichmentPanel", config: Dd, at: "+=0.12" },
      { kind: "status", text: "Contacts enriched", at: "+=0.86" },
      { kind: "dataTable", config: qd, at: "-=0.02" },
      { kind: "marketingDataSourcesGrid", config: Nd, at: "+=0.44" },
      je(qe.bottomRight, "+=3")
    ])
  },
  {
    ...
    build: (r) => {
      ...
      }), t = r.chat.prepareCursorFile("4 context files", r.cursor, "DOC", _n), a = N(
      ...
      return Ee(r, [
        { kind: "status", text: "connect mailbox" },
        { kind: "custom", build: () => r.chat.mailboxConnection(bt), at: "+=0.04" },
        {
          kind: "custom",
          build: () => r.cursor.scanAcross(`[data-mailbox-connection="${bt.id}"]`, {
        ...
        { kind: "cursorClick", at: "-=0.02" },
        { kind: "custom", build: () => r.chat.connectMailbox(bt.id), at: "<+=0.08" },
        ...
        { kind: "custom", build: () => t.landAsUploadedFiles(_n), at: "<" },
        ...
        { kind: "custom", build: () => r.chat.outreachStyleProfile(Od), at: "-=0.02" },
        {
          kind: "prompt",
        ...
        { kind: "custom", build: () => r.chat.proximityLeadList(Bd), at: "-=0.04" },
        je(qe.bottomRight, "+=0.16")
      ]);
    }
  },
  {
    ...
    build: (r) => {
      ...
      return Ee(r, [
        ...
        { kind: "custom", build: () => r.chat.dataTableActionTooltip("website-visitors-sales", "email-sequence", !1), at: "<+=0.02" },
        { kind: "status", text: "building outreach sequence", at: "<" },
        { kind: "custom", build: () => r.chat.sequenceBuildThinking(Fd), at: "+=0.06" },
        { kind: "sequenceEngagement", config: zd, at: "-=0.02" },
        { kind: "custom", build: () => r.timeline().to({}, { duration: M.beat + 0.24 }), at: "+=0.04" },
        {
          kind: "cursorMove",
          target: i,
...
class jd {
  ...
  followPointer = () => {
    ...
    if (this.mode === "play") {
      ...
      this.updatePlayTarget(e), this.target && this.cursor.mimicViewportPoint(this.target, He.smoothing, this.pointer), this.scheduleFollow();
      return;
    }
    if (this.mode === "return") {
      const t = this.getReturnHomePoint(), a = Yd((e - this.returnStartedAt) / Qa.durationMs), i = this.getReturnWavePoint(a, t), n = this.getReturnWavePoint(Math.min(1, a + 0.035), t);
      if (this.target = t, this.cursor.mimicViewportPoint(i, 1, a < 1 ? n : t), a >= 1 || Ge(this.getCursorViewportPoint(), t) <= Qa.arriveDistance) {
  ...
  updateFollowTarget(e) {
    ...
    if (this.lastPointer) {
      ...
      i > 1.5 && (this.trailDirection = {
        x: a.x / i,
        y: a.y / i
      }, this.velocity = Zd(a, K.maxMomentumStep));
    }
    const t = {
      x: e.x - this.trailDirection.x * K.trailDistance,
      y: e.y - this.trailDirection.y * K.trailDistance
    };
    Ge(e, t) < K.minPointerDistance && (t.x = e.x - this.trailDirection.x * K.minPointerDistance, t.y = e.y - this.trailDirection.y * K.minPointerDistance), this.target = t, this.pointer = e, this.lastPointer = e;
  }
  startPlayfulIdle(e) {
  ...
  updatePlayTarget(e) {
    ...
    const t = e - this.playStartedAt, a = this.playPhase + t / He.orbitMs * Math.PI * 2, i = Math.sin(t / He.bobMs * Math.PI * 2), n = {
      x: this.pointer.x + Math.cos(a) * He.radiusX,
      y: this.pointer.y + Math.sin(a * 1.28) * He.radiusY + i * He.bobY
    };
    this.target = Xd(n, this.pointer, He.minPointerDistance, He.viewportInset);
  }
  resumeFollowing(e) {
  ...
  getReturnWavePoint(e, t) {
    const a = this.returnStart ?? this.getCursorViewportPoint(), i = $d(e), n = t.x - a.x, o = t.y - a.y, s = Math.hypot(n, o), l = {
      x: a.x + n * i,
      y: a.y + o * i
    };
    if (s < 1) return l;
    const d = Math.sin(Math.PI * e), c = Math.sin(Math.PI * 2 * e) * d * Qa.amplitude * this.returnWaveDirection;
    return {
      x: l.x - o / s * c,
      y: l.y + n / s * c
    };
  ...
  isCursorTooFarFromBrowser() {
    ...
    return Kd(i, e) > K.maxBrowserDistance;
  }
  getChatShell() {
    return this.chatShell?.isConnected ? this.chatShell : (this.chatShell = this.root.querySelector("[data-chat-shell]"), this.chatShell);
  }
  isPointNearStoryCursor(e, t = la.radius) {
  ...
  pruneSamples(e) {
    this.pruneSampleList(this.samples, e, la.sampleWindowMs);
  }
  ...
  hasMimicGesture() {
    return this.samples.length < 4 ? !1 : this.samples.reduce((t, a, i) => {
      ...
      return n ? t + Ge(a, n) : t;
    }, 0) >= la.minTravel && this.countAxisReversals(this.samples) >= la.minAxisReversals;
  }
  hasDismissShake() {
  ...
  isDismissShakeWindow(e) {
    const t = e[0], a = e[e.length - 1], i = Math.max(1, a.time - t.time), n = e.reduce((l, d, c) => {
      const u = e[c - 1];
      return u ? l + Ge(d, u) : l;
  ...
  countAxisReversals(e) {
    ...
    for (let n = 1; n < e.length; n += 1) {
      const o = e[n - 1], s = e[n], l = Sn(s.x - o.x), d = Sn(s.y - o.y);
...
function kn(r, e) {
  return {
    x: vn(r.x, e, window.innerWidth - e),
    y: vn(r.y, e, window.innerHeight - e)
  };
}
function Xd(r, e, t, a) {
  const i = kn(Jd(r, e, t), a);
...
class Qd {
  constructor(e, t, a, i, n, o) {
    this.root = e, this.stories = t, this.resolver = a, this.cursor = i, this.chat = n, this.options = o, this.storyProgress = this.stories.map(() => 0), this.pausedCursorMimic = new jd(this.root, this.cursor, {
  ...
  updateStories(e, t = {}) {
    if (!e.length) return;
    const a = this.stories[this.activeIndex]?.id, i = this.stories, n = new Map(this.stories.map((d, c) => [d.id, this.storyProgress[c] ?? 0])), o = this.cursor.getPosition(), s = this.playing, l = ec(i, e);
    if (this.stories = e, this.storyProgress = this.stories.map((d) => n.get(d.id) ?? 0), this.activeIndex = Math.max(0, this.resolveStoryIndex(a ?? this.stories[0].id)), l && this.renderStoryTabs(), t.restartActive) {
  ...
  seekTo(e, t = 0.28) {
    ...
    const i = ca(e), n = this.activeTimeline.duration();
  ...
  setActiveTimelineProgress(e) {
    this.activeTimeline && (this.activeTimeline.progress(ca(e)).pause(), this.updateProgress());
  }
  ...
  getMarkerProgress(e, t, a = null) {
    if (a?.marker === e && a.trackHeight > 0)
      return ca((t - a.trackTop) / a.trackHeight);
    const i = e.getBoundingClientRect();
    return i.height <= 0 ? 0 : ca((t - i.top) / i.height);
  }
  attachChatHistoryScroll() {
    ...
    const a = (i) => {
      ...
      if (Math.abs(n) < Cn.minPixelDelta) return;
      const o = this.getThreadMaxScroll(t);
      if (o <= 0 || !(n < 0 || this.historyPaused)) return;
      const l = jr(t.scrollTop + n, 0, o);
      if (!(Math.abs(l - t.scrollTop) >= 0.5)) return;
      const c = Math.max(0, n - (o - t.scrollTop));
      i.preventDefault(), this.pauseForChatHistory(), t.scrollTop = l, c >= Cn.minPixelDelta && window.scrollBy({ top: c, left: 0, behavior: "auto" });
    };
...
const ua = ["mobile", "tablet", "desktop", "wide"];
class tc {
  constructor(e) {
    this.root = e;
  }
  ...
  resolve(e, t = "target") {
    ...
    if (s = {
      ...
      const l = Er(t), d = Math.min(o.width * 0.18, 18), c = Math.min(o.height * 0.18, 14);
  ...
  pickTarget(e) {
    if (this.isBreakpointMap(e)) {
      const t = this.getBreakpoint(), a = ua.indexOf(t), i = [
        t,
        ...ua.slice(0, a).reverse(),
        ...ua.slice(a + 1)
      ];
      for (const n of i)
        if (e[n]) return e[n];
...
function ac(r, e = {}) {
  if (r.classList.add("wa-section"), r.querySelector("[data-chat-shell]")) return;
          ...
          <div class="wa-chat-shell" data-chat-shell>
            ...
            <div class="wa-chat-shell__body">
              <div class="wa-signup-scene" data-signup-scene>
                <span class="wa-signup-scene__logo" data-signup-logo-target aria-hidden="true">${Cr}</span>
...
function ic(r, e = {}) {
  ac(r, { showBuilder: e.showBuilder !== !1 });
  const t = e.stories?.length ? e.stories : Wr, a = e.builderDraftEndpoint ?? "/api/story-draft", i = e.reducedMotion ?? window.matchMedia?.("(prefers-reduced-motion: reduce)").matches ?? !1, n = new tc(r), o = new zs(r), s = new $s(r, n, { reducedMotion: i }), l = new Qd(r, t, n, s, o, {
    ...
    l.updateStories(Jl(p, t), {
      restartActive: m.source === "load"
    });
  }, c = l.destroy.bind(l), u = e.showBuilder === !1 ? null : new el(r, t, {
    onStorySelect: (p) => l.goTo(p),
    onStoriesChange: d,
    draftEndpoint: a,
    draftAutoSave: e.builderDraftAutoSave
  });
  return l.mount(), u?.mount(), !u && a && nc(a, d), {
    play: l.play.bind(l),
...
function $r(r = "[data-chatbot-stories]", e = {}) {
  return e.injectStyles !== !1 && Yr(), ic(rc(r), e);
}
const oc = {
  init: $r,
  defaultStories: Wr
...
if (typeof window < "u") {
  ...
  const r = () => {
    document.querySelector("[data-chatbot-stories][data-auto-init]") && Yr(), document.querySelectorAll("[data-chatbot-stories][data-auto-init]").forEach((e) => {
      e.dataset.chatbotStoriesMounted || (e.dataset.chatbotStoriesMounted = "true", $r(e));
    });
  };
  document.readyState === "loading" ? document.addEventListener("DOMContentLoaded", r, { once: !0 }) : r();
}
export {
  Wr as defaultStories,
  $r as init
};
