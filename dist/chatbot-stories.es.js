...
const Ml = [
...
], Pl = 1.28, S = (o) => Number((o * Pl).toFixed(3)), Rl = [3, 3, 3], Dl = {
  ...
  contentWidth: 1881,
  height: 1280
}, Wl = 96, Tn = ".wa-cursor-file, .wa-file-landing-clone, .wa-file-landing-label, .wa-csv-drop, .wa-signup-logo-transfer", En = "[data-marketing-data-sources-grid]", Mn = "[data-data-table]", Ot = "[data-table-action]", Za = "[data-table-page-button]", $a = "[data-table-page-range]", Pn = "[data-sequence-engagement]", Yl = "[data-sequence-card]", Ql = "[data-sequence-person-card]", Rn = "[data-sequence-people-rail]", j = {
  duration: S(0.12),
  incomingLag: S(0.1),
  rowStagger: S(0.03),
...
class Zl {
  ...
  strategyPlans(e) {
    ...
    const d = this.claimComponentMessage("strategy", a), u = f.timeline().add(this.revealMessage(d, n, Cn)).addLabel(s, Vl).call(() => this.setMotionHints(c), void 0, s).to(t, { ...r.to }, s);
  ...
  applyWindowSceneScale(e) {
    const t = this.getWindowSceneBaseSize(), a = this.getWindowSceneAvailableWidth(), i = Math.ceil(Math.max(
      ...
      e
    )), n = this.getWindowSceneScale(i, a), r = Math.min(1, Math.max(0.01, n)), s = i > t.width + 0.5;
    if (r >= 0.999 && !s) {
      this.clearWindowSceneScaleState();
      return;
    }
    const l = r >= 0.999 ? 1 : Number(r.toFixed(4)), c = String(l), d = Math.ceil(t.height * (i / Math.max(1, t.width))), u = `${i}px`, h = `${Math.ceil(d * l)}px`, g = `${d}px`;
...
function $l(o, e) {
  const t = Ll[o] ?? 0, a = 24 + o * 11 % 8, i = Math.min(100, t + a), n = ao((e - t) / (i - t));
  if (n <= 0) return 0;
...
const Nn = /* @__PURE__ */ new Set(), ua = /* @__PURE__ */ new Set(), dc = ["avatarUrl", "mutualConnectionAvatarUrl"], uc = ["name", "contact", "prospect", "fullName", "mutualConnection", "connector"];
function On(o, e) {
...
const Ea = {
  ...
  tablet: -66,
  mobile: -48
}), co = N("[data-signup-submit]", "center"), yc = N("[data-send-button]", "center"), Yi = {
  desktop: {
...
}, xc = 2.8, _c = 42, vc = 2, Ac = 3, Ma = "[data-chat-shell] [data-chat-thread]", Sc = `${Ma} [data-message-role="assistant"]:not(.wa-message--component) [data-message-body]`, Cc = `${Ma} [data-message-role="assistant"].wa-message--thinking .wa-research-step[data-step-state="current"] .wa-research-step__body, ${Ma} [data-message-role="assistant"].wa-message--thinking .wa-research-step[data-step-state="complete"] .wa-research-step__label`, Pa = 0.24, uo = 0.3, ze = {
...
function wd(o, e, t) {
  ...
  if (e.columns.forEach((i, n) => {
    ...
    const i = Ci(a[e.mutualConnectionKey] ?? ""), n = bd(t);
...
class Nd {
  ...
  updatePlayTarget(e) {
    ...
    this.target = Fd(n, this.pointer, We.minPointerDistance, We.viewportInset);
  }
  resumeFollowing(e) {
...
function Qd(o, e = {}) {
  const t = e.stories?.length ? e.stories : Eo, a = e.builderDraftEndpoint ?? "/api/story-draft", i = e.reducedMotion ?? window.matchMedia?.("(prefers-reduced-motion: reduce)").matches ?? !1, n = new Yd(o), r = new Zl(o), s = new oc(o, n, { reducedMotion: i }), l = new Gd(o, t, n, s, r, {
...
function $d(o) {
  ...
  const e = Ce(o.id), t = Ce(o.label), a = Ce(o.summary), i = o.steps.map((n) => eu(n)).filter((n) => !!n);
