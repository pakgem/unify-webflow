...
var pe = {
  ...
  overwrite: !1,
  delay: 0
}, wi, K, U, ye = 1e8, z = 1 / ye, ti = Math.PI * 2, ro = ti / 4, oo = 0, On = Math.sqrt, so = Math.cos, lo = Math.sin, $ = function(e) {
...
}, ee = Array.isArray, co = /random\([^)]+\)/g, uo = /,\s*/g, zi = /(?:-?\.?\d|\.)+/gi, zn = /[-+=.]*\d+[.e\-+]*\d*[e\-+]*\d*/g, wt = /[-+=.]*\d+[.e-]*\d*[a-z%]*/g, Ra = /[-+=.]*\d+\.?\d*(?:e-|e\+)?\d*/gi, Fn = /[+-]=-?[.\d]+/, ho = /[^,'"\[\]\s]+/gi, po = /^[+\-=e\s\d]*\d+[.\d]*([a-z]*|%)\s*$/i, W, Se, ai, _i, ge = {}, ga = {}, Hn, Un = function(e) {
  ...
  return t.parent && Ke(t), t._start = G((Fe(a) ? a : a || e !== W ? be(e, a, t) : e._time) + t._delay), t._end = G(t._start + (t.totalDuration() / Math.abs(t.timeScale()) || 0)), $n(e, t, "_first", "_last", e._sort ? "_start" : 0), ri(t) || (e._recent = t), i || Kn(e, t), e._ts < 0 && Sa(e, e._tTime), e;
}, Qn = function(e, t) {
  ...
  if (s && e._repeat && (l = ta(0, e._tDur, t), d = St(l, s), e._yoyo && d & 1 && (o = 1 - o), d !== St(e._tTime, s) && (n = 1 - o, e.vars.repeatRefresh && e._initted && e.invalidate())), o !== n || K || i || e._zTime === z || !t && e._zTime) {
    ...
    for (u = e._zTime, e._zTime = t || (a ? z : 0), a || (a = t && !u), e.ratio = o, e._from && (o = 1 - o), e._time = 0, e._tTime = l, c = e._pt; c; )
      c.r(o, c.d), c = c._next;
    t < 0 && ni(e, t, a, !0), e._onUpdate && !a && ue(e, "onUpdate"), l && e._repeat && !a && e.parent && ue(e, "onRepeat"), (t >= e._tDur || t < 0) && e.ratio === o && (o && Ke(e, 1), !a && !K && (ue(e, o ? "onComplete" : "onReverseComplete", !0), e._prom && e._prom()));
  ...
  var i = e.labels, n = e._recent || Ao, o = e.duration() >= ye ? n.endTime(!1) : e._dur, s, l, c;
  ...
  var i = Fe(t[1]), n = (i ? 2 : 1) + (e < 2 ? 0 : 1), o = t[n], s, l;
  ...
  return a === void 0 && (a = []), e.forEach(function(i) {
    var n;
    return $(i) && !t || Jn(i, 1) ? (n = a).push.apply(n, _e(i)) : a.push(i);
  }) || a;
}, _e = function(e, t, a) {
  ...
  return e = _e(e)[0] || Vt("Invalid scope") || {}, function(t) {
    ...
    return _e(t, a.querySelectorAll ? a : a === e ? Vt("Invalid scope") || _i.createElement("div") : e);
  };
}, er = function(e) {
  ...
  return function(a) {
    ...
    return (i - i % 1) / t + (Fe(a) ? 0 : J(a));
  };
}, ar = function(e, t) {
  var a = ee(e), i, n;
  return !a && Me(e) && (i = a = e.radius || ye, e.values ? (e = _e(e.values), (n = !Fe(e[0])) && (i *= i)) : e = li(e.increment)), Je(t, a ? Y(e) ? function(o) {
    ...
    return d = !i || c <= i ? e[d] : o, n || d === o || Fe(o) ? d : d + J(o);
  } : li(e));
}, ir = function(e, t, a, i) {
  ...
  var i = t - e;
  return ee(e) ? nr(e, r(0, e.length), t) : Je(a, function(n) {
    return (i + (n - e) % i) % i + e;
  });
}, Ro = function r(e, t, a) {
  var i = t - e, n = i * 2;
  return ee(e) ? nr(e, r(0, e.length - 1), t) : Je(a, function(o) {
  ...
  return Ke(e), e.scrollTrigger && e.scrollTrigger.kill(!!K), e.progress() < 1 && ue(e, "onInterrupt"), e;
}, bt, or = [], sr = function(e) {
  if (e)
  ...
  var i = e ? Fe(e) ? [e >> 16, e >> 8 & B, e & B] : 0 : qt.black, n, o, s, l, c, d, u, g, p, f;
  if (!i) {
  ...
  if (n = n.map(function(g) {
    ...
    for (c = e.replace($e, "1").split(wt), u = c.length - 1; s < u; s++)
  ...
  return u = {
    ...
    wake: function() {
      Hn && (!ai && yi() && (Se = ai = window, _i = Se.document || {}, ge.gsap = se, (Se.gsapVersions || (Se.gsapVersions = [])).push(se.version), Un(ga || Se.GreenSockGlobals || !Se.gsap && Se || {}), or.forEach(sr)), d = typeof requestAnimationFrame < "u" && requestAnimationFrame, l && u.sleep(), c = d || function(w) {
...
var ae = /* @__PURE__ */ (function(r) {
  ...
  function e(a, i) {
    var n;
    return a === void 0 && (a = {}), n = r.call(this, a) || this, n.labels = {}, n.smoothChildTiming = !!a.smoothChildTiming, n.autoRemoveChildren = !!a.autoRemoveChildren, n._sort = ie(a.sortChildren), W && Ce(a.parent || W, De(n), i), a.reversed && n.reverse(), a.paused && n.paused(!0), a.scrollTrigger && Qn(De(n), a.scrollTrigger), n;
  }
  var t = e.prototype;
  return t.to = function(i, n, o) {
    ...
    return n.duration = 0, n.parent = this, Ft(n).repeatDelay || (n.repeat = 0), n.immediateRender = !!n.immediateRender, new X(i, n, be(this, o), 1), this;
    ...
    if (this !== W && d > l && i >= 0 && (d = l), d !== this._tTime || o || u) {
      ...
      this._onUpdate && !n && ue(this, "onUpdate", !0), (d === l && this._tTime >= this.totalDuration() || !d && s) && (v === this._start || Math.abs(x) !== Math.abs(this._ts)) && (this._lock || ((i || !c) && (d === l && this._ts > 0 || !d && this._ts < 0) && Ke(this, 1), !n && !(i < 0 && !s) && (d || s || !l) && (ue(this, d === l && i >= 0 ? "onComplete" : "onReverseComplete", !0), this._prom && !(d < l && this.timeScale() > 0) && this._prom())));
    }
    return this;
  }, t.add = function(i, n) {
    var o = this;
    if (Fe(n) || (n = be(this, n, i)), !(i instanceof $t)) {
      if (ee(i))
    ...
    var n = this._first;
    for (i = be(this, i); n; )
      n._start === i && n.data === "isPause" && Ke(n), n = n._next;
  }, t.killTweensOf = function(i, n, o) {
    for (var s = this.getTweensOf(i, o), l = s.length; l--; )
      We !== s[l] && s[l].kill(i, n);
    return this;
  }, t.getTweensOf = function(i, n) {
    for (var o = [], s = _e(i), l = this._first, c = Fe(n), d; l; )
      l instanceof X ? fo(l._targets, s) && (c ? (!We || l._initted && l._ts) && l.globalTime(0) <= n && l.globalTime(l.totalDuration()) > n : !n || l.isActive()) && o.push(l) : (d = l.getTweensOf(s, n)).length && o.push.apply(o, d), l = l._next;
    return o;
...
var Fo = function(e, t, a, i, n, o, s) {
  ...
  if (Y(e) && (e = Ut(e, n, t, a, i)), !Me(e) || e.style && e.nodeType || ee(e) || Bn(e))
  ...
  if (v && (!g || !n) && (n = "none"), e._ease = ut(n, Wt.ease), e._rEase = _ && (ut(_) || e._ease), e._from = !v && !!i.runBackwards, e._from && (e.ratio = 1), !v || g && !i.stagger) {
    if (L = w[0] ? ct(w[0]).harness : 0, H = L && i[L.prop], T = fa(i, vi), h && (h._zTime < 0 && h.progress(1), t < 0 && d && s && !p ? h.render(-1, !0) : h.revert(d && f ? da : go), h._lazy = 0), o) {
      ...
      }, T), H && (C[L.prop] = H), Ke(e._startAt = X.set(w, C)), e._startAt._dp = 0, e._startAt._sat = e, t < 0 && (K ? e._startAt.revert(da) : e._startAt.render(-1, !0)), e._zTime = t, !s)
        r(e._startAt, z, z);
      else if (!t)
        return;
    }
    for (e._pt = e._ptCache = 0, l = f && ie(l) || l && !f, k = 0; k < w.length; k++) {
      if (E = w[k], O = E._gsap || Ai(w)[k]._gsap, e._ptLookup[k] = N = {}, ii[O.id] && Xe.length && ma(), P = y === w ? k : y.indexOf(E), L && (I = new L()).init(E, H || T, e, P, y) !== !1 && (e._pt = S = new re(e._pt, E, I.name, 0, 1, I.render, I, 0, I.priority), I._props.forEach(function(Pe) {
        N[Pe] = S;
      }), I.priority && (F = 1)), !L || H)
        for (C in T)
          ce[C] && (I = pr(C, T, e, P, E, y)) ? I.priority && (F = 1) : N[C] = S = Ci.call(e, E, C, "get", T[C], P, y, 0, i.stringFilter);
      e._op && e._op[k] && e.kill(E, e._op[k]), x && e._pt && (We = e, W.killTweensOf(E, N, e.globalTime(t)), Q = !e.parent, We = 0), e._pt && l && (ii[O.id] = 1);
    }
    F && yr(e), e._onInit && e._onInit(e);
  }
  e._onUpdate = c, e._initted = (!e._op || e._pt) && !Q, g && t <= 0 && v.render(ye, !0, !0);
...
var X = /* @__PURE__ */ (function(r) {
  ...
  function e(a, i, n, o) {
    ...
    var l = s.vars, c = l.duration, d = l.delay, u = l.immediateRender, g = l.stagger, p = l.overwrite, f = l.keyframes, h = l.defaults, w = l.scrollTrigger, b = i.parent || W, y = (ee(a) || Bn(a) ? Fe(a[0]) : "length" in i) ? [a] : _e(a), x, v, _, T, k, C, S, E;
    if (s._targets = y.length ? Ai(y) : Vt("GSAP target " + a + " not found. https://gsap.com", !pe.nullTargetWarn) || [], s._ptLookup = [], s._overwrite = p, f || g || aa(c) || aa(d)) {
      ...
      }), x.kill(), x.parent = x._dp = De(s), x._start = 0, g || aa(c) || aa(d)) {
        if (T = y.length, S = g && tr(g), Me(g))
          for (k in g)
            ~gr.indexOf(k) && (E || (E = {}), E[k] = g[k]);
        for (v = 0; v < T; v++)
          _ = fa(i, mr), _.stagger = 0, F && (_.easeReverse = F), E && At(_, E), C = y[v], _.duration = +Ut(c, De(s), v, C, y), _.delay = (+Ut(d, De(s), v, C, y) || 0) - s._delay, !g && T === 1 && _.delay && (s._delay = d = _.delay, s._start += d, _.delay = 0), x.to(C, _, S ? S(v, C, y) : 0), x._ease = R.none;
      ...
      s.timeline = 0;
    return p === !0 && !wi && (We = De(s), W.killTweensOf(y), We = 0), Ce(b, De(s), n), i.reversed && s.reverse(), i.paused && s.paused(!0), (u || !c && !f && s._start === G(b._time) && ie(u) && _o(De(s)) && b.data !== "nested") && (s._tTime = -z, s.render(Math.max(0, -d) || 0)), w && Qn(De(s), w), s;
  }
  var t = e.prototype;
  return t.render = function(i, n, o) {
    ...
    if (!c)
      ...
      for (p = this._pt; p; )
        p.r(y, p.d), p = p._next;
      x && x.render(i < 0 ? i : x._dur * x._ease(g / this._dur), n, o) || this._startAt && (this._zTime = i), this._onUpdate && !n && (d && ni(this, i, n, o), ue(this, "onUpdate")), this._repeat && f !== w && this.vars.onRepeat && !n && this.parent && ue(this, "onRepeat"), (u === this._tDur || !u) && this._tTime === u && (d && !this._onUpdate && ni(this, i, !0, !0), (i || !c) && (u === this._tDur && this._ts > 0 || !u && this._ts < 0) && Ke(this, 1), !n && !(d && !s) && (u || s || b) && (ue(this, u === l ? "onComplete" : "onReverseComplete", !0), this._prom && !(u < l && this.timeScale() > 0) && this._prom()));
    }
    return this;
  }, t.targets = function() {
    ...
    if (this.timeline) {
      ...
      return this.timeline.killTweensOf(i, n, We && We.vars.overwrite !== !0)._first || Nt(this), this.parent && o !== this.timeline.totalDuration() && Ct(this, this._dur * this.timeline._tDur / o, 0, 1), this;
    }
...
var ht = [], ha = {}, Qo = [], Yi = 0, Zo = 0, qa = function(e) {
  ...
  return e.add = function(a, i, n) {
    ...
    for (c in a)
      c === "all" ? d = 1 : (l = Se.matchMedia(a[c]), l && (ht.indexOf(o) < 0 && ht.push(o), (s[c] = l.matches) && (d = 1), l.addListener ? l.addListener(di) : l.addEventListener("change", di)));
  ...
  registerEffect: function(e) {
    ...
    (i || "").split(",").forEach(function(s) {
      ...
      return this.add(Ia[t](s, Me(l) ? l : (c = l) && {}, this), c);
    });
  },
...
R.Expo;
R.Circ;
var ji, Ve, _t, Ri, lt, Xi, Ii, as = function() {
  return typeof window < "u";
}, He = {}, st = 180 / Math.PI, xt = Math.PI / 180, gt = Math.atan2, $i = 1e8, Li = /([A-Z])/g, is = /(left|right|width|margin|padding|x)/i, ns = /[\s,\(]\S/, Ee = {
  ...
  as() && window.document && (ji = window, Ve = ji.document, _t = Ve.documentElement, lt = hi("div") || {
    style: {}
  ...
  if (t) {
    var a = e.style, i;
    t in He && t !== oe && (t = V), a.removeProperty ? (i = t.substr(0, 2), (i === "ms" || t.substr(0, 6) === "webkit") && (t = "-" + t), a.removeProperty(i === "--" ? t : t.replace(Li, "-$1").toLowerCase())) : a.removeAttribute(t);
  }
  ...
  if (i === o || !n || Ji[i] || Ji[o])
    return n;
  if (o !== "px" && !g && (n = r(e, t, a, "px")), b = e.getCTM && Tr(e), (p || o === "%") && (He[t] || ~t.indexOf("adius")))
  ...
  var n;
  return Ri || pi(), t in Ee && t !== "transform" && (t = Ee[t], ~t.indexOf(",") && (t = t.split(",")[0])), He[t] && t !== "transform" ? (n = Qt(e, i), n = t !== "transformOrigin" ? n[t] : n.svg ? n.origin : _a(he(e, oe)) + " " + n.zOrigin + "px") : (n = e.style[t], (!n || n === "auto" || i || ~(n + "").indexOf("calc(")) && (n = ya[t] && ya[t](e, t, a) || he(e, t) || Vn(e, t) || (t === "opacity" ? 1 : 0))), a && !~(n + "").trim().indexOf(" ") ? Ze(e, t, n, a) + a : n;
}, bs = function(e, t, a, i) {
  if (!a || a === "none") {
  ...
  if (s.b = a, s.e = i, a += "", i += "", i.substring(0, 6) === "var(--" && (i = he(e, i.substring(4, i.indexOf(")")))), i === "auto" && (h = e.style[t], e.style[t] = i, i = he(e, t) || i, h ? e.style[t] = h : Qe(e, t)), d = [a, i], dr(d), a = d[0], i = d[1], g = a.match(wt) || [], _ = i.match(wt) || [], _.length) {
    for (; u = wt.exec(i); )
      w = u[0], y = i.substring(l, u.index), f ? f = (f + 1) % 5 : (y.substr(-5) === "rgba(" || y.substr(-5) === "hsla(") && (f = 1), w !== (h = g[c++] || "") && (p = parseFloat(h) || 0, v = h.substr((p + "").length), w.charAt(1) === "=" && (w = yt(p, w) + v), b = parseFloat(w), x = w.substr((b + "").length), l = wt.lastIndex - x.length, x || (x = x || pe.units[t] || v, l === i.length && (i += x, s.e += x)), v !== x && (p = Ze(e, t, h, x) || 0), s._pt = {
        _next: s._pt,
        p: y || c === 1 ? y : ",",
        //note: SVG spec allows omission of comma/space when a negative sign is wedged between two numbers, like 2.5-5.3 instead of 2.5,-5.3 but when tweening, the negative value may switch to positive, so we insert the comma just in case.
        s: p,
  ...
  if (t.tween && t.tween._time === t.tween._dur) {
    ...
    if (n === "all" || n === !0)
      ...
      for (n = n.split(","), c = n.length; --c > -1; )
        s = n[c], He[s] && (l = 1, s = s === "transformOrigin" ? oe : V), Qe(a, s);
    l && (Qe(a, V), o && (o.svg && a.removeAttribute("transform"), i.scale = i.rotate = i.translate = "none", Qt(a, 1), o.uncache = 1, kr(i)));
  }
}, ya = {
  ...
  */
...
}, at = "0deg", Pt = "0px", it = ") ", Pr = function(e, t) {
  ...
  w !== Pt && (v += "perspective(" + w + it), (i || n) && (v += "translate(" + i + "%, " + n + "%) "), (_ || o !== Pt || s !== Pt || l !== Pt) && (v += l !== Pt || _ ? "translate3d(" + o + ", " + s + ", " + l + ") " : "translate(" + o + ", " + s + it), c !== at && (v += "rotate(" + c + it), d !== at && (v += "rotateY(" + d + it), u !== at && (v += "rotateX(" + u + it), (g !== at || p !== at) && (v += "skew(" + g + ", " + p + it), (f !== 1 || h !== 1) && (v += "scale(" + f + ", " + h + it), y.style[V] = v || "translate(0, 0)";
}, vs = function(e, t) {
  ...
  l = parseFloat(l), c = parseFloat(c), d = parseFloat(d), d && (d = parseFloat(d), c += d, l += d), l || c ? (l *= xt, c *= xt, _ = Math.cos(l) * u, T = Math.sin(l) * u, k = Math.sin(l - c) * -g, C = Math.cos(l - c) * g, c && (d *= xt, S = Math.tan(c - d), S = Math.sqrt(1 + S * S), k *= S, C *= S, d && (S = Math.tan(d), S = Math.sqrt(1 + S * S), _ *= S, T *= S)), _ = j(_), T = j(T), k = j(k), C = j(C)) : (_ = u, C = g, T = k = 0), (x && !~(o + "").indexOf("px") || v && !~(s + "").indexOf("px")) && (x = Ze(p, "x", o, "px"), v = Ze(p, "y", s, "px")), (f || h || w || b) && (x = j(x + f - (f * _ + h * k) + w), v = j(v + h - (f * T + h * C) + b)), (i || n) && (S = p.getBBox(), x = j(x + i / 100 * S.width), v = j(v + n / 100 * S.height)), S = "matrix(" + _ + "," + T + "," + k + "," + C + "," + x + "," + v + ")", p.setAttribute("transform", S), y && (p.style[V] = S);
  ...
  i.svg ? (c = a.getAttribute("transform"), a.setAttribute("transform", ""), o[V] = t, s = Qt(a, 1), Qe(a, V), a.setAttribute("transform", c)) : (c = getComputedStyle(a)[V], o[V] = t, s = Qt(a, 1), o[V] = c);
  for (l in He)
    c = i[l], d = s[l], c !== d && n.indexOf(l) < 0 && (p = J(c), f = J(d), u = p !== f ? Ze(a, l, c, f) : parseFloat(c), g = parseFloat(d), e._pt = new re(e._pt, s, l, u, g - u, ui), e._pt.u = f || 0, e._props.push(l));
  an(s, i);
};
...
var Rr = {
    ...
    for (h in t)
      if (h !== "autoRound" && (d = t[h], !(ce[h] && pr(h, t, a, i, e, n)))) {
        if (p = typeof d, f = ya[h], p === "function" && (d = d.call(a, i, e, n), p = typeof d), p === "string" && ~d.indexOf("random(") && (d = jt(d)), f)
          ...
          if (l && h in l ? (c = typeof l[h] == "function" ? l[h].call(a, i, e, n) : l[h], $(c) && ~c.indexOf("random(") && (c = jt(c)), J(c + "") || c === "auto" || (c += pe.units[h] || J(qe(e, h)) || ""), (c + "").charAt(1) === "=" && (c = qe(e, h))) : c = qe(e, h), g = parseFloat(c), y = p === "string" && d.charAt(1) === "=" && d.substr(0, 2), y && (d = d.substr(2)), u = parseFloat(d), h in Ee && (h === "autoAlpha" && (g === 1 && qe(e, "visibility") === "hidden" && u && (g = 0), C.push("visibility", 0, s.visibility), Ye(this, s, "visibility", g ? "inherit" : "hidden", u ? "inherit" : "hidden", !u)), h !== "scale" && h !== "transform" && (h = Ee[h], ~h.indexOf(",") && (h = h.split(",")[0]))), x = h in He, x) {
            ...
            if (v || (_ = e._gsap, _.renderTransform && !t.parseTransform || Qt(e, t.parseTransform), T = t.smoothOrigin !== !1 && _.smooth, v = this._pt = new re(this._pt, s, V, 0, 1, _.renderTransform, _, 0, -1), v.dep = 1), h === "scale")
              ...
              C.push(oe, 0, s[oe]), d = ys(d), _.svg ? gi(e, d, 0, T, 0, this) : (b = parseFloat(d.split(" ")[2]) || 0, b !== _.zOrigin && Ye(this, _, "zOrigin", _.zOrigin, b), Ye(this, s, h, _a(c), _a(d)));
              continue;
            } else if (h === "svgOrigin") {
              gi(e, d, 1, T, 0, this);
              continue;
          ...
          if (x || (u || u === 0) && (g || g === 0) && !ns.test(d) && h in s)
            w = (c + "").substr((g + "").length), u || (u = 0), b = J(d) || (h in pe.units ? pe.units[h] : w), w !== b && (g = Ze(e, h, c, b)), this._pt = new re(this._pt, x ? _ : s, h, g, (y ? yt(g, y + u) : u) - g, !x && (b === "px" || h === "zIndex") && t.autoRound !== !1 ? ls : ui), this._pt.u = b || 0, x && S !== d ? (this._pt.b = c, this._pt.e = S, this._pt.r = ss) : w !== b && b !== "%" && (this._pt.b = c, this._pt.r = os);
          else if (h in s)
  ...
  getSetter: function(e, t, a) {
    var i = Ee[t];
    return i && i.indexOf(",") < 0 && (t = i), t in He && t !== oe && (e._gsap.x || qe(e, "x")) ? a && Xi === a ? t === "scale" ? hs : us : (Xi = a || {}) && (t === "scale" ? ps : gs) : e.style && !bi(e.style[t]) ? cs : ~t.indexOf("-") ? ds : Mi(e, t);
  },
  core: {
    _removeProperty: Qe,
    _getMatrix: Di
...
m.core.Tween;
const Ne = "Thinking", Gt = "Show more", pa = "Show less";
function Ni(r, e) {
...
const Rs = [
  ...
  rowStartHold: A(0.18),
  rowGapHold: A(0.22),
  serviceRevealDuration: A(0.2),
  serviceLoadDuration: A(0.7),
  serviceSettleDuration: A(0.18),
  rowCompleteHold: A(0.2)
}, Ae = {
  tableRow: {
...
class Xs {
  ...
  enrichmentPanel(e) {
    const t = this.createEnrichmentPanel(e), a = this.claimComponentMessage("enrichment", t), i = this.queryElements(t, ".wa-waterfall-row"), n = this.queryElements(t, ".wa-waterfall-chip"), o = this.queryElements(t, ".wa-waterfall-service-step"), s = this.revealPreparedItems(a, i, Ae.waterfallRow), l = t.querySelector(".wa-thinking__glyph");
    return m.set(o, { autoAlpha: 0, y: 3, scale: 0.98 }), m.set(n, { scale: 1 }), s.call(() => this.setLocalLogoMode(l, "thinking"), void 0, 0), s.add(this.animateEnrichmentWaterfall(i), `+=${rt.rowStartHold}`), s.call(() => this.setLocalLogoMode(l, "done")), s;
  }
  strategyPlans(e) {
    const t = e.map((g) => this.createStrategyPlan(g)), a = document.createElement("div"), i = t.flatMap((g) => this.queryElements(g, ".wa-strategy-plan__bullets li")), n = this.getLastMessageBody(), o = Ae.strategyCard, s = "strategyCardsIn", l = o.to.stagger, c = [...t, ...i];
    ...
    return t.forEach((g, p) => {
      ...
      () => this.animateMessageScrollIntoView(d, Ie.followDuration, n, dn),
      void 0,
      "+=0.02"
    );
  }
  ...
  normalizeThinkingInput(e) {
    if (this.isThinkingStateConfig(e)) {
      ...
      return {
        title: e.title || Ne,
        elapsed: e.elapsed,
        items: a.length ? a : [this.normalizeThinkingItem(Ne, 0)]
      };
    }
    ...
    return {
      title: Ne,
      items: t.length ? t : [this.normalizeThinkingItem(Ne, 0)]
    };
  }
  ...
  createWaterfallRow(e, t, a) {
    ...
    return s.className = "wa-waterfall-row__chips", a.forEach((l, c) => {
      ...
      if (d.className = "wa-waterfall-service-step", d.append(u), c < a.length - 1) {
        const g = document.createElement("span");
        g.className = "wa-waterfall-arrow", g.textContent = "→", g.setAttribute("aria-hidden", "true"), d.append(g);
      }
      s.append(d);
    }), i.append(n, o, s), i;
  }
  createWaterfallServiceBadge(e) {
    ...
    return t.className = "wa-waterfall-chip", t.dataset.service = e.service, t.dataset.stepState = "pending", t.dataset.finalStepState = e.state, a.className = "wa-waterfall-chip__icon", a.setAttribute("aria-hidden", "true"), this.appendWaterfallServiceIcon(a, e.service), i.className = "wa-waterfall-chip__label", i.textContent = e.label, t.append(a, i), t;
  }
  ...
  animateEnrichmentWaterfall(e) {
    ...
    return e.forEach((a, i) => {
      const n = this.queryElements(a, ".wa-waterfall-chip"), o = this.queryElements(a, ".wa-waterfall-service-step"), s = this.getAttemptedWaterfallChips(n), l = this.getWaterfallFinalState(a);
      t.call(() => this.setWaterfallState(a, "loading"), void 0, i === 0 ? 0 : `+=${rt.rowGapHold}`).to(o, {
        autoAlpha: 1,
        y: 0,
        scale: 1,
        duration: rt.serviceRevealDuration,
        ease: "power2.out",
        stagger: 0.035
      }, "<"), s.forEach((c) => {
        const d = this.getWaterfallFinalState(c);
        t.call(() => this.setWaterfallState(c, "loading")).to(c, {
          scale: 1.04,
          duration: rt.serviceSettleDuration,
          ease: "power2.out"
        }, "<").to({}, { duration: rt.serviceLoadDuration }).call(() => this.setWaterfallState(c, d)).to(c, {
          scale: 1,
          duration: rt.serviceSettleDuration,
          ease: d === "complete" ? "back.out(1.8)" : "power2.out"
        });
      }), t.call(() => this.setWaterfallState(a, l)).to({}, { duration: rt.rowCompleteHold });
    }), t;
  }
    ...
    e.sequences.forEach((p, f) => {
      ...
      if (k?.length) {
        ...
        C.className = "wa-sequence-steps", k.forEach((I, N) => {
          const P = document.createElement("button"), H = document.createElement("span"), Q = document.createElement("span"), Pe = document.createElement("strong"), ve = this.getSequenceStepWaitDays(I, N, k.length);
          ...
          }), H.className = "wa-sequence-step__channel", H.textContent = this.formatSequenceChannelLabel(I.channel), Q.className = "wa-sequence-step__copy", Pe.textContent = I.label, Q.append(Pe), P.append(H, Q), C.append(P), ve && C.append(this.createSequenceWaitRow(ve, N));
...
}, ul = 2.8, hl = 42, pl = 2, gl = 3, va = "[data-chat-shell] [data-chat-thread]", ml = `${va} [data-message-role="assistant"]:not(.wa-message--component) [data-message-body]`, fl = `${va} [data-message-role="assistant"].wa-message--thinking .wa-research-step[data-step-state="current"] .wa-research-step__body, ${va} [data-message-role="assistant"].wa-message--thinking .wa-research-step[data-step-state="complete"] .wa-research-step__label`, mi = 0.24, Gr = 0.3, Be = {
  ...
  switch (t.kind) {
    ...
    case "dataTable":
      Dt(
        ...
        t.at,
        ft(`[data-data-table="${Oe(t.config.id)}"]`),
        `table-${t.config.id}`
      );
      return;
    case "enrichmentPanel":
      Dt(
        ...
        t.at,
        ft(`[data-enrichment-panel="${Oe(t.config.id)}"]`),
        `enrichment-${t.config.id}`
      );
      return;
    case "strategyPlans":
      {
        const n = ft(`[data-strategy-plans~="${Oe(t.plans[0]?.id ?? "strategy")}"]`);
    ...
    case "dataSourcesGrid":
      Dt(
        ...
        t.at,
        ft(`[data-data-sources-grid="${Oe(t.config.id)}"]`),
        `sources-${t.config.id}`
      );
      return;
    ...
    case "sequenceEngagement":
      Dt(
        ...
        t.at,
        ft(`[data-sequence-engagement="${Oe(t.config.id)}"]`),
...
function yl(r, e, t, a) {
  ...
  r.add(e.chat.personalizationSwipeGame(t), a), t.signals.forEach((n, o) => {
    const s = `${i} [data-swipe-card="${Oe(n.id)}"]`, l = n.decision === "use" ? 1 : -1, c = n.decision === "use" ? "right" : "left", d = q(s, c, {
...
function xl(r, e, t) {
  ...
  return t.forEach((i, n) => {
    const o = `${e} [data-strategy-plan="${Oe(i.id)}"]`;
    a.add(
...
function Ll(r, e, t) {
  ...
  const a = Hl(e);
  return a.length ? Te(r, [...a, je(Be.bottomRight, "+=0.18")]) : t.build(r);
}
function Dl(r, e) {
...
function Nl(r, e) {
  ...
  for (const n of e.steps)
    n === t || n === a || Vr(i, e.id, n);
  return i.push(je(Be.bottomRight, "+=0.16")), Te(r, i);
}
function ql(r, e) {
  const t = ze(e, "user"), a = ea(e, "table"), i = ze(e, "thinking"), n = ea(e, "sequenceEngagement"), o = a ? Jt(a.component, "website-visitors-sales") : null, s = n ? Oi(n.component, "visitor-outreach-sequences") : null, l = [];
  if (t && l.push({
    kind: "prompt",
    text: t.text,
    duration: Zr(t.text),
...
class fc {
  ...
  updatePlayTarget(e) {
    ...
    this.target = yc(n, this.pointer, Ue.minPointerDistance, Ue.viewportInset);
  }
  resumeFollowing(e) {
...
function Rc(r) {
  ...
  const e = xe(r.id), t = xe(r.label), a = xe(r.summary), i = r.steps.map((n) => Ic(n)).filter((n) => !!n);
...
function Dc(r, e) {
  ...
  return t ? {
    ...
    disclosure: xe(r.disclosure) ?? (e === 0 ? Gt : pa)
  } : null;
}
function ao(r, e = "") {
  return {
