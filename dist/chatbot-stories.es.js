...
var xe = {
  ...
  overwrite: !1,
  delay: 0
}, Vi, ae, V, Te = 1e8, F = 1 / Te, Si = Math.PI * 2, rs = Si / 4, os = 0, Tr = Math.sqrt, ss = Math.cos, ls = Math.sin, ee = function(e) {
...
}, oe = Array.isArray, cs = /random\([^)]+\)/g, ds = /,\s*/g, fn = /(?:-?\.?\d|\.)+/gi, Pr = /[-+=.]*\d+[.e\-+]*\d*[e\-+]*\d*/g, Lt = /[-+=.]*\d+[.e-]*\d*[a-z%]*/g, ei = /[-+=.]*\d+\.?\d*(?:e-|e\+)?\d*/gi, Mr = /[+-]=-?[.\d]+/, us = /[^,'"\[\]\s]+/gi, hs = /^[+\-=e\s\d]*\d+[.\d]*([a-z]*|%)\s*$/i, Q, Ue, Ci, Yi, _e = {}, La = {}, Dr, Rr = function(e) {
  ...
  suppressEvents: !0
}, ji = {}, ut = [], Ti = {}, qr, fe = {}, ti = {}, wn = 30, Ra = [], Ki = "", Xi = function(e) {
  var t = e[0], a, i;
  ...
  for (i = e.length; i--; )
    e[i] && (e[i]._gsap || (e[i]._gsap = new ao(e[i], a))) || e.splice(i, 1);
  return e;
}, Ct = function(e) {
  ...
  var t = parseFloat(e);
  return (t || t === 0) && (e + "").match(us).length < 2 ? t : ee(e) ? e.trim() : e;
}, Nr = function(e) {
  return e;
}, ke = function(e, t) {
  for (var a in t)
  ...
  var a;
  if ((t._time || !t._dur && t._initted || t._start < e._time && (t._dur || !t.add)) && (a = Fa(e.rawTime(), t), (!t._dur || wa(0, t.totalDuration(), a) - t._tTime > F) && t.render(a, !0)), Tt(e, t)._dp && e._initted && e._time >= e._dur && e._ts) {
  ...
  return t.parent && pt(t), t._start = G(($e(a) ? a : a || e !== Q ? Ce(e, a, t) : e._time) + t._delay), t._end = G(t._start + (t.totalDuration() / Math.abs(t.timeScale()) || 0)), Fr(e, t, "_first", "_last", e._sort ? "_start" : 0), Pi(t) || (e._recent = t), i || Ur(e, t), e._ts < 0 && Ka(e, e._tTime), e;
}, zr = function(e, t) {
  return (_e.ScrollTrigger || Wi("scrollTrigger", t)) && _e.ScrollTrigger.create(t, e);
}, Hr = function(e, t, a, i, n) {
  if ($i(e, t, n), !e._initted)
    return 1;
  if (!a && e._pt && !ae && (e._dur && e.vars.lazy !== !1 || !e._dur && e.vars.lazy) && qr !== Ae.frame)
  ...
  var n = e.ratio, o = t < 0 || !t && (!e._start && ys(e) && !(!e._initted && Pi(e)) || (e._ts < 0 || e._dp._ts < 0) && !Pi(e)) ? 0 : 1, s = e._rDelay, c = 0, l, d, u;
  if (s && e._repeat && (c = wa(0, e._tDur, t), d = Vt(c, s), e._yoyo && d & 1 && (o = 1 - o), d !== Vt(e._tTime, s) && (n = 1 - o, e.vars.repeatRefresh && e._initted && e.invalidate())), o !== n || ae || i || e._zTime === F || !t && e._zTime) {
    if (!e._initted && Hr(e, t, i, a, c))
      return;
  ...
  var i = e.labels, n = e._recent || _s, o = e.duration() >= Te ? n.endTime(!1) : e._dur, s, c, l;
  ...
  return !ee(e) || !(t = hs.exec(e)) ? "" : t[1];
}, ks = function(e, t, a) {
  return ft(a, function(i) {
    return wa(e, t, i);
  });
}, Mi = [].slice, Vr = function(e, t) {
  return e && Ge(e) && "length" in e && (!t && !e.length || e.length - 1 in e && Ge(e[0])) && !e.nodeType && e !== Ue;
}, Ss = function(e, t, a) {
  return a === void 0 && (a = []), e.forEach(function(i) {
    var n;
    return ee(i) && !t || Vr(i, 1) ? (n = a).push.apply(n, Ee(i)) : a.push(i);
  }) || a;
}, Ee = function(e, t, a) {
  return V && !t && V.selector ? V.selector(e) : ee(e) && !a && (Ci || !Qt()) ? Mi.call((t || Yi).querySelectorAll(e), 0) : oe(e) ? Ss(e, a) : Vr(e) ? Mi.call(e, 0) : e ? [e] : [];
}, Di = function(e) {
  ...
  }[i] || 0 : !s && c && (d = i[0], u = i[1]), function(h, m, f) {
    var p = (f || t).length, w = o[p], b, A, v, _, y, E, k, C, S;
    if (!w) {
      if (S = t.grid === "auto" ? 0 : (t.grid || [1, Te])[1], !S) {
        for (k = -Te; k < (k = f[S++].getBoundingClientRect().left) && S < p; )
          ;
        S < p && S--;
      }
      for (w = o[p] = [], b = c ? Math.min(S, p) * d - 0.5 : i % S, A = S === Te ? 0 : c ? p * u / S - 0.5 : i / S | 0, k = 0, C = Te, E = 0; E < p; E++)
        v = E % S - b, _ = A - (E / S | 0), w[E] = y = l ? Math.abs(l === "y" ? _ : v) : Tr(v * v + _ * _), y > k && (k = y), y < C && (C = y);
      i === "random" && Gr(w), w.max = k - C, w.min = C, w.v = p = (parseFloat(t.amount) || parseFloat(t.each) * (S > p ? p - 1 : l ? l === "y" ? p / S : S : Math.max(S, p / S)) || 0) * (i === "edges" ? -1 : 1), w.b = p < 0 ? n - p : n, w.u = re(t.amount || t.each) || 0, a = a && p < 0 ? Ns(a) : a;
    }
    return p = (w[h] - w.min) / w.max || 0, G(w.b + (a ? a(p) : p) * w.v) + w.u;
  };
}, Ri = function(e) {
  ...
  var a = oe(e), i, n;
  return !a && Ge(e) && (i = a = e.radius || Te, e.values ? (e = Ee(e.values), (n = !$e(e[0])) && (i *= i)) : e = Ri(e.increment)), ft(t, a ? W(e) ? function(o) {
  ...
  return ft(oe(e) ? !t : a === !0 ? !!(a = 0) : !i, function() {
  ...
  var i = t - e;
  return oe(e) ? jr(e, r(0, e.length), t) : ft(a, function(n) {
    return (i + (n - e) % i) % i + e;
  });
}, Ms = function r(e, t, a) {
  var i = t - e, n = i * 2;
  return oe(e) ? jr(e, r(0, e.length - 1), t) : ft(a, function(o) {
    return o = (n + (o - e) % n) % n || 0, e + (o > i ? n - o : o);
  });
}, da = function(e) {
  return e.replace(cs, function(t) {
    var a = t.indexOf("[") + 1, i = t.substring(a || 7, a ? t.indexOf("]") : t.length - 1).split(ds);
    return Wr(a ? i : +i[0], a ? 0 : +i[1], +i[2] || 1e-5);
  });
}, Kr = function(e, t, a, i, n) {
  var o = t - e, s = i - a;
  return ft(n, function(c) {
    return a + ((c - e) / o * s || 0);
  });
}, Ds = function r(e, t, a, i) {
  ...
  if (e)
    if (e = !e.name && e.default || e, Qi() || e.headless) {
      ...
      if (Qt(), e !== i) {
        if (fe[t])
          return;
        ke(i, ke(Na(e, n), o)), Ht(i.prototype, Ht(n, Na(e, o))), fe[i.prop = t] = i, e.targetTest && (Ra.push(i), ji[t] = 1), t = (t === "css" ? "CSS" : t.charAt(0).toUpperCase() + t.substr(1)) + "Plugin";
      }
      Ir(t, i), e.register && e.register(me, i, pe);
    } else
      Xr.push(e);
}, N = 255, ta = {
  aqua: [0, N, N],
  ...
  var i = e ? $e(e) ? [e >> 16, e >> 8 & N, e & N] : 0 : ta.black, n, o, s, c, l, d, u, h, m, f;
  if (!i) {
    if (e.substr(-1) === "," && (e = e.substr(0, e.length - 1)), ta[e])
      ...
      if (i = f = e.match(fn), !t)
        ...
        return i = e.match(Pr), a && i.length < 4 && (i[3] = 1), i;
    } else
      i = e.match(fn) || ta.transparent;
    i = i.map(Number);
  }
  return t && !f && (n = i[0] / N, o = i[1] / N, s = i[2] / N, u = Math.max(n, o, s), h = Math.min(n, o, s), d = (u + h) / 2, u === h ? c = l = 0 : (m = u - h, l = d > 0.5 ? m / (2 - u - h) : m / (u + h), c = u === n ? (o - s) / m + (o < s ? 6 : 0) : u === o ? (s - n) / m + 2 : (n - o) / m + 4, c *= 60), i[0] = ~~(c + 0.5), i[1] = ~~(l * 100 + 0.5), i[2] = ~~(d * 100 + 0.5)), a && i.length < 4 && (i[3] = 1), i;
}, $r = function(e) {
  var t = [], a = [], i = -1;
  ...
  if (n = n.map(function(h) {
    return (h = Zr(h, t, 1)) && o + (t ? h[0] + "," + h[1] + "%," + h[2] + "%," + h[3] : h.join(",")) + ")";
  }), a && (d = $r(e), c = a.c, c.join(i) !== d.c.join(i)))
...
})(), Rs = /hsl[a]?\(/, eo = function(e) {
  var t = e.join(" "), a;
  if (ht.lastIndex = 0, ht.test(t))
    return a = Rs.test(t), e[1] = xn(e[1], a), e[0] = xn(e[0], a, $r(e[1])), !0;
}, ua, Ae = (function() {
  var r = Date.now, e = 500, t = 33, a = r(), i = a, n = 1e3 / 240, o = n, s = [], c, l, d, u, h, m, f = function p(w) {
    var b = r() - i, A = w === !0, v, _, y, E;
  ...
  return u = {
    ...
    wake: function() {
      Dr && (!Ci && Qi() && (Ue = Ci = window, Yi = Ue.document || {}, _e.gsap = me, (Ue.gsapVersions || (Ue.gsapVersions = [])).push(me.version), Rr(La || Ue.GreenSockGlobals || !Ue.gsap && Ue || {}), Xr.forEach(Jr)), d = typeof requestAnimationFrame < "u" && requestAnimationFrame, c && u.sleep(), l = d || function(w) {
    ...
    add: function(w, b, A) {
      var v = b ? function(_, y, E, k) {
        w(_, y, E, k), u.remove(v);
      } : w;
      return u.remove(w), s[A ? "unshift" : "push"](v), Qt(), v;
    },
    remove: function(w, b) {
      ~(b = s.indexOf(w)) && s.splice(b, 1) && m >= b && m--;
    },
    _listeners: s
  }, u;
})(), Qt = function() {
  return !ua && Ae.wake();
}, R = {}, Is = /^[\d.\-M][\d.\-,\s]/, qs = /["']/g, Bs = function(e) {
  for (var t = {}, a = e.substr(1, e.length - 3).split(":"), i = a[0], n = 1, o = a.length, s, c, l; n < o; n++)
    c = a[n], s = n !== o - 1 ? c.lastIndexOf(",") : c.length, l = c.substr(0, s), t[i] = isNaN(l) ? l.replace(qs, "").trim() : +l, i = c.substr(s + 1).trim();
  return t;
}, Ls = function(e) {
  ...
  return a && t.length > 1 && a.config ? a.config.apply(null, ~e.indexOf("{") ? [Bs(t[1])] : Ls(e).split(",").map(Or)) : R._CE && Is.test(e) ? R._CE("", e) : a;
}, Ns = function(e) {
  return function(t) {
    return 1 - e(1 - t);
  };
}, Et = function(e, t) {
  return e && (W(e) ? e : R[e] || Os(e)) || t;
}, Mt = function(e, t, a, i) {
  ...
  var i = t >= 1 ? t : 1, n = (a || (e ? 0.3 : 0.45)) / (t < 1 ? t : 1), o = n / Si * (Math.asin(1 / i) || 0), s = function(d) {
    return d === 1 ? 1 : i * Math.pow(2, -10 * d) * ls((d - o) * n) + 1;
...
var ao = function(e, t) {
  this.id = os++, e._gsap = this, this.target = e, this.harness = t, this.get = t ? t.get : Br, this.set = t ? t.getSetter : tn;
  ...
  return e.delay = function(a) {
    ...
    if (n && n.smoothChildTiming && this._ts) {
      for (Ka(this, a), !n._dp || n.parent || Ur(n, this); n && n.parent; )
    ...
    return (this._tTime !== a || !this._dur && !i || this._initted && Math.abs(this._zTime) === F || !this._initted && this._dur && a || !a && !this._initted && (this.add || this._ptLookup)) && (this._ts || (this._pTime = a), Lr(this, a, i)), this;
  }, e.time = function(a, i) {
    ...
    return this._rts = +a || 0, this._ts = this._ps || a === -F ? 0 : this._rts, this.totalTime(wa(-Math.abs(this._delay), this.totalDuration(), n), i !== !1), ja(this), bs(this);
  }, e.paused = function(a) {
...
var de = /* @__PURE__ */ (function(r) {
  ...
  function e(a, i) {
    var n;
    return a === void 0 && (a = {}), n = r.call(this, a) || this, n.labels = {}, n.smoothChildTiming = !!a.smoothChildTiming, n.autoRemoveChildren = !!a.autoRemoveChildren, n._sort = ue(a.sortChildren), Q && ze(a.parent || Q, Ke(n), i), a.reversed && n.reverse(), a.paused && n.paused(!0), a.scrollTrigger && zr(Ke(n), a.scrollTrigger), n;
  }
  var t = e.prototype;
  return t.to = function(i, n, o) {
    ...
    var s = this._time, c = this._dirty ? this.totalDuration() : this._tDur, l = this._dur, d = i <= 0 ? 0 : G(i), u = this._zTime < 0 != i < 0 && (this._initted || !l), h, m, f, p, w, b, A, v, _, y, E, k;
    if (this !== Q && d > c && i >= 0 && (d = c), d !== this._tTime || o || u) {
      if (s !== this._time && l && (d += this._time - s, i += this._time - s), h = d, _ = this._start, v = this._ts, b = !v, u && (l || (s = this._zTime), (i || !n) && (this._zTime = i)), this._repeat) {
        if (E = this._yoyo, w = l + this._rDelay, this._repeat < -1 && i < 0)
          return this.totalTime(w * 100 + i, n, o);
        if (h = G(d % w), d === c ? (p = this._repeat, h = l) : (y = G(d / w), p = ~~y, p && p === y && (h = l, p--), h > l && (h = l)), y = Vt(this._tTime, w), !s && this._tTime && y !== p && this._tTime - y * w - this._dur <= 0 && (y = p), E && p & 1 && (h = l - h, k = 1), p !== y && !this._lock) {
          var C = E && y & 1, S = C === (E && p & 1);
          if (p < y && (C = !C), s = C ? 0 : d % l ? l : d, this._lock = 1, this.render(s || (k ? 0 : G(p * w)), n, !l)._lock = 0, this._tTime = d, !n && this.parent && ye(this, "onRepeat"), this.vars.repeatRefresh && !k && (this.invalidate()._lock = 1, y = p), s && s !== this._time || b !== !this._ts || this.vars.onRepeat && !this.parent && !this._act)
            return this;
      ...
      if (this._hasPause && !this._forcing && this._lock < 2 && (A = xs(this, G(s), G(h)), A && (d -= h - (h = A._start))), this._tTime = d, this._time = h, this._act = !!v, this._initted || (this._onUpdate = this.vars.onUpdate, this._initted = 1, this._zTime = i, s = 0), !s && d && l && !n && !y && (ye(this, "onStart"), this._tTime !== d))
        return this;
      if (h >= s && i >= 0)
        for (m = this._first; m; ) {
          if (f = m._next, (m._act || h >= m._start) && m._ts && A !== m) {
            if (m.parent !== this)
        ...
        m = this._last;
        for (var P = i < 0 ? i : h; m; ) {
          if (f = m._prev, (m._act || P <= m._end) && m._ts && A !== m) {
            if (m.parent !== this)
              return this.render(i, n, o);
    ...
    for (var o = [], s = Ee(i), c = this._first, l = $e(n), d; c; )
      c instanceof J ? ms(c._targets, s) && (l ? (!ot || c._initted && c._ts) && c.globalTime(0) <= n && c.globalTime(c.totalDuration()) > n : !n || c.isActive()) && o.push(c) : (d = c.getTweensOf(s, n)).length && o.push.apply(o, d), c = c._next;
    return o;
  }, t.tweenTo = function(i, n) {
    n = n || {};
    var o = this, s = Ce(o, i), c = n, l = c.startAt, d = c.onStart, u = c.onStartParams, h = c.immediateRender, m, f = J.to(o, ke({
      ease: n.ease || "none",
      lazy: !1,
      immediateRender: !1,
      time: s,
      ...
      onStart: function() {
        if (o.pause(), !m) {
          var w = n.duration || Math.abs((s - (l && "time" in l ? l.time : o._time)) / o.timeScale());
          f._dur !== w && Gt(f, w, 0, 1).render(f._time, !0, !0), m = 1;
        }
        d && d.apply(f, u || []);
      }
    }, n));
    ...
    if (Q._ts && (Lr(Q, Fa(i, Q)), qr = Ae.frame), Ae.frame >= wn) {
      wn += xe.autoSleep || 120;
      var n = Q._first;
...
var Fs = function(e, t, a, i, n, o, s) {
  var c = new pe(this._pt, e, t, 0, 1, lo, null, n), l = 0, d = 0, u, h, m, f, p, w, b, A;
  for (c.b = a, c.e = i, a += "", i += "", (b = ~i.indexOf("random(")) && (i = da(i)), o && (A = [a, i], o(A, e, t), a = A[0], i = A[1]), h = a.match(ei) || []; u = ei.exec(i); )
    f = u[0], p = i.substring(l, u.index), m ? m = (m + 1) % 5 : p.substr(-5) === "rgba(" && (m = 1), f !== h[d++] && (w = parseFloat(h[d - 1]) || 0, c._pt = {
      _next: c._pt,
      p: p || d === 1 ? p : ",",
      //note: SVG spec allows omission of comma/space when a negative sign is wedged between two numbers, like 2.5-5.3 instead of 2.5,-5.3 but when tweening, the negative value may switch to positive, so we insert the comma just in case.
      s: w,
      c: f.charAt(1) === "=" ? Ft(w, f) - w : parseFloat(f) - w,
      m: m && m < 4 ? Math.round : 0
    }, l = ei.lastIndex);
  return c.c = l < i.length ? i.substring(l, i.length) : "", c.fp = s, (Mr.test(i) || b) && (c.e = 0), this._pt = c, c;
}, Zi = function(e, t, a, i, n, o, s, c, l, d) {
  W(i) && (i = i(n || 0, e, o));
  var u = e[t], h = a !== "get" ? a : W(u) ? l ? e[t.indexOf("set") || !W(e["get" + t.substr(3)]) ? t : "get" + t.substr(3)](l) : e[t]() : u, m = W(u) ? l ? Gs : oo : en, f;
  if (ee(i) && (~i.indexOf("random(") && (i = da(i)), i.charAt(1) === "=" && (f = Ft(h, i) + (re(h) || 0), (f || f === 0) && (i = f))), !d || h !== i || Ii)
    return !isNaN(h * i) && i !== "" ? (f = new pe(this._pt, e, t, +h || 0, i - (h || 0), typeof u == "boolean" ? Ys : so, 0, m), l && (f.fp = l), s && f.modifier(s, this, e), this._pt = f) : (!u && !(t in e) && Wi(t, i), Fs.call(this, e, t, h, i, m, c || xe.stringFilter, l));
}, Us = function(e, t, a, i, n) {
  if (W(e) && (e = oa(e, n, t, a, i)), !Ge(e) || e.style && e.nodeType || oe(e) || Er(e))
    return ee(e) ? oa(e, n, t, a, i) : e;
  var o = {}, s;
  for (s in e)
    o[s] = oa(e[s], n, t, a, i);
  return o;
}, io = function(e, t, a, i, n, o) {
  var s, c, l, d;
  if (fe[e] && (s = new fe[e]()).init(n, s.rawVars ? t[e] : Us(t[e], i, n, o, a), a, i, o) !== !1 && (a._pt = c = new pe(a._pt, n, e, 0, 1, s.render, s, 0, s.priority), a !== Ot))
    for (l = a._ptLookup[a._targets.indexOf(n)], d = s._props.length; d--; )
      l[s._props[d]] = c;
  return s;
}, ot, Ii, $i = function r(e, t, a) {
  var i = e.vars, n = i.ease, o = i.startAt, s = i.immediateRender, c = i.lazy, l = i.onUpdate, d = i.runBackwards, u = i.yoyoEase, h = i.keyframes, m = i.autoRevert, f = e._dur, p = e._startAt, w = e._targets, b = e.parent, A = b && b.data === "nested" ? b.vars.targets : w, v = e._overwrite === "auto" && !Vi, _ = e.timeline, y = i.easeReverse || u, E, k, C, S, P, U, z, L, H, I, q, D, ie;
  if (_ && (!h || !n) && (n = "none"), e._ease = Et(n, sa.ease), e._rEase = y && (Et(y) || e._ease), e._from = !_ && !!i.runBackwards, e._from && (e.ratio = 1), !_ || h && !i.stagger) {
    if (L = w[0] ? Ct(w[0]).harness : 0, D = L && i[L.prop], E = Na(i, ji), p && (p._zTime < 0 && p.progress(1), t < 0 && d && s && !m ? p.render(-1, !0) : p.revert(d && f ? Da : ps), p._lazy = 0), o) {
      if (pt(e._startAt = J.set(w, ke({
        data: "isStart",
        overwrite: !1,
        parent: b,
        immediateRender: !0,
        ...
        stagger: 0
      }, o))), e._startAt._dp = 0, e._startAt._sat = e, t < 0 && (ae || !s && !m) && e._startAt.revert(Da), s && f && t <= 0 && a <= 0) {
        t && (e._zTime = t);
        return;
      }
    } else if (d && f && !p) {
      ...
      }, E), D && (C[L.prop] = D), pt(e._startAt = J.set(w, C)), e._startAt._dp = 0, e._startAt._sat = e, t < 0 && (ae ? e._startAt.revert(Da) : e._startAt.render(-1, !0)), e._zTime = t, !s)
        r(e._startAt, F, F);
      else if (!t)
        return;
    }
    for (e._pt = e._ptCache = 0, c = f && ue(c) || c && !f, k = 0; k < w.length; k++) {
      if (P = w[k], z = P._gsap || Xi(w)[k]._gsap, e._ptLookup[k] = I = {}, Ti[z.id] && ut.length && Oa(), q = A === w ? k : A.indexOf(P), L && (H = new L()).init(P, D || E, e, q, A) !== !1 && (e._pt = S = new pe(e._pt, P, H.name, 0, 1, H.render, H, 0, H.priority), H._props.forEach(function(Be) {
        I[Be] = S;
      }), H.priority && (U = 1)), !L || D)
        for (C in E)
          fe[C] && (H = io(C, E, e, q, P, A)) ? H.priority && (U = 1) : I[C] = S = Zi.call(e, P, C, "get", E[C], q, A, 0, i.stringFilter);
      e._op && e._op[k] && e.kill(P, e._op[k]), v && e._pt && (ot = e, Q.killTweensOf(P, I, e.globalTime(t)), ie = !e.parent, ot = 0), e._pt && c && (Ti[z.id] = 1);
    }
    U && co(e), e._onInit && e._onInit(e);
  }
  e._onUpdate = l, e._initted = (!e._op || e._pt) && !ie, h && t <= 0 && _.render(Te, !0, !0);
}, zs = function(e, t, a, i, n, o, s, c) {
...
}, no = Ki + "repeat,repeatDelay,yoyo,repeatRefresh,yoyoEase,easeReverse,autoRevert", ro = {};
he(no + ",id,stagger,delay,duration,paused,scrollTrigger", function(r) {
  return ro[r] = 1;
});
var J = /* @__PURE__ */ (function(r) {
  ...
  function e(a, i, n, o) {
    ...
    var c = s.vars, l = c.duration, d = c.delay, u = c.immediateRender, h = c.stagger, m = c.overwrite, f = c.keyframes, p = c.defaults, w = c.scrollTrigger, b = i.parent || Q, A = (oe(a) || Er(a) ? $e(a[0]) : "length" in i) ? [a] : Ee(a), v, _, y, E, k, C, S, P;
    if (s._targets = A.length ? Xi(A) : la("GSAP target " + a + " not found. https://gsap.com", !xe.nullTargetWarn) || [], s._ptLookup = [], s._overwrite = m, f || h || Aa(l) || Aa(d)) {
      i = s.vars;
      ...
      if (v = s.timeline = new de({
        ...
        if (E = A.length, S = h && Qr(h), Ge(h))
          for (k in h)
            ~no.indexOf(k) && (P || (P = {}), P[k] = h[k]);
        for (_ = 0; _ < E; _++)
          y = Na(i, ro), y.stagger = 0, U && (y.easeReverse = U), P && Ht(y, P), C = A[_], y.duration = +oa(l, Ke(s), _, C, A), y.delay = (+oa(d, Ke(s), _, C, A) || 0) - s._delay, !h && E === 1 && y.delay && (s._delay = d = y.delay, s._start += d, y.delay = 0), v.to(C, y, S ? S(_, C, A) : 0), v._ease = R.none;
        v.duration() ? l = d = 0 : s.timeline = 0;
      } else if (f) {
        na(ke(v.vars.defaults, {
          ease: "none"
        })), v._ease = Et(f.ease || i.ease || "none");
        var z = 0, L, H, I;
        if (oe(f))
          ...
          y = {};
          for (k in f)
            k === "ease" || k === "easeEach" || Vs(k, f[k], y, f.easeEach);
          for (k in y)
      ...
      s.timeline = 0;
    return m === !0 && !Vi && (ot = Ke(s), Q.killTweensOf(A), ot = 0), ze(b, Ke(s), n), i.reversed && s.reverse(), i.paused && s.paused(!0), (u || !l && !f && s._start === G(b._time) && ue(u) && As(Ke(s)) && b.data !== "nested") && (s._tTime = -F, s.render(Math.max(0, -d) || 0)), w && zr(Ke(s), w), s;
  }
  var t = e.prototype;
  return t.render = function(i, n, o) {
    var s = this._time, c = this._tDur, l = this._dur, d = i < 0, u = i > c - F && !d ? c : i < F ? 0 : i, h, m, f, p, w, b, A, v;
    if (!l)
      vs(this, i, n, o);
      ...
      if (h = u, v = this.timeline, this._repeat) {
        ...
        if (h = G(u % p), u === c ? (f = this._repeat, h = l) : (w = G(u / p), f = ~~w, f && f === w ? (h = l, f--) : h > l && (h = l)), b = this._yoyo && f & 1, b && (h = l - h), w = Vt(this._tTime, p), h === s && !o && this._initted && f === w)
          return this._tTime = u, this;
        f !== w && this.vars.repeatRefresh && !b && !this._lock && h !== p && this._initted && (this._lock = o = 1, this.render(G(p * f), !0).invalidate()._lock = 0);
      }
      if (!this._initted) {
        if (Hr(this, d ? i : h, o, n, u))
      ...
      if (this._from && (this.ratio = A = 1 - A), this._tTime = u, this._time = h, !this._act && this._ts && (this._act = 1, this._lazy = 0), !s && u && !n && !w && (ye(this, "onStart"), this._tTime !== u))
        return this;
      for (m = this._pt; m; )
        m.r(A, m.d), m = m._next;
      v && v.render(i < 0 ? i : v._dur * v._ease(h / this._dur), n, o) || this._startAt && (this._zTime = i), this._onUpdate && !n && (d && Ei(this, i, n, o), ye(this, "onUpdate")), this._repeat && f !== w && this.vars.onRepeat && !n && this.parent && ye(this, "onRepeat"), (u === this._tDur || !u) && this._tTime === u && (d && !this._onUpdate && Ei(this, i, !0, !0), (i || !l) && (u === this._tDur && this._ts > 0 || !u && this._ts < 0) && pt(this, 1), !n && !(d && !s) && (u || s || b) && (ye(this, u === c ? "onComplete" : "onReverseComplete", !0), this._prom && !(u < c && this.timeScale() > 0) && this._prom()));
    }
    return this;
  }, t.targets = function() {
    ...
    return this._initted || $i(this, l), d = this._ease(l / this._dur), zs(this, i, n, o, s, d, l, c) ? this.resetTo(i, n, o, s, 1) : (Ka(this, 0), this.parent || Fr(this._dp, this, "_first", "_last", this._dp._sort ? "_start" : 0), this.render(0));
  }, t.kill = function(i, n) {
    ...
    var s = this._targets, c = i ? Ee(i) : s, l = this._ptLookup, d = this._pt, u, h, m, f, p, w, b;
    if ((!n || n === "all") && ws(s, c))
      return n === "all" && (this._pt = 0), ea(this);
    for (u = this._op = this._op || [], n !== "all" && (ee(n) && (p = {}, he(n, function(A) {
      return p[A] = 1;
    }), n = p), n = Hs(s, n)), b = s.length; b--; )
      if (~c.indexOf(s[b])) {
        h = l[b], n === "all" ? (u[b] = n, f = h, m = {}) : (m = u[b] = u[b] || {}, f = n);
        for (p in f)
          w = h && h[p], w && ((!("kill" in w.d) || w.d.kill(p) === !0) && Wa(this, w, "_pt"), delete h[p]), m !== "all" && (m[p] = 1);
      }
...
var en = function(e, t, a) {
  ...
  return W(e[t]) ? oo : Gi(e[t]) && e.setAttribute ? Qs : en;
}, so = function(e, t) {
  ...
  function r(t, a, i, n, o, s, c, l, d) {
    this.t = a, this.s = n, this.c = o, this.p = i, this.r = s || so, this.d = c || this, this.set = l || en, this.pr = d || 0, this._next = t, t && (t._prev = this);
  }
  var e = r.prototype;
  return e.modifier = function(a, i, n) {
    this.mSet = this.mSet || this.set, this.set = Ks, this.m = a, this.mt = n, this.tween = i;
  }, r;
})();
...
xe.stringFilter = eo;
var Pt = [], Ia = {}, Xs = [], _n = 0, Js = 0, ri = function(e) {
  return (Ia[e] || Xs).map(function(t) {
    return t();
  });
}, qi = function() {
  var e = Date.now(), t = [];
  ...
  function r(t, a) {
    this.selector = a && Di(a), this.data = [], this._r = [], this.isReverted = !1, this.id = Js++, t && this.add(t);
  }
  var e = r.prototype;
  ...
  return e.add = function(a, i, n) {
    ...
    var o = new uo(0, n || this.scope), s = o.conditions = {}, c, l, d;
  ...
  getProperty: function(e, t, a, i) {
    ee(e) && (e = Ee(e)[0]);
    var n = Ct(e || {}).get, o = a ? Nr : Or;
    return a === "native" && (a = ""), e && (t ? o((fe[t] && fe[t].get || n)(e, t, a, i)) : function(s, c, l) {
      return o((fe[s] && fe[s].get || n)(e, s, c, l));
    });
  },
  quickSetter: function(e, t, a) {
    ...
    e = e[0] || {};
    var o = fe[t], s = Ct(e), c = s.harness && (s.harness.aliases || {})[t] || t, l = o ? function(d) {
      var u = new o();
  ...
  registerEffect: function(e) {
    ...
    (i || "").split(",").forEach(function(s) {
      return s && !fe[s] && !_e[s] && la(t + " effect requires " + s + " plugin.");
    }), ti[t] = function(s, c, l) {
...
var $s = function(e, t) {
  ...
  for (i in t)
    for (n = a.length; n--; )
      o = e._ptLookup[n][i], o && (o = o.d) && (o._pt && (o = $s(o, i)), o && o.modifier && o.modifier(t[i], e, a[n], i));
}, oi = function(e, t) {
  return {
    name: e,
    headless: 1,
...
}, oi("roundProps", Ri), oi("modifiers"), oi("snap", Yr)) || Ua;
...
R.Expo;
R.Circ;
var kn, st, Ut, nn, St, Sn, rn, tl = function() {
  return typeof window < "u";
}, et = {}, _t = 180 / Math.PI, zt = Math.PI / 180, Dt = Math.atan2, Cn = 1e8, on = /([A-Z])/g, al = /(left|right|width|margin|padding|x)/i, il = /[\s,\(]\S/, Ve = {
  ...
  if (this.tfm) {
    for (o in this.tfm)
      i[o] = this.tfm[o];
    i.svg && (i.renderTransform(), t.setAttribute("data-svg-origin", this.svgo || "")), n = rn(), (!n || !n.isStart) && !a[Y] && (go(a), i.zOrigin && a[ge] && (a[ge] += " " + i.zOrigin + "px", i.zOrigin = 0, i.renderTransform()), i.uncache = 1);
  }
}, mo = function(e, t) {
  var a = {
    target: e,
  ...
  tl() && window.document && (kn = window, st = kn.document, Ut = st.documentElement, St = Li("div") || {
    style: {}
  ...
  return !!(e.getCTM && (!e.parentNode || e.ownerSVGElement) && wo(e));
}, gt = function(e, t) {
  if (t) {
    var a = e.style, i;
  ...
  var s = new pe(e._pt, t, a, 0, 1, o ? po : ho);
  ...
  var n = parseFloat(a) || 0, o = (a + "").trim().substr((n + "").length) || "px", s = St.style, c = al.test(t), l = e.tagName.toLowerCase() === "svg", d = (l ? "client" : "offset") + (c ? "Width" : "Height"), u = 100, h = i === "px", m = i === "%", f, p, w, b;
  if (i === o || !n || Mn[i] || Mn[o])
    return n;
  if (o !== "px" && !h && (n = r(e, t, a, "px")), b = e.getCTM && bo(e), (m || o === "%") && (et[t] || ~t.indexOf("adius")))
    return f = b ? e.getBBox()[c ? "width" : "height"] : e[d], j(m ? n / f * u : n / 100 * f);
  if (s[c ? "width" : "height"] = u + (h ? o : i), p = i !== "rem" && ~t.indexOf("adius") || i === "em" && e.appendChild && !l ? e : e.parentNode, b && (p = (e.ownerSVGElement || {}).parentNode), (!p || p === st || !p.appendChild) && (p = st.body), w = p._gsap, w && m && w.width && c && w.time === Ae.time && !w.uncache)
    return j(n / w.width * u);
  if (m && (t === "height" || t === "width")) {
    var A = e.style[t];
    e.style[t] = u + i, f = e[d], A ? e.style[t] = A : gt(e, t);
  } else
    (m || o === "%") && !fl[ve(p, "display")] && (s.position = ve(e, "position")), p === e && (s.position = "static"), p.appendChild(St), f = St[d], p.removeChild(St), s.position = "absolute";
  return c && m && (w = Ct(p), w.time = Ae.time, w.width = p[d]), j(h ? f * n / u : f && n ? u / f * n : 0);
}, Xe = function(e, t, a, i) {
  var n;
  return nn || Oi(), t in Ve && t !== "transform" && (t = Ve[t], ~t.indexOf(",") && (t = t.split(",")[0])), et[t] && t !== "transform" ? (n = ga(e, i), n = t !== "transformOrigin" ? n[t] : n.svg ? n.origin : Ha(ve(e, ge)) + " " + n.zOrigin + "px") : (n = e.style[t], (!n || n === "auto" || i || ~(n + "").indexOf("calc(")) && (n = za[t] && za[t](e, t, a) || ve(e, t) || Br(e, t) || (t === "opacity" ? 1 : 0))), a && !~(n + "").trim().indexOf(" ") ? mt(e, t, n, a) + a : n;
}, wl = function(e, t, a, i) {
  if (!a || a === "none") {
    var n = Yt(t, e, 1), o = n && ve(e, n, 1);
    o && o !== a ? (t = n, a = o) : t === "borderColor" && (a = ve(e, "borderTopColor"));
  }
  var s = new pe(this._pt, e.style, t, 0, 1, lo), c = 0, l = 0, d, u, h, m, f, p, w, b, A, v, _, y;
  if (s.b = a, s.e = i, a += "", i += "", i.substring(0, 6) === "var(--" && (i = ve(e, i.substring(4, i.indexOf(")")))), i === "auto" && (p = e.style[t], e.style[t] = i, i = ve(e, t) || i, p ? e.style[t] = p : gt(e, t)), d = [a, i], eo(d), a = d[0], i = d[1], h = a.match(Lt) || [], y = i.match(Lt) || [], y.length) {
    for (; u = Lt.exec(i); )
      w = u[0], A = i.substring(c, u.index), f ? f = (f + 1) % 5 : (A.substr(-5) === "rgba(" || A.substr(-5) === "hsla(") && (f = 1), w !== (p = h[l++] || "") && (m = parseFloat(p) || 0, _ = p.substr((m + "").length), w.charAt(1) === "=" && (w = Ft(m, w) + _), b = parseFloat(w), v = w.substr((b + "").length), c = Lt.lastIndex - v.length, v || (v = v || xe.units[t] || _, c === i.length && (i += v, s.e += v)), _ !== v && (m = mt(e, t, p, v) || 0), s._pt = {
        _next: s._pt,
        p: A || l === 1 ? A : ",",
        //note: SVG spec allows omission of comma/space when a negative sign is wedged between two numbers, like 2.5-5.3 instead of 2.5,-5.3 but when tweening, the negative value may switch to positive, so we insert the comma just in case.
        s: m,
    ...
    s.r = t === "display" && i === "none" ? po : ho;
  return Mr.test(i) && (s.e = 0), this._pt = s, s;
}, Dn = {
  top: "0%",
  bottom: "100%",
  left: "0%",
  ...
  if (t.tween && t.tween._time === t.tween._dur) {
    ...
    c && (gt(a, Y), o && (o.svg && a.removeAttribute("transform"), i.scale = i.rotate = i.translate = "none", ga(a, 1), o.uncache = 1, go(i)));
  }
}, za = {
  clearProps: function(e, t, a, i, n) {
    if (n.data !== "isFromStart") {
      var o = e._pt = new pe(e._pt, t, a, 0, 0, Al);
  ...
  */
}, pa = [1, 0, 0, 1, 0, 0], Ao = {}, yo = function(e) {
  return e === "matrix(1, 0, 0, 1, 0, 0)" || e === "none" || !e;
}, Rn = function(e) {
  var t = ve(e, Y);
  return yo(t) ? pa : t.substr(7).match(Pr).map(j);
}, sn = function(e, t) {
  ...
  var s = e._gsap, c = n || sn(e, !0), l = s.xOrigin || 0, d = s.yOrigin || 0, u = s.xOffset || 0, h = s.yOffset || 0, m = c[0], f = c[1], p = c[2], w = c[3], b = c[4], A = c[5], v = t.split(" "), _ = parseFloat(v[0]) || 0, y = parseFloat(v[1]) || 0, E, k, C, S;
  a ? c !== pa && (k = m * w - f * p) && (C = _ * (w / k) + y * (-p / k) + (p * A - w * b) / k, S = _ * (-f / k) + y * (m / k) - (m * A - f * b) / k, _ = C, y = S) : (E = wo(e), _ = E.x + (~v[0].indexOf("%") ? _ / 100 * E.width : _), y = E.y + (~(v[1] || v[0]).indexOf("%") ? y / 100 * E.height : y)), i || i !== !1 && s.smooth ? (b = _ - l, A = y - d, s.xOffset = u + (b * m + A * p) - b, s.yOffset = h + (b * f + A * w) - A) : s.xOffset = s.yOffset = 0, s.xOrigin = _, s.yOrigin = y, s.smooth = !!i, s.origin = t, s.originIsAbsolute = !!a, e.style[ge] = "0px 0px", o && (lt(o, s, "xOrigin", l, _), lt(o, s, "yOrigin", d, y), lt(o, s, "xOffset", u, s.xOffset), lt(o, s, "yOffset", h, s.yOffset)), e.setAttribute("data-svg-origin", _ + " " + y);
}, ga = function(e, t) {
  var a = e._gsap || new ao(e);
  if ("x" in a && !t && !a.uncache)
    return a;
  var i = e.style, n = a.scaleX < 0, o = "px", s = "deg", c = getComputedStyle(e), l = ve(e, ge) || "0", d, u, h, m, f, p, w, b, A, v, _, y, E, k, C, S, P, U, z, L, H, I, q, D, ie, Be, at, Me, wt, mn, Qe, bt;
  return d = u = h = p = w = b = A = v = _ = 0, m = f = 1, a.svg = !!(e.getCTM && bo(e)), c.translate && ((c.translate !== "none" || c.scale !== "none" || c.rotate !== "none") && (i[Y] = (c.translate !== "none" ? "translate3d(" + (c.translate + " 0 0").split(" ").slice(0, 3).join(", ") + ") " : "") + (c.rotate !== "none" ? "rotate(" + c.rotate + ") " : "") + (c.scale !== "none" ? "scale(" + c.scale.split(" ").join(",") + ") " : "") + (c[Y] !== "none" ? c[Y] : "")), i.scale = i.rotate = i.translate = "none"), k = sn(e, a.svg), a.svg && (a.uncache ? (ie = e.getBBox(), l = a.xOrigin - ie.x + "px " + (a.yOrigin - ie.y) + "px", D = "") : D = !t && e.getAttribute("data-svg-origin"), Ni(e, D || l, !!D || a.originIsAbsolute, a.smooth !== !1, k)), y = a.xOrigin || 0, E = a.yOrigin || 0, k !== pa && (U = k[0], z = k[1], L = k[2], H = k[3], d = I = k[4], u = q = k[5], k.length === 6 ? (m = Math.sqrt(U * U + z * z), f = Math.sqrt(H * H + L * L), p = U || z ? Dt(z, U) * _t : 0, A = L || H ? Dt(L, H) * _t + p : 0, A && (f *= Math.abs(Math.cos(A * zt))), a.svg && (d -= y - (y * U + E * L), u -= E - (y * z + E * H))) : (bt = k[6], mn = k[7], at = k[8], Me = k[9], wt = k[10], Qe = k[11], d = k[12], u = k[13], h = k[14], C = Dt(bt, wt), w = C * _t, C && (S = Math.cos(-C), P = Math.sin(-C), D = I * S + at * P, ie = q * S + Me * P, Be = bt * S + wt * P, at = I * -P + at * S, Me = q * -P + Me * S, wt = bt * -P + wt * S, Qe = mn * -P + Qe * S, I = D, q = ie, bt = Be), C = Dt(-L, wt), b = C * _t, C && (S = Math.cos(-C), P = Math.sin(-C), D = U * S - at * P, ie = z * S - Me * P, Be = L * S - wt * P, Qe = H * P + Qe * S, U = D, z = ie, L = Be), C = Dt(z, U), p = C * _t, C && (S = Math.cos(C), P = Math.sin(C), D = U * S + z * P, ie = I * S + q * P, z = z * S - U * P, q = q * S - I * P, U = D, I = ie), w && Math.abs(w) + Math.abs(p) > 359.9 && (w = p = 0, b = 180 - b), m = j(Math.sqrt(U * U + z * z + L * L)), f = j(Math.sqrt(q * q + bt * bt)), C = Dt(I, q), A = Math.abs(C) > 2e-4 ? C * _t : 0, _ = Qe ? 1 / (Qe < 0 ? -Qe : Qe) : 0), a.svg && (D = e.getAttribute("transform"), a.forceCSS = e.setAttribute("transform", "") || !yo(ve(e, Y)), D && e.setAttribute("transform", D))), Math.abs(A) > 90 && Math.abs(A) < 270 && (n ? (m *= -1, A += p <= 0 ? 180 : -180, p += p <= 0 ? 180 : -180) : (f *= -1, A += A <= 0 ? 180 : -180)), t = t || a.uncache, a.x = d - ((a.xPercent = d && (!t && a.xPercent || (Math.round(e.offsetWidth / 2) === Math.round(-d) ? -50 : 0))) ? e.offsetWidth * a.xPercent / 100 : 0) + o, a.y = u - ((a.yPercent = u && (!t && a.yPercent || (Math.round(e.offsetHeight / 2) === Math.round(-u) ? -50 : 0))) ? e.offsetHeight * a.yPercent / 100 : 0) + o, a.z = h + o, a.scaleX = j(m), a.scaleY = j(f), a.rotation = j(p) + s, a.rotationX = j(w) + s, a.rotationY = j(b) + s, a.skewX = A + s, a.skewY = v + s, a.transformPerspective = _ + o, (a.zOrigin = parseFloat(l.split(" ")[2]) || !t && a.zOrigin || 0) && (i[ge] = Ha(l)), a.xOffset = a.yOffset = 0, a.force3D = xe.force3D, a.renderTransform = a.svg ? vl : fo ? vo : yl, a.uncache = 0, a;
}, Ha = function(e) {
  ...
  t.z = "0px", t.rotationY = t.rotationX = "0deg", t.force3D = 0, vo(e, t);
}, At = "0deg", Kt = "0px", yt = ") ", vo = function(e, t) {
  var a = t || this, i = a.xPercent, n = a.yPercent, o = a.x, s = a.y, c = a.z, l = a.rotation, d = a.rotationY, u = a.rotationX, h = a.skewX, m = a.skewY, f = a.scaleX, p = a.scaleY, w = a.transformPerspective, b = a.force3D, A = a.target, v = a.zOrigin, _ = "", y = b === "auto" && e && e !== 1 || b === !0;
  if (v && (u !== At || d !== At)) {
  ...
  w !== Kt && (_ += "perspective(" + w + yt), (i || n) && (_ += "translate(" + i + "%, " + n + "%) "), (y || o !== Kt || s !== Kt || c !== Kt) && (_ += c !== Kt || y ? "translate3d(" + o + ", " + s + ", " + c + ") " : "translate(" + o + ", " + s + yt), l !== At && (_ += "rotate(" + l + yt), d !== At && (_ += "rotateY(" + d + yt), u !== At && (_ += "rotateX(" + u + yt), (h !== At || m !== At) && (_ += "skew(" + h + ", " + m + yt), (f !== 1 || p !== 1) && (_ += "scale(" + f + ", " + p + yt), A.style[Y] = _ || "translate(0, 0)";
}, vl = function(e, t) {
  var a = t || this, i = a.xPercent, n = a.yPercent, o = a.x, s = a.y, c = a.rotation, l = a.skewX, d = a.skewY, u = a.scaleX, h = a.scaleY, m = a.target, f = a.xOrigin, p = a.yOrigin, w = a.xOffset, b = a.yOffset, A = a.forceCSS, v = parseFloat(o), _ = parseFloat(s), y, E, k, C, S;
  c = parseFloat(c), l = parseFloat(l), d = parseFloat(d), d && (d = parseFloat(d), l += d, c += d), c || l ? (c *= zt, l *= zt, y = Math.cos(c) * u, E = Math.sin(c) * u, k = Math.sin(c - l) * -h, C = Math.cos(c - l) * h, l && (d *= zt, S = Math.tan(l - d), S = Math.sqrt(1 + S * S), k *= S, C *= S, d && (S = Math.tan(d), S = Math.sqrt(1 + S * S), y *= S, E *= S)), y = j(y), E = j(E), k = j(k), C = j(C)) : (y = u, C = h, E = k = 0), (v && !~(o + "").indexOf("px") || _ && !~(s + "").indexOf("px")) && (v = mt(m, "x", o, "px"), _ = mt(m, "y", s, "px")), (f || p || w || b) && (v = j(v + f - (f * y + p * k) + w), _ = j(_ + p - (f * E + p * C) + b)), (i || n) && (S = m.getBBox(), v = j(v + i / 100 * S.width), _ = j(_ + n / 100 * S.height)), S = "matrix(" + y + "," + E + "," + k + "," + C + "," + v + "," + _ + ")", m.setAttribute("transform", S), A && (m.style[Y] = S);
}, xl = function(e, t, a, i, n) {
  var o = 360, s = ee(n), c = parseFloat(n) * (s && ~n.indexOf("rad") ? _t : 1), l = c - i, d = i + l + "deg", u, h;
  return s && (u = n.split("_")[1], u === "short" && (l %= o, l !== l % (o / 2) && (l += l < 0 ? o : -o)), u === "cw" && l < 0 ? l = (l + o * Cn) % o - ~~(l / o) * o : u === "ccw" && l > 0 && (l = (l - o * Cn) % o - ~~(l / o) * o)), e._pt = h = new pe(e._pt, t, a, i, l, nl), h.e = d, h.u = "deg", e._props.push(a), h;
}, In = function(e, t) {
  for (var a in t)
    e[a] = t[a];
  return e;
}, _l = function(e, t, a) {
  var i = In({}, a._gsap), n = "perspective,force3D,transformOrigin,svgOrigin", o = a.style, s, c, l, d, u, h, m, f;
  ...
  for (c in et)
    l = i[c], d = s[c], l !== d && n.indexOf(c) < 0 && (m = re(l), f = re(d), u = m !== f ? mt(a, c, l, f) : parseFloat(l), h = parseFloat(d), e._pt = new pe(e._pt, s, c, u, h - u, Bi), e._pt.u = f || 0, e._props.push(c));
  In(s, i);
};
he("padding,margin,Width,Radius", function(r, e) {
  ...
  za[e > 1 ? "border" + r : r] = function(s, c, l, d, u) {
    ...
    if (arguments.length < 4)
      return h = o.map(function(f) {
        return Xe(s, f, l);
      }), m = h.join(" "), m.split(h[0]).length === 5 ? h[0] : m;
    h = (d + "").split(" "), m = {}, o.forEach(function(f, p) {
      return m[f] = h[p] = h[p] || h[(p - 1) / 2 | 0];
    }), s.init(c, m, u);
  };
});
var xo = {
  ...
  init: function(e, t, a, i, n) {
    var o = this._props, s = e.style, c = a.vars.startAt, l, d, u, h, m, f, p, w, b, A, v, _, y, E, k, C, S;
    nn || Oi(), this.styles = this.styles || mo(e), C = this.styles.props, this.tween = a;
    for (p in t)
      if (p !== "autoRound" && (d = t[p], !(fe[p] && io(p, t, a, i, e, n)))) {
        if (m = typeof d, f = za[p], m === "function" && (d = d.call(a, i, e, n), m = typeof d), m === "string" && ~d.indexOf("random(") && (d = da(d)), f)
          f(this, e, p, d, a) && (k = 1);
        else if (p.substr(0, 2) === "--")
          l = (getComputedStyle(e).getPropertyValue(p) + "").trim(), d += "", ht.lastIndex = 0, ht.test(l) || (w = re(l), b = re(d), b ? w !== b && (l = mt(e, p, l, b) + b) : w && (d += w)), this.add(s, "setProperty", l, d, i, n, 0, 0, p), o.push(p), C.push(p, 0, s[p]);
        else if (m !== "undefined") {
          if (c && p in c ? (l = typeof c[p] == "function" ? c[p].call(a, i, e, n) : c[p], ee(l) && ~l.indexOf("random(") && (l = da(l)), re(l + "") || l === "auto" || (l += xe.units[p] || re(Xe(e, p)) || ""), (l + "").charAt(1) === "=" && (l = Xe(e, p))) : l = Xe(e, p), h = parseFloat(l), A = m === "string" && d.charAt(1) === "=" && d.substr(0, 2), A && (d = d.substr(2)), u = parseFloat(d), p in Ve && (p === "autoAlpha" && (h === 1 && Xe(e, "visibility") === "hidden" && u && (h = 0), C.push("visibility", 0, s.visibility), lt(this, s, "visibility", h ? "inherit" : "hidden", u ? "inherit" : "hidden", !u)), p !== "scale" && p !== "transform" && (p = Ve[p], ~p.indexOf(",") && (p = p.split(",")[0]))), v = p in et, v) {
            ...
            if (_ || (y = e._gsap, y.renderTransform && !t.parseTransform || ga(e, t.parseTransform), E = t.smoothOrigin !== !1 && y.smooth, _ = this._pt = new pe(this._pt, s, Y, 0, 1, y.renderTransform, y, 0, -1), _.dep = 1), p === "scale")
              ...
              C.push(ge, 0, s[ge]), d = bl(d), y.svg ? Ni(e, d, 0, E, 0, this) : (b = parseFloat(d.split(" ")[2]) || 0, b !== y.zOrigin && lt(this, y, "zOrigin", y.zOrigin, b), lt(this, s, p, Ha(l), Ha(d)));
              continue;
            } else if (p === "svgOrigin") {
              Ni(e, d, 1, E, 0, this);
              continue;
            } else if (p in Ao) {
              xl(this, y, p, h, A ? Ft(h, A + d) : d);
              continue;
          ...
          if (v || (u || u === 0) && (h || h === 0) && !il.test(d) && p in s)
            w = (l + "").substr((h + "").length), u || (u = 0), b = re(d) || (p in xe.units ? xe.units[p] : w), w !== b && (h = mt(e, p, l, b)), this._pt = new pe(this._pt, v ? y : s, p, h, (A ? Ft(h, A + u) : u) - h, !v && (b === "px" || p === "zIndex") && t.autoRound !== !1 ? sl : Bi), this._pt.u = b || 0, v && S !== d ? (this._pt.b = l, this._pt.e = S, this._pt.r = ol) : w !== b && b !== "%" && (this._pt.b = l, this._pt.r = rl);
          else if (p in s)
            wl.call(this, e, p, l, A ? A + d : d);
          else if (p in e)
  ...
  getSetter: function(e, t, a) {
    var i = Ve[t];
    return i && i.indexOf(",") < 0 && (t = i), t in et && t !== ge && (e._gsap.x || Xe(e, "x")) ? a && Sn === a ? t === "scale" ? ul : dl : (Sn = a || {}) && (t === "scale" ? hl : pl) : e.style && !Gi(e.style[t]) ? ll : ~t.indexOf("-") ? cl : tn(e, t);
  },
  core: {
    _removeProperty: gt,
    _getMatrix: sn
...
me.core.getStyleSaver = mo;
(function(r, e, t, a) {
  var i = he(r + "," + e + "," + t, function(n) {
    et[n] = 1;
  });
  he(e, function(n) {
    xe.units[n] = "deg", Ao[n] = 1;
...
me.registerPlugin(xo);
var g = me.registerPlugin(xo) || me;
g.core.Tween;
...
const kl = "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABAAAAAQCAYAAAAf8/9hAAAAeUlEQVQ4jd3TsRFAYAyG4Td+1rGFRm8CnbOO0gL0GgOomcEWjmg07jj86aRN8tyXIsJYKN9rAXoceeCxDBABKavUvsBRmhgBInk1NhYNkF21rAkImcpLGXQmroZnQLfmptcCj4D5hB8A4vkLpwSLEZDeBjjNgc43yQ5kyxoFPrhHWwAAAABJRU5ErkJggg==", Sl = "data:image/png;base64,", Cl = "data:image/png;base64,", Bn = "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABAAAAAQCAIAAACQkWg2AAAAFklEQVR4nGNQOhpHEmIY1TCqYfhqAACML0UQHuDXpwAAAABJRU5ErkJggg==", Tl = "data:image/png;base64,", El = "data:image/png;base64,", Ln = "data:image/png;base64,", Pl = "data:image/png;base64,", Ml = "data:image/png;base64,", Dl = "data:image/png;base64,", Rl = "data:image/png;base64,", Il = "data:image/png;base64,", ql = "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABAAAAAQCAIAAACQkWg2AAAAFklEQVR4nGPojvlGEmIY1TCqYfhqAAAq1t0QMabSpAAAAABJRU5ErkJggg==", Bl = "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABAAAAAQCAIAAACQkWg2AAAAFklEQVR4nGOwbvpGEmIY1TCqYfhqAACHB7MQtEO1oAAAAABJRU5ErkJggg==", Ll = "data:image/png;base64,", Ol = "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABAAAAAQCAIAAACQkWg2AAAAFklEQVR4nGP4Oo+bJMQwqmFUw/DVAAACRZ4QdD+g5wAAAABJRU5ErkJggg==", Nl = "data:image/png;base64,", Fl = "data:image/png;base64,", Ul = "data:image/png;base64,", zl = "data:image/png;base64,", Hl = "data:image/png;base64,", Vl = "data:image/png;base64,", On = "data:image/png;base64,", Gl = "data:image/png;base64,", Ql = "data:image/png;base64,", Nn = "data:image/png;base64,", Yl = "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABAAAAAQCAMAAAAoLQ9TAAAAKlBMVEUAAAD///8nJye3t7cyMjKHh4f8/Pz39/ecnJwaGhoSEhI5OTnW1tbT09NHEhmuAAAAOklEQVQYlWNgoB5gZUUTYGNH5XMwMnIg8zkZgYALSYAZJMCM4HMzggE3XIAHIsALF2BhAgMWSt0OAwBMcQCayCv/8QAAAABJRU5ErkJggg==", Wl = "data:image/png;base64,", jl = "data:image/png;base64,", Kl = {
  adyen: kl,
  airtable: Sl,
  brex: Cl,
  "bright layer": Bn,
...
function li(r) {
  const e = Xa(r), t = cc.get(e);
  if (t) return t;
  const a = ko(e);
  if (!a) return "";
  for (const { url: i, normalizedKeys: n, compactKeys: o } of dc)
...
function ci(r) {
  ...
  return e ? e.includes("unify") || e.includes("onprem") ? "on-prem" : e.includes("waterfall") ? "waterfall" : uc.get(e) ?? e : "unknown";
}
function Xa(r) {
...
const B = "https://i.pravatar.cc/96", hc = {
  "andre park": `${B}?img=52`,
  "ava garcia": `${B}?img=46`,
...
function pc(r) {
  const e = So(r).replace(/[^a-z0-9]+/g, "-").replace(/^-|-$/g, "");
  return e ? `${B}?u=${encodeURIComponent(e)}` : "";
}
function Ja(r, e) {
  const t = So(r), a = e?.trim() || void 0;
  return hc[t] ?? a ?? pc(r);
}
const Co = `
...
const gc = "/media/chat-background.png", mc = ["/media/", "/data-logos/", "media/", "data-logos/"], dn = (r) => r;
function fc(r) {
  const e = bc(r.assetBaseUrl), t = Ac(r.assetUrlMap);
  return (a) => {
    const i = a.trim();
    if (!i) return a;
    const n = yc(i, t);
    return n || (!e || !vc(i) ? a : `${e}/${i.replace(/^\/+/, "")}`);
  };
}
function wc(r, e) {
  r.style.setProperty("--wa-media-image", _c(e(gc)));
}
function bc(r) {
...
function vc(r) {
  return xc(r) || r.startsWith("//") || r.startsWith("#") ? !1 : mc.some((e) => r.startsWith(e));
}
function xc(r) {
...
const kc = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="52 42 88 66">
<path fill="#4285f4" d="M58 108h14V74L52 59v43c0 3.32 2.69 6 6 6"/>
<path fill="#34a853" d="M120 108h14c3.32 0 6-2.69 6-6V59l-20 15"/>
<path fill="#fbbc04" d="M120 48v26l20-15v-8c0-7.42-8.47-11.65-14.4-7.2"/>
<path fill="#ea4335" d="M72 74V48l24 18 24-18v26L96 92"/>
<path fill="#c5221f" d="M52 51v8l20 15V48l-5.6-4.2c-5.94-4.45-14.4-.22-14.4 7.2"/>
</svg>`, Sc = `<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" viewBox="60 90.4 570.02 539.67">
<defs>
...
const Po = "chatbot-stories:pause-for-thinking-interaction", Cc = [
...
], Tc = 1.28, x = (r) => Number((r * Tc).toFixed(3)), Ec = [3, 3, 3], Pc = {
  ...
  settleHold: x(0.24)
}, zn = "Learning your style", Mc = "Voice calibrated", Hn = "73 tone & tactic rules defined", di = [
  ...
  0,
  4
], Ic = /* @__PURE__ */ new Set([5, 8, 10, 16]), qc = [
  ...
  detailOffsetY: 0,
  duration: x(0.24)
}, Nc = "display,height,marginTop,minHeight,overflow,opacity,visibility,y,transform", Se = {
  duration: x(0.34),
  ...
  threadGap: 44
}, Fc = "left,right,bottom,width,height,minHeight,paddingTop,paddingRight,paddingBottom,paddingLeft,borderWidth,gap", hi = {
  paddingTop: "",
  paddingRight: "",
  paddingBottom: "",
  paddingLeft: "",
  ...
  contentWidth: 1881,
  height: 1280
}, Vc = 96, jn = ".wa-cursor-file, .wa-file-landing-clone, .wa-file-landing-label, .wa-csv-drop, .wa-enrollment-mail", Kn = "[data-marketing-data-sources-grid]", Xn = "[data-data-table]", pi = "[data-table-page-button]", gi = "[data-table-page-range]", Jn = "[data-sequence-engagement]", Gc = "[data-sequence-card]", Qc = "[data-sequence-person-card]", Zn = "[data-sequence-people-rail]", X = {
  duration: x(0.12),
  incomingLag: x(0.1),
  rowStagger: x(0.03),
...
}, Yc = "https://cdn.jsdelivr.net/npm/simple-icons@latest/icons", Wc = "https://www.google.com/s2/favicons", jc = {
  adyen: "adyen",
  airtable: "airtable",
  brex: "brex",
  "dbt labs": "dbt",
...
class Jc {
  ...
  ensurePausedForThinkingInteraction() {
    return this.isPausedForThinkingInteraction() ? !0 : (this.root.dispatchEvent(new CustomEvent(Po, {
      bubbles: !0,
      cancelable: !0
  ...
  measureComposerFullFrame() {
    g.set(this.composer, { clearProps: Fc });
  ...
  strategyPlans(e) {
    ...
    const d = this.claimComponentMessage("strategy", a), u = g.timeline().add(this.revealMessage(d, n, Yn)).addLabel(s, zc).call(() => this.setMotionHints(l), void 0, s).to(t, { ...o.to }, s);
    return t.forEach((h, m) => {
      const f = this.queryElements(h, ".wa-strategy-plan__bullets li");
      f.length && u.to(f, { ...Wn.to }, `${s}+=${m * c}`);
  ...
  strategyPlanCursorHover(e, t, a) {
    ...
    const l = (p) => {
      ...
      const p = this.root.getBoundingClientRect(), w = t.readPosition(), b = {
        x: p.left + w.x,
        y: p.top + w.y
      };
      for (const A of n) {
      ...
      const p = this.root.querySelector(e), w = p?.matches("[data-strategy-plans]") ? p : p?.closest("[data-strategy-plans]");
      n = w ? this.queryElements(w, ".wa-strategy-plan") : [], d(), n.length && (h(), g.ticker.add(h), c = !0, s = g.delayedCall(a, m));
    };
    return i.eventCallback("onInterrupt", m), i.call(f);
  }
  dataSourcesGrid(e) {
  ...
  connectMailbox(e) {
    ...
    return m.call(() => {
      ...
      i.dataset.mailboxLearningState = "ready", c.textContent = Mc, d.textContent = i.dataset.mailboxLearningReadyDetail ?? Hn;
    }).fromTo(
      c,
      { autoAlpha: 0, y: 4 },
      {
  ...
  sequenceBuildThinking(e) {
    const t = this.createSequenceThinkingStep(e.templateLabel, e.template, 0), a = e.tracks.map(
      (f, p) => this.createSequenceThinkingStep(f.label, f.detail, p + 1, e.total)
    ), i = [t, ...a], n = this.claimThinkingMessage(i), o = { value: 1 }, s = a.map((f) => ({
      label: f.querySelector(".wa-sequence-thinking-progress__count"),
      bar: f.querySelector(".wa-sequence-thinking-progress__bar span")
    })), c = s.flatMap((f) => f.bar ? [f.bar] : []);
    ...
    l.add(d, "<").to({}, { duration: Xt.templateHold }).add(this.createThinkingStepElapsedTimer(t, u), `-=${u}`).add(this.foldThinkingStep(t, n.message)).call(() => {
      a.forEach((f) => {
        f.dataset.stepState = "current", this.showThinkingStepTimer(f), g.set(f, { display: "grid" });
      });
    ...
    return l.to(o, {
      ...
      ease: "power1.inOut",
      onUpdate: () => {
        const f = Math.max(1, Math.round(o.value)), p = f / Math.max(1, e.total);
        s.forEach(({ label: w, bar: b }) => {
          w && (w.textContent = `${f}/${e.total}`), b && g.set(b, { scaleX: p });
        }), this.requestMessageScroll(n.message);
      }
    }, "+=0.14").add(a.map(
      (f) => this.createThinkingStepElapsedTimer(f, m)
    ), `-=${m}`).to({}, { duration: Xt.finalHold }), a.forEach((f, p) => {
      l.add(this.foldThinkingStep(f, n.message), p === 0 ? void 0 : "<");
  ...
  enrollmentProgress(e = {}) {
    const t = Math.max(1, Math.round(e.total ?? 50)), a = { value: 0 }, i = this.createThinkingStep(
      ...
      te.title,
      te.completeTitle
    ), m = e.duration ?? te.duration, f = this.createThinkingStepReveal(i), p = this.createThinkingStepReveal(n), w = this.createThinkingStepReveal(o), b = this.createSequenceEnrollmentMailBurst(s, t, m), A = f.duration() + te.queueHold, v = p.duration() + te.mailboxHold, _ = w.duration() + te.progressDelay + Math.max(m, b.duration()), y = g.timeline();
  ...
  getSequenceEnrollmentMailFlight(e, t) {
    ...
    const n = this.sequenceEnrollmentMailRandom(t, 1), o = this.sequenceEnrollmentMailRandom(t, 2), s = this.sequenceEnrollmentMailRandom(t, 3), c = this.sequenceEnrollmentMailRandom(t, 4), l = this.sequenceEnrollmentMailRandom(t, 5), d = this.sequenceEnrollmentMailRandom(t, 6), u = $.iconSize, h = a.left + Math.min(a.width - 6, a.width * (0.55 + n * 0.34)), m = a.top + a.height * (0.42 + o * 0.16), f = h - i.left - u / 2, p = Math.min(
      Math.max(u * -1, f),
      Math.max(u * -1, i.width - u)
    ), w = m - i.top - u / 2, b = window.visualViewport ? window.visualViewport.offsetTop + window.visualViewport.height : window.innerHeight, A = Math.max(
      $.minExitY,
  ...
  renderSequenceEnrollmentMailParticle(e) {
    ...
    if (!t || !a) return;
    const i = this.clampUnit(e.progress), n = $.launchSplit, o = this.clampUnit(i / n), s = this.clampUnit((i - n) / (1 - n)), c = this.easeOutQuad(o), l = s * s, d = i <= n ? a.launchX * c : a.launchX + a.driftX * this.easeOutQuad(s), u = i <= n ? a.apexY * c : a.apexY + (a.exitY - a.apexY) * l, h = this.clampUnit((u - a.fadeStartY) / Math.max(1, a.exitY - a.fadeStartY)), f = this.clampUnit(i / 0.08) * (1 - h), p = a.startRotation + (a.endRotation - a.startRotation) * this.easeOutQuad(i), w = a.scale * (0.72 + 0.28 * this.easeOutBack(Math.min(1, o * 1.2)));
    g.set(t, {
      x: d,
      y: u,
      rotation: p,
  ...
  revealDroppedFilesMessage(e, t, a, i = [], n = {}) {
    ...
    return h || m.to(
      ...
      this.renderFileLandingClones(s, 1), this.renderFileLandingLabel(c, 1), this.thread.scrollTop = h ? u : d, g.set(o, { autoAlpha: 1, y: 0, scale: 1 }), g.set(t, { opacity: 1, visibility: "visible" }), s.forEach((f) => f.el.remove()), c?.el.remove(), e.remove();
    });
  }
  createFileLandingClones(e, t) {
    const a = this.getCursorFileCards(e), i = this.chatBody;
    return t.map((n, o) => {
      const c = a[Math.min(o, a.length - 1)].getBoundingClientRect(), l = n.getBoundingClientRect(), d = this.getElementLocalRect(c, i), u = this.getElementLocalRect(l, i), h = n.cloneNode(!0), m = this.getCursorFileCardRotation(o, a.length), f = window.getComputedStyle(n), p = d.left + (c.width - l.width) * 0.5, w = d.top + (c.height - l.height) * 0.5;
      return h.classList.add("wa-file-landing-clone"), h.dataset.fileLandingClone = "", i.append(h), g.set(h, {
        ...
        borderStyle: f.borderTopStyle === "none" ? "solid" : f.borderTopStyle,
        borderWidth: f.borderTopWidth || "1px",
  ...
  getFileLandingCloneBounds(e, t) {
    const a = e.map((m) => t === "start" ? m.startX : m.endX), i = e.map((m) => t === "start" ? m.startY : m.endY), n = e.map((m) => t === "start" ? m.startWidth : m.endWidth), o = e.map((m) => t === "start" ? m.startHeight : m.endHeight), s = e.map((m, f) => a[f] + n[f]), c = e.map((m, f) => i[f] + o[f]), l = Math.min(...a), d = Math.min(...i), u = Math.max(...s), h = Math.max(...c);
    return {
      left: l,
      top: d,
      width: u - l,
  ...
  resetMessageClasses(e) {
    e.classList.remove(...Cc), e.classList.remove("wa-message--first-active");
  }
  createCsvDropArea(e = {}) {
  ...
  streamThinkingHeader(e) {
    return this.streamThinkingChild(e, ".wa-thinking__title", Oc);
  }
  streamThinkingStepLabel(e) {
    return this.streamThinkingChild(e, ".wa-research-step__label", Lc);
  }
  ...
  runThinkingSequence(e, t) {
    ...
    return a.call(() => {
      ...
      const l = i[c], d = c === 0 ? "+=0" : `+=${t.hold}`, u = this.createThinkingStepReveal(l), h = typeof s.duration == "number" && Number.isFinite(s.duration) ? Math.max(0.1, s.duration) : null, m = h === null ? t.afterStepHold : Math.max(0, h - u.duration()), f = u.duration() + m;
      a.call(() => this.activateThinkingStep(i, c), void 0, d).add(this.moveThinkingLogoToStep(n, l), "<").add(u, "<").to({}, { duration: m }).add(this.createThinkingStepElapsedTimer(l, f), `-=${f}`).add(this.foldThinkingStep(l, n.message));
  ...
  createMarketingDataSourcesGrid(e) {
    ...
    return t.classList.add("wa-data-source-grid--marketing"), t.dataset.marketingDataSourcesGrid = e.id, a.className = "wa-data-source-grid__scale", i.className = "wa-data-source-grid__groups", Hc.forEach((s) => {
      const c = document.createElement("div");
  ...
  createMailboxConnection(e) {
    ...
    const s = this.createMailboxProviderButton({
      id: e.id,
      icon: "gmail",
      label: fi("gmail", e.ctaLabel),
      loadingLabel: wi(e.loadingLabel, "Connecting"),
      connectedLabel: fi("gmail", e.status, "connected"),
      isPrimary: !0
    }), c = this.createMailboxProviderButton({
      icon: "outlook",
      label: fi("outlook", e.secondaryCtaLabel)
    });
    ...
    f.className = "wa-mailbox-learning__detail", f.textContent = e.learningDetail ?? di[0].detail;
    const p = document.createElement("div");
    p.className = "wa-mailbox-learning__progress";
    const w = document.createElement("span");
    return w.dataset.mailboxLearningProgress = "", p.append(w), l.append(d, u, p, f), t.append(a, l), t;
  }
  createMailboxProviderButton(e) {
    const t = document.createElement("button");
    t.className = "wa-mailbox-connection__button", t.type = "button", t.setAttribute("aria-label", e.label), e.isPrimary && e.id && (t.dataset.mailboxConnect = e.id, t.dataset.mailboxLoadingLabel = wi(e.loadingLabel, "Connecting"), t.dataset.mailboxConnectedLabel = e.connectedLabel ?? "Gmail");
    ...
    if (n.className = e.isPrimary ? "wa-mailbox-connection__button-label" : "wa-mailbox-connection__provider-label", e.isPrimary && (n.dataset.mailboxButtonLabel = "idle", n.setAttribute("aria-hidden", "true")), n.textContent = e.label, i.append(n), e.isPrimary) {
      const s = document.createElement("span");
      s.className = "wa-mailbox-connection__button-label", s.dataset.mailboxButtonLabel = "loading", s.setAttribute("aria-hidden", "true"), s.textContent = wi(e.loadingLabel, "Connecting");
  ...
  createMailboxProviderIcon(e) {
    ...
    return t.className = "wa-mailbox-connection__provider-icon", t.src = this.resolveAssetUrl(Dc[e]), t.alt = "", t.decoding = "async", t.loading = "eager", t.setAttribute("aria-hidden", "true"), t;
  }
  ...
  createMailboxThumbprintGroup(e, t = !1) {
    ...
    return a.classList.add(e), qc.forEach((i, n) => {
  ...
  createPersonalizationSwipeGame(e) {
    ...
    const u = document.createElement("div");
    u.className = "wa-swipe-game__glow", u.setAttribute("aria-hidden", "true"), d.append(u), e.signals.forEach((f, p) => {
      const w = document.createElement("article");
      w.className = "wa-swipe-card", w.dataset.swipeCard = f.id, w.dataset.swipeDecision = f.decision, w.dataset.cardIndex = String(p);
      const b = document.createElement("strong");
      b.className = "wa-swipe-card__label", b.textContent = f.label;
      const A = document.createElement("span");
      A.className = "wa-swipe-card__detail", A.textContent = f.detail, w.append(b, A), d.append(w);
    });
  ...
  createSequenceEngagement(e) {
    const t = document.createElement("section"), a = To(e);
    ...
    const o = e.sequences.some((f) => f.steps?.length);
    let s = null;
    if (o) {
      const f = document.createElement("div"), p = document.createElement("div");
      f.className = "wa-sequence-people-wrap", p.className = "wa-sequence-people", p.dataset.sequencePeopleRail = e.id, p.setAttribute("aria-label", "Sequence people"), f.append(p), e.sequences.forEach((w, b) => {
        ...
        A.className = "wa-sequence-person-card", A.type = "button", A.tabIndex = -1, A.dataset.sequencePersonCard = `${e.id}:${b}`, A.dataset.sequencePersonIndex = String(b), A.dataset.active = String(b === a), A.setAttribute("aria-pressed", String(b === a)), A.setAttribute("aria-label", `Preview sequence for ${w.name}`), A.addEventListener("click", () => this.playSequencePersonInteraction(e.id, b)), v.className = "wa-sequence-person-card__avatar-wrap", _.className = "wa-sequence-person-card__avatar", _.dataset.avatarTone = String(b % 9 + 1), this.setProfileAvatar(_, w.name, w.avatarUrl), v.append(_);
        const C = this.createSequenceCompanyBadge(w.company);
        C && v.append(C), y.className = "wa-sequence-person-card__copy", E.textContent = w.name, k.textContent = [w.title, w.company].filter(Boolean).join(", "), y.append(E, k), A.append(v, y), p.append(A);
      }), s = f;
    }
    e.sequences.forEach((f, p) => {
      const w = document.createElement("article");
      w.className = "wa-sequence-card", w.dataset.sequenceCard = `${e.id}:${p}`, w.dataset.sequenceIndex = String(p), w.dataset.active = String(p === a), w.dataset.sequenceName = f.name, w.dataset.sequenceMeta = [f.title, f.company].filter(Boolean).join(", "), w.dataset.sequenceAvatarUrl = f.avatarUrl ?? "", w.dataset.sequenceTemplateName = f.name, w.dataset.sequenceTemplateMeta = [f.title, f.company].filter(Boolean).join(", "), w.dataset.sequenceTemplateAvatarUrl = f.avatarUrl ?? "", w.dataset.sequenceEmail = this.getSequenceRecipientEmail(f), w.dataset.sequenceTemplateEmail = this.getSequenceRecipientEmail(f), w.dataset.sequencePhone = this.getSequenceRecipientPhone(f), w.dataset.sequenceTemplatePhone = this.getSequenceRecipientPhone(f), p !== a && (w.style.display = "none", g.set(w, { autoAlpha: 0, y: 8 }));
      const b = document.createElement("div");
      b.className = "wa-sequence-card__top";
      const A = document.createElement("span");
      A.className = "wa-sequence-card__identity";
      const v = document.createElement("strong");
      v.textContent = f.name;
      const _ = document.createElement("span");
      _.textContent = [f.title, f.company].filter(Boolean).join(", "), A.append(v, _);
      const y = document.createElement("span");
      y.className = "wa-sequence-card__label", y.textContent = f.signal ?? "Personalized", b.append(A, y);
      const E = document.createElement("p");
      E.className = "wa-sequence-card__subject", E.textContent = f.subject;
      const k = document.createElement("p");
      k.className = "wa-sequence-card__personalization", k.textContent = f.personalization;
      const C = f.steps;
      if (C?.length) {
        ...
        S.className = "wa-sequence-steps", C.forEach((I, q) => {
          ...
          D.className = "wa-sequence-step", D.type = "button", D.tabIndex = -1, D.dataset.stepIndex = String(q), D.dataset.stepOpen = String(q === P), D.dataset.stepSelected = String(q === P), D.dataset.channel = this.slugChannelName(I.channel), D.dataset.stepSubject = q === 0 ? f.subject : I.label, D.dataset.stepBody = this.getSequenceStepCopy(f, I), D.dataset.stepTemplateChannel = I.channel, D.dataset.stepTemplateLabel = I.label, D.dataset.stepTemplateSubject = q === 0 ? f.subject : I.label, D.dataset.stepTemplateBody = this.getSequenceStepCopy(f, I), Me && (D.dataset.waitDays = String(Me), D.dataset.stepTemplateWaitDays = String(Me)), D.setAttribute("aria-pressed", String(q === 0)), D.addEventListener("click", () => {
            this.selectSequenceStep(w, q, { cancelPersonTransition: !0 });
    ...
    c.className = "wa-engage-channels", e.channels.forEach((f) => {
      ...
      const A = document.createElement("span");
      if (A.textContent = f.detail, w.append(b, A), p.append(w), f.badge) {
        const v = document.createElement("span");
        v.className = "wa-engage-channel__badge", v.textContent = f.badge, p.dataset.badge = f.badge.toLowerCase(), p.append(v);
      }
      c.append(p);
    });
  ...
  getSequenceCards(e) {
    return this.queryElements(e, Gc);
  }
  ...
  getSequenceStepWaitDays(e, t, a) {
    return t >= a - 1 ? null : e.waitDays ?? Ec[t] ?? 1;
  }
  ...
  applySequenceTemplateToDisplayCard(e, t, a, i) {
    ...
    t.dataset.sequenceName = a.dataset.sequenceTemplateName ?? a.dataset.sequenceName ?? "", t.dataset.sequenceMeta = a.dataset.sequenceTemplateMeta ?? a.dataset.sequenceMeta ?? "", t.dataset.sequenceAvatarUrl = a.dataset.sequenceTemplateAvatarUrl ?? a.dataset.sequenceAvatarUrl ?? "", t.dataset.sequenceEmail = a.dataset.sequenceTemplateEmail ?? a.dataset.sequenceEmail ?? "", t.dataset.sequencePhone = a.dataset.sequenceTemplatePhone ?? a.dataset.sequencePhone ?? "", o.forEach((l, d) => {
      ...
      const f = s[d], p = this.parsePositiveNumber(l.dataset.waitDays), w = f?.querySelector(".wa-sequence-wait__label");
      f && (f.style.display = p === null ? "none" : "grid", f.dataset.waitDays = String(p ?? "")), w && p !== null && this.populateSequenceWaitLabel(w, p);
...
`);
  ...
  requestMessageScroll(e) {
    ...
    this.scheduledScrollMessage = e, !(t - this.lastStreamScrollAt < Vc) && (this.scheduledScrollFrame || (this.lastStreamScrollAt = t, this.scheduledScrollFrame = window.requestAnimationFrame(() => {
...
function $c(r, e) {
  const t = Rc[r] ?? 0, a = 24 + r * 11 % 8, i = Math.min(100, t + a), n = Zc((e - t) / (i - t));
  if (n <= 0) return 0;
  const o = Ic.has(r) ? 20 : 12;
...
function _a(r, e, t) {
  const a = Do(t.seed), i = Mo(r, e), n = t.speed ?? "normal", o = t.intent ?? "hover", s = typeof t.duration == "number" && Number.isFinite(t.duration) ? Math.max(0.01, t.duration) : null;
  ...
  const c = e.x - r.x, l = e.y - r.y, d = c / i, u = l / i, h = -u, m = d, f = a() > 0.5 ? 1 : -1, p = t.curve ?? 1, b = ct(i * (o === "drag" ? 0.1 : o === "click" ? 0.17 : 0.22), 18, 150) * p * f * (0.72 + a() * 0.44), A = i / td[n] + 0.16, v = ct(
    A * ad[o] * id * (t.durationScale ?? 1),
    0.3,
    1.98
...
class od {
  ...
  resolveSkimPoint(e, t, a, i = "first") {
    ...
    if (!n) return null;
    this.resolver.refresh();
    const o = this.seededScanRandom(t), s = this.root.getBoundingClientRect(), c = n.getBoundingClientRect(), l = this.getChatShellRect(), d = l ? Math.max(c.left, l.left + 18) : c.left, u = l ? Math.min(c.right, l.right - 18) : c.right, h = l ? Math.max(c.top, l.top + 58) : c.top, m = l ? Math.min(c.bottom, l.bottom - 34) : c.bottom, f = Math.max(1, u - d), p = Math.max(1, m - h), w = a % 2 === 0 ? 1 : -1, b = ct(0.62 + w * 0.08 + (o() - 0.5) * 0.08, 0.48, 0.78), A = ct(0.5 + (o() - 0.5) * 0.16, 0.34, 0.66);
    return {
      x: d - s.left + f * b,
      y: h - s.top + p * A
    };
  ...
  resolveScanPoint(e, t, a, i = "first") {
    ...
    this.resolver.refresh();
    const o = this.seededScanRandom(t), s = this.root.getBoundingClientRect(), c = n.getBoundingClientRect(), l = this.getChatShellRect(), d = l ? Math.max(c.left, l.left + 18) : c.left, u = l ? Math.min(c.right, l.right - 18) : c.right, h = l ? Math.max(c.top, l.top + 58) : c.top, m = l ? Math.min(c.bottom, l.bottom - 34) : c.bottom, f = Math.max(1, u - d), p = Math.max(1, m - h), w = a === "start" ? 0.16 + o() * 0.08 : 0.76 + o() * 0.12, b = 0.34 + o() * 0.32;
    return {
      x: d - s.left + f * w,
      y: h - s.top + p * b
    };
  ...
  renderMimicRotation(e, t) {
    ...
    if (a * a + i * i < 4) return;
    const n = Math.atan2(i, a) * 180 / Math.PI, o = ld(n - nd), s = this.rotationState + cd(this.rotationState, o) * rd;
...
const nr = /* @__PURE__ */ new Set(), Sa = /* @__PURE__ */ new Set(), dd = ["avatarUrl", "mutualConnectionAvatarUrl"], ud = ["name", "contact", "prospect", "fullName", "mutualConnection", "connector"];
...
function aa(r) {
  return Za(pd(r).flatMap((e) => gd(e.values)));
}
function hd(r) {
...
function gd(r) {
  const e = dd.map((t) => r[t]);
  for (const t of ud) {
    const a = r[t];
    if (!a || !md(t, r)) continue;
...
}, qo = O("[data-signup-field]", "center", {
  desktop: -74,
  tablet: -66,
  mobile: -48
}), Bo = O("[data-signup-submit]", "center"), yd = O("[data-send-button]", "center"), un = {
  desktop: {
...
}, vd = 2.8, xd = 42, _d = 2, kd = 3, kt = {
  approachDuration: 0.78,
  betweenCardDuration: 0.92,
  betweenCardDurationStep: 0.08,
  curve: 0.2,
  followBuffer: 0.7
}, Ga = "[data-chat-shell] [data-chat-thread]", Sd = `${Ga} [data-message-role="assistant"]:not(.wa-message--component) [data-message-body]`, Cd = `${Ga} [data-message-role="assistant"].wa-message--thinking .wa-research-step[data-step-state="current"] .wa-research-step__body, ${Ga} [data-message-role="assistant"].wa-message--thinking .wa-research-step[data-step-state="complete"] .wa-research-step__label`, Qa = 0.24, Lo = 0.3, Je = {
...
function Uo(r, e, t = We.firstMoveDelay) {
...
function zo(r, e = M.beat + 0.18, t, a = {}) {
  return {
    kind: "custom",
    build: (i) => {
      const n = ba(i);
...
function Td(r, e, t, a, i) {
  switch (t.kind) {
    ...
    case "transitionSignupToChat":
      ...
      return;
    case "assistant":
      r.add(e.chat.assistantMessage(t.text), t.at), qd(r, e, i, {
        kind: "assistant",
        key: t.text,
        text: t.text,
        selector: Sd,
      ...
      return;
    case "thinking": {
      const n = Ed(t), o = n.items.map((c) => c.label), s = Pd(n, t.hold);
    ...
    case "strategyPlans":
      {
        ...
        r.add(e.chat.strategyPlans(t.plans), t.at), r.add(Rd(e, n, t.plans), "+=0.06");
      }
      return;
...
function Pd(r, e = M.thinkingShort) {
...
function Id(r, e, t, a = M.thinkingShort, i = 1, n = "thinking", o = 0, s = a * Math.max(1, i)) {
  const c = s, l = i >= 3 && Ho(e, t, {
    kind: "thinking",
    key: n,
    text: n,
    stepIndex: o,
...
function Ho(r, e, t) {
  const a = t.text.trim(), i = t.minChars ?? xd;
  if (a.length < i || e.textSkimCount >= kd) return !1;
  const n = e.textCandidateCount;
  e.textCandidateCount += 1;
  const o = e.textSkimCount === 0, s = t.stepIndex - e.lastTextSkimStep >= _d, c = Ld(`${r.story.id}:${t.kind}:${n}:${t.key}`), l = n > 0 && n % 3 === 0, d = o || s && (c >= 0.58 || l);
    ...
    if (!(t.kind !== "component" || !t.component))
      switch (t.component.kind) {
        case "table":
          ...
          break;
        case "dataSources":
          Ca(e, hd(Ko(t.component)));
          break;
        case "proximityList":
          Ca(e, Ro($o(t.component)));
          break;
        case "sequenceEngagement":
          Ca(e, Io(pn(t.component, `${r.id}-${t.id}`)));
          break;
      }
  return [...e];
}
...
function $d(r, e) {
  return jd[r] ?? e.entryLeadTime;
}
function eu(r, e, t) {
  if (e.id === "hit-ground-running") return tu(r, e);
  if (e.id === "crm-update") return au(r, e);
  if (e.id === "research-brief") return iu(r, e);
  if (e.id === "csv-import-cleanup") return nu(r, e);
  const a = lu(e);
  return a.length ? He(r, [...a, dt(Je.bottomRight, "+=0.18")]) : t.build(r);
}
function tu(r, e) {
  const t = Ze(e, "status"), a = Ze(e, "user"), i = Ze(e, "thinking"), n = Ze(e, "assistant"), o = fa(e, "strategyCards");
  return He(r, [
    ...
    ...o ? [{ kind: "strategyPlans", plans: jo(o.component), at: "-=0.08" }] : [],
    dt(Je.right, "+=0.18")
  ]);
}
function au(r, e) {
  const t = fa(e, "mailboxConnection"), a = fa(e, "uploadedFiles"), i = [];
  if (t && Zo(i, Jo(t.component)), a) {
    const n = Xo(a.component), o = r.chat.prepareCsvDropArea({
...
function iu(r, e) {
  const t = Ze(e, "user"), a = fa(e, "table"), i = Ze(e, "thinking"), n = fa(e, "sequenceEngagement"), o = a ? ma(a.component, "website-visitors-sales") : null, s = n ? pn(n.component, "visitor-outreach-sequences") : null, c = [];
  if (o && (o.scrollAlign = "equal-inset"), t && c.push({
    ...
    zo("website-visitors-sales", Qd, "+=0.08", {
      align: "top",
      bottomClearance: Gd
    })
  ...
  if (i && c.push($a(i, {
    ...
    c.push(
      ...
      ...Uo("visitor-outreach-sequences", [1, 2, 3], "+=0.22"),
      {
        kind: "cursorMove",
        target: m,
        options: { ...Vd, label: "kickoff-visitor-sequence" }
      },
...
function nu(r, e) {
  ...
  ), o = a ? e.steps.indexOf(a) : -1, s = n.find((f) => o >= 0 && e.steps.indexOf(f) < o), c = [...n].reverse().find((f) => f !== s), l = t?.text || "may_webinar_attendees.csv", d = ru(t, s?.component ?? c?.component), u = r.chat.prepareCsvDropArea(), h = r.chat.prepareCursorFile(l, r.cursor), m = O("[data-chat-shell]", "center", {
    desktop: { x: 0, y: 82 },
    tablet: { x: 0, y: 72 },
    mobile: { x: 0, y: 64 }
  });
  return He(r, [
    ...
    ...c ? [{ kind: "dataTable", config: mu(ma(c.component, "cleaned-webinar-attendees")), at: "-=0.04" }] : [],
...
function lu(r) {
  const e = [], t = r.id === "data-marketplace" ? cu(r.steps) : r.steps;
  let a = 0;
  for (const i of t)
    a += i.kind === "user" ? 1 : 0, Qo(e, r.id, i, a === 1);
  return e;
}
function cu(r) {
  const e = [];
...
function Qo(r, e, t, a = !1) {
  ...
  t.kind !== "component" || !t.component || uu(r, e, t);
}
function uu(r, e, t) {
  const a = t.component;
  if (a.kind === "table") {
    const i = ma(a, `${e}-${t.id}`);
    e === "data-marketplace" && fu(i), Au(e, t, i) && (i.scrollAlign = "equal-inset"), r.push({ kind: "dataTable", config: i, at: "-=0.04" });
    return;
  }
  if (a.kind === "strategyCards") {
    r.push({ kind: "strategyPlans", plans: jo(a), at: "-=0.04" });
    return;
  }
  if (a.kind === "enrichment") {
    r.push({ kind: "enrichmentPanel", config: Pu(a), at: "+=0.12" });
    return;
  }
  ...
  if (a.kind === "uploadedFiles") {
    r.push({ kind: "custom", build: (i) => i.chat.uploadedFilesMessage(Xo(a)), at: "-=0.04" });
    return;
  }
  ...
  if (a.kind === "proximityList") {
    r.push({ kind: "custom", build: (i) => i.chat.proximityLeadList($o(a)), at: "-=0.04" });
    return;
  }
  if (a.kind === "personalizationSwipeGame") {
    r.push({ kind: "personalizationSwipeGame", config: Du(a), at: "+=0.06" });
    return;
  }
...
function $a(r, e = {}) {
  return {
    kind: "thinking",
    thinking: hu(r.thinking, r.text, r.note),
    hold: e.hold,
...
function ma(r, e) {
  const t = yu(r, e), a = r.rows.filter((s) => s.some((c) => c.trim())).map((s, c) => Su(s, t, c)), i = Yo(r.pagination), n = Go(r.pagination?.pageSize) ?? Nd(i) ?? Math.min(10, a.length || 10), o = i.map((s, c) => ({
    page: c + 1,
    range: s,
    rows: Fd(a, s, c, n)
  ...
  return {
    ...
    eyebrow: r.eyebrow,
    count: r.count,
    variant: t.variant ?? Ru(r),
    footerClearance: ku(e),
    columns: t.columns,
    rows: o[0]?.rows ?? a,
    actions: r.actions?.map(Eu),
    pagination: o.length > 1 ? {
      pageSize: n,
      totalRows: Iu(r, a.length),
      activePage: 1,
      pages: o
    } : void 0
  };
...
function dr(r) {
  r.name && "company" in r && (r.company = ia), r.prospectDetail && (r.prospectDetail = wu(r.prospectDetail)), r.connector && !r.connectorDetail && (r.connector = bu(r.connector));
}
function wu(r) {
  const e = r.trim();
...
function yu(r, e) {
  const t = r.columns, a = t.findIndex((d) => d.trim().toLowerCase() === "name"), i = a >= 0 ? t.findIndex((d, u) => u > a && /^role\b/i.test(d.trim())) : -1, n = a >= 0 && i >= 0, o = Wo(e) ? t.findIndex((d) => d.trim().toLowerCase() === "title") : -1, s = n ? i : o >= 0 ? o : void 0, c = t.map((d, u) => u).filter((d) => d !== i && d !== o), l = c.map((d) => {
    ...
    const h = xu(e, u), m = h.key ?? le(u || `column-${d + 1}`);
    return {
      key: m,
      label: u,
      width: h.width ?? vu(u, n),
      cellType: h.cellType ?? _u(e, u, m),
      person: h.person
    };
  });
  return {
...
function vu(r, e) {
  const t = r.toLowerCase();
  if (e)
    return t.includes("connector") || t.includes("connection") ? we.foldedConnector : t.includes("email") ? we.foldedEmail : t.includes("mobile") ? we.foldedMobile : we.foldedDefault;
  if (t === "email" || t === "work email") return we.emailContent;
}
function xu(r, e) {
  const t = e.trim().toLowerCase();
  if (r === "raw-webinar-attendees") {
    if (t === "name") return { width: we.rawName, cellType: "text" };
    if (t === "email") return { width: we.rawEmail };
    if (t === "company") return { width: we.rawCompany };
  }
  if (Wo(r)) {
    if (t === "full name") return { key: "fullName", width: we.cleanName, cellType: "person" };
    if (t === "work email") return { width: we.cleanEmail };
    if (t === "company") return { width: we.cleanCompany };
  }
  return t === "connector" ? {
    key: "connector",
    width: we.foldedConnector,
    cellType: "person",
    person: pu
  } : {};
}
...
function Su(r, e, t) {
  ...
  if (e.columns.forEach((i, n) => {
    ...
    const i = Ui(a[e.mutualConnectionKey] ?? ""), n = Cu(i.context);
...
function Ui(r) {
  const [e = "", t = ""] = r.split(/\s+[—–]\s+/, 2), a = e.trim().match(/^(.+?)(?:\s*\((.+)\))?$/), i = a?.[1]?.trim() || r.trim(), n = t.trim(), o = gu[le(i).replace(/-/g, " ")], s = Tu(a?.[2]?.trim() || "", o, n);
  return {
    name: i,
    title: s.title,
    context: n,
...
function Iu(r, e) {
  const t = Yo(r.pagination), a = t[t.length - 1];
  return hn(a)?.total ?? e;
}
function le(r) {
...
const Qu = {
  ...
  pagination: {
    ...
    pages: [
      ...
      { page: 2, range: "11-20 of 50 people", rows: Wu }
    ]
  },
  actions: [
    {
  ...
  },
  {
    ...
    build: (r) => He(r, [
      ...
      { kind: "enrichmentPanel", config: Vu, at: "+=0.12" },
      { kind: "status", text: "Contacts enriched", at: "+=0.86" },
      { kind: "dataTable", config: fr, at: "-=0.02" },
  ...
  },
  {
    ...
    build: (r) => {
      ...
      }), t = r.chat.prepareCursorFile("4 context files", r.cursor, "DOC", wr), a = {
        desktop: { target: "[data-chat-shell]", anchor: "right", outside: "right", offset: { x: 420, y: -74 }, humanOffset: !1 },
        tablet: { target: "[data-chat-shell]", anchor: "right", outside: "right", offset: { x: 360, y: -58 }, humanOffset: !1 },
        mobile: { target: "[data-chat-shell]", anchor: "right", outside: "right", offset: { x: 280, y: -42 }, humanOffset: !1 }
      ...
      return He(r, [
        ...
        { kind: "custom", build: () => t.landAsUploadedFiles(wr), at: "<" },
  ...
  },
  {
    ...
    build: (r) => {
      ...
      return He(r, [
        ...
        zo("website-visitors-sales", Ou, "+=0.08", {
          align: "top",
          bottomClearance: Lu
        }),
        {
        ...
        { kind: "custom", build: () => r.chat.dataTableActionSelected("website-visitors-sales", "email-sequence"), at: "<" },
        { kind: "status", text: "building outreach sequence", at: "<" },
        { kind: "custom", build: () => r.chat.sequenceBuildThinking(Qu), at: "+=0.06" },
        ...
        ...Uo("visitor-outreach-sequences", [1, 2, 3], "+=0.22"),
        {
          kind: "cursorMove",
          target: s,
          options: { ...Fu, label: "kickoff-visitor-sequence" }
        },
        { kind: "cursorClick", at: "+=0.12" },
        { kind: "custom", build: () => r.chat.sequenceKickoff("visitor-outreach-sequences"), at: "-=0.02" },
        { kind: "custom", build: () => r.chat.enrollmentProgress({ total: 50 }), at: "+=0.08" }
  ...
  },
  {
    ...
    build: (r) => {
      ...
      return He(r, [
        ...
        { kind: "dataTable", config: ju, at: `+=${M.beat}` },
        { kind: "status", text: "Cleaning CSV", at: "<" },
        {
          kind: "thinking",
          steps: [
        ...
        { kind: "dataTable", config: Ku, at: "-=0.04" },
        dt(Je.bottomRight, "+=0.18")
      ]);
    }
  }
...
class Xu {
  ...
  updateFollowTarget(e) {
    ...
    if (this.lastPointer) {
      ...
      i > 1.5 && (this.trailDirection = {
        x: a.x / i,
        y: a.y / i
      }, this.velocity = th(a, ne.maxMomentumStep));
    }
    const t = {
  ...
  updatePlayTarget(e) {
    ...
    this.target = Zu(n, this.pointer, it.minPointerDistance, it.viewportInset);
  }
  resumeFollowing(e) {
  ...
  getReturnWavePoint(e, t) {
    const a = this.returnStart ?? this.getCursorViewportPoint(), i = Ju(e), n = t.x - a.x, o = t.y - a.y, s = Math.hypot(n, o), c = {
      x: a.x + n * i,
      y: a.y + o * i
    };
    if (s < 1) return c;
  ...
  isCursorTooFarFromBrowser() {
    ...
    return eh(i, e) > ne.maxBrowserDistance;
  }
  getChatShell() {
    return this.chatShell?.isConnected ? this.chatShell : (this.chatShell = this.root.querySelector("[data-chat-shell]"), this.chatShell);
  }
...
const Sr = {
  ...
  overshoot: !1,
  settle: !1
}, nh = "chatbotStoriesTheme", rh = /* @__PURE__ */ new Set(["light", "dark", "system"]), oh = [
  "a[href]",
  "button",
  "input",
  "select",
...
class sh {
  constructor(e, t, a, i, n, o) {
    this.root = e, this.stories = t, this.resolver = a, this.cursor = i, this.chat = n, this.options = o, this.storyProgress = this.stories.map(() => 0), this.pausedCursorMimic = new Xu(this.root, this.cursor, {
  ...
  seekTo(e) {
    ...
    this.autoAdvance?.kill(), this.seekTween?.kill(), this.seekTween = null, this.setHistoryPaused(!1), this.chat.stopScrollMotion(), this.cursor.clearTransientInteraction(), this.playing = t, this.renderActiveTimelineProgress(e), t && (this.seekTween = g.delayedCall(ah.resumeDelay, () => {
  ...
  attachControls() {
    this.renderStoryTabs(), this.scrubber = this.root.querySelector("[data-story-scrubber]"), this.playButton = this.root.querySelector("[data-toggle-play]"), this.resumeButton = this.root.querySelector("[data-history-resume]"), this.attachTheme(), this.on("[data-prev-story]", "click", () => this.previous()), this.on("[data-next-story]", "click", () => this.next()), this.on("[data-toggle-play]", "click", () => {
      this.playing ? this.pause() : this.play();
    }), this.on("[data-history-resume]", "click", () => this.play()), this.onRoot(Po, (e) => {
  ...
  readStoredThemePreference() {
    try {
      const e = window.localStorage?.getItem(nh);
  ...
  applyThemePreference(e) {
    ...
    this.root.dataset.theme = e, this.root.dataset.resolvedTheme = t, document.documentElement.style.setProperty("--wa-page-bg", t === "dark" ? "#10100d" : "#fffff9"), document.documentElement.style.colorScheme = t;
  }
  resolveTheme(e) {
...
class dh {
  ...
  resolve(e, t = "target") {
    ...
    if (s = {
      ...
      const c = Do(t), l = Math.min(o.width * 0.18, 18), d = Math.min(o.height * 0.18, 14);
...
function uh(r, e = {}) {
  const t = e.stories?.length ? e.stories : as, a = e.builderDraftEndpoint ?? (e.showBuilder ? "/api/story-draft" : !1), i = fc(e);
  wc(r, i);
  const n = e.reducedMotion ?? window.matchMedia?.("(prefers-reduced-motion: reduce)").matches ?? !1, o = new dh(r), s = new Jc(r, { resolveAssetUrl: i }), c = new od(r, o, { reducedMotion: n }), l = new sh(r, t, o, c, s, {
...
function gh(r) {
  ...
  const e = typeof r.schemaVersion == "number" ? r.schemaVersion : 1, t = r.stories.map((a) => fh(a)).filter((a) => !!a);
...
function fh(r) {
  ...
  const e = T(r.id), t = T(r.label), a = T(r.summary), i = r.steps.map((n) => wh(n)).filter((n) => !!n);
...
function wh(r) {
  ...
  return !e || !t || !mh(t) ? null : {
    ...
    text: a ?? "",
    note: i ?? "",
    thinking: tt(r.thinking) ? Dh(r.thinking, a ?? "", i ?? "") : t === "thinking" ? ns(a ?? "", i ?? "") : void 0,
...
function yh(r) {
  if (!tt(r)) return;
  const e = Vo(r.ranges), t = Go(r.pageSize) ?? void 0;
  return e.length ? {
    ...t ? { pageSize: t } : {},
    ranges: e
  } : void 0;
          ...
          <div class="wa-chat-shell" data-chat-shell>
            ...
            <div class="wa-chat-shell__body">
              <div class="wa-signup-scene" data-signup-scene>
                <span class="wa-signup-scene__logo" data-signup-logo-target aria-hidden="true">${Co}</span>
...
function Vh(r, {
  ...
  function o(c = t, l = {}) {
    ...
    const p = {
      ...h,
      destroy: () => {
        f || (f = !0, i.delete(d), delete d.dataset.chatbotStoriesMounted, m());
      }
    };
