...
function createSeedSteps(storyId: string, fallbackSummary: string): BuilderStep[] {
  const seed: Record<string, Array<Omit<BuilderStep, "id">>> = {
    ...
    "crm-update": [
      ...
      { kind: "user", text: "Generate leads ranked by how personally connected they are to me.", note: "" },
      {
        kind: "thinking",
        text: "Scoring shared schools, fields of study, mutual contacts, and warm signals",
        note: "Combining account history with public source changes and recent activity to prepare a concise research brief.",
        thinking: {
          ...
          items: [
            {
              ...
              detail: "Combining account history with public source changes and recent activity to prepare a concise research brief.",
    ...
    "research-brief": [
      { kind: "user", text: "Show me 50 sales leaders that have recently visited my website.", note: "" },
      {
        ...
        component: createWebsiteVisitorTableComponent("Recent website visitors", [
          ...
          ["Andre Park", "Waterfall", "Head of Sales", "33m ago", "Demo page"],
          ...
          ["Sam Hollis", "Pylon", "VP Sales", "1h ago", "Comparison"],
      ...
      { kind: "cursor", text: "Cursor clicks the next chevron, then clicks the outreach sequence button.", note: "Outreach sequence switches into the selected state." },
      createThinkingStepSeed(
        [
      ...
      { kind: "assistant", text: "I cleaned the attendee list and normalized the fields that matter for routing and follow-up.", note: "" },
      {
        ...
        component: {
          ...
          rows: [
            ...
            ["Lucas Meyer", "lucas.meyer@waterfall.com", "Waterfall", "Revenue Operations"],
            ["Nina Kapoor", "nina.kapoor@mercury.com", "Mercury", "Sales Director"],
            ["Sam Hollis", "sam.hollis@usepylon.com", "Pylon", "VP Sales"],
            ["Anna Li", "anna.li@linear.app", "Linear", "Growth Marketing"],
            ["Devon Park", "devon.park@brex.com", "Brex", "RevOps Manager"],
            ["Rachel Cho", "rachel.cho@figma.com", "Figma", "Product Marketing"],
            ["Owen Lee", "owen.lee@notion.so", "Notion", "Revenue Lead"],
            ["Clara Wong", "clara.wong@brightlayer.com", "BrightLayer", "VP Revenue"],
            ["Sara Patel", "sara.patel@northstar.ai", "Northstar AI", "Demand Gen"],
            ["Ethan Cho", "ethan.cho@clearbit.com", "Clearbit", "Head of Demand Gen"],
            ["Fatima Ali", "fatima.ali@vercel.com", "Vercel", "VP Sales"],
            ["Leo Martin", "leo.martin@hex.tech", "Hex", "Head of Sales"],
            ["Priya Rao", "priya.rao@census.com", "Census", "Sales Director"],
            ["Jules Meyer", "jules.meyer@notion.so", "Notion", "VP Sales"],
            ["Marcus Reed", "marcus.reed@figma.com", "Figma", "Revenue Lead"],
            ["Zoe Carter", "zoe.carter@rippling.com", "Rippling", "Head of Sales"],
            ["Liam Price", "liam.price@webflow.com", "Webflow", "VP Sales"],
          ],
          pagination: {
            pageSize: 10,
            ranges: ["1-10 of 54 records", "11-20 of 54 records"],
          },
        },
      },
    ],
...
function createRawWebinarAttendeesTableComponent(): BuilderTableComponent {
  return {
    ...
    rows: [
      ...
      ["Ethan Cho", "ethan.cho@gmail.com", ""],
      ["Priya Shah", "priya.shah+webinar@orbitgrid.com", "Orbitgrid"],
      ["Lucas", "lucas.meyer@yahoo.com", ""],
      ["N. Kapoor", "", "Mercury"],
      ["Anna Li", "annali.work@gmail.com", ""],
      ["Devon Park", "devon.park@outlook.com", ""],
      ["Rachel C.", "", "Figma"],
      ["Owen Lee", "owen.lee@icloud.com", ""],
      ["Clara Wong", "clara.wong@proton.me", "Bright Layer"],
      ["Maya Rodriguez", "maya.rodriguez@northstar.ai", "Northstar AI"],
      ["Ethan Cho", "", "Clearbit Inc."],
      ["Fatima Ali", "fatima.ali@gmail.com", ""],
      ["Leo Martin", "leo.martin@hex.tech", "Hex"],
      ["Priya Rao", "priya.rao@yahoo.com", ""],
      ["Jules Meyer", "jules@notion.so", "Notion"],
      ["Marcus Reed", "marcus.reed@icloud.com", ""],
      ["Zoe Carter", "zoe.carter@rippling.com", "Rippling"],
      ["Liam Price", "liam.price@gmail.com", ""],
      ["Sara Nelson", "sara.nelson@airtable.com", "Airtable"],
    ],
    pagination: {
      pageSize: 10,
      ranges: ["1-10 of 54 records", "11-20 of 54 records"],
  ...
  return {
    ...
    sources: [
      ...
      },
      {
        category: "Enrichment",
        name: "Waterfall",
        detail: "Identity and business context enrichment.",
...
function createUploadedFilesComponent(): BuilderUploadedFilesComponent {
  return {
    ...
    files: [
      { name: "vercel-positioning.pdf", detail: "Frontend Cloud narrative, buyer pains, proof points", type: "PDF" },
      { name: "ai-app-playbook.docx", detail: "AI app workflows, Vercel AI SDK, launch patterns", type: "DOC" },
      { name: "enterprise-objections.pdf", detail: "Security, scale, migration, and platform objections", type: "PDF" },
      { name: "icp-context.md", detail: "Best-fit teams, disqualifiers, buying triggers", type: "MD" },
    ],
  };
}
